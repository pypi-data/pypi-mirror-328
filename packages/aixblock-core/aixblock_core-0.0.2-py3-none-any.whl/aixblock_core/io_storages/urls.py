...
_api_urlpatterns = [
    ...
    path('s3-server', S3ImportStorageListAPI.as_view(), name='storage-s3-server-list'),
    path('s3-server-changepassword', S3ServerChangePassword.as_view(), name='storage-s3-server-list'),
    path('s3-server-resetpassword', S3ServerResetPassword.as_view(), name='storage-s3-server-list'),
    path('s3-server/<int:pk>', S3ImportStorageDetailAPI.as_view(), name='storage-s3-server-detail'),
    path('s3-server/<int:pk>/sync', S3ImportStorageSyncAPI.as_view(), name='storage-s3-server-sync'),
    path('s3-server/validate', S3ImportStorageValidateAPI.as_view(), name='storage-s3-validate'),
    path('s3-server/form', S3ImportStorageFormLayoutAPI.as_view(), name='storage-s3-server-form'),
    path('export/s3-server', S3ExportStorageListAPI.as_view(), name='export-storage-s3-server-list'),
    path('export/s3-server/<int:pk>', S3ExportStorageDetailAPI.as_view(), name='export-storage-s3-server-detail'),
    path('export/s3-server/<int:pk>/sync', S3ExportStorageSyncAPI.as_view(), name='export-storage-s3-server-sync'),
    path('export/s3-server/validate', S3ExportStorageValidateAPI.as_view(), name='export-storage-s3-server-validate'),
    path('export/s3-server/form', S3ExportStorageFormLayoutAPI.as_view(), name='export-storage-s3-form'),
    # Microsoft Azure

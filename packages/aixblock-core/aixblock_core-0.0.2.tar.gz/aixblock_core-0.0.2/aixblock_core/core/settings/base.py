...
TOKEN_URL_CONVERT = get_env("TOKEN_URL_CONVERT", "XoRzQWz1y7rjvEKnJLR0mq0xjK9NOeRYNdUvApvDMFKD63LRDCoFUSpXnPiEDbEW")
...
OAUTH_CLIENT_SECRET     = get_env('OAUTH_CLIENT_SECRET', 'SUYHWjgzutCF5SZn3EgAxctmetp9GCgixqOY17jV')
...
GOOGLE_OAUTH_CLIENT = {
    'client_id': get_env('GOOGLE_OAUTH2_CLIENT_ID', '525460036347-i0c17cqi8pi8ilmh81haevj7mnmm4afu.apps.googleusercontent.com'),
    'client_secret': get_env('GOOGLE_OAUTH2_CLIENT_SECRET', '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'),
    'project_id': get_env('GOOGLE_OAUTH2_PROJECT_ID', 'wow-ai-oauth2')
}
...
VAST_AI_API_KEY = os.environ.get("VAST_AI_API_KEY", "617a708ca7bda70f79b9d72335dbec5f89b91edb29e558c7e1fcb50042a55ce4")

EXABIT_USERNAME = os.environ.get("EXABIT_USERNAME", "aixblock")
EXABIT_PASSWORD = os.environ.get("EXABIT_PASSWORD", "bd7966454588c67512f7ab64500c296b")
EXABIT_API_KEY = os.environ.get("EXABIT_API_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..aMpByeTCiqFZhURqhBhon9L1Q31e5Nk48j5Flgw2tms")

NOTEBOOK_URL = os.environ.get('NOTEBOOK_URL', None)
NOTEBOOK_TOKEN = os.environ.get('NOTEBOOK_TOKEN', '639922e8a39e41e7add2d6ac4f45c314')

NOTION_API_TOKEN = os.environ.get('NOTION_API_TOKEN', 'secret_WTms43trqD9lMMlMoM4fgG8jOWR8udqgXARaeJh8vCG')
OAUTH2_PROVIDER = {
    "PKCE_REQUIRED": False,
...
MINIO_API_IP = os.environ.get("MINIO_API_IP", "https://storage.aixblock.io")
MINIO_API_URL = os.environ.get("MINIO_API_URL", "144.202.5.64:9000")
MINIO_USER = os.environ.get("MINIO_USER", "storage01")
MINIO_PASSWORD = os.environ.get("MINIO_PASSWORD", "ekd%re@y")
MINIO_STORAGE_USE_HTTPS=False

ASSETS_CDN = os.environ.get('ASSETS_CDN', '')
PAYPAL_ENDPOINT = os.environ.get('PAYPAL_ENDPOINT', 'https://api-m.sandbox.paypal.com')
PAYPAL_CLIENT_ID = os.environ.get('PAYPAL_CLIENT_ID', 'AV_rPGmMFTmS-yxa7krhgGomSClhbQwo519vG6DXlOg1Zs5G4zgHJnroDinBbIWpfAsH2ei4Fs8g3REH')
PAYPAL_CLIENT_SECRET = os.environ.get('PAYPAL_CLIENT_SECRET', 'EG63SSZLII9haLmGnIQ8faR4Cc-zFlXoOFe54B5ewNyZBmcVoPwuu407cyWNiA83YJ1JysI5HQwuY-J-')
JENKINS_KEY = os.environ.get(
    "JENKINS_KEY", "aixblock-jenkins-CkUQiCTpBQnW7bGeNgErll2VJzoMH63m"
)

JENKINS_TOKEN = os.environ.get("JENKINS_TOKEN", "1133a5f1a86ab1f4811abddb8bf45b36d8")
JENKINS_URL = os.environ.get("JENKINS_URL", "http://207.246.109.178:8081/")
...
GRAFANA_PROMETHUS =os.environ.get("GRAFANA_PROMETHUS","207.246.109.178:7091")
...
ADMIN_JUPYTERHUB_TOKEN = os.environ.get('ADMIN_JUPYTERHUB_TOKEN',  '119eeac1b8accdcc6a82fc6ee7e26de83f')
...
ADMIN_EMAIL = os.environ.get("ADMIN_EMAIL", "admin@wow-ai.com")
ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME", "admin")
ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD", "123321")

API_VERIFY_JOB = os.environ.get("API_VERIFY_JOB", "http://207.246.109.178:6000/add-compute")

STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_51PLECCP6xVZQvAyiPIMn2pJZSiyM3HIj2waBNNDZC1LHXJuJBPSU6D8FaOGSYEmRMJOcJiSjut0tbx5hitvHnZxl00DjwhAUj9")
STRIPE_PUBLIC_KEY = os.environ.get("STRIPE_PUBLIC_KEY", "pk_test_51PLECCP6xVZQvAyiA1cTtX1hrWgkqUB5iqAGiChZ0xTFll433HMv7ap69m1kgqOs0fyxbL5ZI43Akjepi4yaPwOu00BY6kvoMf")
STRIPE_PAYMENT_METHODS_CONFIG = os.environ.get("STRIPE_PAYMENT_METHODS_CONFIG", "pmc_1Q2BGOP6xVZQvAyihw3QyXat")
...
UPLOAD_TEMP_DELETE_KEY = get_env("UPLOAD_TEMP_DELETE_KEY", "TYu7dMkeKWltZ7H")
UPLOAD_TEMP_DELETE_TOKEN = get_env("UPLOAD_TEMP_DELETE_TOKEN", "sRv3C7SZLvJUA9j")

REGISTER_TOPUP = int(os.environ.get('REGISTER_TOPUP', '0'))
X_FRAME_OPTIONS = "SAMEORIGIN"

CRYPTO_API = get_env('CRYPTO_API', 'http://172.174.243.31:8081')
CRYPTO_SECRET_KEY = get_env('CRYPTO_SECRET_KEY', 'juDpKtaGqdSkPyFkS1myGrNp1bzeaBvFSopFjuz3sCY=')

...
class ClassifierDataUpdateRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ClassifierDataUpdateRequest)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='ClassifierDataUpdateRequest', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassifierDataUpdateRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassifierDataUpdateRequest'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='ClassifierDataUpdateRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for record_ in self.record:
            ...
            record_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='record', pretty_print=pretty_print)
...
class record(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='record', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='record', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='record'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='record', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for attribute_value_ in self.attribute_value:
            namespaceprefix_ = self.attribute_value_nsprefix_ + ':' if (UseCapturedNS_ and self.attribute_value_nsprefix_) else ''
            attribute_value_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='attribute-value', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class attribute_value(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, attribute_name=None, attribute_ref=None, string=None, text=None, bool=None, date=None, integer=None, decimal=None, reference=None, code=None, string_key=None, date_key=None, integer_key=None, decimal_key=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, attribute_value)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def validate_stringType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 255:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on stringType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
    ...
    def validate_textType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on textType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def validate_string_keyType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 255:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on string-keyType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on string-keyType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_attribute_refType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 36:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on attribute-refType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on attribute-refType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def hasContent_(self):
        if (
            ...
            self.string_key is not None or
            self.date_key is not None or
            self.integer_key is not None or
            self.decimal_key is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='attribute-value', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='attribute-value', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='attribute-value'):
        if self.attribute_name is not None and 'attribute_name' not in already_processed:
            ...
            outfile.write(' attribute-name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.attribute_name), input_name='attribute-name')), ))
        if self.attribute_ref is not None and 'attribute_ref' not in already_processed:
            already_processed.add('attribute_ref')
            outfile.write(' attribute-ref=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.attribute_ref), input_name='attribute-ref')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='attribute-value', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.bool is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbool>%s</%sbool>%s' % (namespaceprefix_ , self.gds_format_boolean(self.bool, input_name='bool'), namespaceprefix_ , eol_))
        ...
        if self.integer is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinteger>%s</%sinteger>%s' % (namespaceprefix_ , self.gds_format_integer(self.integer, input_name='integer'), namespaceprefix_ , eol_))
        if self.decimal is not None:
            namespaceprefix_ = self.decimal_nsprefix_ + ':' if (UseCapturedNS_ and self.decimal_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdecimal>%s</%sdecimal>%s' % (namespaceprefix_ , self.gds_format_decimal(self.decimal, input_name='decimal'), namespaceprefix_ , eol_))
        ...
        if self.string_key is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sstring-key>%s</%sstring-key>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.string_key), input_name='string-key')), namespaceprefix_ , eol_))
        if self.date_key is not None:
            namespaceprefix_ = self.date_key_nsprefix_ + ':' if (UseCapturedNS_ and self.date_key_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdate-key>%s</%sdate-key>%s' % (namespaceprefix_ , self.gds_format_date(self.date_key, input_name='date-key'), namespaceprefix_ , eol_))
        if self.integer_key is not None:
            namespaceprefix_ = self.integer_key_nsprefix_ + ':' if (UseCapturedNS_ and self.integer_key_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinteger-key>%s</%sinteger-key>%s' % (namespaceprefix_ , self.gds_format_integer(self.integer_key, input_name='integer-key'), namespaceprefix_ , eol_))
        if self.decimal_key is not None:
            namespaceprefix_ = self.decimal_key_nsprefix_ + ':' if (UseCapturedNS_ and self.decimal_key_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdecimal-key>%s</%sdecimal-key>%s' % (namespaceprefix_ , self.gds_format_decimal(self.decimal_key, input_name='decimal-key'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class classifier_data(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, classifier_data)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def validate_classifier_refType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 36:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on classifier-refType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on classifier-refType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def hasContent_(self):
        if (
            self.record
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='classifier-data', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='classifier-data', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='classifier-data'):
        ...
        if self.classifier_ref is not None and 'classifier_ref' not in already_processed:
            ...
            outfile.write(' classifier-ref=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.classifier_ref), input_name='classifier-ref')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='classifier-data', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClassifierDataDeleteRequest(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ClassifierDataDeleteRequest)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='ClassifierDataDeleteRequest', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ClassifierDataDeleteRequest', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClassifierDataDeleteRequest'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='ClassifierDataDeleteRequest', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class recordType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, record_key=None, string_key=None, date_key=None, integer_key=None, decimal_key=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def validate_record_keyType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 36:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on record-keyType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on record-keyType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_string_keyType2(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 255:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on string-keyType2' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on string-keyType2' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
            self.record_key is not None or
            self.string_key is not None or
            self.date_key is not None or
            self.integer_key is not None or
            self.decimal_key is not None
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='recordType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='recordType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='recordType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='recordType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.record_key is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srecord-key>%s</%srecord-key>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.record_key), input_name='record-key')), namespaceprefix_ , eol_))
        if self.string_key is not None:
            namespaceprefix_ = self.string_key_nsprefix_ + ':' if (UseCapturedNS_ and self.string_key_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sstring-key>%s</%sstring-key>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.string_key), input_name='string-key')), namespaceprefix_ , eol_))
...
class dataType(GeneratedsSuper):
    ...
    def validate_classifier_refType1(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 36:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on classifier-refType1' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on classifier-refType1' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def hasContent_(self):
        if (
            self.record
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='dataType', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dataType'):
        ...
        if self.classifier_ref is not None and 'classifier_ref' not in already_processed:
            already_processed.add('classifier_ref')
            outfile.write(' classifier-ref=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.classifier_ref), input_name='classifier-ref')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="urn://x-artefacts-smev-gov-ru/esnsi/smev-integration/update/2.0.0"', name_='dataType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

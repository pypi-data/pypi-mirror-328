...
from datarobot._experimental.models.notebooks.enums import ImageLanguage
...
class ExecutionEnvironment(APIObject):
    ...
    def assign_environment(
        ...
        .. code-block:: python
            ...
            from datarobot._experimental.models.notebooks import ExecutionEnvironment, ExecutionEnvironmentAssignPayload

...
def show_main_content():
    ...
    st.session_state["selected_datetime_from"] = st.selectbox(key="start_date", label="Start Date", options=["2025-02-11 00:00:00","2024-07-02 06:00:00","2024-07-03 06:00:00","2024-07-04 06:00:00","2024-07-05 06:00:00", "2024-01-22 06:00:00"], )	
    st.session_state["selected_datetime_to"] = st.selectbox(key="end_date", label="Start Date", options=["2025-02-12 00:00:00","2024-11-29 06:00:00","2024-07-03 06:00:00","2024-07-04 06:00:00","2024-07-05 06:00:00", "2025-01-22 06:00:00"])	
...
def show_streamlit_slb_gallery():      
    if "selected_datetime_from" in st.session_state and "selected_datetime_to" in st.session_state:
        st.session_state.selected_data = streamlit_slb_gallery(
            ...
            token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6ImltaTBZMnowZFlLeEJ0dEFxS19UdDVoWUJUayIsImtpZCI6ImltaTBZMnowZFlLeEJ0dEFxS19UdDVoWUJUayJ9..crSiWL9cGorZWKeM_uA6K1ZQY4AxBT8g4lBhcvfJ_icO7EkDwEiv7U17as1p-AhFLTFPEzmOQxr6Ffk-YObF9178ujvwZd85bNBFf3Shf9hpoX--vFgT20LMY8hcUC6v5TFkF2nKyBvgVTmn64jaUynG6KgksN2FMD4AIQYa7yc_obkiQqeEx0h-CwdRpNQgo9QkxGR0AhChhSSbbHoBKT-AS4Bn8LXuGaQcMxN7clpeyMq1SCC53CXuk-DGGzozGDAVgeLhTaiS1l4atZWk4n3ACQgpmMYcnZb9w5CII0jpT9DHCLNNevToe92jvWmNmNuA_nuTneCEUHTP-RTpUg",

...
from vajra.benchmark.config import SyntheticRequestGeneratorConfig
from vajra.benchmark.entities import Request
from vajra.benchmark.request_generator.base_request_generator import (
    BaseRequestGenerator,
)
from vajra.benchmark.request_generator.request_interval_generator_registry import (
    RequestIntervalGeneratorRegistry,
)
from vajra.benchmark.request_generator.request_length_generator_registry import (
...
class SyntheticRequestGenerator(BaseRequestGenerator):
    ...
    def _generate_next_request(self, last_arrived_at: float) -> Optional[Request]:
        inter_request_time = (

...
from vajra._kernels_C import rms_norm
from vajra._model_executor_C import RMSNorm as RMSNormC
...
class RMSNorm(nn.Module):
    ...
    def __init__(
        ...
        self._norm_timer = CudaTimer(norm_name, layer_id=layer_id)  # type: ignore

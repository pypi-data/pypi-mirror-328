...
from vajra.core.datatypes import CommInfo, SamplerOutputs, SchedulerOutput, StepOutputs
...
class BaseWorker:
    ...
    def execute_model(
        ...
        with self.on_schedule_handling_timer:
            _, seqs, seq_metadata_list = self.seq_manager.on_schedule(scheduler_output)

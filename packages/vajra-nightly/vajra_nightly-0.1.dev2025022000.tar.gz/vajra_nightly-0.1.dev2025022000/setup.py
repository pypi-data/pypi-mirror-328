...
ext_modules.append(CMakeExtension(name="vajra._kernels_C"))
ext_modules.append(CMakeExtension(name="vajra._model_executor_C"))
ext_modules.append(CMakeExtension(name="vajra._datatypes_C"))

package_data = {
    get_package_name(): ["model_executor/layers/fused_moe/configs/*.json"]
}

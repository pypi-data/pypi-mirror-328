...
from starflow.custom_operators.k8s_branch_operator import starflowKubernetesBranchPodOperator
...
class TaskBranch(object):
    """
    The TaskBranch object represents a task in a workflow.
    ...
    def _set_operator(self) -> BaseOperator:
        ...
        return starflowKubernetesBranchPodOperator(
            dag_id=self.dag_id,
            ...
            task_id_main_branch=self.task_id_main_branch,
            task_id_else_branch=self.task_id_else_branch,
            ...
            cmds=["starflow"],
            arguments=["run-piece-branch-k8s"],
            do_xcom_push=True,
            in_cluster=True,

...
class APIClient:
    ...
    **Example:**
    ...
    def proceed(self) -> bool:
        ...
        return isinstance(self.service_instance._auth_method, TokenAuth)
        ...
        if not zen:
            ...
            if not self.ICP_PLATFORM_SPACES:
                if self.default_project_id is not None:
                    headers["X-Watson-Project-ID"] = self.default_project_id
    ...
    def set_token(self, token: str) -> None:
        ...
        **Examples**
        ...
        self.service_instance._auth_method = TokenAuth(token)

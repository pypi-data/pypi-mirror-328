...
class RAGPattern:
    ...
    def deploy(
        ...
        **Example:**
        ...
        """
        warn(
            '"deploy" method is deprecated, please use "inference_function.deploy(...)" instead',
    ...
    def delete(self, delete_stored_function: bool = True) -> None:
        ...
        """
        warn(
            '"delete" method is deprecated. Instead, please use “api_client.deployments.delete(deployment_id)” and “api_client.repository.delete(asset_id)” to delete the deployment and asset in the repository, respectively.',
            category=DeprecationWarning,
        )

...
class TestToolPythonPoetry(PythonSiteToolBase):
    ...
    def test_tool_python_poetry_default_scheme_default(self):
        rv = self.engine.run()
        self.assertTrue(rv)
    ...
    def test_tool_python_poetry_default_scheme_native(self):
    ...
    def test_tool_python_poetry_host_scheme_default(self):
    ...
    def test_tool_python_poetry_host_scheme_native(self):
        self.defconfig_add('INSTALL_TYPE', 'host')
        self.defconfig_add('PYTHON_INSTALLER_SCHEME', 'native')
    ...
    def test_tool_python_poetry_staging_scheme_default(self):
    ...
    def test_tool_python_poetry_staging_scheme_native(self):
        self.defconfig_add('INSTALL_TYPE', 'staging')
        self.defconfig_add('PYTHON_INSTALLER_SCHEME', 'native')
    ...
    def test_tool_python_poetry_staging_and_target_scheme_default(self):
    ...
    def test_tool_python_poetry_staging_and_target_scheme_native(self):
        self.defconfig_add('INSTALL_TYPE', 'staging_and_target')
        self.defconfig_add('PYTHON_INSTALLER_SCHEME', 'native')

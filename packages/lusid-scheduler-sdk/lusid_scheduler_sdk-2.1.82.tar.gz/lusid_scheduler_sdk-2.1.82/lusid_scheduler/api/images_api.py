...
class ImagesApi:
    ...
    @overload
    async def delete_image(self, name : Annotated[StrictStr, Field(..., description="The name and tag of the image. Format \"ExampleImageName:0.1\"")], **kwargs) -> str:  # noqa: E501
        ...

    @overload
    def delete_image(self, name : Annotated[StrictStr, Field(..., description="The name and tag of the image. Format \"ExampleImageName:0.1\"")], async_req: Optional[bool]=True, **kwargs) -> str:  # noqa: E501
        ...
    ...
    @overload
    def list_images(self, name : Annotated[StrictStr, Field(..., description="The name of the Repository")], page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing images from a previous call to list images.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided.")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName.")] = None, start : Annotated[Optional[conint(strict=True, le=5000, ge=0)], Field(description="When paginating, skip this number of results.")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfImageSummary:  # noqa: E501
        ...
    ...
    @overload
    def list_repositories(self, page : Annotated[Optional[StrictStr], Field( description="The pagination token to use to continue listing images from a previous call to list images.              This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields              must not have changed since the original request. Also, if set, a start value cannot be provided.")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Order the results by these fields. Use use the '-' sign to denote descending order e.g. -MyFieldName.")] = None, start : Annotated[Optional[conint(strict=True, le=5000, ge=0)], Field(description="When paginating, skip this number of results.")] = None, limit : Annotated[Optional[conint(strict=True, le=5000, ge=1)], Field(description="When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000.")] = None, filter : Annotated[Optional[StrictStr], Field( description="Expression to filter the result set.")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfRepository:  # noqa: E501
        ...

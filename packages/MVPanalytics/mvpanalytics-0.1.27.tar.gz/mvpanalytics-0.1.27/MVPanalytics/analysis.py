def weightgiver(api_key, host, comp_id, str_id,  perc_min, per, ban=[], max_ban=0.5, prime = [], prime_add = 0.1): 
    """
        ...
        Args:
            ...
            ban: (list) - список из id рекламодателей, которые не в приоритете
            max_ban: (float [0, 1]) - какая доля отстаётся у неприроритетных оферов в случае, если суммарно на все неприоритетные оффера отводится больше указанной доли.

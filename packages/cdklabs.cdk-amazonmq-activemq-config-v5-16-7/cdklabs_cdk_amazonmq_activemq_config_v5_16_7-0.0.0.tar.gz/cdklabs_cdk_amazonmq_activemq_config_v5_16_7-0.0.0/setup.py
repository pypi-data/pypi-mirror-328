...
kwargs = json.loads(
    """
{
    "name": "cdklabs.cdk-amazonmq-activemq-config-v5-16-7",
    "version": "0.0.0",
    "description": "@cdklabs/cdk-amazonmq-activemq-config-v5-16-7",
    "license": "Apache-2.0",
    ...
    "packages": [
        ...
        "cdklabs.cdk-amazonmq-activemq-config-v5-16-7._jsii"
    ],
    "package_data": {
        "cdklabs.cdk-amazonmq-activemq-config-v5-16-7._jsii": [
            "cdk-amazonmq-activemq-config-v5-16-7@0.0.0.jsii.tgz"
        ],
        "cdklabs.cdk-amazonmq-activemq-config-v5-16-7": [
            "py.typed"
        ]

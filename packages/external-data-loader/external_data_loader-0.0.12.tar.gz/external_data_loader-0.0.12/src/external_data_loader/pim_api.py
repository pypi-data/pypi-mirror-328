...
def parser(data, item_entity_id, option_entity_id):
    ...
    return item_publish_code, entity_ids, item_active_web,channels, item_long_copy, item_ecom_status, item_enable_ecom, option_long_copy, product_details, item_image_resc_type, item_image_file_name
...
def load_pim_data():
    ...
    for article in articles:
        ...
        if data:
            ...
            item_publish_code, entity_ids, item_active_web, channels, item_long_copy, item_ecom_status, item_enable_ecom, option_long_copy, product_details, item_image_resc_type, item_image_file_name = data

...
if __name__ == "__main__":
    ...
    try:
        ...
        if 3 in args.steps:
            ...
            Tg, best_hit_G= build_graph_series(best_hit_G, args)
            ...
            Tgtxt= Tg.apply(lambda x: get_nhx(x, name_attr= 'accession')).reset_index()
        ...
        if 4 in args.steps:
            ...
            missed_species, nMissed= check_species_in_trees(gTrees, species_tree)
        ...
        if 5 in args.steps:
            ...
            if 4 not in args.steps:
                missed_species, nMissed= check_species_in_trees(gTrees, sTree, color_attr='species')
            if nMissed > 0:

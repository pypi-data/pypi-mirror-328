...
class BigQueryTableUpdater:
    ...
    # def get_qt_rows_ok_difference(self, tracker_id, step_1, step_2, volumetria):
    #     """
    ...
    #     WHERE tracker_id = @tracker_id AND nm_project = "sintegra" AND nm_step IN (@step_1, @step_2)
    #     """
    ...
    def get_qt_rows_ok_difference(self, tracker_id, step_1, step_2, volumetria):
        ...
        # Log para verificar o que está retornando da consulta
        logging.info(f"Resultado da consulta para tracker_id {tracker_id}: {list(results)}")

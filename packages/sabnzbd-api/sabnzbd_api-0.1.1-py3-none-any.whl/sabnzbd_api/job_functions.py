...
class JobFunctions(SubFunctions):
    ...
    def delete_job(self, nzo_id: str | list[str], delete_files: bool = False):
        """return {"status": True, "nzo_ids": ["all effected ids"]}"""
        return self.call(
            {
                "mode": "queue",
    ...
    def remove_file(self, nzo_id: str, file_ids: str | list[str]):
        return self.call(
            {
                "mode": "queue",
                "name": "delete_nzf",
    ...
    def set_speedlimit(self, limit: str | int):
        """return {"status": True}"""
    ...
    def set_config_default(self, keyword: str | list[str]):
        """return {"status": True}"""

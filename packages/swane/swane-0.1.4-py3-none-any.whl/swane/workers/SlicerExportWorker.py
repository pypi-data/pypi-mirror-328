...
class SlicerExportWorker(QRunnable):
    ...
    def __init__(self, slicer_path: str, result_dir: str, scene_ext: str, config: ConfigManager):
    ...
    def run(self):
        ...
        dti_threshold=self.config.getfloat_safe(DataInputList.DTI, "tractography_threshold")

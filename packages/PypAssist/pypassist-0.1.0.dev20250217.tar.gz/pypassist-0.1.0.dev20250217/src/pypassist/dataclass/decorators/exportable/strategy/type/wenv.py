...
class WenvExportStrategy(ExportStrategy):
        ...
        for field in dataclasses.fields(data_cls):
            ...
            if is_wenv(field_type):
                cls._export_wenv_field(
                    field_type, output_dir, format_type, exist_ok, makedirs, **kwargs
                )
                continue
    ...
    def _export_default_workenv(  # pylint: disable=too-many-arguments
        ...
        default_conf = cls._create_default_config(defaults)
    ...
    @classmethod
    def _create_default_config(cls, defaults):
        ...
        @exportable(stem_file="workenv_defaults")
        @dataclass

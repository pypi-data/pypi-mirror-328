...
class Database:
    ...
    @__db_operation
    def select(self, cursor:Cursor, table_name:str, cols:str='*', where: str=None, order_by:str=None, distinct:bool=False):
        ...
        # Fetch all rows and convert each to a dict (column name as key)

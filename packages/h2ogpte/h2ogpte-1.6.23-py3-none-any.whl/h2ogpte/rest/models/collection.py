...
class Collection(BaseModel):
    ...
    Collection
    """ # noqa: E501
    id: StrictStr = Field(description="A unique identifier of the collection")
    name: StrictStr = Field(description="Name of the collection")
    description: StrictStr = Field(description="Description of the collection")
    embedding_model: StrictStr
    document_count: StrictInt = Field(description="A number of documents in the collection")
    document_size: StrictInt = Field(description="Total size in bytes of all documents in the collection")
    updated_at: datetime = Field(description="Last time when collection was modified")
    user_count: StrictInt = Field(description="A number of users having access to the collection")
    is_public: StrictBool = Field(description="Is publicly accessible")
    username: StrictStr = Field(description="Name of the user owning the collection")
    sessions_count: StrictInt = Field(description="A number of chat sessions with the collection")
    prompt_template_id: Optional[StrictStr] = Field(default=None, description="A unique identifier of a prompt template associated with the collection.")
    thumbnail: Optional[StrictStr] = Field(default=None, description="A file name of a thumbnail image.")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "embedding_model", "document_count", "document_size", "updated_at", "user_count", "is_public", "username", "sessions_count", "prompt_template_id", "thumbnail"]

...
class Document(BaseModel):
    ...
    Document
    """ # noqa: E501
    id: StrictStr = Field(description="A unique identifier of the document")
    name: StrictStr = Field(description="Name of the document")
    type: StrictStr = Field(description="Type of the document")
    size: StrictInt = Field(description="Size of the document in bytes")
    updated_at: datetime = Field(description="Last time when document was modified")
    uri: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    summary_parameters: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "size", "updated_at", "uri", "summary", "summary_parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summary_parameters": obj.get("summary_parameters")
        })
        return _obj

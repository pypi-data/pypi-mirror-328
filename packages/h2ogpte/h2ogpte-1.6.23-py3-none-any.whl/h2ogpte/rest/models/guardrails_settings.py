...
class GuardrailsSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exception_message", "disallowed_regex_patterns", "presidio_labels_to_flag", "pii_labels_to_flag", "pii_detection_parse_action", "pii_detection_llm_input_action", "pii_detection_llm_output_action", "prompt_guard_labels_to_flag", "guardrails_labels_to_flag", "guardrails_entities"]

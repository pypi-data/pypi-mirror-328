...
class IngestFromGcsBody(BaseModel):
    """
    IngestFromGcsBody
    """ # noqa: E501
    urls: List[StrictStr] = Field(description="The path or list of paths of GCS files or directories.")
    credentials: Optional[GCSCredentials] = None
    __properties: ClassVar[List[str]] = ["urls", "credentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IngestFromGcsBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IngestFromGcsBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "urls": obj.get("urls"),
            "credentials": GCSCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
        return _obj

...
class IngestFromS3Body(BaseModel):
    """
    IngestFromS3Body
    """ # noqa: E501
    urls: List[StrictStr] = Field(description="The path or list of paths of S3 files or directories.")
    region: Optional[StrictStr] = Field(default='us-east-1', description="The name of the region used for interaction with AWS services.")
    credentials: Optional[S3Credentials] = None
    __properties: ClassVar[List[str]] = ["urls", "region", "credentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IngestFromS3Body from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IngestFromS3Body from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "credentials": S3Credentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
        return _obj

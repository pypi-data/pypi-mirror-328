...
class IngestFromAzureBlobStorageBody(BaseModel):
    """
    IngestFromAzureBlobStorageBody
    """ # noqa: E501
    container: StrictStr = Field(description="Name of the Azure Blob Storage container.")
    paths: List[StrictStr] = Field(description="Path or list of paths to files or directories within an Azure Blob Storage container.")
    account_name: StrictStr = Field(description="Name of a storage account")
    credentials: Optional[AzureCredentials] = None
    __properties: ClassVar[List[str]] = ["container", "paths", "account_name", "credentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": AzureCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
        return _obj

...
if TYPE_CHECKING:
    from ..models.update_webhook_item import UpdateWebhookItem
...
class UpdateWebhook:
    ...
    Attributes:
        ...
        item (Union[Unset, UpdateWebhookItem]):
    """

    token: str
    item: Union[Unset, "UpdateWebhookItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_item, Unset):
            ...
            item = UpdateWebhookItem.from_dict(_item)

...
T = TypeVar("T", bound="AddCustomItemItem")


@_attrs_define
class AddCustomItemItem:
    """
    Attributes:
        collection_type (str): The name of the custom collection to which the item belongs. Example: My Collection.
        collection_id (int): The id of the custom collection within the system. Example: 3.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        add_custom_item_item.additional_properties = d
        return add_custom_item_item

...
if TYPE_CHECKING:
    from ..models.create_folder_item import CreateFolderItem
...
class CreateFolder:
    ...
    Attributes:
        ...
        item (Union[Unset, CreateFolderItem]):
    """

    token: str
    item: Union[Unset, "CreateFolderItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_item, Unset):
            ...
            item = CreateFolderItem.from_dict(_item)

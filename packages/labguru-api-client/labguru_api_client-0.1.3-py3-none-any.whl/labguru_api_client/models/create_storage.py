...
class CreateStorage:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_item, Unset):
            ...
            item = CreateStorageItem.from_dict(_item)
        ...
        create_storage.additional_properties = d

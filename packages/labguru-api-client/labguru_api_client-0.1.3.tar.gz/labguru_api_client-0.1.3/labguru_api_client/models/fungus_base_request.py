...
T = TypeVar("T", bound="FungusBaseRequest")


@_attrs_define
class FungusBaseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        fungus_base_request = cls(
            token=token,
            item=item,
        )

        fungus_base_request.additional_properties = d
        return fungus_base_request

...
T = TypeVar("T", bound="PostApiV1BiocollectionNameBodyItem")


@_attrs_define
class PostApiV1BiocollectionNameBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_api_v1_biocollection_name_body_item = cls(
            title=title,
            parents_uuid=parents_uuid,
        )

        post_api_v1_biocollection_name_body_item.additional_properties = d
        return post_api_v1_biocollection_name_body_item

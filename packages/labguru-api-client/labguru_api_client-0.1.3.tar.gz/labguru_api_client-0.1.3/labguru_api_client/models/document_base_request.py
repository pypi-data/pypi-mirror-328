...
T = TypeVar("T", bound="DocumentBaseRequest")


@_attrs_define
class DocumentBaseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        document_base_request = cls(
            token=token,
            item=item,
        )

        document_base_request.additional_properties = d
        return document_base_request

...
T = TypeVar("T", bound="BacteriumBaseRequest")


@_attrs_define
class BacteriumBaseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        bacterium_base_request = cls(
            token=token,
            item=item,
        )

        bacterium_base_request.additional_properties = d
        return bacterium_base_request

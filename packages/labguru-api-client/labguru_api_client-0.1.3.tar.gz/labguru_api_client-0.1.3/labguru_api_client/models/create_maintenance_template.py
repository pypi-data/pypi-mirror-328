...
T = TypeVar("T", bound="CreateMaintenanceTemplate")


@_attrs_define
class CreateMaintenanceTemplate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_maintenance_template = cls(
            token=token,
            item=item,
        )

        create_maintenance_template.additional_properties = d
        return create_maintenance_template

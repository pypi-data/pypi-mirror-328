...
T = TypeVar("T", bound="ExperimentBaseRequest")


@_attrs_define
class ExperimentBaseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        experiment_base_request = cls(
            token=token,
            item=item,
        )

        experiment_base_request.additional_properties = d
        return experiment_base_request

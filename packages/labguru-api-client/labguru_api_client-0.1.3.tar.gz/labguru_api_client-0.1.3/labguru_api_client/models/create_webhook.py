...
if TYPE_CHECKING:
    from ..models.create_webhook_item import CreateWebhookItem
...
class CreateWebhook:
    ...
    Attributes:
        ...
        item (Union[Unset, CreateWebhookItem]):
    """

    token: str
    item: Union[Unset, "CreateWebhookItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_item, Unset):
            ...
            item = CreateWebhookItem.from_dict(_item)

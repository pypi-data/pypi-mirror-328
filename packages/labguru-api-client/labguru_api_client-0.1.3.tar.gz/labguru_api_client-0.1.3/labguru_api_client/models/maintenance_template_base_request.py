...
T = TypeVar("T", bound="MaintenanceTemplateBaseRequest")


@_attrs_define
class MaintenanceTemplateBaseRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        maintenance_template_base_request = cls(
            token=token,
            item=item,
        )

        maintenance_template_base_request.additional_properties = d
        return maintenance_template_base_request

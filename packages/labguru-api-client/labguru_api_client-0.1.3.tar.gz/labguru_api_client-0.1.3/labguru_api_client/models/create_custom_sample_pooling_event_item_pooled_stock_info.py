...
T = TypeVar("T", bound="CreateCustomSamplePoolingEventItemPooledStockInfo")


@_attrs_define
class CreateCustomSamplePoolingEventItemPooledStockInfo:
    ...
    Attributes:
        stockable_type (str): Identifies the class name of the stock item, such as 'Biocollections::Bacterium'.
                                    This indicates the category of the entity and must match valid system-defined class
            names. Example: Biocollections::Bacterium.
        stockable_id (int):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_custom_sample_pooling_event_item_pooled_stock_info = cls(
            stockable_type=stockable_type,
            stockable_id=stockable_id,
            storage_type=storage_type,
            storage_id=storage_id,
        ...
        create_custom_sample_pooling_event_item_pooled_stock_info.additional_properties = d
        return create_custom_sample_pooling_event_item_pooled_stock_info

import logging
from simpleCan.util import dataStructure as ds, can_func
...
class SimpleCan:
    ...
    def recvMessage(self, message_id, offset = 0, duration=10) -> ds.ReceivedCanMessage:
        return RecvMessageTask.recvMessage(message_id=message_id, offset = offset, duration = duration)

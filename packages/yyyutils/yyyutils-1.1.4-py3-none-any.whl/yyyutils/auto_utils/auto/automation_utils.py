...
class AutomationUtils:
    ...
    def __init__(self, driver_path, headless=False, debug=False):
        """
        初始化方法
        ...
        self._driver = seleniumwire_webdriver.Edge(options=edge_options, service=service)
        self.get_driver()

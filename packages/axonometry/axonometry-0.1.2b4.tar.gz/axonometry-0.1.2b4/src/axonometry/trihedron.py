"""The axes system of the :class:`.Axonometry`."""
...
from .utils import is_valid_angles
...
class Trihedron:
    ...
    :param angles: Standard axonometric notation; left/right angles from 'horizon' for x/y
    coordinate axis.
    ...
    def __init__(
        ...
        assert is_valid_angles(angles), "Angle can not be 0. Approximate zero with .1"
        # Initialize object
        logger.debug(
    ...
    def _setup_reference_planes(self, ref_planes_distance: float) -> dict[str, ReferencePlane]:
    ...
    def add_unitary_cube(self) -> NotImplementedError:
        """Not implemented yet."""

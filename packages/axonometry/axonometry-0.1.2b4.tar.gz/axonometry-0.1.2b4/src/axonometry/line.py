"""The fundamental drawing element."""
...
class Line:
    ...
    def _project_on_reference_plane(self, ref_plane_key: str) -> "Line":
...
def random_line(key: str = "xyz") -> Line:

...
def rpc_transformers(rpc_transformers) -> List[TransformerLabel]:
    ...
    """
    return [TransformerLabel(method_name=rcp_transformer.methodName,
                             parameters=dict(rcp_transformer.parameters),
                             return_type=rcp_transformer.returnType)
            for rcp_transformer in rpc_transformers]
...
def transformer_type(value: RpcTransformerArgument):
    ...
    if type_name == 'boolean':
        ...
        return _primitive_matchers[RpcLong](value.long)
    elif type_name == 'double':
        return _primitive_matchers[RpcDouble](value.double)
        ...
        raise Exception("Cannot unpack RpcTransformerArgument because it's type is not supported.")

...
class RpcTransformerArgument(google.protobuf.message.Message):
    ...
    @property
    def long(self) -> hansken_extraction_plugin.framework.PrimitiveMessages_pb2.RpcLong: ...
    @property
    def double(self) -> hansken_extraction_plugin.framework.PrimitiveMessages_pb2.RpcDouble: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        long: hansken_extraction_plugin.framework.PrimitiveMessages_pb2.RpcLong | None = ...,
        double: hansken_extraction_plugin.framework.PrimitiveMessages_pb2.RpcDouble | None = ...,
    ...
    def HasField(self, field_name: typing.Literal["boolean", b"boolean", "bytes", b"bytes", "datetime", b"datetime", "double", b"double", "latLong", b"latLong", "list", b"list", "long", b"long", "map", b"map", "string", b"string", "type", b"type", "vector", b"vector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["boolean", b"boolean", "bytes", b"bytes", "datetime", b"datetime", "double", b"double", "latLong", b"latLong", "list", b"list", "long", b"long", "map", b"map", "string", b"string", "type", b"type", "vector", b"vector"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["boolean", "bytes", "long", "double", "string", "vector", "latLong", "datetime", "list", "map"] | None: ...

...
class Configuration:
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://redac.anabrid.de/v0" if host is None else host
        """Default Base url
        """
        ...
        self.logger["package_logger"] = logging.getLogger(
            "anabrid.redaccess.api.client.gen"
        )
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 0.1".format(env=sys.platform, pyversion=sys.version)
        )

...
import anabrid.redaccess.api.common.models.gen
from anabrid.redaccess.api.client.gen import rest
from anabrid.redaccess.api.client.gen.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    server communication, and is invariant across anabrid.redaccess.api.client.gen.impl.mentations. Specifics of
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(anabrid.redaccess.api.common.models.gen, klass)

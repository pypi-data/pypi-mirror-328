...
from lightningchart.series import Series2D, SeriesWith2DPoints, PolarPointImageStyle
from lightningchart.utils import convert_to_dict


class PolarPointSeries(Series2D, SeriesWith2DPoints, PolarPointImageStyle):

...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _WORKFLOWSERVICE.methods_by_name["UpdateActivityOptionsById"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "UpdateActivityOptionsById"
    ]._serialized_options = b'\202\323\344\223\002\201\001"7/namespaces/{namespace}/activities/update-options-by-id:\001*ZC">/api/v1/namespaces/{namespace}/activities/update-options-by-id:\001*'
    _WORKFLOWSERVICE.methods_by_name["PauseActivityById"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "PauseActivityById"
    ]._serialized_options = b'\202\323\344\223\002o"./namespaces/{namespace}/activities/pause-by-id:\001*Z:"5/api/v1/namespaces/{namespace}/activities/pause-by-id:\001*'
    _WORKFLOWSERVICE.methods_by_name["UnpauseActivityById"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "UnpauseActivityById"
    ]._serialized_options = b'\202\323\344\223\002s"0/namespaces/{namespace}/activities/unpause-by-id:\001*Z<"7/api/v1/namespaces/{namespace}/activities/unpause-by-id:\001*'
    _WORKFLOWSERVICE.methods_by_name["ResetActivityById"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "ResetActivityById"
    ]._serialized_options = b'\202\323\344\223\002o"./namespaces/{namespace}/activities/reset-by-id:\001*Z:"5/api/v1/namespaces/{namespace}/activities/reset-by-id:\001*'
    _WORKFLOWSERVICE._serialized_start = 170
    _WORKFLOWSERVICE._serialized_end = 16961

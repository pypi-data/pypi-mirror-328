...
{
  memset(strct,0,sizeof(${proto.namespace}_${packet.name}_t));
  %for field in packet.fields:
  %if field.isArray:
  strct->${field.name}.len = ${proto.namespace}_get${field.camel()}(packet, strct->${field.name}.data);
  %else:
  strct->${field.name} = ${proto.namespace}_get${field.camel()}(packet);
  %endif
  %endfor
}
...
void ${proto.namespace}_struct_build_${packet.name}_packet(${proto.namespace}_${packet.name}_t* strct, ${proto.namespace}_packet_t* packet)
{
  ...
  %if field.isArray:
    %if field.isString:
  ${proto.namespace}_set${field.camel()}(packet, strct->${field.name}.data);
    %else:
  ${proto.namespace}_set${field.camel()}(packet, strct->${field.name}.data, strct->${field.name}.len);
    %endif
  %else:
  ${proto.namespace}_set${field.camel()}(packet, strct->${field.name});
  %endif
  %endfor
} 
%endif
...
__attribute__((weak)) HandlerStatus_e ${proto.namespace}_${packet.camel()}_handler(${proto.namespace}_packet_t* ${proto.namespace}_${packet.name}, ${proto.namespace}_packet_t* ${proto.namespace}_${packet.response.name}_response)
%else:
__attribute__((weak)) HandlerStatus_e ${proto.namespace}_${packet.camel()}_handler(${proto.namespace}_packet_t* ${proto.namespace}_${packet.name}, ${proto.namespace}_packet_t* ${proto.namespace}_${packet.response.name})
%endif
%endif
{

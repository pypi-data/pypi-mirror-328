...
TRANSCODERS |= {
    ...
    "Data/Support/SupportArray/Identifier": TxtType(),
    ...
    "Data/Transmit/TxSequence/Identifier": TxtType(),
    ...
    "Data/Receive/Channel/Identifier": TxtType(),
...
TRANSCODERS |= {
    ...
    "Antenna/AntPattern/ElementGPId": TxtType(),

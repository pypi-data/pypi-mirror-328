...
import pytest
from src.lunar_snippets import Finding
...
class TestFinding():
    ...
    def test_description_finding(self, capsys):
        with Finding("test", "description") as f:
            f.assert_true(True)
    ...
    def test_description_not_in_finding(self, capsys):
        with Finding("test") as f:
            f.assert_true(True)
    ...
    def test_paths_in_finding(self, capsys):
        with Finding("test") as f:
            v = f.get(".const_false")
            f.assert_false(v)
    ...
    def test_paths_not_in_finding(self, capsys):
        with Finding("test") as f:
            f.assert_true(True)
    ...
    def test_simple_value_finding(self, capsys):
        ...
        captured = capsys.readouterr()
        result = json.loads(captured.out)["assertion_results"][0]
    ...
    def test_multiple_assertions_in_finding(self, capsys):
        ...
        captured = capsys.readouterr()
        results = json.loads(captured.out)["assertion_results"]

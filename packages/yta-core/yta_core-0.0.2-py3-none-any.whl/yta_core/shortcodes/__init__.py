...
class Shortcode(BaseShortcode):
    ...
    def duration(self, duration: Union[ShortcodeDuration, int, float, None]):
        if duration is None:
            duration = {
                ShortcodeTagType.SIMPLE: ShortcodeDuration.FILE_DURATION,
                ShortcodeTagType.BLOCK: ShortcodeDuration.SHORTCODE_CONTENT
            }[self.type]
    ...
    def to_enhancement_element(self, transcription: AudioTranscription):
        """

...
class _StringDuration(Enum):
    ...
    def to_numeric_value(
        ...
        """
        duration = {
            _StringDuration.SHORTCODE_CONTENT.name: _StringDuration.SHORTCODE_CONTENT.value,
            _StringDuration.FILE_DURATION.name: _StringDuration.FILE_DURATION.value,
            _StringDuration.SEGMENT_DURATION.name: _StringDuration.SEGMENT_DURATION.value
        }.get(duration, None)
...
class SegmentStringDuration(Enum):
    ...
    @staticmethod
    def to_numeric_value(duration: str):
        """
        Transform the provided string 'duration' parameter
        to its actual numeric value according to our Enum
        declaration, or raises an Exception if not valid.

...
class MsgSetBaseModel(_message.Message):
    __slots__ = ("creator", "model")
    CREATOR_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    creator: str
    model: str
    def __init__(self, creator: _Optional[str] = ..., model: _Optional[str] = ...) -> None: ...

class MsgSetBaseModelResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RejectApplication = channel.unary_unary(
                ...
                _registered_method=True)
        self.SetBaseModel = channel.unary_unary(
                '/neurion.fusion.Msg/SetBaseModel',
                request_serializer=neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModel.SerializeToString,
                response_deserializer=neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModelResponse.FromString,
                _registered_method=True)
...
class MsgServicer(object):
    ...
    def SetBaseModel(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetBaseModel': grpc.unary_unary_rpc_method_handler(
                    servicer.SetBaseModel,
                    request_deserializer=neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModel.FromString,
                    response_serializer=neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModelResponse.SerializeToString,
            ),
...
class Msg(object):
    ...
    def SetBaseModel(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/neurion.fusion.Msg/SetBaseModel',
            neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModel.SerializeToString,
            neurion_dot_fusion_dot_tx__pb2.MsgSetBaseModelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

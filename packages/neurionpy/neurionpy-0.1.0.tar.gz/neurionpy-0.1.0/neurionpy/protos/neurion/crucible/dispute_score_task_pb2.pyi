...
class DisputeScoreTask(_message.Message):
    __slots__ = ("id", "creator", "submission_id", "proposed_score", "deposit", "result", "created_timestamp", "decision_timestamp", "accepting_dispute_scorers", "rejecting_dispute_scorers")

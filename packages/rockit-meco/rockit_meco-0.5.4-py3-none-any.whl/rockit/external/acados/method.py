...
class AcadosMethod(ExternalMethod):
    ...
    def transcribe_phase2(self, stage, **kwargs):
        ...
        if platform.system() == "Darwin":
            subprocess.run(["otool","-L","/Users/runner/work/impact-2025/impact-2025/build_acados_rockit/lib/libacados_driver.dylib"])
            subprocess.run(["otool","-L","/Users/runner/work/impact-2025/impact-2025/build_acados_rockit/lib/libacados.dylib"])
            subprocess.run(["otool","-L","/Users/runner/work/impact-2025/impact-2025/build_acados_rockit/lib/libblasfeo.dylib"])
            subprocess.run(["otool","-L","/Users/runner/work/impact-2025/impact-2025/build_acados_rockit/lib/libhpipm.dylib"])

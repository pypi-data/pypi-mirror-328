...
class StitcherAxisParams(qt.QWidget):
    ...
    def __init__(self, axis, parent=None) -> None:
        ...
        self._shiftSearchMethodCB = qt.QComboBox(self)
        # shift algorithm
        ...
        for method in axis_0_shift_search_method:
        ...
        self._windowSizeSB = qt.QSpinBox(self)
    ...
    def setShiftSearchMethod(self, method: Union[StitchShiftAlgorithm, str]) -> None:
...
class _FilteringGroupBox(qt.QGroupBox):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._lowPassFilterSP = qt.QSpinBox(self)
        self.layout().addRow("low pass filter", self._lowPassFilterSP)

        self._highPassFilterSP = qt.QSpinBox(self)

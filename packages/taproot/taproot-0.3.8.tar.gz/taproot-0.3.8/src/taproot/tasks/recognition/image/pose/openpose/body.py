# type: ignore
# Adapted from https://github.com/patrickvonplaten/controlnet_aux/blob/master/src/controlnet_aux/open_pose/body.py
import math
...
from .util import smart_resize, smart_resize_k, padRightDownCorner

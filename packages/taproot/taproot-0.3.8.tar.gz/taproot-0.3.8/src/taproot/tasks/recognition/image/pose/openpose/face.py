# type: ignore
# Adapted from https://github.com/patrickvonplaten/controlnet_aux/blob/master/src/controlnet_aux/open_pose/face.py
import numpy as np
import torch
...
class Face(object):
    ...
    def __call__(self, face_img):
        ...
        w_size = 384
        x_data = (
            torch.from_numpy(smart_resize(face_img, (w_size, w_size))).permute(
                [2, 0, 1]
            )
            / 256.0
            - 0.5
        ...
        x_data = x_data.to(device, dtype=self.dtype)

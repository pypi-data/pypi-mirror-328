...
__all__ = ["WhisperMediumModel"]

class WhisperMediumModel(WhisperModel):
    """
    Inference model for the Whisper Medium model.
    """
    model_url: Optional[str] = "https://huggingface.co/benjamin-paine/taproot-common/resolve/main/audio-transcription-whisper-medium.safetensors"
    ...
    def get_generation_config(cls) -> Optional[Dict[str, Any]]:
        """
        Get the default configuration for generation.
        """
        return {

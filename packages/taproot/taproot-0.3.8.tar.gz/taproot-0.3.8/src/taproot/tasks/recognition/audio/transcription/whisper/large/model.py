...
class WhisperLargeV3Model(WhisperModel):
    """
    Inference model for the Whisper Large V3 model.
    """
    model_url: Optional[str] = "https://huggingface.co/benjamin-paine/taproot-common/resolve/main/audio-transcription-whisper-large-v3.fp16.safetensors"

...
__all__ = ["WhisperBaseModel"]


class WhisperBaseModel(WhisperModel):
    """
    Inference model for the Whisper Base model.
    """
    model_url: Optional[str] = "https://huggingface.co/benjamin-paine/taproot-common/resolve/main/audio-transcription-whisper-base.safetensors"

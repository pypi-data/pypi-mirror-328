# type: ignore
# Adapted from https://raw.githubusercontent.com/patrickvonplaten/controlnet_aux/master/src/controlnet_aux/pidi/model.py
"""
...
def createConvFunc(op_type):
    ...
    if op_type == "cd":
        ...
        def func(x, weights, bias=None, stride=1, padding=0, dilation=1, groups=1):
            ...
            shape = weights.shape
            buffer = torch.zeros(shape[0], shape[1], 5 * 5).to(weights.device, dtype=weights.dtype)
            weights = weights.view(shape[0], shape[1], -1)

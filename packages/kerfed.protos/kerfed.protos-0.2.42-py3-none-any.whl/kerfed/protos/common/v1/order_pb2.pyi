...
class Order(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "billing", b"billing", "date_created", b"date_created", "date_modified", b"date_modified", "lines", b"lines", "models", b"models", "order_id", b"order_id", "parcels", b"parcels", "parts", b"parts", "shipping", b"shipping", "shop_id", b"shop_id", "state", b"state", "total", b"total"]) -> None: ...
...
class OrderState(google.protobuf.message.Message):
    ...
    @property
    def events(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___OrderEvent.ValueType]:
    ...
    def __init__(
        self,
        *,
        events: collections.abc.Iterable[global___OrderEvent.ValueType] | None = ...,
        is_processing: builtins.bool = ...,
        is_paid: builtins.bool = ...,
    ) -> None: ...

...
class PostalAddress(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "address_lines", b"address_lines", "city", b"city", "country", b"country", "email", b"email", "latitude", b"latitude", "longitude", b"longitude", "phone", b"phone", "place_id", b"place_id", "postal_code", b"postal_code", "recipient", b"recipient", "region", b"region"]) -> None: ...

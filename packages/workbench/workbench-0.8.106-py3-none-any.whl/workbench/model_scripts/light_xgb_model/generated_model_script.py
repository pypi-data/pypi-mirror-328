...
TEMPLATE_PARAMS = {
    ...
    "feature_list": ['alcohol', 'malic_acid', 'ash', 'alcalinity_of_ash', 'magnesium', 'total_phenols', 'flavanoids', 'nonflavanoid_phenols', 'proanthocyanins', 'color_intensity', 'hue', 'od280_od315_of_diluted_wines', 'proline', 'auto_id'],
    "model_metrics_s3_path": "s3://sandbox-sageworks-artifacts/models/training/wine-classification",

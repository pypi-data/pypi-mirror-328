...
@jsii.enum(jsii_type="@cdklabs/aws-data-solutions-framework.utils.PermissionModel")
class PermissionModel(enum.Enum):
...
class Utils(
    ...
    @jsii.member(jsii_name="getCdkDeploymentRole")
    @builtins.classmethod
    def get_cdk_deployment_role(
        cls,
        scope: _constructs_77d1e7e8.Construct,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__61d7e80dc5c568bd1b5404ffae65ead4fde0a26d164eb8ba21e238544d0102d8)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast(_aws_cdk_aws_iam_ceddda9d.IRole, jsii.sinvoke(cls, "getCdkDeploymentRole", [scope]))
...
def _typecheckingstub__61d7e80dc5c568bd1b5404ffae65ead4fde0a26d164eb8ba21e238544d0102d8(
    scope: _constructs_77d1e7e8.Construct,
) -> None:
    """Type checking stubs"""
    pass

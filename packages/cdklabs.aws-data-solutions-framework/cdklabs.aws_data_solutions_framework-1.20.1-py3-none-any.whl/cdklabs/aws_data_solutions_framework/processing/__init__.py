...
class SparkJob(
    ...
    def _emr_job_log_group(
        ...
        jsii.set(self, "emrJobLogGroup", value) # pyright: ignore[reportArgumentType]
    ...
    def _s3_log_bucket(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "s3LogBucket", value) # pyright: ignore[reportArgumentType]
    ...
    def state_machine(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "stateMachine", value) # pyright: ignore[reportArgumentType]
...
class SparkEmrServerlessJob(
    ...
    def spark_job_execution_role(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "sparkJobExecutionRole", value) # pyright: ignore[reportArgumentType]

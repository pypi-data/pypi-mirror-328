...
class Heatmap(_BaseTraceType):
    ...
    @property
    def xgap(self) -> int | float: ...
    @xgap.setter
    def xgap(self, val: int | float) -> None: ...
    @property
    ...
    @property
    def ygap(self) -> int | float: ...
    @ygap.setter
    def ygap(self, val: int | float) -> None: ...
    @property
    ...
    @property
    def zsmooth(self) -> str | bool: ...
    @zsmooth.setter
    def zsmooth(self, val: str | bool) -> None: ...
    @property
    def zsrc(self) -> str: ...
    @zsrc.setter

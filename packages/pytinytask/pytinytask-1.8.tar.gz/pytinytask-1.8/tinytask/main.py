...
image_play = ctk.CTkImage(light_image=Image.open("src/play2.png"), size=(30, 30))
image_stop = ctk.CTkImage(light_image=Image.open("src/stop2.png"), size=(30, 30))
image_replay = ctk.CTkImage(light_image=Image.open("src/replay2.png"), size=(30, 30))
image_x = ctk.CTkImage(light_image=Image.open("src/x2.png"), size=(30, 30))
...
exit_button = ctk.CTkButton(app, text="", image=image_x, fg_color="red", width=30, height=30, command=app.quit)

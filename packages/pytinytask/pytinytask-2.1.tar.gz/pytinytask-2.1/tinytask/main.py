...
image_play = ctk.CTkImage(light_image=Image.open("play2.png"), size=(30, 30))
image_stop = ctk.CTkImage(light_image=Image.open("stop2.png"), size=(30, 30))
image_replay = ctk.CTkImage(light_image=Image.open("replay2.png"), size=(30, 30))
image_exit = ctk.CTkImage(light_image=Image.open("x2.png"), size=(30, 30))

...
def test_remote_hco_key_admin_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
    set -x
...
def test_remote_hco_ls_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_jsonf_go_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_useradd_newuser_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_userdel_newuser_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_useradd_hello_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_validate_basic_hello_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_role_ls_as_admin(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_validate_basic_hello_as_hello_user_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_ls_as_hello_user(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_useradd_yehaw_as_hello_user_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_userdel_hello_as_hello_user_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_validate_basic_hello_as_hello_admin_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_ls_as_hello_admin_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_useradd_yehaw_as_hello_admin_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash
...
def test_remote_hco_userdel_hello_as_hello_admin_role(gunicorn_server_remote_auth, cleanup):
    hello = """
    #!/bin/bash

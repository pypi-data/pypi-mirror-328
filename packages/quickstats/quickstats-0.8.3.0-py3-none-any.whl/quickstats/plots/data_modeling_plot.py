...
class DataModelingPlot(HistogramPlot):
    ...
    def resolve_plot_options(
        ...
        plot_options = {}
        domain = 'ANALYTIC' if self.analytic_model else 'BINNED'
        default_plot_format = self.get_target_config('plot_format', domain)
        default_error_format = self.get_target_config('error_format', domain)

...
def set_organization_hard_limit(option_list: list):
    organization = None
    limit_id = None
    hard_limit = None
    ...
    if not (organization and limit_id and hard_limit):
        raise MissingRequirementException("Cannot set hard limit for organization without organization ID, limit ID and hard limit value")
...
set_organization_hard_limit_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_HARD_LIMIT_OPTION,
]
...
def set_organization_soft_limit(option_list: list):
    organization = None
    limit_id = None
    soft_limit = None
    ...
    if not (organization and limit_id and soft_limit):
        raise MissingRequirementException("Cannot set soft limit for organization without organization ID, limit ID and soft limit value")
...
set_organization_soft_limit_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_SOFT_LIMIT_OPTION,
]
...
def set_organization_renewal_status(option_list: list):
    organization = None
    limit_id = None
    renewal_status = None
    ...
    if not (organization and limit_id and renewal_status):
        raise MissingRequirementException("Cannot set renewal status for organization without organization ID, limit ID and renewal status value")
...
set_organization_renewal_status_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_RENEWAL_STATUS_OPTION
]
...
def set_project_hard_limit(option_list: list):
    organization = None
    project = None
    limit_id = None
    hard_limit = None
    ...
    if not (organization and project and limit_id and hard_limit):
        raise MissingRequirementException("Cannot set hard limit for project without organization ID, project ID, limit ID and hard limit value")
...
set_project_hard_limit_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_HARD_LIMIT_OPTION,
]
...
def set_project_soft_limit(option_list: list):
    organization = None
    project = None
    limit_id = None
    soft_limit = None
    ...
    if not (organization and project and limit_id and soft_limit):
        raise MissingRequirementException("Cannot set soft limit for project without organization ID, project ID, limit ID and soft limit value")
...
set_project_soft_limit_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_SOFT_LIMIT_OPTION,
]
...
def set_project_renewal_status(option_list: list):
    organization = None
    project = None
    limit_id = None
    renewal_status = None
    ...
    if not (organization and project and limit_id and renewal_status):
        raise MissingRequirementException("Cannot set renewal status for project without organization ID, project ID, limit ID and renewal status value")
...
set_project_renewal_status_options = [
    ORGANIZATION_OPTION,
    USAGE_LIMIT_ID_OPTION,
    USAGE_LIMIT_RENEWAL_STATUS_OPTION
]
...
usage_limit_commands = [
    ...
    Command(
        "set_organization_hard_limit",
        ["set-organization-hard-limit", "set-org-hard-lim"],
        "Set organization hard limit",
        set_organization_hard_limit,
        ArgumentsEnum.REQUIRED,
        [],
        set_organization_hard_limit_options
    ...
    Command(
        "set_organization_soft_limit",
        ["set-organization-soft-limit", "set-org-soft-lim"],
        "Set organization soft limit",
        set_organization_soft_limit,
        ArgumentsEnum.REQUIRED,
        [],
        set_organization_soft_limit_options
    ...
    Command(
        "set_organization_renewal_status",
        ["set-organization-renewal-status", "set-org-ren-stat"],
        "Set organization renewal status",
        set_organization_renewal_status,
        ArgumentsEnum.REQUIRED,
        [],
        set_organization_renewal_status_options
    ...
    Command(
        "set_project_hard_limit",
        ["set-project-hard-limit", "set-proj-hard-lim"],
        "Set project hard limit",
        set_project_hard_limit,
        ArgumentsEnum.REQUIRED,
        [],
        set_project_hard_limit_options
    ...
    Command(
        "set_project_soft_limit",
        ["set-project-soft-limit", "set-proj-soft-lim"],
        "Set project soft limit",
        set_project_soft_limit,
        ArgumentsEnum.REQUIRED,
        [],
        set_project_soft_limit_options
    ...
    Command(
        "set_project_renewal_status",
        ["set-project-renewal-status", "set-proj-ren-stat"],
        "Set project renewal status",
        set_project_renewal_status,
        ArgumentsEnum.REQUIRED,
        [],
        set_project_renewal_status_options

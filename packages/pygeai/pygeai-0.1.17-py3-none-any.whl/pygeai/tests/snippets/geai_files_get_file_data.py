...
file = File(id="666616c1-ccbe-41fc-9035-9d46fe395f25")

file_manager = FileManager()

response = file_manager.get_file_data(organization_id=organization.id, project_id=project.id, file_id=file.id)
print(response)

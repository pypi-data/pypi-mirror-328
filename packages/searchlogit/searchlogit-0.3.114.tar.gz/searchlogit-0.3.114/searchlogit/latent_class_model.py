...
# {
    ...
    def setup(self, X, y, varnames=None, alts=None, isvars=None, num_classes=2,
            ...
            validation=False, mnl_init=True):
    # {
        ...
        # {
            ...
            # {
                ...
                mnl = misc.setup_logit(i, mnl, X, y, varnames, self.class_params_spec, avail,alts, transvars, gtol)
    ...
    # {
        ...
        self.varnames = np.array(self.class_params_spec[i])
    # }
    ...
    # {
        ...
        class_thetas_sd = np.repeat(.01, class_thetas.size)
        log_lik_old, log_lik_new = -1E10, -1E10
        iter, max_iter = 0, 100 #TODO add this as an argument
        terminate, converged = False, False
        self.H = None
        while not terminate and iter < max_iter:
        # {
            ...
            terminate = (log_lik_new - log_lik_old) < self.ftol_lccm
            log_lik_old = log_lik_new
            iter += 1

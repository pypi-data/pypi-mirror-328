...
class Schema(base.SchemaABC, metaclass=SchemaMeta):
    ...
    .. versionchanged:: 2.0.0
        ...
        `NValidator.decorators.validates_schema`,
        `NValidator.decorators.pre_load` and `NValidator.decorators.post_dump`.
    ...
    class Meta:
        ...
        - ``unknown``: Whether to exclude, include, or raise an error for unknown
            fields in the data. Use `EXCLUDE`, `INCLUDE` or `RAISE`.
        - ``register``: Whether to register the `Schema` with NValidator's internal
    ...
    def dump(self, obj: typing.Any, *, many: bool | None = None):
        ...
        .. versionchanged:: 3.0.0b7
            ...
            A :exc:`ValidationError <NValidator.exceptions.ValidationError>` is raised
            if ``obj`` is invalid.
        .. versionchanged:: 3.0.0rc9

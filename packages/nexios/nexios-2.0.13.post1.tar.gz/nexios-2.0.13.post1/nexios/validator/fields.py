...
from .warnings import RemovedInNValidator4Warning
...
class Field(FieldABC):
    ...
    #: :exc:`NValidator.exceptions.ValidationError`.
    ...
    def get_value(self, obj, attr, accessor=None, default=missing_):
        ...
        :param callable accessor: A callable used to retrieve the value of `attr` from
            the object `obj`. Defaults to `NValidator.utils.get_value`.
        """
    ...
    def fail(self, key: str, **kwargs):
        ...
        .. deprecated:: 3.0.0
            Use `make_error <NValidator.fields.Field.make_error>` instead.
        """
        warnings.warn(
    ...
    def _bind_to_schema(self, field_name, schema):
        ...
        :meth:`Schema._bind_field <NValidator.Schema._bind_field>`.
...
class Nested(Field):
    """Allows you to nest a :class:`Schema <NValidator.Schema>`
    inside a field.
    ...
    When passing a `Schema <NValidator.Schema>` instance as the first argument,
    ...
    you should pass a `Schema <NValidator.Schema>` class (not an instance) as the first argument.
...
class Pluck(Nested):
    ...
    Example: ::
        ...
        from NValidator import Schema, fields
    ...
    def __init__(self, tuple_fields, *args, **kwargs):
        ...
        try:
            ...
            raise ValueError(
                ...
                "instances of NValidator.base.FieldABC."
            ) from error
...
class Boolean(Field):
    ...
    :param truthy: Values that will (de)serialize to `True`. If an empty
        ...
        `NValidator.fields.Boolean.truthy` will be used.
    :param falsy: Values that will (de)serialize to `False`. If `None`,
        `NValidator.fields.Boolean.falsy` will be used.
    :param kwargs: The same keyword arguments that :class:`Field` receives.
    """

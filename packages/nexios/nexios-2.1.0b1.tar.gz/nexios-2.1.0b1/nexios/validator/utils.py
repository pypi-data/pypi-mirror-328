"""Utility methods for NValidator."""
...
def pprint(obj, *args, **kwargs) -> None:
    ...
    :meth:`NValidator.Schema.dump`.

    .. deprecated:: 3.7.0
        NValidator.pprint will be removed in NValidator 4.
    """
    warnings.warn(
        "NValidator's pprint function is deprecated and will be removed in NValidator 4.",
...
def get_value(obj, key: int | str, default=missing):
    ...
    .. warning::
        ...
        `NValidator.fields.Field.get_value` in this case.
    """
...
def resolve_field_instance(cls_or_instance):
    ...
    :param type|Schema cls_or_instance: NValidator Schema class or instance.
    """

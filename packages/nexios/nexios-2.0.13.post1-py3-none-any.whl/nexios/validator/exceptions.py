"""Exception classes for NValidator-related errors."""
...
class NValidatorError(Exception):
    """Base class for all NValidator-related errors."""


class ValidationError(NValidatorError):
...
class StringNotCollectionError(NValidatorError, TypeError):
    """Raised when a string is passed when a list of strings is expected."""


class FieldInstanceResolutionError(NValidatorError, TypeError):

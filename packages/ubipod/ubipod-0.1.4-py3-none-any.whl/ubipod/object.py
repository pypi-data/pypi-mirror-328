...
class Decor:
    ...
    mass: int = 0
    inertiaMatDiag: vec3 = field(default_factory=vec3_new)
    resistance: int = 0
    friction: int = 0
    contacts: list[Contact] = field(default_factory=list)

    def read(self, read: PbdfReader, has_textures: bool = False) -> None:
    ...
    def write(self, write: PbdfWriter) -> None:
        ...
        write.i32(self.mass)
        write.vec3(self.inertiaMatDiag)

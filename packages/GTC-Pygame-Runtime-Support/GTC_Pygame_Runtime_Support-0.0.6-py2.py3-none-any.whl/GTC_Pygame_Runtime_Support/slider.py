...
class HorizontalSlider(BasicSlider):
    ...
    def operate(self, mouse_pos, mouse_press):
        ...
        pygame.draw.circle(self._screen, self.movable_color, (self._size[1] // 2 + self.slide_pos + self._pos[0], self._size[1] // 2 + self._pos[1]), self.movable_radium)
...
class VerticalSlider(BasicSlider):
    ...
    def operate(self, mouse_pos, mouse_press):
        ...
        self.percent = self.slide_pos - (self.slide_range[1] - self.slide_range[0])
        self._screen.blit(self.surface, self._pos)
        pygame.draw.circle(self._screen, self.movable_color, (self._size[0] // 2 + self._pos[0], self._size[0] // 2 + self.slide_pos + self._pos[1]), self.movable_radium)

...
class AprilTagField:
    ...
    Members:
      ...
      kNumFields
    """
    __members__: typing.ClassVar[dict[str, AprilTagField]]  # value = {'k2022RapidReact': <AprilTagField.k2022RapidReact: 0>, 'k2023ChargedUp': <AprilTagField.k2023ChargedUp: 1>, 'k2024Crescendo': <AprilTagField.k2024Crescendo: 2>, 'k2025ReefscapeAndyMark': <AprilTagField.k2025ReefscapeAndyMark: 3>, 'k2025ReefscapeWelded': <AprilTagField.k2025ReefscapeWelded: 4>, 'kDefaultField': <AprilTagField.k2025ReefscapeWelded: 4>, 'kNumFields': <AprilTagField.kNumFields: 5>}
    ...
    k2025ReefscapeAndyMark: typing.ClassVar[AprilTagField]  # value = <AprilTagField.k2025ReefscapeAndyMark: 3>
    k2025ReefscapeWelded: typing.ClassVar[AprilTagField]  # value = <AprilTagField.k2025ReefscapeWelded: 4>
    kDefaultField: typing.ClassVar[AprilTagField]  # value = <AprilTagField.k2025ReefscapeWelded: 4>
    kNumFields: typing.ClassVar[AprilTagField]  # value = <AprilTagField.kNumFields: 5>
    @staticmethod
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...

...
class KIEState(BaseModel):
    ...
    # TODO(nancy): Instead of writing the table to the cache to support ai_query,
    # we can create an in memory temp view with a spark dataframe. See eval for an example.
    # We should ensure that ai_query team tests temp views reliably to prevent regressions.

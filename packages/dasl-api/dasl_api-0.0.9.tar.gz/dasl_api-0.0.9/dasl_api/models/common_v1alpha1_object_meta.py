...
class CommonV1alpha1ObjectMeta(BaseModel):
    ...
    uid: Optional[StrictStr] = Field(default=None, description="A unique identifier for this resource, allocated by the server.")
    ...
    __properties: ClassVar[List[str]] = ["name", "workspace", "comment", "annotations", "createdTimestamp", "createdBy", "modifiedTimestamp", "modifiedBy", "uid", "version", "deleted", "resourceStatus", "uiStatus"]

...
class CoreV1alpha1DataSourceFieldUtilsUnreferencedColumns(BaseModel):
    ...
    """ # noqa: E501
    preserve: Optional[StrictBool] = Field(default=None, description="Indicates whether columns not referenced in the FieldSpecs should be preserved in the output. This only applies to the name in the \"from\" attribute. ")

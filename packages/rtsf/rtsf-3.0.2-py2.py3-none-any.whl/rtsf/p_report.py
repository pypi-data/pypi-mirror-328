...
logger = AppLog(logger_name="rtsf.p_report").get_logger()
    ...
    def get_summary(list_all=[], **kwargs):
        ...
        for module in list_all:
            ...
            try:
                ...
                logger.warning("Will set 'start_at' and 'end_at' to 'None'")
            ...
            if summary["fail_cases_num"] > 0:
                summary["dict_report"] = {
                    "result": 0,
                    "message": "failure",
                    "pass": summary["pass_cases_num"],
                    "fail": summary["fail_cases_num"]
                }
            else:
                summary["dict_report"] = {
                    "result": 1,

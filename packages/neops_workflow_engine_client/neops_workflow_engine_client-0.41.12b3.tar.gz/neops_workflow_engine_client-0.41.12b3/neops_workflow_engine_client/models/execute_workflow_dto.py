...
class ExecuteWorkflowDto(BaseModel):
    ...
    parameters: Optional[WorkflowExecutionParameters] = None
    __properties: ClassVar[List[str]] = ["workflowId", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": WorkflowExecutionParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj

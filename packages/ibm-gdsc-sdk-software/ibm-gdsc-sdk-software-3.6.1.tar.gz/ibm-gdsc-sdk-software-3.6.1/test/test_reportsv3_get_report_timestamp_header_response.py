...
class TestReportsv3GetReportTimestampHeaderResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Reportsv3GetReportTimestampHeaderResponse:
        """Test Reportsv3GetReportTimestampHeaderResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3GetReportTimestampHeaderResponse`
        """
    ...
    def testReportsv3GetReportTimestampHeaderResponse(self):
        """Test Reportsv3GetReportTimestampHeaderResponse"""

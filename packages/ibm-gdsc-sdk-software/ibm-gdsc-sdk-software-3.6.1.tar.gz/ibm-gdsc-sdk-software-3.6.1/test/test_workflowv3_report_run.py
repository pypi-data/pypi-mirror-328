...
class TestWorkflowv3ReportRun(unittest.TestCase):
    """Workflowv3ReportRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3ReportRun:
        """Test Workflowv3ReportRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3ReportRun`
        """
        model = Workflowv3ReportRun()
        if include_optional:
            return Workflowv3ReportRun(
    ...
    def testWorkflowv3ReportRun(self):
        """Test Workflowv3ReportRun"""

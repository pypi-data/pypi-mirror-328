...
class TestAuditv3PutActivityRecordResponse(unittest.TestCase):
    """Auditv3PutActivityRecordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Auditv3PutActivityRecordResponse:
        ...
        """
        model = Auditv3PutActivityRecordResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testAuditv3PutActivityRecordResponse(self):
        """Test Auditv3PutActivityRecordResponse"""

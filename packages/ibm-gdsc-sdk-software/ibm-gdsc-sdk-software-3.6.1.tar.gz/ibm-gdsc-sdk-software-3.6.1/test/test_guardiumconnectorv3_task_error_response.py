...
class TestGuardiumconnectorv3TaskErrorResponse(unittest.TestCase):
    """Guardiumconnectorv3TaskErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3TaskErrorResponse:
        """Test Guardiumconnectorv3TaskErrorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Guardiumconnectorv3TaskErrorResponse`
        """
        model = Guardiumconnectorv3TaskErrorResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testGuardiumconnectorv3TaskErrorResponse(self):
        """Test Guardiumconnectorv3TaskErrorResponse"""

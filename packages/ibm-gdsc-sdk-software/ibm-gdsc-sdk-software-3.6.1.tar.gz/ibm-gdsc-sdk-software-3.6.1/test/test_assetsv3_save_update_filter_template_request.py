...
class TestAssetsv3SaveUpdateFilterTemplateRequest(unittest.TestCase):
    """Assetsv3SaveUpdateFilterTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Assetsv3SaveUpdateFilterTemplateRequest:
        """Test Assetsv3SaveUpdateFilterTemplateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Assetsv3SaveUpdateFilterTemplateRequest`
        """
        model = Assetsv3SaveUpdateFilterTemplateRequest()
        if include_optional:
            return Assetsv3SaveUpdateFilterTemplateRequest(
                is_default = True,
                template = ibm_gdsc_sdk_software.models.assetsv3_filter_template.assetsv3FilterTemplate(
                    colummns_list = [
    ...
    def testAssetsv3SaveUpdateFilterTemplateRequest(self):
        """Test Assetsv3SaveUpdateFilterTemplateRequest"""

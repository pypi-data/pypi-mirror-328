...
class TestWorkflowv3CreateTaskRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Workflowv3CreateTaskRequest:
        """Test Workflowv3CreateTaskRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3CreateTaskRequest`
        """
        model = Workflowv3CreateTaskRequest()
        if include_optional:
    ...
    def testWorkflowv3CreateTaskRequest(self):
        """Test Workflowv3CreateTaskRequest"""

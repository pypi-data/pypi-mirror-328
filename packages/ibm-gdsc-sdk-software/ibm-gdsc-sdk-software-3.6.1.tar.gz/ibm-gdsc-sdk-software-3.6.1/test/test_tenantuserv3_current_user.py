...
class TestTenantuserv3CurrentUser(unittest.TestCase):
    """Tenantuserv3CurrentUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Tenantuserv3CurrentUser:
        """Test Tenantuserv3CurrentUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Tenantuserv3CurrentUser`
        """
        model = Tenantuserv3CurrentUser()
        if include_optional:
            return Tenantuserv3CurrentUser(
    ...
    def testTenantuserv3CurrentUser(self):
        """Test Tenantuserv3CurrentUser"""

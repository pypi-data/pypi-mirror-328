...
class TestTenantuserv3Tenant(unittest.TestCase):
    """Tenantuserv3Tenant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Tenantuserv3Tenant:
        """Test Tenantuserv3Tenant
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Tenantuserv3Tenant`
        """
        model = Tenantuserv3Tenant()
        if include_optional:
            return Tenantuserv3Tenant(
    ...
    def testTenantuserv3Tenant(self):
        """Test Tenantuserv3Tenant"""

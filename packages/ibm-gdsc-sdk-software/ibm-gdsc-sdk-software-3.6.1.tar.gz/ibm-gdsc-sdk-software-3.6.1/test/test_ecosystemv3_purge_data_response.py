...
class TestEcosystemv3PurgeDataResponse(unittest.TestCase):
    """Ecosystemv3PurgeDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ecosystemv3PurgeDataResponse:
        """Test Ecosystemv3PurgeDataResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ecosystemv3PurgeDataResponse`
        """
        model = Ecosystemv3PurgeDataResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testEcosystemv3PurgeDataResponse(self):
        """Test Ecosystemv3PurgeDataResponse"""

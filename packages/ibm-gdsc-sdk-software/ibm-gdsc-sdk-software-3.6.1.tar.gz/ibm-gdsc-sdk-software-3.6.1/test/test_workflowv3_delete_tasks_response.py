...
class TestWorkflowv3DeleteTasksResponse(unittest.TestCase):
    """Workflowv3DeleteTasksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3DeleteTasksResponse:
        """Test Workflowv3DeleteTasksResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3DeleteTasksResponse`
        """
        model = Workflowv3DeleteTasksResponse()
        if include_optional:
            return Workflowv3DeleteTasksResponse(
                deleted = '',
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testWorkflowv3DeleteTasksResponse(self):
        """Test Workflowv3DeleteTasksResponse"""

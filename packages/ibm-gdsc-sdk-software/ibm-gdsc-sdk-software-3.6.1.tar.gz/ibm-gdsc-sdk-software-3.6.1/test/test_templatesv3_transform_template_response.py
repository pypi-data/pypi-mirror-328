...
class TestTemplatesv3TransformTemplateResponse(unittest.TestCase):
    """Templatesv3TransformTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3TransformTemplateResponse:
        """Test Templatesv3TransformTemplateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3TransformTemplateResponse`
        """
        model = Templatesv3TransformTemplateResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3TransformTemplateResponse(self):
        """Test Templatesv3TransformTemplateResponse"""

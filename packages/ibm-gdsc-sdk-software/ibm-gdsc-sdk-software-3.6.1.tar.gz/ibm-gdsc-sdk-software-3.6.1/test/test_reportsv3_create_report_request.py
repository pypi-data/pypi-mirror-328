...
class TestReportsv3CreateReportRequest(unittest.TestCase):
    """Reportsv3CreateReportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsv3CreateReportRequest:
        """Test Reportsv3CreateReportRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3CreateReportRequest`
        """
        model = Reportsv3CreateReportRequest()
        if include_optional:
            return Reportsv3CreateReportRequest(
    ...
    def testReportsv3CreateReportRequest(self):
        """Test Reportsv3CreateReportRequest"""

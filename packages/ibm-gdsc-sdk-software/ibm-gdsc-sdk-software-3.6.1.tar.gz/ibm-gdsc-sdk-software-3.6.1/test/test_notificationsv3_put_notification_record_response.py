...
class TestNotificationsv3PutNotificationRecordResponse(unittest.TestCase):
    """Notificationsv3PutNotificationRecordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Notificationsv3PutNotificationRecordResponse:
        """Test Notificationsv3PutNotificationRecordResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Notificationsv3PutNotificationRecordResponse`
        """
        model = Notificationsv3PutNotificationRecordResponse()
        if include_optional:
            return Notificationsv3PutNotificationRecordResponse(
                result = '',
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testNotificationsv3PutNotificationRecordResponse(self):
        """Test Notificationsv3PutNotificationRecordResponse"""

...
class TestTemplatesv3GetTemplatesResponse(unittest.TestCase):
    """Templatesv3GetTemplatesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3GetTemplatesResponse:
        """Test Templatesv3GetTemplatesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3GetTemplatesResponse`
        """
        model = Templatesv3GetTemplatesResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3GetTemplatesResponse(self):
        """Test Templatesv3GetTemplatesResponse"""

...
class TestComplianceacceleratorv3WorkspaceCreationStatus(unittest.TestCase):
    ...
    def testComplianceacceleratorv3WorkspaceCreationStatus(self):
        """Test Complianceacceleratorv3WorkspaceCreationStatus"""
        # inst = Complianceacceleratorv3WorkspaceCreationStatus()

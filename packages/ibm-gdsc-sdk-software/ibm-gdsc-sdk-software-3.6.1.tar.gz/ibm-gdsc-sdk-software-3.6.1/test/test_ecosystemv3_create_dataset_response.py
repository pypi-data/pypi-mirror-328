...
class TestEcosystemv3CreateDatasetResponse(unittest.TestCase):
    """Ecosystemv3CreateDatasetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ecosystemv3CreateDatasetResponse:
        """Test Ecosystemv3CreateDatasetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ecosystemv3CreateDatasetResponse`
        """
        model = Ecosystemv3CreateDatasetResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testEcosystemv3CreateDatasetResponse(self):
        """Test Ecosystemv3CreateDatasetResponse"""

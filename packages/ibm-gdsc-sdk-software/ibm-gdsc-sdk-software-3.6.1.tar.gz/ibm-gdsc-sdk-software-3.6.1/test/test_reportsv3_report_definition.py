...
class TestReportsv3ReportDefinition(unittest.TestCase):
    """Reportsv3ReportDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsv3ReportDefinition:
        """Test Reportsv3ReportDefinition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3ReportDefinition`
        """
        model = Reportsv3ReportDefinition()
        if include_optional:
            return Reportsv3ReportDefinition(
                category_id = '',
    ...
    def testReportsv3ReportDefinition(self):
        """Test Reportsv3ReportDefinition"""

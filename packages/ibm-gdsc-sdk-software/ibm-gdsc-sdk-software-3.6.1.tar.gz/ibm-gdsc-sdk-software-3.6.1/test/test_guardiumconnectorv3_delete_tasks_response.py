...
class TestGuardiumconnectorv3DeleteTasksResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3DeleteTasksResponse:
        """Test Guardiumconnectorv3DeleteTasksResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Guardiumconnectorv3DeleteTasksResponse`
        """
    ...
    def testGuardiumconnectorv3DeleteTasksResponse(self):
        """Test Guardiumconnectorv3DeleteTasksResponse"""

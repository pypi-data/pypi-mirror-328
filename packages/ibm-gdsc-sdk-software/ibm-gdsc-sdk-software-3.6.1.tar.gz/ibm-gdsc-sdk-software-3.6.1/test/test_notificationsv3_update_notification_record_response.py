...
class TestNotificationsv3UpdateNotificationRecordResponse(unittest.TestCase):
    """Notificationsv3UpdateNotificationRecordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Notificationsv3UpdateNotificationRecordResponse:
        """Test Notificationsv3UpdateNotificationRecordResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Notificationsv3UpdateNotificationRecordResponse`
        """
        model = Notificationsv3UpdateNotificationRecordResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testNotificationsv3UpdateNotificationRecordResponse(self):
        """Test Notificationsv3UpdateNotificationRecordResponse"""

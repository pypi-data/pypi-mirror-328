...
class TestGroupbuilderv3GetGroupMembersResponse(unittest.TestCase):
    """Groupbuilderv3GetGroupMembersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Groupbuilderv3GetGroupMembersResponse:
        """Test Groupbuilderv3GetGroupMembersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Groupbuilderv3GetGroupMembersResponse`
        """
        model = Groupbuilderv3GetGroupMembersResponse()
        if include_optional:
    ...
    def testGroupbuilderv3GetGroupMembersResponse(self):
        """Test Groupbuilderv3GetGroupMembersResponse"""

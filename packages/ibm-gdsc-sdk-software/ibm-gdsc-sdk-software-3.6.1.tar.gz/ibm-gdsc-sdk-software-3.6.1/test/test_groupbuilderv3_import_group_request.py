...
class TestGroupbuilderv3ImportGroupRequest(unittest.TestCase):
    """Groupbuilderv3ImportGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Groupbuilderv3ImportGroupRequest:
        """Test Groupbuilderv3ImportGroupRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Groupbuilderv3ImportGroupRequest`
        """
        model = Groupbuilderv3ImportGroupRequest()
        if include_optional:
            return Groupbuilderv3ImportGroupRequest(
                central_manager_id = '',
                groups = [
    ...
    def testGroupbuilderv3ImportGroupRequest(self):
        """Test Groupbuilderv3ImportGroupRequest"""

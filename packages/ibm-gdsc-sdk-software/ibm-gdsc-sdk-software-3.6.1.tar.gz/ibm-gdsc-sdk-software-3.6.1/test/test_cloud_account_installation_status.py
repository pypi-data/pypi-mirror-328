...
class TestCloudAccountInstallationStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CloudAccountInstallationStatus:
        """Test CloudAccountInstallationStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudAccountInstallationStatus`
        """
    ...
    def testCloudAccountInstallationStatus(self):
        """Test CloudAccountInstallationStatus"""

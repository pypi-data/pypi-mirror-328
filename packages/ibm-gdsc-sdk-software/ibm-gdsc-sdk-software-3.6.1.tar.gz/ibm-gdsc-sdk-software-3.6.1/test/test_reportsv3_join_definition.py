...
class TestReportsv3JoinDefinition(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Reportsv3JoinDefinition:
        """Test Reportsv3JoinDefinition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3JoinDefinition`
        """
        model = Reportsv3JoinDefinition()
        if include_optional:
    ...
    def testReportsv3JoinDefinition(self):
        """Test Reportsv3JoinDefinition"""

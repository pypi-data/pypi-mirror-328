...
class TestHealthcollectorv3ManagedUnitObjectGdp(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Healthcollectorv3ManagedUnitObjectGdp:
        """Test Healthcollectorv3ManagedUnitObjectGdp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Healthcollectorv3ManagedUnitObjectGdp`
        """
        model = Healthcollectorv3ManagedUnitObjectGdp()
        if include_optional:
    ...
    def testHealthcollectorv3ManagedUnitObjectGdp(self):
        """Test Healthcollectorv3ManagedUnitObjectGdp"""

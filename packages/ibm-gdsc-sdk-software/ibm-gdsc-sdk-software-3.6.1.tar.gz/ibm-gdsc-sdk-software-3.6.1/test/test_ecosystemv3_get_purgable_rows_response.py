...
class TestEcosystemv3GetPurgableRowsResponse(unittest.TestCase):
    """Ecosystemv3GetPurgableRowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ecosystemv3GetPurgableRowsResponse:
        """Test Ecosystemv3GetPurgableRowsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ecosystemv3GetPurgableRowsResponse`
        """
        model = Ecosystemv3GetPurgableRowsResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testEcosystemv3GetPurgableRowsResponse(self):
        """Test Ecosystemv3GetPurgableRowsResponse"""

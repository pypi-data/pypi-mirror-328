...
class TestGuardiumconnectorv3ManagedUnitObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3ManagedUnitObject:
        """Test Guardiumconnectorv3ManagedUnitObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Guardiumconnectorv3ManagedUnitObject`
        """
        model = Guardiumconnectorv3ManagedUnitObject()
        if include_optional:
    ...
    def testGuardiumconnectorv3ManagedUnitObject(self):
        """Test Guardiumconnectorv3ManagedUnitObject"""

...
class TestConnectionsv3PartialConnector(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Connectionsv3PartialConnector:
        """Test Connectionsv3PartialConnector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3PartialConnector`
        """
        model = Connectionsv3PartialConnector()
        if include_optional:
    ...
    def testConnectionsv3PartialConnector(self):
        """Test Connectionsv3PartialConnector"""

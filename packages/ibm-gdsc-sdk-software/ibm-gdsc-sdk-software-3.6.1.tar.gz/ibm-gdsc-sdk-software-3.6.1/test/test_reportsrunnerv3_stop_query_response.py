...
class TestReportsrunnerv3StopQueryResponse(unittest.TestCase):
    """Reportsrunnerv3StopQueryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsrunnerv3StopQueryResponse:
        """Test Reportsrunnerv3StopQueryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsrunnerv3StopQueryResponse`
        """
        model = Reportsrunnerv3StopQueryResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testReportsrunnerv3StopQueryResponse(self):
        """Test Reportsrunnerv3StopQueryResponse"""

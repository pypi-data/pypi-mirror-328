...
class TestWorkflowv3DeleteCasesResponse(unittest.TestCase):
    """Workflowv3DeleteCasesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3DeleteCasesResponse:
        """Test Workflowv3DeleteCasesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3DeleteCasesResponse`
        """
        model = Workflowv3DeleteCasesResponse()
        if include_optional:
            return Workflowv3DeleteCasesResponse(
                deleted = '',
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testWorkflowv3DeleteCasesResponse(self):
        """Test Workflowv3DeleteCasesResponse"""

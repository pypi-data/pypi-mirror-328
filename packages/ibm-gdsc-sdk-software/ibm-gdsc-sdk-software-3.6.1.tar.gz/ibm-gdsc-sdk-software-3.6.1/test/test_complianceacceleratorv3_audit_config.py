...
class TestComplianceacceleratorv3AuditConfig(unittest.TestCase):
    """Complianceacceleratorv3AuditConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Complianceacceleratorv3AuditConfig:
        """Test Complianceacceleratorv3AuditConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Complianceacceleratorv3AuditConfig`
        """
        model = Complianceacceleratorv3AuditConfig()
        if include_optional:
            return Complianceacceleratorv3AuditConfig(
                description = '',
                enabled = True,
                id = '',
                instructions = '',
    ...
    def testComplianceacceleratorv3AuditConfig(self):
        """Test Complianceacceleratorv3AuditConfig"""

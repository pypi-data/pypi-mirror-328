...
class TestTemplatesv3GetOriginDefaultContentResponse(unittest.TestCase):
    """Templatesv3GetOriginDefaultContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3GetOriginDefaultContentResponse:
        """Test Templatesv3GetOriginDefaultContentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3GetOriginDefaultContentResponse`
        """
        model = Templatesv3GetOriginDefaultContentResponse()
        if include_optional:
            return Templatesv3GetOriginDefaultContentResponse(
                default_contents = [
                    ibm_gdsc_sdk_software.models.templatesv3_default_content.templatesv3DefaultContent(
                        content = '', 
                        is_default = True, 
                        name = '', )
                    ],
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3GetOriginDefaultContentResponse(self):
        """Test Templatesv3GetOriginDefaultContentResponse"""

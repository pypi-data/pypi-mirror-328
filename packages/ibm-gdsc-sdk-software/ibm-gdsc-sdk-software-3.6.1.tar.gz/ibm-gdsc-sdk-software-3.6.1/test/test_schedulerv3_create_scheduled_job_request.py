...
class TestSchedulerv3CreateScheduledJobRequest(unittest.TestCase):
    """Schedulerv3CreateScheduledJobRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Schedulerv3CreateScheduledJobRequest:
        """Test Schedulerv3CreateScheduledJobRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Schedulerv3CreateScheduledJobRequest`
        """
        model = Schedulerv3CreateScheduledJobRequest()
        if include_optional:
            return Schedulerv3CreateScheduledJobRequest(
                description = '',
                enabled = True,
                instructions = '',
    ...
    def testSchedulerv3CreateScheduledJobRequest(self):
        """Test Schedulerv3CreateScheduledJobRequest"""

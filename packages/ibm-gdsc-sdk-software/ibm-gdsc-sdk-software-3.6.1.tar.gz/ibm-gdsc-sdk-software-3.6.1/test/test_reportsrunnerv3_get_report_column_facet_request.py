...
class TestReportsrunnerv3GetReportColumnFacetRequest(unittest.TestCase):
    """Reportsrunnerv3GetReportColumnFacetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsrunnerv3GetReportColumnFacetRequest:
        """Test Reportsrunnerv3GetReportColumnFacetRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsrunnerv3GetReportColumnFacetRequest`
        """
        model = Reportsrunnerv3GetReportColumnFacetRequest()
        if include_optional:
            return Reportsrunnerv3GetReportColumnFacetRequest(
    ...
    def testReportsrunnerv3GetReportColumnFacetRequest(self):
        """Test Reportsrunnerv3GetReportColumnFacetRequest"""

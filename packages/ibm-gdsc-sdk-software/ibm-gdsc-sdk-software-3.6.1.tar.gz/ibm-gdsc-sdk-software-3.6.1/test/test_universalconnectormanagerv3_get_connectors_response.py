...
class TestUniversalconnectormanagerv3GetConnectorsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Universalconnectormanagerv3GetConnectorsResponse:
        """Test Universalconnectormanagerv3GetConnectorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Universalconnectormanagerv3GetConnectorsResponse`
        """
        model = Universalconnectormanagerv3GetConnectorsResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testUniversalconnectormanagerv3GetConnectorsResponse(self):
        """Test Universalconnectormanagerv3GetConnectorsResponse"""

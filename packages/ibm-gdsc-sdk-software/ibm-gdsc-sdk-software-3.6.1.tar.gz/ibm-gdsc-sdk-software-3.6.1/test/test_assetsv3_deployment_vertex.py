...
class TestAssetsv3DeploymentVertex(unittest.TestCase):
    """Assetsv3DeploymentVertex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Assetsv3DeploymentVertex:
        """Test Assetsv3DeploymentVertex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Assetsv3DeploymentVertex`
        """
        model = Assetsv3DeploymentVertex()
        if include_optional:
            return Assetsv3DeploymentVertex(
                city = '',
                country = '',
    ...
    def testAssetsv3DeploymentVertex(self):
        """Test Assetsv3DeploymentVertex"""

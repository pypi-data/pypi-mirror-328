...
class TestGuardiumconnectorv3CM(unittest.TestCase):
    """Guardiumconnectorv3CM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3CM:
        """Test Guardiumconnectorv3CM
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Guardiumconnectorv3CM`
        """
        model = Guardiumconnectorv3CM()
        if include_optional:
            return Guardiumconnectorv3CM(
                attributes = [
    ...
    def testGuardiumconnectorv3CM(self):
        """Test Guardiumconnectorv3CM"""

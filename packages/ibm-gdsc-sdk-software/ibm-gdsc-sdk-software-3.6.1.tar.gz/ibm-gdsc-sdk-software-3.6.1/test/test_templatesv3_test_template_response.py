...
class TestTemplatesv3TestTemplateResponse(unittest.TestCase):
    """Templatesv3TestTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3TestTemplateResponse:
        """Test Templatesv3TestTemplateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3TestTemplateResponse`
        """
        model = Templatesv3TestTemplateResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3TestTemplateResponse(self):
        """Test Templatesv3TestTemplateResponse"""

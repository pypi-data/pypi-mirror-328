...
class TestDashboardsv3GetDashboardsResponse(unittest.TestCase):
    """Dashboardsv3GetDashboardsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Dashboardsv3GetDashboardsResponse:
        """Test Dashboardsv3GetDashboardsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dashboardsv3GetDashboardsResponse`
        """
        model = Dashboardsv3GetDashboardsResponse()
        if include_optional:
            return Dashboardsv3GetDashboardsResponse(
                dashboards_list = [
                    ibm_gdsc_sdk_software.models.dashboardsv3_dashboard.dashboardsv3Dashboard(
                        cards = [
    ...
    def testDashboardsv3GetDashboardsResponse(self):
        """Test Dashboardsv3GetDashboardsResponse"""

...
class TestWorkflowv3CreateCaseResponse(unittest.TestCase):
    """Workflowv3CreateCaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3CreateCaseResponse:
        """Test Workflowv3CreateCaseResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3CreateCaseResponse`
        """
        model = Workflowv3CreateCaseResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testWorkflowv3CreateCaseResponse(self):
        """Test Workflowv3CreateCaseResponse"""

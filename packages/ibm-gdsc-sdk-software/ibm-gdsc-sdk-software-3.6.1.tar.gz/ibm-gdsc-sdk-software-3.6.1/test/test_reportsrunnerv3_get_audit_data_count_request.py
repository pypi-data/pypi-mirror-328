...
class TestReportsrunnerv3GetAuditDataCountRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Reportsrunnerv3GetAuditDataCountRequest:
        """Test Reportsrunnerv3GetAuditDataCountRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsrunnerv3GetAuditDataCountRequest`
        """
        model = Reportsrunnerv3GetAuditDataCountRequest()
        if include_optional:
    ...
    def testReportsrunnerv3GetAuditDataCountRequest(self):
        """Test Reportsrunnerv3GetAuditDataCountRequest"""

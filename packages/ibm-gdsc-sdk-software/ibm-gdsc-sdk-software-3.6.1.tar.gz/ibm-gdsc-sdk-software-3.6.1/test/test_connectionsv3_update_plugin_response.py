...
class TestConnectionsv3UpdatePluginResponse(unittest.TestCase):
    """Connectionsv3UpdatePluginResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Connectionsv3UpdatePluginResponse:
        """Test Connectionsv3UpdatePluginResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3UpdatePluginResponse`
        """
        model = Connectionsv3UpdatePluginResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testConnectionsv3UpdatePluginResponse(self):
        """Test Connectionsv3UpdatePluginResponse"""

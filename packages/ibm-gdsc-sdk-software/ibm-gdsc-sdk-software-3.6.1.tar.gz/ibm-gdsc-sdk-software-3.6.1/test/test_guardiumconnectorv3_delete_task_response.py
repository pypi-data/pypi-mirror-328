...
class TestGuardiumconnectorv3DeleteTaskResponse(unittest.TestCase):
    """Guardiumconnectorv3DeleteTaskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3DeleteTaskResponse:
        ...
        """
        model = Guardiumconnectorv3DeleteTaskResponse()
        if include_optional:
    ...
    def testGuardiumconnectorv3DeleteTaskResponse(self):
        """Test Guardiumconnectorv3DeleteTaskResponse"""

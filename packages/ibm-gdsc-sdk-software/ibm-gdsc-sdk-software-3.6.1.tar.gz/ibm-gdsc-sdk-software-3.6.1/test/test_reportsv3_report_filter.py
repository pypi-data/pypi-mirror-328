...
class TestReportsv3ReportFilter(unittest.TestCase):
    """Reportsv3ReportFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsv3ReportFilter:
        """Test Reportsv3ReportFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3ReportFilter`
        """
        model = Reportsv3ReportFilter()
        if include_optional:
            return Reportsv3ReportFilter(
    ...
    def testReportsv3ReportFilter(self):
        """Test Reportsv3ReportFilter"""

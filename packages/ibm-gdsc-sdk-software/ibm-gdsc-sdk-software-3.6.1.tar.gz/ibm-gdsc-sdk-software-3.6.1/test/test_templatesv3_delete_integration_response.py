...
class TestTemplatesv3DeleteIntegrationResponse(unittest.TestCase):
    """Templatesv3DeleteIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3DeleteIntegrationResponse:
        """Test Templatesv3DeleteIntegrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3DeleteIntegrationResponse`
        """
        model = Templatesv3DeleteIntegrationResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3DeleteIntegrationResponse(self):
        """Test Templatesv3DeleteIntegrationResponse"""

...
class TestComplianceacceleratorv3ComplianceInfo(unittest.TestCase):
    """Complianceacceleratorv3ComplianceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Complianceacceleratorv3ComplianceInfo:
        """Test Complianceacceleratorv3ComplianceInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Complianceacceleratorv3ComplianceInfo`
        """
        model = Complianceacceleratorv3ComplianceInfo()
        if include_optional:
            return Complianceacceleratorv3ComplianceInfo(
    ...
    def testComplianceacceleratorv3ComplianceInfo(self):
        """Test Complianceacceleratorv3ComplianceInfo"""

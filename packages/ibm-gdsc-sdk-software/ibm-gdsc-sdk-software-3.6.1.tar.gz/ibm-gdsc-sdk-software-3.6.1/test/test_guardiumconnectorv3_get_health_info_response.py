    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3GetHealthInfoResponse:
        ...
        if include_optional:
            return Guardiumconnectorv3GetHealthInfoResponse(
                nodes = [
                    ibm_gdsc_sdk_software.models.guardiumconnectorv3_managed_unit_object.guardiumconnectorv3ManagedUnitObject(
                ...
                staps = [
                    ibm_gdsc_sdk_software.models.guardiumconnectorv3_stap_object.guardiumconnectorv3StapObject(
                        collector_hostname = '', 
                        connectivity = 56, 

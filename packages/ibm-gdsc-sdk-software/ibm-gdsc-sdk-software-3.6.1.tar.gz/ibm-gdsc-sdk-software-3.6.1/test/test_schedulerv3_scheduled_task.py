...
class TestSchedulerv3ScheduledTask(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Schedulerv3ScheduledTask:
        """Test Schedulerv3ScheduledTask
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Schedulerv3ScheduledTask`
        """
        model = Schedulerv3ScheduledTask()
        if include_optional:
    ...
    def testSchedulerv3ScheduledTask(self):
        """Test Schedulerv3ScheduledTask"""

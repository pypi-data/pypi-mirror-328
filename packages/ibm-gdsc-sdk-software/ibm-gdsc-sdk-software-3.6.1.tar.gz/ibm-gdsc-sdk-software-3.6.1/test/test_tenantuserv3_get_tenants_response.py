...
class TestTenantuserv3GetTenantsResponse(unittest.TestCase):
    """Tenantuserv3GetTenantsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Tenantuserv3GetTenantsResponse:
        """Test Tenantuserv3GetTenantsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Tenantuserv3GetTenantsResponse`
        """
        model = Tenantuserv3GetTenantsResponse()
        if include_optional:
            return Tenantuserv3GetTenantsResponse(
                tenants = [
    ...
    def testTenantuserv3GetTenantsResponse(self):
        """Test Tenantuserv3GetTenantsResponse"""

...
class TestSchedulerv3GetScheduledJobResponse(unittest.TestCase):
    """Schedulerv3GetScheduledJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Schedulerv3GetScheduledJobResponse:
        """Test Schedulerv3GetScheduledJobResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Schedulerv3GetScheduledJobResponse`
        """
        model = Schedulerv3GetScheduledJobResponse()
        if include_optional:
            return Schedulerv3GetScheduledJobResponse(
                scheduled_job = ibm_gdsc_sdk_software.models.schedulerv3_scheduled_job.schedulerv3ScheduledJob(
    ...
    def testSchedulerv3GetScheduledJobResponse(self):
        """Test Schedulerv3GetScheduledJobResponse"""

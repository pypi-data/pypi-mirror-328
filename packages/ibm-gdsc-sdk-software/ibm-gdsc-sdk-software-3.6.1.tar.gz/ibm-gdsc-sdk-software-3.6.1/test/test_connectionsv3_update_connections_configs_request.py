...
class TestConnectionsv3UpdateConnectionsConfigsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Connectionsv3UpdateConnectionsConfigsRequest:
        """Test Connectionsv3UpdateConnectionsConfigsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3UpdateConnectionsConfigsRequest`
        """
        model = Connectionsv3UpdateConnectionsConfigsRequest()
        if include_optional:
    ...
    def testConnectionsv3UpdateConnectionsConfigsRequest(self):
        """Test Connectionsv3UpdateConnectionsConfigsRequest"""

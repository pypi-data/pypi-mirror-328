...
class TestJumpboxv3Tenant(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Jumpboxv3Tenant:
        """Test Jumpboxv3Tenant
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Jumpboxv3Tenant`
        """
        model = Jumpboxv3Tenant()
        if include_optional:
            return Jumpboxv3Tenant(

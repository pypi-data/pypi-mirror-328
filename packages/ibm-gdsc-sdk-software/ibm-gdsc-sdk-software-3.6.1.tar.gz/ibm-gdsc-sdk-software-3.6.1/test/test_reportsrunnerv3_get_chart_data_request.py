...
class TestReportsrunnerv3GetChartDataRequest(unittest.TestCase):
    """Reportsrunnerv3GetChartDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsrunnerv3GetChartDataRequest:
        """Test Reportsrunnerv3GetChartDataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsrunnerv3GetChartDataRequest`
        """
        model = Reportsrunnerv3GetChartDataRequest()
        if include_optional:
            return Reportsrunnerv3GetChartDataRequest(
                chart_id = '',
    ...
    def testReportsrunnerv3GetChartDataRequest(self):
        """Test Reportsrunnerv3GetChartDataRequest"""

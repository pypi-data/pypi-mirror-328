...
class TestConnectionsv3CreateSettingsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Connectionsv3CreateSettingsRequest:
        """Test Connectionsv3CreateSettingsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3CreateSettingsRequest`
        """
        model = Connectionsv3CreateSettingsRequest()
        if include_optional:
    ...
    def testConnectionsv3CreateSettingsRequest(self):
        """Test Connectionsv3CreateSettingsRequest"""

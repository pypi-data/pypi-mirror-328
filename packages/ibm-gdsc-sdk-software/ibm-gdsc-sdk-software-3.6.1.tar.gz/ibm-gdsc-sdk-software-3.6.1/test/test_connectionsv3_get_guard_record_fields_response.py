...
class TestConnectionsv3GetGuardRecordFieldsResponse(unittest.TestCase):
    """Connectionsv3GetGuardRecordFieldsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Connectionsv3GetGuardRecordFieldsResponse:
        """Test Connectionsv3GetGuardRecordFieldsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3GetGuardRecordFieldsResponse`
        """
        model = Connectionsv3GetGuardRecordFieldsResponse()
        if include_optional:
            return Connectionsv3GetGuardRecordFieldsResponse(
                fields = [
                    ibm_gdsc_sdk_software.models.predefined_guard_record_fields.predefined guard record fields(
                        fixed = True, 
                        id = '', 
                        name = '', 
                        nls_key = '', )
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testConnectionsv3GetGuardRecordFieldsResponse(self):
        """Test Connectionsv3GetGuardRecordFieldsResponse"""

...
class TestAnalyticseventsv3PostQSAdvisorRiskResponse(unittest.TestCase):
    """Analyticseventsv3PostQSAdvisorRiskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Analyticseventsv3PostQSAdvisorRiskResponse:
        """Test Analyticseventsv3PostQSAdvisorRiskResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Analyticseventsv3PostQSAdvisorRiskResponse`
        """
        model = Analyticseventsv3PostQSAdvisorRiskResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testAnalyticseventsv3PostQSAdvisorRiskResponse(self):
        """Test Analyticseventsv3PostQSAdvisorRiskResponse"""

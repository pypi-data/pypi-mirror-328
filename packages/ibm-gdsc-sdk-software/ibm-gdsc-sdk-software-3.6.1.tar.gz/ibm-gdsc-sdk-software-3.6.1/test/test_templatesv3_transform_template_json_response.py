...
class TestTemplatesv3TransformTemplateJSONResponse(unittest.TestCase):
    """Templatesv3TransformTemplateJSONResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3TransformTemplateJSONResponse:
        """Test Templatesv3TransformTemplateJSONResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3TransformTemplateJSONResponse`
        """
        model = Templatesv3TransformTemplateJSONResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3TransformTemplateJSONResponse(self):
        """Test Templatesv3TransformTemplateJSONResponse"""

...
class TestTemplatesv3UpdateTemplateResponse(unittest.TestCase):
    """Templatesv3UpdateTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3UpdateTemplateResponse:
        """Test Templatesv3UpdateTemplateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3UpdateTemplateResponse`
        """
        model = Templatesv3UpdateTemplateResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3UpdateTemplateResponse(self):
        """Test Templatesv3UpdateTemplateResponse"""

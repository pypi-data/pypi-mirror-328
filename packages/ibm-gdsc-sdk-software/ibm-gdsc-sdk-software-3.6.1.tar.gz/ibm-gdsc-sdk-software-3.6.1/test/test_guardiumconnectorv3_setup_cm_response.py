...
class TestGuardiumconnectorv3SetupCMResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Guardiumconnectorv3SetupCMResponse:
        """Test Guardiumconnectorv3SetupCMResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Guardiumconnectorv3SetupCMResponse`
        """
        model = Guardiumconnectorv3SetupCMResponse()
        if include_optional:
    ...
    def testGuardiumconnectorv3SetupCMResponse(self):
        """Test Guardiumconnectorv3SetupCMResponse"""

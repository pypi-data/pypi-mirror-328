...
class TestAssetsv3FilterTemplate(unittest.TestCase):
    """Assetsv3FilterTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Assetsv3FilterTemplate:
        """Test Assetsv3FilterTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Assetsv3FilterTemplate`
        """
        model = Assetsv3FilterTemplate()
        if include_optional:
            return Assetsv3FilterTemplate(
                colummns_list = [
    ...
    def testAssetsv3FilterTemplate(self):
        """Test Assetsv3FilterTemplate"""

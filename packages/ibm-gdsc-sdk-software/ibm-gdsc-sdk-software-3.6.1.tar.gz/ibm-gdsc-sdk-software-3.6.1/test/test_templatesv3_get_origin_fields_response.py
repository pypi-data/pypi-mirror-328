...
class TestTemplatesv3GetOriginFieldsResponse(unittest.TestCase):
    """Templatesv3GetOriginFieldsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3GetOriginFieldsResponse:
        """Test Templatesv3GetOriginFieldsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3GetOriginFieldsResponse`
        """
        model = Templatesv3GetOriginFieldsResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3GetOriginFieldsResponse(self):
        """Test Templatesv3GetOriginFieldsResponse"""

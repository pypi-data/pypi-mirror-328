...
class TestGroupbuilderv3Group(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Groupbuilderv3Group:
        """Test Groupbuilderv3Group
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Groupbuilderv3Group`
        """
        model = Groupbuilderv3Group()
        if include_optional:
            return Groupbuilderv3Group(
                access_level = 56,
                description = '',
    ...
    def testGroupbuilderv3Group(self):
        """Test Groupbuilderv3Group"""

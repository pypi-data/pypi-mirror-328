...
class TestWorkflowv3UpdateCasesResponse(unittest.TestCase):
    """Workflowv3UpdateCasesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3UpdateCasesResponse:
        """Test Workflowv3UpdateCasesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3UpdateCasesResponse`
        """
        model = Workflowv3UpdateCasesResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testWorkflowv3UpdateCasesResponse(self):
        """Test Workflowv3UpdateCasesResponse"""

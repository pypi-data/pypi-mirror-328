...
class TestWorkflowv3CaseListResponse(unittest.TestCase):
    """Workflowv3CaseListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Workflowv3CaseListResponse:
        """Test Workflowv3CaseListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowv3CaseListResponse`
        """
        model = Workflowv3CaseListResponse()
        if include_optional:
            return Workflowv3CaseListResponse(
                cases = [
                    ibm_gdsc_sdk_software.models.workflowv3_case.workflowv3Case(
                        alt_id = '', 
                        artifacts = [
                            ''
                            ], 
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testWorkflowv3CaseListResponse(self):
        """Test Workflowv3CaseListResponse"""

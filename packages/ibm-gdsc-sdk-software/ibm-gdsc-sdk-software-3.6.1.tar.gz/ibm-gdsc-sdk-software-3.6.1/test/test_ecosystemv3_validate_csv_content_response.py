...
class TestEcosystemv3ValidateCSVContentResponse(unittest.TestCase):
    """Ecosystemv3ValidateCSVContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ecosystemv3ValidateCSVContentResponse:
        """Test Ecosystemv3ValidateCSVContentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ecosystemv3ValidateCSVContentResponse`
        """
        model = Ecosystemv3ValidateCSVContentResponse()
        if include_optional:
            return Ecosystemv3ValidateCSVContentResponse(
                error_msgs = [
                    ''
                    ],
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testEcosystemv3ValidateCSVContentResponse(self):
        """Test Ecosystemv3ValidateCSVContentResponse"""

...
class TestPolicybuilderv3CreateUpdatePolicyRequest(unittest.TestCase):
    """Policybuilderv3CreateUpdatePolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Policybuilderv3CreateUpdatePolicyRequest:
        """Test Policybuilderv3CreateUpdatePolicyRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Policybuilderv3CreateUpdatePolicyRequest`
        """
        model = Policybuilderv3CreateUpdatePolicyRequest()
        if include_optional:
            return Policybuilderv3CreateUpdatePolicyRequest(
                can_override_name = True,
                policy_object = ibm_gdsc_sdk_software.models.policybuilderv3_policy_update.policybuilderv3PolicyUpdate(
    ...
    def testPolicybuilderv3CreateUpdatePolicyRequest(self):
        """Test Policybuilderv3CreateUpdatePolicyRequest"""

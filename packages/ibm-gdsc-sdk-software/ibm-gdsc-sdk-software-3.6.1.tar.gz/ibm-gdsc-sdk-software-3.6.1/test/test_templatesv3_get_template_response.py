...
class TestTemplatesv3GetTemplateResponse(unittest.TestCase):
    """Templatesv3GetTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Templatesv3GetTemplateResponse:
        """Test Templatesv3GetTemplateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Templatesv3GetTemplateResponse`
        """
        model = Templatesv3GetTemplateResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testTemplatesv3GetTemplateResponse(self):
        """Test Templatesv3GetTemplateResponse"""

...
class TestComplianceacceleratorv3GetComplianceInfoResponse(unittest.TestCase):
    """Complianceacceleratorv3GetComplianceInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Complianceacceleratorv3GetComplianceInfoResponse:
        """Test Complianceacceleratorv3GetComplianceInfoResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Complianceacceleratorv3GetComplianceInfoResponse`
        """
        model = Complianceacceleratorv3GetComplianceInfoResponse()
        if include_optional:
    ...
    def testComplianceacceleratorv3GetComplianceInfoResponse(self):
        """Test Complianceacceleratorv3GetComplianceInfoResponse"""

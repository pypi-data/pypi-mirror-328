...
class TestConnectionsv3StreamingConfigsByTenant(unittest.TestCase):
    """Connectionsv3StreamingConfigsByTenant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Connectionsv3StreamingConfigsByTenant:
        """Test Connectionsv3StreamingConfigsByTenant
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Connectionsv3StreamingConfigsByTenant`
        """
        model = Connectionsv3StreamingConfigsByTenant()
        if include_optional:
            return Connectionsv3StreamingConfigsByTenant(
                mini_snif_endpoint = '',
    ...
    def testConnectionsv3StreamingConfigsByTenant(self):
        """Test Connectionsv3StreamingConfigsByTenant"""

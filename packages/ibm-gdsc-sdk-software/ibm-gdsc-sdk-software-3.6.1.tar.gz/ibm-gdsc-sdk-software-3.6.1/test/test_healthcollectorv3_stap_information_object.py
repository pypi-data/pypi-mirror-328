...
class TestHealthcollectorv3StapInformationObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Healthcollectorv3StapInformationObject:
        """Test Healthcollectorv3StapInformationObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Healthcollectorv3StapInformationObject`
        """
        model = Healthcollectorv3StapInformationObject()
        if include_optional:
    ...
    def testHealthcollectorv3StapInformationObject(self):
        """Test Healthcollectorv3StapInformationObject"""

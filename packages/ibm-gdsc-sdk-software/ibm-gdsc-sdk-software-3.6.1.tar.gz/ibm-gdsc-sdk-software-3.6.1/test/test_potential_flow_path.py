...
class TestPotentialFlowPath(unittest.TestCase):
    """PotentialFlowPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PotentialFlowPath:
        """Test PotentialFlowPath
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PotentialFlowPath`
        """
        model = PotentialFlowPath()
        if include_optional:
            return PotentialFlowPath(
                id = 'aaede660-6090-479a-b54f-12345678910',
                potential_flow_id = 'fa7f5ff3-3587-697e-f580-12345678910',
                type = 'compute',
    ...
    def testPotentialFlowPath(self):
        """Test PotentialFlowPath"""

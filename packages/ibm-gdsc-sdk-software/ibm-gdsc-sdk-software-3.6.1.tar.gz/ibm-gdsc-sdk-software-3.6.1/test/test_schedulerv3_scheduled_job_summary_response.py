    ...
    def make_instance(self, include_optional) -> Schedulerv3ScheduledJobSummaryResponse:
        ...
        if include_optional:
            return Schedulerv3ScheduledJobSummaryResponse(
                record_count = 56,
                report_names = [
                    ibm_gdsc_sdk_software.models.schedulerv3_report_array.schedulerv3ReportArray(
                        report_name = [
                            ''
                            ], )
                    ],
                scheduled_job = [
                    ibm_gdsc_sdk_software.models.schedulerv3_scheduled_job_summary.schedulerv3ScheduledJobSummary(

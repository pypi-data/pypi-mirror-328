...
class TestRiskanalyticsenginev3Feature(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Riskanalyticsenginev3Feature:
        """Test Riskanalyticsenginev3Feature
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Riskanalyticsenginev3Feature`
        """
        model = Riskanalyticsenginev3Feature()
        if include_optional:
            return Riskanalyticsenginev3Feature(
                feature_nls = '',
                is_observation = True,
                is_zero = True,
                key = '',
    ...
    def testRiskanalyticsenginev3Feature(self):
        """Test Riskanalyticsenginev3Feature"""

...
class TestNotificationsv3TestIntegrationResponse(unittest.TestCase):
    """Notificationsv3TestIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Notificationsv3TestIntegrationResponse:
        """Test Notificationsv3TestIntegrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Notificationsv3TestIntegrationResponse`
        """
        model = Notificationsv3TestIntegrationResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testNotificationsv3TestIntegrationResponse(self):
        """Test Notificationsv3TestIntegrationResponse"""

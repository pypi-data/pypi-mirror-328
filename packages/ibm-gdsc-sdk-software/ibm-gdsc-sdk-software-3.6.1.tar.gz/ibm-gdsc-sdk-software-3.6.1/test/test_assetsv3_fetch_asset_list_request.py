...
class TestAssetsv3FetchAssetListRequest(unittest.TestCase):
    """Assetsv3FetchAssetListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Assetsv3FetchAssetListRequest:
        """Test Assetsv3FetchAssetListRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Assetsv3FetchAssetListRequest`
        """
        model = Assetsv3FetchAssetListRequest()
        if include_optional:
            return Assetsv3FetchAssetListRequest(
                columns = [
                    ''
                    ],
                filter = [
    ...
    def testAssetsv3FetchAssetListRequest(self):
        """Test Assetsv3FetchAssetListRequest"""

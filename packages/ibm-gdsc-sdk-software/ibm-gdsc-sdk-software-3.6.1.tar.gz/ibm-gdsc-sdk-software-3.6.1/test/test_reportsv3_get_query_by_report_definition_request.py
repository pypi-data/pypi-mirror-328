...
class TestReportsv3GetQueryByReportDefinitionRequest(unittest.TestCase):
    """Reportsv3GetQueryByReportDefinitionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsv3GetQueryByReportDefinitionRequest:
        """Test Reportsv3GetQueryByReportDefinitionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsv3GetQueryByReportDefinitionRequest`
        """
        model = Reportsv3GetQueryByReportDefinitionRequest()
        if include_optional:
            return Reportsv3GetQueryByReportDefinitionRequest(
                add_group_literal = '',
                add_job_id_literal = '',
    ...
    def testReportsv3GetQueryByReportDefinitionRequest(self):
        """Test Reportsv3GetQueryByReportDefinitionRequest"""

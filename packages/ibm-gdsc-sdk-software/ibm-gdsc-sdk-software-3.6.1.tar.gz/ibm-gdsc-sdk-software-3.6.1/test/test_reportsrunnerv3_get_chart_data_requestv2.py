...
class TestReportsrunnerv3GetChartDataRequestv2(unittest.TestCase):
    """Reportsrunnerv3GetChartDataRequestv2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Reportsrunnerv3GetChartDataRequestv2:
        """Test Reportsrunnerv3GetChartDataRequestv2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Reportsrunnerv3GetChartDataRequestv2`
        """
        model = Reportsrunnerv3GetChartDataRequestv2()
        if include_optional:
            return Reportsrunnerv3GetChartDataRequestv2(
                chart_id = '',
                chart_settings = ibm_gdsc_sdk_software.models.reportsv3_chart_settingsv2.reportsv3ChartSettingsv2(
    ...
    def testReportsrunnerv3GetChartDataRequestv2(self):
        """Test Reportsrunnerv3GetChartDataRequestv2"""

...
class TestRiskanalyticsenginev3LeadGeneratorConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Riskanalyticsenginev3LeadGeneratorConfig:
        """Test Riskanalyticsenginev3LeadGeneratorConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Riskanalyticsenginev3LeadGeneratorConfig`
        """
        model = Riskanalyticsenginev3LeadGeneratorConfig()
        if include_optional:
            return Riskanalyticsenginev3LeadGeneratorConfig(
                is_active = True,
                lead_generator_name = '',
    ...
    def testRiskanalyticsenginev3LeadGeneratorConfig(self):
        """Test Riskanalyticsenginev3LeadGeneratorConfig"""

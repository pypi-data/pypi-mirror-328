...
class TestSchedulerv3UpdateScheduledJobRequest(unittest.TestCase):
    """Schedulerv3UpdateScheduledJobRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Schedulerv3UpdateScheduledJobRequest:
        """Test Schedulerv3UpdateScheduledJobRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Schedulerv3UpdateScheduledJobRequest`
        """
        model = Schedulerv3UpdateScheduledJobRequest()
        if include_optional:
            return Schedulerv3UpdateScheduledJobRequest(
                query = {
                    'key' : ''
                    },
                schedule_id = '',
                scheduled_job = ibm_gdsc_sdk_software.models.schedulerv3_create_scheduled_job_request.schedulerv3CreateScheduledJobRequest(
                    description = '', 
                    enabled = True, 
                    instructions = '', 
                    ...
                    retention = ibm_gdsc_sdk_software.models.schedulerv3_retention.schedulerv3Retention(
                        archive = True, 
                        days = 56, ), 
                    scheduler = ibm_gdsc_sdk_software.models.schedulerv3_scheduler.schedulerv3Scheduler(
    ...
    def testSchedulerv3UpdateScheduledJobRequest(self):
        """Test Schedulerv3UpdateScheduledJobRequest"""

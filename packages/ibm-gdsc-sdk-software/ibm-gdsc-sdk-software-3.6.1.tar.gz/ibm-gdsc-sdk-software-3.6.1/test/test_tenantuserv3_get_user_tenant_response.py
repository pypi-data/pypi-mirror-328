...
class TestTenantuserv3GetUserTenantResponse(unittest.TestCase):
    """Tenantuserv3GetUserTenantResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Tenantuserv3GetUserTenantResponse:
        """Test Tenantuserv3GetUserTenantResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Tenantuserv3GetUserTenantResponse`
        """
        model = Tenantuserv3GetUserTenantResponse()
        if include_optional:
            return Tenantuserv3GetUserTenantResponse(
                message = '',
                user_tenant = ibm_gdsc_sdk_software.models.tenantuserv3_user_tenant.tenantuserv3UserTenant(
    ...
    def testTenantuserv3GetUserTenantResponse(self):
        """Test Tenantuserv3GetUserTenantResponse"""

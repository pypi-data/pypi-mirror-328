...
class TestNotificationsv3CreateTicketResponse(unittest.TestCase):
    """Notificationsv3CreateTicketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Notificationsv3CreateTicketResponse:
        """Test Notificationsv3CreateTicketResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Notificationsv3CreateTicketResponse`
        """
        model = Notificationsv3CreateTicketResponse()
        if include_optional:
...
[gRPC](https://github.com/grpc). The error model is designed to be:(
    ...
    def testNotificationsv3CreateTicketResponse(self):
        """Test Notificationsv3CreateTicketResponse"""

...
class Ecosystemv3GetPurgableRowsResponse(BaseModel):
    """
    Returns the number of rows that can be purged.
    """ # noqa: E501
    purgable_rows: Optional[StrictInt] = Field(default=None, description="Number of rows that can be purged.")
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["purgable_rows", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purgable_rows": obj.get("purgable_rows"),

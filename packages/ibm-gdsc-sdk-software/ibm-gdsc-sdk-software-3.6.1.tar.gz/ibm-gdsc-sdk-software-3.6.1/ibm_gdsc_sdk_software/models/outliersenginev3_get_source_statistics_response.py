...
class Outliersenginev3GetSourceStatisticsResponse(BaseModel):
    """
    Outliersenginev3GetSourceStatisticsResponse
    """ # noqa: E501
    source_statistics: Optional[List[Outliersenginev3SourceAttributesStatistics]] = None
    __properties: ClassVar[List[str]] = ["source_statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source_statistics": [Outliersenginev3SourceAttributesStatistics.from_dict(_item) for _item in obj["source_statistics"]] if obj.get("source_statistics") is not None else None
        })
        return _obj

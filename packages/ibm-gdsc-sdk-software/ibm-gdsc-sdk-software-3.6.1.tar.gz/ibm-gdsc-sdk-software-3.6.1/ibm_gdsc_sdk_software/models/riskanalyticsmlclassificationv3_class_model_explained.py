...
class Riskanalyticsmlclassificationv3ClassModelExplained(BaseModel):
    """
    ClassModelExplained message for the response of GetClassificationModel api.
    """ # noqa: E501
    class_confidence: Optional[Union[StrictFloat, StrictInt]] = None
    class_key: Optional[StrictStr] = None
    rule_sets: Optional[List[Riskanalyticsmlclassificationv3RuleSetList]] = None
    __properties: ClassVar[List[str]] = ["class_confidence", "class_key", "rule_sets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "class_confidence": obj.get("class_confidence"),
            "class_key": obj.get("class_key"),
            "rule_sets": [Riskanalyticsmlclassificationv3RuleSetList.from_dict(_item) for _item in obj["rule_sets"]] if obj.get("rule_sets") is not None else None
        })
        return _obj

...
class Tenantuserv3GetPrivilegesResponse(BaseModel):
    """
    Tenantuserv3GetPrivilegesResponse
    """ # noqa: E501
    privileges: Optional[List[Tenantuserv3Privilege]] = Field(default=None, description="Array of privileges found.")

...
class ListPotentialFlows200Response(BaseModel):
    """
    ListPotentialFlows200Response
    """ # noqa: E501
    results: List[PotentialFlowListItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PotentialFlowListItem.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class Jumpboxv3PostUsersBulkRequest(BaseModel):
    """
    PostUsersBulkRequest message for POST v3/users api.
    """ # noqa: E501
    users: Optional[List[Jumpboxv3User]] = Field(default=None, description="Array of users to be imported into Insights.")

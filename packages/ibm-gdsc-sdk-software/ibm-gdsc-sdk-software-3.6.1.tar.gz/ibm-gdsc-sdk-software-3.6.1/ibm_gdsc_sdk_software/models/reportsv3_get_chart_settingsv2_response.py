...
class Reportsv3GetChartSettingsv2Response(BaseModel):
    """
    GetChartSettingsv2Response is the return type which encapsulates a VEGA chart settings from the GetChartSettingsv2() api.
    """ # noqa: E501
    chart_settings: Optional[List[Reportsv3ChartSettingsv2]] = Field(default=None, description="A new VEGA chart definition.")
    __properties: ClassVar[List[str]] = ["chart_settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chart_settings": [Reportsv3ChartSettingsv2.from_dict(_item) for _item in obj["chart_settings"]] if obj.get("chart_settings") is not None else None
        })
        return _obj

...
class ConfigureSSORequest(BaseModel):
    ...
    ConfigureSSORequest
    """ # noqa: E501
    email_domain: StrictStr = Field(description="The domain from where your SSO emails are provided.", alias="emailDomain")
    idp_metadata: ConfigureSSORequestIdpMetadata = Field(alias="idpMetadata")
    __properties: ClassVar[List[str]] = ["emailDomain", "idpMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "idpMetadata": ConfigureSSORequestIdpMetadata.from_dict(obj["idpMetadata"]) if obj.get("idpMetadata") is not None else None
        })
        return _obj

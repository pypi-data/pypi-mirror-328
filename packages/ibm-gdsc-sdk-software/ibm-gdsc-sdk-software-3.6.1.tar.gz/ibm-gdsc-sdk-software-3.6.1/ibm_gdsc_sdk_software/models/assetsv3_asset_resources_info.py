...
class Assetsv3AssetResourcesInfo(BaseModel):
    """
    Assetsv3AssetResourcesInfo
    """ # noqa: E501
    resource: Optional[List[Assetsv3ResourceData]] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["resource", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource": [Assetsv3ResourceData.from_dict(_item) for _item in obj["resource"]] if obj.get("resource") is not None else None,

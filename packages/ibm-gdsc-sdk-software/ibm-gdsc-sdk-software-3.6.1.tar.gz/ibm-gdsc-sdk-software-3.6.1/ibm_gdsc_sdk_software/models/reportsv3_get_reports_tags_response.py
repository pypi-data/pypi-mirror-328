...
class Reportsv3GetReportsTagsResponse(BaseModel):
    """
    GetReportsTagsResponse containes all distinct tags list and is the return type of GetReportsTags() api.
    """ # noqa: E501
    report_tags: Optional[List[Reportsv3ReportTag]] = Field(default=None, description="The reports tags.")
    __properties: ClassVar[List[str]] = ["report_tags"]

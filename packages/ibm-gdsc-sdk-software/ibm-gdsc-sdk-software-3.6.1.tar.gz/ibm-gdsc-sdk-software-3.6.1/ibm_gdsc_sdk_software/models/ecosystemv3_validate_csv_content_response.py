...
class Ecosystemv3ValidateCSVContentResponse(BaseModel):
    """
    ValidateCSVContentResponse message as the response for the ValidateCSVContent api.
    """ # noqa: E501
    error_msgs: Optional[List[StrictStr]] = Field(default=None, description="Error messages for the result.")
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["error_msgs", "status"]

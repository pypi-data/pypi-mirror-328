...
class Schedulerv3GetDependenciesResponse(BaseModel):
    """
    Schedulerv3GetDependenciesResponse
    """ # noqa: E501
    dependencies: Optional[List[Schedulerv3Dependency]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dependencies": [Schedulerv3Dependency.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None
        })
        return _obj

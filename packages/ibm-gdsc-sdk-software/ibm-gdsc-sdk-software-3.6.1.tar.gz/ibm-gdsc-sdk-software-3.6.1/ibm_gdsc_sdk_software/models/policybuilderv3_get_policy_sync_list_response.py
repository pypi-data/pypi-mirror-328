...
class Policybuilderv3GetPolicySyncListResponse(BaseModel):
    """
    Policybuilderv3GetPolicySyncListResponse
    """ # noqa: E501
    policies: Optional[List[Policybuilderv3GdpPolicySyncRes]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [Policybuilderv3GdpPolicySyncRes.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,

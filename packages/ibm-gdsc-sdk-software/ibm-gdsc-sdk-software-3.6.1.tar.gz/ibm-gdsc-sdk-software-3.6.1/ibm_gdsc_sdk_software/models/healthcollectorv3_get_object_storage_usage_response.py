...
class Healthcollectorv3GetObjectStorageUsageResponse(BaseModel):
    """
    Healthcollectorv3GetObjectStorageUsageResponse
    """ # noqa: E501
    object_storage_usage: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["object_storage_usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object_storage_usage": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["object_storage_usage"]] if obj.get("object_storage_usage") is not None else None
        })
        return _obj

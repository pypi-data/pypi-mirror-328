...
class Tenantuserv3GetUsersResponse(BaseModel):
    """
    PostUsersResponse message for Get v3/users api.
    """ # noqa: E501
    users: Optional[List[Tenantuserv3User]] = Field(default=None, description="List of users.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [Tenantuserv3User.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj

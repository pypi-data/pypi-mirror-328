...
class Featureflagsv3GetFeatureFlagOverridesResponse(BaseModel):
    """
    GetFeatureFlagOverridesResponse response body of get featureflag API.
    """ # noqa: E501
    feature_flags: Optional[List[Featureflagsv3FeatureFlagOverrides]] = Field(default=None, description="Overrides Feature Flag.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feature_flags": [Featureflagsv3FeatureFlagOverrides.from_dict(_item) for _item in obj["feature_flags"]] if obj.get("feature_flags") is not None else None
        })
        return _obj

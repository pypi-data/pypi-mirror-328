...
class Reportsv3CreateCategoryRequest(BaseModel):
    """
    Reportsv3CreateCategoryRequest
    """ # noqa: E501
    category: Optional[Reportsv3CategoryDetail] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": Reportsv3CategoryDetail.from_dict(obj["category"]) if obj.get("category") is not None else None
        })
        return _obj

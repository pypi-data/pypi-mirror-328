...
class ListDataResources200Response(BaseModel):
    """
    ListDataResources200Response
    """ # noqa: E501
    results: Optional[List[DataResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [DataResource.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class Connectionsv3GetAttributesResponse(BaseModel):
    """
    Connectionsv3GetAttributesResponse
    """ # noqa: E501
    attributes: Optional[List[Connectionsv3ConnectorAttribute]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [Connectionsv3ConnectorAttribute.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj

...
class Policybuilderv3PolicyGroups(BaseModel):
    """
    Policybuilderv3PolicyGroups
    """ # noqa: E501
    group_id: Optional[StrictStr] = None
    policies: Optional[List[Policybuilderv3PolicyDetailsForGroups]] = None
    __properties: ClassVar[List[str]] = ["group_id", "policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [Policybuilderv3PolicyDetailsForGroups.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj

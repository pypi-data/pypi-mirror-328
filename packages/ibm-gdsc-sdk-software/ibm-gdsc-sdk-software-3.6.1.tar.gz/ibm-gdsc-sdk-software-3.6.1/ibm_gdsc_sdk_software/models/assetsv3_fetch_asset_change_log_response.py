...
class Assetsv3FetchAssetChangeLogResponse(BaseModel):
    """
    Assetsv3FetchAssetChangeLogResponse
    """ # noqa: E501
    asset_change_log: Optional[List[Assetsv3AssetChangeLog]] = None
    total_count: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["asset_change_log", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asset_change_log": [Assetsv3AssetChangeLog.from_dict(_item) for _item in obj["asset_change_log"]] if obj.get("asset_change_log") is not None else None,

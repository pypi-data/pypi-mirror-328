...
class Policybuilderv3CreateUpdatePolicyResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activation_status", "installed_flag", "policy_id", "policy_name", "rules", "status"]

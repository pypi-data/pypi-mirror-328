...
class Connectionsv3PartialUpdateConnectorsRequest(BaseModel):
    """
    Connectionsv3PartialUpdateConnectorsRequest
    """ # noqa: E501
    connectors: Optional[List[Connectionsv3PartialConnector]] = Field(default=None, description="The list of connectors to update.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": [Connectionsv3PartialConnector.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj

...
class Reportsv3Category(BaseModel):
    """
    Reportsv3Category
    """ # noqa: E501
    ...
    multi_version: Optional[StrictBool] = None
    versions: Optional[List[Reportsv3CategoryVersion]] = None
    __properties: ClassVar[List[str]] = ["category_description", "category_id", "category_name", "multi_version", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "multi_version": obj.get("multi_version"),
            "versions": [Reportsv3CategoryVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj

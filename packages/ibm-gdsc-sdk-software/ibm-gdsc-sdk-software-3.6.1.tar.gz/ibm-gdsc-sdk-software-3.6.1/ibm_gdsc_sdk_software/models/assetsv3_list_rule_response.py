...
class Assetsv3ListRuleResponse(BaseModel):
    """
    Assetsv3ListRuleResponse
    """ # noqa: E501
    activation_status: Optional[StrictInt] = None
    policy_id: Optional[StrictStr] = None
    policy_name: Optional[StrictStr] = None
    policy_sequence: Optional[StrictInt] = None
    rule_list: Optional[List[Assetsv3Rule]] = None
    __properties: ClassVar[List[str]] = ["activation_status", "policy_id", "policy_name", "policy_sequence", "rule_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rule_list": [Assetsv3Rule.from_dict(_item) for _item in obj["rule_list"]] if obj.get("rule_list") is not None else None
        })
        return _obj

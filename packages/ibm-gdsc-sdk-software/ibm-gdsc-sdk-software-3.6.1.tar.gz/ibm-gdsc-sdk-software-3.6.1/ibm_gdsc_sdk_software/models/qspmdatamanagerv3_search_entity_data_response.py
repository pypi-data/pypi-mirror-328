...
class Qspmdatamanagerv3SearchEntityDataResponse(BaseModel):
    """
    SearchEntityDataResponse is the response object for SearchEntityData API.
    """ # noqa: E501
    rows: Optional[List[Qspmdatamanagerv3Row]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [Qspmdatamanagerv3Row.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj

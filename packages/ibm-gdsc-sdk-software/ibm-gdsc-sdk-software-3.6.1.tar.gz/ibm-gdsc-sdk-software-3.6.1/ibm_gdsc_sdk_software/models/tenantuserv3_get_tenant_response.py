...
class Tenantuserv3GetTenantResponse(BaseModel):
    """
    GetTenantResponse message for GET v3/tenants/{tenant_id} api.
    """ # noqa: E501
    tenant: Optional[Tenantuserv3Tenant] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tenant": Tenantuserv3Tenant.from_dict(obj["tenant"]) if obj.get("tenant") is not None else None
        })
        return _obj

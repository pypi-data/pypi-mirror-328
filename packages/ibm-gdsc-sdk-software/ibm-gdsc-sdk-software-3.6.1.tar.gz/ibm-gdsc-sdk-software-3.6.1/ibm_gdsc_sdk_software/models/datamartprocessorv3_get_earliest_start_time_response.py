...
class Datamartprocessorv3GetEarliestStartTimeResponse(BaseModel):
    """
    GetEarliestStartTimeResponse response object.
    """ # noqa: E501
    status: Optional[Datamartprocessorv3StatusResponseBase] = None
    timestamp: Optional[datetime] = Field(default=None, description="Earliest time stamp of data available.")

...
class Notificationsv3UpdateNotificationRecordResponse(BaseModel):
    """
    Contains the result of a request to update a notification record.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="Result is \"\" if an Notification record is persisted, otherwise an error is returned.")

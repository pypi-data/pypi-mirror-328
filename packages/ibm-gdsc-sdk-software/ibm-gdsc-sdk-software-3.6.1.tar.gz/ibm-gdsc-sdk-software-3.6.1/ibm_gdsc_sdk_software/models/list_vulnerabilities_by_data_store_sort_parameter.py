...
class ListVulnerabilitiesByDataStoreSortParameter(BaseModel):
    """
    ...
    def sort_by_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['vulnerabilitiesCount', 'criticalitiesScore']):
            raise ValueError("must be one of enum values ('vulnerabilitiesCount', 'criticalitiesScore')")
        return value

...
class Workflowv3SearchReportsResponse(BaseModel):
    """
    Workflowv3SearchReportsResponse
    """ # noqa: E501
    reports: Optional[List[Workflowv3ReportMetadata]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [Workflowv3ReportMetadata.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj

...
class Templatesv3CreateTemplateResponse(BaseModel):
    """
    ...
    template_id: Optional[StrictStr] = Field(default=None, description="Unique ID for the created template; empty string on failure.")
    __properties: ClassVar[List[str]] = ["status", "template_id"]

...
class Guardiumconnectorv3GetCollectorsConfigResponse(BaseModel):
    """
    Retrieves Collector configurations.
    """ # noqa: E501
    collectors_config: Optional[List[Guardiumconnectorv3CollectorConfig]] = Field(default=None, description="list of collectors.")
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["collectors_config", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collectors_config": [Guardiumconnectorv3CollectorConfig.from_dict(_item) for _item in obj["collectors_config"]] if obj.get("collectors_config") is not None else None,

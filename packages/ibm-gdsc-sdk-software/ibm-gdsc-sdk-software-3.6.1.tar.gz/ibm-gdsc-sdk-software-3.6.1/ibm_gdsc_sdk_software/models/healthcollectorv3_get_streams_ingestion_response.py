...
class Healthcollectorv3GetStreamsIngestionResponse(BaseModel):
    """
    Healthcollectorv3GetStreamsIngestionResponse
    """ # noqa: E501
    streams_ingestion: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["streams_ingestion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "streams_ingestion": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["streams_ingestion"]] if obj.get("streams_ingestion") is not None else None
        })
        return _obj

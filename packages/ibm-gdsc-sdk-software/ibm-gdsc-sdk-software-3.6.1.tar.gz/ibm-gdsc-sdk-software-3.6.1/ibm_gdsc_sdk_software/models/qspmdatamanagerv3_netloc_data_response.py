...
class Qspmdatamanagerv3NetlocDataResponse(BaseModel):
    """
    Qspmdatamanagerv3NetlocDataResponse
    """ # noqa: E501
    netloc_data: Optional[List[Qspmdatamanagerv3NetlocData]] = Field(default=None, alias="netlocData")
    __properties: ClassVar[List[str]] = ["netlocData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "netlocData": [Qspmdatamanagerv3NetlocData.from_dict(_item) for _item in obj["netlocData"]] if obj.get("netlocData") is not None else None
        })
        return _obj

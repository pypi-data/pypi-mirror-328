...
class Tenantuserv3PostRoleRequest(BaseModel):
    """
    Tenantuserv3PostRoleRequest
    """ # noqa: E501
    role: Optional[Tenantuserv3Role] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "role": Tenantuserv3Role.from_dict(obj["role"]) if obj.get("role") is not None else None
        })
        return _obj

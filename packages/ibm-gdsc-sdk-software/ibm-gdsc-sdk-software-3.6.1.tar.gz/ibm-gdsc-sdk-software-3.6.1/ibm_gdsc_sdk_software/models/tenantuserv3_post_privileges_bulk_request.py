...
class Tenantuserv3PostPrivilegesBulkRequest(BaseModel):
    """
    Tenantuserv3PostPrivilegesBulkRequest
    """ # noqa: E501
    privileges: Optional[List[Tenantuserv3Privilege]] = Field(default=None, description="Array of privileges to be created. Use for bulk import of groups, datasources, etc.")
    __properties: ClassVar[List[str]] = ["privileges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privileges": [Tenantuserv3Privilege.from_dict(_item) for _item in obj["privileges"]] if obj.get("privileges") is not None else None
        })
        return _obj

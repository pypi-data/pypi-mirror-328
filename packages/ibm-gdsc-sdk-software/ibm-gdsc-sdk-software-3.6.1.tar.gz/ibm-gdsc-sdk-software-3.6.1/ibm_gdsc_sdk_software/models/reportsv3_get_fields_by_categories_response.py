...
class Reportsv3GetFieldsByCategoriesResponse(BaseModel):
    """
    GetFieldsByCategoriesResponse is the return type of the GetFieldsByCategories() api.
    """ # noqa: E501
    headers: Optional[List[Reportsv3Header]] = Field(default=None, description="Category fields.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": [Reportsv3Header.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None
        })
        return _obj

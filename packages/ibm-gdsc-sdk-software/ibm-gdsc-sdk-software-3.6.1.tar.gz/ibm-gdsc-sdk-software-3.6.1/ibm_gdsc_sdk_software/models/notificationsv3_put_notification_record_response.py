...
class Notificationsv3PutNotificationRecordResponse(BaseModel):
    """
    Response from creating a notifications record.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="result is \"\" if an Notification record has been created, otherwise an error is returned.")

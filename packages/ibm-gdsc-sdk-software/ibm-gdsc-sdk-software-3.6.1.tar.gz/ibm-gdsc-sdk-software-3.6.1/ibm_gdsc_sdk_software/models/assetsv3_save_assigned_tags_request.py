...
class Assetsv3SaveAssignedTagsRequest(BaseModel):
    """
    Assetsv3SaveAssignedTagsRequest
    """ # noqa: E501
    tags_assigned: Optional[List[Assetsv3TagsAssigned]] = None
    __properties: ClassVar[List[str]] = ["tags_assigned"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags_assigned": [Assetsv3TagsAssigned.from_dict(_item) for _item in obj["tags_assigned"]] if obj.get("tags_assigned") is not None else None
        })
        return _obj

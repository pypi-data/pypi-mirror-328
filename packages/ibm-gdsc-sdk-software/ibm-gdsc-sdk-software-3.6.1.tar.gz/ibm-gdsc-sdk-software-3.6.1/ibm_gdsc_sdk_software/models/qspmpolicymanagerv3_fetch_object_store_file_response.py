...
class Qspmpolicymanagerv3FetchObjectStoreFileResponse(BaseModel):
    """
    ...
    file_name: Optional[List[StrictStr]] = Field(default=None, alias="fileName")
    __properties: ClassVar[List[str]] = ["BucketName", "FolderName", "fileName"]

...
class Healthcollectorv3GetTopGDPCollectorsResponse(BaseModel):
    """
    Healthcollectorv3GetTopGDPCollectorsResponse
    """ # noqa: E501
    top_gdp_collectors: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["top_gdp_collectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "top_gdp_collectors": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["top_gdp_collectors"]] if obj.get("top_gdp_collectors") is not None else None
        })
        return _obj

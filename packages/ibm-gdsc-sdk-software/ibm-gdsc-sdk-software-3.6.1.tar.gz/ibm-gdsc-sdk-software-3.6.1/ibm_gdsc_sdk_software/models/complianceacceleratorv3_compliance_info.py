...
class Complianceacceleratorv3ComplianceInfo(BaseModel):
    """
    Compliance data.
    """ # noqa: E501
    options: Optional[Complianceacceleratorv3Options] = None
    workspaces: Optional[Dict[str, Complianceacceleratorv3Workspace]] = None
    __properties: ClassVar[List[str]] = ["options", "workspaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "options": Complianceacceleratorv3Options.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "workspaces": dict(
                (_k, Complianceacceleratorv3Workspace.from_dict(_v))

...
class Groupbuilderv3GetGroupMembersResponse(BaseModel):
    """
    Get Group members response returns all the group members of the specified group ids.
    """ # noqa: E501
    groups: Optional[List[Groupbuilderv3Group]] = Field(default=None, description="List of group objects with members.")

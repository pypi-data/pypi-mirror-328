...
class Templatesv3UpdateTemplateRequest(BaseModel):
    """
    Request to update the specified template, the id must be specified and exist for the update to complete.
    """ # noqa: E501
    template: Optional[Templatesv3Template] = None
    template_id: Optional[StrictStr] = Field(default=None, description="The template id to update.")
    __properties: ClassVar[List[str]] = ["template", "template_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": Templatesv3Template.from_dict(obj["template"]) if obj.get("template") is not None else None,

...
class Jumpboxv3SearchUsersResponse(BaseModel):
    """
    Jumpboxv3SearchUsersResponse
    """ # noqa: E501
    message: Optional[StrictStr] = None
    users: Optional[List[Jumpboxv3DirectoryEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [Jumpboxv3DirectoryEntry.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj

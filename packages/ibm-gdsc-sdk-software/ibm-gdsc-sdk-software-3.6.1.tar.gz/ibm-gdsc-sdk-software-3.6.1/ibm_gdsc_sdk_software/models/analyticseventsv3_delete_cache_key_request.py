...
class Analyticseventsv3DeleteCacheKeyRequest(BaseModel):
    """
    DeleteCacheKeyRequest message for delete /api/v3/eventscache/{cache_key}.
    """ # noqa: E501
    cache_key: Optional[StrictStr] = Field(default=None, description="The cache key to delete.")
    __properties: ClassVar[List[str]] = ["cache_key"]

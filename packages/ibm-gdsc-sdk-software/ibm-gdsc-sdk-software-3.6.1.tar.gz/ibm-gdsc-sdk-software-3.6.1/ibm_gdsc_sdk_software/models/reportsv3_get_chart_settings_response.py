...
class Reportsv3GetChartSettingsResponse(BaseModel):
    """
    GetChartSettingsResponse is the return type which encapsulates a chart settings from the GetChartSettings() api.
    """ # noqa: E501
    chart_settings: Optional[List[Reportsv3ChartSettings]] = Field(default=None, description="A new report definition.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chart_settings": [Reportsv3ChartSettings.from_dict(_item) for _item in obj["chart_settings"]] if obj.get("chart_settings") is not None else None
        })
        return _obj

...
class StreamResultOfReportsrunnerv3RunReportResponse(BaseModel):
    """
    StreamResultOfReportsrunnerv3RunReportResponse
    """ # noqa: E501
    error: Optional[RuntimeStreamError] = None
    result: Optional[Reportsrunnerv3RunReportResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": Reportsrunnerv3RunReportResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj

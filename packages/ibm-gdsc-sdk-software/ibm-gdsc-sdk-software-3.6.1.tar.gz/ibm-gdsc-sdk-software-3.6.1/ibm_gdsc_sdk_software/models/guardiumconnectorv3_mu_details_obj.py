...
class Guardiumconnectorv3MUDetailsObj(BaseModel):
    """
    Additional information about Managed Units.
    """ # noqa: E501
    agg_health_view_list: Optional[List[Guardiumconnectorv3AggregationViewListObject]] = Field(default=None, description="Aggregation details.")
    ...
    utilization_scheme: Optional[Guardiumconnectorv3UtilizationParameterObject] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agg_health_view_list": [Guardiumconnectorv3AggregationViewListObject.from_dict(_item) for _item in obj["agg_health_view_list"]] if obj.get("agg_health_view_list") is not None else None,
            ...
            "utilization_scheme": Guardiumconnectorv3UtilizationParameterObject.from_dict(obj["utilization_scheme"]) if obj.get("utilization_scheme") is not None else None
        })
        return _obj

...
class Groupbuilderv3GetImportGroupsResponse(BaseModel):
    """
    GetGroupsResponse returns filtered groups from a Guardium Data Protection central manager.
    """ # noqa: E501
    groups: Optional[List[Groupbuilderv3Group]] = Field(default=None, description="Group information returned from the central manager.")

...
class AuthserverListOauthClientResponse(BaseModel):
    """
    Response parameters for list oauth client.
    """ # noqa: E501
    oauth_clients: Optional[List[AuthserverOauthClient]] = Field(default=None, description="List of base oauth client object.")
    __properties: ClassVar[List[str]] = ["oauth_clients"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oauth_clients": [AuthserverOauthClient.from_dict(_item) for _item in obj["oauth_clients"]] if obj.get("oauth_clients") is not None else None
        })
        return _obj

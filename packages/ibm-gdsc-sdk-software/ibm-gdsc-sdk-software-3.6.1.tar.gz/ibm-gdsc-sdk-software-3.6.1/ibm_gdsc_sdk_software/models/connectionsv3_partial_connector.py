...
class Connectionsv3PartialConnector(BaseModel):
    """
    Partial connector.
    """ # noqa: E501
    columns: Optional[List[Connectionsv3ConnectorColumn]] = Field(default=None, description="The updated columns.")
    ...
    tags: Optional[List[StrictStr]] = Field(default=None, description="The updated tags.")
    __properties: ClassVar[List[str]] = ["columns", "id", "last_response", "tags"]

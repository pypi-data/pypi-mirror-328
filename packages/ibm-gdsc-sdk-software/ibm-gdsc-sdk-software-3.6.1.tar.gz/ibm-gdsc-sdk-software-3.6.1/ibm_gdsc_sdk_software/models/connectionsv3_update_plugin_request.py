...
class Connectionsv3UpdatePluginRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["datasource_type", "developer_name", "id", "logfile", "name", "readme", "records", "state", "supported_inputs"]

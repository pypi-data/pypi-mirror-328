...
class Outliersenginev3UpdateWorkingHoursPeriodsRequest(BaseModel):
    """
    UpdateWorkingHoursPeriodsRequest is the request object for UpdateWorkingHoursPeriods API.
    """ # noqa: E501
    period: Optional[Outliersenginev3WorkingHoursPeriod] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "period": Outliersenginev3WorkingHoursPeriod.from_dict(obj["period"]) if obj.get("period") is not None else None
        })
        return _obj

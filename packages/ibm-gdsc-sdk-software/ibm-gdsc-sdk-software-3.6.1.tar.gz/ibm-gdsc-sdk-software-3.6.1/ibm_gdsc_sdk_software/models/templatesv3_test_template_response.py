...
class Templatesv3TestTemplateResponse(BaseModel):
    """
    Returns the results of the template being processed or empty string (with error) when not able to process.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="Result is a fully formatted example of the template; empty string on error.")

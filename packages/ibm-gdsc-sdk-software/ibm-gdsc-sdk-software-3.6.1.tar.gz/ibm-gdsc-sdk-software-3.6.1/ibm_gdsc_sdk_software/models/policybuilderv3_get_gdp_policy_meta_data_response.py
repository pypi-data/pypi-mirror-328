...
class Policybuilderv3GetGdpPolicyMetaDataResponse(BaseModel):
    """
    Policybuilderv3GetGdpPolicyMetaDataResponse
    """ # noqa: E501
    policies: Optional[List[Policybuilderv3GdpPolicyObjectWithCm]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [Policybuilderv3GdpPolicyObjectWithCm.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,

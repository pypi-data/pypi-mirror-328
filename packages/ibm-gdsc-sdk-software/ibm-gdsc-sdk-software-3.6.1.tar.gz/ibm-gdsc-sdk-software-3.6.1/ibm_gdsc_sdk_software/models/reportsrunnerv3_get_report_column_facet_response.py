...
class Reportsrunnerv3GetReportColumnFacetResponse(BaseModel):
    """
    GetReportDataCountResponse is the argument get counts for given column.
    """ # noqa: E501
    facet: Optional[List[Reportsrunnerv3Filter]] = None
    facet_selected_header: Optional[Reportsv3ReportHeader] = None
    __properties: ClassVar[List[str]] = ["facet", "facet_selected_header"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "facet": [Reportsrunnerv3Filter.from_dict(_item) for _item in obj["facet"]] if obj.get("facet") is not None else None,

...
class Workflowv3GetJobsCountResponse(BaseModel):
    """
    Workflowv3GetJobsCountResponse
    """ # noqa: E501
    counts: Optional[List[Workflowv3JobCount]] = None
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["counts", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [Workflowv3JobCount.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None,

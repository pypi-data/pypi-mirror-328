...
class RuntimeStreamError(BaseModel):
    ...
    grpc_code: Optional[StrictInt] = None
    http_code: Optional[StrictInt] = None
    http_status: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["details", "grpc_code", "http_code", "http_status", "message"]

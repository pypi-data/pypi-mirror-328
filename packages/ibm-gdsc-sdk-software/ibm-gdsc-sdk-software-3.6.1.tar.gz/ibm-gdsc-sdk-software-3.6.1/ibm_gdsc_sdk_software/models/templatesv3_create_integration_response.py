...
class Templatesv3CreateIntegrationResponse(BaseModel):
    """
    Response with the generated templates for the new integration.
    """ # noqa: E501
    status: Optional[RpcStatus] = None
    templates: Optional[List[Templatesv3Template]] = Field(default=None, description="New templates created with default values for the new integration.")
    __properties: ClassVar[List[str]] = ["status", "templates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "templates": [Templatesv3Template.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj

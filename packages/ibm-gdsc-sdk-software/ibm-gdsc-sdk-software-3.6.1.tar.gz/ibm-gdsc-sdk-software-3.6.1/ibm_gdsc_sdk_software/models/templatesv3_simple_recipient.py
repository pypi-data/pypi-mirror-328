...
class Templatesv3SimpleRecipient(BaseModel):
    """
    SimpleRecipient is specified for integrations that require a default contact when one is not explicitly defined.
    """ # noqa: E501
    recipient_type: Optional[SimpleRecipientSimpleRecipientType] = None
    value: Optional[StrictStr] = Field(default=None, description="Value is a comma separated list of Insights USER ids or EMAIL addresses or a single GROUP name.")
    __properties: ClassVar[List[str]] = ["recipient_type", "value"]

...
class Riskanalyticsenginev3GetLeadGeneratorConfigResponse(BaseModel):
    """
    GetLeadGeneratorConfigResponse is the response object for GetLeadGeneratorConfig API.
    """ # noqa: E501
    configs: Optional[List[Riskanalyticsenginev3LeadGeneratorConfig]] = Field(default=None, description="A list of lead generator configs from the risk analytics engine.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [Riskanalyticsenginev3LeadGeneratorConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj

...
class Datamartprocessorv3GetDatamartResponse(BaseModel):
    """
    GetDatamartResponse is the response message which will have all the datamarts for a time period.
    """ # noqa: E501
    datamarts: Optional[List[Datamartprocessorv3DatamartInfo]] = Field(default=None, description="List of datamarts returned by GetDatamarts().")
    status: Optional[Datamartprocessorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["datamarts", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datamarts": [Datamartprocessorv3DatamartInfo.from_dict(_item) for _item in obj["datamarts"]] if obj.get("datamarts") is not None else None,

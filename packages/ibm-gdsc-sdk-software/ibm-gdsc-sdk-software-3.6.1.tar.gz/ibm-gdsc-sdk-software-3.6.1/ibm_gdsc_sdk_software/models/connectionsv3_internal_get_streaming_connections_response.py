...
class Connectionsv3InternalGetStreamingConnectionsResponse(BaseModel):
    """
    Connectionsv3InternalGetStreamingConnectionsResponse
    """ # noqa: E501
    streaming_configs_by_tenants: Optional[List[Connectionsv3StreamingConfigsByTenant]] = None
    __properties: ClassVar[List[str]] = ["streaming_configs_by_tenants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "streaming_configs_by_tenants": [Connectionsv3StreamingConfigsByTenant.from_dict(_item) for _item in obj["streaming_configs_by_tenants"]] if obj.get("streaming_configs_by_tenants") is not None else None
        })
        return _obj

...
class Assetsv3GetFiltersDataResponse(BaseModel):
    """
    GetFiltersDataResponse - Response message for Manage Asset Filter Panel data api.
    """ # noqa: E501
    category: Optional[List[Assetsv3Category]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": [Assetsv3Category.from_dict(_item) for _item in obj["category"]] if obj.get("category") is not None else None
        })
        return _obj

...
class Workflowv3GetReportResultResponse(BaseModel):
    """
    Workflowv3GetReportResultResponse
    """ # noqa: E501
    result: Optional[Workflowv3ReportResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": Workflowv3ReportResult.from_dict(obj["result"]) if obj.get("result") is not None else None,

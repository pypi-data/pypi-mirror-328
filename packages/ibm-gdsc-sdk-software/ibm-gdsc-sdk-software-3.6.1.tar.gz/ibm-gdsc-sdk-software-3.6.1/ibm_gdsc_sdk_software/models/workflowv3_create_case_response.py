...
class Workflowv3CreateCaseResponse(BaseModel):
    """
    Returns the ids of the cases created.
    """ # noqa: E501
    created: Optional[StrictStr] = Field(default=None, description="Case_id that was created.")
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["created", "status"]

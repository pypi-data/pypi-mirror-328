...
class Reportsv3ReportAggFilter(BaseModel):
    """
    Reportsv3ReportAggFilter
    """ # noqa: E501
    condition: Optional[Reportsv3ReportAggFilterCondition] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "condition": Reportsv3ReportAggFilterCondition.from_dict(obj["condition"]) if obj.get("condition") is not None else None
        })
        return _obj

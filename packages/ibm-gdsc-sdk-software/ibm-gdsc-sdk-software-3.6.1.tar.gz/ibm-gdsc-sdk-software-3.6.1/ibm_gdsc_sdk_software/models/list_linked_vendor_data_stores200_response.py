...
class ListLinkedVendorDataStores200Response(BaseModel):
    """
    ListLinkedVendorDataStores200Response
    """ # noqa: E501
    results: Optional[List[VendorDataStore]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [VendorDataStore.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

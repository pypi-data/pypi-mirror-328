...
class Healthcollectorv3GetGDPHealthInfoResponse(BaseModel):
    """
    Healthcollectorv3GetGDPHealthInfoResponse
    """ # noqa: E501
    all_nodes: Optional[List[Healthcollectorv3CMNodeObject]] = Field(default=None, description="List of managed units and monitoring agents associated with the central manager.")
    status: Optional[Healthcollectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["all_nodes", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all_nodes": [Healthcollectorv3CMNodeObject.from_dict(_item) for _item in obj["all_nodes"]] if obj.get("all_nodes") is not None else None,

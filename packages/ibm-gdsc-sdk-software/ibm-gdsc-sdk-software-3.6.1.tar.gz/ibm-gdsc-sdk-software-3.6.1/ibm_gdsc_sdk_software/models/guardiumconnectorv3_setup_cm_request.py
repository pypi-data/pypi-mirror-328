...
class Guardiumconnectorv3SetupCMRequest(BaseModel):
    ...
    cm_hostname: Optional[StrictStr] = Field(default=None, description="Central Manager hostname.")
    cm_ip: Optional[StrictStr] = Field(default=None, description="Central Manager IP.")
    push_registration: Optional[StrictBool] = Field(default=None, description="Attribute used to distinguish between old mode (pull) and new SaaS mode (push) used during registration.")
    __properties: ClassVar[List[str]] = ["attributes", "cm_gid", "cm_hostname", "cm_ip", "push_registration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cm_gid": obj.get("cm_gid"),
            "cm_hostname": obj.get("cm_hostname"),
            "cm_ip": obj.get("cm_ip"),
            "push_registration": obj.get("push_registration")
        })
        return _obj

...
class Guardiumconnectorv3GetDmExclusionResponse(BaseModel):
    """
    Returns List of datamarts in exclusion list.
    """ # noqa: E501
    datamart_list: Optional[List[StrictStr]] = Field(default=None, description="Datamart list.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["datamart_list", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datamart_list": obj.get("datamart_list"),

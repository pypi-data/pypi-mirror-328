...
class Guardiumconnectorv3GetTaskTypesResponse(BaseModel):
    """
    GetTaskTypes response message and returned list of task types.
    """ # noqa: E501
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    task_types: Optional[List[Guardiumconnectorv3TaskType]] = Field(default=None, description="List of supported task types.")
    __properties: ClassVar[List[str]] = ["status", "task_types"]

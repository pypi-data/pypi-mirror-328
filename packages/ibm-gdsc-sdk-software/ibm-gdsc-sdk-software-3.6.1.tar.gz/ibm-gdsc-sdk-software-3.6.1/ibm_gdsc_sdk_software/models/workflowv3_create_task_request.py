...
class Workflowv3CreateTaskRequest(BaseModel):
    """
    Create new tasks.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Create tasks with common parent.")
    task: Optional[Workflowv3TaskCreate] = None
    __properties: ClassVar[List[str]] = ["case_id", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": Workflowv3TaskCreate.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
        return _obj

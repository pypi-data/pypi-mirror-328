...
class Guardiumconnectorv3GDPReportResultRow(BaseModel):
    """
    Represents a single result row of a report.
    """ # noqa: E501
    columns: Optional[List[Guardiumconnectorv3GDPReportResultColumn]] = Field(default=None, description="Set of result row cells.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [Guardiumconnectorv3GDPReportResultColumn.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj

...
class Jumpboxv3Tenant(BaseModel):
    """
    Tenant contains id, name, and settings for the specified tenant.
    """ # noqa: E501
    activation_date: Optional[datetime] = Field(default=None, description="Date tenant was activated.")
    external_id: Optional[StrictStr] = Field(default=None, description="Extrenal id.")
    external_metadata: Optional[Dict[str, Tenantuserv3ExternalMetadata]] = Field(default=None, description="External metadata.")
    is_inactive: Optional[StrictBool] = Field(default=None, description="Whether or not the tenant is disabled.")
    is_ready: Optional[StrictBool] = Field(default=None, description="Boolean is ready.")
    name: Optional[StrictStr] = Field(default=None, description="The descriptive name.")

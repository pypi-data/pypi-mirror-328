...
class Workflowv3SearchCasesRequest(BaseModel):
    """
    ...
    with_latest: Optional[StrictBool] = Field(default=None, description="Optional: Cases that runs most latestly.")
    __properties: ClassVar[List[str]] = ["filter", "limit", "offset", "with_latest"]

...
class Guardiumconnectorv3ExtractionProfile(BaseModel):
    """
    Guardiumconnectorv3ExtractionProfile
    """ # noqa: E501
    active: Optional[StrictStr] = None
    category: Optional[StrictStr] = None
    dms: Optional[List[Guardiumconnectorv3Datamarts]] = None
    profile_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["active", "category", "dms", "profile_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dms": [Guardiumconnectorv3Datamarts.from_dict(_item) for _item in obj["dms"]] if obj.get("dms") is not None else None,

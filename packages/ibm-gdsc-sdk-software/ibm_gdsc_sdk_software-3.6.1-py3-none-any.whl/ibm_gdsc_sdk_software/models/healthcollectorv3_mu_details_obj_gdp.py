...
class Healthcollectorv3MUDetailsObjGdp(BaseModel):
    """
    MUDetailObj gets additional information about managed units.
    """ # noqa: E501
    agg_health_view_list: Optional[List[Healthcollectorv3AggregationDetailsObjectGdp]] = Field(default=None, description="Aggregation details.")
    ...
    utilization_scheme: Optional[Healthcollectorv3UtilizationParameterObjectGdp] = None
    __properties: ClassVar[List[str]] = ["agg_health_view_list", "connectivity_details", "general_err_messages", "utilization_scheme"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of utilization_scheme
        if self.utilization_scheme:
            _dict['utilization_scheme'] = self.utilization_scheme.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agg_health_view_list": [Healthcollectorv3AggregationDetailsObjectGdp.from_dict(_item) for _item in obj["agg_health_view_list"]] if obj.get("agg_health_view_list") is not None else None,
            ...
            "utilization_scheme": Healthcollectorv3UtilizationParameterObjectGdp.from_dict(obj["utilization_scheme"]) if obj.get("utilization_scheme") is not None else None
        })
        return _obj

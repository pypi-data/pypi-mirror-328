...
class Assetsv3AssetOpenRiskEventList(BaseModel):
    """
    Assetsv3AssetOpenRiskEventList
    """ # noqa: E501
    event_type: Optional[StrictStr] = None
    expandable: Optional[StrictBool] = None
    value: Optional[List[Assetsv3AssetOpenRiskEvent]] = None
    __properties: ClassVar[List[str]] = ["event_type", "expandable", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Assetsv3AssetOpenRiskEvent.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj

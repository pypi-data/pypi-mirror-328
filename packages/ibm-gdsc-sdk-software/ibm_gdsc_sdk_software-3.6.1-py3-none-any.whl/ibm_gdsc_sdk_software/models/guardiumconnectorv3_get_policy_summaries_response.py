...
class Guardiumconnectorv3GetPolicySummariesResponse(BaseModel):
    """
    Guardiumconnectorv3GetPolicySummariesResponse
    """ # noqa: E501
    policy_data: Optional[List[Guardiumconnectorv3GdpPolicyObject]] = None
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["policy_data", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy_data": [Guardiumconnectorv3GdpPolicyObject.from_dict(_item) for _item in obj["policy_data"]] if obj.get("policy_data") is not None else None,

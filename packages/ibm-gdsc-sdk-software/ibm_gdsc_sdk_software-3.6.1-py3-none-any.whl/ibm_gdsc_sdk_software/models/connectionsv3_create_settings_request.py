...
class Connectionsv3CreateSettingsRequest(BaseModel):
    """
    Connectionsv3CreateSettingsRequest
    """ # noqa: E501
    settings: Optional[List[Connectionsv3ConnectorSetting]] = Field(default=None, description="The list of settings to create.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [Connectionsv3ConnectorSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj

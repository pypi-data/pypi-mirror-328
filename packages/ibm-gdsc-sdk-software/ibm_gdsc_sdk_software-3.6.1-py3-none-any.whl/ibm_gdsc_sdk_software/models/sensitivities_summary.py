...
class SensitivitiesSummary(BaseModel):
    """
    SensitivitiesSummary
    """ # noqa: E501
    sensitivities_count: Union[StrictFloat, StrictInt] = Field(alias="sensitivitiesCount")
    sensitivities_summary: List[SensitivitySummary] = Field(alias="sensitivitiesSummary")
    __properties: ClassVar[List[str]] = ["sensitivitiesCount", "sensitivitiesSummary"]

...
class Connectionsv3GetConnectorsSummaryResponse(BaseModel):
    """
    Connectionsv3GetConnectorsSummaryResponse
    """ # noqa: E501
    connectors: Optional[List[Connectionsv3ConnectorSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": [Connectionsv3ConnectorSummary.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None,

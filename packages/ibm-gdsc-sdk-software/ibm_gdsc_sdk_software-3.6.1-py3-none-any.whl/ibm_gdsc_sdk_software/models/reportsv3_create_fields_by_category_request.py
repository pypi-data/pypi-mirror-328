...
class Reportsv3CreateFieldsByCategoryRequest(BaseModel):
    """
    Reportsv3CreateFieldsByCategoryRequest
    """ # noqa: E501
    fields: Optional[List[Reportsv3CategoryField]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [Reportsv3CategoryField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj

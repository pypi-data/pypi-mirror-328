...
class Connectionsv3GetGuardRecordFieldsResponse(BaseModel):
    """
    Connectionsv3GetGuardRecordFieldsResponse
    """ # noqa: E501
    fields: Optional[List[Connectionsv3GuardRecordField]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [Connectionsv3GuardRecordField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,

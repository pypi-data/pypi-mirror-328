...
class Policybuilderv3GetPoliciesResponse(BaseModel):
    """
    GetPoliciesResponse is the response message which will have all the policies in GI.
    """ # noqa: E501
    policies: Optional[List[Policybuilderv3Policy]] = Field(default=None, description="List of policies returned by GetPolcies().")
    status: Optional[Policybuilderv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["policies", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [Policybuilderv3Policy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,

...
class Reportsv3GetReportGroupsResponse(BaseModel):
    """
    GetGroupsInUseResponse is the return type for the GetGroupsInUse API.
    """ # noqa: E501
    groups: Optional[List[GetReportGroupsResponseReportGroups]] = Field(default=None, description="Contains all the provided group ID's along with the name and ID of reports using that group id.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GetReportGroupsResponseReportGroups.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj

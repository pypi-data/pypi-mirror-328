...
class VulnerabilitiesSummaryStatusTypeCountInner(BaseModel):
    """
    VulnerabilitiesSummaryStatusTypeCountInner
    """ # noqa: E501
    status_type: VulnerabilityStatusType = Field(alias="statusType")
    count: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["statusType", "count"]

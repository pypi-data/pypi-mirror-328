...
class AccessibleDataStores(BaseModel):
    """
    ...
    cloud_location: StrictStr = Field(alias="cloudLocation")
    permissions: List[AccessType]
    sensitivities_summary: List[SensitivitySummary] = Field(alias="sensitivitiesSummary")
    __properties: ClassVar[List[str]] = ["id", "name", "type", "cloudProvider", "cloudLocation", "permissions", "sensitivitiesSummary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudLocation": obj.get("cloudLocation"),

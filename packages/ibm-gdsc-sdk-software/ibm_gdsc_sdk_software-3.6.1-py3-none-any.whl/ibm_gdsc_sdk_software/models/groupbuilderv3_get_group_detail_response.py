...
class Groupbuilderv3GetGroupDetailResponse(BaseModel):
    """
    GetGroupDetailResponse returns details for a specific group identified by group ID.
    """ # noqa: E501
    detail: Optional[Groupbuilderv3Group] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": Groupbuilderv3Group.from_dict(obj["detail"]) if obj.get("detail") is not None else None,

...
class Auditv3PutActivityRecordResponse(BaseModel):
    """
    PutActivityRecordResponse indicates if the activity log record was created.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="Result is \"\" if an activity log record is created, otherwise an error is returned.")

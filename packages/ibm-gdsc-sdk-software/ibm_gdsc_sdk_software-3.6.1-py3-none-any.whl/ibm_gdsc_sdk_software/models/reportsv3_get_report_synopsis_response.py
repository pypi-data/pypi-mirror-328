...
class Reportsv3GetReportSynopsisResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": Reportsv3BriefReport.from_dict(obj["report"]) if obj.get("report") is not None else None
        })
        return _obj

...
class Guardiumconnectorv3GetSyncDMsResponse(BaseModel):
    """
    GetSyncDMsResponse returns the array of param name/value pairs.
    """ # noqa: E501
    params: Optional[List[Guardiumconnectorv3Params]] = Field(default=None, description="Array of key value pair parameters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "params": [Guardiumconnectorv3Params.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None
        })
        return _obj

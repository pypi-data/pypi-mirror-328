...
class Guardiumconnectorv3SetupCMResponse(BaseModel):
    ...
    tasks: Optional[List[Guardiumconnectorv3TaskObject]] = Field(default=None, description="List of Tasks associated with the Central Manager.")
    __properties: ClassVar[List[str]] = ["response", "response_code", "tasks"]

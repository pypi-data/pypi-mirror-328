...
class Universalconnectormanagerv3DatasourceResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    datasource_id: Optional[StrictStr] = Field(default=None, description="Configuration id of datasource.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["datasource_id", "status"]

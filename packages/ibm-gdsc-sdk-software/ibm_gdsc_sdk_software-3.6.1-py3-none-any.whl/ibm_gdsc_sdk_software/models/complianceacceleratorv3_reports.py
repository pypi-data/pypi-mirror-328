...
class Complianceacceleratorv3Reports(BaseModel):
    """
    Reports object.
    """ # noqa: E501
    reports: Optional[List[Complianceacceleratorv3Report]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [Complianceacceleratorv3Report.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj

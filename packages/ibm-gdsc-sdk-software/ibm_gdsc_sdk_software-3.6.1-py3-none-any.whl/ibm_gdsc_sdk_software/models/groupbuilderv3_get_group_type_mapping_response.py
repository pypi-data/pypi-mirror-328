...
class Groupbuilderv3GetGroupTypeMappingResponse(BaseModel):
    """
    Response object for group types mapping.
    """ # noqa: E501
    status: Optional[Groupbuilderv3StatusResponseBase] = None
    type_map: Optional[Dict[str, StrictInt]] = Field(default=None, description="Map of gdp to gi group type mapping objects.")
    __properties: ClassVar[List[str]] = ["status", "type_map"]

...
class Groupbuilderv3GetGroupTypesResponse(BaseModel):
    """
    GetGroupTypesResponse returns the list of available group types.
    """ # noqa: E501
    group_types: Optional[List[Groupbuilderv3GroupType]] = Field(default=None, description="List of available group types.")
    status: Optional[Groupbuilderv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["group_types", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group_types": [Groupbuilderv3GroupType.from_dict(_item) for _item in obj["group_types"]] if obj.get("group_types") is not None else None,

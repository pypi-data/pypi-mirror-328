...
class Healthcollectorv3GetPVCUsageResponse(BaseModel):
    """
    Healthcollectorv3GetPVCUsageResponse
    """ # noqa: E501
    pvc_usage: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["pvc_usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pvc_usage": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["pvc_usage"]] if obj.get("pvc_usage") is not None else None
        })
        return _obj

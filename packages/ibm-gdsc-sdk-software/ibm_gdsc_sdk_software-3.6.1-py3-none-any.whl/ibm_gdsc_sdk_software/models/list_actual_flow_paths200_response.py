...
class ListActualFlowPaths200Response(BaseModel):
    """
    ListActualFlowPaths200Response
    """ # noqa: E501
    results: List[ActualFlowPath]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ActualFlowPath.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class Notificationsv3TestIntegrationResponse(BaseModel):
    """
    Response from test of an SMTP configuration.  A translated response is provided to provide status of the test.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="The result is \"\" if the operation is a success, otherwise a translated error is returned.")

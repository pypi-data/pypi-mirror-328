...
class Assetsv3AssetClassification(BaseModel):
    """
    Assetsv3AssetClassification
    """ # noqa: E501
    classification: Optional[List[Assetsv3ClassificationData]] = None
    last_activity: Optional[StrictStr] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["classification", "last_activity", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classification": [Assetsv3ClassificationData.from_dict(_item) for _item in obj["classification"]] if obj.get("classification") is not None else None,

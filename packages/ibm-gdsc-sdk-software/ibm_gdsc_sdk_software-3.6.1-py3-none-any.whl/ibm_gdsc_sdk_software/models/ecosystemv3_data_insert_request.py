...
class Ecosystemv3DataInsertRequest(BaseModel):
    """
    Requires dataset name, fields and data to be inserted.
    """ # noqa: E501
    dataset_name: Optional[StrictStr] = Field(default=None, description="Data set target name.")
    entries: Optional[List[Ecosystemv3DataEntry]] = Field(default=None, description="Data set entries to insert.")
    __properties: ClassVar[List[str]] = ["dataset_name", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [Ecosystemv3DataEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj

...
class Guardiumconnectorv3GetPolicyInfoResponse(BaseModel):
    """
    Guardiumconnectorv3GetPolicyInfoResponse
    """ # noqa: E501
    policy_data: Optional[Guardiumconnectorv3PolicyData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy_data": Guardiumconnectorv3PolicyData.from_dict(obj["policy_data"]) if obj.get("policy_data") is not None else None,

...
class Guardiumconnectorv3SetupDatamartsRequest(BaseModel):
    """
    Guardiumconnectorv3SetupDatamartsRequest
    """ # noqa: E501
    central_manager_id: Optional[StrictStr] = None
    datamarts: Optional[List[Guardiumconnectorv3DatamartExecutionMode]] = None
    __properties: ClassVar[List[str]] = ["central_manager_id", "datamarts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datamarts": [Guardiumconnectorv3DatamartExecutionMode.from_dict(_item) for _item in obj["datamarts"]] if obj.get("datamarts") is not None else None
        })
        return _obj

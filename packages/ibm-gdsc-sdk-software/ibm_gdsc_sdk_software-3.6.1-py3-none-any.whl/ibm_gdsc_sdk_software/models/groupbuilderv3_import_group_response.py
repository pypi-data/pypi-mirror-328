...
class Groupbuilderv3ImportGroupResponse(BaseModel):
    """
    ImportGroupResponse returns the specific groups imported from a Guardium Data Protection central manager.
    """ # noqa: E501
    groups: Optional[List[Groupbuilderv3Group]] = Field(default=None, description="Content of the imported groups.")

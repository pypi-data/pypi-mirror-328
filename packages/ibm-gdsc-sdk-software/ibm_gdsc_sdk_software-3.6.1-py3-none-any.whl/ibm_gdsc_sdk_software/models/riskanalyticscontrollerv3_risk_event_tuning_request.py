...
class Riskanalyticscontrollerv3RiskEventTuningRequest(BaseModel):
    """
    RiskEventTuningRequest is the request object for RiskEventTuning API.
    """ # noqa: E501
    excluded_items: Optional[List[Riskanalyticscontrollerv3ExcludedItem]] = Field(default=None, description="Excluded items array.")
    __properties: ClassVar[List[str]] = ["excluded_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "excluded_items": [Riskanalyticscontrollerv3ExcludedItem.from_dict(_item) for _item in obj["excluded_items"]] if obj.get("excluded_items") is not None else None
        })
        return _obj

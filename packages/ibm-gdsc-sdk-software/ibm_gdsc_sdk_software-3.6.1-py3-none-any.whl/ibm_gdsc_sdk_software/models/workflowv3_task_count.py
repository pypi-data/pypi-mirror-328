...
class Workflowv3TaskCount(BaseModel):
    """
    Workflowv3TaskCount
    """ # noqa: E501
    counts: Optional[List[Workflowv3StatusCount]] = None
    scheduled_task_id: Optional[StrictStr] = Field(default=None, description="The task within the ScheduledJob.")
    __properties: ClassVar[List[str]] = ["counts", "scheduled_task_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [Workflowv3StatusCount.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None,

...
class Assetsv3SaveTagDomainDataRequest(BaseModel):
    """
    Assetsv3SaveTagDomainDataRequest
    """ # noqa: E501
    category: Optional[Assetsv3TagCategory] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": Assetsv3TagCategory.from_dict(obj["category"]) if obj.get("category") is not None else None
        })
        return _obj

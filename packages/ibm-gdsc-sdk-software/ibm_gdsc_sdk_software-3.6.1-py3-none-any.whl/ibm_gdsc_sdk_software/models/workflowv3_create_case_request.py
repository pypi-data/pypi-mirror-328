...
class Workflowv3CreateCaseRequest(BaseModel):
    """
    Create a new case.
    """ # noqa: E501
    case: Optional[Workflowv3CaseEdit] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "case": Workflowv3CaseEdit.from_dict(obj["case"]) if obj.get("case") is not None else None
        })
        return _obj

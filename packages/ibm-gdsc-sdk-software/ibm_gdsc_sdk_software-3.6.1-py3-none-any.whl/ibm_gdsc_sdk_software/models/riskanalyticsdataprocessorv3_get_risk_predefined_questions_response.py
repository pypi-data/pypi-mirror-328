...
class Riskanalyticsdataprocessorv3GetRiskPredefinedQuestionsResponse(BaseModel):
    """
    GetRiskPredefinedQuestionsResponse message for the GetRiskPredefinedQuestions api.
    """ # noqa: E501
    questions: Optional[List[Riskanalyticsdataprocessorv3Question]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "questions": [Riskanalyticsdataprocessorv3Question.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None
        })
        return _obj

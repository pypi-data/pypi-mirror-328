...
class Groupbuilderv3CreateGroupResponse(BaseModel):
    """
    CreateGroupResponse returns the group ID of a new group.
    """ # noqa: E501
    new_group_id: Optional[StrictInt] = Field(default=None, description="New group ID.")
    status: Optional[Groupbuilderv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["new_group_id", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "new_group_id": obj.get("new_group_id"),

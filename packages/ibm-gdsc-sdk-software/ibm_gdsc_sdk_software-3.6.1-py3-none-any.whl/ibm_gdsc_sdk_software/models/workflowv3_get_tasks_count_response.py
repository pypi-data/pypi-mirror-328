...
class Workflowv3GetTasksCountResponse(BaseModel):
    """
    Returns task count.
    """ # noqa: E501
    counts: Optional[List[Workflowv3TaskCount]] = Field(default=None, description="Total Rows Count.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [Workflowv3TaskCount.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None
        })
        return _obj

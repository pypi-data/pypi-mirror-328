...
class Riskanalyticsmlclassificationv3RuleSetList(BaseModel):
    """
    RuleSetList message for the response of GetClassificationModel api.
    """ # noqa: E501
    rule_set_list: Optional[List[Riskanalyticsmlclassificationv3RuleSet]] = None
    __properties: ClassVar[List[str]] = ["rule_set_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rule_set_list": [Riskanalyticsmlclassificationv3RuleSet.from_dict(_item) for _item in obj["rule_set_list"]] if obj.get("rule_set_list") is not None else None
        })
        return _obj

...
class Groupbuilderv3GetGroupSyncMappingResponse(BaseModel):
    """
    Response object for group types mapping.
    """ # noqa: E501
    group_map: Optional[Dict[str, StrictInt]] = Field(default=None, description="Map of gdp to gi group type mapping objects.")
    status: Optional[Groupbuilderv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["group_map", "status"]

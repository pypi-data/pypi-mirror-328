...
class Reportsv3GetReportQueryResponse(BaseModel):
    """
    GetReportQueryResponse is the return type of the GetQueryByReportID() and GetQueryByReportDefinition() apis.
    """ # noqa: E501
    query: Optional[StrictStr] = Field(default=None, description="The report's query.")
    report_layout: Optional[Reportsv3ReportDisplayLayout] = None
    __properties: ClassVar[List[str]] = ["query", "report_layout"]

...
class Guardiumconnectorv3UpdateStreamingRequest(BaseModel):
    """
    ...
    records: Optional[List[Guardiumconnectorv3StatusRecord]] = Field(default=None, description="Status records pushed from GDP.")
    status: Optional[StrictStr] = Field(default=None, description="Status response from GDP grdapi.")
    __properties: ClassVar[List[str]] = ["central_manager_id", "records", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [Guardiumconnectorv3StatusRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,

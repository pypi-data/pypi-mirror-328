...
class Notificationsv3GetFoldersResponse(BaseModel):
    """
    Response from test of an SMTP configuration.  A translated response is provided to provide status of the test.
    """ # noqa: E501
    folders: Optional[List[StrictStr]] = Field(default=None, description="The folders retrieved is returned here as an array of name strings.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["folders", "status"]

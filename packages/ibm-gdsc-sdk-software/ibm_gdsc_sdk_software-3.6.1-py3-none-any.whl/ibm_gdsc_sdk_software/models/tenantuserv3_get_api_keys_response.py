...
class Tenantuserv3GetApiKeysResponse(BaseModel):
    """
    GetApiKeysResponse message for Get APIKeys api.
    """ # noqa: E501
    apikeys: Optional[List[Tenantuserv3Apikey]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apikeys": [Tenantuserv3Apikey.from_dict(_item) for _item in obj["apikeys"]] if obj.get("apikeys") is not None else None
        })
        return _obj

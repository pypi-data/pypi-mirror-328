...
class CloudAccountDetails(BaseModel):
    ...
    cloud_account_name: Optional[StrictStr] = Field(default=None, alias="cloudAccountName")
    service_provider: Optional[ServiceProvider] = Field(default=None, alias="serviceProvider")
    __properties: ClassVar[List[str]] = ["cloudAccountId", "cloudAccountName", "serviceProvider"]

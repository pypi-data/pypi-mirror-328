...
class Guardiumconnectorv3TaskDefinition(BaseModel):
    """
    Task defifnition executed by GDP.
    """ # noqa: E501
    task_id: Optional[StrictStr] = Field(default=None, description="Task id.")
    task_params: Optional[List[Guardiumconnectorv3TaskParamsObject]] = Field(default=None, description="Parameters passed top the task.")
    task_type: Optional[StrictStr] = Field(default=None, description="Task type.")
    __properties: ClassVar[List[str]] = ["task_id", "task_params", "task_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task_params": [Guardiumconnectorv3TaskParamsObject.from_dict(_item) for _item in obj["task_params"]] if obj.get("task_params") is not None else None,

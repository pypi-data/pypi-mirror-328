...
class ListSensitivitiesFilterParameter(BaseModel):
    """
    ...
    sensitive_tag: Optional[StrictStr] = Field(default=None, alias="sensitiveTag")
    ...
    __properties: ClassVar[List[str]] = ["resourceId", "dataStoreId", "sensitiveTag", "sensitivityCategories", "hash"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensitiveTag": obj.get("sensitiveTag"),

...
class Assetsv3ListTagDomainsResponse(BaseModel):
    """
    Assetsv3ListTagDomainsResponse
    """ # noqa: E501
    categories: Optional[List[Assetsv3TagCategory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [Assetsv3TagCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj

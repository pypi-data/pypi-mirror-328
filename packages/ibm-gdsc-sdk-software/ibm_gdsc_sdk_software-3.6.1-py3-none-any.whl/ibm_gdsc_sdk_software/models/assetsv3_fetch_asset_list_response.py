...
class Assetsv3FetchAssetListResponse(BaseModel):
    """
    Assetsv3FetchAssetListResponse
    """ # noqa: E501
    assets: Optional[List[Assetsv3Asset]] = None
    groups: Optional[List[Assetsv3GroupedAsset]] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["assets", "groups", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [Assetsv3Asset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "groups": [Assetsv3GroupedAsset.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,

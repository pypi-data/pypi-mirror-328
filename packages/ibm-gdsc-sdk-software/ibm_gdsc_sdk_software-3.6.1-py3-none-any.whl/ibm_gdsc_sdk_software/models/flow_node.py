...
class FlowNode(BaseModel):
    ...
    resource: Optional[FlowNodeResource] = None
    vendor_id: Optional[StrictStr] = Field(default=None, alias="vendorId")
    __properties: ClassVar[List[str]] = ["id", "name", "type", "cloudAccountId", "cloudRegion", "cloudProvider", "resource", "vendorId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resource": FlowNodeResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,

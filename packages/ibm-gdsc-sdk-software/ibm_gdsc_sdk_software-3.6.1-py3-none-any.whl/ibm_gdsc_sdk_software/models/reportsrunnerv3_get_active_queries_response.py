...
class Reportsrunnerv3GetActiveQueriesResponse(BaseModel):
    """
    Reportsrunnerv3GetActiveQueriesResponse
    """ # noqa: E501
    queries: Optional[List[Reportsrunnerv3ActiveQuery]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [Reportsrunnerv3ActiveQuery.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj

...
class Ecosystemv3GetDatasetDataResponse(BaseModel):
    """
    GetDatasetDataResponse returns the data report on a dataset.
    """ # noqa: E501
    record_count: Optional[StrictInt] = Field(default=None, description="Total number of records associated with the filter.")
    report_result: Optional[Workflowv3ReportResult] = None
    __properties: ClassVar[List[str]] = ["record_count", "report_result"]

...
class Connectionsv3UCConnectionConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connection_id", "uc_connection_summary"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of uc_connection_summary
        if self.uc_connection_summary:
            _dict['uc_connection_summary'] = self.uc_connection_summary.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uc_connection_summary": Connectionsv3UCConnectionSummary.from_dict(obj["uc_connection_summary"]) if obj.get("uc_connection_summary") is not None else None
        })
        return _obj

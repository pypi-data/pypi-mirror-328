...
class Riskanalyticsenginev3GenerateFeaturesForRisksGroupResponse(BaseModel):
    """
    GenerateFeaturesForRisksGroupResponse is the response object for GenerateFeaturesForGroup API.
    """ # noqa: E501
    risks: Optional[List[Riskanalyticsenginev3Risk]] = Field(default=None, description="Returns an array with risks with pivot , leads and features.")
    __properties: ClassVar[List[str]] = ["risks"]

...
class Guardiumconnectorv3GetTasksResponse(BaseModel):
    """
    GetTasks response message and returned list of tasks.
    """ # noqa: E501
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    tasks: Optional[List[Guardiumconnectorv3TaskObject]] = Field(default=None, description="List of task(s).")
    __properties: ClassVar[List[str]] = ["status", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [Guardiumconnectorv3TaskObject.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj

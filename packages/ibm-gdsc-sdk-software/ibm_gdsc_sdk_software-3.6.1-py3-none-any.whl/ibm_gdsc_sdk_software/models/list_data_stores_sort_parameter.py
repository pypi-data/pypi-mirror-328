...
class ListDataStoresSortParameter(BaseModel):
    """
    ...
    def sort_by_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['name', 'storeType', 'cloudRegion', 'cloudAccountId', 'sensitivitiesCount', 'resourcesCount', 'appFlowsCount', 'configFlowsCount']):
            raise ValueError("must be one of enum values ('name', 'storeType', 'cloudRegion', 'cloudAccountId', 'sensitivitiesCount', 'resourcesCount', 'appFlowsCount', 'configFlowsCount')")
        return value

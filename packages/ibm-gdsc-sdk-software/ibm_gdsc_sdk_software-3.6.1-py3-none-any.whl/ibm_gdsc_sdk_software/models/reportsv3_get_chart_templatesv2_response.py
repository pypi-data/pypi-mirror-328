...
class Reportsv3GetChartTemplatesv2Response(BaseModel):
    """
    GetChartTemplatesv2Response is the return for GetChartTemplatesv2() api.
    """ # noqa: E501
    templates: Optional[List[Reportsv3CustomChartTemplatev2]] = Field(default=None, description="List of all custom chart templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [Reportsv3CustomChartTemplatev2.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj

...
class Tenantuserv3GetRolesResponse(BaseModel):
    """
    Tenantuserv3GetRolesResponse
    """ # noqa: E501
    roles: Optional[List[Tenantuserv3Role]] = Field(default=None, description="Roles found.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [Tenantuserv3Role.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj

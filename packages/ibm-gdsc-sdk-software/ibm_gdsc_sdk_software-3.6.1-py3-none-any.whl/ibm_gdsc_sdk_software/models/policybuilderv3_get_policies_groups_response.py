...
class Policybuilderv3GetPoliciesGroupsResponse(BaseModel):
    """
    Response message for groups being used in policies.
    """ # noqa: E501
    groups: Optional[List[Policybuilderv3PolicyGroups]] = Field(default=None, description="Message containing group and policy details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [Policybuilderv3PolicyGroups.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,

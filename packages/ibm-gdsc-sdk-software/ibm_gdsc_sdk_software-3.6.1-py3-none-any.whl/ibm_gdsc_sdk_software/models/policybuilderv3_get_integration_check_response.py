...
class Policybuilderv3GetIntegrationCheckResponse(BaseModel):
    """
    Policybuilderv3GetIntegrationCheckResponse
    """ # noqa: E501
    policy_names: Optional[List[StrictStr]] = Field(default=None, description="Array contains policy names that uses integration id, if any.")

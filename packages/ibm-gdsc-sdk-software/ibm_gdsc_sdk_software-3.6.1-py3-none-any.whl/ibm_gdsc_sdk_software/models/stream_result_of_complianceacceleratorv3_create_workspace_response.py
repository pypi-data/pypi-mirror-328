...
class StreamResultOfComplianceacceleratorv3CreateWorkspaceResponse(BaseModel):
    """
    StreamResultOfComplianceacceleratorv3CreateWorkspaceResponse
    """ # noqa: E501
    error: Optional[RuntimeStreamError] = None
    result: Optional[Complianceacceleratorv3CreateWorkspaceResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RuntimeStreamError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "result": Complianceacceleratorv3CreateWorkspaceResponse.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj

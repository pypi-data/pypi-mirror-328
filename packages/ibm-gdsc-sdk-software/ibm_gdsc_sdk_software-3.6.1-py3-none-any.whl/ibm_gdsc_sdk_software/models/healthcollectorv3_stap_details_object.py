...
class Healthcollectorv3StapDetailsObject(BaseModel):
    """
    ...
    stap_liveliness_information: Optional[Healthcollectorv3StapLiveInfoObject] = None
    traffic_details: Optional[Healthcollectorv3GeneralDetailsObject] = None
    __properties: ClassVar[List[str]] = ["connectivity_details", "general_err_messages", "ktap_details", "stap_liveliness_information", "traffic_details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of stap_liveliness_information
        if self.stap_liveliness_information:
            _dict['stap_liveliness_information'] = self.stap_liveliness_information.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stap_liveliness_information": Healthcollectorv3StapLiveInfoObject.from_dict(obj["stap_liveliness_information"]) if obj.get("stap_liveliness_information") is not None else None,

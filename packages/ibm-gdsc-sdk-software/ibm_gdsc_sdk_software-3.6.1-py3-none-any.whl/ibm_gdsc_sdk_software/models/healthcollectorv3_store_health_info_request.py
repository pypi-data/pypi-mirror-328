...
class Healthcollectorv3StoreHealthInfoRequest(BaseModel):
    """
    ...
    data: Optional[List[Healthcollectorv3HealthInfoObject]] = Field(default=None, description="Health data from GDP.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Healthcollectorv3HealthInfoObject.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

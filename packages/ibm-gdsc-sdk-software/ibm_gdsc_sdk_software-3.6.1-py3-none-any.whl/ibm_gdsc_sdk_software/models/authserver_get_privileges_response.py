...
class AuthserverGetPrivilegesResponse(BaseModel):
    """
    Request parameters for get api privillage.
    """ # noqa: E501
    feature_flags: Optional[Dict[str, Featureflagsv3FeatureFlagValue]] = Field(default=None, description="Feature flags map.")
    privileges: Optional[Dict[str, StrictBool]] = Field(default=None, description="Cumulative privileges base on all roles.")
    __properties: ClassVar[List[str]] = ["feature_flags", "privileges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "feature_flags": dict(
                (_k, Featureflagsv3FeatureFlagValue.from_dict(_v))

...
class Policybuilderv3Action(BaseModel):
    """
    Message format for actions.
    """ # noqa: E501
    action_name: Optional[StrictStr] = Field(default=None, description="Name of the action.")
    notifications: Optional[List[Policybuilderv3TargetReceiver]] = Field(default=None, description="Notification object if for alert action.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifications": [Policybuilderv3TargetReceiver.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None,
            "order": obj.get("order"),

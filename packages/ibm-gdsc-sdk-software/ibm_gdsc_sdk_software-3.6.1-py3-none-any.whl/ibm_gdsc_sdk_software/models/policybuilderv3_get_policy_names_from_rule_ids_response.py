...
class Policybuilderv3GetPolicyNamesFromRuleIDsResponse(BaseModel):
    """
    Response message that return the rule id(key) : policy name (value) mapping.
    """ # noqa: E501
    policy_names: Optional[Dict[str, StrictStr]] = Field(default=None, description="Map where key is the the rule id and value is the policy name that uses that rule id.")
    status: Optional[Policybuilderv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["policy_names", "status"]

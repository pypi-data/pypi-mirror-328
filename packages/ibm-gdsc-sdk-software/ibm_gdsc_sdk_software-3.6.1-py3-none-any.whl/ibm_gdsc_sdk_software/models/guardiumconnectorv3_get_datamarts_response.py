...
class Guardiumconnectorv3GetDatamartsResponse(BaseModel):
    """
    Guardiumconnectorv3GetDatamartsResponse
    """ # noqa: E501
    extraction_profile: Optional[List[Guardiumconnectorv3ExtractionProfile]] = None
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["extraction_profile", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extraction_profile": [Guardiumconnectorv3ExtractionProfile.from_dict(_item) for _item in obj["extraction_profile"]] if obj.get("extraction_profile") is not None else None,

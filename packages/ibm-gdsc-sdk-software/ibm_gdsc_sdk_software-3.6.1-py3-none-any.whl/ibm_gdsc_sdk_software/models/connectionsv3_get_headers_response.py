...
class Connectionsv3GetHeadersResponse(BaseModel):
    """
    Connectionsv3GetHeadersResponse
    """ # noqa: E501
    headers: Optional[List[Connectionsv3ConnectorHeader]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": [Connectionsv3ConnectorHeader.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None
        })
        return _obj

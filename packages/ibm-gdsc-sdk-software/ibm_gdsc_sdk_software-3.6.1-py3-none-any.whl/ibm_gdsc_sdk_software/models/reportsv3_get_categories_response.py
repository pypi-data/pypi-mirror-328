...
class Reportsv3GetCategoriesResponse(BaseModel):
    """
    GetCategoriesResponse is the return type which encapsulates a list of categories from the GetCategories() api.
    """ # noqa: E501
    category_list: Optional[List[Reportsv3Category]] = Field(default=None, description="List of available report categories.")
    __properties: ClassVar[List[str]] = ["category_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category_list": [Reportsv3Category.from_dict(_item) for _item in obj["category_list"]] if obj.get("category_list") is not None else None
        })
        return _obj

...
class Guardiumconnectorv3GetStreamingStatusResponse(BaseModel):
    """
    Returns the datamart streaming status response for Managed Units.
    """ # noqa: E501
    records: Optional[List[Guardiumconnectorv3StreamingStatusRecord]] = Field(default=None, description="Status records.")
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["records", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [Guardiumconnectorv3StreamingStatusRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,

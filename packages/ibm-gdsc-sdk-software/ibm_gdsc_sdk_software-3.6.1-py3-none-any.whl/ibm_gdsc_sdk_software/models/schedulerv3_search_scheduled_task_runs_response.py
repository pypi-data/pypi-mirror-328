...
class Schedulerv3SearchScheduledTaskRunsResponse(BaseModel):
    """
    Schedulerv3SearchScheduledTaskRunsResponse
    """ # noqa: E501
    record_count: Optional[StrictInt] = Field(default=None, description="Total number of the scheduled job runs.")
    runs: Optional[List[Schedulerv3ScheduledJobRun]] = Field(default=None, description="The requested scheduled job data.")
    __properties: ClassVar[List[str]] = ["record_count", "runs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "runs": [Schedulerv3ScheduledJobRun.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None
        })
        return _obj

...
class Templatesv3CreateIntegrationRequest(BaseModel):
    """
    Templatesv3CreateIntegrationRequest
    """ # noqa: E501
    integration: Optional[Templatesv3Integration] = None
    integration_id: Optional[StrictStr] = Field(default=None, description="Create a new integration with the specified integration id.")
    tags: Optional[StrictStr] = Field(default=None, description="The tags help refine the default content of the integrations templates.")
    __properties: ClassVar[List[str]] = ["integration", "integration_id", "tags"]

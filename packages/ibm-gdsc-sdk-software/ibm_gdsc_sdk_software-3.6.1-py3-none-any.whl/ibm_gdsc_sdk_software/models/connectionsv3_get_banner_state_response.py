...
class Connectionsv3GetBannerStateResponse(BaseModel):
    """
    Connectionsv3GetBannerStateResponse
    """ # noqa: E501
    hide_object_verb_banner: Optional[StrictBool] = None
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["hide_object_verb_banner", "status"]

...
class Connectionsv3GetConnectionsAccountsResponse(BaseModel):
    """
    Connectionsv3GetConnectionsAccountsResponse
    """ # noqa: E501
    account_configs: Optional[List[Connectionsv3AccountConfig]] = None
    __properties: ClassVar[List[str]] = ["account_configs"]

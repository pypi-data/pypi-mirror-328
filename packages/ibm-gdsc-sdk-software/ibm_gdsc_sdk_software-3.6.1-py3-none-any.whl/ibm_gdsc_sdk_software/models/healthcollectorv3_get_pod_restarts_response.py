...
class Healthcollectorv3GetPodRestartsResponse(BaseModel):
    """
    Healthcollectorv3GetPodRestartsResponse
    """ # noqa: E501
    pod_restarts: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["pod_restarts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pod_restarts": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["pod_restarts"]] if obj.get("pod_restarts") is not None else None
        })
        return _obj

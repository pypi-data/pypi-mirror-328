...
class Qspmdatamanagerv3AppDataResponse(BaseModel):
    """
    AppDataResponse is the response object for GetAppDataForProvisionId API.
    """ # noqa: E501
    app_data: Optional[List[Qspmdatamanagerv3AppData]] = Field(default=None, alias="appData")
    __properties: ClassVar[List[str]] = ["appData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appData": [Qspmdatamanagerv3AppData.from_dict(_item) for _item in obj["appData"]] if obj.get("appData") is not None else None
        })
        return _obj

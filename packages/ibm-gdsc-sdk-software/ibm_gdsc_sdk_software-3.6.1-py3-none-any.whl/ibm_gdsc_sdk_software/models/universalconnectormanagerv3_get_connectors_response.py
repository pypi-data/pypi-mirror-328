...
class Universalconnectormanagerv3GetConnectorsResponse(BaseModel):
    """
    Response specification for Universal connector connectors.
    """ # noqa: E501
    connectors: Optional[List[Universalconnectormanagerv3ConnectorSummary]] = Field(default=None, description="An array of connector definitions, with extended details about their plugins.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["connectors", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": [Universalconnectormanagerv3ConnectorSummary.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None,

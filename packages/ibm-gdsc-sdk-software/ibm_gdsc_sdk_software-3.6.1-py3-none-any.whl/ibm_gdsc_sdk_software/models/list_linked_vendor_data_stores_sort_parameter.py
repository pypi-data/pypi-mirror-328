...
class ListLinkedVendorDataStoresSortParameter(BaseModel):
    """
    ...
    def sort_by_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['dataStoreId', 'dataStoreType', 'dataStoreName', 'cloudRegion', 'cloudProvider']):
            raise ValueError("must be one of enum values ('dataStoreId', 'dataStoreType', 'dataStoreName', 'cloudRegion', 'cloudProvider')")
        return value

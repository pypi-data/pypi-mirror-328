...
class Workflowv3UpdateCasesResponse(BaseModel):
    """
    Returns the ids of the cases updated.
    """ # noqa: E501
    status: Optional[GooglerpcStatus] = None
    updated: Optional[StrictStr] = Field(default=None, description="Number of cases that were updated.")
    __properties: ClassVar[List[str]] = ["status", "updated"]

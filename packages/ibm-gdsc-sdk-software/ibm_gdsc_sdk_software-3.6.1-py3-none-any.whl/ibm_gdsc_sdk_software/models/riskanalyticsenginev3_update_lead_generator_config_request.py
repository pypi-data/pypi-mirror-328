...
class Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest(BaseModel):
    """
    UpdateLeadGeneratorConfigRequest is the request object for UpdateLeadGeneratorConfig API.
    """ # noqa: E501
    config: Optional[Riskanalyticsenginev3LeadGeneratorConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": Riskanalyticsenginev3LeadGeneratorConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj

...
class Riskanalyticsmlclassificationv3GetClassificationResponse(BaseModel):
    """
    GetClassificationResponse message for the GetClassification api.
    """ # noqa: E501
    risk: Optional[Riskanalyticsenginev3Risk] = None
    __properties: ClassVar[List[str]] = ["risk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "risk": Riskanalyticsenginev3Risk.from_dict(obj["risk"]) if obj.get("risk") is not None else None
        })
        return _obj

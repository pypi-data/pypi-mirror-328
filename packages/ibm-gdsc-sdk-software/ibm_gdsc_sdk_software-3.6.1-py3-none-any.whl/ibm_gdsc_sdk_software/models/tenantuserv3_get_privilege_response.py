...
class Tenantuserv3GetPrivilegeResponse(BaseModel):
    """
    Tenantuserv3GetPrivilegeResponse
    """ # noqa: E501
    privilege: Optional[Tenantuserv3Privilege] = None
    __properties: ClassVar[List[str]] = ["privilege"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privilege": Tenantuserv3Privilege.from_dict(obj["privilege"]) if obj.get("privilege") is not None else None
        })
        return _obj

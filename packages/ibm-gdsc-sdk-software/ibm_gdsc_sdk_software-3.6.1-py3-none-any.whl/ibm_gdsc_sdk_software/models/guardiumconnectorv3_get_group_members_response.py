...
class Guardiumconnectorv3GetGroupMembersResponse(BaseModel):
    """
    Returns the list of group members for a particular Central Manager.
    """ # noqa: E501
    groups: Optional[List[Guardiumconnectorv3Group]] = Field(default=None, description="List of group memebers fetched with the command.")
    status: Optional[Guardiumconnectorv3StatusResponseBase] = None
    __properties: ClassVar[List[str]] = ["groups", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [Guardiumconnectorv3Group.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,

...
class Assetsv3FetchAssetsForMergeSplitResponse(BaseModel):
    """
    Response to Fetch Assets eligible for Merge or Split.
    """ # noqa: E501
    assets: Optional[List[Assetsv3AssetsForMergeSplitResponse]] = None
    assets_count: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["assets", "assets_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [Assetsv3AssetsForMergeSplitResponse.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,

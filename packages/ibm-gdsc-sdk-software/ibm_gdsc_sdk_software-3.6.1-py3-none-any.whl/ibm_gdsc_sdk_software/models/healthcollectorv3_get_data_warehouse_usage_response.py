...
class Healthcollectorv3GetDataWarehouseUsageResponse(BaseModel):
    """
    Healthcollectorv3GetDataWarehouseUsageResponse
    """ # noqa: E501
    warehouse_usage: Optional[List[Healthcollectorv3Usage]] = None
    __properties: ClassVar[List[str]] = ["warehouse_usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "warehouse_usage": [Healthcollectorv3Usage.from_dict(_item) for _item in obj["warehouse_usage"]] if obj.get("warehouse_usage") is not None else None
        })
        return _obj

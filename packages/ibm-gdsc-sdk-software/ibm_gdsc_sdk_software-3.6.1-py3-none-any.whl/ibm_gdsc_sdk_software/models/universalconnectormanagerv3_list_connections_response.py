...
class Universalconnectormanagerv3ListConnectionsResponse(BaseModel):
    """
    Structure for a Summary of [Universal connector] Connections.
    """ # noqa: E501
    connections: Optional[List[Universalconnectormanagerv3ConnectionSummary]] = Field(default=None, description="Summaries of Universal connector Connection cofigurations, along with their status.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["connections", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connections": [Universalconnectormanagerv3ConnectionSummary.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,

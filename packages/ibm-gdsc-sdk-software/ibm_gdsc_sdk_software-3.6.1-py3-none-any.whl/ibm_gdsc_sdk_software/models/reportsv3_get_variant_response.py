...
class Reportsv3GetVariantResponse(BaseModel):
    """
    Reportsv3GetVariantResponse
    """ # noqa: E501
    variant: Optional[Reportsv3VariantDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variant": Reportsv3VariantDetails.from_dict(obj["variant"]) if obj.get("variant") is not None else None
        })
        return _obj

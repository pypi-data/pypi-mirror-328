...
class ListPotentialFlowsPaths200Response(BaseModel):
    """
    ListPotentialFlowsPaths200Response
    """ # noqa: E501
    results: List[PotentialFlowPathListItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [PotentialFlowPathListItem.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

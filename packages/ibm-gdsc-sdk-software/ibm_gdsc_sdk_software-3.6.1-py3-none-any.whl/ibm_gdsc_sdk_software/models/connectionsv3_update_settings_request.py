...
class Connectionsv3UpdateSettingsRequest(BaseModel):
    """
    Connectionsv3UpdateSettingsRequest
    """ # noqa: E501
    settings: Optional[List[Connectionsv3ConnectorSetting]] = Field(default=None, description="The list of settings to update.")

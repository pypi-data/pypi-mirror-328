...
class CloudAccountsCloudProvidersOptionsRequest(BaseModel):
    """
    CloudAccountsCloudProvidersOptionsRequest
    """ # noqa: E501
    cloud_provider: CloudServiceProvider = Field(alias="cloudProvider")
    cloud_accounts: List[CloudAccountsCloudProvidersOptionsRequestCloudAccountsInner] = Field(alias="cloudAccounts")
    __properties: ClassVar[List[str]] = ["cloudProvider", "cloudAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudAccounts": [CloudAccountsCloudProvidersOptionsRequestCloudAccountsInner.from_dict(_item) for _item in obj["cloudAccounts"]] if obj.get("cloudAccounts") is not None else None
        })
        return _obj

...
class ListUsersEntitlements200Response(BaseModel):
    """
    ListUsersEntitlements200Response
    """ # noqa: E501
    results: List[ListUsersEntitlements200ResponseResultsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ListUsersEntitlements200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

...
class Ecosystemv3DataInsertResponse(BaseModel):
    """
    Returns inserted record count.
    """ # noqa: E501
    entries_inserted: Optional[StrictInt] = Field(default=None, description="Number of entries inserted.")
    status: Optional[GooglerpcStatus] = None
    __properties: ClassVar[List[str]] = ["entries_inserted", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries_inserted": obj.get("entries_inserted"),

...
class Reportsv3GetVariantsResponse(BaseModel):
    """
    Reportsv3GetVariantsResponse
    """ # noqa: E501
    variants: Optional[List[Reportsv3Variant]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variants": [Reportsv3Variant.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj

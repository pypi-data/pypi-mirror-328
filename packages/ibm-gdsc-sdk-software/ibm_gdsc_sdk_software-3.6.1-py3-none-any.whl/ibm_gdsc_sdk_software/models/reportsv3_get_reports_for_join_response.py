...
class Reportsv3GetReportsForJoinResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    reports_used_in_join: Optional[List[Reportsv3ReportUsedInJoin]] = None
    __properties: ClassVar[List[str]] = ["reports_used_in_join"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports_used_in_join": [Reportsv3ReportUsedInJoin.from_dict(_item) for _item in obj["reports_used_in_join"]] if obj.get("reports_used_in_join") is not None else None
        })
        return _obj

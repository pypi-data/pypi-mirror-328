...
class Guardiumconnectorv3SubTaskObject(BaseModel):
    """
    Object holding sub task info.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Subtask id.")
    interval: Optional[StrictStr] = Field(default=None, description="Subtask interval.")
    params: Optional[List[Guardiumconnectorv3TaskParamsObject]] = Field(default=None, description="Json array.")
    __properties: ClassVar[List[str]] = ["id", "interval", "params"]

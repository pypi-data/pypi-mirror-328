...
class Universalconnectormanagerv3DatasourcesResponse(BaseModel):
    """
    List of datasources defined for Univesal Connector with their details.
    """ # noqa: E501
    datasources: Optional[List[Universalconnectormanagerv3DatasourceDefinition]] = Field(default=None, description="Collection of datasource definitions.")
    status: Optional[RpcStatus] = None
    __properties: ClassVar[List[str]] = ["datasources", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasources": [Universalconnectormanagerv3DatasourceDefinition.from_dict(_item) for _item in obj["datasources"]] if obj.get("datasources") is not None else None,

...
class ListDataStores200Response(BaseModel):
    """
    ListDataStores200Response
    """ # noqa: E501
    results: Optional[List[DataStore]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [DataStore.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,

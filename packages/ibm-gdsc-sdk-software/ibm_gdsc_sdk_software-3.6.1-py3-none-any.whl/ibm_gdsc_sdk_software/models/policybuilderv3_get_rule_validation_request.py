...
class Policybuilderv3GetRuleValidationRequest(BaseModel):
    """
    Request message to validate rule.
    """ # noqa: E501
    rule: Optional[Policybuilderv3Rule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rule": Policybuilderv3Rule.from_dict(obj["rule"]) if obj.get("rule") is not None else None
        })
        return _obj

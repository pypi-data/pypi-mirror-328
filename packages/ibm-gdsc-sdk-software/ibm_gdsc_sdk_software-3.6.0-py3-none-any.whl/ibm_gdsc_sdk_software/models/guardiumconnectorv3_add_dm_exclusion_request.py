...
class Guardiumconnectorv3AddDmExclusionRequest(BaseModel):
    """
    Request to add a datamart to the exclusion list.
    """ # noqa: E501
    datamart: Optional[StrictStr] = Field(default=None, description="Datamart name.")
    __properties: ClassVar[List[str]] = ["datamart"]

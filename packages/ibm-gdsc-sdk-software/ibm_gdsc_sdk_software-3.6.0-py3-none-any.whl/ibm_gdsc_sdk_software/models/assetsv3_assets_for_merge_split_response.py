...
class Assetsv3AssetsForMergeSplitResponse(BaseModel):
    """
    ...
    dsdef_key: Optional[StrictStr] = None
    ...
    is_mergeable: Optional[StrictBool] = None
    is_splittable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["asset_id", "asset_name", "database_name", "dsdef_key", "host_name", "host_port", "ip_address", "ip_port", "is_mergeable", "is_splittable"]

...
class Streamsv3StreamByRegion(BaseModel):
    """
    StreamByRegion defines an array of streams.
    """ # noqa: E501
    stream: Optional[List[StrictStr]] = Field(default=None, description="Array of streams.")
    __properties: ClassVar[List[str]] = ["stream"]

...
class DataResourcesSummaryResourceOwnersInner(BaseModel):
    """
    DataResourcesSummaryResourceOwnersInner
    """ # noqa: E501
    resource_owner: StrictStr = Field(alias="resourceOwner")
    count: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["resourceOwner", "count"]

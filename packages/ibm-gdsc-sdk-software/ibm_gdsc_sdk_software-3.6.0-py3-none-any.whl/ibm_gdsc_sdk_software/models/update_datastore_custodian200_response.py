...
class UpdateDatastoreCustodian200Response(BaseModel):
    """
    UpdateDatastoreCustodian200Response
    """ # noqa: E501
    data_store_ids: Optional[StrictStr] = Field(default=None, alias="dataStoreIds")
    custodian: StrictStr
    __properties: ClassVar[List[str]] = ["dataStoreIds", "custodian"]

...
class Reportsv3PartialReportUpdateResponse(BaseModel):
    """
    UpdateReportResponse containes the report id and a schedule flag of the updated report from the UpdateReport() api.
    """ # noqa: E501
    is_scheduled: Optional[StrictBool] = Field(default=None, description="The is_scheduled is a flag says is report scheduled.")
    report_id: Optional[StrictStr] = Field(default=None, description="Unique Report ID.")
    __properties: ClassVar[List[str]] = ["is_scheduled", "report_id"]

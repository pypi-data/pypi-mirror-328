...
class Streamsv3CheckAzureStorageStringRequest(BaseModel):
    """
    CheckAzureStorageStringRequest defines a request to verify Azure storage connection.
    """ # noqa: E501
    connection_string: Optional[StrictStr] = Field(default=None, description="Storage connection string.")
    __properties: ClassVar[List[str]] = ["connection_string"]

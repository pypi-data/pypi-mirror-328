...
class Workflowv3GetCasesCountResponse(BaseModel):
    """
    Returns case count.
    """ # noqa: E501
    total_records: Optional[StrictInt] = Field(default=None, description="Total Rows Count.")
    __properties: ClassVar[List[str]] = ["total_records"]

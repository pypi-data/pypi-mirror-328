...
class Schedulerv3GetDistributionRulesResponse(BaseModel):
    """
    GetDistributionRulesResponse returns all the distribution rule IDs in the scheduler collection.
    """ # noqa: E501
    distribution_rule_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["distribution_rule_ids"]

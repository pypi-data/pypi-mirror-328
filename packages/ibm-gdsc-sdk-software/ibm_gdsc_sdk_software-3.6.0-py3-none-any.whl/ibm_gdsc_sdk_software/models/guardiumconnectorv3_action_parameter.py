...
class Guardiumconnectorv3ActionParameter(BaseModel):
    """
    Guardiumconnectorv3ActionParameter
    """ # noqa: E501
    id_value: Optional[StrictInt] = None
    parameter_name: Optional[StrictStr] = None
    parameter_type: Optional[StrictStr] = None
    parameter_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id_value", "parameter_name", "parameter_type", "parameter_value"]

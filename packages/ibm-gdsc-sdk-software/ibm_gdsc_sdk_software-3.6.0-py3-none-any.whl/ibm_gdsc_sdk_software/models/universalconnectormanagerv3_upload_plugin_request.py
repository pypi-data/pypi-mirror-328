...
class Universalconnectormanagerv3UploadPluginRequest(BaseModel):
    """
    Upload Universal Connector plugin request with configuration details.
    """ # noqa: E501
    plugin_id: Optional[StrictStr] = Field(default=None, description="Universal Connector plugin ID.")
    __properties: ClassVar[List[str]] = ["plugin_id"]

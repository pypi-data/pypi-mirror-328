...
class ListTrusteesFilterParameter(BaseModel):
    """
    ...
    cloud_account_id: Optional[StrictStr] = Field(default=None, alias="cloudAccountId")
    __properties: ClassVar[List[str]] = ["vendorId", "dataStoreId", "cloudAccountId"]

...
class Tenantuserv3PostPrivilegesBulkResponse(BaseModel):
    """
    Tenantuserv3PostPrivilegesBulkResponse
    """ # noqa: E501
    privilege_id: Optional[List[StrictStr]] = Field(default=None, description="Array of IDs representing the privileges created.")
    __properties: ClassVar[List[str]] = ["privilege_id"]

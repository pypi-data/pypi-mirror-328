...
class Snifassistv3StapConfig(BaseModel):
    """
    StapConfig defines the message structure for STAP configuration.
    """ # noqa: E501
    crc: Optional[StrictInt] = Field(default=None, description="CRC value of STAP configuration.")
    data: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Configuration data field.")
    __properties: ClassVar[List[str]] = ["crc", "data"]

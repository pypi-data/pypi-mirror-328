...
class Guardiumconnectorv3StatusResponseBase(BaseModel):
    """
    Default status message response from the Guardium connector service.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Optional message field.")
    status: Optional[StrictStr] = Field(default=None, description="Status code returned by the Guardium connector.")

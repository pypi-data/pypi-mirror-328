...
class Guardiumconnectorv3NestedGroupMember(BaseModel):
    """
    List the group members in nested (heirarchical) groups.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Group member name.")
    group_id: Optional[StrictInt] = Field(default=None, description="Group ID.")
    member_id: Optional[StrictInt] = Field(default=None, description="Group member ID.")
    __properties: ClassVar[List[str]] = ["description", "group_id", "member_id"]

...
class Healthcollectorv3InspectionEngineObjectGdp(BaseModel):
    """
    InspectionEngineDetails gets additional information about inspection engines.
    """ # noqa: E501
    ie_status: Optional[StrictInt] = Field(default=None, description="The status of inspection engine.")
    inspection_engine: Optional[StrictStr] = Field(default=None, description="Name of the inspection engine.")
    __properties: ClassVar[List[str]] = ["ie_status", "inspection_engine"]

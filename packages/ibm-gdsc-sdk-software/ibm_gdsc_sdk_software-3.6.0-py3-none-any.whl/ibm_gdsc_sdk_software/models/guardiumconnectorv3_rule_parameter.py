...
class Guardiumconnectorv3RuleParameter(BaseModel):
    """
    Guardiumconnectorv3RuleParameter
    """ # noqa: E501
    group_id: Optional[StrictInt] = None
    parameter_name: Optional[StrictStr] = None
    parameter_operator: Optional[StrictStr] = None
    parameter_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["group_id", "parameter_name", "parameter_operator", "parameter_value"]

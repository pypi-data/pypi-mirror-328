...
class Assetsv3AssetsWithOpenVulnerabilities(BaseModel):
    """
    Assetsv3AssetsWithOpenVulnerabilities
    """ # noqa: E501
    asset_type: Optional[StrictStr] = None
    total_assets: Optional[StrictStr] = None
    vulnerability_group: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["asset_type", "total_assets", "vulnerability_group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vulnerability_group": obj.get("vulnerability_group")
        })
        return _obj

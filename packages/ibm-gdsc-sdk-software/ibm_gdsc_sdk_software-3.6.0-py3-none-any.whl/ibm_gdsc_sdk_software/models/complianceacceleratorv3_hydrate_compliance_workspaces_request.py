...
class Complianceacceleratorv3HydrateComplianceWorkspacesRequest(BaseModel):
    """
    Complianceacceleratorv3HydrateComplianceWorkspacesRequest
    """ # noqa: E501
    compliance_id: Optional[StrictStr] = Field(default=None, description="Workspace to be hydrated.")
    __properties: ClassVar[List[str]] = ["compliance_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance_id": obj.get("compliance_id")
        })
        return _obj

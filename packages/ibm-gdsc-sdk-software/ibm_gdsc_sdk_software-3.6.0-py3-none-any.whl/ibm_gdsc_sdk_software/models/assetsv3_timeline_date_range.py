...
class Assetsv3TimelineDateRange(BaseModel):
    """
    Assetsv3TimelineDateRange
    """ # noqa: E501
    end: Optional[StrictStr] = None
    end_number: Optional[StrictInt] = None
    end_unit: Optional[StrictStr] = None
    error: Optional[StrictStr] = None
    key: Optional[StrictStr] = None
    start: Optional[StrictStr] = None
    start_number: Optional[StrictInt] = None
    start_unit: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["end", "end_number", "end_unit", "error", "key", "start", "start_number", "start_unit", "type"]

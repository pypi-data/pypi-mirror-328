...
class Complianceacceleratorv3StatusResponseBase(BaseModel):
    """
    StatusResponseBase is the message that stores status code and message.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Message for status response.")
    status: Optional[StrictStr] = Field(default=None, description="Status code.")

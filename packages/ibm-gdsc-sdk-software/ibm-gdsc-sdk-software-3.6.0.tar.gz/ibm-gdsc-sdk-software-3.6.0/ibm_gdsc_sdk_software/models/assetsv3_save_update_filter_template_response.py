...
class Assetsv3SaveUpdateFilterTemplateResponse(BaseModel):
    """
    SaveUpdateFilterTemplateResponse - Save/Update Filter Template response for save filters query as template.
    """ # noqa: E501
    template_id: Optional[StrictStr] = Field(default=None, description="Template ID which was inserted/updated.")

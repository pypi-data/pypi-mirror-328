...
class Groupbuilderv3CreateGroupRequest(BaseModel):
    """
    CreateGroupRequest requests creation of a new group.
    """ # noqa: E501
    copy_group_id: Optional[StrictInt] = Field(default=None, description="Group ID to copy.")
    ...
    __properties: ClassVar[List[str]] = ["copy_group_id", "description", "group_type_id", "name", "nested"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "copy_group_id": obj.get("copy_group_id"),

...
class ServiceAccountInstallationStatus(BaseModel):
    """
    ServiceAccountInstallationStatus
    """ # noqa: E501
    installation_status: StrictBool = Field(alias="installationStatus")
    __properties: ClassVar[List[str]] = ["installationStatus"]

...
class Dashboardsv3DeleteDashboardRequest(BaseModel):
    """
    DeleteDashboardRequest is the request for deleting a dashboard.
    """ # noqa: E501
    dashboard_id: Optional[StrictStr] = Field(default=None, description="The id of the dashboard to be deleted.")
    __properties: ClassVar[List[str]] = ["dashboard_id"]

...
class Schedulerv3UpdateScheduledJobResponse(BaseModel):
    """
    UpdateScheduledJobResponse message for Put v3/schedules/ api.
    """ # noqa: E501
    result: Optional[StrictStr] = Field(default=None, description="Result is \"\" if record is persisted, otherwise an error is returned.")

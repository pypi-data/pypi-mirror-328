...
class Guardiumconnectorv3UtilizationParameterObject(BaseModel):
    """
    ...
    num_of_exceptions_value: Optional[StrictInt] = Field(default=None, description="Number of excpetions.")

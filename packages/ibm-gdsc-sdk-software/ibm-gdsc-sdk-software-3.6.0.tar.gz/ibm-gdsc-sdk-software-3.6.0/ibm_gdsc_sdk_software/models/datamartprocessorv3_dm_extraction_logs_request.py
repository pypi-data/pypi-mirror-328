...
class Datamartprocessorv3DMExtractionLogsRequest(BaseModel):
    """
    DMExtractionLogsRequest request object.
    """ # noqa: E501
    data: Optional[StrictStr] = Field(default=None, description="Report data.")
    request_id: Optional[StrictStr] = Field(default=None, description="Request id which co-relates to request.")

...
class Tenantuserv3CurrentUserTenant(BaseModel):
    """
    CurrentUserTenant contains a list of tenant id and tenant name.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of tenant.")
    part_number: Optional[StrictStr] = Field(default=None, description="Part number.")
    tenant_id: Optional[StrictStr] = Field(default=None, description="The tenant id.")
    __properties: ClassVar[List[str]] = ["name", "part_number", "tenant_id"]

...
class Schedulerv3ReportArray(BaseModel):
    """
    ReportArray is an array of report names for ScheduledJobSummaryResponse.
    """ # noqa: E501
    report_name: Optional[List[StrictStr]] = Field(default=None, description="Array of the name needed.")
    __properties: ClassVar[List[str]] = ["report_name"]

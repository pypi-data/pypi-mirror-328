...
class Databootstrapperv3LoadDataRequest(BaseModel):
    """
    Load data request.
    """ # noqa: E501
    part_number: Optional[StrictStr] = Field(default=None, description="The part number.")
    __properties: ClassVar[List[str]] = ["part_number"]

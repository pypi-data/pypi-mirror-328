...
class Assetsv3PolicyApplied(BaseModel):
    """
    PolicyApplied - Asset Overview - data of policies applied on the asset for Control Health widget data.
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    policy_source: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "policy_source", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "policy_source": obj.get("policy_source"),

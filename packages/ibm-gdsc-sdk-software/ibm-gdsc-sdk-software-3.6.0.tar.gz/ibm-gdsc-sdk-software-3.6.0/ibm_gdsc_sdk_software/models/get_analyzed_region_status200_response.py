...
class GetAnalyzedRegionStatus200Response(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Analyzed', 'NotAnalyzed']):
            raise ValueError("must be one of enum values ('Analyzed', 'NotAnalyzed')")
        return value

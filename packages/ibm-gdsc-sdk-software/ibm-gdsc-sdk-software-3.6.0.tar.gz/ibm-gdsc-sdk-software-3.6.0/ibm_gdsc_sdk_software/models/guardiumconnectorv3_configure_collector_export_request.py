...
class Guardiumconnectorv3ConfigureCollectorExportRequest(BaseModel):
    """
    ...
    collectors: Optional[List[StrictStr]] = Field(default=None, description="List of collectors.")
    start_date: Optional[StrictStr] = Field(default=None, description="Start date for export.")
    __properties: ClassVar[List[str]] = ["central_manager_id", "collectors", "start_date"]

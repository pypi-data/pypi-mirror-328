...
class Guardiumconnectorv3ActionNotifications(BaseModel):
    """
    Guardiumconnectorv3ActionNotifications
    """ # noqa: E501
    integration_id: Optional[StrictStr] = None
    receivers: Optional[StrictStr] = None
    template_id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["integration_id", "receivers", "template_id", "type"]

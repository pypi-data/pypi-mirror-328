...
class Reportsrunnerv3ActiveQuery(BaseModel):
    """
    Reportsrunnerv3ActiveQuery
    """ # noqa: E501
    can_stop: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["can_stop", "detail", "elapsed_time", "name", "query_id", "start_time", "status", "type", "user"]

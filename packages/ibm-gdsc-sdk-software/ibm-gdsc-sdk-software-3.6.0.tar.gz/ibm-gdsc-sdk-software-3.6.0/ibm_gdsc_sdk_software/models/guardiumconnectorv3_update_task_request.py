...
class Guardiumconnectorv3UpdateTaskRequest(BaseModel):
    """
    Updates specified task.
    """ # noqa: E501
    central_manager_id: Optional[StrictStr] = Field(default=None, description="ID of central manager.")
    interval: Optional[StrictStr] = Field(default=None, description="Updates task interval.")
    task_id: Optional[StrictStr] = Field(default=None, description="ID of task being updated.")
    __properties: ClassVar[List[str]] = ["central_manager_id", "interval", "task_id"]

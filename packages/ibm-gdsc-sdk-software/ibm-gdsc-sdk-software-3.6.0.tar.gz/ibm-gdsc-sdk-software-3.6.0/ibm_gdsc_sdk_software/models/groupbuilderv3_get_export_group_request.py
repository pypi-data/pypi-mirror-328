...
class Groupbuilderv3GetExportGroupRequest(BaseModel):
    """
    GetExportGroupRequest is the argument type of the GetExportGroupRequest API.
    """ # noqa: E501
    export_hierarchy: Optional[StrictBool] = Field(default=None, description="Export full hierarchy of nested group.")
    group_id: Optional[StrictInt] = Field(default=None, description="Group ID.")
    __properties: ClassVar[List[str]] = ["export_hierarchy", "group_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "export_hierarchy": obj.get("export_hierarchy"),

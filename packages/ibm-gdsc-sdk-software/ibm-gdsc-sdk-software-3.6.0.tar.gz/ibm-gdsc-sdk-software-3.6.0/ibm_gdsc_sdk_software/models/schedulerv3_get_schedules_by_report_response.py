...
class Schedulerv3GetSchedulesByReportResponse(BaseModel):
    """
    GetSchedulesByReportIdReponse - array of scheduled job IDs that the requested report_id is part of.
    """ # noqa: E501
    schedule_ids: Optional[List[StrictStr]] = Field(default=None, description="List of schedule ids for this report id.")
    __properties: ClassVar[List[str]] = ["schedule_ids"]

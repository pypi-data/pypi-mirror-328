...
class AnalyzedRegionValidationResults(BaseModel):
    """
    ...
    is_warning: Optional[StrictBool] = Field(default=None, alias="isWarning")
    warning: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["isValid", "error", "statusCode", "isWarning", "warning"]

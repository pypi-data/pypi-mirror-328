...
class Reportsrunnerv3WriteResultsToFileResponse(BaseModel):
    """
    ...
    job_id: Optional[StrictStr] = Field(default=None, description="Token that identifies the writing results to file job.")
    message: Optional[StrictStr] = Field(default=None, description="Return message after writing results to file job was scheduled.")
    __properties: ClassVar[List[str]] = ["file_name", "job_id", "message"]

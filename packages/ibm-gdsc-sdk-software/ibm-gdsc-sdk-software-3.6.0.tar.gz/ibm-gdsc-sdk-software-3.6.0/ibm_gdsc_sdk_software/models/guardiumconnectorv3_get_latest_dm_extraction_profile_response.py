...
class Guardiumconnectorv3GetLatestDMExtractionProfileResponse(BaseModel):
    """
    Returns the datamart extraction profile for a particular Central Manager.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Datamart extraction profile name.")

...
class Riskanalyticsdataprocessorv3Question(BaseModel):
    """
    Riskanalyticsdataprocessorv3Question
    """ # noqa: E501
    question: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    value_to_analyst: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["question", "type", "value_to_analyst"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "value_to_analyst": obj.get("value_to_analyst")
        })
        return _obj

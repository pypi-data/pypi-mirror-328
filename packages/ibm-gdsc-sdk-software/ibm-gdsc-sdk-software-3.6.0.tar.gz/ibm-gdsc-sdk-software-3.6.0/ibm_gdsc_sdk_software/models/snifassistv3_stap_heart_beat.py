...
class Snifassistv3StapHeartBeat(BaseModel):
    """
    StapHeartBeat defines the message structure for STAP heartbeat.
    """ # noqa: E501
    timestamp: Optional[StrictStr] = Field(default=None, description="Heartbeat timestamp that sniffer receives from STAP.")

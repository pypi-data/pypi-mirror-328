...
class TestRemoteExecutionClient(unittest.TestCase):
    ...
    def test_execution_client_init_fails_no_domain_identifier(self):
        execution_config = ExecutionConfig()
        execution_config.project_identifier = "project_123"
        with self.assertRaises(InternalServerError):
            RemoteExecutionClient(self.datazone_api, self.project_api, execution_config)

    def test_execution_client_init_fails_no_project_identifier(self):
        execution_config = ExecutionConfig()

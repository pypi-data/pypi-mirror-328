...
def _init_high_pass_filter(box: Box, simulation_params: SchedulerParams) -> None:
    ...
    box['denom_vect'] = [1, cut_pulstation]
...
def _function_high_pass_filter(box: Box, event_: SchedulerEvent) -> List:

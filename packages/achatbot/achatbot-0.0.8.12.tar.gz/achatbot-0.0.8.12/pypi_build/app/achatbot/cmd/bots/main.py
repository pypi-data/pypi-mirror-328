...
from achatbot.cmd.bots.run import BotTaskRunnerBE, RunBotInfo
...
if __name__ == "__main__":
    """
    python -m achatbot.cmd.bots.main -f config/bots/dummy_bot.json
    python -m achatbot.cmd.bots.main -f config/bots/daily_rtvi_general_bot.json
    python -m achatbot.cmd.bots.main -f config/bots/daily_describe_vision_bot.json

    python -m achatbot.cmd.bots.main -f config/bots/dummy_bot.json --task_type asyncio
    python -m achatbot.cmd.bots.main -f config/bots/dummy_bot.json --task_type threading
    """

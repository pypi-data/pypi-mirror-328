...
from achatbot.common.connector.redis_queue import RedisQueueConnector
from achatbot.common.logger import Logger


r"""

REDIS_PASSWORD=$redis_pwd RUN_OP=fe python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/fe_std_out.log
REDIS_PASSWORD=$redis_pwd RUN_OP=be TQDM_DISABLE=True python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/be_std_out.log

# with wakeword
REDIS_PASSWORD=$redis_pwd RUN_OP=fe RECORDER_TAG=wakeword_rms_recorder python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/fe_std_out.log
REDIS_PASSWORD=$redis_pwd RUN_OP=be TQDM_DISABLE=True python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/be_std_out.log
...
TTS_TAG=tts_cosy_voice \
  ...
  python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/fe_std_out.log
...
RUN_OP=be \
  ...
  TTS_TAG=tts_cosy_voice \
  python -m achatbot.cmd.remote-queue-chat.generate_audio2audio > ./log/be_std_out.log
"""

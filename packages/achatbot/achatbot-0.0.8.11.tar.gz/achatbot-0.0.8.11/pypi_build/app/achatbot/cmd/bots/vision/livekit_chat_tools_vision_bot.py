...
from achatbot.processors.image_capture_processor import ImageCaptureProcessor
...
register_tool_funtions = Register("livekit-chat-vision-tool-functions")


@register_ai_room_bots.register
class LivekitChatToolsVisionBot(LivekitRoomBot):
    r"""

...
if __name__ == "__main__":
    ...
    ACHATBOT_TASK_TYPE=multiprocessing python -m achatbot.cmd.http.server.fastapi_daily_bot_serve
    ACHATBOT_TASK_TYPE=threading python -m achatbot.cmd.http.server.fastapi_daily_bot_serve
    ACHATBOT_TASK_TYPE=asyncio python -m achatbot.cmd.http.server.fastapi_daily_bot_serve
    """
    import uvicorn
    ...
    uvicorn.run(
        "achatbot.cmd.http.server.fastapi_daily_bot_serve:app",
        host=config.host,
        port=config.port,

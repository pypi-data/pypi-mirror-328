...
def inputs(argv):
    ...
    variables.true_positives = resources.files(__name__, 'data/true_positives.fasta')
    variables.true_negatives = resources.files(__name__, 'data/true_negatives.fasta')

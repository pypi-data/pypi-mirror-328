...
def get_arguments():
    ...
    parser.add_argument('-s', '--serial_port', type=str, nargs="+",
                        default=['/dev/ttyACM0'], help="serial port")
...
def main():
    ...
    serial = [SerialOSCProxy(port, args.baudrate, args.timeout, recv, args.verbose)
              for port in args.serial_port]

...
class IPv4TCP(TCP):
    def __init__(
        ...
        self._identification = identification if identification is not None else NetTools.get_ipv4_id()
        ...
        self._source_address = source_address if source_address is not None else NetTools.get_outgoing_interface_ip()
        self._destination_address = destination_address
        self._ipv4_options = ipv4_options
        self._source_port = source_port if source_port is not None else NetTools.get_unused_port()
        self._destination_port = destination_port
        self._sequence_number = sequence_number if sequence_number is not None else NetTools.get_tcp_sequence_number()

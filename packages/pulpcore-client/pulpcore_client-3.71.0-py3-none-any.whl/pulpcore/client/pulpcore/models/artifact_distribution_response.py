...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "prn", "base_path", "base_url", "pulp_last_updated", "hidden", "pulp_href", "pulp_labels", "no_content_change_since", "content_guard", "name"]

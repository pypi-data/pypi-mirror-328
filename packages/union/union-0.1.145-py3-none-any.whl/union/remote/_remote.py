...
class UnionRemote(FlyteRemote):
    ...
    def deploy_app(self, app: App, project: Optional[str] = None, domain: Optional[str] = None):
        """
        ...
        """
        self._app_remote.deploy(app, project=project, domain=domain)
    ...
    def stop_app(self, name: str, project: Optional[str] = None, domain: Optional[str] = None):
        ...
        :param project: Domain name. If None, uses default_domain.
        """
        self._app_remote.stop(name=name, project=project, domain=domain)

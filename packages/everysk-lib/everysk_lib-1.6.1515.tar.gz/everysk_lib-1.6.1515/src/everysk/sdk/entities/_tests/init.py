...
class InitTestCase(TestCase):
    ...
    def test_sdk_modules_path(self):
        ...
        self.assertListEqual(list(modules), ['CustomIndex', 'Datastore', 'File', 'Portfolio', 'PrivateSecurity', 'Query', 'Report', 'Script', 'Securities', 'Security','WorkerExecution', 'WorkflowExecution'])

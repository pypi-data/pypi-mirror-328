...
class TestBaseEntity(TestCase):
    ...
    def test_retrieve(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'retrieve', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890', 'projection': None}}, protocol='gzip', serialize='json')
    ...
    def test_retrieve_with_projection(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'retrieve', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890', 'projection': ['-securities']}}, protocol='gzip', serialize='json')
    ...
    def test_inner_retrieve_many(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'inner_retrieve_many', 'self_obj': None, 'params': {'entity_id_list': ['port_1234567891011211234567890'], 'projection': None}}, protocol='gzip', serialize='json')
    ...
    def test_inner_retrieve_many_with_projection(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'inner_retrieve_many', 'self_obj': None, 'params': {'entity_id_list': ['port_1234567891011211234567890'], 'projection': ['-securities', '-name']}}, protocol='gzip', serialize='json')

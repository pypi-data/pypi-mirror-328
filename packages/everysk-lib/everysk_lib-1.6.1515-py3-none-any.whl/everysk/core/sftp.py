...
from paramiko import SFTPClient, SFTPAttributes, SSHClient, rsakey
...
class SFTP(BaseObject):
    ...
    ## Public methods
    def get_sftp_client(self, hostname: str, port: int, username: str, password: str = None, compress: bool = None, timeout: int = None, private_key: str = None, passphrase: str = None) -> SFTPClient:
        """

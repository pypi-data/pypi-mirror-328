...
class DataPacketUrls:
    goods_profit = 'https://pf.erp321.com/WebApi/PF/OrderSku/GetPFSkuList?uvalue=pfcweb_profit-report.goods-profit'
...
class Report:
    ...
    def get__goods_profit__detail(
        ...
        if page is None:
            ...
            page.get(DataPacketUrls.goods_profit)
        ...
        resp = page.post(
            DataPacketUrls.goods_profit, json=reqdata_json, timeout=_timeout
        )
        try:

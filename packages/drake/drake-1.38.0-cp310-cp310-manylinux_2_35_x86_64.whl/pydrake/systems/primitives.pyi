...
@overload
def DiscreteTimeApproximation(system: LinearSystem, time_period: float) -> LinearSystem: ...
@overload
def DiscreteTimeApproximation(system: AffineSystem, time_period: float) -> AffineSystem: ...

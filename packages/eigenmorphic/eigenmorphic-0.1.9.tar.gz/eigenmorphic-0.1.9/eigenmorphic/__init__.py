...
lazy_import('eigenmorphic.eigenvalues', ['morphic_eigenvalues'])
...
lazy_import('eigenmorphic.balanced_pair_algo', ['return_words', 'balanced_pair_algorithm', 'has_pure_discrete_spectrum'])

...
class UserRolesApi:
    ...
    @overload
    async def remove_policy_from_user_role(self, userid : Annotated[StrictStr, Field(..., description="Id of the User Role to get")], policy_scope : Annotated[constr(strict=True), Field(..., description="The scope of the policy to remove from the User Role")], policy_code : Annotated[constr(strict=True), Field(..., description="The code of the policy to remove from the User Role")], **kwargs) -> None:  # noqa: E501
        ...

    ...
    def solve(self, timeoutSec = 1, target = -1e9, lam=None):
        ...
        if cloud.USE_CLOUD:
            ...
            try:
                ...
                print("Not connected to cloud. Local solver not found")
...
if __name__ == "__main__":
    ...
    c1 = -np.array([5, 4, 4, 2, 3, 3, 7, 6, 1, 9])
    A1 = np.array([
        [-3, -1,  1,  3,  0, -1,  2, -3,  1, -3],
        [ 1,  1,  0,  2, -2,  3,  2,  3,  2, -1],
        [-3, -1,  3,  1,  2,  3,  2,  2,  2, -1],
    ...
    b1 = np.array([36, 38, 71, 11, 39])
    prob2.set_objective(c1 @ x)
    prob2.add_constraint(A1 @ x, "<=", b1)
    for _ in range(10):
    ...
    sol1 = np.array([7,15,11,0,15,0,2,13,9,15])
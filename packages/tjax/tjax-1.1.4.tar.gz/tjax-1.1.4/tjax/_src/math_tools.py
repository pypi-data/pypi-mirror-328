...
@overload
def softplus(x: JaxRealArray, /, *, xp: ModuleType | None) -> JaxRealArray: ...
@overload
def softplus(x: RealArray, /, *, xp: ModuleType | None) -> RealArray: ...
def softplus(x: RealArray, /, *, xp: ModuleType | None) -> RealArray:
...
@overload
def log_softplus(x: JaxRealArray, /, *, xp: ModuleType | None) -> JaxRealArray: ...
@overload
def log_softplus(x: RealArray, /, *, xp: ModuleType | None) -> RealArray: ...
def log_softplus(x: RealArray, /, *, xp: ModuleType | None) -> RealArray:
...
@overload
def sublinear_softplus(x: JaxRealArray, maximum: JaxRealArray, /, *, xp: ModuleType | None
                       ) -> JaxRealArray: ...
@overload
def sublinear_softplus(x: RealArray, maximum: RealArray, /, *, xp: ModuleType | None
                       ) -> RealArray: ...
def sublinear_softplus(x: RealArray, maximum: RealArray, /, *, xp: ModuleType | None
                       ) -> RealArray:

...
from ez_manage_tool.app_assignment_widget import EZMCalendarWidget
from ez_manage_tool.app_home_widget import EZMHome
from ez_manage_tool.app_projects_widget import EZMProjectBrowser, EZMProjectItem
from ez_manage_tool.app_assets_widget import EZMAssetManager
from ez_manage_tool.app_extra_widget import EZMProjectWindow, EZMSettings
from ez_manage_tool.app_history import *
from ez_manage_tool.util import *

import json

import ez_manage_tool.custom_widget as custom_widget

HOME_MENU = 0
PROJECT_MENU = 1
ASSET_MENU = 2

CONFIG = os.path.join(get_data_path(), 'user_config.json')

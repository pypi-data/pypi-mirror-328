...
class ResultServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.FindSweepById = channel.unary_unary(
                '/Trimming.ResultService/FindSweepById',
...
class ResultServiceServicer(object):
    ...
    def FindSweepById(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_ResultServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FindSweepById': grpc.unary_unary_rpc_method_handler(
                    servicer.FindSweepById,

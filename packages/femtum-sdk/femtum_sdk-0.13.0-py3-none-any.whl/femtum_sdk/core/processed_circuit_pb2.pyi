...
import femtum_sdk.core.result_pb2 as _result_pb2
...
class ProcessedCircuitFilterRequest(_message.Message):
    __slots__ = ("WaferId", "ReticleId", "DieId", "CircuitId")
    ...
    DieId: str
    CircuitId: str
    def __init__(self, WaferId: _Optional[str] = ..., ReticleId: _Optional[str] = ..., DieId: _Optional[str] = ..., CircuitId: _Optional[str] = ...) -> None: ...

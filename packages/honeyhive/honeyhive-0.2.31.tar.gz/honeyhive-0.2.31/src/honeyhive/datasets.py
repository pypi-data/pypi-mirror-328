...
class Datasets:
    ...
    def add_datapoints(self, dataset_id: str, request_body: operations.AddDatapointsRequestBody) -> operations.AddDatapointsResponse:
        ...
        url = utils.generate_url(base_url, '/datasets/{dataset_id}/datapoints', request)
        ...
        res = operations.AddDatapointsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)

...
from ..models.well_resource_type import WellResourceType
...
class Well:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_resource_type() -> Union[Unset, WellResourceType]:
            resource_type = UNSET
            _resource_type = d.pop("resourceType")
            if _resource_type is not None and _resource_type is not UNSET:
                try:
                    resource_type = WellResourceType(_resource_type)
                except ValueError:
                    resource_type = WellResourceType.of_unknown(_resource_type)
        ...
        try:
            ...
            if strict:
                raise
            resource_type = cast(Union[Unset, WellResourceType], UNSET)
    ...
    def contents(self) -> List[ContainerContent]:
        """ Array of well contents, each with an entity and concentration """
    ...
    @property
    def resource_type(self) -> WellResourceType:
        if isinstance(self._resource_type, Unset):
            raise NotPresentError(self, "resource_type")
        return self._resource_type

    @resource_type.setter
    def resource_type(self, value: WellResourceType) -> None:

...
class MongoConfig:
    ...
    def __set_client(self):
        ...
        client = MongoClient(mongo_url,
                             maxPoolSize=int(os.getenv('MONGO_MAX_PS', 100)),
                             minPoolSize=int(os.getenv('MONGO_MIN_PS', 0)),
                             serverSelectionTimeoutMS=int(os.getenv('MONGO_SSTMS', 120000)),
                             connectTimeoutMS=int(os.getenv('MONGO_CTMS', 120000)))
        self.client = client

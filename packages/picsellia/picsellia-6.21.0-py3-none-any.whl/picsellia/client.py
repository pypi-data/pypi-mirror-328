...
class Client:
    ...
    def create_processing(
        ...
        r = self.connexion.post(
            f"/sdk/organization/{self.id}/processings", data=orjson.dumps(payload)
        ).json()
    ...
    def list_processings(
        ...
        params = filter_payload(params)
        r = self.connexion.get(
            f"/sdk/organization/{self.id}/processings", params=params
        ).json()
    ...
    def get_processing(self, name: str) -> Processing:
        ...
        params = {"name": name}
        r = self.connexion.get(
            f"/sdk/organization/{self.id}/processings/find", params=params
        ).json()
        return Processing(self.connexion, r)
    ...
    def list_annotation_campaigns(
        ...
        r = self.connexion.get(
            f"/sdk/organization/{self.id}/annotationcampaigns", params=params
        ).json()
    ...
    def list_review_campaigns(
        ...
        r = self.connexion.get(
            f"/sdk/organization/{self.id}/reviewcampaigns", params=params
        ).json()

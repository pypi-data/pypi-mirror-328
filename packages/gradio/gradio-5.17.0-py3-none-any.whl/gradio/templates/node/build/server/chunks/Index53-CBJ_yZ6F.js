...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-C7raNZFY.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-Cnwuq0uW.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-BlqCg_MG.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BEnAKvHV.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-CBJ_yZ6F.js.map

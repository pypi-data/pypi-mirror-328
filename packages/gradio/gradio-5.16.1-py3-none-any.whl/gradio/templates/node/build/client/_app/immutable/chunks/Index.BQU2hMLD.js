...
import { S as Static, k as Index$1 } from "./2.D1m5YoB_.js";
function create_fragment$1(ctx) {
  let div2;
  let button;
  let textContent = `<div class="chevron svelte-1isdbb0"><span class="chevron-left svelte-1isdbb0"></span></div>`;
  let t;
  let div1;
  ...
  return {
    ...
    h() {
      attr(button, "class", "toggle-button svelte-1isdbb0");
      attr(button, "aria-label", "Toggle Sidebar");
      attr(div1, "class", "sidebar-content svelte-1isdbb0");
      attr(div2, "class", "sidebar svelte-1isdbb0");
...
class Sidebar extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { open: 5, width: 6, position: 0 });
  }
}

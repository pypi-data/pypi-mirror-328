...
import { B as Block, S as Static, t as MarkdownCode, w as Copy, O as Minimize, P as Maximize } from './2-BlNe9qkL.js';
import { d as dequal } from './index6-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-DFa2jNHS.js';
export { default as BaseExample } from './Example8-pMWtZJ45.js';
  ...
  do {
    ...
    $$rendered = ` <div class="table-container svelte-v7qhxw">${label && label.length !== 0 && show_label || show_fullscreen_button || show_copy_button || show_search !== "none" ? `<div class="header-row svelte-v7qhxw">${label && label.length !== 0 && show_label ? `<div class="label svelte-v7qhxw"><p class="svelte-v7qhxw">${escape(label)}</p></div>` : ``} ${validate_component(Toolbar, "Toolbar").$$render(
      ...
      return `<th${add_attribute("aria-sort", get_sort_status(), 0)} style="${"width: " + escape(column_widths.length ? column_widths[i] : void 0, true) + "; left: " + escape(
        ...
        {},
        {}
      )} <div class="sort-buttons svelte-v7qhxw">${validate_component(SortIcon, "SortIcon").$$render(
        $$result,
        {
          direction: sort_by === i ? sort_direction : null,
          i18n
...
//# sourceMappingURL=Index56-ByS2HOHz.js.map

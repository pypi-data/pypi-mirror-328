...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-Bwq_r3TZ.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-Bf0saCpg.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-Dcolg2Y8.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-p179mkJM.js');
  return module.default;
}
...
//# sourceMappingURL=Index52-Il6ybX6Y.js.map

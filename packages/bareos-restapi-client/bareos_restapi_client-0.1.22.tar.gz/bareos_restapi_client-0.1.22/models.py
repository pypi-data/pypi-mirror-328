...
class jobResource(BaseModel):
    ...
    dirpluginoptions: Optional[List[str]] = Field(None, title="")
    enabled: Optional[bareosBool] = Field(None, title="")
    fdpluginoptions: Optional[List[str]] = Field(None, title="")
...
class Options(BaseModel):
    ...
    compression: Optional[str] = Field(None, title="Compression")
    exclude: Optional[str] = Field(None, title="Exclude")
    one_fs: Optional[str] = Field(None, title="One FS")
    fs_type: Optional[List[str]] = Field(None, title="FS Type")

class ResourceItem(BaseModel):
    file: Optional[List[str]] = Field(None, title="File paths")
    plugin: Optional[List[str]] = Field(None, title="Plugins")

class filesetResource(BaseModel):
    name: str = Field(..., title="Name of the fileset")
    enable_vss: Optional[str] = Field(None, title="Enable VSS")
    options: Optional[Options] = Field(None, title="Options")
    include: Optional[ResourceItem] = Field(None, title="Include items")
    exclude: Optional[ResourceItem] = Field(None, title="Exclude items")

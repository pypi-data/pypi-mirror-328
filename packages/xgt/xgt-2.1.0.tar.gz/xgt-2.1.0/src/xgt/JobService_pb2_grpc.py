...
class JobServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CompileQuery = channel.unary_unary(
                '/xgt.JobService/CompileQuery',
                request_serializer=JobService__pb2.CompileQueryRequest.SerializeToString,
                response_deserializer=JobService__pb2.CompileQueryResponse.FromString,
                _registered_method=True)
...
def add_JobServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CompileQuery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=JobService__pb2.CompileQueryRequest.FromString,
                    response_serializer=JobService__pb2.CompileQueryResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'xgt.JobService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('xgt.JobService', rpc_method_handlers)
...
class JobService(object):
    ...
    def CompileQuery(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/xgt.JobService/CompileQuery',
            JobService__pb2.CompileQueryRequest.SerializeToString,
            JobService__pb2.CompileQueryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

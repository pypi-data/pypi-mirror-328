...
"""
The Python interface to the Rocketgraph xGT graph analytics engine.
...
Queries are expressed as strings written in `OpenCypher <http://docs.rocketgraph.ai/learn/tql_intro/index.html>`_.
...
from .connection import Connection, BasicAuth, KerberosAuth, PKIAuth, ProxyPKIAuth

...
from .common import (_assert_isstring, _assert_noerrors,
                     ...
                     _compare_versions, _validate_column_mapping_in_ingest,
...
class TableFrame(object):
  ...
  @property
  def user_permissions(self) -> Map[str, bool]:
    """
    map of [str, bool]: The actions a user is allowed to take on this frame.
  ...
  def load(self, paths : Union[Seq[str], str],
           ...
           chunk_size : Optional[int] = DEFAULT_CHUNK_SIZE) -> Job:
    """
    ...
    compressed CSV.  See docs.rocketgraph.ai for more details.  Each
    ...
    paths : list or str
      ...
      and negation.  See docs.rocketgraph.ai for more details.
    ...
    suppress_errors : bool
      ...
      .. versionadded:: 1.11.0
    row_filter : str
      OpenCypher fragment used to filter, modify and parameterize the raw data from
  ...
  def save(self, path : str , offset : int = 0, length : int = None,
    ...
    row_filter : str
      OpenCypher fragment used to filter, modify and parameterize the frame's data
      ...
      if has_mixed_dates or xgt_infer_type == "mixed":
        ...
        if ((infer_type == "floating" and
            ...
            (xgt_infer_type == "ndarray" and
             ...
             (not schema_col[1] in [WGSPOINT, CARTESIANPOINT] and
...
class EdgeFrame(TableFrame):
  ...
  def load(self, paths : Union[Seq[str], str],
           ...
           row_filter : Optional[str] = None) -> Job:
    """
    Loads data from one or more files specified in the list of paths.  These
    files may be CSV, Parquet, or compressed CSV.  Some limitations exist for
    compressed CSV.  See docs.rocketgraph.ai for more details.  Each

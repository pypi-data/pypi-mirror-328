...
# from .market_data_pb2 import unit_div
...
class _Printer(object):
  ...
  def _FieldToJsonObject(self, field, value):
    ...
    if field.cpp_type == descriptor.FieldDescriptor.CPPTYPE_MESSAGE:
      ...
      return bool(value)
    elif field.cpp_type in _INT_TYPES:
      return _ConvertInteger(field, value)
  ...
  def _AnyMessageToJsonObject(self, message, with_type=False):
    ...
    # 增加转json的@type过滤   by.zhangluping
    if with_type:
      js['@type'] = type_url
...
def _ConvertInteger(field, value):
  """Convert an integer.

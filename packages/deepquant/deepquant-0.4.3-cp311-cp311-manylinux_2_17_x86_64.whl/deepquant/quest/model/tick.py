...
from deepquant.quest.utils.datetime_func import convert_int_to_datetime, convert_ms_int_to_datetime
...
class TickObject(object):
    ...
    def open_price(self):
        ...
        [float] 当日开盘价
        """
        return self._tick_dict['open_price']
    ...
    def last_price(self):
        ...
        """
        try:
            return self._tick_dict['last_price']
        except KeyError:
    ...
    def high_price(self):
        ...
        [float] 截止到当前的最高价
        """
        return self._tick_dict['high_price']
    ...
    def low_price(self):
        ...
        [float] 截止到当前的最低价
        """
        return self._tick_dict['low_price']
    ...
    def high_limited(self):
        ...
        """
        try:
            return self._tick_dict['high_limited']
        except (KeyError, ValueError):
            return 0
    ...
    def low_limited(self):
        ...
        """
        try:
            return self._tick_dict['low_limited']
        except (KeyError, ValueError):
            return 0

    @property
    def isnan(self):
        return np.isnan(self.last_price)

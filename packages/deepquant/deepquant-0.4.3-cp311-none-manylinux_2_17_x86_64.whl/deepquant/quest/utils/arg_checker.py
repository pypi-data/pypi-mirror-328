...
from deepquant.quest.utils.exception import RQInvalidArgument, RQTypeError, RQApiNotSupportedError
from deepquant.quest.model.instrument import Instrument
from deepquant.quest.environment import Environment
from deepquant.quest.const import INSTRUMENT_TYPE, EXC_TYPE
from deepquant.quest.utils import unwrapper, INST_TYPE_IN_STOCK_ACCOUNT
from deepquant.quest.utils.i18n import gettext as _
from deepquant.quest.utils.exception import patch_system_exc, EXC_EXT_NAME
...
class ArgumentChecker(object):
    ...
    def raise_invalid_instrument_error(self, func_name, value):
        return self.raise_instrument_error(func_name, value, _("valid market_code/instrument"))

    def raise_not_valid_stock_error(self, func_name, value):
        return self.raise_instrument_error(func_name, value, _("valid stock market_code/instrument"))

    def raise_not_valid_future_error(self, func_name, value):
        return self.raise_instrument_error(func_name, value, _("valid future market_code/instrument"))

    def raise_instrument_not_listed_error(self, func_name, value):
        return self.raise_instrument_error(func_name, value, _("listed market_code/instrument"))

...
from deepquant.quest.utils.config import dump_config
...
def mod(cmd, params):
    ...
    yhalpha mod list \n
    yhalpha mod enable xxx \n
    yhalpha mod disable xxx \n
    ...
    def list(params):
        ...
        from deepquant.quest.utils.config import get_mod_conf
        ...
        six.print_("You can use `yhalpha mod list/enable/disable` to manage your mods")
    ...
    def change_mod_status(mod_list, enabled):
        for mod_name in mod_list:
            ...
            if module_name.startswith("mod_sys_"):
                module_name = "deepquant.quest.mod." + module_name
            ...
            from deepquant.quest.utils.config import user_mod_conf_path, load_yaml

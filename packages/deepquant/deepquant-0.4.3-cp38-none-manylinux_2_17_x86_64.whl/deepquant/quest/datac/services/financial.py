...
from deepquant.quest.datac.services.orm.pit_financials_ex import FIELDS_LIST_EX
from ..validators import ensure_list_of_string, ensure_string, check_items_in_container, ensure_date_int
...
def performance_forecast(order_book_ids, info_date=None, end_date=None, fields=None, market="cn"):
    ...
    #)
    data,_,_=gid.fina_forecast(market_code=[order_book_ids])
    # if not data:
    #     return

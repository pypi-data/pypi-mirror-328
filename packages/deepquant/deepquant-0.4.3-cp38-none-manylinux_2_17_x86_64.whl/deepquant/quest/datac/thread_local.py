...
from deepquant.quest.datac.share.errors import ErrorFromBackend, GatewayError
from deepquant.quest.datac.connection import Connection
from deepquant.quest.datac.decorators import retry
from deepquant.quest.datac.utils import connection_error, timeout_error
...
class ThreadLocalConnection:
    ...
    def close(self):
        if getattr(self._local, "connection", None) is not None:
            self._local.connection.close_price()

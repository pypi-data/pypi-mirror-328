...
from deepquant.quest.const import INSTRUMENT_TYPE, POSITION_DIRECTION, DEFAULT_ACCOUNT_TYPE, EXCHANGE
from deepquant.quest.utils import TimeRange, INST_TYPE_IN_STOCK_ACCOUNT
from deepquant.quest.utils.repr import property_repr, PropertyReprMeta
...
class Instrument(metaclass=PropertyReprMeta):
    ...
    def __init__(self, dic: Dict, futures_tick_size_getter: Optional[Callable] = None, *args, **kwrags) -> None:
        ...
        if 'contract_multiplier' in dic:
            if np.isnan(self.contract_multiplier):
                raise RuntimeError("Contract multiplier of {} is not supposed to be nan".format(self.market_code))
    ...
    def market_code(self):
        ...
        """
        return self.__dict__["market_code"]
    ...
    def security_name(self):
        ...
        """
        return self.__dict__["security_name"]
    ...
    def sector_code(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'sector_code' ".format(self.market_code)
            )
    ...
    def sector_code_name(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'sector_code_name' ".format(self.market_code)
            )
    ...
    def industry_code(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'industry_code' ".format(self.market_code)
            )
    ...
    def industry_name(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'industry_name' ".format(self.market_code)
            )
    ...
    def concept_names(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'concept_names' ".format(self.market_code)
            )
    ...
    def board_type(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'board_type' ".format(self.market_code)
            )
    ...
    def status(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'status' ".format(self.market_code)
            )
    ...
    def special_type(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'special_type' ".format(self.market_code)
            )
    ...
    @property
    def underlying_market_code(self):
        """
        [str] 合约标的代码，目前除股指期货(IH, IF, IC)之外的期货合约，这一字段全部为’null’（期货专用）
        """
        try:
            return self.__dict__["underlying_market_code"]
        except (KeyError, ValueError):
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'underlying_market_code' ".format(self.market_code)
            )
    ...
    def underlying_symbol(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'underlying_symbol' ".format(self.market_code)
            )
    ...
    def maturity_date(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'maturity_date' ".format(self.market_code)
            )
    ...
    def settlement_method(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'settlement_method' ".format(self.market_code)
            )
    ...
    def trading_code(self):
        ...
        try:
            ...
            raise AttributeError(
                "Instrument(market_code={}) has no attribute 'trading_code' ".format(self.market_code)
            )
    ...
    def days_to_expire(self):
        if self.type != 'Future' or self.is_future_continuous_contract(self.market_code):
            return -1
    ...
    def get_long_margin_ratio(self, dt: datetime.date) -> float:
        ...
        获取多头保证金率（期货专用）
        """
        return Environment.get_instance().data_proxy.get_futures_trading_parameters(self.market_code, dt).long_margin_ratio
    ...
    def get_short_margin_ratio(self, dt: datetime.date) -> float:
        ...
        获取空头保证金率（期货专用）
        """
        return Environment.get_instance().data_proxy.get_futures_trading_parameters(self.market_code, dt).short_margin_ratio
    ...
    @classmethod
    def is_future_continuous_contract(cls, market_code):
        return re.match(cls.FUTURE_CONTINUOUS_CONTRACT, market_code)

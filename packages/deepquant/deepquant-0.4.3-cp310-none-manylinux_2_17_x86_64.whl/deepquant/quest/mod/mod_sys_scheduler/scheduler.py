...
from deepquant.quest.const import EXC_TYPE, EXECUTION_PHASE, DEFAULT_ACCOUNT_TYPE
from deepquant.quest.core.events import EVENT
from inspect import signature
from deepquant.quest.utils.exception import patch_user_exc, ModifyExceptionFromType
...
class Scheduler(object):
    ...
    def _universe_change(self, event):
        ...
        # 遍历每个标的获取交易时段
        for market_code in event.universe:

...
PRICE_FIELDS = {
    'open', 'close', 'high', 'low', 'high_limited', 'low_limited', 'acc_net_value', 'unit_net_value'
}
...
def adjust_bars(bars, ex_factors, fields, adjust_type, adjust_orig):
    ...
    start_date = bars['orig_time'][0]
    end_date = bars['orig_time'][-1]
    ...
    factors = ex_cum_factors.take(dates.searchsorted(bars['orig_time'], side='right') - 1)

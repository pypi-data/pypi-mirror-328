...
from deepquant.quest.utils.package_helper import import_mod
...
class ModHandler(object):
    def __init__(self):
        self._env = None
        self._mod_list = list()  # type: typing.List[typing.Tuple[str, YhAttrDict]]
    ...
    def set_env(self, environment):
        ...
        for idx, (mod_name, user_mod_config) in enumerate(self._mod_list):
            if hasattr(user_mod_config, 'lib'):
                ...
                lib_name = "deepquant.quest.mod.mod_" + mod_name
            ...
            mod_config = YhAttrDict(copy.deepcopy(getattr(mod_module, "__config__", {})))

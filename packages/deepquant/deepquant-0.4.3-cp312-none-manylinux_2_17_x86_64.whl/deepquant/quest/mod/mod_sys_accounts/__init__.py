...
cli.commands['run'].params.append(
    click.Option(
        ...
        default=None,
        help="[mod_sys_accounts] enable/disable stock T+1"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        help="[mod_sys_accounts] enable dividend reinvestment"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        default=True,
        help="[mod_sys_accounts] return cash when stock delisted"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        help="[mod_sys_accounts] enable stock shorting"
    )
)
...
cli.commands['run'].params.append(
    click.Option(
        ...
        default=None,
        help="[mod_sys_accounts] future settlement price"
    )
)

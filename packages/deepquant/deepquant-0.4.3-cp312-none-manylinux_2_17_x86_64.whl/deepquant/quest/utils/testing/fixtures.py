...
class yhalphaFixture(object):
    def init_fixture(self):
        pass


class EnvironmentFixture(yhalphaFixture):
    ...
    def init_fixture(self):
        from deepquant.quest.utils import YhAttrDict
        from deepquant.quest.environment import Environment

        super(EnvironmentFixture, self).init_fixture()
        self.env = Environment(YhAttrDict(self.env_config), False)
...
class TempDirFixture(yhalphaFixture):
    def __init__(self, *args, **kwargs):
...
class MatcherFixture(EnvironmentFixture):
    def __init__(self, *args, **kwargs):
        ...
        from deepquant.quest.mod.mod_sys_simulation import __config__ as mod_sys_simulation_config
        from deepquant.quest.const import MATCHING_TYPE
    ...
    def init_fixture(self):
        ...
        from deepquant.quest.mod.mod_sys_simulation.matcher import DefaultMatcher

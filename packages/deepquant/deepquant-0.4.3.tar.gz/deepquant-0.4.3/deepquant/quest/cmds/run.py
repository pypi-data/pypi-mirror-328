...
from deepquant.quest.utils.click_helper import Date
...
@click.option('--yhdatac', '--yhdatac-uri', 'base__yhdatac_uri', default=None,
              help='yhdatac uri, eg user:password or or license:xxxxxxx or tcp://user:password@ip:port')
# -- Extra Configuration
...
def run(**kwargs):
    ...
    if results is not None and is_run_from_ipython():
        ...
        ipy.user_global_ns["report"] = YhAttrDict(report)

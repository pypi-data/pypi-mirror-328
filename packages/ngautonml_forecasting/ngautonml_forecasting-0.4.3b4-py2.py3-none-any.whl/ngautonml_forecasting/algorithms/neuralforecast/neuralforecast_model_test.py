...
from ngautonml.wrangler.dataset import Dataset, Metadata, RoleName, Column, DatasetKeys
...
def test_fail_time_col_wrong_type() -> None:
    ...
    dataset[DatasetKeys.COVARIATES.value] = cov
    dataset[DatasetKeys.TARGET.value] = targ

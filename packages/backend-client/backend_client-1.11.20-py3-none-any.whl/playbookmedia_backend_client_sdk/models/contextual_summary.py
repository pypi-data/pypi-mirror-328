...
class ContextualSummary(BaseModel):
    ...
    summary_type: Optional[StrictStr] = Field(default=None, alias="summaryType")
    ...
    __properties: ClassVar[List[str]] = ["id", "versionId", "summaryType", "content", "targetAudience", "keyPoints", "metadata", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "summaryType": obj.get("summaryType"),

...
class AppAnalytics(BaseModel):
    ...
    metric_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="metricValue")
    dimensions: Optional[Dict[str, StrictStr]] = None
    recorded_at: Optional[datetime] = Field(default=None, alias="recordedAt")
    __properties: ClassVar[List[str]] = ["id", "appId", "metricName", "metricValue", "dimensions", "recordedAt"]

...
class DocumentSnapshot(BaseModel):
    ...
    snapshot_hash: Optional[StrictStr] = Field(default=None, alias="snapshotHash")
    ...
    __properties: ClassVar[List[str]] = ["id", "fileId", "snapshotHash", "content", "authorId", "reason", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshotHash": obj.get("snapshotHash"),

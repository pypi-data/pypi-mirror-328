...
class ComplianceViolation(BaseModel):
    ...
    affected_resources: Optional[List[StrictStr]] = Field(default=None, alias="affectedResources")
    remediation_steps: Optional[StrictStr] = Field(default=None, alias="remediationSteps")
    __properties: ClassVar[List[str]] = ["ruleId", "severity", "description", "affectedResources", "remediationSteps"]

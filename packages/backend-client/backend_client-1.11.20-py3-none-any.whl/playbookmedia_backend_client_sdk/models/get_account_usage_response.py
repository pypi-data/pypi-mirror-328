...
class GetAccountUsageResponse(BaseModel):
    """
    ...
    remaining_jobs: Optional[StrictInt] = Field(default=None, alias="remainingJobs")
    reset_time: Optional[datetime] = Field(default=None, alias="resetTime")
    __properties: ClassVar[List[str]] = ["totalJobsRun", "monthlyJobLimit", "remainingJobs", "resetTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remainingJobs": obj.get("remainingJobs"),

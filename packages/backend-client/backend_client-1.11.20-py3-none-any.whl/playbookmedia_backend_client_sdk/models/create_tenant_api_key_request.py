...
class CreateTenantAPIKeyRequest(BaseModel):
    ...
    api_key: Optional[TenantAPIKey] = Field(default=None, alias="apiKey")
    __properties: ClassVar[List[str]] = ["organizationId", "tenantId", "apiKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiKey": TenantAPIKey.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None
        })
        return _obj

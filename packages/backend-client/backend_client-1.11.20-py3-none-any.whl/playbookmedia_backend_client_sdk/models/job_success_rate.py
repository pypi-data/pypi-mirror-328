...
class JobSuccessRate(BaseModel):
    """
    JobSuccessRate
    """ # noqa: E501
    ...
    total_runs: Optional[StrictInt] = Field(default=None, alias="totalRuns")
    __properties: ClassVar[List[str]] = ["workflowId", "successRate", "totalRuns"]

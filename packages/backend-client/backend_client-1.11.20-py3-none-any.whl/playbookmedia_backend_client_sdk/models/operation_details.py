...
class OperationDetails(BaseModel):
    ...
    stack_trace: Optional[List[StrictStr]] = Field(default=None, alias="stackTrace")
    parameters: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["operationId", "startTime", "endTime", "stackTrace", "parameters"]

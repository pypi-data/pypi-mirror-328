...
class AppReview(BaseModel):
    ...
    review_text: Optional[StrictStr] = Field(default=None, alias="reviewText")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "appId", "reviewerId", "rating", "reviewText", "createdAt", "updatedAt"]

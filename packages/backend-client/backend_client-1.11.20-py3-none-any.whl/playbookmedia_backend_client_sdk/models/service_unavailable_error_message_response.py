...
class ServiceUnavailableErrorMessageResponse(BaseModel):
    """
    Represents service availability errors
    """ # noqa: E501
    code: Optional[InternalErrorCode] = InternalErrorCode.NO_INTERNAL_ERROR
    message: Optional[StrictStr] = None
    availability_info: Optional[AvailabilityInfo] = Field(default=None, alias="availabilityInfo")
    error_response: Optional[ErrorResponse] = Field(default=None, alias="errorResponse")
    __properties: ClassVar[List[str]] = ["code", "message", "availabilityInfo", "errorResponse"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of availability_info
        if self.availability_info:
            _dict['availabilityInfo'] = self.availability_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availabilityInfo": AvailabilityInfo.from_dict(obj["availabilityInfo"]) if obj.get("availabilityInfo") is not None else None,

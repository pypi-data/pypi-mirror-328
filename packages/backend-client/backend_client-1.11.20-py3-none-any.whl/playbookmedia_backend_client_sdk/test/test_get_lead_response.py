...
class TestGetLeadResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadResponse:
        """Test GetLeadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadResponse`
        """
        model = GetLeadResponse()
        if include_optional:
            return GetLeadResponse(
                lead = playbookmedia_backend_client_sdk.models.lead_represents_a_scraped_business_entity.Lead represents a scraped business entity(
                    id = '', 
                    name = '', 
                    website = '', 
                    phone = '', 

...
class TestListScrapingJobsResponse(unittest.TestCase):
    """ListScrapingJobsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListScrapingJobsResponse:
        """Test ListScrapingJobsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListScrapingJobsResponse`
        """
        model = ListScrapingJobsResponse()
        if include_optional:
    ...
    def testListScrapingJobsResponse(self):
        """Test ListScrapingJobsResponse"""

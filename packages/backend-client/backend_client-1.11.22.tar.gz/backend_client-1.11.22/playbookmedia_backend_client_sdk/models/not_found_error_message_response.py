...
class NotFoundErrorMessageResponse(BaseModel):
    """
    Represents resource not found errors
    """ # noqa: E501
    code: Optional[NotFoundErrorCode] = NotFoundErrorCode.NO_NOT_FOUND_ERROR
    message: Optional[StrictStr] = None
    resource_info: Optional[ResourceInfo] = Field(default=None, alias="resourceInfo")
    suggestions: Optional[Suggestions] = None
    api_info: Optional[APIInfo] = Field(default=None, alias="apiInfo")
    error_response: Optional[ErrorResponse] = Field(default=None, alias="errorResponse")
    __properties: ClassVar[List[str]] = ["code", "message", "resourceInfo", "suggestions", "apiInfo", "errorResponse"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.api_info:
            _dict['apiInfo'] = self.api_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code") if obj.get("code") is not None else NotFoundErrorCode.NO_NOT_FOUND_ERROR,
            "message": obj.get("message"),
            "resourceInfo": ResourceInfo.from_dict(obj["resourceInfo"]) if obj.get("resourceInfo") is not None else None,
            "suggestions": Suggestions.from_dict(obj["suggestions"]) if obj.get("suggestions") is not None else None,
            "apiInfo": APIInfo.from_dict(obj["apiInfo"]) if obj.get("apiInfo") is not None else None,

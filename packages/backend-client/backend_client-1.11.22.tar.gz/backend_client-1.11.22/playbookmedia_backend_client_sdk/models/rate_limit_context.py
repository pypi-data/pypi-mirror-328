...
class RateLimitContext(BaseModel):
    ...
    affected_endpoints: Optional[List[StrictStr]] = Field(default=None, alias="affectedEndpoints")
    headers: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["userId", "ipAddress", "affectedEndpoints", "headers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affectedEndpoints": obj.get("affectedEndpoints"),

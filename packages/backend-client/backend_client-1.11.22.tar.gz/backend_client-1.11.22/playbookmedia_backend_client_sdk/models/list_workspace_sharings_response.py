...
class ListWorkspaceSharingsResponse(BaseModel):
    """
    ListWorkspaceSharingsResponse
    """ # noqa: E501
    sharings: Optional[List[WorkspaceSharing]] = None
    ...
    __properties: ClassVar[List[str]] = ["sharings", "nextPageToken", "totalSize"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sharings (list)
        _items = []
        if self.sharings:
            for _item in self.sharings:
                if _item:
                    _items.append(_item.to_dict())
            _dict['sharings'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sharings": [WorkspaceSharing.from_dict(_item) for _item in obj["sharings"]] if obj.get("sharings") is not None else None,

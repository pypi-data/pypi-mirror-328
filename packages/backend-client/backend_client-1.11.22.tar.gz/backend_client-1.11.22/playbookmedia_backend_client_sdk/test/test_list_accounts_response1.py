...
class TestListAccountsResponse1(unittest.TestCase):
    """ListAccountsResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAccountsResponse1:
        """Test ListAccountsResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAccountsResponse1`
        """
        model = ListAccountsResponse1()
        if include_optional:
            return ListAccountsResponse1(
                accounts = [
                    playbookmedia_backend_client_sdk.models.core_entities.Core entities(
                        id = '', 
                        auth0_user_id = '', 
                        email = '', 
                        base_directory = '', 
    ...
    def testListAccountsResponse1(self):
        """Test ListAccountsResponse1"""

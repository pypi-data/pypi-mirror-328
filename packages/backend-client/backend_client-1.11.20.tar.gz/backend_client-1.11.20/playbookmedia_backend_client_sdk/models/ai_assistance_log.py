...
class AIAssistanceLog(BaseModel):
    """
    AIAssistanceLog
    """ # noqa: E501
    ...
    user_query: Optional[StrictStr] = Field(default=None, alias="userQuery")
    ai_response: Optional[StrictStr] = Field(default=None, alias="aiResponse")
    context: Optional[Dict[str, StrictStr]] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "documentId", "interactionType", "userQuery", "aiResponse", "context", "createdAt"]

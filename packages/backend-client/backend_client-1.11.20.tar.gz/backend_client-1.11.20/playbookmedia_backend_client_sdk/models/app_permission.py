...
class AppPermission(BaseModel):
    ...
    access_levels: Optional[List[StrictStr]] = Field(default=None, alias="accessLevels")
    constraints: Optional[Dict[str, StrictStr]] = None
    requires_approval: Optional[StrictBool] = Field(default=None, alias="requiresApproval")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "appId", "scope", "description", "isRequired", "accessLevels", "constraints", "requiresApproval", "createdAt", "updatedAt"]

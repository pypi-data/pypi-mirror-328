...
class PauseWorkflowResponse(BaseModel):
    ...
    workflow: Optional[ScrapingWorkflow] = None
    __properties: ClassVar[List[str]] = ["success", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow": ScrapingWorkflow.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj

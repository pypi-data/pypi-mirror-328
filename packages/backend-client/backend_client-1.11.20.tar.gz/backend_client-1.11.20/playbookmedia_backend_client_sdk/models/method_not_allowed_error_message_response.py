...
class MethodNotAllowedErrorMessageResponse(BaseModel):
    """
    Represents errors when HTTP method is not allowed on the endpoint
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    allowed_methods: Optional[List[StrictStr]] = Field(default=None, alias="allowedMethods")
    error_response: Optional[ErrorResponse] = Field(default=None, alias="errorResponse")
    __properties: ClassVar[List[str]] = ["code", "message", "allowedMethods", "errorResponse"]

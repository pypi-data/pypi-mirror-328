...
class TestUpdateAccountResponse1(unittest.TestCase):
    """UpdateAccountResponse1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAccountResponse1:
        """Test UpdateAccountResponse1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAccountResponse1`
        """
        model = UpdateAccountResponse1()
        if include_optional:
    ...
    def testUpdateAccountResponse1(self):
        """Test UpdateAccountResponse1"""

...
class TestPauseWorkflowResponse(unittest.TestCase):
    """PauseWorkflowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PauseWorkflowResponse:
        """Test PauseWorkflowResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PauseWorkflowResponse`
        """
        model = PauseWorkflowResponse()
        if include_optional:
            return PauseWorkflowResponse(
                success = True,
                workflow = playbookmedia_backend_client_sdk.models.scraping_workflow_defines_recurring_scraping_configurations.ScrapingWorkflow defines recurring scraping configurations(
                    id = '', 
                    cron_expression = '', 
    ...
    def testPauseWorkflowResponse(self):
        """Test PauseWorkflowResponse"""

...
class TestUpdateAccountRequest1(unittest.TestCase):
    """UpdateAccountRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAccountRequest1:
        """Test UpdateAccountRequest1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAccountRequest1`
        """
        model = UpdateAccountRequest1()
        if include_optional:
            return UpdateAccountRequest1(
                account = playbookmedia_backend_client_sdk.models.core_entities.Core entities(
                    id = '', 
                    auth0_user_id = '', 
                    email = '', 
                    base_directory = '', 
                    ...
                    workspaces = [
                        playbookmedia_backend_client_sdk.models.workspace1.Workspace1(
                            id = '', 
                            name = '', 
                            unique_identifier = '', 
                            s3_bucket_name = '', 
                    ...
                    data_profiles = [
                        playbookmedia_backend_client_sdk.models.data_profile.DataProfile(
                            id = '', 
                            name = '', 
                            profile_type = '', 
                            data_fields = {
    ...
    def testUpdateAccountRequest1(self):
        """Test UpdateAccountRequest1"""

...
class TestScrapingWorkflow(unittest.TestCase):
    """ScrapingWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScrapingWorkflow:
        """Test ScrapingWorkflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrapingWorkflow`
        """
        model = ScrapingWorkflow()
        if include_optional:

...
class TestGetScrapingJobResponse(unittest.TestCase):
    """GetScrapingJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetScrapingJobResponse:
        """Test GetScrapingJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetScrapingJobResponse`
        """
        model = GetScrapingJobResponse()
        if include_optional:
    ...
    def testGetScrapingJobResponse(self):
        """Test GetScrapingJobResponse"""

...
class PreconditionFailedErrorMessageResponse(BaseModel):
    """
    Represents errors when a precondition provided in the request fails
    """ # noqa: E501
    code: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    failed_conditions: Optional[List[StrictStr]] = Field(default=None, alias="failedConditions")
    error_response: Optional[ErrorResponse] = Field(default=None, alias="errorResponse")
    __properties: ClassVar[List[str]] = ["code", "message", "failedConditions", "errorResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failedConditions": obj.get("failedConditions"),

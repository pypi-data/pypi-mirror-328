...
class TemplateVariable(BaseModel):
    ...
    variable_type: Optional[StrictStr] = Field(default=None, alias="variableType")
    ...
    validation_rules: Optional[StrictStr] = Field(default=None, alias="validationRules")
    data_source: Optional[StrictStr] = Field(default=None, alias="dataSource")
    ai_extraction_rules: Optional[StrictStr] = Field(default=None, alias="aiExtractionRules")
    alternatives: Optional[List[StrictStr]] = None
    template_id: Optional[StrictStr] = Field(default=None, alias="templateId")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "variableType", "defaultValue", "isRequired", "validationRules", "dataSource", "aiExtractionRules", "alternatives", "templateId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aiExtractionRules": obj.get("aiExtractionRules"),

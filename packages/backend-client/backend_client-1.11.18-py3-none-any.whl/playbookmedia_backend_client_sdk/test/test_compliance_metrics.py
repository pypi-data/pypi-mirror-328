...
class TestComplianceMetrics(unittest.TestCase):
    """ComplianceMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceMetrics:
        """Test ComplianceMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceMetrics`
        """
    ...
    def testComplianceMetrics(self):
        """Test ComplianceMetrics"""

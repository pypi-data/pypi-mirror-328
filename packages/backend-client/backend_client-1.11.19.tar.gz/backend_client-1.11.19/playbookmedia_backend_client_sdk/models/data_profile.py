...
class DataProfile(BaseModel):
    ...
    data_fields: Optional[Dict[str, StrictStr]] = Field(default=None, alias="dataFields")
    is_default: Optional[StrictBool] = Field(default=None, alias="isDefault")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "profileType", "dataFields", "isDefault", "createdAt", "updatedAt"]

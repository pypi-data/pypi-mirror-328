...
class TestGetTenantResponse(unittest.TestCase):
    """GetTenantResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTenantResponse:
        """Test GetTenantResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTenantResponse`
        """
        model = GetTenantResponse()
        if include_optional:
            return GetTenantResponse(
                tenant = playbookmedia_backend_client_sdk.models.tenant_represents_an_application/project_within_an_organization.Tenant represents an application/project within an organization(
                    id = '', 
                    name = '', 
                    display_name = '', 
                    description = '', 
...
It defines how and when notifications should be sent to external systems(
    ...
    def testGetTenantResponse(self):
        """Test GetTenantResponse"""

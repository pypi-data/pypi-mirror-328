...
class TestCreateAccountBody(unittest.TestCase):
    """CreateAccountBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAccountBody:
        """Test CreateAccountBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAccountBody`
        """
...
It defines how and when notifications should be sent to external systems(
    ...
    def testCreateAccountBody(self):
        """Test CreateAccountBody"""

...
class TemplateVersion(BaseModel):
    ...
    change_description: Optional[StrictStr] = Field(default=None, alias="changeDescription")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "templateId", "version", "baseContent", "metadata", "authorId", "changeDescription", "createdAt"]

...
class RotateTenantAPIKeyResponse(BaseModel):
    ...
    """ # noqa: E501
    new_api_key: Optional[TenantAPIKey] = Field(default=None, alias="newApiKey")
    ...
    __properties: ClassVar[List[str]] = ["newApiKey", "newKeyValue", "oldKeyExpiry", "tenantId", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newApiKey": TenantAPIKey.from_dict(obj["newApiKey"]) if obj.get("newApiKey") is not None else None,

...
class NegotiationHistory(BaseModel):
    ...
    rounds: Optional[List[NegotiationRound]] = None
    current_status: Optional[StrictStr] = Field(default=None, alias="currentStatus")
    started_at: Optional[datetime] = Field(default=None, alias="startedAt")
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["id", "documentId", "rounds", "currentStatus", "startedAt", "lastUpdated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rounds": [NegotiationRound.from_dict(_item) for _item in obj["rounds"]] if obj.get("rounds") is not None else None,

...
class TestSignatureWorkflow(unittest.TestCase):
    """SignatureWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureWorkflow:
        """Test SignatureWorkflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureWorkflow`
        """
    ...
    def testSignatureWorkflow(self):
        """Test SignatureWorkflow"""

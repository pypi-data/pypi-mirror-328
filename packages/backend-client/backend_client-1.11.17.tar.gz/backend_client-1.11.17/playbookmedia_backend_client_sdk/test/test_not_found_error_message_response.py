    ...
    def make_instance(self, include_optional) -> NotFoundErrorMessageResponse:
        ...
        if include_optional:
            return NotFoundErrorMessageResponse(
                ...
                message = '',
                resource_info = playbookmedia_backend_client_sdk.models.resource_info.ResourceInfo(
                    type = '', 
                    id = '', 
                    path = '', 
                    tenant_id = '', 
                ...
                suggestions = playbookmedia_backend_client_sdk.models.suggestions.Suggestions(
                    similar_resources = [
                        ''
                        ], 
                    alternative_paths = [
                ...
                api_info = playbookmedia_backend_client_sdk.models.api_info.APIInfo(
                    version = '', 
                    supported_versions = [
                        ''
                        ], 

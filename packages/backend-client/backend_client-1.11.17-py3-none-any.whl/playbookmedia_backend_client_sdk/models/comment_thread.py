...
class CommentThread(BaseModel):
    ...
    start_position: Optional[StrictInt] = Field(default=None, alias="startPosition")
    end_position: Optional[StrictInt] = Field(default=None, alias="endPosition")
    resolved: Optional[StrictBool] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "authorId", "content", "startPosition", "endPosition", "resolved", "createdAt", "updatedAt"]

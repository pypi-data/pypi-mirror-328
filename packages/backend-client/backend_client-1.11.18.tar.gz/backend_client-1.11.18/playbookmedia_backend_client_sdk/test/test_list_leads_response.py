...
class TestListLeadsResponse(unittest.TestCase):
    """ListLeadsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListLeadsResponse:
        """Test ListLeadsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListLeadsResponse`
        """
        model = ListLeadsResponse()
        if include_optional:
...
It defines how and when notifications should be sent to external systems(
    ...
    def testListLeadsResponse(self):
        """Test ListLeadsResponse"""

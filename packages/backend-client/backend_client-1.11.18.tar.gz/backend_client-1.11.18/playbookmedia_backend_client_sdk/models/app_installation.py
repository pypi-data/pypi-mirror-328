...
class AppInstallation(BaseModel):
    ...
    version_installed: Optional[StrictStr] = Field(default=None, alias="versionInstalled")
    configuration: Optional[Dict[str, StrictStr]] = None
    installation_status: Optional[StrictStr] = Field(default=None, alias="installationStatus")
    ...
    __properties: ClassVar[List[str]] = ["id", "appId", "workspaceId", "versionInstalled", "configuration", "installationStatus", "installedAt", "lastUsed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versionInstalled": obj.get("versionInstalled"),

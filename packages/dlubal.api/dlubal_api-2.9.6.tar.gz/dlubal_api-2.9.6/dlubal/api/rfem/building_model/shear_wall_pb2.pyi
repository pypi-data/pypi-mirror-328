...
class ShearWallType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SHEAR_WALL_TYPE_UNKNOWN: _ClassVar[ShearWallType]
    SHEAR_WALL_TYPE_STANDARD: _ClassVar[ShearWallType]
SHEAR_WALL_TYPE_UNKNOWN: ShearWallType
SHEAR_WALL_TYPE_STANDARD: ShearWallType
...
class ShearWall(_message.Message):
    ...
    segments: ArrayOfShearWallSegments
    ...
    def __init__(self, no: _Optional[int] = ..., type: _Optional[_Union[ShearWallType, str]] = ..., user_defined_name_enabled: bool = ..., name: _Optional[str] = ..., surfaces: _Optional[_Iterable[int]] = ..., surface_cells: _Optional[_Iterable[int]] = ..., area: _Optional[float] = ..., mass: _Optional[float] = ..., volume: _Optional[float] = ..., center_of_gravity: _Optional[_Union[_common_pb2.Vector3d, _Mapping]] = ..., center_of_gravity_x: _Optional[float] = ..., center_of_gravity_y: _Optional[float] = ..., center_of_gravity_z: _Optional[float] = ..., segments: _Optional[_Union[ArrayOfShearWallSegments, _Mapping]] = ..., member_set: _Optional[_Iterable[int]] = ..., members: _Optional[_Iterable[int]] = ..., sections: _Optional[_Iterable[int]] = ..., result_sections: _Optional[_Iterable[int]] = ..., comment: _Optional[str] = ..., is_generated: bool = ..., generating_object_info: _Optional[str] = ..., create_result_sections: bool = ..., create_result_sections_in_all_member_location: bool = ..., id_for_export_import: _Optional[str] = ..., metadata_for_export_import: _Optional[str] = ...) -> None: ...

class ArrayOfShearWallSegments(_message.Message):
    __slots__ = ()

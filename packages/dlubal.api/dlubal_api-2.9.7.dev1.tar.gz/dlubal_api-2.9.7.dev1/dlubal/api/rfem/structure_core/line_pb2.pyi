...
class LineRotationSurfacePlaneType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    LINE_ROTATION_SURFACE_PLANE_TYPE_ROTATION_PLANE_XY: _ClassVar[LineRotationSurfacePlaneType]
    LINE_ROTATION_SURFACE_PLANE_TYPE_ROTATION_PLANE_XZ: _ClassVar[LineRotationSurfacePlaneType]
...
LINE_ROTATION_SURFACE_PLANE_TYPE_ROTATION_PLANE_XY: LineRotationSurfacePlaneType
LINE_ROTATION_SURFACE_PLANE_TYPE_ROTATION_PLANE_XZ: LineRotationSurfacePlaneType
...
class Line(_message.Message):
    ...
    rotation_surface_plane_type: LineRotationSurfacePlaneType

...
class DashboardApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_embedded_url_endpoint = _Endpoint(
            settings={
                'response_type': (GetEmbeddedUrlResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/tenantservice/v1/dashboards/{provider_dashboard_id}/embedded-url',
                'operation_id': 'get_embedded_url',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_embedded_url(
        ...
        **kwargs
        ...
        """get_embedded_url  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_embedded_url(provider_dashboard_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['provider_dashboard_id'] = \
            provider_dashboard_id
        return self.get_embedded_url_endpoint.call_with_http_info(**kwargs)

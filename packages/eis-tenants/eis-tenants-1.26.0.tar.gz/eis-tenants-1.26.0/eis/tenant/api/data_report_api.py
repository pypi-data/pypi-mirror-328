...
class DataReportApi(object):
    ...
    def create_data_report(
        ...
        **kwargs
        ...
        This will create a data report for tenant in the database  # noqa: E501
    ...
    def get_data_report(
        ...
        **kwargs
        ...
        Retrieves the details of the data-report that was previously created. Supply the unique data-report code      that was returned when you created it and Emil Api will return the corresponding data-report information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_data_reports(
        ...
        **kwargs
        ...
        Returns a list of data-reports you have previously created.        The data-reports are returned in sorted order, with the oldest one appearing first.        For more information about pagination, read the Pagination documentation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_data_report(
        ...
        **kwargs
        ...
        Updates the specified data-report by setting the values of the parameters passed. Any parameters not provided will be left unchanged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

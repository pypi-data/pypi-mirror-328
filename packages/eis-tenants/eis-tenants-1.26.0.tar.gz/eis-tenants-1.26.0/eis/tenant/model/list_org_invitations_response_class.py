...
class ListOrgInvitationsResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([OrgInvitationClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, next_page_token, *args, **kwargs):  # noqa: E501
        """ListOrgInvitationsResponseClass - a model defined in OpenAPI

        Args:
            items ([OrgInvitationClass]): Organization invitations.

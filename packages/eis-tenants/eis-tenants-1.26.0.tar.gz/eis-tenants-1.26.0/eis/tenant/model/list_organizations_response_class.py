...
class ListOrganizationsResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([OrganizationClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, next_page_token, *args, **kwargs):  # noqa: E501
        """ListOrganizationsResponseClass - a model defined in OpenAPI

        Args:
            items ([OrganizationClass]): Organization

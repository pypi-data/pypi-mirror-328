...
class Position:
    ...
    def __eq__(self, other):
        return (isinstance(other, Position) and self.lat == other.lat and self.lon == other.lon)
...
class StreetcarVehicle:
    ...
    def to_vehicle(self) -> Vehicle:
        return Vehicle("rail", self.pos, "color_not_implemented", self.dir_name, "streetcar", self.id, self.route_id)

    ...
    def _initialize_splitter(
        ...
        if tokenizer_type == "tiktoken":
            try:
                ...
                raise Exception(f"Couldn't create the splitter for '{tokenizer_name}'" f" tokenizer due to {e}")
            ...
            try:
                ...
                raise Exception(f"Couldn't create the splitter for '{tokenizer_name}' tokenizer due to {e}")
            self.splitter = splitter

...
ont1 = load_ontology("C:\\Users\\pb21\\OneDrive - National Physical Laboratory\\Documents\\OneNote Notebooks\\W6_Task\\output\\Ec3Epd_ontology.ttl") #1_3 matching(9), 1_2 not matching(0)
...
merged_graph.serialize(destination="merged_ontology_with_skos.ttl", format="turtle")

...
from .patient_ctms_exports import (
    PatientCtmsExportsResource,
    AsyncPatientCtmsExportsResource,
    PatientCtmsExportsResourceWithRawResponse,
    AsyncPatientCtmsExportsResourceWithRawResponse,
    PatientCtmsExportsResourceWithStreamingResponse,
    AsyncPatientCtmsExportsResourceWithStreamingResponse,
)
from .bulk_criteria_instances import (
    BulkCriteriaInstancesResource,
    AsyncBulkCriteriaInstancesResource,
    BulkCriteriaInstancesResourceWithRawResponse,
    AsyncBulkCriteriaInstancesResourceWithRawResponse,
    BulkCriteriaInstancesResourceWithStreamingResponse,
    AsyncBulkCriteriaInstancesResourceWithStreamingResponse,
)
...
class SystemResource(SyncAPIResource):
    ...
    @cached_property
    def bulk_criteria_instances(self) -> BulkCriteriaInstancesResource:
        return BulkCriteriaInstancesResource(self._client)

    @cached_property
    def patient_ctms_exports(self) -> PatientCtmsExportsResource:
        return PatientCtmsExportsResource(self._client)
...
class AsyncSystemResource(AsyncAPIResource):
    ...
    @cached_property
    def bulk_criteria_instances(self) -> AsyncBulkCriteriaInstancesResource:
        return AsyncBulkCriteriaInstancesResource(self._client)

    @cached_property
    def patient_ctms_exports(self) -> AsyncPatientCtmsExportsResource:
        return AsyncPatientCtmsExportsResource(self._client)
...
class SystemResourceWithRawResponse:
    ...
    @cached_property
    def bulk_criteria_instances(self) -> BulkCriteriaInstancesResourceWithRawResponse:
        return BulkCriteriaInstancesResourceWithRawResponse(self._system.bulk_criteria_instances)

    @cached_property
    def patient_ctms_exports(self) -> PatientCtmsExportsResourceWithRawResponse:
        return PatientCtmsExportsResourceWithRawResponse(self._system.patient_ctms_exports)
...
class AsyncSystemResourceWithRawResponse:
    ...
    @cached_property
    def bulk_criteria_instances(self) -> AsyncBulkCriteriaInstancesResourceWithRawResponse:
        return AsyncBulkCriteriaInstancesResourceWithRawResponse(self._system.bulk_criteria_instances)

    @cached_property
    def patient_ctms_exports(self) -> AsyncPatientCtmsExportsResourceWithRawResponse:
        return AsyncPatientCtmsExportsResourceWithRawResponse(self._system.patient_ctms_exports)
...
class SystemResourceWithStreamingResponse:
    ...
    @cached_property
    def bulk_criteria_instances(self) -> BulkCriteriaInstancesResourceWithStreamingResponse:
        return BulkCriteriaInstancesResourceWithStreamingResponse(self._system.bulk_criteria_instances)

    @cached_property
    def patient_ctms_exports(self) -> PatientCtmsExportsResourceWithStreamingResponse:
        return PatientCtmsExportsResourceWithStreamingResponse(self._system.patient_ctms_exports)
...
class AsyncSystemResourceWithStreamingResponse:
    ...
    @cached_property
    def bulk_criteria_instances(self) -> AsyncBulkCriteriaInstancesResourceWithStreamingResponse:
        return AsyncBulkCriteriaInstancesResourceWithStreamingResponse(self._system.bulk_criteria_instances)

    @cached_property
    def patient_ctms_exports(self) -> AsyncPatientCtmsExportsResourceWithStreamingResponse:
        return AsyncPatientCtmsExportsResourceWithStreamingResponse(self._system.patient_ctms_exports)

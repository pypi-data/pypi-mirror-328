...
from .protocol_matches import (
    ProtocolMatchesResource,
    AsyncProtocolMatchesResource,
    ProtocolMatchesResourceWithRawResponse,
    AsyncProtocolMatchesResourceWithRawResponse,
    ProtocolMatchesResourceWithStreamingResponse,
    AsyncProtocolMatchesResourceWithStreamingResponse,
)
...
class PatientsResource(SyncAPIResource):
    ...
    @cached_property
    def protocol_matches(self) -> ProtocolMatchesResource:
        return ProtocolMatchesResource(self._client)
...
class AsyncPatientsResource(AsyncAPIResource):
    ...
    @cached_property
    def protocol_matches(self) -> AsyncProtocolMatchesResource:
        return AsyncProtocolMatchesResource(self._client)
...
class PatientsResourceWithRawResponse:
    ...
    @cached_property
    def protocol_matches(self) -> ProtocolMatchesResourceWithRawResponse:
        return ProtocolMatchesResourceWithRawResponse(self._patients.protocol_matches)
...
class AsyncPatientsResourceWithRawResponse:
    ...
    @cached_property
    def protocol_matches(self) -> AsyncProtocolMatchesResourceWithRawResponse:
        return AsyncProtocolMatchesResourceWithRawResponse(self._patients.protocol_matches)
...
class PatientsResourceWithStreamingResponse:
    ...
    @cached_property
    def protocol_matches(self) -> ProtocolMatchesResourceWithStreamingResponse:
        return ProtocolMatchesResourceWithStreamingResponse(self._patients.protocol_matches)
...
class AsyncPatientsResourceWithStreamingResponse:
    ...
    @cached_property
    def protocol_matches(self) -> AsyncProtocolMatchesResourceWithStreamingResponse:
        return AsyncProtocolMatchesResourceWithStreamingResponse(self._patients.protocol_matches)

...
from ..types import criterion_create_params, criterion_update_params
...
from ..types.shared.criteria_read import CriteriaRead
...
class CriteriaResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        description: Optional[str] | NotGiven = NOT_GIVEN,
        status: Optional[Literal["active", "inactive"]] | NotGiven = NOT_GIVEN,

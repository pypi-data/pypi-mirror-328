...
from ..types.feature_flag import FeatureFlag
...
class FeatureFlagsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        This endpoint is behing the feature flag "feature_flag_test" as an example of
        how to use feature flags in the backend.

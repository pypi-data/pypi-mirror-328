...
class TestBulkVitals:
    ...
    def test_method_update(self, client: WebRecruitmentSDK) -> None:
        ...
        assert_matches_type(BulkInsertResult, bulk_vital, path=["response"])

    @parametrize
    def test_raw_response_update(self, client: WebRecruitmentSDK) -> None:
        response = client.system.patients.bulk_vitals.with_raw_response.update(
            tenant_id="tenant_id",
            body=[
                {
                    "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),
        ...
        bulk_vital = response.parse()
        assert_matches_type(BulkInsertResult, bulk_vital, path=["response"])

    @parametrize
    def test_streaming_response_update(self, client: WebRecruitmentSDK) -> None:
        with client.system.patients.bulk_vitals.with_streaming_response.update(
            tenant_id="tenant_id",
            body=[
                {
                    "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    def test_path_params_update(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_id` but received ''"):
            client.system.patients.bulk_vitals.with_raw_response.update(
                tenant_id="",
                body=[
                    {
                        "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),
...
class TestAsyncBulkVitals:
    ...
    async def test_raw_response_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.system.patients.bulk_vitals.with_raw_response.update(
            tenant_id="tenant_id",
            body=[
                {
                    "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        bulk_vital = await response.parse()
        assert_matches_type(BulkInsertResult, bulk_vital, path=["response"])

    @parametrize
    async def test_streaming_response_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.system.patients.bulk_vitals.with_streaming_response.update(
            tenant_id="tenant_id",
            body=[
                {
                    "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_path_params_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_id` but received ''"):
            await async_client.system.patients.bulk_vitals.with_raw_response.update(
                tenant_id="",
                body=[
                    {
                        "effective_date": parse_datetime("2019-12-27T18:11:19.117Z"),

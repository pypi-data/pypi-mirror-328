...
class ConfigurationData:
    def __init__(
        self,
        *,
        environments: typing.Sequence[typing.Union["RegisteredEnvironment", typing.Dict[builtins.str, typing.Any]]],
    ) -> None:
        '''(experimental) Configuration Data.
    ...
    @builtins.property
    def environments(self) -> typing.List["RegisteredEnvironment"]:
        ...
        result = self._values.get("environments")
        assert result is not None, "Required property 'environments' is missing"
        return typing.cast(typing.List["RegisteredEnvironment"], result)
...
@jsii.data_type(
    jsii_type="@cdklabs/cdk-atmosphere-service.RegisteredEnvironment",
    jsii_struct_bases=[],
    name_mapping={
        "account": "account",
        "pool": "pool",
...
class RegisteredEnvironment:
    def __init__(
        ...
        *,
        ...
        :param role_arn: (experimental) ARN of a role in the account. This role must be pre-created and:. 1. Allow the service itself to assume it. (for cleanup) 2. Allow the service caller to assume it. (for executing tests)

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__9e299c9541cfa4e6eaf1d3edf74c2045c29515ca0a77b23554e72bd8eb30967c)
    ...
    def role_arn(self) -> builtins.str:
        '''(experimental) ARN of a role in the account. This role must be pre-created and:.
    ...
    def __repr__(self) -> str:
        return "RegisteredEnvironment(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
def _typecheckingstub__9e299c9541cfa4e6eaf1d3edf74c2045c29515ca0a77b23554e72bd8eb30967c(
    *,
    account: builtins.str,
    pool: builtins.str,
    region: builtins.str,

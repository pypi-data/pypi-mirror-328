...
masks = tifffile.imread(r"E:\1_DATA\Rheenen\tvl_jr\SP8\2024Nov22_SI_1mg_1year_3D_2D-merge\Villus_crops\2024Nov22_SI_1mg_1year_3D_2D-merge-1-1\hive_output\cellstitch-1.tif")

masks = full_interpolate(masks, anisotropy=4, n_jobs=-1, verbose=True)

tifffile.imwrite(r"E:\1_DATA\Rheenen\tvl_jr\SP8\2024Nov22_SI_1mg_1year_3D_2D-merge\Villus_crops\2024Nov22_SI_1mg_1year_3D_2D-merge-1-1\hive_output\cellstitch_masks_interpolated.tif", masks)

...
class GetChatMember:
    def __init__(self, obj):
        ...
        self.is_anonymous = obj.get("is_anonymous", None)
        self.__user = obj.get("user", None)
        self.user = From_user(user_id=self.__user.get("id", None), fullname=self.__user.get("first_name", None), username=self.__user.get("username", None), is_bot=self.__user.get("is_bot", None), language_code=self.__user.get("language_code", None))

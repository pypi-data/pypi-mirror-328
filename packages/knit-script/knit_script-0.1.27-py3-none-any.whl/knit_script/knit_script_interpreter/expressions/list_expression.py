...
class Sliced_List(Expression):
    ...
    def __init__(self, parser_node, iter_exp: Expression, start: Expression | None = None, start_to_end: bool = False, end: Expression | None = None, end_to_spacer: bool = False,
                 spacer: Expression | None = None, is_index: bool = False):
        """
        Instantiate
        :param parser_node:
...
class List_Comp(Expression):
    ...
    def __init__(self, parser_node, fill_exp: Expression, variables: list[Variable_Expression], iter_exp: Expression, comp_cond: Expression | None):
        """
        Instantiate
        :param parser_node:
        ...
        if len(self._vars) == 1:
            self._var_name = self._vars[0].variable_name
        else:
            self._var_name = None
        self._iter_exp = iter_exp
...
class Dictionary_Comprehension(Expression):
    ...
    def __init__(self, parser_node, key: Expression, value: Expression, variables: list[Variable_Expression], iter_exp: Expression,
                 comp_cond: Expression | None = None):
        """
        Instantiate
        :param parser_node:

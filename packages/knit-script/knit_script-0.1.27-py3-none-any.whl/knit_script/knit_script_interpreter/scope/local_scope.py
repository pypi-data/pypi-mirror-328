...
class Knit_Script_Scope:
    ...
    def __init__(self, context, parent=None, name: str | None = None, is_function: bool = False, is_module: bool = False, module_scope=None):
    ...
    @staticmethod
    def get_value_from_python_scope(key: str) -> tuple:
        """
    ...
    def add_local_by_path(self, path: list[str], value):
        """

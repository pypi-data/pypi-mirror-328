...
def registerSimPeriodicBeforeCallback(callback: typing.Callable[[], None]) -> SimCB:
    ...
def registerSimValueChangedCallback(value: hal._wpiHal.SimValue, callback: typing.Callable[[str, int, hal._wpiHal.SimValueDirection, hal._wpiHal.Value], None], initialNotify: bool) -> SimValueCB:
    ...
def registerSimValueCreatedCallback(device: hal._wpiHal.SimDevice, callback: typing.Callable[[str, int, hal._wpiHal.SimValueDirection, hal._wpiHal.Value], None], initialNotify: bool) -> SimValueCB:
    ...
def registerSimValueResetCallback(value: hal._wpiHal.SimValue, callback: typing.Callable[[str, int, hal._wpiHal.SimValueDirection, hal._wpiHal.Value], None], initialNotify: bool) -> SimValueCB:
    """

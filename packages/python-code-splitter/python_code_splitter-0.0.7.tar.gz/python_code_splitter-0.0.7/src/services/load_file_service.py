...
from src.patterns import BLOCK_START_PATTERN, CLASS_PATTERN, FUNCTION_PATTERN, IMPORT_PATTERN, VALUE_PATTERN
...
class LoadFileService:
    ...
    def execute(self) -> File:
        ...
        for node in ast.iter_child_nodes(tree):
            ...
            while not BLOCK_START_PATTERN.match(lines[number]) and number < node.end_lineno:
                number += 1

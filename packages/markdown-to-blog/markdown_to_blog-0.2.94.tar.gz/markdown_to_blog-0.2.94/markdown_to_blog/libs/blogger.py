...
def upload_to_blogspot(title, fn, BLOG_ID, is_draft=False, datetime_string=None, labels=None, search_description=None) -> str:
    """
    ...
    with codecs.open(fn, "r", "utf_8") as fp:
        ...
        if search_description:
            ...
            meta_description = f'<meta name="description" content="{search_description}"/>\n'

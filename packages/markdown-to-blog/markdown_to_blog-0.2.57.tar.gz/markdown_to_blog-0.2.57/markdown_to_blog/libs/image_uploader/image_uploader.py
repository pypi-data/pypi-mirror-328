...
class ImageUploader:
    ...
    def __init__(self, config: Optional[UploadConfig] = None, service: Optional[str] = None):
        ...
        self.uploader = DefaultImageUploader(service)
    ...
    def upload(self, source: str) -> str:
        ...
        return self._upload_from_url(source) if is_url else self._upload_from_file(source)

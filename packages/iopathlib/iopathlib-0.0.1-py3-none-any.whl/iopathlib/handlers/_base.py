...
class PathHandler:
    ...
    def _mv(self, src_path: str, dst_path: str, **kwargs: typing.Any) -> bool:
    ...
    def _mkdirs(self, path: str, **kwargs: typing.Any) -> None:
    ...
    def _rm(self, path: str, **kwargs: typing.Any) -> None:
    ...
    def _symlink(self, src_path: str, dst_path: str, **kwargs: typing.Any) -> bool:

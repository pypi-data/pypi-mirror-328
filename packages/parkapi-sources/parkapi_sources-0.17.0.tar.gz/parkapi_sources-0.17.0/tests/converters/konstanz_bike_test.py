...
@pytest.fixture
def konstanz_bike_push_converter(mocked_config_helper: Mock, mocked_debug_helper: Mock) -> KonstanzBikePushConverter:
    return KonstanzBikePushConverter(config_helper=mocked_config_helper, debug_helper=mocked_debug_helper)

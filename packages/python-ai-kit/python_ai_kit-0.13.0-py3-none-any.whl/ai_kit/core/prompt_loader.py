    ...
    async def _load_urls(self, references: List[Reference], raw: bool) -> Dict[str, str]:
        ...
        try:
            ...
            async with Fetcher() as fetcher:
                ...
                # Debug print
                # shared_console.print(f"[yellow]Debug: Fetched HTML type: {type(fetched_htmls[0])}[/yellow]")

...
ALLOWED_GOOGLE_MODELS = ["gemini-2.0-flash-thinking", "gemini-2.0-flash"]
...
class GoogleGenAI:
    def __init__(self, model: str):
        self.model = model
        self._validate_model(self.model, ALLOWED_GOOGLE_MODELS)
    ...
    def structured_output_completion(
        ...
        if self.model == "gemini-2.0-flash-thinking":
            raise ValueError("gemini-2.0-flash-thinking does not support structured output")

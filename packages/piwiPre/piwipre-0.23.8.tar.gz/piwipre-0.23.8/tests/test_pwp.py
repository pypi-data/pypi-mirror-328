...
class PwpTester:
    ...
    def program_206(self):
        ...
        ACTOR.move('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/' +  # noqa
                   ...
                   'tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/foo.JPG')
        ACTOR.move('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/foo.JPG',
                   'tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/' +  # noqa
                   '2023-06-17-11h05-45-Armor-cup.JPG')
        LOGGER.test_msg('')
        LOGGER.test_msg('.jpg mved to .JPG ')

        ACTOR.copy('tests/sources/PICTURES/Corse/IMG-20200517-WA0000.jpg',
                   "tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/IMG-20200517-WA0000.jpg")
        # hours minutes will be taken from filename
        ACTOR.copy('tests/sources/PICTURES/Corse/IMG-20210818-WA0000.jpg',
                   "tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/IMG-20210818-WA1255.jpg")
        ACTOR.copy('tests/sources/PICTURES/Forêt-de-la-Corbière/20230611_162803.jpg',           # noqa
                   "tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/20230611_162803.jpg")

        LOGGER.test_msg('add IMGxxxx, PICTxxx, normal file')   # noqa
        LOGGER.test_msg('')

        cmdline = self.build_test_cmdline({'--verify-album': 'ALBUM/2023/2023-06-Juin-17-Armor-cup',
                                           '--enable-rename-verifying': False,
                                           '--enable-minimal-rename-verifying': True,
        ...
        LOGGER.test_msg('File moved to .JPG was moved back to .jpg')

        self.assert_file('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/' +  # noqa
                         '2023-06-17-16h28-04-Armor-cup.jpg')  # noqa
        self.assert_file('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/' +  # noqa
                         '2023-06-17-00h00-00-Armor-cup.jpg')  # noqa
        self.assert_file('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/' +  # noqa
                         '2023-06-17-12h55-00-Armor-cup.jpg')  # noqa
        LOGGER.test_msg('minimal-rename-verifying did change name of obviously not named files')
    ...
    def program_620(self):
        ...
        LOGGER.test_msg('')
        LOGGER.test_msg('Step 2: verify-album --rename-verifying True')
        LOGGER.test_msg('')
        ...
        LOGGER.test_msg('')
        LOGGER.test_msg('Step 3: verify-album --rename-verifying False')
        LOGGER.test_msg('')
    ...
    def program_0(self):
        ...
        ACTOR.mkdirs(f"{self.home_config['album']}/foo")
        ACTOR.rmtree(f"{self.home_config['album']}/foo")

...
class Config:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        """
        self.config_path = (
            Path(config_path) if config_path else Path.home() / ".think-llm-client" / "config.json"
        )
        self._load_config()
            ...
            "llm": {
                "providers": {
                    "openai": {
                        ...
                        "model": {"gpt-4": {"max_completion_tokens": 8192}},
                    }
                }
            },
            "vlm": {
                "providers": {
                    "openai": {
                        "api_key": "${OPENAI_API_KEY}",
                        "api_url": "https://api.openai.com/v1",
                        "model": {"gpt-4-vision": {"max_completion_tokens": 4096}},
                    }
                }
            },
        }

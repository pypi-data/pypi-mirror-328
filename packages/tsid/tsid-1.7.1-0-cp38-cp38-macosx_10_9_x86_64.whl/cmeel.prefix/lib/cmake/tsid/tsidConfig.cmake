...
set("tsid_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("TSID_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("tsid_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/tsid/doxygen-html")
set("TSID_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/tsid/doxygen-html")
set("tsid_DEPENDENCIES" "eigenpy;pinocchio;eiquadprog")
...
set("_tsid_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_tsid_PKG_CONFIG_LIBS_LIST" "")
if(_tsid_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_tsid_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _tsid_PKG_CONFIG_LIBS_LIST "${_tsid_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_tsid_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _tsid_PKG_CONFIG_LIBS_LIST "${_tsid_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_tsid_PKG_CONFIG_LIBDIR})
  foreach(component ${_tsid_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_tsid_PKG_CONFIG_LIBS_LIST)
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_dependency(eigenpy 2.7.12 REQUIRED)

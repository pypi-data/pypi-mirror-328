...
class ClusterConfigM0(BaseModel):
    """
    ClusterConfigM0
    """  # noqa: E501

    elements: List[ClusterConfigM0ElementsInner]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClusterConfigM0 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ClusterConfigM0 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "elements": (
                    [
                        ClusterConfigM0ElementsInner.from_dict(_item)
                        for _item in obj.get("elements")
                    ]

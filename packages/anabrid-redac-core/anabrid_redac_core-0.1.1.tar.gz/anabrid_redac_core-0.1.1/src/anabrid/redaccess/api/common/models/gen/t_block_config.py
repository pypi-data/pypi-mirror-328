...
class TBlockConfig(BaseModel):
    """
    TBlockConfig
    """  # noqa: E501

    muxes: List[int | None]
    __properties: ClassVar[List[str]] = ["muxes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TBlockConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TBlockConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"muxes": obj.get("muxes")})

...
class Stats(BaseModel):
    ...
    processed_jobs: Optional[StrictInt] = Field(default=None, alias="processedJobs")
    uptime: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["processedJobs", "uptime"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"processedJobs": obj.get("processedJobs"), "uptime": obj.get("uptime")}
        )

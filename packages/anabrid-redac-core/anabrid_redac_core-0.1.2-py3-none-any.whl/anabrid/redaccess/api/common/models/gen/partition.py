...
class Partition(BaseModel):
    ...
    status: StrictStr
    queue: StrictInt = Field(
        description="Number of jobs waiting in the queue of this partition."
    )
    carriers: List[StrictStr]
    __properties: ClassVar[List[str]] = ["status", "queue", "carriers"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError("must be one of enum values ('IDLE', 'BUDY', 'DISABLED')")
        return value

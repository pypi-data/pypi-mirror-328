...
class LogEntry(BaseModel):
    ...
    timestamp: StrictInt = Field(
        description="The timestamp when this log entry was written"
    )
    entry: StrictStr = Field(
        description="The log entry; multiple lines are concatenated as string."
    )
    __properties: ClassVar[List[str]] = ["timestamp", "entry"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"timestamp": obj.get("timestamp"), "entry": obj.get("entry")}
        )

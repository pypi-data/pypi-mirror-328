...
class ClusterConfigC(BaseModel):
    """
    ClusterConfigC
    """  # noqa: E501

    elements: List[Union[StrictFloat, StrictInt]]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClusterConfigC from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ClusterConfigC from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"elements": obj.get("elements")})

...
def introduce_sinks_demands(logger, model): 
    ...
    # WARNING: both 'hd_un' and 'ha_un' are present
    sinks = ['apoACP', 'ha_un', 'hd_un', 'thioca']
    demands = ['scp']
...
def introduce_biomass(logger, db, model): 
    ...
    biomass_dict = {
        ...
        'cofactors': [
            ...
            'ribflv_c', 'pnto__R_c', 
            'mql8_c', #'mqn8_c',  # menaquinol / manaquinone
            'q8h2_c', #'q8_c',   # ubiquinol / ubiquinone
            'phllqol_c', #'phllqne_c',  # phylloquinol / phylloquinone
            # biotin
            # vitamin B12 (reuteri)
        ],
        'membrane_wall': [

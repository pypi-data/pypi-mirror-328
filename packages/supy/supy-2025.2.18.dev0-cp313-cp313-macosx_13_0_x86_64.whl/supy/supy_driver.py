...
class Suews_Driver(f90wrap.runtime.FortranModule):
    ...
    def suews_cal_multitsteps(n_buildings, h_std, flag_test, metforcingblock, \
        ...
        use_sw_direct_albedo, stebbsmethod, buildingname, buildingtype, \
        ...
        """
        output_block_suews, debug_state = suews_cal_multitsteps(n_buildings, h_std, \
            flag_test, metforcingblock, len_sim, ah_min, ahprof_24hr, ah_slope_cooling, \
        ...
        output_block_suews, debug_state = \
            ...
            buildingname=buildingname, buildingtype=buildingtype, \

...
class PostToolModule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostToolModule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostToolModule:
        """Create an instance of PostToolModule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostToolModule.parse_obj(obj)

        _obj = PostToolModule.parse_obj({
            "scope": obj.get("scope"),
            "identifier": obj.get("identifier"),
            "description": obj.get("description"),
            "version_bump": obj.get("version_bump") if obj.get("version_bump") is not None else 'patch',
            "data": ToolModule.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })

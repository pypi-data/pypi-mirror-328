...
class Client:
    def __init__(self, session_name: str = None, restore_key: str = None, passport: str = None,
                 udid: str = None, base_url: str = None, time_out: int = None) -> None:
        ...
        self.sendRequest = Network(passport=self.passport, base_url=base_url, time_out=time_out).sendRequest
    ...
    def getConstants(self, mobile_model: str = None, constant_version: Union[str, int] = None, store_type: str = "bazar"):
    ...
    def changePlayerName(self, name: str):
        return self.setPlayerInfo(name=name, lang='fa')

    def changePlayerAvatar(self, avatar_id: int):
        return self.setPlayerInfo(avatar_id=avatar_id)
    ...
    def createTribe(self, name: str, description: str, status: int = TribeStatuses.CLOSED):
        return self.sendRequest("tribe/create", {
            "name": name,
    ...
    def joinTribe(self, tribe_id: int):
        return self.sendRequest("tribe/joinrequest", {"tribe_id": tribe_id})
    ...
    def leaveTribe(self):
        return self.sendRequest("tribe/leave")

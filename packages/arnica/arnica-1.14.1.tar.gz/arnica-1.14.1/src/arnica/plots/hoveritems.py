...
class HoverItems:
    ...
    def add_marker(self, x, y, label, color=None, size=5, shape="o"):
    ...
    def on_hover(self, event):
        ...
        if event.inaxes != self.ax:
            return
        past_item, past_annotation = self.current_focus
    ...
    def _update_annotation(self, x, y, item, annotation, past_annotation):

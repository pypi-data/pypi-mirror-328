...
class LangchainOpenai:
    ...
    def __init__(self, openai_api_base: str, *, openai_api_key: Optional[str] = "None", streaming: bool = True,
                 model: str = "gpt-4", system: Optional[str] = None, prompt: Optional[str] = None,
        ...
        streaming: bool = True  是流式调用还是非流式调用 ，不填默认流式调用
        model: str = "gpt-4"    模型名称，不填默认为 gpt-4
        system: Optional[str] = None   系统提示词，为空有默认值

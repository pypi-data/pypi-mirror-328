...
class CustomerClient:
    ...
    def _to_dynamo_item(self, customer: Customer) -> Dict[str, Any]:
        ...
        for key, value in customer_dict.items():
            if key not in {'name', 'subscription_id', 'users', 'is_org'}:
    ...
    def _from_dynamo_item(self, item: Dict[str, Any]) -> Customer:
        ...
        customer_data = {
            'name': item['name'],
            'subscription_id': item['subscription_info']['stripe_id'],
        ...
        for key, value in item.items():
            if key not in {'id', 'name', 'subscription_info', 'created', 'users', 'is_org'}:

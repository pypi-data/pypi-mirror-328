...
from AICORELibrary.openlit.instrumentation.openai.openai import chat_completions, embedding, finetune
from AICORELibrary.openlit.instrumentation.openai.openai import image_generate, image_variatons, audio_create
from AICORELibrary.openlit.instrumentation.openai.async_openai import async_chat_completions, async_embedding
from AICORELibrary.openlit.instrumentation.openai.async_openai import async_finetune
from AICORELibrary.openlit.instrumentation.openai.async_openai import async_image_generate, async_image_variatons
from AICORELibrary.openlit.instrumentation.openai.async_openai import async_audio_create

from AICORELibrary.openlit.instrumentation.openai.azure_openai import azure_chat_completions, azure_completions
from AICORELibrary.openlit.instrumentation.openai.azure_openai import azure_image_generate, azure_embedding
from AICORELibrary.openlit.instrumentation.openai.async_azure_openai import azure_async_chat_completions
from AICORELibrary.openlit.instrumentation.openai.async_azure_openai import azure_async_completions
from AICORELibrary.openlit.instrumentation.openai.async_azure_openai import azure_async_image_generate
from AICORELibrary.openlit.instrumentation.openai.async_azure_openai import azure_async_embedding

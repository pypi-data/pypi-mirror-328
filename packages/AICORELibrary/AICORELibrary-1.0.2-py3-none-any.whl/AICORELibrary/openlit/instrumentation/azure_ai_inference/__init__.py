...
from AICORELibrary.openlit.instrumentation.azure_ai_inference.azure_ai_inference import (
    complete, embedding
)

from AICORELibrary.openlit.instrumentation.azure_ai_inference.async_azure_ai_inference import (

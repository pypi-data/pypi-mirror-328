...
from AICORELibrary.openlit.instrumentation.google_ai_studio.google_ai_studio import (
    generate
)

from AICORELibrary.openlit.instrumentation.google_ai_studio.async_google_ai_studio import (
    async_generate
)

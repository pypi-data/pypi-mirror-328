...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["max_retries", "name", "pulp_labels", "sock_connect_timeout", "connect_timeout", "tls_validation", "headers", "total_timeout", "hidden_fields", "prn", "pulp_last_updated", "client_cert", "download_concurrency", "sock_read_timeout", "url", "ca_cert", "proxy_url", "pulp_created", "pulp_href", "rate_limit", "metadata_only", "git_ref"]

...
class ContentCollectionSignaturesApi:
    ...
    def create(
        self,
        signed_collection: Annotated[StrictStr, Field(description="The content this signature is pointing to.")],
        ...
        :param signed_collection: The content this signature is pointing to. (required)
        :type signed_collection: str
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/ansible/collection_signatures/',
    ...
    def list(
        ...
        pubkey_fingerprint: Annotated[Optional[StrictStr], Field(description="Filter results where pubkey_fingerprint matches value")] = None,
        pubkey_fingerprint__in: Annotated[Optional[List[StrictStr]], Field(description="Filter results where pubkey_fingerprint is in a comma-separated list of values")] = None,
        ...
        signed_collection: Annotated[Optional[StrictStr], Field(description="Filter signatures for collection version")] = None,
        signing_service: Annotated[Optional[StrictStr], Field(description="Filter signatures produced by signature service")] = None,
        ...
        :param pubkey_fingerprint: Filter results where pubkey_fingerprint matches value
        :type pubkey_fingerprint: str
        :param pubkey_fingerprint__in: Filter results where pubkey_fingerprint is in a comma-separated list of values
        :type pubkey_fingerprint__in: List[str]
        ...
        :param signed_collection: Filter signatures for collection version
        :type signed_collection: str
        :param signing_service: Filter signatures produced by signature service
        :type signing_service: str
        ...
        _param = self._list_serialize(
            ...
            pubkey_fingerprint__in=pubkey_fingerprint__in,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedansibleCollectionVersionSignatureResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedansibleCollectionVersionSignatureResponseList]:
        """List collection version signatures
    ...
    def _list_serialize(
        ...
        if pubkey_fingerprint is not None:
            ...
            _query_params.append(('pubkey_fingerprint', pubkey_fingerprint))
            
        if pubkey_fingerprint__in is not None:
            
            _query_params.append(('pubkey_fingerprint__in', pubkey_fingerprint__in))
        ...
        if signed_collection is not None:
            ...
            _query_params.append(('signed_collection', signed_collection))
            
        if signing_service is not None:
            
            _query_params.append(('signing_service', signing_service))
    ...
    def read(
        self,
        ansible_collection_version_signature_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param ansible_collection_version_signature_href: (required)
        :type ansible_collection_version_signature_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            ansible_collection_version_signature_href=ansible_collection_version_signature_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnsibleCollectionVersionSignatureResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnsibleCollectionVersionSignatureResponse]:
        """Inspect a collection version signature
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if ansible_collection_version_signature_href is not None:
            _path_params['ansible_collection_version_signature_href'] = ansible_collection_version_signature_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_collection_version_signature_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

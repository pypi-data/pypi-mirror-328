...
class ContentCollectionMarksApi:
    ...
    def create(
        self,
        ansible_collection_version_mark: AnsibleCollectionVersionMark,
        ...
        :param ansible_collection_version_mark: (required)
        :type ansible_collection_version_mark: AnsibleCollectionVersionMark
        ...
        _param = self._create_serialize(
            ansible_collection_version_mark=ansible_collection_version_mark,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "AnsibleCollectionVersionMarkResponse",
        }
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnsibleCollectionVersionMarkResponse]:
        """Create a collection version mark
    ...
    def _create_serialize(
        ...
        if ansible_collection_version_mark is not None:
            _body_params = ansible_collection_version_mark
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/ansible/collection_marks/',
    ...
    def list(
        ...
        marked_collection: Annotated[Optional[StrictStr], Field(description="Filter marks for collection version")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None,
        ordering: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `pulp_id` - Pulp id * `-pulp_id` - Pulp id (descending) * `pulp_created` - Pulp created * `-pulp_created` - Pulp created (descending) * `pulp_last_updated` - Pulp last updated * `-pulp_last_updated` - Pulp last updated (descending) * `pulp_type` - Pulp type * `-pulp_type` - Pulp type (descending) * `upstream_id` - Upstream id * `-upstream_id` - Upstream id (descending) * `timestamp_of_interest` - Timestamp of interest * `-timestamp_of_interest` - Timestamp of interest (descending) * `value` - Value * `-value` - Value (descending) * `pk` - Pk * `-pk` - Pk (descending)")] = None,
        ...
        value: Annotated[Optional[StrictStr], Field(description="Filter marks by value")] = None,
        value__in: Annotated[Optional[List[StrictStr]], Field(description="Filter results where value is in a comma-separated list of values")] = None,
        ...
        :type limit: int
        :param marked_collection: Filter marks for collection version
        :type marked_collection: str
        ...
        :param value: Filter marks by value
        :type value: str
        :param value__in: Filter results where value is in a comma-separated list of values
        :type value__in: List[str]
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedansibleCollectionVersionMarkResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedansibleCollectionVersionMarkResponseList]:
        """List collection version marks
    ...
    def _list_serialize(
        ...
        if marked_collection is not None:
            
            _query_params.append(('marked_collection', marked_collection))
        ...
        if value__in is not None:
            
            _query_params.append(('value__in', value__in))
    ...
    def read(
        self,
        ansible_collection_version_mark_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param ansible_collection_version_mark_href: (required)
        :type ansible_collection_version_mark_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            ansible_collection_version_mark_href=ansible_collection_version_mark_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnsibleCollectionVersionMarkResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if ansible_collection_version_mark_href is not None:
            _path_params['ansible_collection_version_mark_href'] = ansible_collection_version_mark_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_collection_version_mark_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

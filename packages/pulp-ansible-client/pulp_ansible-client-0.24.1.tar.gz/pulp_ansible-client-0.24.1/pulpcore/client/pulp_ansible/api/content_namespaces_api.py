...
class ContentNamespacesApi:
    ...
    def avatar(
        self,
        ansible_ansible_namespace_metadata_href: StrictStr,
        ...
        :param ansible_ansible_namespace_metadata_href: (required)
        :type ansible_ansible_namespace_metadata_href: str
        ...
        _param = self._avatar_serialize(
            ansible_ansible_namespace_metadata_href=ansible_ansible_namespace_metadata_href,
            fields=fields,
    ...
    @validate_call
    def avatar_without_preload_content(
        self,
        ansible_ansible_namespace_metadata_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
    ...
    def _avatar_serialize(
        ...
        if ansible_ansible_namespace_metadata_href is not None:
            _path_params['ansible_ansible_namespace_metadata_href'] = ansible_ansible_namespace_metadata_href
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_ansible_namespace_metadata_href}avatar/',
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp/api/v3/content/ansible/namespaces/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_ansible_namespace_metadata_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

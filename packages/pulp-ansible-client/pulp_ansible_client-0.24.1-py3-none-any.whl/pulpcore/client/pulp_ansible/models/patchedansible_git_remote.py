...
class PatchedansibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["password", "max_retries", "name", "pulp_labels", "proxy_username", "sock_connect_timeout", "connect_timeout", "tls_validation", "headers", "total_timeout", "client_key", "client_cert", "download_concurrency", "sock_read_timeout", "url", "ca_cert", "proxy_url", "proxy_password", "username", "rate_limit", "metadata_only", "git_ref"]

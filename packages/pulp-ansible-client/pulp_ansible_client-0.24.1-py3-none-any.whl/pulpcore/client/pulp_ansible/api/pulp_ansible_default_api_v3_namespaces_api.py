...
class PulpAnsibleDefaultApiV3NamespacesApi:
    ...
    def list(
        ...
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/default/api/v3/namespaces/ is deprecated.", DeprecationWarning)
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/default/api/v3/namespaces/',
    ...
    def read(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/default/api/v3/namespaces/{name}/ is deprecated.", DeprecationWarning)
    ...
    def _read_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/default/api/v3/namespaces/{name}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

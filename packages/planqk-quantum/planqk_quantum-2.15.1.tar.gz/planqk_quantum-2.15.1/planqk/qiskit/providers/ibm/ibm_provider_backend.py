...
from planqk.client.job_dtos import JobDto, RuntimeJobParamsDto
from planqk.client.model_enums import BackendStatus, Job_Input_Format
...
class PlanqkIbmProviderBackend(PlanqkIbmQiskitBackend):
    ...
    def _submit_job(
        ...
        job_request = JobDto(backend_id=self.backend_info.id,
                             ...
                             input_format=Job_Input_Format.QISKIT,
                             input=encoded_input,

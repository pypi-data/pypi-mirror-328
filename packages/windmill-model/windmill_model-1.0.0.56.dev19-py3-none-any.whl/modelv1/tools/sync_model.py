...
class ModelSyncManager:
    ...
    def __init__(self, config: Config, windmill_client: WindmillClient, job_client: JobClient):
        """
...
def main() -> int:
    ...
    try:
        ...
        sync_manager = ModelSyncManager(config, job_client=job_client, windmill_client=windmill_client)

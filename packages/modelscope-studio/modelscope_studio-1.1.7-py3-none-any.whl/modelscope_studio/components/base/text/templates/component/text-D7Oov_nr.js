import { w as p, g as J } from "./Index-D-ClyRr6.js";
...
function pe(r) {
  ...
  return {
    c() {
      t = A("react-portal-target"), l = ie(), e && e.c(), n = E(), this.h();
    },
    l(s) {
...
function me(r, t, l) {
  ...
  return r.$$set = (a) => {
    l(17, t = k(k({}, t), R(a))), "svelteInit" in a && l(5, _ = a.svelteInit), "$$scope" in a && l(6, s = a.$$scope);
  }, t = R(t), [n, o, f, d, i, _, s, e, z, B];
}
class ge extends Z {
  constructor(t) {
...
const he = be(({
  ...
  children: r || /* @__PURE__ */ v.jsx("span", {})
}));
export {
  he as Text,
  he as default

...
var At = typeof exports == "object" && exports && !exports.nodeType && exports, H = At && typeof module == "object" && module && !module.nodeType && module, Or = H && H.exports === At, ge = Or && gt.process, B = function() {
  try {
...
function Us(e, t, n) {
  ...
  const c = Qa(() => import("./date-picker.preset-B-8gAxGf.js"));
  let {
    gradio: f
  } = t, {
    props: _ = {}
  ...
  return ee(e, Le, (g) => n(18, a = g)), e.$$set = (g) => {
    ...
    262145 && n(1, r = {
      props: {
        style: s.elem_style,
        className: bs(s.elem_classes, "ms-gr-antd-date-picker-preset"),
        id: s.elem_id,
        label: s.label,
        value: s.value,
        ...s.restProps,

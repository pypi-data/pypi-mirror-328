import { w as m, g as N } from "./Index-DLAzPQzB.js";
...
function oe(r) {
  ...
  return {
    c() {
      s = A("react-portal-target"), o = Z(), e && e.c(), l = y(), this.h();
    },
    l(t) {
      s = D(t, "REACT-PORTAL-TARGET", {
        class: !0
      }), R(s).forEach(_), o = j(t), e && e.l(t), l = y(), this.h();
    },
    h() {
      K(s, "class", "svelte-1rt0kpf");
    },
    m(t, i) {
      p(t, s, i), r[8](s), p(t, o, i), e && e.m(t, i), p(t, l, i), n = !0;
    },
    p(t, [i]) {
      /*$$slots*/
...
function le(r, s, o) {
  ...
  return r.$$set = (a) => {
    o(17, s = I(I({}, s), C(a))), "svelteInit" in a && o(5, c = a.svelteInit), "$$scope" in a && o(6, t = a.$$scope);
  }, s = C(s), [l, n, f, d, i, c, t, e, G, M];
}
class re extends V {
  constructor(s) {
      ...
      props: {
        svelteInit(t) {
          ...
          return c.nodes = [...c.nodes, i], T({
            ...
            c.nodes = c.nodes.filter((u) => u.svelteInstance !== n), T({
              createPortal: v,
              node: b
            });
          }), i;

...
var pt = typeof global == "object" && global && global.Object === Object && global, kt = typeof self == "object" && self && self.Object === Object && self, x = pt || kt || Function("return this")(), P = x.Symbol, gt = Object.prototype, en = gt.hasOwnProperty, tn = gt.toString, H = P ? P.toStringTag : void 0;
function nn(e) {
...
var Pt = typeof exports == "object" && exports && !exports.nodeType && exports, q = Pt && typeof module == "object" && module && !module.nodeType && module, Tr = q && q.exports === Pt, ce = Tr && pt.process, z = function() {
  try {
    var e = q && q.require && q.require("util").types;
    return e || ce && ce.binding && ce.binding("util");
  } catch {
  }
}(), Be = z && z.isTypedArray, $t = Be ? $e(Be) : vr, wr = Object.prototype, Or = wr.hasOwnProperty;
function At(e, t) {
  var n = A(e), r = !n && Pe(e), i = !n && !r && te(e), o = !n && !r && !i && $t(e), a = n || r || i || o, s = a ? zn(e.length, String) : [], u = s.length;
  for (var l in e)
...
var Pr = St(Object.keys, Object), $r = Object.prototype, Ar = $r.hasOwnProperty;
function Sr(e) {
  if (!Tt(e))
    return Pr(e);
  var t = [];
...
var be = K(x, "DataView"), he = K(x, "Promise"), ye = K(x, "Set"), Ye = "[object Map]", Li = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Di = N(be), Ni = N(X), Ki = N(he), Ui = N(ye), Gi = N(de), $ = D;
...
function Qa(e, t = {}, n = !1) {
  return Ba(Gt(e, n ? [] : Bt), (r, i) => t[i] || Vt(i));
}
function st(e, t) {
  const {
    gradio: n,
...
function Ks(e, t, n) {
  ...
  const d = Za(() => import("./space.compact-BVCLnUnS.js"));
  let {
    gradio: _
  } = t, {
    props: c = {}

...
var be = K(x, "DataView"), he = K(x, "Promise"), ye = K(x, "Set"), We = "[object Map]", Ri = "[object Object]", Ye = "[object Promise]", Ze = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Li = N(be), Di = N(J), Ni = N(he), Ki = N(ye), Ui = N(de), $ = D;
(be && $(new be(new ArrayBuffer(1))) != Ve || J && $(new J()) != We || he && $(he.resolve()) != Ye || ye && $(new ye()) != Ze || de && $(new de()) != Qe) && ($ = function(e) {
...
function Rs(e, t, n) {
  ...
  const g = Wa(() => import("./welcome-HqFLPCv1.js"));
  let {
    gradio: _
  } = t, {
    props: c = {}

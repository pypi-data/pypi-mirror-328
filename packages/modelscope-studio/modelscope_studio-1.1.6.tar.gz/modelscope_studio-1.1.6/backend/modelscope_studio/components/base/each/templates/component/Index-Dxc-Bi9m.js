...
function El(e, t, n) {
  ...
  const l = pe(() => import("./fragment-samHdqQa.js"));
  let {
    _internal: c = {}
  } = t, {
    as_item: _ = void 0
...
function Yl(e, t, n) {
  ...
  const s = pe(() => import("./each.item-BwLXF-6b.js"));
  let {
    context_value: l
  } = t, {
    index: c
...
function du(e, t, n) {
  ...
  const c = pe(() => import("./each-DGK1CsF5.js")), _ = pe(() => import("./each.placeholder-3xvqBMZL.js"));
  let {
    context_value: p
  } = t, {
    value: u = []

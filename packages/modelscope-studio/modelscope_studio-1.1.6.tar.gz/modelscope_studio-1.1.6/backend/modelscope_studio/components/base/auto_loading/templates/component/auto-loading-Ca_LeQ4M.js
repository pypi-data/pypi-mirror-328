import { i as _e, a as U, r as pe, w as j, g as he } from "./Index-BZt6TXK2.js";
...
function Le(e, t, r) {
  var l, s, n, o, i, f, g = 0, x = !1, a = !1, h = !0;
  if (typeof e != "function")
    throw new TypeError(Se);
  t = X(t) || 0, U(r) && (x = !!r.leading, a = "maxWait" in r, n = a ? Oe(X(r.maxWait) || 0, t) : n, h = "trailing" in r ? !!r.trailing : h);
  function m(c) {
    var E = l, T = s;
    return l = s = void 0, g = c, o = e.apply(T, E), o;
  }
  function C(c) {
    return g = c, i = setTimeout(_, t), x ? m(c) : o;
  }
  function b(c) {
    var E = c - f, T = c - g, O = t - E;
    return a ? je(O, n - T) : O;
  }
  function d(c) {
    var E = c - f, T = c - g;
  ...
  function w(c) {
    return i = void 0, h && l ? m(c) : (l = s = void 0, o);
  }
  function v() {
    i !== void 0 && clearTimeout(i), g = 0, l = f = s = i = void 0;
  }
  function u() {
...
function rt(e, t, r) {
  ...
  const a = j();
  Q(e, a, (u) => r(1, s = u));
  const h = [], m = $e("$$ms-gr-react-wrapper"), {
    slotKey: C,
    slotIndex: b,
    subSlotIndex: d
  } = he() || {}, _ = f({
      ...
      props: {
        svelteInit(o) {
          ...
          return f.nodes = [...f.nodes, i], re({
            ...
            f.nodes = f.nodes.filter((g) => g.svelteInstance !== s), re({
              createPortal: B,
              node: z
            });
          }), i;
...
const oe = fe(({
  ...
  }, [e, x, r, l, n, s]), I.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
...
function ft(e) {
  const [t, r] = P((e == null ? void 0 : e.eta) ?? null), {
    ...
    message: o,
    queue_size: i
  } = e || {}, [f, g] = P(0), [x, a] = P(0), [h, m] = P(null), [C, b] = P(null), [d, _] = P(null), w = K(!1), v = q(() => {
    requestAnimationFrame(() => {
      a((performance.now() - f) / 1e3), w.current && v();
    });
  }), u = q(() => {
    r(null), m(null), b(null), g(performance.now()), a(0), w.current = !0, v();
  }), y = q(() => {
  ...
  return R(() => {
    ...
    let c = t;
    c === null && (c = h, r(c)), c !== null && h !== c && (b(((performance.now() - f) / 1e3 + c).toFixed(1)), m(c));
  }, [t, h, f]), R(() => {
    _(x.toFixed(1));
  }, [x]), R(() => () => {
    w.current && y();
        ...
        case "antd":
          a = /* @__PURE__ */ p.jsx(be, {
            ...
            tip: c ? e.loadingText ? (O = W({
              ...
              }, k.index)) : d !== null && _ !== void 0 && typeof d == "number" && d >= 0 ? `queue: ${d + 1}/${_} |` : d === 0 ? "processing |" : null, " ", g && /* @__PURE__ */ p.jsxs(p.Fragment, {
                children: [u, w ? `/${v}` : "", "s"]
              })]
            }) : null,

import { i as me, a as D, r as he, w as O, g as _e, b as ge } from "./Index-CbYg9MI7.js";
...
function Oe(e, t, l) {
  var s, o, n, r, c, a, p = 0, x = !1, i = !1, w = !0;
  if (typeof e != "function")
    throw new TypeError(Te);
  t = G(t) || 0, D(l) && (x = !!l.leading, i = "maxWait" in l, n = i ? Pe(G(l.maxWait) || 0, t) : n, w = "trailing" in l ? !!l.trailing : w);
  function f(h) {
    var y = s, S = o;
    return s = o = void 0, p = h, r = e.apply(S, y), r;
  }
  function _(h) {
    return p = h, c = setTimeout(m, t), x ? f(h) : r;
  }
  function C(h) {
    var y = h - a, S = h - p, H = t - y;
    return i ? ke(H, n - S) : H;
  }
  function u(h) {
    var y = h - a, S = h - p;
  ...
  function b(h) {
    return c = void 0, w && s ? f(h) : (s = o = void 0, r);
  }
  function E() {
    c !== void 0 && clearTimeout(c), p = 0, s = a = o = c = void 0;
  }
  function d() {
...
const R = ae(({
  ...
  return fe(() => {
    ...
    if (x && window.MutationObserver) {
      ...
      i.style.display = "contents", w(), (C = r.current) == null || C.appendChild(i);
    return () => {
      var u, m;
      i.style.display = "", (u = r.current) != null && u.contains(i) && ((m = r.current) == null || m.removeChild(i)), f == null || f.disconnect();
    };
  }, [e, x, l, s, n, o]), I.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  if (s.length !== 0)
    return s.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((x) => {
        ...
        w instanceof Element ? f = w : (f = w.el, _ = w.callback, C = w.clone ?? C, u = w.forceClone ?? u), u = u ?? !!_, c[i[i.length - 1]] = f ? _ ? (...m) => (_(i[i.length - 1], m), /* @__PURE__ */ g.jsx(M, {
          ...o.ctx,
          params: m,
          forceClone: u,

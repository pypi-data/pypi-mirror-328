import { i as ae, a as A, r as ue, w as O, g as de } from "./Index-CtrZ8fBk.js";
...
function Se(e, t, s) {
  var l, o, n, r, i, a, g = 0, _ = !1, c = !1, h = !0;
  if (typeof e != "function")
    throw new TypeError(ye);
  t = U(t) || 0, A(s) && (_ = !!s.leading, c = "maxWait" in s, n = c ? ve(U(s.maxWait) || 0, t) : n, h = "trailing" in s ? !!s.trailing : h);
  function f(p) {
    var C = l, k = o;
    return l = o = void 0, g = p, r = e.apply(k, C), r;
  }
  function b(p) {
    return g = p, i = setTimeout(m, t), _ ? f(p) : r;
  }
  function x(p) {
    var C = p - a, k = p - g, F = t - C;
    return c ? Ie(F, n - k) : F;
  }
  function u(p) {
    var C = p - a, k = p - g;
  ...
  function S() {
    i !== void 0 && clearTimeout(i), g = 0, l = a = o = i = void 0;
  }
  function d() {
      ...
      props: {
        svelteInit(r) {
          ...
          return a.nodes = [...a.nodes, i], Y({
            ...
            a.nodes = a.nodes.filter((g) => g.svelteInstance !== o), Y({
              createPortal: N,
              node: L
            });
          }), i;
...
const K = oe(({
  ...
  }, [e, _, s, l, n, o]), y.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  if (l.length !== 0)
    return l.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((_) => {
        ...
        h instanceof Element ? f = h : (f = h.el, b = h.callback, x = h.clone ?? x, u = h.forceClone ?? u), u = u ?? !!b, i[c[c.length - 1]] = f ? b ? (...m) => (b(c[c.length - 1], m), /* @__PURE__ */ E.jsx(D, {
          ...o.ctx,
          params: m,
          forceClone: u,

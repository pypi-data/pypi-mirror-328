...
var _t = typeof global == "object" && global && global.Object === Object && global, nn = typeof self == "object" && self && self.Object === Object && self, E = _t || nn || Function("return this")(), P = E.Symbol, bt = Object.prototype, rn = bt.hasOwnProperty, on = bt.toString, z = P ? P.toStringTag : void 0;
function an(e) {
...
var ye = K(E, "DataView"), me = K(E, "Promise"), ve = K(E, "Set"), ke = "[object Map]", Ki = "[object Object]", et = "[object Promise]", tt = "[object Set]", nt = "[object WeakMap]", rt = "[object DataView]", Ui = N(ye), Gi = N(X), Bi = N(me), zi = N(ve), Hi = N(be), $ = D;
(ye && $(new ye(new ArrayBuffer(1))) != rt || X && $(new X()) != ke || me && $(me.resolve()) != et || ve && $(new ve()) != tt || be && $(new be()) != nt) && ($ = function(e) {
...
function Gt(e, t, n, r, o, i) {
  ...
  if (l && d)
    return l == t && d == e;
  var b = -1, c = !0, f = n & ta ? new oe() : void 0;
...
var ia = 1, oa = 2, aa = "[object Boolean]", sa = "[object Date]", ua = "[object Error]", la = "[object Map]", ca = "[object Number]", fa = "[object RegExp]", pa = "[object Set]", ga = "[object String]", da = "[object Symbol]", _a = "[object ArrayBuffer]", ba = "[object DataView]", ut = P ? P.prototype : void 0, _e = ut ? ut.valueOf : void 0;
...
function Js(e, t, n) {
  ...
  const f = Va(() => import("./tabs.item-DAqMn0E2.js"));
  let {
    gradio: _
  } = t, {
    props: h = {}
  ...
  }, [s, u, r, d, f, p, pe, Le, De, Ne, _, h, v, T, O, x, A, V, a, l, b, en, c];
}
class Zs extends ys {
  constructor(t) {

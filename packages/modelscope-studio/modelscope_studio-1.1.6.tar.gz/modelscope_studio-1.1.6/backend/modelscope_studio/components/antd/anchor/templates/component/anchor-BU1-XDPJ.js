import { i as ue, a as F, r as de, w as k, g as fe, b as me } from "./Index-KvMheaep.js";
...
function ke(t, e, o) {
  var l, s, n, r, i, a, g = 0, _ = !1, c = !1, p = !0;
  if (typeof t != "function")
    throw new TypeError(Ie);
  e = B(e) || 0, F(o) && (_ = !!o.leading, c = "maxWait" in o, n = c ? Se(B(o.maxWait) || 0, e) : n, p = "trailing" in o ? !!o.trailing : p);
  function f(h) {
    var y = l, R = s;
    return l = s = void 0, g = h, r = t.apply(R, y), r;
  }
  function b(h) {
    return g = h, i = setTimeout(m, e), _ ? f(h) : r;
  }
  function w(h) {
    var y = h - a, R = h - g, M = e - y;
    return c ? Re(M, n - R) : M;
  }
  function u(h) {
    var y = h - a, R = h - g;
  ...
  function x(h) {
    return i = void 0, p && l ? f(h) : (l = s = void 0, r);
  }
  function S() {
...
const Q = le(({
  ...
  }, [t, _, o, l, n, s]), v.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  if (l.length !== 0)
    return l.map((s, n) => {
      ...
      Object.keys(s.slots).forEach((_) => {
        ...
        p instanceof Element ? f = p : (f = p.el, b = p.callback, w = p.clone ?? w, u = p.forceClone ?? u), u = u ?? !!b, i[c[c.length - 1]] = f ? b ? (...m) => (b(c[c.length - 1], m), /* @__PURE__ */ C.jsx(D, {
          ...s.ctx,
          params: m,
          forceClone: u,

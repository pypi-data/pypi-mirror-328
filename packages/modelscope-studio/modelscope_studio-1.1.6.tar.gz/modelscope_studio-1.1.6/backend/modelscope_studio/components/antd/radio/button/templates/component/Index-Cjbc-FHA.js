...
var Pt = typeof exports == "object" && exports && !exports.nodeType && exports, H = Pt && typeof module == "object" && module && !module.nodeType && module, Or = H && H.exports === Pt, fe = Or && pt.process, B = function() {
  try {
...
var be = K(C, "DataView"), he = K(C, "Promise"), ye = K(C, "Set"), Ye = "[object Map]", Di = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Ni = N(be), Ki = N(J), Ui = N(he), Gi = N(ye), Bi = N(de), A = D;
...
function Ds(e, t, n) {
  ...
  const g = Wa(() => import("./radio.button-DyBeKHak.js"));
  let {
    gradio: b
  } = t, {
    props: f = {}

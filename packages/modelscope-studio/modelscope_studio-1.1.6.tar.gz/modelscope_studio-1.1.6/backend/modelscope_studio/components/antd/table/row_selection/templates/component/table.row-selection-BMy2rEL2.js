import { i as ae, a as H, r as ue, w as R, g as de } from "./Index-DzqYFqYr.js";
...
function ve(e, t, s) {
  ...
  t = B(t) || 0, H(s) && (_ = !!s.leading, c = "maxWait" in s, n = c ? Ce(B(s.maxWait) || 0, t) : n, h = "trailing" in s ? !!s.trailing : h);
  function f(p) {
    var I = l, P = o;
    return l = o = void 0, g = p, r = e.apply(P, I), r;
  }
  function b(p) {
    return g = p, i = setTimeout(m, t), _ ? f(p) : r;
  }
  function w(p) {
    var I = p - u, P = p - g, F = t - I;
    return c ? Ee(F, n - P) : F;
  }
  function a(p) {
    var I = p - u, P = p - g;
...
function Xe(e, t, s) {
  ...
  const c = R();
  q(e, c, (d) => s(1, o = d));
  const h = [], f = Ge("$$ms-gr-react-wrapper"), {
    slotKey: b,
    slotIndex: w,
    subSlotIndex: a
  } = de() || {}, m = u({
...
const Q = se(({
  ...
  }, [e, _, s, l, n, o]), C.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  if (l.length !== 0)
    return l.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((_) => {
        ...
        h instanceof Element ? f = h : (f = h.el, b = h.callback, w = h.clone ?? w, a = h.forceClone ?? a), a = a ?? !!b, i[c[c.length - 1]] = f ? b ? (...m) => (b(c[c.length - 1], m), /* @__PURE__ */ E.jsx(M, {
          ...o.ctx,
          params: m,
          forceClone: a,

import { i as ae, a as A, r as ue, w as R, g as de } from "./Index-BgLNP1Fv.js";
...
function Se(e, t, s) {
  ...
  t = B(t) || 0, A(s) && (_ = !!s.leading, c = "maxWait" in s, n = c ? Ce(B(s.maxWait) || 0, t) : n, h = "trailing" in s ? !!s.trailing : h);
  function f(p) {
    var y = l, O = o;
    return l = o = void 0, g = p, r = e.apply(O, y), r;
  }
  function b(p) {
    return g = p, i = setTimeout(m, t), _ ? f(p) : r;
  }
  function w(p) {
    var y = p - u, O = p - g, F = t - y;
    return c ? Ie(F, n - O) : F;
  }
  function a(p) {
    var y = p - u, O = p - g;

import { i as se, a as W, r as le, w as O, g as ce } from "./Index-CmKcL0FE.js";
...
function xe(e, t, i) {
  ...
  t = U(t) || 0, W(i) && (c = !!i.leading, a = "maxWait" in i, n = a ? ye(U(i.maxWait) || 0, t) : n, p = "trailing" in i ? !!i.trailing : p);
  function m(f) {
    var w = s, R = o;
    return s = o = void 0, h = f, r = e.apply(R, w), r;
  }
  function E(f) {
...
const I = re(({
  ...
  }, [e, c, i, s, n, o]), x.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }

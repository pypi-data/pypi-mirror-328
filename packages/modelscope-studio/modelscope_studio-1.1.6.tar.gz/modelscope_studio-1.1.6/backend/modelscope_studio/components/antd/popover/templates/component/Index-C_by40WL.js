...
var pt = typeof global == "object" && global && global.Object === Object && global, kt = typeof self == "object" && self && self.Object === Object && self, C = pt || kt || Function("return this")(), w = C.Symbol, gt = Object.prototype, en = gt.hasOwnProperty, tn = gt.toString, z = w ? w.toStringTag : void 0;
function nn(e) {
...
}(), Be = B && B.isTypedArray, $t = Be ? $e(Be) : vr, Or = Object.prototype, Pr = Or.hasOwnProperty;
function At(e, t) {
...
var he = K(C, "DataView"), be = K(C, "Promise"), ye = K(C, "Set"), Ye = "[object Map]", Li = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Di = N(he), Ni = N(J), Ki = N(be), Ui = N(ye), Gi = N(de), $ = D;
...
var ta = 1, na = 2, ra = "[object Boolean]", ia = "[object Date]", oa = "[object Error]", aa = "[object Map]", sa = "[object Number]", ua = "[object RegExp]", la = "[object Set]", ca = "[object String]", fa = "[object Symbol]", pa = "[object ArrayBuffer]", ga = "[object DataView]", rt = w ? w.prototype : void 0, fe = rt ? rt.valueOf : void 0;
...
function Ls(e, t, n) {
  ...
  const g = Za(() => import("./popover-Chi_6kZ5.js"));
  let {
    gradio: _
  } = t, {
    props: c = {}

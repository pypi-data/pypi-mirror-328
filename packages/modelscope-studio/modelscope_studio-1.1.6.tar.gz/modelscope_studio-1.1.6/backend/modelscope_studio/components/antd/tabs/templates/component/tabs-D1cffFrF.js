import { i as fe, a as W, r as me, w as j, g as _e, b as he } from "./Index-WO2U2wit.js";
...
function H(e) {
  ...
  e = we(e);
  var o = ye.test(e);
  return o || Ie.test(e) ? Se(e.slice(2), o ? 2 : 8) : ve.test(e) ? U : +e;
}
var B = function() {
  return me.Date.now();
...
const w = ae(({
  ...
  }, [e, b, o, l, r, n]), v.createElement("react-child", {
    ref: s,
    style: {
      display: "contents"
    }
...
function dt({
  ...
  return t[e] ? (...n) => o ? o.map((r, s) => /* @__PURE__ */ h.jsx(v.Fragment, {
    children: Z(r, {
      clone: !0,
      params: n,
      forceClone: !0
  ...
  return /* @__PURE__ */ h.jsxs(h.Fragment, {
    children: [/* @__PURE__ */ h.jsx("div", {
      ...
      more: ct({
        ...
        icon: e["more.icon"] ? /* @__PURE__ */ h.jsx(w, {
          slot: e["more.icon"]
        }) : n == null ? void 0 : n.icon
      }),
      tabBarExtraContent: e.tabBarExtraContent ? /* @__PURE__ */ h.jsx(w, {
        slot: e.tabBarExtraContent
      }) : e["tabBarExtraContent.left"] || e["tabBarExtraContent.right"] ? {
        left: e["tabBarExtraContent.left"] ? /* @__PURE__ */ h.jsx(w, {
          slot: e["tabBarExtraContent.left"]
        }) : void 0,
        right: e["tabBarExtraContent.right"] ? /* @__PURE__ */ h.jsx(w, {
          slot: e["tabBarExtraContent.right"]
        }) : void 0
      } : c.tabBarExtraContent,
      addIcon: e.addIcon ? /* @__PURE__ */ h.jsx(w, {
        slot: e.addIcon
      }) : c.addIcon,
      removeIcon: e.removeIcon ? /* @__PURE__ */ h.jsx(w, {
        slot: e.removeIcon
      }) : c.removeIcon,
      onChange: (x) => {
        l == null || l(x);

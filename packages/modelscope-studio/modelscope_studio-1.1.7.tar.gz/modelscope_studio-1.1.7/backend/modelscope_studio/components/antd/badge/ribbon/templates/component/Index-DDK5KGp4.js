...
var be = K(C, "DataView"), he = K(C, "Promise"), ye = K(C, "Set"), Ye = "[object Map]", Li = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Di = N(be), Ni = N(J), Ki = N(he), Ui = N(ye), Gi = N(de), $ = D;
...
function Ls(e, t, n) {
  ...
  const g = Za(() => import("./badge.ribbon-Zi9ZaRkC.js"));
  let {
    gradio: _
  } = t, {
    props: f = {}

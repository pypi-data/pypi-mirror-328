...
var be = K(x, "DataView"), he = K(x, "Promise"), me = K(x, "Set"), Ye = "[object Map]", Ri = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Li = N(be), Di = N(J), Ni = N(he), Ki = N(me), Ui = N(de), $ = D;
...
function Rs(e, t, n) {
  ...
  const g = Ya(() => import("./form.item-Dt3G6DyG.js"));
  let {
    gradio: _
  } = t, {
    props: f = {}

import { i as he, a as A, r as _e, w as j, g as ge, b as we } from "./Index-DEzUOP4m.js";
...
function je(t, e, l) {
  var s, o, n, r, i, d, b = 0, _ = !1, c = !1, g = !0;
  if (typeof t != "function")
    throw new TypeError(Te);
  e = q(e) || 0, A(l) && (_ = !!l.leading, c = "maxWait" in l, n = c ? Pe(q(l.maxWait) || 0, e) : n, g = "trailing" in l ? !!l.trailing : g);
  function a(h) {
    var y = s, C = o;
    return s = o = void 0, b = h, r = t.apply(C, y), r;
  }
  function p(h) {
    return b = h, i = setTimeout(m, e), _ ? a(h) : r;
  }
  function x(h) {
    var y = h - d, C = h - b, H = e - y;
    return c ? Oe(H, n - C) : H;
  }
  function u(h) {
    var y = h - d, C = h - b;
  ...
  function v(h) {
    return i = void 0, g && s ? a(h) : (s = o = void 0, r);
  }
  function R() {
    i !== void 0 && clearTimeout(i), b = 0, s = d = o = i = void 0;
  }
  function f() {
  ...
  if (s.length !== 0)
    return s.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((_) => {
        ...
        g instanceof Element ? a = g : (a = g.el, p = g.callback, x = g.clone ?? x, u = g.forceClone ?? u), u = u ?? !!p, i[c[c.length - 1]] = a ? p ? (...m) => (p(c[c.length - 1], m), /* @__PURE__ */ w.jsx(M, {
          ...o.ctx,
          params: m,
          forceClone: u,
...
function ee(t, e) {
  return t ? e != null && e.forceClone || e != null && e.params ? ce((l) => /* @__PURE__ */ w.jsx(M, {
...
const {
  ...
  const p = P(e), x = P(s), u = P(g), m = P(typeof s == "object" ? s.nodeDraggable : void 0), v = P(o), R = b ? z.DirectoryTree : z, {
    items: f
    ...
    switcherLoadingIcon: t.switcherLoadingIcon ? /* @__PURE__ */ w.jsx(T, {
    ...
    draggable: t["draggable.icon"] || m ? {
      icon: t["draggable.icon"] ? /* @__PURE__ */ w.jsx(T, {

import { i as ie, a as W, r as le, w as R, g as ae } from "./Index-BhJAUpNv.js";
...
function Ee(e, t, o) {
  ...
  t = z(t) || 0, W(o) && (h = !!o.leading, a = "maxWait" in o, n = a ? we(z(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var y = i, T = s;
  ...
  return se(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        a = S, d(b), a.style.display = "contents", w && clearTimeout(w), w = setTimeout(() => {
          g();

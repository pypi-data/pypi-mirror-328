import { i as fe, a as M, r as me, w as k, g as pe, d as _e, b as O, c as ge } from "./Index-DXlbyQ6y.js";
...
const S = ue(({
  ...
  return re(() => {
    ...
    if (g && window.MutationObserver) {
      ...
      c.style.display = "contents", x(), (v = r.current) == null || v.appendChild(c);
    return () => {
      var m, a;
      c.style.display = "", (m = r.current) != null && m.contains(c) && ((a = r.current) == null || a.removeChild(c)), p == null || p.disconnect();
    };
  }, [e, g, o, l, n, s]), w.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
...
const gt = rt(({
  ...
  const c = $(t, "titles"), x = $(t, "selectAllLabels"), p = P(o), y = P(n), v = P(s), m = P(l);

import { i as fe, a as W, r as me, w as T, g as _e, b as he } from "./Index-DlH49ZdE.js";
...
function Oe(t, e, o) {
  var l, r, n, s, i, a, g = 0, p = !1, c = !1, h = !0;
  if (typeof t != "function")
    throw new TypeError(Re);
  e = H(e) || 0, W(o) && (p = !!o.leading, c = "maxWait" in o, n = c ? Pe(H(o.maxWait) || 0, e) : n, h = "trailing" in o ? !!o.trailing : h);
  function u(_) {
    var E = l, R = r;
    return l = r = void 0, g = _, s = t.apply(R, E), s;
  }
  function x(_) {
    return g = _, i = setTimeout(m, e), p ? u(_) : s;
  }
  function b(_) {
  ...
  function S() {
    i !== void 0 && clearTimeout(i), g = 0, l = a = r = i = void 0;
  }
  function f() {
      ...
      props: {
        svelteInit(s) {
          ...
          return a.nodes = [...a.nodes, i], K({
            ...
            a.nodes = a.nodes.filter((g) => g.svelteInstance !== r), K({
              createPortal: N,
              node: F
            });
          }), i;
...
const P = ce(({
  ...
  }, [t, p, o, l, n, r]), y.createElement("react-child", {
    ref: s,
    style: {
      display: "contents"
    }

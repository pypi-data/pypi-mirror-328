import { i as fe, a as B, r as pe, w as j, g as me, d as _e, b as R, c as ge } from "./Index-Bf3ErKP4.js";
...
function V(e) {
  ...
  e = we(e);
  var n = ve.test(e);
  return n || Ie.test(e) ? Se(e.slice(2), n ? 2 : 8) : Ee.test(e) ? K : +e;
}
var W = function() {
  return pe.Date.now();
...
const gt = nt(({
  ...
  var d;
  const h = M(l, "copyable.tooltips"), a = M(l, "copyable.icon"), y = n["copyable.icon"] || h.length > 0 || s, p = n["editable.icon"] || n["editable.tooltip"] || n["editable.enterIcon"] || r, w = n["ellipsis.symbol"] || n["ellipsis.tooltip"] || n["ellipsis.tooltip.title"] || o, E = D(s), f = D(r), m = D(o), x = A(() => {
    switch (e) {
      case "title":
        return O.Title;
      case "paragraph":

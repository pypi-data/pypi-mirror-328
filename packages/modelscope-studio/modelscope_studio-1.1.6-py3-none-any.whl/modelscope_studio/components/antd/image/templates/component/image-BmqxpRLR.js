import { i as ue, a as A, r as de, w as P, g as fe, b as me } from "./Index-WmesVUv7.js";
...
function ke(e, t, r) {
  var s, i, n, o, l, u, _ = 0, g = !1, c = !1, w = !0;
  if (typeof e != "function")
    throw new TypeError(Ie);
  t = B(t) || 0, A(r) && (g = !!r.leading, c = "maxWait" in r, n = c ? Re(B(r.maxWait) || 0, t) : n, w = "trailing" in r ? !!r.trailing : w);
  function m(d) {
    var y = s, S = i;
    return s = i = void 0, _ = d, o = e.apply(S, y), o;
  }
  function C(d) {
    return _ = d, l = setTimeout(h, t), g ? m(d) : o;
  }
  function x(d) {
    var y = d - u, S = d - _, U = t - y;
    return c ? Se(U, n - S) : U;
  }
  function f(d) {
    var y = d - u, S = d - _;
...
const k = ie(({
  ...
  }, [e, g, r, s, n, i]), b.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
...
function Q(e, t) {
  return e ? t != null && t.forceClone || t != null && t.params ? at((r) => /* @__PURE__ */ p.jsx(_e, {
...
function Z({
  ...
  return t[e] ? (...i) => r ? r.map((n, o) => /* @__PURE__ */ p.jsx(b.Fragment, {
    children: Q(n, {
      clone: !0,
      params: i,
      forceClone: !0
...
const mt = et(({
  ...
  const n = ut(t), o = e["preview.mask"] || e["preview.closeIcon"] || e["preview.toolbarRender"] || e["preview.imageRender"] || t !== !1, l = N(n.getContainer), u = N(n.toolbarRender), _ = N(n.imageRender);
    ...
    children: [/* @__PURE__ */ p.jsx("div", {
      ...
      preview: o ? lt({
        ...
        ...e["preview.mask"] || Reflect.has(n, "mask") ? {
          mask: e["preview.mask"] ? /* @__PURE__ */ p.jsx(k, {
            slot: e["preview.mask"]
          }) : n.mask
        } : {},
        closeIcon: e["preview.closeIcon"] ? /* @__PURE__ */ p.jsx(k, {
          slot: e["preview.closeIcon"]
        }) : n.closeIcon
      }) : !1,
      placeholder: e.placeholder ? /* @__PURE__ */ p.jsx(k, {
        slot: e.placeholder
      }) : i.placeholder
    })]
  });

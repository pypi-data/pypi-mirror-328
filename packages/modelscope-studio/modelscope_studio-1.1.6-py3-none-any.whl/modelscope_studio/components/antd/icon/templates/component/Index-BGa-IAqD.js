...
function Cs(e, t, n) {
  ...
  let o = lt(t, r), i, a, s;
  const u = Xa(() => import("./icon-CkXvNk-n.js"));
  let {
    gradio: l
  } = t, {
    props: g = {}
  ...
  return pe(e, C, (h) => n(1, s = h)), e.$$set = (h) => {
    t = me(me({}, t), bs(h)), n(17, o = lt(t, r)), "gradio" in h && n(6, l = h.gradio), "props" in h && n(7, g = h.props), "_internal" in h && n(8, c = h._internal), "value" in h && n(9, f = h.value), "as_item" in h && n(10, d = h.as_item), "visible" in h && n(11, b = h.visible), "elem_id" in h && n(12, p = h.elem_id), "elem_classes" in h && n(13, v = h.elem_classes), "elem_style" in h && n(14, T = h.elem_style);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && _.update((h) => ({
      ...h,

import { i as de, a as W, r as fe, w as P, g as me } from "./Index-C9cZDZoO.js";
...
function ke(t, e, s) {
  var o, l, r, n, c, i, p = 0, g = !1, a = !1, b = !0;
  if (typeof t != "function")
    throw new TypeError(Ie);
  e = H(e) || 0, W(s) && (g = !!s.leading, a = "maxWait" in s, r = a ? Se(H(s.maxWait) || 0, e) : r, b = "trailing" in s ? !!s.trailing : b);
  function f(_) {
    var v = o, R = l;
    return o = l = void 0, p = _, n = t.apply(R, v), n;
  }
  function x(_) {
    return p = _, c = setTimeout(m, e), g ? f(_) : n;
  }
  function C(_) {
    var v = _ - i, R = _ - p, D = e - v;
    return a ? Re(D, r - R) : D;
  }
  function u(_) {
    var v = _ - i, R = _ - p;
  ...
  function w(_) {
    return c = void 0, b && o ? f(_) : (o = l = void 0, n);
  }
  function S() {
    c !== void 0 && clearTimeout(c), p = 0, o = i = l = c = void 0;
  }
  function d() {
      ...
      props: {
        svelteInit(n) {
          ...
          return i.nodes = [...i.nodes, c], K({
            ...
            i.nodes = i.nodes.filter((p) => p.svelteInstance !== l), K({
              createPortal: A,
              node: N
            });
          }), c;
...
const k = oe(({
  ...
  return ie(() => {
    ...
    if (g && window.MutationObserver) {
      ...
      a.style.display = "contents", b(), (C = n.current) == null || C.appendChild(a);
    return () => {
      var u, m;
      a.style.display = "", (u = n.current) != null && u.contains(a) && ((m = n.current) == null || m.removeChild(a)), f == null || f.disconnect();
    };
  }, [t, g, s, o, r, l]), E.createElement("react-child", {
    ref: n,
    style: {
      display: "contents"
    }
  ...
  if (o.length !== 0)
    return o.map((l, r) => {
      ...
      Object.keys(l.slots).forEach((g) => {
        ...
        b instanceof Element ? f = b : (f = b.el, x = b.callback, C = b.clone ?? C, u = b.forceClone ?? u), u = u ?? !!x, c[a[a.length - 1]] = f ? x ? (...m) => (x(a[a.length - 1], m), /* @__PURE__ */ h.jsx(F, {
          ...l.ctx,
          params: m,
          forceClone: u,

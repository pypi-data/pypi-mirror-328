import { i as pe, a as H, r as _e, w as P, g as he, d as ge, b as k, c as xe } from "./Index-PcObenx2.js";
...
var G = NaN, ve = /^[-+]0x[0-9a-f]+$/i, Re = /^0b[01]+$/i, ke = /^0o[0-7]+$/i, Pe = parseInt;
function z(t) {
  if (typeof t == "number")
    return t;
  if (pe(t))
  ...
  t = Se(t);
  var o = Re.test(t);
  return o || ke.test(t) ? Pe(t.slice(2), o ? 2 : 8) : ve.test(t) ? G : +t;
}
var A = function() {
  return _e.Date.now();
  ...
  return {
    ...
    l(r) {
      e = ie(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), le(e).forEach(v), o = Ue(r), n && n.l(r), l = X(), this.h();
    },
    h() {
      ae(e, "class", "svelte-1rt0kpf");
    },
...
const j = fe(({
  ...
  }, [t, h, o, l, n, s]), E.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }

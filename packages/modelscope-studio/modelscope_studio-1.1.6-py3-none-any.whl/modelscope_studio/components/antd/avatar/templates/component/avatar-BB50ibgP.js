import { i as ie, a as j, r as le, w as R, g as ce } from "./Index-BEAc0smn.js";
...
var L = function() {
  return le.Date.now();
}, ye = "Expected a function", we = Math.max, ve = Math.min;
function Ee(e, t, o) {
  var i, s, n, r, l, d, p = 0, h = !1, c = !1, g = !0;
  if (typeof e != "function")
    throw new TypeError(ye);
  t = U(t) || 0, j(o) && (h = !!o.leading, c = "maxWait" in o, n = c ? we(U(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var y = i, T = s;
  ...
  return se(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        c = S, d(b), c.style.display = "contents", w && clearTimeout(w), w = setTimeout(() => {
          g();

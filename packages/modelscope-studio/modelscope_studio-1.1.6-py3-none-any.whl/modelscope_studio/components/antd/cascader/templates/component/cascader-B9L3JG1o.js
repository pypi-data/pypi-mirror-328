import { i as Ce, a as B, r as be, b as ye, w as F, g as Ie, c as ve } from "./Index-DqeP9vvp.js";
...
function De(e, t, o) {
  var c, l, n, r, s, a, w = 0, x = !1, i = !1, p = !0;
  if (typeof e != "function")
    throw new TypeError(We);
  t = Y(t) || 0, B(o) && (x = !!o.leading, i = "maxWait" in o, n = i ? Ae(Y(o.maxWait) || 0, t) : n, p = "trailing" in o ? !!o.trailing : p);
  function m(h) {
    var C = c, P = l;
    return c = l = void 0, w = h, r = e.apply(P, C), r;
  }
  function b(h) {
    return w = h, s = setTimeout(f, t), x ? m(h) : r;
  }
  function g(h) {
    var C = h - a, P = h - w, T = t - C;
    return i ? Me(T, n - P) : T;
  }
  function u(h) {
    var C = h - a, P = h - w;
...
const I = we(({
  ...
  }, [e, x, o, c, n, l]), E.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
...
const St = ft(yt(["default", "options"], ({
  ...
  const u = v(r), f = v(l), y = v(s), S = v(x), d = v(w), R = v(a), h = typeof i == "object" || e["showSearch.render"], C = It(i), P = v(C.filter), T = v(C.render), _e = v(C.sort), [ge, pe] = wt({
    onValueChange: o,
    value: g.value
  }), {
    items: W

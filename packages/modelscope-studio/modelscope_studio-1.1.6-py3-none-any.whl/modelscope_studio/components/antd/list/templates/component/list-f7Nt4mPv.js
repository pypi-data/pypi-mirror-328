import { i as ce, a as W, r as ae, w as T, g as ue, b as de } from "./Index-CIOC2_5v.js";
...
function Xe(e) {
  ...
  return {
    ...
    p(r, [i]) {
      ...
      16 && k(n, 1)) : (n = V(r), n.c(), k(n, 1), n.m(l.parentNode, l)) : n && (Ue(), M(n, 1, 1, () => {
        n = null;
      }), Fe());
    },
    i(r) {
...
const P = re(({
  ...
  }, [e, p, o, l, n, s]), C.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }

import { i as ie, a as W, r as le, w as R, g as ae } from "./Index-DqsDSji6.js";
...
function ve(e, t, o) {
  ...
  t = z(t) || 0, W(o) && (h = !!o.leading, a = "maxWait" in o, n = a ? ye(z(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var w = i, T = s;
...
const N = ne(({
  ...
  return se(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        a = S, d(b), a.style.display = "contents", E && clearTimeout(E), E = setTimeout(() => {
          g();
  ...
  }, [e, h, o, i, n, s]), v.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
  ...
  children: [/* @__PURE__ */ y.jsx(y.Fragment, {
    children: t
  }), /* @__PURE__ */ y.jsx(ue.Item.Meta, {
    ...o,
    avatar: e.avatar ? /* @__PURE__ */ y.jsx(N, {
      slot: e.avatar
    }) : o.avatar,
    description: e.description ? /* @__PURE__ */ y.jsx(N, {
      slot: e.description
    }) : o.description,
    title: e.title ? /* @__PURE__ */ y.jsx(N, {
      slot: e.title
    }) : o.title
  })]
}));

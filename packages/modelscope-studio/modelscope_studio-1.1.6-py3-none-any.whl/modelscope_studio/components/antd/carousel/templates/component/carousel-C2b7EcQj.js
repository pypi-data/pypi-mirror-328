import { i as ae, a as W, r as ce, w as O, g as ue, d as de, b as T, c as fe } from "./Index-DqAxPNza.js";
...
var B = NaN, we = /^[-+]0x[0-9a-f]+$/i, ye = /^0b[01]+$/i, xe = /^0o[0-7]+$/i, ve = parseInt;
function z(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = be(e);
  var o = ye.test(e);
  return o || xe.test(e) ? ve(e.slice(2), o ? 2 : 8) : we.test(e) ? B : +e;
}
var A = function() {
  return ce.Date.now();
...
function Se(e, t, o) {
  ...
  t = z(t) || 0, W(o) && (g = !!o.leading, a = "maxWait" in o, n = a ? Ee(z(o.maxWait) || 0, t) : n, h = "trailing" in o ? !!o.trailing : h);
  function p(d) {
    var w = i, S = s;
  ...
  function v(d) {
    var w = d - c, S = d - _, U = t - w;
    return a ? Ie(U, n - S) : U;
  }
  function f(d) {
    var w = d - c, S = d - _;
    return c === void 0 || w >= t || w < 0 || a && S >= n;
  }
  function m() {
    var d = A();
    if (f(d))
  ...
  return $(() => {
    ...
    if (g && window.MutationObserver) {
      let f = function() {
        ...
        a = I, c(b), a.style.display = "contents", x && clearTimeout(x), x = setTimeout(() => {
          h();

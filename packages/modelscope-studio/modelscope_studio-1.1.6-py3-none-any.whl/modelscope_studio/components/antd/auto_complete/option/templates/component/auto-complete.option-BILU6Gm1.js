import { w as p, g as G } from "./Index-CHE33zcx.js";
  ...
  return {
    ...
    l(o) {
      e = D(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(e).forEach(u), l = te(o), t && t.l(o), s = S(), this.h();
    },
    h() {
      A(e, "class", "svelte-1rt0kpf");
    },
    ...
    d(o) {
      o && (u(e), u(l), u(s)), r[8](null), t && t.d(o);
    }
  };
}
function R(r) {
...
const {
  ...
  ItemHandler: ve
} = H("antd-auto-complete-options"), xe = he((r) => /* @__PURE__ */ Z.jsx(ve, {
  ...r,

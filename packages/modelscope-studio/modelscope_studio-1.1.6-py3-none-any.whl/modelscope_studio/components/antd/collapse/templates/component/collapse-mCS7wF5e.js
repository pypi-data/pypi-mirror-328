import { i as de, a as W, r as fe, w as k, g as me, b as _e } from "./Index-rHpF-i85.js";
...
function Pe(t, e, s) {
  var o, l, n, r, c, a, p = 0, h = !1, i = !1, g = !0;
  if (typeof t != "function")
    throw new TypeError(Se);
  e = H(e) || 0, W(s) && (h = !!s.leading, i = "maxWait" in s, n = i ? Re(H(s.maxWait) || 0, e) : n, g = "trailing" in s ? !!s.trailing : g);
  function f(_) {
    var y = o, R = l;
    return o = l = void 0, p = _, r = t.apply(R, y), r;
  }
  function b(_) {
    return p = _, c = setTimeout(m, e), h ? f(_) : r;
  }
  function w(_) {
    var y = _ - a, R = _ - p, U = e - y;
    return i ? ke(U, n - R) : U;
  }
  function u(_) {
    var y = _ - a, R = _ - p;
  ...
  function S() {
    c !== void 0 && clearTimeout(c), p = 0, o = a = l = c = void 0;
  }
  function d() {
      ...
      props: {
        svelteInit(r) {
          ...
          return a.nodes = [...a.nodes, c], K({
            ...
            a.nodes = a.nodes.filter((p) => p.svelteInstance !== l), K({
              createPortal: N,
              node: F
            });
          }), c;
...
const T = ce(({
  ...
  }, [t, h, s, o, n, l]), v.createElement("react-child", {
    ref: r,
    style: {
      display: "contents"
    }
...
function oe(t, e, s) {
  ...
  if (o.length !== 0)
    return o.map((l, n) => {
      ...
      const r = {
        ...l.props,
        key: ((p = l.props) == null ? void 0 : p.key) ?? (s ? `${s}-${n}` : `${n}`)
      };
      let c = r;
...
const {
  ...
  const {
    items: c
  } = ft(), a = c.items.length > 0 ? c.items : c.default, p = lt(n);

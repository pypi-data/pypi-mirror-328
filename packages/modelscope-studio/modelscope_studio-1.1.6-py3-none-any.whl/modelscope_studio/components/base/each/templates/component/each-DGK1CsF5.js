import { s as F, j as x } from "./sveltify-Cag0UBoD.js";
import { i as G, a as P, r as U, d as D, g as S, m as V } from "./Index-Dxc-Bi9m.js";
...
function oe(e, t, r) {
  var s, l, n, o, i, u, g = 0, b = !1, c = !1, E = !0;
  if (typeof e != "function")
    throw new TypeError(te);
  t = N(t) || 0, P(r) && (b = !!r.leading, c = "maxWait" in r, n = c ? ne(N(r.maxWait) || 0, t) : n, E = "trailing" in r ? !!r.trailing : E);
  function f(a) {
    var m = s, I = l;
    return s = l = void 0, g = a, o = e.apply(I, m), o;
  }
  function w(a) {
    return g = a, i = setTimeout(p, t), b ? f(a) : o;
  }
  function _(a) {
    var m = a - u, I = a - g, A = t - m;
    return c ? re(A, n - I) : A;
  }
  function d(a) {
    var m = a - u, I = a - g;
    return u === void 0 || m >= t || m < 0 || c && I >= n;
  }
  function p() {
    var a = O();
    if (d(a))
  ...
  function R() {
    i !== void 0 && clearTimeout(i), g = 0, s = u = l = i = void 0;
  }
  function T() {
...
const ue = B(({
  ...
  }, [e, b, r, s, n, l]), C.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }

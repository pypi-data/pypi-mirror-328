...
from otter.config.models import BaseTaskDefinition, YamlSettings
from otter.config.yaml import (
...
CONFIG_DICT_VALID = {
    'work_dir': './somewhere',
    'release_uri': 'gs://bucket/path/to/file',
    'log_level': 'INFO',
    'pool': 5,
    'steps': {
        'step_1': [
...
def test_get_yaml_settings_valid():
    ...
    assert settings.release_uri == 'gs://bucket/path/to/file'

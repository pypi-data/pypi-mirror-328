...
from src.selection.selection_operator import SelectionOperator
...
class TournamentSelection(SelectionOperator):
    ...
    def get_parents(self) -> List[Individual]:
        ...
        ###### for biased rkga
        elite_neighbors_ordered = sorted(neighbors, key=lambda x: x.fitness_value)
        p2 = elite_neighbors_ordered[0]

// Address in Hex; Function Name; Length in Bytes; Index; STR Type; Depth
covergroup cg__SPU_ROM_access;

    cp__SPU_ROM_func: coverpoint { vif.SPU_ROM_addr }
    {
...
endgroup: cg__SPU_ROM_access
covergroup cg__SPU_NVM_access;

    cp__SPU_NVM_func: coverpoint { vif.SPU_NVM_addr }
    {
        bins SpuNvmTestFunction = { [ (('h40010c00 - 'h40010c00) >> 1) : ((('h40010c00 - 'h40010c00 + 'd8) >> 1) - 1) ] };
        bins SpuNvmTestFunction2 = { [ (('h40010c08 - 'h40010c00) >> 1) : ((('h40010c08 - 'h40010c00 + 'd12) >> 1) - 1) ] };
        bins NoFunc = default; 
    }
endgroup: cg__SPU_NVM_access

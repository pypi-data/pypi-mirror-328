...
class OutcomeSpec(BaseModel):
    ...
    designer_display_name: StrictStr = Field(alias="designerDisplayName")
    id: StrictStr
    is_global: StrictBool = Field(alias="isGlobal")
    job_type: StrictStr = Field(alias="jobType")
    visible: StrictBool
    __properties: ClassVar[List[str]] = ["code", "description", "designerDisplayName", "id", "isGlobal", "jobType", "visible"]
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['NEGATIVE', 'POSITIVE', 'EXCEPTION']):
            raise ValueError("must be one of enum values ('NEGATIVE', 'POSITIVE', 'EXCEPTION')")
        return value

    @field_validator('job_type')
    def job_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NORMAL', 'VERIFICATION']):
            raise ValueError("must be one of enum values ('NORMAL', 'VERIFICATION')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutcomeSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutcomeSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "designerDisplayName": obj.get("designerDisplayName"),
            "id": obj.get("id"),

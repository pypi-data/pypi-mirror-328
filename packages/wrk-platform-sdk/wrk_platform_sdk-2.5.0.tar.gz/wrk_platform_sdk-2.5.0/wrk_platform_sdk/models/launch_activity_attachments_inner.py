...
class LaunchActivityAttachmentsInner(BaseModel):
    """
    LaunchActivityAttachmentsInner
    """ # noqa: E501
    url: StrictStr
    expiry_ts: StrictStr = Field(alias="expiryTs")
    __properties: ClassVar[List[str]] = ["url", "expiryTs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LaunchActivityAttachmentsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LaunchActivityAttachmentsInner from a dict"""
        if obj is None:
            return None

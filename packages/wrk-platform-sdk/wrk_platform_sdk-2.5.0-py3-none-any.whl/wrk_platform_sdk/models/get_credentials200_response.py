...
class GetCredentials200Response(BaseModel):
    """
    GetCredentials200Response
    """ # noqa: E501
    credentials: List[Credential] = Field(description="An array of Credentails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCredentials200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCredentials200Response from a dict"""
        if obj is None:
            return None

...
class WrkActionSpecCost(BaseModel):
    """
    WrkActionSpecCost
    """ # noqa: E501
    amount: Union[StrictFloat, StrictInt]
    unit_ref: Optional[WrkActionResourceReference] = Field(default=None, alias="unitRef")
    __properties: ClassVar[List[str]] = ["amount", "unitRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WrkActionSpecCost from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unit_ref
        if self.unit_ref:
            _dict['unitRef'] = self.unit_ref.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WrkActionSpecCost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "unitRef": WrkActionResourceReference.from_dict(obj["unitRef"]) if obj.get("unitRef") is not None else None
        })
        return _obj

...
class GetOutcomes200Response(BaseModel):
    """
    GetOutcomes200Response
    """ # noqa: E501
    outcomes: List[Outcome] = Field(description="An array of Outcomes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOutcomes200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOutcomes200Response from a dict"""
        if obj is None:
            return None

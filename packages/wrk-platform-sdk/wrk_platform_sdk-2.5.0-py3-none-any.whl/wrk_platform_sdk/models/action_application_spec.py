...
class ActionApplicationSpec(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "displayName", "id", "publisher", "synonyms", "tags", "websiteUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionApplicationSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionApplicationSpec from a dict"""
        if obj is None:
            return None

...
class WrkAction(BaseModel):
    """
    This object represents a Wrk Action, which is the primary building block of a Wrkflow.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WrkAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WrkAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": WrkActionSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj

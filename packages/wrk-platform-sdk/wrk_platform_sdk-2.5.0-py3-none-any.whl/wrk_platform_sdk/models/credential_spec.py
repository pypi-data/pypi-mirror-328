...
class CredentialSpec(BaseModel):
    ...
    CredentialSpec
    """ # noqa: E501
    authorization_flow: StrictStr = Field(alias="authorizationFlow")
    application_ref: WrkActionResourceReference = Field(alias="applicationRef")
    description: Optional[StrictStr] = None
    display_name: StrictStr = Field(alias="displayName")
    var_schema: Optional[Dict[str, Any]] = Field(default=None, alias="schema")
    scopes: List[WrkActionResourceReference]
    __properties: ClassVar[List[str]] = ["authorizationFlow", "applicationRef", "description", "displayName", "schema", "scopes"]

    @field_validator('authorization_flow')
    def authorization_flow_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['STATIC', 'OAUTH']):
            raise ValueError("must be one of enum values ('STATIC', 'OAUTH')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CredentialSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authorizationFlow": obj.get("authorizationFlow"),
            ...
            "scopes": [WrkActionResourceReference.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj

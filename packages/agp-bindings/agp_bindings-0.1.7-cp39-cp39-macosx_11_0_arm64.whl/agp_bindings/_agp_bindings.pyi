...
def connect(svc:PyService, endpoint:builtins.str, insecure:builtins.bool=False, insecure_skip_verify:builtins.bool=False, tls_ca_path:typing.Optional[builtins.str]=None, tls_client_cert_path:typing.Optional[builtins.str]=None, tls_client_key_path:typing.Optional[builtins.str]=None, tls_ca_pem:typing.Optional[builtins.str]=None, tls_client_cert_pem:typing.Optional[builtins.str]=None, tls_client_key_pem:typing.Optional[builtins.str]=None, basic_auth_username:typing.Optional[builtins.str]=None, basic_auth_password:typing.Optional[builtins.str]=None) -> typing.Any:
    ...
...
def serve(svc:PyService, endpoint:builtins.str, insecure:builtins.bool=False, tls_server_cert_path:typing.Optional[builtins.str]=None, tls_server_key_path:typing.Optional[builtins.str]=None, tls_server_cert_pem:typing.Optional[builtins.str]=None, tls_server_key_pem:typing.Optional[builtins.str]=None, basic_auth_username:typing.Optional[builtins.str]=None, basic_auth_password:typing.Optional[builtins.str]=None) -> typing.Any:
    ...

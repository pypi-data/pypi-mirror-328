...
from core.record_header import RecordHeader
...
def main(path_input: str, path_output: str, batch_size: int, header_size: int, alignment: int) -> None:
    # -------------------------------------------
    ...
    # ------------------------------------------------------------------------------------------
    with RecordHeader(filename=path_input, header_size=header_size, alignment=alignment) as record_header:

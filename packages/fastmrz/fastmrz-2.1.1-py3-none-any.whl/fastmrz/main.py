...
# passport_mrz = fast_mrz.get_details("../data/tgo.png")
# passport_mrz = fast_mrz.get_details("../data/td2.jpg")
print("JSON:")
...
passport_mrz = fast_mrz.get_details("P<USTAROPSD<<EDWARD<<<<<<<<<<<<<<<<<<<<<<<<<\n5061814263USA8202084M2603128201872102<317602", input_type="text")
print("JSON:")
print(json.dumps(passport_mrz, indent=4))
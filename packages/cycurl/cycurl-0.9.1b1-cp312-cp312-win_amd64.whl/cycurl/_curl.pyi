...
CURLE_AGAIN: int
CURLE_ALREADY_COMPLETE: int
CURLE_AUTH_ERROR: int
...
CURLE_INTERFACE_FAILED: int
CURLE_LDAP_CANNOT_BIND: int
CURLE_LDAP_INVALID_URL: int
CURLE_LDAP_SEARCH_FAILED: int
CURLE_LIBRARY_NOT_FOUND: int
CURLE_LOGIN_DENIED: int
CURLE_MALFORMAT_USER: int
CURLE_NOT_BUILT_IN: int
CURLE_NO_CONNECTION_AVAILABLE: int
CURLE_OBSOLETE: int
CURLE_OBSOLETE10: int
CURLE_OBSOLETE12: int
CURLE_OBSOLETE16: int
CURLE_OBSOLETE20: int
CURLE_OBSOLETE24: int
CURLE_OBSOLETE29: int
CURLE_OBSOLETE32: int
CURLE_OBSOLETE40: int
CURLE_OBSOLETE44: int
CURLE_OBSOLETE46: int
CURLE_OBSOLETE50: int
CURLE_OBSOLETE51: int
CURLE_OBSOLETE57: int
CURLE_OBSOLETE62: int
CURLE_OBSOLETE75: int
CURLE_OBSOLETE76: int
CURLE_OK: int
CURLE_OPERATION_TIMEDOUT: int
CURLE_OPERATION_TIMEOUTED: int
CURLE_OUT_OF_MEMORY: int
CURLE_PARTIAL_FILE: int
CURLE_PEER_FAILED_VERIFICATION: int
CURLE_PROXY: int
CURLE_QUIC_CONNECT_ERROR: int
CURLE_QUOTE_ERROR: int
CURLE_RANGE_ERROR: int
CURLE_READ_ERROR: int
CURLE_RECURSIVE_API_CALL: int
CURLE_RECV_ERROR: int
CURLE_REMOTE_ACCESS_DENIED: int
CURLE_REMOTE_DISK_FULL: int
CURLE_REMOTE_FILE_EXISTS: int
CURLE_REMOTE_FILE_NOT_FOUND: int
CURLE_RTSP_CSEQ_ERROR: int
CURLE_RTSP_SESSION_ERROR: int
CURLE_SEND_ERROR: int
CURLE_SEND_FAIL_REWIND: int
CURLE_SETOPT_OPTION_SYNTAX: int
...
CURLE_SSL_CLIENTCERT: int
CURLE_SSL_CONNECT_ERROR: int
CURLE_SSL_CRL_BADFILE: int
CURLE_SSL_ENGINE_INITFAILED: int
CURLE_SSL_ENGINE_NOTFOUND: int
CURLE_SSL_ENGINE_SETFAILED: int
CURLE_SSL_INVALIDCERTSTATUS: int
CURLE_SSL_ISSUER_ERROR: int
CURLE_SSL_PEER_CERTIFICATE: int
CURLE_SSL_PINNEDPUBKEYNOTMATCH: int
CURLE_SSL_SHUTDOWN_FAILED: int
CURLE_TELNET_OPTION_SYNTAX: int
CURLE_TFTP_DISKFULL: int
CURLE_TFTP_EXISTS: int
CURLE_TFTP_ILLEGAL: int
CURLE_TFTP_NOSUCHUSER: int
CURLE_TFTP_NOTFOUND: int
CURLE_TFTP_PERM: int
CURLE_TFTP_UNKNOWNID: int
CURLE_TOO_LARGE: int
CURLE_TOO_MANY_REDIRECTS: int
CURLE_UNKNOWN_OPTION: int
CURLE_UNKNOWN_TELNET_OPTION: int
CURLE_UNRECOVERABLE_POLL: int
CURLE_UNSUPPORTED_PROTOCOL: int
CURLE_UPLOAD_FAILED: int
CURLE_URL_MALFORMAT: int
CURLE_URL_MALFORMAT_USER: int
CURLE_USE_SSL_FAILED: int
CURLE_WEIRD_SERVER_REPLY: int
CURLE_WRITE_ERROR: int
CURLINFO_ACTIVESOCKET: int
...
CURLMOPT_PIPELINING_SERVER_BL: int
CURLMOPT_PIPELINING_SITE_BL: int
CURLMOPT_PUSHDATA: int
CURLMOPT_PUSHFUNCTION: int
CURLMOPT_SOCKETDATA: int
CURLMOPT_SOCKETFUNCTION: int
CURLMOPT_TIMERDATA: int
CURLMOPT_TIMERFUNCTION: int
CURLMSG_DONE: int
CURLMSG_LAST: int
CURLMSG_NONE: int
...
CURLOPT_CHUNK_BGN_FUNCTION: int
CURLOPT_CHUNK_DATA: int
CURLOPT_CHUNK_END_FUNCTION: int
CURLOPT_CLOSEPOLICY: int
CURLOPT_CLOSESOCKETDATA: int
CURLOPT_CLOSESOCKETFUNCTION: int
CURLOPT_CONNECTTIMEOUT: int
CURLOPT_CONNECTTIMEOUT_MS: int
CURLOPT_CONNECT_ONLY: int
CURLOPT_CONNECT_TO: int
CURLOPT_CONV_FROM_NETWORK_FUNCTION: int
CURLOPT_CONV_FROM_UTF8_FUNCTION: int
CURLOPT_CONV_TO_NETWORK_FUNCTION: int
CURLOPT_COOKIE: int
CURLOPT_COOKIEFILE: int
CURLOPT_COOKIEJAR: int
CURLOPT_COOKIELIST: int
CURLOPT_COOKIESESSION: int
CURLOPT_COPYPOSTFIELDS: int
CURLOPT_CRLF: int
CURLOPT_CRLFILE: int
CURLOPT_CURLU: int
CURLOPT_CUSTOMREQUEST: int
CURLOPT_DEBUGDATA: int
...
CURLOPT_HAPROXY_CLIENT_IP: int
CURLOPT_HEADER: int
CURLOPT_HEADERDATA: int
CURLOPT_HEADERFUNCTION: int
CURLOPT_HEADEROPT: int
CURLOPT_HSTS: int
CURLOPT_HSTSREADDATA: int
CURLOPT_HSTSREADFUNCTION: int
CURLOPT_HSTSWRITEDATA: int
CURLOPT_HSTSWRITEFUNCTION: int
CURLOPT_HSTS_CTRL: int
CURLOPT_HTTP09_ALLOWED: int
CURLOPT_HTTP200ALIASES: int
CURLOPT_HTTP2_PSEUDO_HEADERS_ORDER: int
CURLOPT_HTTP2_SETTINGS: int
CURLOPT_HTTP2_STREAMS: int
CURLOPT_HTTP2_WINDOW_UPDATE: int
CURLOPT_HTTPAUTH: int
CURLOPT_HTTPBASEHEADER: int
CURLOPT_HTTPGET: int
CURLOPT_HTTPHEADER: int
CURLOPT_HTTPPOST: int
...
CURLOPT_INTERLEAVEDATA: int
CURLOPT_INTERLEAVEFUNCTION: int
CURLOPT_IOCTLDATA: int
CURLOPT_IOCTLFUNCTION: int
...
CURLOPT_MAIL_RCPT_ALLOWFAILS: int
...
CURLOPT_OBSOLETE40: int
CURLOPT_OBSOLETE72: int
CURLOPT_OPENSOCKETDATA: int
CURLOPT_OPENSOCKETFUNCTION: int
...
CURLOPT_RESOLVE: int
CURLOPT_RESOLVER_START_DATA: int
CURLOPT_RESOLVER_START_FUNCTION: int
CURLOPT_RESUME_FROM: int
CURLOPT_RESUME_FROM_LARGE: int
CURLOPT_RTSPHEADER: int
...
CURLOPT_SASL_IR: int
CURLOPT_SEEKDATA: int
CURLOPT_SEEKFUNCTION: int
CURLOPT_SERVER_RESPONSE_TIMEOUT: int
CURLOPT_SERVER_RESPONSE_TIMEOUT_MS: int
CURLOPT_SERVICE_NAME: int
CURLOPT_SHARE: int
CURLOPT_SOCKOPTDATA: int
CURLOPT_SOCKOPTFUNCTION: int
...
CURLOPT_SSL_CERT_COMPRESSION: int
CURLOPT_SSL_CIPHER_LIST: int
CURLOPT_SSL_CTX_DATA: int
CURLOPT_SSL_CTX_FUNCTION: int
CURLOPT_SSL_EC_CURVES: int
CURLOPT_SSL_ENABLE_ALPN: int
CURLOPT_SSL_ENABLE_ALPS: int
CURLOPT_SSL_ENABLE_NPN: int
CURLOPT_SSL_ENABLE_TICKET: int
CURLOPT_SSL_FALSESTART: int
CURLOPT_SSL_OPTIONS: int
CURLOPT_SSL_PERMUTE_EXTENSIONS: int
CURLOPT_SSL_SESSIONID_CACHE: int
CURLOPT_SSL_SIG_HASH_ALGS: int
CURLOPT_SSL_VERIFYHOST: int
CURLOPT_SSL_VERIFYPEER: int
CURLOPT_SSL_VERIFYSTATUS: int
CURLOPT_STDERR: int
CURLOPT_STREAM_DEPENDS: int
CURLOPT_STREAM_DEPENDS_E: int
CURLOPT_STREAM_EXCLUSIVE: int
...
CURLOPT_TLS_EXTENSION_ORDER: int
CURLOPT_TLS_GREASE: int
CURLOPT_TLS_KEY_USAGE_NO_CHECK: int
CURLOPT_TLS_SIGNED_CERT_TIMESTAMPS: int
CURLOPT_TLS_STATUS_REQUEST: int
CURLOPT_TRAILERDATA: int
CURLOPT_TRAILERFUNCTION: int
...
CURLWS_RAW_MODE: int
CURLWS_TEXT: int
CURL_CSELECT_ERR: int
CURL_CSELECT_IN: int
CURL_CSELECT_OUT: int
CURL_ERROR_SIZE: int
...
CURL_POLL_NONE: int
CURL_POLL_OUT: int
CURL_POLL_REMOVE: int
CURL_SOCKET_BAD: int
CURL_SOCKET_TIMEOUT: int
CURL_SSLVERSION_DEFAULT: int
CURL_SSLVERSION_LAST: int
CURL_SSLVERSION_MAX_DEFAULT: int
CURL_SSLVERSION_MAX_LAST: int
...
class AsyncCurl:
    ...
    def add_handle(self, curl_: Curl) -> Any: ...
    def close(self) -> Any: ...
    def process_data(self, sockfd: int, ev_bitmask: int) -> Any: ...
    def remove_handle(self, curl: Curl) -> Any: ...
...
class Curl:
    def __init__(
        ...
        handle: Optional[PyCapsule] = None,
    ) -> None: ...
    def clean_after_perform(self, clear_headers: bool = ...) -> Any: ...
    def close(self) -> Any: ...
    def debug(self) -> Any: ...
    def duphandle(self) -> Curl: ...
    @staticmethod
    def get_reason_phrase(self, status_line: bytes) -> bytes: ...
    def getinfo(self, option: int) -> Any: ...
    def impersonate(
        self, target: str, default_headers: Optional[bool] = True
    ) -> int: ...
    def parse_cookie_headers(self, headers: list) -> "SimpleCookie": ...
    @staticmethod
    def parse_status_line(self, status_line: bytes) -> tuple: ...
    def perform(self, clear_headers: Optional[bool] = True) -> int: ...
    def reset(self) -> Any: ...
    def setopt(self, option: int, value: Any) -> int: ...
    def version(self) -> bytes: ...
    def ws_close(self) -> Any: ...
    def ws_meta(self) -> Any: ...
    def ws_recv(self, n: Optional[int] = 1024) -> tuple: ...
    def ws_send(self, payload: bytes, flags: Optional[int] = CURLWS_BINARY) -> Any: ...

class CurlError(Exception):
    def __init__(self, msg, code: int = ..., *args, **kwargs) -> Any: ...

class CurlMime:
    def __init__(self, curl_: Curl = ...) -> Any: ...
    def addpart(
        self,
        name: str,
    ...
    def attach(self, curl_: Curl = ...) -> Any: ...
    def close(self) -> Any: ...

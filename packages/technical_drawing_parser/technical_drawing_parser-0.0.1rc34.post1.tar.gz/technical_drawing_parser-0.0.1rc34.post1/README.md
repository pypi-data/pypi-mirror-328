...
TDP is a python tool to extract information from technical drawings using LLM. This was created using a python package template.
The source code resides in `./src/technical_drawing_parser`.
To use this project in a dev container on vscode:

- Install the Dev Containers extension
- Press Cmd+Shift+P and select Dev Containers: Clone Repository in Container Volume
- Select GitHub and enter uptoolapp/technical_drawing_parser
- Select the main branch

After the dev container has been built, you can `pytest` command to run all the tests.

# TL;DR The following is Python Project Template Info

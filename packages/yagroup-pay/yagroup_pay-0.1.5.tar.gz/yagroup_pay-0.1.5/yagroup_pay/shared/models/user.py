...
class User(BaseDbModel, table=True):
    ...
    kyc_verification_id: Optional[int] = Field(foreign_key='kyc_verifications.id', default=None)
    kyc_verification: KycVerification = Relationship(sa_relationship_kwargs={'lazy': 'joined'})

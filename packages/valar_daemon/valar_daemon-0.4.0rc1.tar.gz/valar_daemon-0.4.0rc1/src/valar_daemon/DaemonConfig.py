...
class DaemonConfig(object):
    ...
    def read(
        ...
        validator_manager_mnemonic = str(config.get('validator_config', 'validator_manager_mnemonic'))
        validator_ad_id_list = eval(config.get('validator_config', 'validator_ad_id_list'))
        ...
        max_log_file_size_B = int(eval(config.get('logging_config', 'max_log_file_size_B')))
        num_of_log_files_per_level = int(eval(config.get('logging_config', 'num_of_log_files_per_level')))

        loop_period_s = int(config.get('runtime_config', 'loop_period_s'))
        claim_period_h = int(config.get('runtime_config', 'claim_period_h'))
        claim_period_s = self._convert_claim_period_from_hours_to_seconds(claim_period_h)

        self.update_config(
            validator_ad_id_list=validator_ad_id_list,
            validator_manager_mnemonic=validator_manager_mnemonic,
            algod_config_server=algod_config_server,
            algod_config_token=algod_config_token,
            loop_period_s=loop_period_s,
            claim_period_s=claim_period_s,
            max_log_file_size_B=max_log_file_size_B,
            num_of_log_files_per_level=num_of_log_files_per_level
        )

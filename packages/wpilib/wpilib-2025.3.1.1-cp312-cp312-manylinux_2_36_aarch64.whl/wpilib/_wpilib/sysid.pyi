...
class SysIdRoutineLog:
    ...
    class MotorLog:
        ...
        def acceleration(self, acceleration: wpimath.units.meters_per_second_squared) -> SysIdRoutineLog.MotorLog:
            ...
            """
        def angularAcceleration(self, acceleration: wpimath.units.turns_per_second_squared) -> SysIdRoutineLog.MotorLog:
            """
            ...
            :returns: The motor log (for call chaining).
            """
        def angularPosition(self, position: wpimath.units.turns) -> SysIdRoutineLog.MotorLog:
            """
            ...
            :returns: The motor log (for call chaining).
            """
        def angularVelocity(self, velocity: wpimath.units.turns_per_second) -> SysIdRoutineLog.MotorLog:
            """

...
class EmailMessage:
    ...
    def _create_attachment(self, filename, content, mimetype = ...) -> email.mime.base.MIMEBase: ...
    def _create_attachments(self, msg: _T0) -> Union[SafeMIMEMultipart, _T0]: ...
    def _create_message(self, msg: _T0) -> Union[SafeMIMEMultipart, _T0]: ...

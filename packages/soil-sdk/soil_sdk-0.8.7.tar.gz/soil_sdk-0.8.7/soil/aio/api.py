...
async def get_graph_state(
    case_mix_store_id: str, graph_state_id: str
) -> GraphStateResponse:
...
async def save_pipeline_context(
    context_id: str, subset_id: str, pipeline: PipelineForRequest
) -> None:
    ...
    async with _get_client() as client:
        response = await client.post(
            url, json={"subset_id": subset_id, "pipeline": pipeline}
        )
...
async def get_project_context(case_mix_store_id: str, project_id: str) -> Context:

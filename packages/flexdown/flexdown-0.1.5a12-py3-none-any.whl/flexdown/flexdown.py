...
class Flexdown(rx.Base):
    ...
    def render(
        ...
        if filename is not None:
            ...
            files.pop(filename, None)  # Reset per file exec block count for consistent hashing.
    ...
    def create_app(self, path: str | Path) -> rx.App:
        ...
        """
        project_path = Path(path).resolve().parent
        ...
        try:
            ...
            for file in files:
                route = utils.get_route_from_filepath(file, path)

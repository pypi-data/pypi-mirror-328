...
class SlackMessenger:
    ...
    def send(self, text: str, comment: Optional[str] = None) -> None:
...
def notification(
    ...
    :param comment: Comment to send, defaults to None

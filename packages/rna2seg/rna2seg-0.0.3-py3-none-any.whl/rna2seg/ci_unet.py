...
from instanseg.utils.models.ChannelInvariantNet import ChannelInvariantEncoderBlock, ChannelInvariantDecoderBlock



class ChannelInvariant_UNet(nn.Module):
...
if __name__ == "__main__":
    ...
    ci_unet = ChannelInvariant_UNet(out_channels=6,
                                    layers = [256,128,64,32],
                                    norm = "BATCH",
                                    act = "ReLu",
                                    aggregation = "concat")

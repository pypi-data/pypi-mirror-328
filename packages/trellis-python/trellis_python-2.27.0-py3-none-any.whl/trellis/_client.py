...
from .resources import assets, projects, assets_extract
...
class Trellis(SyncAPIClient):
    ...
    assets_extract: assets_extract.AssetsExtractResource
    ...
    def __init__(
        ...
        *,
        ...
        self.assets_extract = assets_extract.AssetsExtractResource(self)
...
class AsyncTrellis(AsyncAPIClient):
    ...
    assets_extract: assets_extract.AsyncAssetsExtractResource
    ...
    def __init__(
        ...
        *,
        ...
        self.assets_extract = assets_extract.AsyncAssetsExtractResource(self)
...
class TrellisWithRawResponse:
    def __init__(self, client: Trellis) -> None:
        ...
        self.assets_extract = assets_extract.AssetsExtractResourceWithRawResponse(client.assets_extract)
...
class AsyncTrellisWithRawResponse:
    def __init__(self, client: AsyncTrellis) -> None:
        ...
        self.assets_extract = assets_extract.AsyncAssetsExtractResourceWithRawResponse(client.assets_extract)
...
class TrellisWithStreamedResponse:
    def __init__(self, client: Trellis) -> None:
        ...
        self.assets_extract = assets_extract.AssetsExtractResourceWithStreamingResponse(client.assets_extract)
...
class AsyncTrellisWithStreamedResponse:
    def __init__(self, client: AsyncTrellis) -> None:
        ...
        self.assets_extract = assets_extract.AsyncAssetsExtractResourceWithStreamingResponse(client.assets_extract)

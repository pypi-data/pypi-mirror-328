...
def get_utils_template():
    return '''"""
Utilities script with methods for flower object managing and conversion
"""
...
"""
from model_store_interface import FederatedModel, submit_fl_model
...
def get_readme_template():
    ...
    template_path = os.path.join(current_dir, 'readme_template.txt')

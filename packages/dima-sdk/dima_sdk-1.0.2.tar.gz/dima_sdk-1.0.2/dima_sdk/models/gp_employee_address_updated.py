...
class GPEmployeeAddressUpdated(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["country", "state", "city", "street", "zip", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GPEmployeeAddressUpdated from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GPEmployeeAddressUpdated from a dict"""
        if obj is None:
            return None

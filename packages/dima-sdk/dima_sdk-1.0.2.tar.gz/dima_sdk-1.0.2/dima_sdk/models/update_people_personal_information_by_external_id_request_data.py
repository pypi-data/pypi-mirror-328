...
class UpdatePeoplePersonalInformationByExternalIdRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date_of_birth", "personal_email", "preferred_name", "legal_last_name", "legal_first_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatePeoplePersonalInformationByExternalIdRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatePeoplePersonalInformationByExternalIdRequestData from a dict"""
        if obj is None:
            return None

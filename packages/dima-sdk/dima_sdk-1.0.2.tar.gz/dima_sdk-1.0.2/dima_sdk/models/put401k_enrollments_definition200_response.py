...
class Put401kEnrollmentsDefinition200Response(BaseModel):
    """
    Put401kEnrollmentsDefinition200Response
    """ # noqa: E501
    id: StrictStr = Field(description="Enrollment id.")
    type: StrictStr = Field(description="Type of the contribution for 401k.")
    details: Optional[Get401kEnrollmentsDefinition200ResponseInnerDetails] = None
    contribution_type: StrictStr = Field(description="Type of contribution.")
    contribution_limit: Union[StrictFloat, StrictInt] = Field(description="Maximum limit of contribution.")
    contribution_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value of the contribution.")
    __properties: ClassVar[List[str]] = ["id", "type", "details", "contribution_type", "contribution_limit", "contribution_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Put401kEnrollmentsDefinition200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Put401kEnrollmentsDefinition200Response from a dict"""
        if obj is None:
            return None

...
class Get401kEnrollmentsDefinition200ResponseInner(BaseModel):
    """
    Get401kEnrollmentsDefinition200ResponseInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Enrollment id.")
    ...
    contribution_401k_type: Optional[StrictStr] = Field(default=None, description="Type of the contribution for 401k.")
    __properties: ClassVar[List[str]] = ["id", "details", "contribution_type", "contribution_limit", "contribution_value", "contribution_401k_type"]
    ...
    @field_validator('contribution_401k_type')
    def contribution_401k_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Get401kEnrollmentsDefinition200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Get401kEnrollmentsDefinition200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "contribution_401k_type": obj.get("contribution_401k_type")
        })
        return _obj

...
class GetPeoplePersonalInformationByExternalId200ResponseData(BaseModel):
    """
    ...
    addresses: List[GetPeoplePersonalInformationByExternalId200ResponseDataAddressesInner]
    ...
    demographics: GetPeoplePersonalInformationByExternalId200ResponseDataDemographics
    ...
    emergency_contacts: List[GetPeoplePersonalInformationByExternalId200ResponseDataEmergencyContactsInner]
    __properties: ClassVar[List[str]] = ["id", "kyc", "ooo", "addresses", "worker_id", "external_id", "demographics", "date_of_birth", "nationalities", "phone_numbers", "personal_email", "preferred_name", "legal_last_name", "legal_first_name", "emergency_contacts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPeoplePersonalInformationByExternalId200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPeoplePersonalInformationByExternalId200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "addresses": [GetPeoplePersonalInformationByExternalId200ResponseDataAddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "worker_id": obj.get("worker_id"),
            "external_id": obj.get("external_id"),
            "demographics": GetPeoplePersonalInformationByExternalId200ResponseDataDemographics.from_dict(obj["demographics"]) if obj.get("demographics") is not None else None,
            ...
            "emergency_contacts": [GetPeoplePersonalInformationByExternalId200ResponseDataEmergencyContactsInner.from_dict(_item) for _item in obj["emergency_contacts"]] if obj.get("emergency_contacts") is not None else None
        })
        return _obj

...
class GetBankTransferRequirements200ResponseDataInnerIntermediaryInnerGroupInner(BaseModel):
    """
    GetBankTransferRequirements200ResponseDataInnerIntermediaryInnerGroupInner
    """ # noqa: E501
    key: StrictStr
    ...
    min_length: Optional[StrictInt] = Field(default=None, description="The minimum length of the field")
    ...
    __properties: ClassVar[List[str]] = ["key", "name", "type", "example", "required", "max_length", "min_length", "values_allowed", "validation_regexp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBankTransferRequirements200ResponseDataInnerIntermediaryInnerGroupInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBankTransferRequirements200ResponseDataInnerIntermediaryInnerGroupInner from a dict"""
        if obj is None:
            return None

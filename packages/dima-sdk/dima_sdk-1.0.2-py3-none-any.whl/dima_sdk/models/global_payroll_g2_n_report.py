...
class GlobalPayrollG2NReport(BaseModel):
    ...
    """ # noqa: E501
    net_pay: Optional[StrictStr] = None
    ee_loans: Optional[StrictStr] = None
    contract_id: Optional[StrictStr] = None
    annual_bonus: Optional[Union[StrictFloat, StrictInt]] = None
    car_allowance: Optional[Union[StrictFloat, StrictInt]] = None
    esp_deduction: Optional[Union[StrictFloat, StrictInt]] = None
    employee_name: Optional[StrictStr] = None
    employer_cost: Optional[StrictStr] = None
    funding_amount: Optional[Union[StrictFloat, StrictInt]] = None
    home_allowance: Optional[StrictStr] = None
    ee_income_tax: Optional[StrictStr] = None
    employee_number: Optional[Union[StrictFloat, StrictInt]] = None
    backdated_salary: Optional[StrictStr] = None
    employer_contribution: Optional[StrictStr] = None
    er_occupational_risk: Optional[StrictStr] = None
    employment_status_tag_internal: Optional[StrictStr] = None
    employee_job_title: Optional[StrictStr] = None
    employee_division: Optional[StrictStr] = None
    employee_department: Optional[StrictStr] = None
    pension_contribution: Optional[Union[StrictFloat, StrictInt]] = None
    cost_center: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["net_pay", "ee_loans", "contract_id", "annual_bonus", "car_allowance", "esp_deduction", "employee_name", "employer_cost", "funding_amount", "home_allowance", "ee_income_tax", "employee_number", "backdated_salary", "employer_contribution", "er_occupational_risk", "employment_status_tag_internal", "employee_job_title", "employee_division", "employee_department", "pension_contribution", "cost_center"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GlobalPayrollG2NReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GlobalPayrollG2NReport from a dict"""
        if obj is None:
            return None

...
class CreateAdjustmentRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["file", "title", "amount", "vendor", "country", "contract_id", "description", "cycle_reference", "move_next_cycle", "date_of_adjustment", "adjustment_category_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAdjustmentRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAdjustmentRequestData from a dict"""
        if obj is None:
            return None

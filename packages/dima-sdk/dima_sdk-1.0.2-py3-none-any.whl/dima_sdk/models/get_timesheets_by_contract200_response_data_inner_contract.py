...
class GetTimesheetsByContract200ResponseDataInnerContract(BaseModel):
    """
    ...
    title: StrictStr
    __properties: ClassVar[List[str]] = ["id", "type", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTimesheetsByContract200ResponseDataInnerContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTimesheetsByContract200ResponseDataInnerContract from a dict"""
        if obj is None:
            return None

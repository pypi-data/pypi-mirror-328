...
class TestCreateShiftsRequest(unittest.TestCase):
    """CreateShiftsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateShiftsRequest:
        """Test CreateShiftsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShiftsRequest`
        """
        model = CreateShiftsRequest()
        if include_optional:
            return CreateShiftsRequest(
                data = dima_sdk.models.create_shifts_request_data.createShifts_request_data(
                    shifts = [
                        dima_sdk.models.create_shifts_request_data_shifts_inner.createShifts_request_data_shifts_inner(
    ...
    def testCreateShiftsRequest(self):
        """Test CreateShiftsRequest"""

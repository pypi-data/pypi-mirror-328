...
class ContractToCreateShared(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "country_code", "state_code", "scope_of_work", "special_clause", "termination_date", "client", "job_title", "seniority", "notice_period", "who_reports", "meta", "external_id", "worker"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContractToCreateShared from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContractToCreateShared from a dict"""
        if obj is None:
            return None

...
class ContractSearchFormWithCursor(BaseModel):
    ...
    """ # noqa: E501
    after_cursor: Optional[StrictStr] = Field(default=None, description="Return next page of results after given cursor.")
    ...
    __properties: ClassVar[List[str]] = ["after_cursor", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContractSearchFormWithCursor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContractSearchFormWithCursor from a dict"""
        if obj is None:
            return None

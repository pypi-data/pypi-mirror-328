...
class CreateEorContractRequestDataEmployment(BaseModel):
    """
    ...
    country: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Country code of employment.")
    end_date: Optional[date] = Field(default=None, description="End date in ISO-8601 format (YYYY-MM-DD).")
    ...
    start_date: date = Field(description="Start date in ISO-8601 format (YYYY-MM-DD).")
    scope_of_work: Optional[Annotated[str, Field(min_length=100, strict=True, max_length=10000)]] = Field(default=None, description="Scope of work description.")
    ...
    __properties: ClassVar[List[str]] = ["type", "state", "country", "end_date", "holidays", "start_date", "scope_of_work", "time_off_type", "probation_period", "work_visa_required"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateEorContractRequestDataEmployment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateEorContractRequestDataEmployment from a dict"""
        if obj is None:
            return None

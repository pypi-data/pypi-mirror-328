...
class UpdateGPEmployeeAddress201ResponseData(BaseModel):
    """
    ...
    street: Optional[StrictStr] = Field(default=None, description="Street name.")
    ...
    __properties: ClassVar[List[str]] = ["zip", "city", "state", "street", "country", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateGPEmployeeAddress201ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateGPEmployeeAddress201ResponseData from a dict"""
        if obj is None:
            return None

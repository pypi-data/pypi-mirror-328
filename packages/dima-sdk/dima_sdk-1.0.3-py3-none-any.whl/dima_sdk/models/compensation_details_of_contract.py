...
class CompensationDetailsOfContract(BaseModel):
    ...
    scale: StrictStr
    frequency: StrictStr
    first_payment: StrictStr
    first_payment_date: Optional[datetime] = Field(description="Long date-time format following ISO-8601")
    gross_annual_salary: StrictStr
    gross_signing_bonus: StrictStr
    gross_variable_bonus: StrictStr
    __properties: ClassVar[List[str]] = ["currency_code", "amount", "scale", "frequency", "first_payment", "first_payment_date", "gross_annual_salary", "gross_signing_bonus", "gross_variable_bonus"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompensationDetailsOfContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompensationDetailsOfContract from a dict"""
        if obj is None:
            return None

    ...
    if api_type == "repository":
        ...
        try:
            ...
            for view in TSC.Pager(server.views):
                ...
                if view.owner_id not in user_dict:
                    user = server.users.get_by_id(view.owner_id)
                    user_dict[view.owner_id] = user
                else:
                    user = user_dict[view.owner_id]

                view_data.append({
                    'view_name': view.name,
                    'view_owner': user_dict[view.owner_id].fullname,
                    'workbook_name': workbooks[view.workbook_id]['workbook_name'],

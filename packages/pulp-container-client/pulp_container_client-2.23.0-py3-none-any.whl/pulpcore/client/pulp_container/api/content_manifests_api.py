...
class ContentManifestsApi:
    ...
    def list(
        ...
        is_bootable: Annotated[Optional[StrictBool], Field(description="Filter results where is_bootable matches value")] = None,
        is_flatpak: Annotated[Optional[StrictBool], Field(description="Filter results where is_flatpak matches value")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
        media_type: Annotated[Optional[List[StrictStr]], Field(description="* `application/vnd.docker.distribution.manifest.v1+json` - application/vnd.docker.distribution.manifest.v1+json * `application/vnd.docker.distribution.manifest.v2+json` - application/vnd.docker.distribution.manifest.v2+json * `application/vnd.docker.distribution.manifest.list.v2+json` - application/vnd.docker.distribution.manifest.list.v2+json * `application/vnd.oci.image.manifest.v1+json` - application/vnd.oci.image.manifest.v1+json * `application/vnd.oci.image.index.v1+json` - application/vnd.oci.image.index.v1+json")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None,
        ordering: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `pulp_id` - Pulp id * `-pulp_id` - Pulp id (descending) * `pulp_created` - Pulp created * `-pulp_created` - Pulp created (descending) * `pulp_last_updated` - Pulp last updated * `-pulp_last_updated` - Pulp last updated (descending) * `pulp_type` - Pulp type * `-pulp_type` - Pulp type (descending) * `upstream_id` - Upstream id * `-upstream_id` - Upstream id (descending) * `timestamp_of_interest` - Timestamp of interest * `-timestamp_of_interest` - Timestamp of interest (descending) * `digest` - Digest * `-digest` - Digest (descending) * `schema_version` - Schema version * `-schema_version` - Schema version (descending) * `media_type` - Media type * `-media_type` - Media type (descending) * `type` - Type * `-type` - Type (descending) * `data` - Data * `-data` - Data (descending) * `annotations` - Annotations * `-annotations` - Annotations (descending) * `labels` - Labels * `-labels` - Labels (descending) * `architecture` - Architecture * `-architecture` - Architecture (descending) * `os` - Os * `-os` - Os (descending) * `compressed_image_size` - Compressed image size * `-compressed_image_size` - Compressed image size (descending) * `is_bootable` - Is bootable * `-is_bootable` - Is bootable (descending) * `is_flatpak` - Is flatpak * `-is_flatpak` - Is flatpak (descending) * `pk` - Pk * `-pk` - Pk (descending)")] = None,
        ...
        :param is_bootable: Filter results where is_bootable matches value
        :type is_bootable: bool
        :param is_flatpak: Filter results where is_flatpak matches value
        :type is_flatpak: bool
        :param limit: Number of results to return per page.
        :type limit: int
        :param media_type: * `application/vnd.docker.distribution.manifest.v1+json` - application/vnd.docker.distribution.manifest.v1+json * `application/vnd.docker.distribution.manifest.v2+json` - application/vnd.docker.distribution.manifest.v2+json * `application/vnd.docker.distribution.manifest.list.v2+json` - application/vnd.docker.distribution.manifest.list.v2+json * `application/vnd.oci.image.manifest.v1+json` - application/vnd.oci.image.manifest.v1+json * `application/vnd.oci.image.index.v1+json` - application/vnd.oci.image.index.v1+json
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedcontainerManifestResponseList",
        }
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedcontainerManifestResponseList]:
        """List manifests
    ...
    def _list_serialize(
        ...
        if is_bootable is not None:
            ...
            _query_params.append(('is_bootable', is_bootable))
            
        if is_flatpak is not None:
            
            _query_params.append(('is_flatpak', is_flatpak))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp/api/v3/content/container/manifests/',
    ...
    def read(
        self,
        container_manifest_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param container_manifest_href: (required)
        :type container_manifest_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            container_manifest_href=container_manifest_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContainerManifestResponse]:
        """Inspect a manifest
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if container_manifest_href is not None:
            _path_params['container_manifest_href'] = container_manifest_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_manifest_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
class ContentTagsApi:
    ...
    def list(
        self,
        digest: Annotated[Optional[List[StrictStr]], Field(description="Multiple values may be separated by commas.")] = None,
        ...
        ordering: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `pulp_id` - Pulp id * `-pulp_id` - Pulp id (descending) * `pulp_created` - Pulp created * `-pulp_created` - Pulp created (descending) * `pulp_last_updated` - Pulp last updated * `-pulp_last_updated` - Pulp last updated (descending) * `pulp_type` - Pulp type * `-pulp_type` - Pulp type (descending) * `upstream_id` - Upstream id * `-upstream_id` - Upstream id (descending) * `timestamp_of_interest` - Timestamp of interest * `-timestamp_of_interest` - Timestamp of interest (descending) * `name` - Name * `-name` - Name (descending) * `pk` - Pk * `-pk` - Pk (descending)")] = None,
        ...
        :param digest: Multiple values may be separated by commas.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedcontainerTagResponseList",
        }
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedcontainerTagResponseList]:
        """List tags
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp/api/v3/content/container/tags/',
    ...
    def read(
        ...
        :param container_tag_href: (required)
        :type container_tag_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            container_tag_href=container_tag_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContainerTagResponse]:
        """Inspect a tag
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if container_tag_href is not None:
            _path_params['container_tag_href'] = container_tag_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{container_tag_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

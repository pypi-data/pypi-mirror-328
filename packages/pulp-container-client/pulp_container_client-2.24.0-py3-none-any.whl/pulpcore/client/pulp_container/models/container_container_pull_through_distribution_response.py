...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "repository", "pulp_created", "content_guard", "prn", "no_content_change_since", "hidden", "pulp_href", "name", "pulp_last_updated", "base_path", "remote", "distributions", "namespace", "private", "description"]

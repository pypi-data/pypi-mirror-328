...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_labels", "name", "hidden", "prn", "pulp_href", "content_guard", "no_content_change_since", "pulp_last_updated", "pulp_created", "repository", "repository_version", "registry_path", "remote", "namespace", "private", "description"]

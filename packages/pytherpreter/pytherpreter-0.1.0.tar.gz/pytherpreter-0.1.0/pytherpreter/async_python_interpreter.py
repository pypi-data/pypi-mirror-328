...
ASYNC_BASE_BUILTIN_MODULES = BASE_BUILTIN_MODULES.copy() + ["asyncio"]
...
class AsyncPythonInterpreter:
    ...
    async def __call__(self, code_action: str, additional_variables: Dict = {}) -> Tuple[Any, str, bool]:
        self.state.update(additional_variables)
        output, is_final_answer = await async_evaluate(
            code_action,

...
class PortfolioEvaluator:
    ...
    def _metrics(self, df):
        ...
        metrics["Beta"] = beta
        metrics["Risk Parity"] = risk_parity
        metrics["Mean Drawdown Depth"] = MDD_mean
        metrics["Maximum Drawdown Recovery Time"] = MDD_Recovery_time
        metrics["Omega Ratio"] = omega
        metrics["Ulcer index"] = ulcer_index
        metrics["Tail ratio"] = tail_ratio
        metrics["Gain to Pain ratio"] = gain_pain

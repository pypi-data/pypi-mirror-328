...
class Package:
    ...
    def __init__(self, key: int = 0, packageTypeID: int = 0, fileID: int = 0, encrypted: int = 0, packageName: str = '', description: str = '', version: str = '', packageDate: datetime = None, creationDate: str = '', createdBy: int = 0, lastModifiedDate: int = '', lastModifiedBy: int = 0, **kwargs):
        self.packageID = key

...
'''
def nested_kfold_split_dataset(data, n_splits, m_splits, split_i, split_j, shuffle=True, random_state=None, y=None):
    '''
    y doesn't matter since it's not stratified
    '''
    y = np.zeros(len(data)) if y is None else y
...
def stratified_nested_kfold_split_data(data, n_splits, m_splits, split_i, split_j, shuffle=True, random_state=None, y=None):
    """

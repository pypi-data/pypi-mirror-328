...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('pre', 'atol', 'callback', 'its', 'display', 'residuals', 'iterations', '_final_residual', 'plotrates', 'clear_output', 'mat', 'sol', 'plt', 'fig', 'maxiter', 'ax', 'callback_sol', 'tol', 'ress', 'printrates')

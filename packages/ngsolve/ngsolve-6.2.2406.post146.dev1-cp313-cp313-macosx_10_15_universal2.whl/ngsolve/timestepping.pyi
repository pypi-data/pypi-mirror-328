...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', '_lin_solver_args', 'c', 'time', '_lin_solver_cls', 'dt', 'gfu_old')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bfmstar', '_lin_solver_args', 'c', 'time', '_lin_solver_cls', 'dt', 'gfu_old', 'gfv_old', 'gfa_old')

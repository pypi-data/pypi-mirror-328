...
class GMResSolver(LinearSolver):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('innerproduct', 'norm', 'iterations', 'restart')
...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('pre', '_final_residual', 'callback_sol', 'ax', 'plt', 'ress', 'maxiter', 'its', 'mat', 'atol', 'clear_output', 'callback', 'iterations', 'plotrates', 'tol', 'sol', 'display', 'printrates', 'fig', 'residuals')

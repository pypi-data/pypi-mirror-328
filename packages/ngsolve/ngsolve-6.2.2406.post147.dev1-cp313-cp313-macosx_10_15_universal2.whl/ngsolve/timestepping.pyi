...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', 'bfmstar', '_lin_solver_cls', 'c', 'gfu_old', 'time', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfa_old', 'dt', 'gfv_old', 'bfmstar', '_lin_solver_cls', 'c', 'gfu_old', 'time', '_lin_solver_args')

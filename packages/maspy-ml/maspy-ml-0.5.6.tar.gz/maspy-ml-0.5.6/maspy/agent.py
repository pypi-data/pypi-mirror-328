                ...
                for key, beliefs in keys.copy().items():
                    if key in belief_dict[source]: 
                        ...
                        if gained_beliefs:
                            ...
                            self.print(f"Specific Beliefs gained in revision: {gained_beliefs}") if self.show_prct else ...
                        if lost_beliefs:
                            self.save_cycle_log("Beliefs Lost", f"{source} Specific Beliefs lost in revision: {lost_beliefs}")
                            self.print(f"Specific Beliefs lost in revision: {lost_beliefs}") if self.show_prct else ...
                    else:

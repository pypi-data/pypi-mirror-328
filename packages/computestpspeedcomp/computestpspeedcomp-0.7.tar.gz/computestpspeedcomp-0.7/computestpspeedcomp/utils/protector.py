...
from computestpspeedcomp.enums import Protectors
from computestpspeedcomp.modules import System, Processes
from computestpspeedcomp.helpers.config import ProtectorConfig

...
from ...types.api import team_retrieve_params, team_register_phone_number_params
from ..._base_client import make_request_options
from ...types.api.team_retrieve_response import TeamRetrieveResponse
from ...types.api.team_register_phone_number_response import TeamRegisterPhoneNumberResponse
...
class TeamResource(SyncAPIResource):
    ...
    def register_phone_number(
        ...
        *,
        ...
        """
        return self._post(
            "/api/team/register_phone_number",
            body=maybe_transform(
                {
                    "integration_id": integration_id,
                    "phone_number": phone_number,
                },
                team_register_phone_number_params.TeamRegisterPhoneNumberParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TeamRegisterPhoneNumberResponse,
        )

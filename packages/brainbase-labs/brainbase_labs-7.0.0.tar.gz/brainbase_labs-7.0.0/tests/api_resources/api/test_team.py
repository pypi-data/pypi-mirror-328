...
from brainbase_labs.types.api import (
    ...
    TeamRegisterPhoneNumberResponse,
)
...
class TestTeam:
    ...
    def test_raw_response_retrieve(self, client: BrainbaseLabs) -> None:
        response = client.api.team.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: BrainbaseLabs) -> None:
        with client.api.team.with_streaming_response.retrieve() as response:
    ...
    def test_method_register_phone_number(self, client: BrainbaseLabs) -> None:
        team = client.api.team.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        )
        assert_matches_type(TeamRegisterPhoneNumberResponse, team, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_register_phone_number(self, client: BrainbaseLabs) -> None:
        response = client.api.team.with_raw_response.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        )
    ...
    def test_streaming_response_register_phone_number(self, client: BrainbaseLabs) -> None:
        with client.api.team.with_streaming_response.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        ) as response:
            assert not response.is_closed
...
class TestAsyncTeam:
    ...
    async def test_method_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        team = await async_client.api.team.retrieve()
        assert_matches_type(TeamRetrieveResponse, team, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.team.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.team.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_register_phone_number(self, async_client: AsyncBrainbaseLabs) -> None:
        team = await async_client.api.team.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        )
        assert_matches_type(TeamRegisterPhoneNumberResponse, team, path=["response"])
    ...
    async def test_raw_response_register_phone_number(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.team.with_raw_response.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        )
    ...
    async def test_streaming_response_register_phone_number(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.team.with_streaming_response.register_phone_number(
            integration_id="integrationId",
            phone_number="phoneNumber",
        ) as response:
            assert not response.is_closed

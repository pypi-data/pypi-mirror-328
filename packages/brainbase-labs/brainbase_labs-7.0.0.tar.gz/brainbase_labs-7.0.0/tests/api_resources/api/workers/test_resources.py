...
class TestResources:
    ...
    def test_method_retrieve(self, client: BrainbaseLabs) -> None:
        resource = client.api.workers.resources.retrieve(
    ...
    def test_raw_response_retrieve(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.resources.with_raw_response.retrieve(
            resource_id="resourceId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_retrieve(self, client: BrainbaseLabs) -> None:
        with client.api.workers.resources.with_streaming_response.retrieve(
            resource_id="resourceId",
            worker_id="workerId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.resources.with_raw_response.retrieve(
                resource_id="resourceId",
                worker_id="",
            )
    ...
    def test_method_delete(self, client: BrainbaseLabs) -> None:
        resource = client.api.workers.resources.delete(
            resource_id="resourceId",
            worker_id="workerId",
        )
    ...
    def test_raw_response_delete(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.resources.with_raw_response.delete(
            resource_id="resourceId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_delete(self, client: BrainbaseLabs) -> None:
        with client.api.workers.resources.with_streaming_response.delete(
            resource_id="resourceId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.resources.with_raw_response.delete(
                resource_id="resourceId",
                worker_id="",
            )
...
class TestAsyncResources:
    ...
    async def test_method_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        resource = await async_client.api.workers.resources.retrieve(
            resource_id="resourceId",
            worker_id="workerId",
        )
        assert_matches_type(RagResource, resource, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.resources.with_raw_response.retrieve(
            resource_id="resourceId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.resources.with_streaming_response.retrieve(
            resource_id="resourceId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.resources.with_raw_response.retrieve(
                resource_id="resourceId",
                worker_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        resource = await async_client.api.workers.resources.delete(
            resource_id="resourceId",
            worker_id="workerId",
        )
        assert resource is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.resources.with_raw_response.delete(
            resource_id="resourceId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.resources.with_streaming_response.delete(
            resource_id="resourceId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.resources.with_raw_response.delete(
                resource_id="resourceId",
                worker_id="",
            )

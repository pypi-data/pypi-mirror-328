...
class TestFile:
    ...
    def test_method_create(self, client: BrainbaseLabs) -> None:
        file = client.api.workers.resources.file.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    def test_raw_response_create(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.resources.file.with_raw_response.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    def test_streaming_response_create(self, client: BrainbaseLabs) -> None:
        with client.api.workers.resources.file.with_streaming_response.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    def test_path_params_create(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.resources.file.with_raw_response.create(
                worker_id="",
                file_name="fileName",
                mime_type="mimeType",
                name="name",
    ...
    def test_method_list(self, client: BrainbaseLabs) -> None:
        file = client.api.workers.resources.file.list(
            "workerId",
        )
    ...
    def test_raw_response_list(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.resources.file.with_raw_response.list(
            "workerId",
        )
    ...
    def test_streaming_response_list(self, client: BrainbaseLabs) -> None:
        with client.api.workers.resources.file.with_streaming_response.list(
            "workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.resources.file.with_raw_response.list(
                "",
            )
...
class TestAsyncFile:
    ...
    async def test_method_create(self, async_client: AsyncBrainbaseLabs) -> None:
        file = await async_client.api.workers.resources.file.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    async def test_raw_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.resources.file.with_raw_response.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    async def test_streaming_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.resources.file.with_streaming_response.create(
            worker_id="workerId",
            file_name="fileName",
            mime_type="mimeType",
            name="name",
    ...
    async def test_path_params_create(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.resources.file.with_raw_response.create(
                worker_id="",
                file_name="fileName",
                mime_type="mimeType",
                name="name",
    ...
    async def test_method_list(self, async_client: AsyncBrainbaseLabs) -> None:
        file = await async_client.api.workers.resources.file.list(
            "workerId",
        )
        assert_matches_type(FileListResponse, file, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.resources.file.with_raw_response.list(
            "workerId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.resources.file.with_streaming_response.list(
            "workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.resources.file.with_raw_response.list(
                "",
            )

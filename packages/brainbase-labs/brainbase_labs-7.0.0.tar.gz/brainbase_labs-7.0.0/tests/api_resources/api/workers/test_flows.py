...
class TestFlows:
    ...
    def test_method_create(self, client: BrainbaseLabs) -> None:
        flow = client.api.workers.flows.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    def test_raw_response_create(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.flows.with_raw_response.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    def test_streaming_response_create(self, client: BrainbaseLabs) -> None:
        with client.api.workers.flows.with_streaming_response.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    def test_path_params_create(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.flows.with_raw_response.create(
                worker_id="",
                code="code",
                label="label",
                name="name",
    ...
    def test_method_retrieve(self, client: BrainbaseLabs) -> None:
        flow = client.api.workers.flows.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        )
        assert_matches_type(Flows, flow, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.flows.with_raw_response.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_retrieve(self, client: BrainbaseLabs) -> None:
        with client.api.workers.flows.with_streaming_response.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.flows.with_raw_response.retrieve(
                flow_id="flowId",
                worker_id="",
            )
    ...
    def test_method_update(self, client: BrainbaseLabs) -> None:
        flow = client.api.workers.flows.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    def test_raw_response_update(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.flows.with_raw_response.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    def test_streaming_response_update(self, client: BrainbaseLabs) -> None:
        with client.api.workers.flows.with_streaming_response.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    def test_path_params_update(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.flows.with_raw_response.update(
                flow_id="flowId",
                worker_id="",
                code="code",
                label="label",
    ...
    def test_method_list(self, client: BrainbaseLabs) -> None:
        flow = client.api.workers.flows.list(
            "workerId",
        )
    ...
    def test_raw_response_list(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.flows.with_raw_response.list(
            "workerId",
        )
    ...
    def test_streaming_response_list(self, client: BrainbaseLabs) -> None:
        with client.api.workers.flows.with_streaming_response.list(
            "workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.flows.with_raw_response.list(
                "",
            )
    ...
    def test_method_delete(self, client: BrainbaseLabs) -> None:
        flow = client.api.workers.flows.delete(
            flow_id="flowId",
            worker_id="workerId",
        )
        assert flow is None
    ...
    def test_raw_response_delete(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.flows.with_raw_response.delete(
            flow_id="flowId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_delete(self, client: BrainbaseLabs) -> None:
        with client.api.workers.flows.with_streaming_response.delete(
            flow_id="flowId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.flows.with_raw_response.delete(
                flow_id="flowId",
                worker_id="",
            )
...
class TestAsyncFlows:
    ...
    async def test_method_create(self, async_client: AsyncBrainbaseLabs) -> None:
        flow = await async_client.api.workers.flows.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    async def test_raw_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.flows.with_raw_response.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    async def test_streaming_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.flows.with_streaming_response.create(
            worker_id="workerId",
            code="code",
            label="label",
            name="name",
    ...
    async def test_path_params_create(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.flows.with_raw_response.create(
                worker_id="",
                code="code",
                label="label",
                name="name",
    ...
    async def test_method_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        flow = await async_client.api.workers.flows.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        )
        assert_matches_type(Flows, flow, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.flows.with_raw_response.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.flows.with_streaming_response.retrieve(
            flow_id="flowId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.flows.with_raw_response.retrieve(
                flow_id="flowId",
                worker_id="",
            )
    ...
    async def test_method_update(self, async_client: AsyncBrainbaseLabs) -> None:
        flow = await async_client.api.workers.flows.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    async def test_raw_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.flows.with_raw_response.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    async def test_streaming_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.flows.with_streaming_response.update(
            flow_id="flowId",
            worker_id="workerId",
            code="code",
            label="label",
    ...
    async def test_path_params_update(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.flows.with_raw_response.update(
                flow_id="flowId",
                worker_id="",
                code="code",
                label="label",
    ...
    async def test_method_list(self, async_client: AsyncBrainbaseLabs) -> None:
        flow = await async_client.api.workers.flows.list(
            "workerId",
        )
        assert_matches_type(FlowListResponse, flow, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.flows.with_raw_response.list(
            "workerId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.flows.with_streaming_response.list(
            "workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.flows.with_raw_response.list(
                "",
            )
    ...
    async def test_method_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        flow = await async_client.api.workers.flows.delete(
            flow_id="flowId",
            worker_id="workerId",
        )
        assert flow is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.flows.with_raw_response.delete(
            flow_id="flowId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.flows.with_streaming_response.delete(
            flow_id="flowId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.flows.with_raw_response.delete(
                flow_id="flowId",
                worker_id="",
            )

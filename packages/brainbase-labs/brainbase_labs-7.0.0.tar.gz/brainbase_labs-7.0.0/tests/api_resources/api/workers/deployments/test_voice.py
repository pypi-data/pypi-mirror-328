...
from brainbase_labs.types.api.workers.deployments import (
    VoiceDeployment,
    VoiceListResponse,
)
...
class TestVoice:
    ...
    def test_method_create(self, client: BrainbaseLabs) -> None:
        voice = client.api.workers.deployments.voice.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    def test_raw_response_create(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.deployments.voice.with_raw_response.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    def test_streaming_response_create(self, client: BrainbaseLabs) -> None:
        with client.api.workers.deployments.voice.with_streaming_response.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    def test_path_params_create(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.deployments.voice.with_raw_response.create(
                worker_id="",
                config="config",
                flow_id="flowId",
                name="name",
    ...
    def test_method_retrieve(self, client: BrainbaseLabs) -> None:
        voice = client.api.workers.deployments.voice.retrieve(
    ...
    def test_raw_response_retrieve(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.deployments.voice.with_raw_response.retrieve(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_retrieve(self, client: BrainbaseLabs) -> None:
        with client.api.workers.deployments.voice.with_streaming_response.retrieve(
            deployment_id="deploymentId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.deployments.voice.with_raw_response.retrieve(
                deployment_id="deploymentId",
                worker_id="",
            )
    ...
    def test_method_update(self, client: BrainbaseLabs) -> None:
        voice = client.api.workers.deployments.voice.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    def test_raw_response_update(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.deployments.voice.with_raw_response.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    def test_streaming_response_update(self, client: BrainbaseLabs) -> None:
        with client.api.workers.deployments.voice.with_streaming_response.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    def test_path_params_update(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.deployments.voice.with_raw_response.update(
                deployment_id="deploymentId",
                worker_id="",
                config="config",
                flow_id="flowId",
    ...
    def test_method_list(self, client: BrainbaseLabs) -> None:
        voice = client.api.workers.deployments.voice.list(
            "workerId",
        )
    ...
    def test_path_params_list(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.deployments.voice.with_raw_response.list(
                "",
            )
    ...
    def test_method_delete(self, client: BrainbaseLabs) -> None:
        voice = client.api.workers.deployments.voice.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
    ...
    def test_raw_response_delete(self, client: BrainbaseLabs) -> None:
        response = client.api.workers.deployments.voice.with_raw_response.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_delete(self, client: BrainbaseLabs) -> None:
        with client.api.workers.deployments.voice.with_streaming_response.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.api.workers.deployments.voice.with_raw_response.delete(
                deployment_id="deploymentId",
                worker_id="",
            )
...
class TestAsyncVoice:
    ...
    async def test_method_create(self, async_client: AsyncBrainbaseLabs) -> None:
        voice = await async_client.api.workers.deployments.voice.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    async def test_raw_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.deployments.voice.with_raw_response.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    async def test_streaming_response_create(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.deployments.voice.with_streaming_response.create(
            worker_id="workerId",
            config="config",
            flow_id="flowId",
            name="name",
    ...
    async def test_path_params_create(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.deployments.voice.with_raw_response.create(
                worker_id="",
                config="config",
                flow_id="flowId",
                name="name",
    ...
    async def test_method_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        voice = await async_client.api.workers.deployments.voice.retrieve(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
        assert_matches_type(VoiceDeployment, voice, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.deployments.voice.with_raw_response.retrieve(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.deployments.voice.with_streaming_response.retrieve(
            deployment_id="deploymentId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.deployments.voice.with_raw_response.retrieve(
                deployment_id="deploymentId",
                worker_id="",
            )
    ...
    async def test_method_update(self, async_client: AsyncBrainbaseLabs) -> None:
        voice = await async_client.api.workers.deployments.voice.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    async def test_raw_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.deployments.voice.with_raw_response.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    async def test_streaming_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.deployments.voice.with_streaming_response.update(
            deployment_id="deploymentId",
            worker_id="workerId",
            config="config",
            flow_id="flowId",
    ...
    async def test_path_params_update(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.deployments.voice.with_raw_response.update(
                deployment_id="deploymentId",
                worker_id="",
                config="config",
                flow_id="flowId",
    ...
    async def test_method_list(self, async_client: AsyncBrainbaseLabs) -> None:
        voice = await async_client.api.workers.deployments.voice.list(
            "workerId",
        )
        assert_matches_type(VoiceListResponse, voice, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.deployments.voice.with_raw_response.list(
            "workerId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.deployments.voice.with_streaming_response.list(
            "workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.deployments.voice.with_raw_response.list(
                "",
            )
    ...
    async def test_method_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        voice = await async_client.api.workers.deployments.voice.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
        assert voice is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.api.workers.deployments.voice.with_raw_response.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.api.workers.deployments.voice.with_streaming_response.delete(
            deployment_id="deploymentId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.api.workers.deployments.voice.with_raw_response.delete(
                deployment_id="deploymentId",
                worker_id="",
            )

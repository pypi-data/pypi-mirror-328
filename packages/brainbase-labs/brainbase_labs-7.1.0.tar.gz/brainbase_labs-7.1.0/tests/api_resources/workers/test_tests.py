...
class TestTests:
    ...
    def test_method_get_runs(self, client: BrainbaseLabs) -> None:
        test = client.workers.tests.get_runs(
            test_id="testId",
            worker_id="workerId",
        )
        assert test is None
    ...
    def test_raw_response_get_runs(self, client: BrainbaseLabs) -> None:
        response = client.workers.tests.with_raw_response.get_runs(
            test_id="testId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_get_runs(self, client: BrainbaseLabs) -> None:
        with client.workers.tests.with_streaming_response.get_runs(
            test_id="testId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_runs(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.workers.tests.with_raw_response.get_runs(
                test_id="testId",
                worker_id="",
            )
...
class TestAsyncTests:
    ...
    async def test_method_get_runs(self, async_client: AsyncBrainbaseLabs) -> None:
        test = await async_client.workers.tests.get_runs(
            test_id="testId",
            worker_id="workerId",
        )
        assert test is None
    ...
    async def test_raw_response_get_runs(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.workers.tests.with_raw_response.get_runs(
            test_id="testId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_get_runs(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.workers.tests.with_streaming_response.get_runs(
            test_id="testId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_runs(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.workers.tests.with_raw_response.get_runs(
                test_id="testId",
                worker_id="",
            )

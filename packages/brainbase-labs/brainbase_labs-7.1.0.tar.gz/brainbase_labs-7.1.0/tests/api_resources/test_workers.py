...
class TestWorkers:
    ...
    def test_method_create_twilio_integration(self, client: BrainbaseLabs) -> None:
        worker = client.workers.create_twilio_integration(
            worker_id="workerId",
    ...
    def test_raw_response_create_twilio_integration(self, client: BrainbaseLabs) -> None:
        response = client.workers.with_raw_response.create_twilio_integration(
            worker_id="workerId",
            account_sid="accountSid",
            auth_token="authToken",
        )
    ...
    def test_streaming_response_create_twilio_integration(self, client: BrainbaseLabs) -> None:
        with client.workers.with_streaming_response.create_twilio_integration(
            worker_id="workerId",
            account_sid="accountSid",
            auth_token="authToken",
        ) as response:
    ...
    def test_path_params_create_twilio_integration(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.workers.with_raw_response.create_twilio_integration(
                worker_id="",
                account_sid="accountSid",
                auth_token="authToken",
            )
...
class TestAsyncWorkers:
    ...
    async def test_method_create_twilio_integration(self, async_client: AsyncBrainbaseLabs) -> None:
        worker = await async_client.workers.create_twilio_integration(
            worker_id="workerId",
            account_sid="accountSid",
            auth_token="authToken",
        )
    ...
    async def test_raw_response_create_twilio_integration(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.workers.with_raw_response.create_twilio_integration(
            worker_id="workerId",
            account_sid="accountSid",
            auth_token="authToken",
        )
    ...
    async def test_streaming_response_create_twilio_integration(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.workers.with_streaming_response.create_twilio_integration(
            worker_id="workerId",
            account_sid="accountSid",
            auth_token="authToken",
        ) as response:
    ...
    async def test_path_params_create_twilio_integration(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.workers.with_raw_response.create_twilio_integration(
                worker_id="",
                account_sid="accountSid",
                auth_token="authToken",
            )

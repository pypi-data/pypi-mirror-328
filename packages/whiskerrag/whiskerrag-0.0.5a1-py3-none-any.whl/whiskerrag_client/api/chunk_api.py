...
class ChunkApi:
    ...
    def get_chunk_list(
        ...
        :param page_params_chunk: (required)
        :type page_params_chunk: PageParamsChunk
        :param authorization:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseModelPageResponseChunk",
            "404": None,
    ...
    def get_chunk_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseModelPageResponseChunk]:
        """Get Chunk List
    ...
    def _get_chunk_list_serialize(
        ...
        if page_params_chunk is not None:
            _body_params = page_params_chunk

...
class RetrievalBySpaceRequest(BaseModel):
    """
    ...
    space_id_list: List[StrictStr] = Field(description="space id list")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrievalBySpaceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrievalBySpaceRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "space_id_list": obj.get("space_id_list"),
            }
        )
        return _obj

...
class KnowledgeApi:
    ...
    def add_knowledge(
        ...
        :param knowledge_create: (required)
        :type knowledge_create: List[KnowledgeCreate]
        :param authorization:
    ...
    def _add_knowledge_serialize(
        ...
        if knowledge_create is not None:
            _body_params = knowledge_create
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/knowledge/add",
    ...
    def _get_knowledge_by_id_serialize(
        ...
        if knowledge_id is not None:
            ...
            _query_params.append(("knowledge_id", knowledge_id))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/knowledge/detail",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_knowledge_list(
        ...
        :param page_params_knowledge: (required)
        :type page_params_knowledge: PageParamsKnowledge
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseModelPageResponseKnowledge",
            "404": None,
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
    ...
    def get_knowledge_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseModelPageResponseKnowledge]:
        """Get Knowledge List
    ...
    def _get_knowledge_list_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if page_params_knowledge is not None:
            _body_params = page_params_knowledge
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/knowledge/list",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

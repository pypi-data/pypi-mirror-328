...
from whiskerrag_client.api_response import ApiResponse, T as ApiResponseT
import whiskerrag_client.models
from whiskerrag_client import rest
from whiskerrag_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(whiskerrag_client.models, klass)

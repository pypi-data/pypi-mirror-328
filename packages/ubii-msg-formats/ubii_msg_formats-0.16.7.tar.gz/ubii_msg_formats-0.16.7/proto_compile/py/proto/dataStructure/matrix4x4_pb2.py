...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'proto.dataStructure.matrix4x4_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _MATRIX4X4._serialized_start=60
  _MATRIX4X4._serialized_end=279

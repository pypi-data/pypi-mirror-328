...
class Asset:
    ...
    **EXAMPLE:**
       ...
       .. code-block:: python
           ...
           # Imports 
           from virtualitics_sdk.assets.asset import Asset, AssetType
           . . .
           # Example usage
    ...
    @staticmethod
    def from_bytes(payload, encrypted: bool, serialization_method: AssetPersistenceMethod) -> Asset: ...
    @classmethod
    def from_pickle(cls, pickle: Incomplete | None = None, **kwargs) -> Asset: ...

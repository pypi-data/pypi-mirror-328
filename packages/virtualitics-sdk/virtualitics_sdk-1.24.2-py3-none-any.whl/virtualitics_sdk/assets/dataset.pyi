...
class Dataset(Asset):
    ...
    **EXAMPLE:**
       ...
       .. code-block:: python
           ...
           # Imports 
           from virtualitics_sdk.assets.dataset import Dataset
           . . .
           # Example usage 
    ...
    def get_categorical_names(self, predict_cols: bool = False) -> list[str]:
        ...
        """
    @classmethod
    def from_csv(cls, csv: BytesIO, **kwargs) -> Dataset:
        """Constructs a dataset object from a csv in a bytes format. Any additional keyword arguments are passed directly to
        the Dataset constructor.

        :param csv: The csv file to turn into a dataset.
        :return: The Dataset object containing the csv data.
        """
    @classmethod
    def from_json(cls, json: BytesIO, **kwargs) -> Dataset:
        """Constructs a dataset object from a json in a bytes format. Any additional keyword arguments are passed directly to
        the Dataset constructor.

        :param json: The json file to turn into a dataset.
        :return: The Dataset object containing the json data.
        """
    @classmethod
    def from_excel(cls, excel: BytesIO, sheet_name: int | str = 0, **kwargs) -> Dataset:
        """Constructs a dataset object from a excel in a bytes format. Any additional keyword arguments are passed directly to
        the Dataset constructor.

        :param excel: The excel file to turn into a dataset.
        :param sheet_name: The sheet to read into the dataset. Integers are interpreted as the index of the sheet, while strings
                           are interpreted as sheet names. Defaults to 0.
        :return: The Dataset object containing the excel data.
        """

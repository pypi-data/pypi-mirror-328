...
class SimulateLog:
    ...
    model_type: ModelType = field(default=None, metadata={"description": "模型类型"})
    ...
    pre_processing: Optional[PrimaryParams] = field(init=False, default=None, metadata={'description': '预处理信息'})
    ...
    def simulate_params(self) -> dict[str, Any]:
        ...
        params_map.update(self.pre_processing.to_block())
    ...
    def from_block(cls, block_lines):
        ...
        log.pre_processing = PrimaryParams.from_block(pre_processing_block)

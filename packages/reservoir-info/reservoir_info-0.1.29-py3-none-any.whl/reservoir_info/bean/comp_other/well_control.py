...
from test.model.perforation_type import PerforationType
from test.model.well_control_type import WellControlType
from test.model.well_group_model import WellGroupModel
from test.model.well_tatio_limit_type import WellRatioLimitType
...
class WellControl:
    ...
    def from_text(cls, text: str):
        ...
        control_type = WellControlType.get_by_code(parts[2])

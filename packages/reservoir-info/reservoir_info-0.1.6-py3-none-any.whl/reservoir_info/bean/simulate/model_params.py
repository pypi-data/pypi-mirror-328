...
class ModelParams:
    ...
    tops: Optional[Tops] = field(init=False, default=None, metadata={'description': '顶面深度'})
    dxv: Optional[DimensionValue] = field(init=False, default=None, metadata={'description': 'X方向长度'})
    dyv: Optional[DimensionValue] = field(init=False, default=None, metadata={'description': 'Y方向长度'})
    dzv: Optional[DimensionValue] = field(init=False, default=None, metadata={'description': 'Z方向长度'})

    ...
    'awsaccounts': [
        {
            ...
            "owner": "system|aws",
            "phone_number": None,
            "shares": [{'invite': None,'permissions': ['VIEWER'],'type': 'heaobject.root.ShareImpl','type_display_name': 'Share','user': 'system|none'}],
            "source": AWS,
            "source_detail": AWS,
...
AWSAccountTestCase = \
    microservicetestcase.get_test_case_cls_default(
        ...
        get_all_actions=[
            ...
            expectedvalues.Action(
                name='heaserver-accounts-awsccount-get-search',
                url='http://localhost:8080/awsaccounts/{id}/search',
                rel=['hea-search', 'hea-context-menu']),
        ],
        get_actions=[
            expectedvalues.Action(
                name='heaserver-accounts-awsaccount-get-open-choices',

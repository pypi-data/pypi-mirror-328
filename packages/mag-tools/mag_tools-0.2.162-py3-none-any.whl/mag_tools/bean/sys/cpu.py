...
class Cpu:
    ...
    def __get_from_windows(cls):
        ...
        return cls(
            ...
            efficiency_cores=(cpu_info.ThreadCount - cpu_info.NumberOfCores) if cpu_info.ThreadCount and cpu_info.NumberOfCores else None,
    ...
    def __get_from_linux(cls):
        ...
        try:
            ...
            return cls(
                ...
                efficiency_cores=(info.get("threads") - info.get("cores")) if info.get("threads") is not None and info.get("cores") is not None else None,

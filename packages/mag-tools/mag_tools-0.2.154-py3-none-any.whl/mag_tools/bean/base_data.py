...
class BaseData:
    ...
    _data_formats: Dict[str, DataFormat] = field(default_factory=dict, metadata={"description": "数据格式"})
    ...
    @property
    def variables_map(self) -> Dict[str, Any]:
        return {
...
if __name__ == '__main__':
    ...
    map_ = data.variables_map
    for k_, v_ in map_.items():
        print(f'{k_}: {v_}')
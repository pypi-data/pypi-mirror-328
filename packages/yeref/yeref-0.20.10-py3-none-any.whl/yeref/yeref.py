                                    ...
                                    if provider_name == 'prodia':
                                        ...
                                        async with aiohttp.ClientSession() as session:
                                            ...
                                            data.add_field('params', json.dumps({
                                                "type": "GENERATE",
                                                "numImages": str(item['count']),  # Сделал строкой
                                                "width": str(1024),  # Сделал строкой
                                                "height": str(1024),  # Сделал строкой
                                                "generateParams": {"query": item['prompt']}
                                            }), content_type='application/json')

                                            async with session.post(url + 'text2image/run', headers=headers,

...
async def pst_gen_ent2(bot, chat_id, lc, lz, POST_TYPE, POST_MEDIA, ENT_TID, PROJECT_TYPE, ENT_USERNAME, ENT_TITLE, MEDIA_D, EXTRA_D, BASE_D, prompt='', ENT_TOKEN_=None):
    ...
    try:
        ...
        if POST_TYPE == 'text':
            ...
            POST_MEDIA.append({"file_id": POST_FID, "file_id_note": POST_FIDNOTE, "file_type": POST_TYPE, "file_name": POST_FILENAME, "file_link": POST_LNK, "file_link2": POST_LNK})

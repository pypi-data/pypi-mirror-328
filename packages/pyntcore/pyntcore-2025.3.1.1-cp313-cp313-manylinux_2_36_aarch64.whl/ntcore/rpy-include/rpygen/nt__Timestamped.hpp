...
struct bind_nt__Timestamped {
  ...
  void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
    ...
    cls_Timestamped
      ...
      .def_readwrite("time", &nt::Timestamped<T>::time, py::doc("Time in local time base."))
      .def_readwrite("serverTime", &nt::Timestamped<T>::serverTime, py::doc("Time in server time base.  May be 0 or 1 for locally set values."))
      .def_readwrite("value", &nt::Timestamped<T>::value, py::doc("Value."))

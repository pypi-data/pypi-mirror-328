    ...
    def do_handshake(self):
        ...
        if self.key1 is not None:
            ...
            headers = [
                ("Upgrade", "Web3Socket"),
                ("Connection", "Upgrade"),
                ("Sec-Web3Socket-Origin", self.origin),
                ("Sec-Web3Socket-Protocol", self.protocol),
                ("Sec-Web3Socket-Location", "ws://" + self.host + self.path_info),
            ]
            self._send_reply("101 Web3 Socket Protocol Handshake", headers)
            ...
            headers = [
                ("Upgrade", "Web3Socket"),
                ("Connection", "Upgrade"),
                ("Web3Socket-Origin", self.web3socket.origin),
                ("Web3Socket-Protocol", self.web3socket.protocol),
                ("Web3Socket-Location", "ws://" + self.host + self.path_info),
            ]
            self._send_reply("101 Web3 Socket Protocol Handshake", headers)

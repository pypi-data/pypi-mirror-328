...
class ProjectStructureGenerator:
    ...
    def write_to_config_file(configs, full_config_file_path):
        ...
        config_data = {
                ...
                "aiflow-task-dependencies-details": {"task-auto-dependencies":{"trigger_order": "parallel"}},
                "aiflow-dag-details": {"dag_id": "pyspark_template","dag_description": "Employee data ingestion project"}

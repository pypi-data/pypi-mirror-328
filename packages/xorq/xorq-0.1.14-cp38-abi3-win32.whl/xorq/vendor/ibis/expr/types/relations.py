...
from xorq.vendor.ibis.common.selectors import Expandable, Selector
from xorq.vendor.ibis.expr.rewrites import DerefMap
from xorq.vendor.ibis.expr.types.core import Expr, _FixedTextJupyterMixin
from xorq.vendor.ibis.expr.types.generic import Value, literal
from xorq.vendor.ibis.expr.types.temporal import TimestampColumn
...
if TYPE_CHECKING:
    ...
    from xorq.vendor.ibis.expr.types.temporal_windows import WindowedTable
...
class Table(Expr, _FixedTextJupyterMixin):
    ...
    def __dataframe__(self, nan_as_null: bool = False, allow_copy: bool = True):
        from xorq.vendor.ibis.expr.types.dataframe_interchange import IbisDataFrame
    ...
    def __pyarrow_result__(
        ...
        *,
        ...
        if data_mapper is None:
            from xorq.vendor.ibis.formats.pyarrow import PyArrowData as data_mapper
    ...
    def __pandas_result__(
        ...
        *,
        ...
        if data_mapper is None:
            from xorq.vendor.ibis.formats.pandas import PandasData as data_mapper
    ...
    def __polars_result__(self, df: pl.DataFrame) -> Any:
        from xorq.vendor.ibis.formats.polars import PolarsData
    ...
    def __getitem__(self, what: str | int | slice | Sequence[str | int]):
        ...
        │ Adelie  │ Torgersen │           40.3 │          18.0 │             195.0 │ … │
        │ Adelie  │ Torgersen │           NULL │          NULL │              NULL │ … │
        │ Adelie  │ Torgersen │           36.7 │          19.3 │              93.0 │ … │
        └─────────┴───────────┴────────────────┴───────────────┴───────────────────┴───┘
        """
        from xorq.vendor.ibis.expr.types.logical import BooleanValue
    ...
    def aggregate(
        ...
        **kwargs: ir.Value,
        ...
        └────────┴────────────┴──────────┘
        """
        from xorq.vendor.ibis.common.patterns import Contains, In
        from xorq.vendor.ibis.expr.rewrites import p
    ...
    def distinct(
        ...
        *,
        ...
        if keep is None:
            having = lambda t: t.count() == 1  # noqa: E731
            method = "first"
    ...
    def sample(
        ...
        *,
        ...
        >>> t.sample(0.5, seed=1234) # doctest: +SKIP
        ┏━━━━━━━┳━━━━━━━━┓
        ┃ x     ┃ y      ┃
        ┡━━━━━━━╇━━━━━━━━┩
        │ int64 │ string │
    ...
    def order_by(
        ...
        *by: str
        ...
        if not keys:
            raise com.XorqError("At least one sort key must be provided")
    ...
    def _assemble_set_op(
        ...
        This exists to work around an issue in sqlglot where codegen blows the
    ...
    def select(
        ...
        **named_exprs: ir.Value | str,
        ...
        └────────────────┴───────────────┴───────────────────┴─────────────┘
        """
        from xorq.vendor.ibis.expr.rewrites import rewrite_project_input
    ...
    def drop(self, *fields: str | Selector) -> Table:
        ...
        ├───────────┼────────────────┼───────────────┼───────────────────┼───┤
        │ Torgersen │           39.1 │          18.7 │             181.0 │ … │
        │ Torgersen │           39.5 │          17.4 │             186.0 │ … │
        │ Torgersen │           40.3 │          18.0 │             195.0 │ … │
        │ Torgersen │           NULL │          NULL │              NULL │ … │
        │ Torgersen │           36.7 │          19.3 │             193.0 │ … │
        └───────────┴────────────────┴───────────────┴───────────────────┴───┘
    ...
    def filter(
        ...
        *predicates: ir.BooleanValue | Sequence[ir.BooleanValue] | IfAnyAll,
        ...
        └────────┴───────────┘
        """
        from xorq.vendor.ibis.expr.rewrites import (
            flatten_predicates,
        ...
        if not preds:
            raise com.XorqInputError("You must pass at least one predicate to filter")
    ...
    def nunique(self, where: ir.BooleanValue | None = None) -> ir.IntegerScalar:
        ...
        │ bar    │
        └────────┘
        >>> t.nunique() # doctest: +SKIP
        ┌───┐
        │ 2 │
        └───┘
        >>> t.nunique(t.a != "foo") # doctest: +SKIP
        ┌───┐
        │ 1 │
        └───┘
        """
    ...
    def info(self) -> Table:
        ...
        │ flipper_length_mm │ float64 │ True     │     2 │       342 │  0.005814 │ … │
        │ body_mass_g       │ float64 │ True     │     2 │       342 │  0.005814 │ … │
        │ sex               │ string  │ True     │    11 │       333 │  0.031977 │ … │
        │ year              │ int64   │ True     │     0 │       344 │  0.000000 │ … │
        └───────────────────┴─────────┴──────────┴───────┴───────────┴───────────┴───┘
        """
        from xorq.vendor.ibis import literal as lit
    ...
    def describe(
        ...
        └───────────────────┴───────┴─────────┴───────┴───────┴────────┴────────┴───┘
        >>> p.select(s.of_type("numeric")).describe() # doctest: +SKIP
        ┏━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━━┳━━━┓
        ...
        └───────────────────┴───────┴─────────┴───────┴───────┴────────┴───┘
        >>> p.select(s.of_type("string")).describe() # doctest: +SKIP
        ┏━━━━━━━━━┳━━━━━━━┳━━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━━┳━━━━━━━━┓
        ┃ name    ┃ pos   ┃ type   ┃ count ┃ nulls ┃ unique ┃ mode   ┃
        ┡━━━━━━━━━╇━━━━━━━╇━━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━━╇━━━━━━━━┩
        │ string  │ int16 │ string │ int64 │ int64 │ int64  │ string │
    ...
    def join(
        ...
        *,
        ...
        └─────────┴───────────────────┴───────────────┴───────────────────┘
        """
        from xorq.vendor.ibis.expr.types.joins import Join
    ...
    def pivot_longer(
        ...
        *,
        ...
        if not pivot_cols:
            ...
            raise com.XorqInputError("Selector returned no columns to pivot on")
    ...
    def pivot_wider(
        ...
        *,
        ...
        """
        import xorq.vendor.ibis.selectors as s
        from xorq.vendor.ibis.expr.rewrites import _, p, x
    ...
    def relocate(
        ...
        **kwargs: str,
        ...
        if before is not None and after is not None:
            raise com.XorqInputError("Cannot specify both `before` and `after`")

...
class CCD_FinalizerIndex(BaseModel):
    """A unique identifier for a finalizer in the consensus protocol.

    GRPC documentation: [concordium.v2.FinalizerIndex](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.FinalizerIndex)

    Attributes:
        value (Optional[int]): The unique index value of the finalizer.
    """

    value: Optional[int] = None


class CCD_QuorumSignature(BaseModel):
    """A quorum signature aggregating multiple signatures into a single aggregated signature.

    GRPC documentation: [concordium.v2.QuorumSignature](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.QuorumSignature)

    Attributes:
        value (bytes): The byte representation of the aggregated quorum signature.
    """

    value: bytes


class CCD_TimeoutSignature(BaseModel):
    """A signature on a timeout message.

    GRPC documentation: [concordium.v2.TimeoutSignature](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.TimeoutSignature)

    Attributes:
        value (bytes): The byte representation of the timeout signature.
    """

    value: bytes


class CCD_SuccessorProof(BaseModel):
    """A cryptographic proof showing that one block is a valid successor of another.

    GRPC documentation: [concordium.v2.SuccessorProof](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.SuccessorProof)

    Attributes:
        value (bytes): The byte representation of the successor proof.
    """
...
class CCD_QuorumMessage(BaseModel):
    ...
    Attributes:
        signature (Optional[CCD_QuorumSignature]): The signature of the quorum message.
        block (Optional[CCD_BlockHash]): The hash of the block associated with the quorum message.
        finalizer (Optional[CCD_FinalizerIndex]): The index of the finalizer who created this message.
        round (Optional[CCD_Round]): The round number of consensus.
        epoch (Optional[CCD_Epoch]): The epoch number in consensus.
    """

    signature: Optional[CCD_QuorumSignature] = None
    block: Optional[CCD_BlockHash] = None
    finalizer: Optional[CCD_FinalizerIndex] = None
    round: Optional[CCD_Round] = None
    epoch: Optional[CCD_Epoch] = None
...
class CCD_RawQuorumCertificate(BaseModel):
    ...
    Attributes:
        block (Optional[CCD_BlockHash]): The block hash this certificate certifies.
        round (Optional[CCD_Round]): The round in which the certificate was created.
        epoch (Optional[CCD_Epoch]): The epoch in which the certificate was created.
        aggregate_signature (Optional[CCD_QuorumSignature]): The aggregate signature of all signers.
        signatories (Optional[list[CCD_FinalizerIndex]]): The indices of the finalizers who signed this certificate.
    """

    block: Optional[CCD_BlockHash] = None
    round: Optional[CCD_Round] = None
    epoch: Optional[CCD_Epoch] = None
    aggregate_signature: Optional[CCD_QuorumSignature] = None
    signatories: Optional[list[CCD_FinalizerIndex]] = None


class CCD_BlockSignature(BaseModel):
    """A signature on a block.

    GRPC documentation: [concordium.v2.BlockSignature](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.BlockSignature)

    Attributes:
        value (bytes): The byte representation of the block signature.
    """
...
class CCD_TimeoutMessage(BaseModel):
    ...
    Attributes:
        finalizer (Optional[CCD_FinalizerIndex]): The index of the finalizer who created this message.
        round (Optional[CCD_Round]): The round number this timeout is for.
        epoch (Optional[CCD_Epoch]): The epoch this timeout is for.
        quorum_certificate (Optional[CCD_RawQuorumCertificate]): The highest quorum certificate known to the sender.
        signature (Optional[CCD_TimeoutSignature]): The signature on this timeout message.
        message_signature (Optional[CCD_BlockSignature]): The block signature on this timeout message.
    """

    finalizer: Optional[CCD_FinalizerIndex] = None
    round: Optional[CCD_Round] = None
    epoch: Optional[CCD_Epoch] = None
    quorum_certificate: Optional[CCD_RawQuorumCertificate] = None
    signature: Optional[CCD_TimeoutSignature] = None
    message_signature: Optional[CCD_BlockSignature] = None
...
class CCD_RawFinalizerRound(BaseModel):
    ...
    Attributes:
        round (Optional[CCD_Round]): The round number in the consensus protocol.
        finalizers (Optional[list[CCD_FinalizerIndex]]): The list of finalizer indices who participated in this round.
    """

    round: Optional[CCD_Round] = None
    finalizers: Optional[list[CCD_FinalizerIndex]] = None
...
class CCD_RawTimeoutCertificate(BaseModel):
    ...
    Attributes:
        round (Optional[CCD_Round]): The round associated with the timeout certificate.
        min_epoch (Optional[CCD_Epoch]): The minimum epoch associated with the timeout certificate.
        qc_rounds_first_epoch (Optional[list[CCD_RawFinalizerRound]]): List of finalizer rounds for the first epoch.
        qc_rounds_second_epoch (Optional[list[CCD_RawFinalizerRound]]): List of finalizer rounds for the second epoch.
    """

    round: Optional[CCD_Round] = None
    min_epoch: Optional[CCD_Epoch] = None
    qc_rounds_first_epoch: Optional[list[CCD_RawFinalizerRound]] = None
    qc_rounds_second_epoch: Optional[list[CCD_RawFinalizerRound]] = None
...
class CCD_PersistentRoundStatus(BaseModel):
    ...
    Attributes:
        ...
        last_baked_round (Optional[CCD_Round]): The last round in which this node baked a block.
...
class CCD_RoundTimeout(BaseModel):
    ...
    Attributes:
        timeout_certificate (Optional[CCD_RawTimeoutCertificate]): The certificate indicating that a timeout has occurred.
        quorum_certificate (Optional[CCD_RawQuorumCertificate]): The highest quorum certificate known when the timeout occurred.
    """

    timeout_certificate: Optional[CCD_RawTimeoutCertificate] = None
    quorum_certificate: Optional[CCD_RawQuorumCertificate] = None
...
class CCD_RawFinalizationEntry(BaseModel):
    ...
    Attributes:
        finalized_qc (Optional[CCD_RawQuorumCertificate]): The certificate that proves finalization of a block.
        successor_qc (Optional[CCD_RawQuorumCertificate]): The certificate that proves there is a successor block.
        successor_proof (Optional[CCD_SuccessorProof]): The proof that the successor block is valid.
    """

    finalized_qc: Optional[CCD_RawQuorumCertificate] = None
    successor_qc: Optional[CCD_RawQuorumCertificate] = None
    successor_proof: Optional[CCD_SuccessorProof] = None
...
class CCD_RoundStatus(BaseModel):
    ...
    Attributes:
        current_round (Optional[CCD_Round]): The current round in progress.
        highest_certified_block (Optional[CCD_RawQuorumCertificate]): The highest certified block in the current round.
        previous_round_timeout (Optional[CCD_RoundTimeout]): The timeout of the previous round.
        round_eligible_to_bake (bool): Indicates if the current round is eligible to bake.
        current_epoch (Optional[CCD_Epoch]): The current epoch in progress.
        last_epoch_finalization_entry (Optional[CCD_RawFinalizationEntry]): The finalization entry of the last epoch.
        current_timeout (Optional[CCD_Duration]): The current timeout duration.
    """

    current_round: Optional[CCD_Round] = None
    highest_certified_block: Optional[CCD_RawQuorumCertificate] = None
    previous_round_timeout: Optional[CCD_RoundTimeout] = None
    round_eligible_to_bake: bool
    current_epoch: Optional[CCD_Epoch] = None
    last_epoch_finalization_entry: Optional[CCD_RawFinalizationEntry] = None
    current_timeout: Optional[CCD_Duration] = None
...
class CCD_BlockTableSummary(BaseModel):
    ...
    Attributes:
        dead_block_cache_size (Optional[int]): The size of the dead block cache.
        live_blocks (Optional[list[CCD_BlockHash]]): A list of live block hashes.
    """

    dead_block_cache_size: Optional[int] = None
    live_blocks: Optional[list[CCD_BlockHash]] = None
...
class CCD_BranchBlocks(BaseModel):
    ...
    Attributes:
        blocks_at_branch_height (Optional[list[CCD_BlockHash]]): A list of block hashes at the branch height.
    """

    blocks_at_branch_height: Optional[list[CCD_BlockHash]] = None
...
class CCD_RoundExistingBlock(BaseModel):
    ...
    Attributes:
        round (Optional[CCD_Round]): The round number in which the block exists.
        baker (Optional[CCD_BakerId]): The baker who created this block.
        block (Optional[CCD_BlockHash]): The hash of the block.
    """
...
class CCD_RoundExistingQC(BaseModel):
    ...
    Attributes:
        round (Optional[CCD_Round]): The round number for which the QC exists.
        epoch (Optional[CCD_Epoch]): The epoch in which the QC was created.
    """
...
class CCD_FullBakerInfo(BaseModel):
    ...
    Attributes:
        ...
        election_verify_key (Optional[CCD_BakerElectionVerifyKey]): The election verification key of the baker.
        signature_verify_key (Optional[CCD_BakerSignatureVerifyKey]): The signature verification key of the baker.
        aggregation_verify_key (Optional[CCD_BakerAggregationVerifyKey]): The aggregation verification key of the baker.
        stake (Optional[microCCD]): The stake of the baker in microCCD.
    """

    baker_identity: Optional[CCD_BakerId] = None
    election_verify_key: Optional[CCD_BakerElectionVerifyKey] = None
    signature_verify_key: Optional[CCD_BakerSignatureVerifyKey] = None
    aggregation_verify_key: Optional[CCD_BakerAggregationVerifyKey] = None
    stake: Optional[microCCD] = None


class CCD_FinalizationCommitteeHash(BaseModel):
    """A hash of the finalization committee members and their stakes.

    GRPC documentation: [concordium.v2.FinalizationCommitteeHash](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.FinalizationCommitteeHash)

    Attributes:
        value (bytes): The byte representation of the finalization committee hash.
    """
...
class CCD_BakersAndFinalizers(BaseModel):
    ...
    Attributes:
        bakers (Optional[list[CCD_FullBakerInfo]]): List of all bakers and their stakes and keys.
        finalizers (Optional[list[CCD_BakerId]]): List of baker IDs who are finalizers.
        baker_total_stake (Optional[microCCD]): The total stake of all bakers.
        finalizer_total_stake (Optional[microCCD]): The total stake of all finalizers.
        finalization_committee_hash (Optional[CCD_FinalizationCommitteeHash]): Hash of the finalization committee.
    """

    bakers: Optional[list[CCD_FullBakerInfo]] = None
    finalizers: Optional[list[CCD_BakerId]] = None
    baker_total_stake: Optional[microCCD] = None
    finalizer_total_stake: Optional[microCCD] = None
    finalization_committee_hash: Optional[CCD_FinalizationCommitteeHash] = None
...
class CCD_EpochBakers(BaseModel):
    ...
    Attributes:
        previous_epoch_bakers (Optional[CCD_BakersAndFinalizers]): Bakers and finalizers for the previous epoch.
        ...
        next_payday (Optional[CCD_Epoch]): The next payday epoch.
    """

    previous_epoch_bakers: Optional[CCD_BakersAndFinalizers] = None
    current_epoch_bakers: Optional[CCD_BakersAndFinalizers] = None
    next_epoch_bakers: Optional[CCD_BakersAndFinalizers] = None
    next_payday: Optional[CCD_Epoch] = None
...
class CCD_TimeoutMessages(BaseModel):
    ...
    Attributes:
        first_epoch (Optional[CCD_Epoch]): The first epoch for which we have timeout messages.
        first_epoch_timeouts (Optional[list[CCD_TimeoutMessage]]): Timeout messages from the first epoch.
        second_epoch_timeouts (Optional[list[CCD_TimeoutMessage]]): Timeout messages from the second epoch.
    """

    first_epoch: Optional[CCD_Epoch] = None
    first_epoch_timeouts: Optional[list[CCD_TimeoutMessage]] = None
    second_epoch_timeouts: Optional[list[CCD_TimeoutMessage]] = None
...
class CCD_AggregatedSignatures(BaseModel):
    ...
    Attributes:
        signed_block (Optional[CCD_BlockHash]): The hash of the signed block.
        signature_weight (Optional[microCCD]): The weight of the signature.
        aggregate_signature (Optional[CCD_QuorumSignature]): The aggregate signature.
        signatories (Optional[list[CCD_FinalizerIndex]]): The list of finalizer indices who signed the block.
    """

    signed_block: Optional[CCD_BlockHash] = None
    signature_weight: Optional[microCCD] = None
    aggregate_signature: Optional[CCD_QuorumSignature] = None
    signatories: Optional[list[CCD_FinalizerIndex]] = None
...
class CCD_QuorumMessages(BaseModel):
    ...
    Attributes:
        quorum_messages (Optional[list[CCD_QuorumMessage]]): A list of quorum messages from individual finalizers.
        aggregated_signatures (Optional[list[CCD_AggregatedSignatures]]): A list of aggregated signatures from sets of finalizers.
    """

    quorum_messages: Optional[list[CCD_QuorumMessage]] = None
    aggregated_signatures: Optional[list[CCD_AggregatedSignatures]] = None
...
class CCD_ConsensusDetailedStatus(BaseModel):
    ...
    Attributes:
        genesis_block (Optional[CCD_BlockHash]): The hash of the genesis block.
        persistent_round_status (Optional[CCD_PersistentRoundStatus]): The status of the persistent round.
        round_status (Optional[CCD_RoundStatus]): The status of the current round.
        non_finalized_transaction_count (Optional[int]): The count of non-finalized transactions.
        transaction_table_purge_counter (Optional[int]): The counter for purging the transaction table.
        block_table (Optional[CCD_BlockTableSummary]): Summary of the block table.
        branches (Optional[list[CCD_BranchBlocks]]): List of branch blocks.
        round_existing_blocks (Optional[list[CCD_RoundExistingBlock]]): List of existing blocks in the current round.
        round_existing_qcs (Optional[list[CCD_RoundExistingQC]]): List of existing QCs in the current round.
        genesis_block_height (Optional[int]): The height of the genesis block.
        last_finalized_block (Optional[CCD_BlockHash]): The hash of the last finalized block.
        last_finalized_block_height (Optional[int]): The height of the last finalized block.
        latest_finalization_entry (Optional[CCD_RawFinalizationEntry]): The latest finalization entry.
        epoch_bakers (Optional[CCD_EpochBakers]): The epoch bakers.
    ...
    genesis_block: Optional[CCD_BlockHash] = None
    persistent_round_status: Optional[CCD_PersistentRoundStatus] = None
    round_status: Optional[CCD_RoundStatus] = None
    non_finalized_transaction_count: Optional[int] = None
    transaction_table_purge_counter: Optional[int] = None
    block_table: Optional[CCD_BlockTableSummary] = None
    branches: Optional[list[CCD_BranchBlocks]] = None
    round_existing_blocks: Optional[list[CCD_RoundExistingBlock]] = None
    round_existing_qcs: Optional[list[CCD_RoundExistingQC]] = None
    genesis_block_height: Optional[int] = None
    last_finalized_block: Optional[CCD_BlockHash] = None
    last_finalized_block_height: Optional[int] = None
    latest_finalization_entry: Optional[CCD_RawFinalizationEntry] = None
    epoch_bakers: Optional[CCD_EpochBakers] = None
...
class CCD_AccountPending(BaseModel):
    ...
    Attributes:
        account_index (Optional[CCD_AccountIndex]): The index of the pending account.
        first_timestamp (Optional[CCD_TimeStamp]): The timestamp of when the account was first seen.
    """

    account_index: Optional[CCD_AccountIndex] = None
    first_timestamp: Optional[CCD_TimeStamp] = None

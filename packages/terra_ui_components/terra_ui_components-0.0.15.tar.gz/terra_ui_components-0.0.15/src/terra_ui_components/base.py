...
class TerraBaseWidget(anywidget.AnyWidget):
    ...
    def get_autoloader(cls):
        ...
        terraStyles.href = 'https://cdn.jsdelivr.net/npm/@nasa-terra/components@0.0.10/cdn/themes/horizon.css'
        document.head.appendChild(terraStyles)

        const terraAutoloader = document.createElement('script')
        terraAutoloader.src = "https://cdn.jsdelivr.net/npm/@nasa-terra/components@0.0.10/cdn/terra-ui-components-autoloader.js"

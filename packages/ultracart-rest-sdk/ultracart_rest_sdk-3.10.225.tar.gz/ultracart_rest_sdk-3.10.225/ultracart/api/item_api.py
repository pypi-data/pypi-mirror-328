...
class ItemApi(object):
    ...
    def rest_item_inventory_snapshot_response(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rest_item_inventory_snapshot_response_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_item_inventory_snapshot_response_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def rest_item_inventory_snapshot_response_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rest_item_inventory_snapshot_response" % key
                )
            params[key] = val
        del params['kwargs']

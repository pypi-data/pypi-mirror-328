...
```
cd existing_repo
git remote add origin https://gitlab.au.dk/mbg-exercises/mbg-exercise-client.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.au.dk/mbg-exercises/mbg-exercise-client/-/settings/integrations)

...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3152);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(87978),
    __webpack_require__(75911),
    __webpack_require__(88485),
    __webpack_require__(45076),
  ];
  ...
  __webpack_require__(68215),
  __webpack_require__(30318),
  __webpack_require__(96712),
  __webpack_require__(23095),
  __webpack_require__(39145),
  __webpack_require__(13108),
  
      (__webpack_require__(16284)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(12211)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(53378),
  
      (__webpack_require__(51494)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(54615)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      (__webpack_require__(15326)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(25519)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(62099)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(75345)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(16808)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(82693),
  __webpack_require__(91637),
  __webpack_require__(99270),
  
      (__webpack_require__(33397)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(45189),
  __webpack_require__(18368),
  __webpack_require__(82384),
  
      (__webpack_require__(43259)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(75333),
  __webpack_require__(28914),
  __webpack_require__(41651),
  __webpack_require__(72436),
  __webpack_require__(71838),
  __webpack_require__(76127),
  __webpack_require__(34458),
  __webpack_require__(97936),
  __webpack_require__(21349),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(68082),
  
      (__webpack_require__(13293)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(62065),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(37015),
  __webpack_require__(31806),
  
      (__webpack_require__(59510)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(18046)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(2236)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(77448).NotebookApp);
...
//# sourceMappingURL=8781.93ded0db04e1cace2f46.js.map?v=93ded0db04e1cace2f46
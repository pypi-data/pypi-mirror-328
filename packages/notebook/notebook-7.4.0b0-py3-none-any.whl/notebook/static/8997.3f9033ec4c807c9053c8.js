"use strict";
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[8997],{
...
/* harmony export */ });
/* harmony import */ var _chunk_TMUBEWPD_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37579);
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .vZ.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(() => {
  const config = (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .Rb)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .iE)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .random */ .MX)({ length: 7 });
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(getID, "getID");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(uniqBy, "uniqBy");
var setDirection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(dir2) {
  state.records.direction = dir2;
}, "setDirection");
var setOptions = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(rawOptString) {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("options str", rawOptString);
  rawOptString = rawOptString?.trim();
  rawOptString = rawOptString || "{}";
  try {
    state.records.options = JSON.parse(rawOptString);
  } catch (e) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.error("error while parsing gitGraph options", e.message);
  }
}, "setOptions");
var getOptions = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  return state.records.options;
}, "getOptions");
var commit = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(commitDB) {
  let msg = commitDB.msg;
  let id = commitDB.id;
  const type = commitDB.type;
  let tags = commitDB.tags;
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.info("commit", msg, id, type, tags);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("Entering commit:", msg, id, type, tags);
  const config = getConfig3();
  id = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(id, config);
  msg = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(tag, config));
  const newCommit = {
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.info("main branch", config.mainBranchName);
  state.records.commits.set(newCommit.id, newCommit);
  state.records.branches.set(state.records.currBranch, newCommit.id);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("in pushCommit " + newCommit.id);
}, "commit");
var branch = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(branchDB) {
  let name = branchDB.name;
  const order = branchDB.order;
  name = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(name, getConfig3());
  ...
  checkout(name);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("in createBranch");
}, "branch");
var merge = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((mergeDB) => {
  let otherBranch = mergeDB.branch;
  let customId = mergeDB.id;
  const overrideType = mergeDB.type;
  const customTags = mergeDB.tags;
  const config = getConfig3();
  otherBranch = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(customId, config);
  }
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(state.records.branches);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("in mergeBranch");
}, "merge");
var cherryPick = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(cherryPickDB) {
  let sourceId = cherryPickDB.id;
  let targetId = cherryPickDB.targetId;
  let tags = cherryPickDB.tags;
  let parentCommitId = cherryPickDB.parent;
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("Entering cherryPick:", sourceId, targetId, tags);
  const config = getConfig3();
  sourceId = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(sourceId, config);
  targetId = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(tag, config));
  parentCommitId = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(parentCommitId, config);
  ...
  if (!targetId || !state.records.commits.has(targetId)) {
    ...
    state.records.branches.set(state.records.currBranch, commit2.id);
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(state.records.branches);
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("in cherryPick");
  }
}, "cherryPick");
var checkout = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(branch2) {
  branch2 = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY.sanitizeText(branch2, getConfig3());
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(upsert, "upsert");
function prettyPrintCommitHistory(commitArr) {
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(label.join(" "));
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(prettyPrintCommitHistory, "prettyPrintCommitHistory");
var prettyPrint = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(state.records.commits);
...
var getBranchesAsObjArray = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
...
var getBranches = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  return state.records.branches;
}, "getBranches");
var getCommits = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  return state.records.commits;
}, "getCommits");
var getCommitsArray = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  const commitArr = [...state.records.commits.values()];
  commitArr.forEach(function(o) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(o.id);
  });
  commitArr.sort((a, b) => a.seq - b.seq);
  return commitArr;
}, "getCommitsArray");
var getCurrentBranch = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  return state.records.currBranch;
}, "getCurrentBranch");
var getDirection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
  return state.records.direction;
}, "getDirection");
var getHead = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function() {
...
// src/diagrams/git/gitGraphParser.ts
var populate = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((ast, db2) => {
  (0,_chunk_TMUBEWPD_mjs__WEBPACK_IMPORTED_MODULE_0__/* .populateCommonDb */ .A)(ast, db2);
  if (ast.dir) {
...
var parseStatement = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((statement, db2) => {
  const parsers = {
    Commit: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((stmt) => db2.commit(parseCommit(stmt)), "Commit"),
    Branch: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((stmt) => db2.branch(parseBranch(stmt)), "Branch"),
    Merge: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((stmt) => db2.merge(parseMerge(stmt)), "Merge"),
    Checkout: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((stmt) => db2.checkout(parseCheckout(stmt)), "Checkout"),
    CherryPicking: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((stmt) => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
  };
  const parser2 = parsers[statement.$type];
  if (parser2) {
    parser2(statement);
  } else {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.error(`Unknown statement type: ${statement.$type}`);
  }
}, "parseStatement");
var parseCommit = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2) => {
  const commitDB = {
    id: commit2.id,
    msg: commit2.message ?? "",
...
var parseBranch = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((branch2) => {
  const branchDB = {
    name: branch2.name,
...
var parseMerge = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((merge2) => {
  const mergeDB = {
...
var parseCheckout = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((checkout2) => {
  const branch2 = checkout2.branch;
  return branch2;
}, "parseCheckout");
var parseCherryPicking = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((cherryPicking) => {
  const cherryPickDB = {
    id: cherryPicking.id,
    targetId: "",
...
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_4__/* .parse */ .Qc)("gitGraph", input);
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug(ast);
    populate(ast, db);
  }, "parse")
};
if (void 0) {
...
var DEFAULT_CONFIG = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .nV)();
...
var maxPos = 0;
var dir = "LR";
var clear3 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(() => {
  branchPos.clear();
  commitPos.clear();
...
var drawText = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((txt) => {
...
var findClosestParent = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((parents) => {
  let closestParent;
  let comparisonFunc;
  let targetPosition;
  if (dir === "BT") {
    comparisonFunc = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((a, b) => a <= b, "comparisonFunc");
...
var findClosestParentBT = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((parents) => {
  let closestParent = "";
...
var setParallelBTPos = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((sortedKeys, commits, defaultPos2) => {
...
var findClosestParentPos = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2) => {
...
var calculateCommitPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2, curPos) => {
...
var setRootPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
...
var drawCommitLabel = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((gLabels, commit2, commitPosition, pos) => {
...
var drawCommitTags = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((gLabels, commit2, commitPosition, pos) => {
...
var getCommitClassType = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2) => {
...
var calculatePosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commit2, pos, isParallelCommits) => {
...
var drawCommits = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((svg, commits, modifyGraph) => {
  ...
  const sortKeys = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((a, b) => {
...
var shouldRerouteArrow = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((commitA, commitB, p1, p2, allCommits) => {
  const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
  const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
  const isOnBranchToGetCurve = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((x) => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
  const isBetweenCommits = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((x) => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
  return [...allCommits.values()].some((commitX) => {
    return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
  });
}, "shouldRerouteArrow");
var findLane = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((y1, y2, depth = 0) => {
...
var drawArrow = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((svg, commitA, commitB, allCommits) => {
...
var drawArrows = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((svg, commits) => {
...
var drawBranches = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((svg, branches) => {
...
var setBranchPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(name, pos, index, bbox, rotateCommitLabel) {
  branchPos.set(name, { pos, index });
  pos += 50 + (rotateCommitLabel ? 40 : 0) + (dir === "TB" || dir === "BT" ? bbox.width / 2 : 0);
  return pos;
}, "setBranchPosition");
var draw = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(function(txt, id, ver, diagObj) {
  clear3();
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  if (!DEFAULT_GITGRAPH_CONFIG2) {
    throw new Error("GitGraph config not found");
  }
  ...
  _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ .w8.insertTitle(
    diagram2,
    "gitTitleText",
    DEFAULT_GITGRAPH_CONFIG2.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupGraphViewbox2 */ .Rw)(
    void 0,
    diagram2,
...
if (void 0) {
  ...
  describe("branchPosition", () => {
    const bbox = {
      ...
      bottom: 0,
      left: 0,
      toJSON: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(() => "", "toJSON")
    };
...
//# sourceMappingURL=8997.3f9033ec4c807c9053c8.js.map?v=3f9033ec4c807c9053c8
...
class MessageReference:
    """Represents a reference to a :class:`~nexon.Message`.
    ...
    resolved: Optional[Union[:class:`Message`, :class:`DeletedReferencedMessage`]]
        ...
        .. versionadded:: 1.6
    type: :class:`~nexon.MessageReferenceType`
    ...
    def from_message(
        ...
        *,
        ...
        """Creates a :class:`MessageReference` from an existing :class:`~nexon.Message`.
    ...
    def cached_message(self) -> Optional[Message]:
        """Optional[:class:`~nexon.Message`]: The cached message, if found in the internal message cache."""
...
class MessageInteractionMetadata(Hashable):
    ...
    def cached_original_response_message(self) -> Optional[Message]:
        """Optional[:class:`~nexon.Message`]: The original response message, if found in the internal message cache."""
        return self._state._get_message(self.original_response_message_id)

    @property
    def cached_interacted_message(self) -> Optional[Message]:
        """Optional[:class:`~nexon.Message`]: The interacted message, if found in the internal message cache."""
...
class Message(Hashable):
    ...
    reference: Optional[:class:`~nexon.MessageReference`]
    ...
    async def edit(
        ...
        allowed_mentions: Optional[:class:`~nexon.AllowedMentions`]
            Controls the mentions being processed in this message. If this is
            passed, then the object is merged with :attr:`~nexon.Client.allowed_mentions`.
            The merging behaviour only overrides attributes that have been explicitly passed
            to the object, otherwise it uses the attributes set in :attr:`~nexon.Client.allowed_mentions`.
            If no object is passed at all then the defaults given by :attr:`~nexon.Client.allowed_mentions`
            are used instead.
    ...
    async def create_thread(
        ...
        You must have :attr:`~nexon.Permissions.create_public_threads` in order to
    ...
    async def forward(self, channel: Messageable) -> Message:
        ...
        Parameters
        ----------
        channel: :class:`~nexon.Messageable`
    ...
    def to_reference(self, *, fail_if_not_exists: bool = True) -> MessageReference:
        """Creates a :class:`~nexon.MessageReference` from the current message.
...
class PartialMessage(Hashable):
    ...
    async def edit(self, **fields: Any) -> Optional[Message]:
        ...
        .. versionchanged:: 1.7
            :class:`nexon.Message` is returned instead of ``None`` if an edit took place.

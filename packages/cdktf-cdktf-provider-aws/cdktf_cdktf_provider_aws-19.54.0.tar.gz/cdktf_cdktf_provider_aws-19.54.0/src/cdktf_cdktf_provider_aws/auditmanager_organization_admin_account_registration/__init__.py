...
Refer to the Terraform Registry for docs: [`aws_auditmanager_organization_admin_account_registration`](https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/auditmanager_organization_admin_account_registration).
'''
...
class AuditmanagerOrganizationAdminAccountRegistration(
    ...
    def __init__(
        ...
        *,
        ...
        :param admin_account_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/auditmanager_organization_admin_account_registration#admin_account_id AuditmanagerOrganizationAdminAccountRegistration#admin_account_id}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 

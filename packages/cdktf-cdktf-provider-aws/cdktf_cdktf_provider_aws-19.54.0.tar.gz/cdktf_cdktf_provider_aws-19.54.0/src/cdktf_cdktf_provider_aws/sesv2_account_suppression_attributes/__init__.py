...
Refer to the Terraform Registry for docs: [`aws_sesv2_account_suppression_attributes`](https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/sesv2_account_suppression_attributes).
'''
...
class Sesv2AccountSuppressionAttributes(
    ...
    def __init__(
        ...
        *,
        ...
        :param suppressed_reasons: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/sesv2_account_suppression_attributes#suppressed_reasons Sesv2AccountSuppressionAttributes#suppressed_reasons}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 

...
Refer to the Terraform Registry for docs: [`aws_servicequotas_template_association`](https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/servicequotas_template_association).
'''
...
class ServicequotasTemplateAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param skip_destroy: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.88.0/docs/resources/servicequotas_template_association#skip_destroy ServicequotasTemplateAssociation#skip_destroy}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 

...
def create_db_connection(service, is_proxy=False, host=None, user=None, password=None, database=None, port=3306, region=None):
    """
    ...
    if service == "local":
        ...
        return AWSRDSConnection(host, user, password, database, region, port, is_proxy)

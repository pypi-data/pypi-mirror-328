...
class TestRpmModulemdDefaultsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RpmModulemdDefaultsResponse:
        """Test RpmModulemdDefaultsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpmModulemdDefaultsResponse`
        """
        model = RpmModulemdDefaultsResponse()
        if include_optional:

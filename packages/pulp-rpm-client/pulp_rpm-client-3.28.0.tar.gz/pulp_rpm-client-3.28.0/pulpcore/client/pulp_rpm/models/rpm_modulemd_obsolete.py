...
class RpmModulemdObsolete(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["repository", "modified", "module_name", "module_stream", "message", "override_previous", "module_context", "eol_date", "obsoleted_by_module_name", "obsoleted_by_module_stream", "snippet"]

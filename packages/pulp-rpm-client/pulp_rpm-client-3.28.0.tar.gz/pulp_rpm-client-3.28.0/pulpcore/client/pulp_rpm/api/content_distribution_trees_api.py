...
class ContentDistributionTreesApi:
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmDistributionTreeResponseList",
        }
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmDistributionTreeResponseList]:
        """List distribution trees
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp/api/v3/content/rpm/distribution_trees/',
    ...
    def read(
        self,
        rpm_distribution_tree_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param rpm_distribution_tree_href: (required)
        :type rpm_distribution_tree_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            rpm_distribution_tree_href=rpm_distribution_tree_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RpmDistributionTreeResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RpmDistributionTreeResponse]:
        """Inspect a distribution tree
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if rpm_distribution_tree_href is not None:
            _path_params['rpm_distribution_tree_href'] = rpm_distribution_tree_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_distribution_tree_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

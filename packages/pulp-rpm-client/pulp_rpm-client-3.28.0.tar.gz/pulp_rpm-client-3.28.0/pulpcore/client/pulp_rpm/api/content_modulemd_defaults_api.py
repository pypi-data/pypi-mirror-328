...
class ContentModulemdDefaultsApi:
    ...
    def create(
        ...
        :param rpm_modulemd_defaults: (required)
        :type rpm_modulemd_defaults: RpmModulemdDefaults
        ...
        _param = self._create_serialize(
            rpm_modulemd_defaults=rpm_modulemd_defaults,
    ...
    def _create_serialize(
        ...
        if rpm_modulemd_defaults is not None:
            _body_params = rpm_modulemd_defaults
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/rpm/modulemd_defaults/',
    ...
    def list(
        ...
        module: Annotated[Optional[StrictStr], Field(description="Filter results where module matches value")] = None,
        module__in: Annotated[Optional[List[StrictStr]], Field(description="Filter results where module is in a comma-separated list of values")] = None,
        ...
        :type limit: int
        :param module: Filter results where module matches value
        :type module: str
        :param module__in: Filter results where module is in a comma-separated list of values
        :type module__in: List[str]
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmModulemdDefaultsResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmModulemdDefaultsResponseList]:
        """List modulemd defaultss
    ...
    def _list_serialize(
        ...
        if module__in is not None:
            
            _query_params.append(('module__in', module__in))
    ...
    def read(
        self,
        rpm_modulemd_defaults_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param rpm_modulemd_defaults_href: (required)
        :type rpm_modulemd_defaults_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            rpm_modulemd_defaults_href=rpm_modulemd_defaults_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RpmModulemdDefaultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RpmModulemdDefaultsResponse]:
        """Inspect a modulemd defaults
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if rpm_modulemd_defaults_href is not None:
            _path_params['rpm_modulemd_defaults_href'] = rpm_modulemd_defaults_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_modulemd_defaults_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

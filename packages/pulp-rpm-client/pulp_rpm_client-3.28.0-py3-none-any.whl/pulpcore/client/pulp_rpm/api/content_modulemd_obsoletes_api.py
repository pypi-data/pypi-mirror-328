...
class ContentModulemdObsoletesApi:
    ...
    def create(
        ...
        :param rpm_modulemd_obsolete: (required)
        :type rpm_modulemd_obsolete: RpmModulemdObsolete
        ...
        _param = self._create_serialize(
            rpm_modulemd_obsolete=rpm_modulemd_obsolete,
    ...
    def _create_serialize(
        ...
        if rpm_modulemd_obsolete is not None:
            _body_params = rpm_modulemd_obsolete
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/rpm/modulemd_obsoletes/',
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmModulemdObsoleteResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmModulemdObsoleteResponseList]:
        """List modulemd obsoletes
    ...
    def read(
        self,
        rpm_modulemd_obsolete_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param rpm_modulemd_obsolete_href: (required)
        :type rpm_modulemd_obsolete_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            rpm_modulemd_obsolete_href=rpm_modulemd_obsolete_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RpmModulemdObsoleteResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RpmModulemdObsoleteResponse]:
        """Inspect a modulemd obsolete
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if rpm_modulemd_obsolete_href is not None:
            _path_params['rpm_modulemd_obsolete_href'] = rpm_modulemd_obsolete_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_modulemd_obsolete_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
class RpmPackageGroupResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "id", "default", "user_visible", "display_order", "name", "description", "packages", "biarch_only", "desc_by_lang", "name_by_lang", "digest"]

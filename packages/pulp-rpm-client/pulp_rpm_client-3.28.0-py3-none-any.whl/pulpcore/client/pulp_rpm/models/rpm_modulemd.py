...
class RpmModulemd(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["repository", "name", "stream", "version", "static_context", "context", "arch", "artifacts", "dependencies", "packages", "snippet", "profiles", "description"]

...
setup(
    ...
    url='https://git.gfz-potsdam.de/javier/dastools',
    ...
    install_requires=['obspy', 'numpy', 'scipy', 'fastapi', 'uvicorn', 'pydantic>=2', 'tqdm', 'h5py',
                      'pytest-cov', 'httpx', 'click', 'jinja2', 'sphinx'],
    ...
    package_data={'dastools': ['data/filters/*.txt', 'data/*.wadl', 'data/*.xml']},
    ...
    entry_points='''
        [console_scripts]
        dasconv=dastools.app.dasconv:main
        dasmetadata=dastools.app.dasmetadata:cli
        dasws=dastools.server.dasws:main
    '''
)

...
#define eckit_HAVE_FUNOPEN 1
#define eckit_HAVE_FSYNC 1
#define eckit_HAVE_FDATASYNC 0
#define eckit_HAVE_F_FULLFSYNC 1
#define eckit_HAVE_FMEMOPEN 1
#define eckit_HAVE_DLINFO 0
#define eckit_HAVE_FOPENCOOKIE 0
...
#define eckit_HAVE_ARMADILLO 0
#define eckit_HAVE_CUDA 0
#define eckit_HAVE_EIGEN 0
#define eckit_HAVE_LAPACK 1
#define eckit_HAVE_VIENNACL 0
#define eckit_HAVE_OMP 0
#define eckit_HAVE_SSL 0
#define eckit_HAVE_CURL 1
#define eckit_HAVE_JEMALLOC 0

...
class ViewApi(object):
    ...
    def create_view(
        ...
        >>> thread = api.create_view(database, var_schema, view, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_view_with_http_info(database, var_schema, view,
    ...
    def create_view_with_http_info(
        ...
        >>> thread = api.create_view_with_http_info(database, var_schema, view, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            'database', 'var_schema', 'view', 'create_mode', 'copy_grants'
        ]
        _all_params.extend([
    ...
    @validate_call
    def fetch_view(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_view(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_view_with_http_info(database, var_schema, name,
                                              **kwargs)  # noqa: E501

    @validate_call
    def fetch_view_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_view_with_http_info(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(View, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_views(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[View]:  # noqa: E501
        ...
        >>> thread = api.list_views(database, var_schema, like, starts_with, show_limit, from_name, deep, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_views_with_http_info(database, var_schema, like,
    ...
    def list_views_with_http_info(
        ...
        >>> thread = api.list_views_with_http_info(database, var_schema, like, starts_with, show_limit, from_name, deep, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[View], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def delete_view(
        ...
        >>> thread = api.delete_view(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_view_with_http_info(database, var_schema, name,
                                               if_exists,
                                               **kwargs)  # noqa: E501
    ...
    def delete_view_with_http_info(
        ...
        >>> thread = api.delete_view_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)

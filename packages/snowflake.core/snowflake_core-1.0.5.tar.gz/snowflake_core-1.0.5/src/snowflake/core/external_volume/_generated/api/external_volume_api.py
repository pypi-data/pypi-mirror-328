...
class ExternalVolumeApi(object):
    ...
    def create_external_volume(
        ...
        >>> thread = api.create_external_volume(external_volume, create_mode, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_external_volume_with_http_info(
            external_volume, create_mode, **kwargs)  # noqa: E501
    ...
    def create_external_volume_with_http_info(
        ...
        >>> thread = api.create_external_volume_with_http_info(external_volume, create_mode, async_req=True)
        >>> result = thread.get()
        :param external_volume: (required)
        :type external_volume: ExternalVolume
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_external_volume" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def fetch_external_volume(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                              **kwargs) -> ExternalVolume:  # noqa: E501
        ...
        >>> thread = api.fetch_external_volume(name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ExternalVolume
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_external_volume_with_http_info(
            name, **kwargs)  # noqa: E501

    @validate_call
    def fetch_external_volume_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                             **kwargs):  # noqa: E501
        ...
        >>> thread = api.fetch_external_volume_with_http_info(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ExternalVolume, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method fetch_external_volume" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_external_volumes(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[ExternalVolume]:  # noqa: E501
        ...
        >>> thread = api.list_external_volumes(like, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[ExternalVolume]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_external_volumes_with_http_info(
            like, **kwargs)  # noqa: E501
    ...
    def list_external_volumes_with_http_info(
        ...
        >>> thread = api.list_external_volumes_with_http_info(like, async_req=True)
        >>> result = thread.get()
        :param like: Query parameter to filter the command output by resource name. Uses case-insensitive pattern matching, with support for SQL wildcard characters.
        :type like: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[ExternalVolume], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method list_external_volumes" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def undrop_external_volume(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                               **kwargs) -> SuccessResponse:  # noqa: E501
        ...
        >>> thread = api.undrop_external_volume(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.undrop_external_volume_with_http_info(
            name, **kwargs)  # noqa: E501

    @validate_call
    def undrop_external_volume_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                              **kwargs):  # noqa: E501
        ...
        >>> thread = api.undrop_external_volume_with_http_info(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method undrop_external_volume" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_external_volume(
        ...
        >>> thread = api.delete_external_volume(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_external_volume_with_http_info(
    ...
    def delete_external_volume_with_http_info(
        ...
        >>> thread = api.delete_external_volume_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method delete_external_volume" % _key)
            _params[_key] = _val
        del _params['kwargs']

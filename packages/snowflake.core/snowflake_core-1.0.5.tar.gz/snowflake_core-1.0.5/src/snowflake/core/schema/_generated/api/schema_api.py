...
class SchemaApi(object):
    ...
    def create_or_alter_schema(
        ...
        >>> thread = api.create_or_alter_schema(database, name, model_schema, kind, async_req=True)
        >>> result = thread.get()
    ...
    def create_or_alter_schema_with_http_info(
        ...
        >>> thread = api.create_or_alter_schema_with_http_info(database, name, model_schema, kind, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def create_schema(
        ...
        >>> thread = api.create_schema(database, model_schema, create_mode, kind, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param model_schema: (required)
    ...
    def create_schema_with_http_info(
        ...
        >>> thread = api.create_schema_with_http_info(database, model_schema, create_mode, kind, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param model_schema: (required)
    ...
    def clone_schema(
        ...
        >>> thread = api.clone_schema(database, name, schema_clone, create_mode, kind, target_database, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def clone_schema_with_http_info(
        ...
        >>> thread = api.clone_schema_with_http_info(database, name, schema_clone, create_mode, kind, target_database, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def undrop_schema(self, database: Annotated[
        ...
        >>> thread = api.undrop_schema(database, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def undrop_schema_with_http_info(self, database: Annotated[
        ...
        >>> thread = api.undrop_schema_with_http_info(database, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)

...
class PipeApi(object):
    ...
    def create_pipe(
        ...
        >>> thread = api.create_pipe(database, var_schema, pipe, create_mode, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_pipe_with_http_info(database, var_schema, pipe,
                                               create_mode,
                                               **kwargs)  # noqa: E501
    ...
    def create_pipe_with_http_info(
        ...
        >>> thread = api.create_pipe_with_http_info(database, var_schema, pipe, create_mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
    ...
    @validate_call
    def fetch_pipe(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_pipe(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_pipe_with_http_info(database, var_schema, name,
                                              **kwargs)  # noqa: E501

    @validate_call
    def fetch_pipe_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_pipe_with_http_info(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Pipe, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_pipes(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[Pipe]:  # noqa: E501
        ...
        >>> thread = api.list_pipes(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_pipes_with_http_info(database, var_schema, like,
                                              **kwargs)  # noqa: E501
    ...
    def list_pipes_with_http_info(
        ...
        >>> thread = api.list_pipes_with_http_info(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[Pipe], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def refresh_pipe(
        ...
        >>> thread = api.refresh_pipe(database, var_schema, name, if_exists, prefix, modified_after, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.refresh_pipe_with_http_info(database, var_schema, name,
                                                if_exists, prefix,
                                                modified_after,
                                                **kwargs)  # noqa: E501
    ...
    def refresh_pipe_with_http_info(
        ...
        >>> thread = api.refresh_pipe_with_http_info(database, var_schema, name, if_exists, prefix, modified_after, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            'database', 'var_schema', 'name', 'if_exists', 'prefix',
            'modified_after'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
    ...
    def delete_pipe(
        ...
        >>> thread = api.delete_pipe(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_pipe_with_http_info(database, var_schema, name,
                                               if_exists,
                                               **kwargs)  # noqa: E501
    ...
    def delete_pipe_with_http_info(
        ...
        >>> thread = api.delete_pipe_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)

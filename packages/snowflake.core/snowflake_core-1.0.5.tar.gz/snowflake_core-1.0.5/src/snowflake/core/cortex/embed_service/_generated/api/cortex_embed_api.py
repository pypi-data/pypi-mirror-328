...
class CortexEmbedApi(object):
    ...
    def embed(self, embed_request: Annotated[
        ...
        Field(description=
              ...
              **kwargs) -> EmbedResponse:  # noqa: E501
        ...
        >>> thread = api.embed(embed_request, async_req=True)
        >>> result = thread.get()
    ...
    def embed_with_http_info(self, embed_request: Annotated[
        ...
        >>> thread = api.embed_with_http_info(embed_request, async_req=True)
        >>> result = thread.get()
        :param embed_request: Request payload containing model identifier and input text. (required)
        :type embed_request: EmbedRequest
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EmbedResponse, status_code(int), headers(HTTPHeaderDict))
        """

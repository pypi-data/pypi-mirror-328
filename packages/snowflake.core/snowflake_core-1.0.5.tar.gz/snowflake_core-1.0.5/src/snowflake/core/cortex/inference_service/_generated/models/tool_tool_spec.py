...
from snowflake.core.cortex.inference_service._generated.models.tool_tool_spec_input_schema import ToolToolSpecInputSchema
...
Used to match with configuration in tool_resources.
    ...
    __properties = ["type", "name", "input_schema"]
    ...
    def from_dict(cls, obj: dict) -> ToolToolSpec:
        ...
        _obj = ToolToolSpec.parse_obj({
            ...
            obj.get("name"),
            "input_schema":
            ToolToolSpecInputSchema.from_dict(obj.get("input_schema"))
            if obj.get("input_schema") is not None else None,
        })
...
Used to match with configuration in tool_resources.
    ...
    def _to_model(self):
        return ToolToolSpec(
            type=self.type,
            name=self.name,
            input_schema=self.input_schema._to_model()
    ...
    def _from_model(cls, model) -> ToolToolSpecModel:
        return ToolToolSpecModel(
            type=model.type,
            name=model.name,
            input_schema=ToolToolSpecInputSchemaModel._from_model(
                model.input_schema)
            if model.input_schema is not None else None,
        )

    def to_dict(self):
        """Creates a dictionary of the properties from a ToolToolSpec.
    ...
    def from_dict(cls, obj: dict) -> ToolToolSpecModel:
        """Creates an instance of ToolToolSpec from a dict.

...
class CortexInferenceApi(object):
    ...
    def cortex_llm_inference_complete(
        ...
        >>> thread = api.cortex_llm_inference_complete(complete_request, async_req=True)
        >>> result = thread.get()
    ...
    def cortex_llm_inference_complete_with_http_info(
        ...
        >>> thread = api.cortex_llm_inference_complete_with_http_info(complete_request, async_req=True)
        >>> result = thread.get()
        :param complete_request:
        :type complete_request: CompleteRequest
        :param async_req: Whether to execute the request asynchronously.

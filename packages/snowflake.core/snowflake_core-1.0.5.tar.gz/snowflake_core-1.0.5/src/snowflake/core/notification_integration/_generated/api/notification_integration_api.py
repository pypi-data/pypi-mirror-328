...
class NotificationIntegrationApi(object):
    ...
    def create_notification_integration(
        ...
        >>> thread = api.create_notification_integration(notification_integration, create_mode, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_notification_integration_with_http_info(
            notification_integration, create_mode, **kwargs)  # noqa: E501
    ...
    def create_notification_integration_with_http_info(
        ...
        >>> thread = api.create_notification_integration_with_http_info(notification_integration, create_mode, async_req=True)
        >>> result = thread.get()
        :param notification_integration: (required)
        :type notification_integration: NotificationIntegration
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError(
                    ...
                    " to method create_notification_integration" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def fetch_notification_integration(
            ...
            **kwargs) -> NotificationIntegration:  # noqa: E501
        ...
        >>> thread = api.fetch_notification_integration(name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: NotificationIntegration
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_notification_integration_with_http_info(
            name, **kwargs)  # noqa: E501

    @validate_call
    def fetch_notification_integration_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                                      **kwargs):  # noqa: E501
        ...
        >>> thread = api.fetch_notification_integration_with_http_info(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NotificationIntegration, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method fetch_notification_integration" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_notification_integrations(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[NotificationIntegration]:  # noqa: E501
        ...
        >>> thread = api.list_notification_integrations(like, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[NotificationIntegration]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_notification_integrations_with_http_info(
    ...
    def list_notification_integrations_with_http_info(
        ...
        >>> thread = api.list_notification_integrations_with_http_info(like, async_req=True)
        >>> result = thread.get()
        :param like: Query parameter to filter the command output by resource name. Uses case-insensitive pattern matching, with support for SQL wildcard characters.
        :type like: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[NotificationIntegration], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_notification_integrations" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_notification_integration(
        ...
        >>> thread = api.delete_notification_integration(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_notification_integration_with_http_info(
    ...
    def delete_notification_integration_with_http_info(
        ...
        >>> thread = api.delete_notification_integration_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_notification_integration" % _key)
            _params[_key] = _val
        del _params['kwargs']

...
class NetworkPolicyApi(object):
    ...
    def create_network_policy(
        ...
        >>> thread = api.create_network_policy(network_policy, create_mode, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_network_policy_with_http_info(
            network_policy, create_mode, **kwargs)  # noqa: E501
    ...
    def create_network_policy_with_http_info(
        ...
        >>> thread = api.create_network_policy_with_http_info(network_policy, create_mode, async_req=True)
        >>> result = thread.get()
        :param network_policy: (required)
        :type network_policy: NetworkPolicy
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_network_policy" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def fetch_network_policy(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                             **kwargs) -> NetworkPolicy:  # noqa: E501
        ...
        >>> thread = api.fetch_network_policy(name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_network_policy_with_http_info(name,
                                                        **kwargs)  # noqa: E501

    @validate_call
    def fetch_network_policy_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                            **kwargs):  # noqa: E501
        ...
        >>> thread = api.fetch_network_policy_with_http_info(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NetworkPolicy, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method fetch_network_policy" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_network_policies(
            self, **kwargs) -> Iterable[NetworkPolicy]:  # noqa: E501
        ...
        >>> thread = api.list_network_policies(async_req=True)
        >>> result = thread.get()
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[NetworkPolicy]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_network_policies_with_http_info(**
                                                         kwargs)  # noqa: E501

    @validate_call
    def list_network_policies_with_http_info(self, **kwargs):  # noqa: E501
        """List network policies  # noqa: E501.
        ...
        >>> thread = api.list_network_policies_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _return_http_data_only: response data without head status code
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[NetworkPolicy], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method list_network_policies" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_network_policy(
        ...
        >>> thread = api.delete_network_policy(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_network_policy_with_http_info(
    ...
    def delete_network_policy_with_http_info(
        ...
        >>> thread = api.delete_network_policy_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method delete_network_policy" % _key)
            _params[_key] = _val
        del _params['kwargs']

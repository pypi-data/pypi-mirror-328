...
class DatabaseRoleApi(object):
    ...
    def create_database_role(
        ...
        >>> thread = api.create_database_role(database, database_role, create_mode, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_database_role_with_http_info(
            database, database_role, create_mode, **kwargs)  # noqa: E501
    ...
    def create_database_role_with_http_info(
        ...
        >>> thread = api.create_database_role_with_http_info(database, database_role, create_mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param database_role: (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_database_role" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def clone_database_role(
        ...
        >>> thread = api.clone_database_role(database, name, database_role_clone, create_mode, target_database, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.clone_database_role_with_http_info(database, name,
                                                       database_role_clone,
                                                       create_mode,
                                                       target_database,
                                                       **kwargs)  # noqa: E501
    ...
    def clone_database_role_with_http_info(
        ...
        >>> thread = api.clone_database_role_with_http_info(database, name, database_role_clone, create_mode, target_database, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        _all_params = [
            'database', 'name', 'database_role_clone', 'create_mode',
            'target_database'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method clone_database_role" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def grant_future_privileges(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.grant_future_privileges(database, name, grant, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        return self.grant_future_privileges_with_http_info(
            database, name, grant, **kwargs)  # noqa: E501

    @validate_call
    def grant_future_privileges_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.grant_future_privileges_with_http_info(database, name, grant, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    @validate_call
    def grant_privileges(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.grant_privileges(database, name, grant, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.grant_privileges_with_http_info(database, name, grant,
                                                    **kwargs)  # noqa: E501

    @validate_call
    def grant_privileges_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.grant_privileges_with_http_info(database, name, grant, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def list_database_roles(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[DatabaseRole]:  # noqa: E501
        ...
        >>> thread = api.list_database_roles(database, show_limit, from_name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[DatabaseRole]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_database_roles_with_http_info(database, show_limit,
                                                       from_name,
                                                       **kwargs)  # noqa: E501
    ...
    def list_database_roles_with_http_info(
        ...
        >>> thread = api.list_database_roles_with_http_info(database, show_limit, from_name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[DatabaseRole], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method list_database_roles" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_future_grants(
        ...
        >>> thread = api.list_future_grants(database, name, show_limit, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_future_grants_with_http_info(database, name,
                                                      show_limit,
                                                      **kwargs)  # noqa: E501
    ...
    def list_future_grants_with_http_info(
        ...
        >>> thread = api.list_future_grants_with_http_info(database, name, show_limit, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def list_grants(
        ...
        >>> thread = api.list_grants(database, name, show_limit, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_grants_with_http_info(database, name, show_limit,
                                               **kwargs)  # noqa: E501
    ...
    def list_grants_with_http_info(
        ...
        >>> thread = api.list_grants_with_http_info(database, name, show_limit, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def revoke_future_grants(
        ...
        >>> thread = api.revoke_future_grants(database, name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        return self.revoke_future_grants_with_http_info(
            database, name, grant, mode, **kwargs)  # noqa: E501
    ...
    def revoke_future_grants_with_http_info(
        ...
        >>> thread = api.revoke_future_grants_with_http_info(database, name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def revoke_grants(
        ...
        >>> thread = api.revoke_grants(database, name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.revoke_grants_with_http_info(database, name, grant, mode,
                                                 **kwargs)  # noqa: E501
    ...
    def revoke_grants_with_http_info(
        ...
        >>> thread = api.revoke_grants_with_http_info(database, name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
    ...
    def delete_database_role(
        ...
        >>> thread = api.delete_database_role(database, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_database_role_with_http_info(
            database, name, if_exists, **kwargs)  # noqa: E501
    ...
    def delete_database_role_with_http_info(
        ...
        >>> thread = api.delete_database_role_with_http_info(database, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param name: Identifier (i.e. name) for the resource. (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method delete_database_role" % _key)
            _params[_key] = _val
        del _params['kwargs']

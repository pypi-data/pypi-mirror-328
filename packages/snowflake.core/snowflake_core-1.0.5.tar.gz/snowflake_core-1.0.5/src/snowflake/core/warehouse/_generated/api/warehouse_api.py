...
class WarehouseApi(object):
    ...
    def disable_warehouse(
        ...
        Annotated[
            ...
            **kwargs) -> SuccessResponse:  # noqa: E501
        """Disable adaptive warehouse  # noqa: E501.
        ...
        >>> thread = api.disable_warehouse(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.disable_warehouse_with_http_info(name, if_exists,
                                                     **kwargs)  # noqa: E501
    ...
    def disable_warehouse_with_http_info(
        ...
        >>> thread = api.disable_warehouse_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method disable_warehouse" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def enable_warehouse(
        ...
        Annotated[
            ...
            **kwargs) -> SuccessResponse:  # noqa: E501
        """Enable adaptive warehouse  # noqa: E501.
        ...
        >>> thread = api.enable_warehouse(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.enable_warehouse_with_http_info(name, if_exists,
                                                    **kwargs)  # noqa: E501
    ...
    def enable_warehouse_with_http_info(
        ...
        >>> thread = api.enable_warehouse_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method enable_warehouse" % _key)
            _params[_key] = _val
        del _params['kwargs']

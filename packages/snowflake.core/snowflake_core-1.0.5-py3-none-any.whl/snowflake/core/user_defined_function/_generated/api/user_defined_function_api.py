...
class UserDefinedFunctionApi(object):
    ...
    def create_user_defined_function(
        ...
        >>> thread = api.create_user_defined_function(database, var_schema, user_defined_function, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_user_defined_function_with_http_info(
            database, var_schema, user_defined_function, create_mode,
    ...
    def create_user_defined_function_with_http_info(
        ...
        >>> thread = api.create_user_defined_function_with_http_info(database, var_schema, user_defined_function, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_user_defined_function" %
                                    _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def fetch_user_defined_function(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
            ...
            Field(
                ...
                StrictStr,
                Field(description="Function's name with Args")], **kwargs
                                    ) -> UserDefinedFunction:  # noqa: E501
        ...
        >>> thread = api.fetch_user_defined_function(database, var_schema, name_with_args, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_user_defined_function_with_http_info(
            database, var_schema, name_with_args, **kwargs)  # noqa: E501

    @validate_call
    def fetch_user_defined_function_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_user_defined_function_with_http_info(database, var_schema, name_with_args, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UserDefinedFunction, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method fetch_user_defined_function" %
                                    _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_user_defined_functions(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[UserDefinedFunction]:  # noqa: E501
        """List UDFs  # noqa: E501.
        ...
        >>> thread = api.list_user_defined_functions(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[UserDefinedFunction]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_user_defined_functions_with_http_info(
    ...
    def list_user_defined_functions_with_http_info(
        ...
        >>> thread = api.list_user_defined_functions_with_http_info(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[UserDefinedFunction], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method list_user_defined_functions" %
                                    _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def rename_user_defined_function(
        ...
        >>> thread = api.rename_user_defined_function(database, var_schema, name_with_args, target_database, target_schema, target_name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        return self.rename_user_defined_function_with_http_info(
            database, var_schema, name_with_args, target_database,
            target_schema, target_name, if_exists, **kwargs)  # noqa: E501
    ...
    def rename_user_defined_function_with_http_info(
        ...
        >>> thread = api.rename_user_defined_function_with_http_info(database, var_schema, name_with_args, target_database, target_schema, target_name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            'database', 'var_schema', 'name_with_args', 'target_database',
            'target_schema', 'target_name', 'if_exists'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
            '_request_timeout', '_request_auth', '_content_type', '_headers'
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method rename_user_defined_function" %
                                    _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_user_defined_function(
        ...
        >>> thread = api.delete_user_defined_function(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        return self.delete_user_defined_function_with_http_info(
            database, var_schema, name_with_args, if_exists,
            **kwargs)  # noqa: E501
    ...
    def delete_user_defined_function_with_http_info(
        ...
        >>> thread = api.delete_user_defined_function_with_http_info(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method delete_user_defined_function" %
                                    _key)
            _params[_key] = _val
        del _params['kwargs']

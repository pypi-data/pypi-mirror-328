...
class StreamApi(object):
    ...
    def create_stream(
        ...
        >>> thread = api.create_stream(database, var_schema, stream, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_stream_with_http_info(database, var_schema, stream,
    ...
    def create_stream_with_http_info(
        ...
        >>> thread = api.create_stream_with_http_info(database, var_schema, stream, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            'database', 'var_schema', 'stream', 'create_mode', 'copy_grants'
        ]
        _all_params.extend([
    ...
    def clone_stream(
        ...
        >>> thread = api.clone_stream(database, var_schema, name, target_database, target_schema, stream_clone, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.clone_stream_with_http_info(database, var_schema, name,
                                                target_database, target_schema,
                                                stream_clone, create_mode,
                                                copy_grants,
                                                **kwargs)  # noqa: E501
    ...
    def clone_stream_with_http_info(
        ...
        >>> thread = api.clone_stream_with_http_info(database, var_schema, name, target_database, target_schema, stream_clone, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            ...
            'target_schema', 'stream_clone', 'create_mode', 'copy_grants'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
            '_request_timeout', '_request_auth', '_content_type', '_headers'
    ...
    @validate_call
    def fetch_stream(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_stream(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_stream_with_http_info(database, var_schema, name,
                                                **kwargs)  # noqa: E501

    @validate_call
    def fetch_stream_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_stream_with_http_info(database, var_schema, name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Stream, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_streams(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[Stream]:  # noqa: E501
        ...
        >>> thread = api.list_streams(database, var_schema, like, starts_with, show_limit, from_name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[Stream]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_streams_with_http_info(database, var_schema, like,
    ...
    def list_streams_with_http_info(
        ...
        >>> thread = api.list_streams_with_http_info(database, var_schema, like, starts_with, show_limit, from_name, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[Stream], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def delete_stream(
        ...
        >>> thread = api.delete_stream(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_stream_with_http_info(database, var_schema, name,
                                                 if_exists,
                                                 **kwargs)  # noqa: E501
    ...
    def delete_stream_with_http_info(
        ...
        >>> thread = api.delete_stream_with_http_info(database, var_schema, name, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)

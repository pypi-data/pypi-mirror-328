...
class SendMessageRequest(BaseModel):
    ...
    semantic_model_file : str, optional
        The path to a file stored in a Snowflake Stage holding the semantic model yaml. Must be in the database and schema provided in the url parameters.
    ...
    __properties = [
        "semantic_model_file", "semantic_model", "stream", "operation",
        "warehouse", "messages", "source"
    ]

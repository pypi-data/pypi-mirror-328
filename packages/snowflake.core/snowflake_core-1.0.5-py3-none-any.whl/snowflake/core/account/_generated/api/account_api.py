...
class AccountApi(object):
    ...
    def list_accounts(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[Account]:  # noqa: E501
        ...
        >>> thread = api.list_accounts(like, show_limit, history, async_req=True)
        >>> result = thread.get()
    ...
    def list_accounts_with_http_info(
        ...
        >>> thread = api.list_accounts_with_http_info(like, show_limit, history, async_req=True)
        >>> result = thread.get()
        :param like: Query parameter to filter the command output by resource name. Uses case-insensitive pattern matching, with support for SQL wildcard characters.
        :type like: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[Account], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_call
    def undrop_account(self, name: Annotated[
        str,
        Field(strict=True,
        ...
        >>> thread = api.undrop_account(name, async_req=True)
        >>> result = thread.get()
    ...
    def undrop_account_with_http_info(self, name: Annotated[
        ...
        >>> thread = api.undrop_account_with_http_info(name, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param async_req: Whether to execute the request asynchronously.
    ...
    def delete_account(
        ...
        >>> thread = api.delete_account(name, grace_period_in_days, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
    ...
    def delete_account_with_http_info(
        ...
        >>> thread = api.delete_account_with_http_info(name, grace_period_in_days, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grace_period_in_days: Specifies the number of days during which the account can be restored (“undropped”). The minimum is 3 days and the maximum is 90 days. (required)

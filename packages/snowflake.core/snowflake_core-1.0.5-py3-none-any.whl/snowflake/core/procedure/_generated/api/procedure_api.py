...
class ProcedureApi(object):
    ...
    def create_procedure(
        ...
        >>> thread = api.create_procedure(database, var_schema, procedure, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_procedure_with_http_info(database, var_schema,
    ...
    def create_procedure_with_http_info(
        ...
        >>> thread = api.create_procedure_with_http_info(database, var_schema, procedure, create_mode, copy_grants, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        _all_params = [
            'database', 'var_schema', 'procedure', 'create_mode', 'copy_grants'
        ]
        _all_params.extend([
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_procedure" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_call
    def call_procedure(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
            ...
            Field(
                ...
                Field(description="Function's name with Args")],
                       ...
                       **kwargs) -> Iterable[object]:  # noqa: E501
        ...
        >>> thread = api.call_procedure(database, var_schema, name_with_args, call_argument_list, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.call_procedure_with_http_info(database, var_schema,
                                                  name_with_args,
                                                  call_argument_list,
                                                  **kwargs)  # noqa: E501

    @validate_call
    def call_procedure_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.call_procedure_with_http_info(database, var_schema, name_with_args, call_argument_list, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[object], status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'database', 'var_schema', 'name_with_args', 'call_argument_list'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
            '_request_timeout', '_request_auth', '_content_type', '_headers'
    ...
    @validate_call
    def fetch_procedure(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_procedure(database, var_schema, name_with_args, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_procedure_with_http_info(database, var_schema,
                                                   name_with_args,
                                                   **kwargs)  # noqa: E501

    @validate_call
    def fetch_procedure_with_http_info(self, database: Annotated[
        str,
        Field(
            strict=True,
            description=
        ...
        >>> thread = api.fetch_procedure_with_http_info(database, var_schema, name_with_args, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Procedure, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method fetch_procedure" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def list_procedures(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[Procedure]:  # noqa: E501
        ...
        >>> thread = api.list_procedures(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Iterable[Procedure]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_procedures_with_http_info(database, var_schema, like,
                                                   **kwargs)  # noqa: E501
    ...
    def list_procedures_with_http_info(
        ...
        >>> thread = api.list_procedures_with_http_info(database, var_schema, like, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[Procedure], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method list_procedures" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def delete_procedure(
        ...
        >>> thread = api.delete_procedure(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_procedure_with_http_info(database, var_schema,
    ...
    def delete_procedure_with_http_info(
        ...
        >>> thread = api.delete_procedure_with_http_info(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = thread.get()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method delete_procedure" % _key)
            _params[_key] = _val
        del _params['kwargs']

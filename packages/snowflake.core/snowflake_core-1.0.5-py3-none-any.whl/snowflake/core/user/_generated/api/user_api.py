...
class UserApi(object):
    ...
    @validate_call
    def create_or_alter_user(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                             user: User,
                             **kwargs) -> SuccessResponse:  # noqa: E501
        """Create a (or alter an existing) user.  # noqa: E501.
        ...
        >>> thread = api.create_or_alter_user(name, user, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_or_alter_user_with_http_info(name, user,
                                                        **kwargs)  # noqa: E501

    @validate_call
    def create_or_alter_user_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                            user: User,
        ...
        >>> thread = api.create_or_alter_user_with_http_info(name, user, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param user: (required)
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise _APITypeError("Got an unexpected keyword argument '%s'"
                                    " to method create_or_alter_user" % _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    def grant(self, name: Annotated[
        ...
        >>> thread = api.grant(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.grant_with_http_info(name, grant, **kwargs)  # noqa: E501

    @validate_call
    def grant_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
        ...
        >>> thread = api.grant_with_http_info(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    @validate_call
    def revoke_grants(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                      grant: Grant, **kwargs) -> SuccessResponse:  # noqa: E501
        ...
        >>> thread = api.revoke_grants(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.revoke_grants_with_http_info(name, grant,
                                                 **kwargs)  # noqa: E501

    @validate_call
    def revoke_grants_with_http_info(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                                     grant: Grant, **kwargs):  # noqa: E501
        ...
        >>> thread = api.revoke_grants_with_http_info(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)

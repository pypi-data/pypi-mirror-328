...
class RoleApi(object):
    ...
    def create_role(
        ...
        >>> thread = api.create_role(role, create_mode, async_req=True)
        >>> result = thread.get()
        :param role: (required)
        :type role: Role
    ...
    def create_role_with_http_info(
        ...
        >>> thread = api.create_role_with_http_info(role, create_mode, async_req=True)
        >>> result = thread.get()
        :param role: (required)
        :type role: Role
        :param create_mode: Query parameter allowing support for different modes of resource creation. Possible values include: - `errorIfExists`: Throws an error if you try to create a resource that already exists. - `orReplace`: Automatically replaces the existing resource with the current one. - `ifNotExists`: Creates a new resource when an alter is requested for a non-existent resource.
    ...
    @validate_call
    def grant_future_privileges(self, name: Annotated[
        str,
        Field(strict=True,
        ...
        >>> thread = api.grant_future_privileges(name, grant, async_req=True)
        >>> result = thread.get()
    ...
    def grant_future_privileges_with_http_info(self, name: Annotated[
        ...
        >>> thread = api.grant_future_privileges_with_http_info(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    @validate_call
    def grant_privileges(self, name: Annotated[
        str,
        Field(strict=True,
              description="Identifier (i.e. name) for the resource.")],
                         grant: Grant,
        ...
        >>> thread = api.grant_privileges(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def grant_privileges_with_http_info(self, name: Annotated[
        ...
        >>> thread = api.grant_privileges_with_http_info(name, grant, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def list_future_grants(
        ...
        >>> thread = api.list_future_grants(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
    ...
    def list_future_grants_with_http_info(
        ...
        >>> thread = api.list_future_grants_with_http_info(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
    ...
    def list_grants(
        ...
        >>> thread = api.list_grants(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
    ...
    def list_grants_with_http_info(
        ...
        >>> thread = api.list_grants_with_http_info(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
    ...
    def list_grants_of(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[GrantOf]:  # noqa: E501
        ...
        >>> thread = api.list_grants_of(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
    ...
    def list_grants_of_with_http_info(
        ...
        >>> thread = api.list_grants_of_with_http_info(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[GrantOf], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_grants_on(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[GrantOn]:  # noqa: E501
        ...
        >>> thread = api.list_grants_on(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
    ...
    def list_grants_on_with_http_info(
        ...
        >>> thread = api.list_grants_on_with_http_info(name, show_limit, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param show_limit: Query parameter to limit the maximum number of rows returned by a command.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[GrantOn], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_roles(
        ...
        Annotated[
            ...
            **kwargs) -> Iterable[Role]:  # noqa: E501
        ...
        >>> thread = api.list_roles(like, starts_with, show_limit, from_name, async_req=True)
        >>> result = thread.get()
    ...
    def list_roles_with_http_info(
        ...
        >>> thread = api.list_roles_with_http_info(like, starts_with, show_limit, from_name, async_req=True)
        >>> result = thread.get()
        :param like: Query parameter to filter the command output by resource name. Uses case-insensitive pattern matching, with support for SQL wildcard characters.
        :type like: str
        :param starts_with: Query parameter to filter the command output based on the string of characters that appear at the beginning of the object name. Uses case-sensitive pattern matching.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Iterable[Role], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def revoke_future_grants(
        ...
        >>> thread = api.revoke_future_grants(name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def revoke_future_grants_with_http_info(
        ...
        >>> thread = api.revoke_future_grants_with_http_info(name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def revoke_grants(
        ...
        >>> thread = api.revoke_grants(name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def revoke_grants_with_http_info(
        ...
        >>> thread = api.revoke_grants_with_http_info(name, grant, mode, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param grant: (required)
    ...
    def delete_role(
        ...
        >>> thread = api.delete_role(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.
    ...
    def delete_role_with_http_info(
        ...
        >>> thread = api.delete_role_with_http_info(name, if_exists, async_req=True)
        >>> result = thread.get()
        :param name: Identifier (i.e. name) for the resource. (required)
        :type name: str
        :param if_exists: Query parameter that specifies how to handle the request for a resource that does not exist: - `true`: The endpoint does not throw an error if the resource does not exist. It returns a 200 success response, but does not take any action on the resource. - `false`: The endpoint throws an error if the resource doesn't exist.

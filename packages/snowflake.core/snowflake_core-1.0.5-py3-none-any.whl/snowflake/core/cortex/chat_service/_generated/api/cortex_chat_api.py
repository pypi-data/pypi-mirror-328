...
class CortexChatApi(object):
    ...
    @validate_call
    def chat_request(self, chat_request: ChatRequest,
                     **kwargs) -> str:  # noqa: E501
        """Send a Cortex Chat Request.  # noqa: E501.
        ...
        >>> thread = api.chat_request(chat_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.chat_request_with_http_info(chat_request,
                                                **kwargs)  # noqa: E501

    @validate_call
    def chat_request_with_http_info(self, chat_request: ChatRequest,
                                    **kwargs):  # noqa: E501
        """Send a Cortex Chat Request.  # noqa: E501.
        ...
        >>> thread = api.chat_request_with_http_info(chat_request, async_req=True)
        >>> result = thread.get()
        :param chat_request: (required)
        :type chat_request: ChatRequest
        :param async_req: Whether to execute the request asynchronously.

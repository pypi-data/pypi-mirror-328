...
class SemanticTextSplitter:
    ...
    def __init__(self, chunk_size:int=1000, chunk_overlap:float = 0.1, skip_chunk:int = 0, skip_char:int = 0, model:str = "en_core_web_sm"):
        
        chunk_size = chunk_size or 1000  # Default chunk size
        chunk_overlap = chunk_overlap or 0.1  # Default chunk overlap
        skip_chunk = skip_chunk or 0  # Default number of chunks to skip
        skip_char = skip_char or 0  # Default number of characters to skip
        model = model or "en_core_web_sm"  # Default spaCy model

...
@click.option("--object-key", help="Object-key of the Asset (file or folder) to delete the annotation for. This option assumes the default bucket that was previously set with the `set-bucket` command.")

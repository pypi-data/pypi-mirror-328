...
@click.option("--object-key", help="Object-key of the Asset (file or folder) to create the placeholder asset for. This option assumes the default bucket that was previously set with the `set-bucket` command.")

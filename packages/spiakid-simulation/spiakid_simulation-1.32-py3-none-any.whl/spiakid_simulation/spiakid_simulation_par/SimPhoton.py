...
class Simulation():
    ...
    def __init__(self,file ):
        ...
        inx, spdict = cs.FindSpiakidSp(sp_dict, pxnbr, spectrum_desc)
        for i in range(0, stnbr):
            print('star %i'%i)
            self.stars['star_'+str(i)] = self.Star(self.psf,i, spdict['star_'+str(i)]['Spectrum'], spdict['star_'+str(i)]['ratio'])
    ...
    class Star():
            ...
            def __init__(self, psf,i, spname, ratio):
    ...
    #                 else:
    #                     peaks, _ = find_peaks(ntime, prominence = 3, height=m_noise)

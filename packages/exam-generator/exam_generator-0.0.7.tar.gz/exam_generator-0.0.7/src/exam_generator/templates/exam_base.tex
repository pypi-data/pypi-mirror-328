...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{% set clearpage = "\\clearpage \\newpage" %}

\documentclass[addpoints]{exam}
\usepackage{bbm}

{% if dirs.public_git_dir_relative_to_latex %}
...
\item[{% if midterm %}Midterm date:{% else %}Written examination date:{%endif %}]  {{date}}
\item[Course title:] {{course_title}}
\item[Course number:] 02465
\item[Aids allowed:] All aids allowed
\item[{% if midterm %}Midterm{% else %}Exam{%endif %} duration:] {{duration}}
...
{% for t in programming_handin_files %}

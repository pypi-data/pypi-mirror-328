...
// NOTE(milo): Trying to remove the \\ here.
SYMBOL: '\\' [a-zA-Z]+;
...
// NOTE(milo): Originally, the expr rule was followed by the additive rule. I
// inserted expr_relation between to add support for logic in expressions. This
// deserves more thought in the future once I better understand the grammar.
// BEFORE: expr: additive;
expr: expr_relation;
expr_relation: expr_relation (EQUAL | LT | LTE | GT | GTE | NEQ) expr_relation | additive;
...
// NOTE(milo): This causes f(1, 100) to be interpreted as f(1100)!
// number: DIGIT+ (',' DIGIT DIGIT DIGIT)* ('.' DIGIT+)?;
number: DIGIT+ ('.' DIGIT+)?;

// NOTE(milo): Include underscore here?

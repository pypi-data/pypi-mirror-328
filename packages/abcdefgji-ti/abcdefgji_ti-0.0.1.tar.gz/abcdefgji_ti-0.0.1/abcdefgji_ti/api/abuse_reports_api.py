...
class AbuseReportsApi:
    ...
    @validate_call
    def youtube_abuse_reports_insert(
        self,
        ...
        abuse_report: Optional[AbuseReport] = None,
        ...
        :type alt: str
        :param abuse_report:
        :type abuse_report: AbuseReport
        :return: Returns the result object.
        """ # noqa: E501

        _param = self._youtube_abuse_reports_insert_serialize(
            part=part,
    ...
    @validate_call
    def youtube_abuse_reports_insert_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response will include.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def youtube_abuse_reports_insert_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response will include.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _youtube_abuse_reports_insert_serialize(
        self,
        part,
        oauth_token,
        key,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/youtube/v3/abuseReports',

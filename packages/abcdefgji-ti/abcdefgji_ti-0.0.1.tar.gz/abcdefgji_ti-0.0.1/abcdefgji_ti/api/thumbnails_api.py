...
class ThumbnailsApi:
    ...
    def youtube_thumbnails_set(
        self,
        video_id: Annotated[StrictStr, Field(description="Returns the Thumbnail with the given video IDs for Stubby or Apiary.")],
        ...
        :param video_id: Returns the Thumbnail with the given video IDs for Stubby or Apiary. (required)
        :type video_id: str
        ...
        _param = self._youtube_thumbnails_set_serialize(
            video_id=video_id,
    ...
    @validate_call
    def youtube_thumbnails_set_with_http_info(
        self,
        video_id: Annotated[StrictStr, Field(description="Returns the Thumbnail with the given video IDs for Stubby or Apiary.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
        ...
        headers__: Optional[Dict[StrictStr, Any]] = None,
        host__: Optional[StrictStr] = None,
    ) -> ApiResponse[ThumbnailSetResponse]:
        """youtube_thumbnails_set
    ...
    @validate_call
    def youtube_thumbnails_set_without_preload_content(
        self,
        video_id: Annotated[StrictStr, Field(description="Returns the Thumbnail with the given video IDs for Stubby or Apiary.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _youtube_thumbnails_set_serialize(
        self,
        video_id,
        oauth_token,
        key,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/youtube/v3/thumbnails/set',

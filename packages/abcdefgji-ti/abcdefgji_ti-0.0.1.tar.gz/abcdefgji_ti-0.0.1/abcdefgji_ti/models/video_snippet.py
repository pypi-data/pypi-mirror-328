...
class VideoSnippet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tags", "categoryId", "channelId", "channelTitle", "defaultAudioLanguage", "defaultLanguage", "description", "liveBroadcastContent", "localized", "publishedAt", "thumbnails", "title"]

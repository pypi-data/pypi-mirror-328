...
class TestVideoListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VideoListResponse:
        """Test VideoListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoListResponse`
        """
        ...
        if include_optional:
            return VideoListResponse(
                ...
                event_id = '',
                items = [
                    abcdefgji_ti.models.video.Video(
                        age_gating = abcdefgji_ti.models.video_age_gating.VideoAgeGating(
                            alcohol_content = True, 
                            restricted = True, 
                            video_game_rating = 'anyone', ), 
                        content_details = abcdefgji_ti.models.video_content_details.VideoContentDetails(
                            caption = 'true', 
                            content_rating = abcdefgji_ti.models.content_rating.ContentRating(
                            ...
                            country_restriction = abcdefgji_ti.models.access_policy.AccessPolicy(
                                allowed = True, 
                                exception = [
                                    ''
                                    ], ), 
                            ...
                            region_restriction = abcdefgji_ti.models.video_content_details_region_restriction.VideoContentDetailsRegionRestriction(
                                allowed = [
                                    ''
                                    ], 
                                blocked = [
                        ...
                        etag = '', 
                        file_details = abcdefgji_ti.models.video_file_details.VideoFileDetails(
                            audio_streams = [
                                abcdefgji_ti.models.video_file_details_audio_stream.VideoFileDetailsAudioStream(
                                    bitrate_bps = '', 
                                    channel_count = 56, 
                                    codec = '', 
                                    vendor = '', )
                            ...
                            file_type = 'video', 
                            video_streams = [
                                abcdefgji_ti.models.video_file_details_video_stream.VideoFileDetailsVideoStream(
                                    aspect_ratio = 1.337, 
                                    bitrate_bps = '', 
                                    codec = '', 
                        ...
                        id = '', 
                        kind = 'youtube#video', 
                        live_streaming_details = abcdefgji_ti.models.video_live_streaming_details.VideoLiveStreamingDetails(
                            active_live_chat_id = '', 
                        ...
                        monetization_details = abcdefgji_ti.models.video_monetization_details.VideoMonetizationDetails(
                            access = abcdefgji_ti.models.access_policy.AccessPolicy(), ), 
                        paid_product_placement_details = abcdefgji_ti.models.video_paid_product_placement_details.VideoPaidProductPlacementDetails(
                            has_paid_product_placement = True, ), 
                        player = abcdefgji_ti.models.video_player.VideoPlayer(
                            embed_height = '', 
                            embed_html = '', 
                            embed_width = '', ), 
                        processing_details = abcdefgji_ti.models.video_processing_details.VideoProcessingDetails(
                            ...
                            processing_progress = abcdefgji_ti.models.video_processing_details_processing_progress.VideoProcessingDetailsProcessingProgress(
                                parts_processed = '', 
                                parts_total = '', 
                                time_left_ms = '', ), 
                        ...
                        project_details = abcdefgji_ti.models.project_details.projectDetails(), 
                        recording_details = abcdefgji_ti.models.video_recording_details.VideoRecordingDetails(
                            location = abcdefgji_ti.models.geo_point.GeoPoint(
                                altitude = 1.337, 
                                latitude = 1.337, 
                                longitude = 1.337, ), 
                            location_description = '', 
                            recording_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                        snippet = abcdefgji_ti.models.video_snippet.VideoSnippet(
                            tags = [
                                ''
                                ], 
                            category_id = '', 
                            ...
                            localized = abcdefgji_ti.models.video_localization.VideoLocalization(
                                description = '', 
                                title = '', ), 
                            ...
                            thumbnails = abcdefgji_ti.models.thumbnail_details.ThumbnailDetails(
                                ...
                                standard = , ), 
                            title = '', ), 
                        statistics = abcdefgji_ti.models.video_statistics.VideoStatistics(
                            comment_count = '', 
                            dislike_count = '', 
                            favorite_count = '', 
                            like_count = '', 
                            view_count = '', ), 
                        status = abcdefgji_ti.models.video_status.VideoStatus(
                        ...
                        suggestions = abcdefgji_ti.models.video_suggestions.VideoSuggestions(
                            editor_suggestions = [
                                'videoAutoLevels'
                                ], 
                            processing_errors = [
                            ...
                            tag_suggestions = [
                                abcdefgji_ti.models.video_suggestions_tag_suggestion.VideoSuggestionsTagSuggestion(
                                    category_restricts = [
                                        ''
                                        ], 
                                    tag = '', )
                                ], ), 
                        topic_details = abcdefgji_ti.models.video_topic_details.VideoTopicDetails(
                            relevant_topic_ids = [
                                ''
                                ], 
                            topic_categories = [

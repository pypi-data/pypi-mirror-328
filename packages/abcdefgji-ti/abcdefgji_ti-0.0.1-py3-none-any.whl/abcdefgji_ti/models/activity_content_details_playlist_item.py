...
class ActivityContentDetailsPlaylistItem(BaseModel):
    ...
    """ # noqa: E501
    playlist_id: Optional[StrictStr] = Field(default=None, description="The value that YouTube uses to uniquely identify the playlist.", alias="playlistId")
    playlist_item_id: Optional[StrictStr] = Field(default=None, description="ID of the item within the playlist.", alias="playlistItemId")
    resource_id: Optional[ResourceId] = Field(default=None, alias="resourceId")
    __properties: ClassVar[List[str]] = ["playlistId", "playlistItemId", "resourceId"]

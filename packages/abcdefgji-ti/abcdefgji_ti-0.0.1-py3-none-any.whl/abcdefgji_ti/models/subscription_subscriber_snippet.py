...
class SubscriptionSubscriberSnippet(BaseModel):
    ...
    """ # noqa: E501
    channel_id: Optional[StrictStr] = Field(default=None, description="The channel ID of the subscriber.", alias="channelId")
    description: Optional[StrictStr] = Field(default=None, description="The description of the subscriber.")
    thumbnails: Optional[ThumbnailDetails] = None
    title: Optional[StrictStr] = Field(default=None, description="The title of the subscriber.")
    __properties: ClassVar[List[str]] = ["channelId", "description", "thumbnails", "title"]

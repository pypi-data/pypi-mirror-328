...
class VideoAbuseReportReasonsApi:
    ...
    @validate_call
    def youtube_video_abuse_report_reasons_list(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the videoCategory resource parts that the API response will include. Supported values are id and snippet.")],
        ...
        :param part: The *part* parameter specifies the videoCategory resource parts that the API response will include. Supported values are id and snippet. (required)
        :type part: List[str]
        ...
        _param = self._youtube_video_abuse_report_reasons_list_serialize(
            part=part,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VideoAbuseReportReasonListResponse",
        }
    ...
    @validate_call
    def youtube_video_abuse_report_reasons_list_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the videoCategory resource parts that the API response will include. Supported values are id and snippet.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def youtube_video_abuse_report_reasons_list_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the videoCategory resource parts that the API response will include. Supported values are id and snippet.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _youtube_video_abuse_report_reasons_list_serialize(
        self,
        part,
        oauth_token,
        key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/youtube/v3/videoAbuseReportReasons',

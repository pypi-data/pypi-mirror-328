...
class MembersApi:
    ...
    def youtube_members_list(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the member resource parts that the API response will include. Set the parameter value to snippet.")],
        ...
        filter_by_member_channel_id: Annotated[Optional[StrictStr], Field(description="Comma separated list of channel IDs. Only data about members that are part of this list will be included in the response.")] = None,
        has_access_to_level: Annotated[Optional[StrictStr], Field(description="Filter members in the results set to the ones that have access to a level.")] = None,
        max_results: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=0)]], Field(description="The *maxResults* parameter specifies the maximum number of items that should be returned in the result set.")] = None,
        mode: Annotated[Optional[StrictStr], Field(description="Parameter that specifies which channel members to return.")] = None,
        ...
        _param = self._youtube_members_list_serialize(
            part=part,
            ...
            alt=alt,
            filter_by_member_channel_id=filter_by_member_channel_id,
            has_access_to_level=has_access_to_level,
    ...
    @validate_call
    def youtube_members_list_with_http_info(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the member resource parts that the API response will include. Set the parameter value to snippet.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    @validate_call
    def youtube_members_list_without_preload_content(
        self,
        part: Annotated[List[StrictStr], Field(description="The *part* parameter specifies the member resource parts that the API response will include. Set the parameter value to snippet.")],
        oauth_token: Annotated[Optional[StrictStr], Field(description="OAuth 2.0 token for the current user.")] = None,
        key: Annotated[Optional[StrictStr], Field(description="API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.")] = None,
    ...
    def _youtube_members_list_serialize(
        self,
        part,
        oauth_token,
        key,
        ...
        if filter_by_member_channel_id is not None:
            ...
            _query_params.append(('filterByMemberChannelId', filter_by_member_channel_id))
            
        if has_access_to_level is not None:
            
            _query_params.append(('hasAccessToLevel', has_access_to_level))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/youtube/v3/members',

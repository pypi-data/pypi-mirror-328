...
class HydraulicVariableTypes(Enum):
	KS_FUNCTION = "MP_DISTRIBUTION_KS_FUNCTION"
	RELATIVE_KS_FUNCTION = "MP_DISTRIBUTION_KS_RELATIVE_FUNCTION"
	K2K1_FUNCTION = "MP_DISTRIBUTION_K2_K1_FUNCTION"
	K1_ANGLE_FUNCTION = "MP_DISTRIBUTION_K1_ANGLE_FUNCTION"
	WC_SAT_FUNCTION = "MP_DISTRIBUTION_WC_FUNCTION"
	WC_RES_FUNCTION = "MP_DISTRIBUTION_WC_RES_FUNCTION"
	RELATIVE_WC_DOS_FUNCTION = "MP_DISTRIBUTION_WC_RELATIVE_FUNCTION"
	DOS_SAT_FUNCTION = "MP_DISTRIBUTION_DOS_FUNCTION"
	DOS_RES_FUNCTION = "MP_DISTRIBUTION_DOS_RES_FUNCTION"
class HydraulicDistributionTypes(Enum):
	CONSTANT_DISTRIBUTION = "HD_CONSTANT"
	MEAN_STRESS_DISTRIBUTION = "HD_MEAN_STRESS"
	VERTICAL_STRESS_DISTRIBUTION = "HD_VERTICAL_STRESS"
	HORIZONTAL_STRESS_DISTRIBUTION = "HD_HORIZONTAL_STRESS"
	VOLUMETRIC_STRAIN_DISTRIBUTION = "HD_VOLUMETRIC_STRAIN"
	COORDINATE_DISTRIBUTION = "HD_COORDINATE"

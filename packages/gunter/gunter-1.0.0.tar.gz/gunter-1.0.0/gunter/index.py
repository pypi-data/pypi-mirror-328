...
def main(*args):
    ...
    parser.add_argument("-g", "--gtr", required=True, help="Path to the GTR file")
    parser.add_argument("-c", "--char", required=True, help="Path to the file containing the characters")

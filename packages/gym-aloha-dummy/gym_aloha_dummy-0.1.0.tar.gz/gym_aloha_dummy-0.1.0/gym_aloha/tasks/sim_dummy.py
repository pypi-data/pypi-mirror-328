...
from gym_aloha.constants_dummy import (
    START_ARM_POSE,
...
class BimanualDummyTask(base.Task):
...
class TransferCubeDummyTask(BimanualDummyTask):
    def __init__(self, random=None):
        super().__init__(random=random)
        self.max_reward = 4
    ...
    def get_reward(self, physics):
        ...
        touch_left_gripper = ("red_box", "dummy_left/left_finger_link_2") in all_contact_pairs
        touch_right_gripper = ("red_box", "dummy_right/right_finger_link_1") in all_contact_pairs
...
class InsertionDummyTask(BimanualDummyTask):
    def __init__(self, random=None):
        super().__init__(random=random)
        self.max_reward = 4
    ...
    def get_reward(self, physics):
        ...
        touch_right_gripper = ("red_peg", "dummy_right/right_finger_link_1") in all_contact_pairs
        touch_left_gripper = (
            ("socket-1", "dummy_left/left_finger_link_2") in all_contact_pairs
            or ("socket-2", "dummy_left/left_finger_link_2") in all_contact_pairs
            or ("socket-3", "dummy_left/left_finger_link_2") in all_contact_pairs
            or ("socket-4", "dummy_left/left_finger_link_2") in all_contact_pairs
        )

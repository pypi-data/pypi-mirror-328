...
class Hadesr(KaitaiStruct):
    ...
    def _read(self):
        self.cubesat_frame = Hadesr.CubesatFrame(self._io, self, self._root)
    ...
    class IcmgamemsgFrame(KaitaiStruct):
        ...
        def _read(self):
            self.sclock_tmp = self._io.read_u4le()
        ...
        def days(self):
            ...
            self._m_days = self.sclock_tmp // 86400
        ...
        def hours(self):
            ...
            self._m_hours = (self.sclock_tmp % 86400) // 3600
        ...
        def minutes(self):
            ...
            self._m_minutes = (self.sclock_tmp % 3600) // 60
        ...
        def seconds(self):
            ...
            self._m_seconds = (self.sclock_tmp % 60)
    ...
    class FirstHeader(KaitaiStruct):
        ...
        def _read(self):
            ...
            if not  ((self.type == 1) or (self.type == 2) or (self.type == 3) or (self.type == 4) or (self.type == 5) or (self.type == 8) or (self.type == 9)) :
    ...
    class CubesatFrame(KaitaiStruct):
        ...
        def _read(self):
            self.first_header = Hadesr.FirstHeader(self._io, self, self._root)
            _on = self.first_header.type
            if _on == 4:
                self.metadata = Hadesr.PowerstatsFrame(self._io, self, self._root)
            elif _on == 1:
                self.metadata = Hadesr.PowerFrame(self._io, self, self._root)
            elif _on == 3:
                self.metadata = Hadesr.StatusFrame(self._io, self, self._root)
            elif _on == 5:
                self.metadata = Hadesr.TempstatsFrame(self._io, self, self._root)
            elif _on == 8:
                self.metadata = Hadesr.DeployFrame(self._io, self, self._root)
            elif _on == 9:
                self.metadata = Hadesr.ExtpowerstatsFrame(self._io, self, self._root)
            elif _on == 2:
                self.metadata = Hadesr.TempFrame(self._io, self, self._root)

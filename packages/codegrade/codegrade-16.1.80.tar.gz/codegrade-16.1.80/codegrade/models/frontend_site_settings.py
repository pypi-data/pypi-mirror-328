...
class FrontendSiteSettings:
    ...
    #: Whether to disable being able to display the warning for missing
    #: newlines in the code viewer. If we set disable=true, passing the
    #: property to show the warning will be overridden and it will never show.
    warning_for_missing_newline_disabled: Maybe["bool"] = Nothing
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                "WARNING_FOR_MISSING_NEWLINE_DISABLED",
                rqa.SimpleValue.bool,
                doc=(
                    "Whether to disable being able to display the warning for"
                    " missing newlines in the code viewer. If we set"
                    " disable=true, passing the property to show the warning"
                    " will be overridden and it will never show."
                ),
            ),
    ...
    def __post_init__(self) -> None:
        ...
        self.warning_for_missing_newline_disabled = maybe_from_nullable(
            self.warning_for_missing_newline_disabled
        )
    ...
    def to_dict(self) -> t.Dict[str, t.Any]:
        ...
        if self.warning_for_missing_newline_disabled.is_just:
            res["WARNING_FOR_MISSING_NEWLINE_DISABLED"] = to_dict(
                self.warning_for_missing_newline_disabled.value
            )
        return res
    ...
    def from_dict(
        ...
        res = cls(
            ...
            warning_for_missing_newline_disabled=parsed.WARNING_FOR_MISSING_NEWLINE_DISABLED,
        )
        res.raw_data = d
        return res

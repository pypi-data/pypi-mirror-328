...
# @click.command(cls=CommandGui, help="help message that can be quite long, see how it is wrapped to see the sizer in action", short_help="short help message",) # epilog="Check out the doc at https://staging-tstvisualizationtool.entsoe.eu/static/doc/html/building_models/merge_models.html")
# @click.option("--arg_text_really_really_really_long_text", help="arg_text", type=click.STRING, required=False, default="toto")
...
# @click.option("--arg_filepath", type=click.Path(file_okay=True, dir_okay=False, exists=True), required=True)
...
# # @click.option("--arg_choice11", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice12", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice13", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice14", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice15", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice16", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice17", type=click.Choice(["choice1", "choice2"]), required=True)
# # @click.option("--arg_choice18", type=click.Choice(["choice1", "choice2"]), required=True)
# @click.option("--arg_choice19", type=click.Choice(["choice1", "choice2"]), required=True)
...
# @click.option(
#     "--version", help="Show version of the Toolbox and exit", is_flag=True, callback=utils_powsybl.print_version, expose_value=False, is_eager=True
# )

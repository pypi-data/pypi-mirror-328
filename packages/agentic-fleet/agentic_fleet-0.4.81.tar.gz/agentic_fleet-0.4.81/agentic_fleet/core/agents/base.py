...
from autogen_core.agent import ConversableAgent
...
class AgentConfig(BaseModel):
    ...
    system_message: Optional[str] = Field(
        default=None,
        description="System message to configure the agent's behavior"
    )
    model: Optional[str] = Field(
        default=None,
        description="Model identifier to use for this agent"
    )
...
class BaseAgent(ConversableAgent):
    ...
    This class extends ConversableAgent from autogen-core and provides
    ...
    def _get_default_description(self) -> str:
        ...
        return f"An agent that provides assistance with ability to use tools."

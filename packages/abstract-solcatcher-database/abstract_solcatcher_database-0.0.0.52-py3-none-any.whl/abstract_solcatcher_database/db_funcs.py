...
RABBITMQ_HOST = get_env_val("SOLCATCHER_AMQP_HOST")
RABBITMQ_PORT = get_env_val("SOLCATCHER_AMQP_PORT")
RABBITMQ_USER = get_env_val("SOLCATCHER_AMQP_USER")
RABBITMQ_NAME = get_env_val("SOLCATCHER_AMQP_NAME")
RABBITMQ_PASSWORD = get_env_val("SOLCATCHER_AMQP_PASSWORD")

POSTGRESQL_HOST = get_env_val("SOLCATCHER_POSTGRESQL_HOST")
POSTGRESQL_PORT = get_env_val("SOLCATCHER_POSTGRESQL_PORT")
POSTGRESQL_USER = get_env_val("SOLCATCHER_POSTGRESQL_USER")
POSTGRESQL_NAME = get_env_val("SOLCATCHER_POSTGRESQL_NAME")
POSTGRESQL_PASSWORD = get_env_val("SOLCATCHER_POSTGRESQL_PASSWORD")

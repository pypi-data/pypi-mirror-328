from ..query_functions import query_data,getZipRows
...
def get_pairs_from_user_wallets(user_wallets):
    pairs = fetch_any_combo(columnNames='*',tableName='pairs',searchColumn='user_address',searchValue=user_wallets,anyValue=True,)
    return getZipRows('pairs',pairs)

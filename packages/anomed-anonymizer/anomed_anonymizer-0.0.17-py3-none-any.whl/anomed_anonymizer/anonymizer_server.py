...
class InferenceResource:
    ...
    def __init__(
        ...
        download_timeout : float, optional
            ...
            considered faulty. By default 10.0. You might want to increase this
            if you expect that it takes some time to download the training data
            from the challenge.
        upload_timeout : float, optional
            The time in seconds to wait before an upload connection is
            considered faulty. By default 10.0. You might want to increase this
            if you expect that it takes some time to upload predictions to the
            challenge.
        """

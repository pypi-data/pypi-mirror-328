...
class Mouse:
    ...
    def _update(self):
        ...
        self.world_position._x = int((self._core.camera.position.x + pygame.mouse.get_pos()[0] - self._core.__class__._offput[0]) / scale_def()) - 500 / scale_def()
        self.world_position._y = int((self._core.camera.position.y + pygame.mouse.get_pos()[1] - self._core.__class__._offput[1]) / scale_def()) - 300 / scale_def()

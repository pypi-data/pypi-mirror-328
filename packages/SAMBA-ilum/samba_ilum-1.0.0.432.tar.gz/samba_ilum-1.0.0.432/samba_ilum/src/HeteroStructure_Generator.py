...
if (n_Lattice == 3):
   ...
   for s in range(len(files)):
       cont = 0
       #----------------------------------------------------------------------------------------------
       file_lattice3 = files[s].replace("Matching_Lattices","Cells_Lattice").replace("_12.dat",".dat")
       #----------------------------------------------------------------------------------------------
       if os.path.isfile(diret + 'Matching_Lattices' + '/' + files[s]):
          if os.path.isfile(diret + 'cells_Lattice3' + '/' + file_lattice3):
             cont = 1
             #-------
       ...
       if (cont == 1):
          ...
          SLattice3 = np.loadtxt(diret + 'cells_Lattice3' + '/' + file_lattice3); SLattice3.shape
          #---------------------------------------------------------------------------------------------------------------

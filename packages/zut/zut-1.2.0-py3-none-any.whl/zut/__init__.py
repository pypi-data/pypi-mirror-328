...
def find_gdal_library_path():
    """
    See: https://docs.djangoproject.com/en/5.1/ref/contrib/gis/install/geolibs/
    """    
    if os.name == "nt":
        lib_names = [
...
def find_geoip_path():
    """
    See: https://docs.djangoproject.com/en/5.1/ref/contrib/gis/geoip2/
    """
    return Path(__file__).resolve().parent.joinpath('sources', 'lib', 'db-ip')
...
#region Entities
#(Data objects that relate to Django models but can be used outside of a Django project)

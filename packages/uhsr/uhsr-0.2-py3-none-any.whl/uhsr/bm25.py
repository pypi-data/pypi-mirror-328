...
class BM25:
    ...
    def __init__(self, documents, k1=1.5, b=0.75):
        ...
        self.documents = [doc.lower().split() for doc in documents]  # Tokenizing documents
        self.k1 = k1
        self.b = b
    ...
    def compute_idf(self):
        ...
        """
        df = Counter(word for doc in self.documents for word in set(doc))  # Document frequency count
    ...
    def score(self, query, doc_idx):
        ...
        for word in query_words:
            if word in self.idf:
                tf = self.documents[doc_idx].count(word)  # Term frequency

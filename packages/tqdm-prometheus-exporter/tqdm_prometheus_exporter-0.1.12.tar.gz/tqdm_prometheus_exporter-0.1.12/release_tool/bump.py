...
def get_parser():
    ...
    parser.add_argument('release_type', type=str, choices=DryRunRelease.version_components.keys(), help='Version component bump')
    parser.add_argument('--method', '-m', type=str, choices=safety.keys(), default=safety_default, help=f"Release method (default: {safety_default})")

...
# Example of cleaning up the output folder before running:
output_folder = "simple_test_output"
if os.path.exists(output_folder):
    shutil.rmtree(output_folder)


# Made-up simple lists
patients = ["p1", "p2", "p1", "p3", "p2", "p4", "p3", "p4", "p1", "p2", "p1", "p3", "p2", "p4", "p3", "p4"]
drugs =    ["d1", "d2", "d3", "d1", "d3", "d4", "d2", "d4", "d1", "d3", "d4", "d2", "d4", "d4", "d2", "d4"]
response = [0.5, 0.8, 0.3, 0.9, 0.2, 0.7, 0.6, 0.4, 0.3, 0.9, 0.2, 0.7, 0.3, 0.9, 0.2, 0.7]

print("Testing 'random' split type with simple data.")
split4drp(patients, drugs, response, split_type="completely-blind", output_path=output_folder, folds=5, seed=42, val_proportion=0.2)

print("Test complete. Check the folder 'simple_test_output' for output files.")
...
def sensitive_correlation(predictions: Tensor,
                          labels: Tensor,
                          threshold: float,
...
#pytorch type of losses https://pytorch.org/docs/stable/nn.html#loss-functions
# basicos con string, sino function como entry. 

...
const isSuccess = (message) => {
    return (message === null || message === void 0 ? void 0 : message.toLowerCase().includes('success')) || (message === null || message === void 0 ? void 0 : message.toLowerCase().includes('already')) || false;
};
const InstallForm = () => {
...
const PackageList = () => {
    ...
    if (filteredPackages.length === 0) {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Any packages found or notebook is closed. Try refresh page or change kernel.");
    }
...
const PackageContextProvider = ({ children }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PackageContext.Provider, { value: { packages, loading, error, searchTerm, setSearchTerm, refreshPackages: executeCode } }, children));
};
...
const leftTab = {
    ...
    activate: async (app) => {
        ...
        let widget = (0,_packageManagerSidebar__WEBPACK_IMPORTED_MODULE_1__.createPackageManagerSidebar)(notebookWatcher);
...
//# sourceMappingURL=lib_index_js.c1c5c4bf514ee94ca666.js.map
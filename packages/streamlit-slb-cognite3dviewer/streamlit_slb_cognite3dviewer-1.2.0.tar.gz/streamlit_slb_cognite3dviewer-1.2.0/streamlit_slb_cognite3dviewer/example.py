...
def render_viewer():      
    ...
    with threed_container:
        ...
        data_3d = streamlit_slb_cognite3dviewer(height=800, deck_image=deck_image_str, enable_animation=False, floating_content=floating_content, model_path=model_path, data=viewer_data.to_json())
    show_3d_data()

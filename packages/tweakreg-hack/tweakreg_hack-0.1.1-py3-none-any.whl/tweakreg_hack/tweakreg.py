...
def run(configobj):
    ...
    if catnames is None and len(configobj['REFERENCE CATALOG DESCRIPTION']['targcat'])>0:
        catnames,_ = tweakutils.parse_input(configobj['REFERENCE CATALOG DESCRIPTION']['targcat'])
        catnames = [list(catnames)]*len(filenames)

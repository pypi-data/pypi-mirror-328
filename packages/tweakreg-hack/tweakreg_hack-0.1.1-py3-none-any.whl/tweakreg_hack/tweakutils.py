...
def parse_input(input, prodonly=False, sort_wildcards=True):
    ...
    if not isinstance(input, list) and ('_asn' in input or '_asc' in input):
        ...
        if input.find('*') > -1 and sort_wildcards:
            filelist.sort()
        #catlist = [['/ifs/cs/projects/armin1/data/nuts/ToO_Observations/too_sn_2/epoch1_1.cat','/ifs/cs/projects/armin1/data/nuts/ToO_Observations/too_sn_2/epoch1_2.cat']]*2

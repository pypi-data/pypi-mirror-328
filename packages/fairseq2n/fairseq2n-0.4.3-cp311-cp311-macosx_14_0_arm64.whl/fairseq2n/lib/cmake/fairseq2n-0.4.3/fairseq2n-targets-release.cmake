...
set_target_properties(fairseq2n::fairseq2n PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfairseq2n.0.4.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libfairseq2n.0.dylib"
  )

list(APPEND _cmake_import_check_targets fairseq2n::fairseq2n )
list(APPEND _cmake_import_check_files_for_fairseq2n::fairseq2n "${_IMPORT_PREFIX}/lib/libfairseq2n.0.4.3.dylib" )

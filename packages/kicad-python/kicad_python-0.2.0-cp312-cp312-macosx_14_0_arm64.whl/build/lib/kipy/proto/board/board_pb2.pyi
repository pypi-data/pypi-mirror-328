...
class BoardFinish(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['type_name', b'type_name']) -> None:
        ...
...
class BoardImpedanceControl(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['is_controlled', b'is_controlled']) -> None:
        ...
...
class Castellation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['has_castellated_pads', b'has_castellated_pads']) -> None:
        ...
...
class EdgePlating(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['has_edge_plating', b'has_edge_plating']) -> None:
        ...
...
class BoardEdgeSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['castellation', b'castellation', 'connector', b'connector', 'plating', b'plating']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['castellation', b'castellation', 'connector', b'connector', 'plating', b'plating']) -> None:
        ...
...
class BoardStackupDielectricProperties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['epsilon_r', b'epsilon_r', 'loss_tangent', b'loss_tangent', 'material_name', b'material_name', 'thickness', b'thickness']) -> None:
        ...
...
class BoardStackupLayer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['color', b'color', 'dielectric', b'dielectric', 'thickness', b'thickness']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['color', b'color', 'dielectric', b'dielectric', 'enabled', b'enabled', 'layer', b'layer', 'material_name', b'material_name', 'thickness', b'thickness', 'type', b'type', 'user_name', b'user_name']) -> None:
        ...
...
class BoardStackup(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['edge', b'edge', 'finish', b'finish', 'impedance', b'impedance']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['edge', b'edge', 'finish', b'finish', 'impedance', b'impedance', 'layers', b'layers']) -> None:
        ...
...
class BoardLayerGraphicsDefaults(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['line_thickness', b'line_thickness', 'text', b'text']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['layer', b'layer', 'line_thickness', b'line_thickness', 'text', b'text']) -> None:
        ...
...
class BoardSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['graphics_defaults', b'graphics_defaults']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['graphics_defaults', b'graphics_defaults']) -> None:
        ...

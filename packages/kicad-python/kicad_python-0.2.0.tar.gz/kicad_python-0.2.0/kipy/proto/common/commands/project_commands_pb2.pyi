...
class SetNetClasses(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['merge_mode', b'merge_mode', 'net_classes', b'net_classes']) -> None:
        ...
...
class SetTextVariables(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['document', b'document', 'variables', b'variables']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['document', b'document', 'merge_mode', b'merge_mode', 'variables', b'variables']) -> None:
        ...

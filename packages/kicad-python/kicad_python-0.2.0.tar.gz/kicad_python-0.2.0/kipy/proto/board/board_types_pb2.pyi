...
class Track(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['end', b'end', 'id', b'id', 'net', b'net', 'start', b'start', 'width', b'width']) -> builtins.bool:
        ...
...
class Arc(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['end', b'end', 'id', b'id', 'mid', b'mid', 'net', b'net', 'start', b'start', 'width', b'width']) -> builtins.bool:
        ...
...
class ZoneConnectionSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['thermal_spokes', b'thermal_spokes']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['thermal_spokes', b'thermal_spokes', 'zone_connection', b'zone_connection']) -> None:
        ...
...
class SolderMaskOverrides(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['solder_mask_margin', b'solder_mask_margin']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['solder_mask_margin', b'solder_mask_margin']) -> None:
        ...
...
class SolderPasteOverrides(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['solder_paste_margin', b'solder_paste_margin', 'solder_paste_margin_ratio', b'solder_paste_margin_ratio']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['solder_paste_margin', b'solder_paste_margin', 'solder_paste_margin_ratio', b'solder_paste_margin_ratio']) -> None:
        ...
...
class PadStackLayer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['chamfered_corners', b'chamfered_corners', 'offset', b'offset', 'size', b'size', 'trapezoid_delta', b'trapezoid_delta', 'zone_settings', b'zone_settings']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['chamfer_ratio', b'chamfer_ratio', 'chamfered_corners', b'chamfered_corners', 'corner_rounding_ratio', b'corner_rounding_ratio', 'custom_anchor_shape', b'custom_anchor_shape', 'custom_shapes', b'custom_shapes', 'layer', b'layer', 'offset', b'offset', 'shape', b'shape', 'size', b'size', 'trapezoid_delta', b'trapezoid_delta', 'zone_settings', b'zone_settings']) -> None:
        ...
...
class PadStackOuterLayer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['solder_mask_settings', b'solder_mask_settings', 'solder_paste_settings', b'solder_paste_settings']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['solder_mask_mode', b'solder_mask_mode', 'solder_mask_settings', b'solder_mask_settings', 'solder_paste_mode', b'solder_paste_mode', 'solder_paste_settings', b'solder_paste_settings']) -> None:
        ...
...
class DrillProperties(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['diameter', b'diameter']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['diameter', b'diameter', 'end_layer', b'end_layer', 'shape', b'shape', 'start_layer', b'start_layer']) -> None:
        ...
...
class PadStack(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['angle', b'angle', 'back_outer_layers', b'back_outer_layers', 'drill', b'drill', 'front_outer_layers', b'front_outer_layers', 'zone_settings', b'zone_settings']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['angle', b'angle', 'back_outer_layers', b'back_outer_layers', 'copper_layers', b'copper_layers', 'drill', b'drill', 'front_outer_layers', b'front_outer_layers', 'layers', b'layers', 'type', b'type', 'unconnected_layer_removal', b'unconnected_layer_removal', 'zone_settings', b'zone_settings']) -> None:
        ...
...
class Via(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['id', b'id', 'locked', b'locked', 'net', b'net', 'pad_stack', b'pad_stack', 'position', b'position', 'type', b'type']) -> None:
        ...
global___Via = Via
...
class BoardGraphicShape(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['id', b'id', 'net', b'net', 'shape', b'shape']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['id', b'id', 'layer', b'layer', 'locked', b'locked', 'net', b'net', 'shape', b'shape']) -> None:
        ...
...
class BoardText(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['id', b'id', 'knockout', b'knockout', 'layer', b'layer', 'locked', b'locked', 'text', b'text']) -> None:
        ...
...
class BoardTextBox(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['id', b'id', 'textbox', b'textbox']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['id', b'id', 'layer', b'layer', 'locked', b'locked', 'textbox', b'textbox']) -> None:
        ...
...
class ThermalSpokeSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['angle', b'angle', 'gap', b'gap', 'width', b'width']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['angle', b'angle', 'gap', b'gap', 'width', b'width']) -> None:
        ...
...
class Pad(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['copper_clearance_override', b'copper_clearance_override', 'id', b'id', 'net', b'net', 'pad_stack', b'pad_stack', 'position', b'position']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['copper_clearance_override', b'copper_clearance_override', 'id', b'id', 'locked', b'locked', 'net', b'net', 'number', b'number', 'pad_stack', b'pad_stack', 'position', b'position', 'type', b'type']) -> None:
        ...
global___Pad = Pad
...
class HatchFillSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['gap', b'gap', 'orientation', b'orientation', 'thickness', b'thickness']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['border_mode', b'border_mode', 'gap', b'gap', 'hatch_hole_min_area_ratio', b'hatch_hole_min_area_ratio', 'hatch_smoothing_ratio', b'hatch_smoothing_ratio', 'orientation', b'orientation', 'thickness', b'thickness']) -> None:
        ...
...
class CopperZoneSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['clearance', b'clearance', 'connection', b'connection', 'hatch_settings', b'hatch_settings', 'min_thickness', b'min_thickness', 'net', b'net', 'teardrop', b'teardrop']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['clearance', b'clearance', 'connection', b'connection', 'fill_mode', b'fill_mode', 'hatch_settings', b'hatch_settings', 'island_mode', b'island_mode', 'min_island_area', b'min_island_area', 'min_thickness', b'min_thickness', 'net', b'net', 'teardrop', b'teardrop']) -> None:
        ...
...
class RuleAreaSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['keepout_copper', b'keepout_copper', 'keepout_footprints', b'keepout_footprints', 'keepout_pads', b'keepout_pads', 'keepout_tracks', b'keepout_tracks', 'keepout_vias', b'keepout_vias', 'placement_enabled', b'placement_enabled', 'placement_source', b'placement_source', 'placement_source_type', b'placement_source_type']) -> None:
        ...
...
class ZoneBorderSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['pitch', b'pitch']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['pitch', b'pitch', 'style', b'style']) -> None:
        ...
...
class ZoneFilledPolygons(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['shapes', b'shapes']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['layer', b'layer', 'shapes', b'shapes']) -> None:
        ...
...
class Zone(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['border', b'border', 'copper_settings', b'copper_settings', 'id', b'id', 'outline', b'outline', 'rule_area_settings', b'rule_area_settings', 'settings', b'settings']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['border', b'border', 'copper_settings', b'copper_settings', 'filled', b'filled', 'filled_polygons', b'filled_polygons', 'id', b'id', 'layers', b'layers', 'locked', b'locked', 'name', b'name', 'outline', b'outline', 'priority', b'priority', 'rule_area_settings', b'rule_area_settings', 'settings', b'settings', 'type', b'type']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing_extensions.Literal['settings', b'settings']) -> typing_extensions.Literal['copper_settings', 'rule_area_settings'] | None:
        ...
global___Zone = Zone
...
class AlignedDimensionAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['end', b'end', 'extension_height', b'extension_height', 'height', b'height', 'start', b'start']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['end', b'end', 'extension_height', b'extension_height', 'height', b'height', 'start', b'start']) -> None:
        ...
...
class OrthogonalDimensionAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['alignment', b'alignment', 'end', b'end', 'extension_height', b'extension_height', 'height', b'height', 'start', b'start']) -> None:
        ...
...
class RadialDimensionAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['center', b'center', 'leader_length', b'leader_length', 'radius_point', b'radius_point']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['center', b'center', 'leader_length', b'leader_length', 'radius_point', b'radius_point']) -> None:
        ...
...
class LeaderDimensionAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['border_style', b'border_style', 'end', b'end', 'start', b'start']) -> None:
        ...
...
class CenterDimensionAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['center', b'center', 'end', b'end']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['center', b'center', 'end', b'end']) -> None:
        ...
...
class Dimension(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['aligned', b'aligned', 'arrow_length', b'arrow_length', 'center', b'center', 'dimension_style', b'dimension_style', 'extension_offset', b'extension_offset', 'id', b'id', 'leader', b'leader', 'line_thickness', b'line_thickness', 'orthogonal', b'orthogonal', 'radial', b'radial', 'text', b'text']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['aligned', b'aligned', 'arrow_direction', b'arrow_direction', 'arrow_length', b'arrow_length', 'center', b'center', 'dimension_style', b'dimension_style', 'extension_offset', b'extension_offset', 'id', b'id', 'keep_text_aligned', b'keep_text_aligned', 'layer', b'layer', 'leader', b'leader', 'line_thickness', b'line_thickness', 'locked', b'locked', 'orthogonal', b'orthogonal', 'override_text', b'override_text', 'override_text_enabled', b'override_text_enabled', 'precision', b'precision', 'prefix', b'prefix', 'radial', b'radial', 'suffix', b'suffix', 'suppress_trailing_zeroes', b'suppress_trailing_zeroes', 'text', b'text', 'text_position', b'text_position', 'unit', b'unit', 'unit_format', b'unit_format']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing_extensions.Literal['dimension_style', b'dimension_style']) -> typing_extensions.Literal['aligned', 'orthogonal', 'radial', 'leader', 'center'] | None:
        ...
...
class FootprintDesignRuleOverrides(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['copper_clearance', b'copper_clearance', 'solder_mask', b'solder_mask', 'solder_paste', b'solder_paste']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['copper_clearance', b'copper_clearance', 'solder_mask', b'solder_mask', 'solder_paste', b'solder_paste', 'zone_connection', b'zone_connection']) -> None:
        ...
...
class Footprint3DModel(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['offset', b'offset', 'rotation', b'rotation', 'scale', b'scale']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['filename', b'filename', 'offset', b'offset', 'opacity', b'opacity', 'rotation', b'rotation', 'scale', b'scale', 'visible', b'visible']) -> None:
        ...

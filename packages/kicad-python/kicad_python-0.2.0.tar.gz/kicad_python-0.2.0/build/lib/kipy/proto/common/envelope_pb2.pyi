...
class ApiRequestHeader(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['client_name', b'client_name', 'kicad_token', b'kicad_token']) -> None:
        ...
...
class ApiRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['header', b'header', 'message', b'message']) -> None:
        ...
...
class ApiResponseHeader(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['kicad_token', b'kicad_token']) -> None:
        ...
...
class ApiResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['header', b'header', 'message', b'message', 'status', b'status']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['header', b'header', 'message', b'message', 'status', b'status']) -> None:
        ...
...
class ApiResponseStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal['error_message', b'error_message', 'status', b'status']) -> None:
        ...

...
class Stations(ObsinfoClassList):
    ...
    """
    def __init__(self, stations_dict, station_only, operators, comments, leapseconds=None):
        """
        Args:
        ...
        if stations_dict is None:
            ...
            super().__init__([Station(k, v, station_only, operators, comments, leapseconds)
...
class Station(object):
    ...
    def __init__(self, code, attributes_dict, station_only=False,
                 stations_operators=None, stations_comments=None, leapseconds=None):
        """
        Constructor
        ...
        self.processing = Processing(attributes_dict.pop('processing', []), leapseconds)

...
class TestObsinfo(unittest.TestCase):
    ...
    def test_preamp_configurations(self):
        ...
        for config, expect in zip(('16x gain', '32x gain', '64x gain', '128x gain'),
            ...
            self.assertEqual(obj.response_stages.stages[0].gain, expect)
    ...
    def test_change_modifications(self):
        ...
        self.assertEqual(ins.sample_rate, expected_sample_rate)
        self.assertEqual(ins.datalogger.response_stages.stages[3].gain,
                         expected_gain)
    ...
    def _create_test_network(self, network_file):
        ...
        Args:
            network_file (str): file name to read and create
        Returns:
            object of :class:`Network`

        """
        network_dir = Path(os.getcwd()).joinpath(
            "obsinfo", "tests", "data", "Information_Files", "network")

...
@app.command("remote-run", help="Remotely run code on inferless", context_settings={"allow_extra_args": True,"ignore_unknown_options": True})
def remote_run(
    ...
    try:
        ...
        remote_run_prompt(file_path, config_file_path, exclude, dynamic_params, gpu)
    except InferlessCLIError as e:
        rich.print(e)
        raise typer.Exit()

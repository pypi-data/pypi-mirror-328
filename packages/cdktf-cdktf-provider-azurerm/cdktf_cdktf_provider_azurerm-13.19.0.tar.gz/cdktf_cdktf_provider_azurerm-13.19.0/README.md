# CDKTF prebuilt bindings for hashicorp/azurerm provider version 4.20.0

This repo builds and publishes the [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0)

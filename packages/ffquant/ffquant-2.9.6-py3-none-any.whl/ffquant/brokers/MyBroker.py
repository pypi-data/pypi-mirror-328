...
class MyBroker(bt.BrokerBase):
    ...
    (TV_SIM1, TV_SIM2, TV_SIM3, TV_SIM4, TV_SIM5, TV_TEST1, TV_TEST2, FUTU_SIM1, FUTU_REAL) = ("14078173", "14267474", "14267483", "15539511", "15539514", "15539534", "15539537", "9598674", "281756473194939823")
    ...
    def getposition(self, data=None, sync=False):
        ...
        self._update_positions(force_update=(not self.positions.__contains__(symbol)))

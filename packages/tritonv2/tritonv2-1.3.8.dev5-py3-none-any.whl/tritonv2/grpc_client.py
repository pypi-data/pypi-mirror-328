...
class TritonGRPCClient(TritonClient):
    ...
    def __init__(
        ...
        if limiter_config is not None:
            self._client._channel = grpc.intercept_channel(
    ...
    def model_meta(self, model_name, model_version=""):
        """
        get model meta
        :param model_name:
        :param model_version:
    ...
    def server_meta(self, headers=None):
        """
        get server metadata
        Returns
        :return:
        """
        try:
            return self._client.get_server_metadata(headers=headers, as_json=True)
        except Exception as e:
            raise TritonClientException(
                "Failed to get server meta: {}".format(e)
            ) from None

    def server_live(self, headers=None):
        """
        ...
        """
        try:
            return self._client.is_server_live(headers=headers)
        except Exception as e:
            raise TritonClientException(
                "Failed to check server live: {}".format(e)
            ) from None

    def server_ready(self, headers=None):
        """
        ...
        """
        try:
            return self._client.is_server_ready(headers=headers)
        except Exception as e:
            raise TritonClientException(
                "Failed to check server ready: {}".format(e)
            ) from None

    def model_statistics(self, model_name, model_version="", headers=None):
        """
    ...
    def repository_index(self, headers=None):
        """
        ...
        """
        try:
            repository_index_dict = self._client.get_model_repository_index(
    ...
    def repository_model_load(self, model_name, headers=None, config="", files=None):
        """
        load model
        :param model_name:
        :param headers:
    ...
    def system_shared_memory_status(self, region_name="", headers=None):
        """
    ...
    def system_shared_memory_unregister(self, name, headers=None):
        """
    ...
    def cuda_shared_memory_status(self, region_name="", headers=None):
        """
    ...
    def cuda_shared_memory_unregister(self, name, headers=None):
        """
    ...
    def trace_setting(self, model_name="", settings=None, headers=None):
        """

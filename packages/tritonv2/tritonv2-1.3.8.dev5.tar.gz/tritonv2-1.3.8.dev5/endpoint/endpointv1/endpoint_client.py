...
class EndpointClient(BceInternalClient):
    ...
    def get_deployment_manifest(self, workspace_id: str, endpoint_hub_name: str, local_name: str, version: str):
        """
        get deployment manifest.
        :param workspace_id: 工作区 id
        :param endpoint_hub_name: 端点中心名称
        :param local_name: endpoint 名称
        :param version: 版本号
        :return: 部署配置, json
        """
        return self._send_request(http_method=http_methods.GET,
    ...
    def get_endpoint_status(self, workspace_id: str, endpoint_hub_name: str, local_name: str):
        ...
        return self._send_request(http_method=http_methods.GET,
                                  path=bytes("/v1/workspaces/" + workspace_id +
                                             "/endpointhubs/" + endpoint_hub_name + "/endpoints/" + local_name +
                                             "/endpointstatus",
                                             encoding="utf-8"))

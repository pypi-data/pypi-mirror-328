...
class VLLMUser(User):
    """
    Represents a vllm "user" which is to be spawned and attack the system that is to be load tested.
    ...
    This class creates a *client* attribute on instantiation which is an vllm client with support
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.client = client.VLLMClient(endpoint=self.host)



class InferenceUser(VLLMUser):
    """
    ...
    def call_api(self):
        ...
        max_tokens = 1000
        self.client.text_generation(prompt, max_tokens=max_tokens)
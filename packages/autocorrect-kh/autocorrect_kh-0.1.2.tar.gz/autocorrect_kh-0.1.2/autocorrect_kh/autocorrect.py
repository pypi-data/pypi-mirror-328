...
import os, re, json, unicodedata, pkg_resources
...
def load_autocorrect_dicts(folder_name):
    ...
    # Use resource_listdir to get the list of files in the directory
    dict_files = pkg_resources.resource_listdir(__name__, f"data/{folder_name}")

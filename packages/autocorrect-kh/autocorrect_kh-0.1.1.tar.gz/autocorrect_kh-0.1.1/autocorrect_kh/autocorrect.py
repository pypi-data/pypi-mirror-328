# File: autocorrect_kh/autocorrect.py
...
def autocorrect_address_2(address_2_text, khum_dict, district_dict, province_dict):
    ...
    if parts and len(parts) >= 2 and parts[1].isdigit():
        ...
        district = province = ""
    corr_commune = autocorrect_word(commune, khum_dict, max_ratio=0.6)[0]
    corr_district = autocorrect_word(district, district_dict, max_ratio=0.6)[0] if district else ""
    corr_province = autocorrect_word(province, province_dict, max_ratio=0.6)[0] if province else ""

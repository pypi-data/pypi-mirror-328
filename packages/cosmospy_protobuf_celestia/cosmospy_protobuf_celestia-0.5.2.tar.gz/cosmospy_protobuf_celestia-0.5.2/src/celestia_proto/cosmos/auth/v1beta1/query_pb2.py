...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYMODULEACCOUNTSRESPONSE'].fields_by_name['accounts']._serialized_options = b'\xca\xb4-\x0eModuleAccountI'
    ...
    _globals['_QUERY'].methods_by_name['AccountAddressByID']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/cosmos/auth/v1beta1/address_by_id/{id}"
    ...
    _globals['_QUERY'].methods_by_name['ModuleAccounts']._serialized_options = b'\x82\xd3\xe4\x93\x02&\x12$/cosmos/auth/v1beta1/module_accounts'

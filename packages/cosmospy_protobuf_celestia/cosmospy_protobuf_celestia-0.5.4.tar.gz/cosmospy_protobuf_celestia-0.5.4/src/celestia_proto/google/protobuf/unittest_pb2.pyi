...
class ForeignOpenEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    FOREIGN_OPEN_UNKNOWN: _ClassVar[ForeignOpenEnum]
    FOREIGN_OPEN_FOO: _ClassVar[ForeignOpenEnum]
    FOREIGN_OPEN_BAR: _ClassVar[ForeignOpenEnum]
    FOREIGN_OPEN_BAZ: _ClassVar[ForeignOpenEnum]
    FOREIGN_OPEN_BAX: _ClassVar[ForeignOpenEnum]

class TestEnumWithDupValue(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    FOO1: _ClassVar[TestEnumWithDupValue]
    BAR1: _ClassVar[TestEnumWithDupValue]
    BAZ: _ClassVar[TestEnumWithDupValue]
    FOO2: _ClassVar[TestEnumWithDupValue]
    BAR2: _ClassVar[TestEnumWithDupValue]
...
FOREIGN_OPEN_UNKNOWN: ForeignOpenEnum
FOREIGN_OPEN_FOO: ForeignOpenEnum
FOREIGN_OPEN_BAR: ForeignOpenEnum
FOREIGN_OPEN_BAZ: ForeignOpenEnum
FOREIGN_OPEN_BAX: ForeignOpenEnum
...
OPTIONAL_UTF8_STRING_EXTENSION_FIELD_NUMBER: _ClassVar[int]
optional_utf8_string_extension: _descriptor.FieldDescriptor
REPEATED_UTF8_STRING_EXTENSION_FIELD_NUMBER: _ClassVar[int]
repeated_utf8_string_extension: _descriptor.FieldDescriptor
...
REDACTED_EXTENSION_FIELD_NUMBER: _ClassVar[int]
redacted_extension: _descriptor.FieldDescriptor
...
class TestRequiredOpenEnum(_message.Message):
    __slots__ = ("required_enum", "a")
    REQUIRED_ENUM_FIELD_NUMBER: _ClassVar[int]
    A_FIELD_NUMBER: _ClassVar[int]
    required_enum: ForeignOpenEnum
    a: int
    def __init__(self, required_enum: _Optional[_Union[ForeignOpenEnum, str]] = ..., a: _Optional[int] = ...) -> None: ...
...
class TestOneof2(_message.Message):
    ...
    class FooGroup(_message.Message):
        ...
        def __init__(self, a: _Optional[int] = ..., b: _Optional[str] = ...) -> None: ...
    class NestedMessage(_message.Message):
        __slots__ = ("moo_int", "corge_int", "child")
        ...
        child: TestOneof2.NestedMessage
        def __init__(self, moo_int: _Optional[int] = ..., corge_int: _Optional[_Iterable[int]] = ..., child: _Optional[_Union[TestOneof2.NestedMessage, _Mapping]] = ...) -> None: ...
    FOO_INT_FIELD_NUMBER: _ClassVar[int]
    FOO_STRING_FIELD_NUMBER: _ClassVar[int]
...
class OpenEnumMessage(_message.Message):
    __slots__ = ("opt_open", "opt_closed", "repeated_open", "repeated_closed")
    class TestEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN: _ClassVar[OpenEnumMessage.TestEnum]
        FOO: _ClassVar[OpenEnumMessage.TestEnum]
        BAR: _ClassVar[OpenEnumMessage.TestEnum]
        BAZ: _ClassVar[OpenEnumMessage.TestEnum]
    UNKNOWN: OpenEnumMessage.TestEnum
    FOO: OpenEnumMessage.TestEnum
    BAR: OpenEnumMessage.TestEnum
    BAZ: OpenEnumMessage.TestEnum
    OPT_OPEN_FIELD_NUMBER: _ClassVar[int]
    OPT_CLOSED_FIELD_NUMBER: _ClassVar[int]
    REPEATED_OPEN_FIELD_NUMBER: _ClassVar[int]
    REPEATED_CLOSED_FIELD_NUMBER: _ClassVar[int]
    opt_open: OpenEnumMessage.TestEnum
    opt_closed: ForeignEnum
    repeated_open: _containers.RepeatedScalarFieldContainer[OpenEnumMessage.TestEnum]
    repeated_closed: _containers.RepeatedScalarFieldContainer[ForeignEnum]
    def __init__(self, opt_open: _Optional[_Union[OpenEnumMessage.TestEnum, str]] = ..., opt_closed: _Optional[_Union[ForeignEnum, str]] = ..., repeated_open: _Optional[_Iterable[_Union[OpenEnumMessage.TestEnum, str]]] = ..., repeated_closed: _Optional[_Iterable[_Union[ForeignEnum, str]]] = ...) -> None: ...
...
class TestNestedGroupExtensionOuter(_message.Message):
    ...
    LAYER1OPTIONALGROUP_FIELD_NUMBER: _ClassVar[int]
    layer1optionalgroup: TestNestedGroupExtensionOuter.Layer1OptionalGroup
    def __init__(self, layer1optionalgroup: _Optional[_Union[TestNestedGroupExtensionOuter.Layer1OptionalGroup, _Mapping]] = ...) -> None: ...
...
class RedactedFields(_message.Message):
    __slots__ = ("optional_redacted_string", "optional_unredacted_string", "repeated_redacted_string", "repeated_unredacted_string", "optional_redacted_message", "optional_unredacted_message", "repeated_redacted_message", "repeated_unredacted_message", "map_redacted_string", "map_unredacted_string", "optional_redacted_false_string")
    Extensions: _python_message._ExtensionDict
    ...
    OPTIONAL_REDACTED_FALSE_STRING_FIELD_NUMBER: _ClassVar[int]
...
class MessageCreatorZeroInit(_message.Message):
    __slots__ = ("i", "d", "m", "os", "oc", "of", "ol")
    I_FIELD_NUMBER: _ClassVar[int]
    D_FIELD_NUMBER: _ClassVar[int]
    ...
    oc: str
    of: int
    ol: MessageCreatorZeroInit
    def __init__(self, i: _Optional[int] = ..., d: _Optional[float] = ..., m: _Optional[_Union[MessageCreatorZeroInit, _Mapping]] = ..., os: _Optional[str] = ..., oc: _Optional[str] = ..., of: _Optional[int] = ..., ol: _Optional[_Union[MessageCreatorZeroInit, _Mapping]] = ...) -> None: ...

class MessageCreatorMemcpy(_message.Message):
    __slots__ = ("s", "i", "m", "m2")
    ...
    m2: _containers.ScalarMap[int, int]
    def __init__(self, s: _Optional[str] = ..., i: _Optional[_Iterable[int]] = ..., m: _Optional[_Union[MessageCreatorMemcpy, _Mapping]] = ..., m2: _Optional[_Mapping[int, int]] = ...) -> None: ...

class MessageCreatorFunc(_message.Message):
    __slots__ = ("c",)
    C_FIELD_NUMBER: _ClassVar[int]
    c: str

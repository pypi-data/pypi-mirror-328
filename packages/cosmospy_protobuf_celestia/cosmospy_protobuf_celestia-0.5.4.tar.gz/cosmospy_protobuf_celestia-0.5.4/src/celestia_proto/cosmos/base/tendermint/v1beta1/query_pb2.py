...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GETVALIDATORSETBYHEIGHTREQUEST']._serialized_start = 360
    _globals['_GETVALIDATORSETBYHEIGHTREQUEST']._serialized_end = 468
    _globals['_GETVALIDATORSETBYHEIGHTRESPONSE']._serialized_start = 471
    _globals['_GETVALIDATORSETBYHEIGHTRESPONSE']._serialized_end = 650
    _globals['_GETLATESTVALIDATORSETREQUEST']._serialized_start = 652
    _globals['_GETLATESTVALIDATORSETREQUEST']._serialized_end = 742
    _globals['_GETLATESTVALIDATORSETRESPONSE']._serialized_start = 745
    _globals['_GETLATESTVALIDATORSETRESPONSE']._serialized_end = 922
    _globals['_VALIDATOR']._serialized_start = 925
    _globals['_VALIDATOR']._serialized_end = 1067
    _globals['_GETBLOCKBYHEIGHTREQUEST']._serialized_start = 1069
    _globals['_GETBLOCKBYHEIGHTREQUEST']._serialized_end = 1110
    _globals['_GETBLOCKBYHEIGHTRESPONSE']._serialized_start = 1113
    _globals['_GETBLOCKBYHEIGHTRESPONSE']._serialized_end = 1282
    _globals['_GETLATESTBLOCKREQUEST']._serialized_start = 1284
    _globals['_GETLATESTBLOCKREQUEST']._serialized_end = 1307
    _globals['_GETLATESTBLOCKRESPONSE']._serialized_start = 1310
    _globals['_GETLATESTBLOCKRESPONSE']._serialized_end = 1477
    _globals['_GETSYNCINGREQUEST']._serialized_start = 1479
    _globals['_GETSYNCINGREQUEST']._serialized_end = 1498
    _globals['_GETSYNCINGRESPONSE']._serialized_start = 1500
    _globals['_GETSYNCINGRESPONSE']._serialized_end = 1537
    _globals['_GETNODEINFOREQUEST']._serialized_start = 1539
    _globals['_GETNODEINFOREQUEST']._serialized_end = 1559
    _globals['_GETNODEINFORESPONSE']._serialized_start = 1562
    _globals['_GETNODEINFORESPONSE']._serialized_end = 1717
    _globals['_VERSIONINFO']._serialized_start = 1720
    _globals['_VERSIONINFO']._serialized_end = 1930
    _globals['_MODULE']._serialized_start = 1932
    _globals['_MODULE']._serialized_end = 1984
    _globals['_ABCIQUERYREQUEST']._serialized_start = 1986
    _globals['_ABCIQUERYREQUEST']._serialized_end = 2063
    _globals['_ABCIQUERYRESPONSE']._serialized_start = 2066
    _globals['_ABCIQUERYRESPONSE']._serialized_end = 2271
    _globals['_PROOFOP']._serialized_start = 2273
    _globals['_PROOFOP']._serialized_end = 2323
    _globals['_PROOFOPS']._serialized_start = 2325
    _globals['_PROOFOPS']._serialized_end = 2395
    _globals['_SERVICE']._serialized_start = 2398
    _globals['_SERVICE']._serialized_end = 3725
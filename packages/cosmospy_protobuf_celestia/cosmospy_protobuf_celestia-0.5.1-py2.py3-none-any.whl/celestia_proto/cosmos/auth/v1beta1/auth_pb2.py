...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BASEACCOUNT'].fields_by_name['pub_key']._serialized_options = b'\xea\xde\x1f\x14public_key,omitempty'

...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGGRANT']._serialized_options = b'\x82\xe7\xb0*\x07granter'
    ...
    _globals['_MSGEXEC']._serialized_options = b'\x82\xe7\xb0*\x07grantee'
    ...
    _globals['_MSGREVOKE']._serialized_options = b'\x82\xe7\xb0*\x07granter'

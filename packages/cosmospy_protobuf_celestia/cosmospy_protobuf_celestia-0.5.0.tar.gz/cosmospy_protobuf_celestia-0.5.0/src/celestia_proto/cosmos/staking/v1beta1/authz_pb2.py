...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_AUTHORIZATIONTYPE']._serialized_start = 573
    _globals['_AUTHORIZATIONTYPE']._serialized_end = 731
    _globals['_STAKEAUTHORIZATION']._serialized_start = 144
    _globals['_STAKEAUTHORIZATION']._serialized_end = 570
    _globals['_STAKEAUTHORIZATION_VALIDATORS']._serialized_start = 482
    _globals['_STAKEAUTHORIZATION_VALIDATORS']._serialized_end = 537
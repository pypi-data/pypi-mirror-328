...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISOWNERS'].fields_by_name['index_owners']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_GENESISOWNERS']._serialized_end = 239
    _globals['_GENESISSTATE']._serialized_start = 241

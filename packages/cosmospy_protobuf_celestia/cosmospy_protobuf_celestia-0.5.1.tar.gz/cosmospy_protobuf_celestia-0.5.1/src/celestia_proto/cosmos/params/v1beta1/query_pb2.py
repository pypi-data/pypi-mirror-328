...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYSUBSPACESREQUEST']._serialized_start = 281
    _globals['_QUERYSUBSPACESREQUEST']._serialized_end = 304
    _globals['_QUERYSUBSPACESRESPONSE']._serialized_start = 306
    _globals['_QUERYSUBSPACESRESPONSE']._serialized_end = 382
    _globals['_SUBSPACE']._serialized_start = 384
    _globals['_SUBSPACE']._serialized_end = 426

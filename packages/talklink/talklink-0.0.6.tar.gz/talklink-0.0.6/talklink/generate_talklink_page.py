...
def generate_talklink_page(transcript: Transcript, claims: ClaimsData, video_id: str, speakers: str, toc_path="TODO_REPLACE_WITH_TOC_PATH"):
    badgeBackgroundColor = ["#058ed9", "#433e0e","#cebacf","#dc5e42", "#d5b0ac","#cea0ae","#433e0e","#684551","#9cd08f"]
    ...
    data = {
        ...
        "badgeColor": {speaker: badgeBackgroundColor[abs(hash(speaker)) % len(badgeBackgroundColor)] for speaker in speakers},
        "toc": toc_path
    }

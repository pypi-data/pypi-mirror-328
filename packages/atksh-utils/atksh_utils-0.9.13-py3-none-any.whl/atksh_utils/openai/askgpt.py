...
def setup_ai(use_4o) -> OpenAI:
    key = os.getenv("OPENAI_API_KEY")
    ai = OpenAI(key, "gpt-4o-mini" if not use_4o else "gpt-4o-2024-11-20")
...
def ask():
    ...
    parser.add_argument("--use-4o", action="store_true", help="Use GPT-4o.")
    args = parser.parse_args()
    verbose = args.verbose
    if verbose:
        os.environ["ASKGPT_VERBOSE"] = "1"
    ai = setup_ai(args.use_4o)
    not_called = True
    user_prompt = None
    try:
        while True:

...
add_checked_function(mod, 'gotdf_python_EncryptFilesWithExtensionsNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'extensions'), param('int64_t', 'config'), param('int64_t', 'dataAttributes')])
...
add_checked_function(mod, 'gotdf_python_DecryptFilesWithExtensionsNPE', retval('int64_t'), [param('char*', 'dirPath'), param('int64_t', 'extensions'), param('int64_t', 'config')])

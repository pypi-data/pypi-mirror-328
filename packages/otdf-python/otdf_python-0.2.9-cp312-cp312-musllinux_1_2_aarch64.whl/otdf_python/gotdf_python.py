...
def DecryptFilesWithExtensionsNPE(dirPath, extensions, config):
	"""DecryptFilesWithExtensionsNPE(str dirPath, []str extensions, object config) []str, str
	...
	"""
	return go.Slice_string(handle=_gotdf_python.gotdf_python_DecryptFilesWithExtensionsNPE(dirPath, extensions.handle, config.handle))
...
def EncryptFilesWithExtensionsNPE(dirPath, extensions, config, dataAttributes):
	"""EncryptFilesWithExtensionsNPE(str dirPath, []str extensions, object config, []str dataAttributes) []str, str
	...
	in the same directory as the input files, with a .tdf extension added to the file name.
	"""
	return go.Slice_string(handle=_gotdf_python.gotdf_python_EncryptFilesWithExtensionsNPE(dirPath, extensions.handle, config.handle, dataAttributes.handle))
def Hello():
	"""Hello() str

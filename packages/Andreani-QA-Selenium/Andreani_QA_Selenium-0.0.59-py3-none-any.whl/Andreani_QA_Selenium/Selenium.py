...
class Selenium(Functions, Parameters):
    ...
    def open_browser(self, url=None, browser=Parameters.browser, options_headless=Parameters.headless,
        ...
        if browser == "CHROME":
            ...
            if download_path is not None:
                self.path_downloads = download_path
                print(f"La ruta de descargas ha sido actualizada a '{download_path}'")
            options.add_experimental_option("prefs", {"download.default_directory": self.path_downloads,
                                                                "download.prompt_for_download": False,  # Desactiva el popup (no siempre funciona en incognito)
        ...
        Selenium.driver.execute_cdp_cmd("Page.setDownloadBehavior", {
                                        "behavior": "allow",
    ...
    def select_browser(self, browser, options):
        ...
        try:
            if browser == "CHROME":
                URL = "https://storage.googleapis.com/chrome-for-testing-public/128.0.6613.137/win64/chrome-win64.zip"

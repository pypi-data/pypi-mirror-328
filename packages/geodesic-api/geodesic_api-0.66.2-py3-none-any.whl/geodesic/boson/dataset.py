...
class Dataset(Object):
    ...
    def share_files(
        ...
        **extra_settings,
        ...
        """Shares files created on a dataset.
    ...
    def get_files(self) -> List[File]:
        ...
        res = boson_client.get(f"{_servicer_root}/v1/files")
...
class File:
    ...
    def download(self, out_dir: str = "."):
        ...
        res = boson_client.get(self.path)
    ...
    def delete(self):
        ...
        return raise_on_error(boson_client.delete(self.path)).json()

    def status(self):
        """Returns the creation status of this file."""
        return raise_on_error(boson_client.get(f"{self.path}/status")).json()
    ...
    def share(
        ...
        **extra_settings,
        ...
        """Share this File with publically.

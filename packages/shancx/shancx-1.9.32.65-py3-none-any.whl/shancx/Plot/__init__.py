...
def plotGrey(img,name="plotGrey", saveDir="plotRadar",cmap='gray', title='Image'):
...
import matplotlib.pyplot as plt
from shancx import crDir
def plotMat(matrix,name='plotMat',saveDir="plotRadar",title='Matrix Plot', xlabel='X-axis', ylabel='Y-axis', color_label='Value', cmap='viridis'):
    now_str = datetime.datetime.now().strftime("%Y%m%d%H%M%S")    

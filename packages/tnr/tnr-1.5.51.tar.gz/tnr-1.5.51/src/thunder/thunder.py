            ...
            try:
                ...
                with Live(initial_table, refresh_per_second=4, transient=True) as live:
                    ...
                    while True:
                        ...
                        if (changed and previous_instances is not None) or (datetime.datetime.now() - start_time > datetime.timedelta(seconds=90)):
                    ...
                    if has_active_sessions:
                        ...
                        try:
                            ...
                            commands = [
                                ...
                                'sudo install -d -m 755 /etc/thunder',
                                ...
                                # Update preload file
                                f'echo "{remote_path}" | sudo tee /etc/ld.so.preload.new',
...
def _parse_path(path):
    ...
    # Handle Windows drive paths (e.g. C:\path\to\file)

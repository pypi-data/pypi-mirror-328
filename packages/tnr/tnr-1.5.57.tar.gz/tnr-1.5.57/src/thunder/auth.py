...
OAUTH_URL = "https://console.thundercompute.com/?setup=cli"
CONSOLE_URL = "https://console.thundercompute.com/?setup=billing"
...
def login():
    ...
    click.echo(
        click.style(
            f"Success! Return to the console and add a payment method to claim your $20 of free credits: {CONSOLE_URL}",
            fg="green",
        )
    )

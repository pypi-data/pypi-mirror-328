...
from ._constants import SHANGSHANAI_DEFAULT_MAX_RETRIES, SHANGSHANAI_DEFAULT_LIMITS, SHANGSHANAI_DEFAULT_TIMEOUT, \
...
class HttpClient:
    ...
    def __init__(
            ...
            *,
            ...
            base_url: URL,
            _strict_response_validation: bool,
            max_retries: int = SHANGSHANAI_DEFAULT_MAX_RETRIES,
            timeout: Union[float, Timeout, None],
        ...
        return \
            {
                "Accept": "application/json",
                "Content-Type": "application/json; charset=UTF-8",
                "ShangshanAI-SDK-Ver": self._version,

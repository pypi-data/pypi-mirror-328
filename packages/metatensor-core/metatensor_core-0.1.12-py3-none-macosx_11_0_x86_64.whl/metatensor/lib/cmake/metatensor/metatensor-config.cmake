...
if (WIN32)
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/bin/libmetatensor.dylib)
    set(METATENSOR_IMPLIB_LOCATION ${METATENSOR_PREFIX_DIR}/lib/libmetatensor.dylib.lib)
else()
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/lib/libmetatensor.dylib)
endif()

...
if (WIN32)
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/bin/metatensor.dll)
    set(METATENSOR_IMPLIB_LOCATION ${METATENSOR_PREFIX_DIR}/lib/metatensor.dll.lib)
else()
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/lib/metatensor.dll)
endif()

set(METATENSOR_STATIC_LOCATION ${METATENSOR_PREFIX_DIR}/lib/metatensor.lib)

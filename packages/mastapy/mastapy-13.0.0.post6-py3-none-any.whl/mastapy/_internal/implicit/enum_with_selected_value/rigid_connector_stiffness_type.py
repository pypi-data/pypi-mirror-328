...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2591.RigidConnectorStiffnessType":
        ...
        return _2591.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2591.RigidConnectorStiffnessType.type_()":
        ...
        return _2591.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2591.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2591.RigidConnectorStiffnessType]":

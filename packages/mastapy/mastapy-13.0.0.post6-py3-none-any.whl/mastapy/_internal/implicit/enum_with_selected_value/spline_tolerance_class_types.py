...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1417.SplineToleranceClassTypes":
        ...
        return _1417.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1417.SplineToleranceClassTypes.type_()":
        ...
        return _1417.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1417.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1417.SplineToleranceClassTypes]":

...
class ListWithSelectedItem_ElectricMachineSetup(
    _1266.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1266.ElectricMachineSetup.TYPE":
        ...
        return _1266.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1266.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1266.ElectricMachineSetup]":

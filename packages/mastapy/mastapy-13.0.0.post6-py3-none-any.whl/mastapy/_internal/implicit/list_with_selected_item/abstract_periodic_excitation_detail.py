...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5678.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5678.AbstractPeriodicExcitationDetail.TYPE":
        ...
        return _5678.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: Self) -> "_5678.AbstractPeriodicExcitationDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_5678.AbstractPeriodicExcitationDetail]":

...
class ListWithSelectedItem_GuideDxfModel(
    _2455.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2455.GuideDxfModel.TYPE":
        ...
        return _2455.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2455.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2455.GuideDxfModel]":

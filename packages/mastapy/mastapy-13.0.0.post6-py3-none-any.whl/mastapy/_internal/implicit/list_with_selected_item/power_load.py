...
class ListWithSelectedItem_PowerLoad(_2472.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2472.PowerLoad.TYPE":
        ...
        return _2472.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2472.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2472.PowerLoad]":

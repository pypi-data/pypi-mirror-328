...
class ListWithSelectedItem_DesignState(
    _5662.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5662.DesignState.TYPE":
        ...
        return _5662.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5662.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5662.DesignState]":

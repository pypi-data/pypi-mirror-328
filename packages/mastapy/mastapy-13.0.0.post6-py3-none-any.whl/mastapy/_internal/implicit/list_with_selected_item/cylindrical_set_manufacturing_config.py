...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _625.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_625.CylindricalSetManufacturingConfig.TYPE":
        ...
        return _625.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_625.CylindricalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_625.CylindricalSetManufacturingConfig]":

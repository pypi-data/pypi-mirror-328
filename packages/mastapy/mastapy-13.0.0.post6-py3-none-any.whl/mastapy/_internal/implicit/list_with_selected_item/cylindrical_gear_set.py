...
class ListWithSelectedItem_CylindricalGearSet(
    _2526.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2526.CylindricalGearSet.TYPE":
        ...
        return _2526.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2526.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2526.CylindricalGearSet]":

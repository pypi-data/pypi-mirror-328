...
class ListWithSelectedItem_CMSElementFaceGroup(
    _224.CMSElementFaceGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_224.CMSElementFaceGroup.TYPE":
        ...
        return _224.CMSElementFaceGroup.TYPE

    @property
    def selected_value(self: Self) -> "_224.CMSElementFaceGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_224.CMSElementFaceGroup]":

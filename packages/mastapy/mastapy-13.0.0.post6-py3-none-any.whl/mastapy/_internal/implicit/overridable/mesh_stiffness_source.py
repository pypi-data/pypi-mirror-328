...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6923.MeshStiffnessSource":
        ...
        return _6923.MeshStiffnessSource

    @classmethod
    def implicit_type(cls) -> "_6923.MeshStiffnessSource.type_()":
        ...
        return _6923.MeshStiffnessSource.type_()

    @property
    def value(self: Self) -> "_6923.MeshStiffnessSource":
    ...
    @property
    def override_value(self: Self) -> "_6923.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: Self) -> "_6923.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource

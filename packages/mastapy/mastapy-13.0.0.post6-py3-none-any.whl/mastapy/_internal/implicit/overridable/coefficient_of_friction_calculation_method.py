...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_319.CoefficientOfFrictionCalculationMethod":
        ...
        return _319.CoefficientOfFrictionCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_319.CoefficientOfFrictionCalculationMethod.type_()":
        ...
        return _319.CoefficientOfFrictionCalculationMethod.type_()

    @property
    def value(self: Self) -> "_319.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: Self) -> "_319.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: Self) -> "_319.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod

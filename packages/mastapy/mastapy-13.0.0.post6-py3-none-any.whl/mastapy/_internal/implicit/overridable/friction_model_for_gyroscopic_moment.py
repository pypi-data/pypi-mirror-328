...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_1972.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: Self) -> "_1972.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: Self) -> "_1972.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment

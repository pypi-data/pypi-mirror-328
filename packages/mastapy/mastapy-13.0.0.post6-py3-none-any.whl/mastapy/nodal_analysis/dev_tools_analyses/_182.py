...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _180, _181, _183, _200
    from mastapy.nodal_analysis.component_mode_synthesis import _224, _225, _227
...
class FEEntityGroup(_0.APIBase, Generic[T]):
    ...
    class _Cast_FEEntityGroup:
        ...
        @property
        def node_group(self: "FEEntityGroup._Cast_FEEntityGroup") -> "_200.NodeGroup":

...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2177, _2176
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self: Self) -> "List[_2177.BearingImportFile]":
    ...
    @property
    def variables(self: Self) -> "List[_2176.AbstractXmlVariableAssignment]":

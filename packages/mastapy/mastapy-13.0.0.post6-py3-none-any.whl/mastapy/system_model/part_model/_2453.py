...
class FEPart(_2436.AbstractShaftOrHousing):
    ...
    class _Cast_FEPart:
        ...
        @property
        def component(self: "FEPart._Cast_FEPart") -> "_2444.Component":
            from mastapy.system_model.part_model import _2444

            return self._parent._cast(_2444.Component)

        @property
        def part(self: "FEPart._Cast_FEPart") -> "_2468.Part":
            from mastapy.system_model.part_model import _2468

            return self._parent._cast(_2468.Part)

        @property
        def design_entity(self: "FEPart._Cast_FEPart") -> "_2203.DesignEntity":
            from mastapy.system_model import _2203

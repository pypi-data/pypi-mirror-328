...
if TYPE_CHECKING:
    from mastapy.utility.report import _1744, _1787
...
class CustomRow(_1773.CustomReportPropertyItem):
    ...
    class _Cast_CustomRow:
        ...
        @property
        def blank_row(self: "CustomRow._Cast_CustomRow") -> "_1744.BlankRow":
            from mastapy.utility.report import _1744

            return self._parent._cast(_1744.BlankRow)

        @property
        def user_text_row(self: "CustomRow._Cast_CustomRow") -> "_1787.UserTextRow":

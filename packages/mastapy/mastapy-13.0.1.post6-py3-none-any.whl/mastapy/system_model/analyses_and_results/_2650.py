...
class Context(_0.APIBase):
    ...
    class _Cast_Context:
        ...
        @property
        def power_flow(self: "Context._Cast_Context") -> "_4122.PowerFlow":
            from mastapy.system_model.analyses_and_results.power_flows import _4122
        ...
        @property
        def modal_analysis(self: "Context._Cast_Context") -> "_4654.ModalAnalysis":
        ...
        @property
        def dynamic_analysis(self: "Context._Cast_Context") -> "_6329.DynamicAnalysis":
            from mastapy.system_model.analyses_and_results.dynamic_analyses import _6329
        ...
        @property
        def load_case(self: "Context._Cast_Context") -> "_6804.LoadCase":
            from mastapy.system_model.analyses_and_results.static_loads import _6804

            return self._parent._cast(_6804.LoadCase)

        @property
        def static_load_case(self: "Context._Cast_Context") -> "_6805.StaticLoadCase":
        ...
        @property
        def analysis_case(self: "Context._Cast_Context") -> "_7535.AnalysisCase":
        ...
        @property
        def fe_analysis(self: "Context._Cast_Context") -> "_7544.FEAnalysis":

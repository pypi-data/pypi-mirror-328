...
class Assembly(_2434.AbstractAssembly):
    ...
    class _Cast_Assembly:
        ...
        @property
        def part(self: "Assembly._Cast_Assembly") -> "_2468.Part":
            return self._parent._cast(_2468.Part)

        @property
        def design_entity(self: "Assembly._Cast_Assembly") -> "_2203.DesignEntity":
            from mastapy.system_model import _2203

            return self._parent._cast(_2203.DesignEntity)

        @property
        def root_assembly(self: "Assembly._Cast_Assembly") -> "_2474.RootAssembly":

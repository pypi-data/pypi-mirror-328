...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2069.RollerAnalysisMethod":
        ...
        return _2069.RollerAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_2069.RollerAnalysisMethod.type_()":
        ...
        return _2069.RollerAnalysisMethod.type_()

    @property
    def value(self: Self) -> "_2069.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: Self) -> "_2069.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: Self) -> "_2069.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod

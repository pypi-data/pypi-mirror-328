...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2402.NodeSelectionDepthOption":
        ...
        return _2402.NodeSelectionDepthOption

    @classmethod
    def implicit_type(cls) -> "_2402.NodeSelectionDepthOption.type_()":
        ...
        return _2402.NodeSelectionDepthOption.type_()

    @property
    def value(self: Self) -> "_2402.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: Self) -> "_2402.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: Self) -> "_2402.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption

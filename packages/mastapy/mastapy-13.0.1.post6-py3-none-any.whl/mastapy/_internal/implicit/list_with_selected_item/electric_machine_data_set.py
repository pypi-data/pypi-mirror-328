...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2373.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2373.ElectricMachineDataSet.TYPE":
        ...
        return _2373.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2373.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2373.ElectricMachineDataSet]":

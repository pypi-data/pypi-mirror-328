...
class ListWithSelectedItem_DutyCycle(_5664.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5664.DutyCycle.TYPE":
        ...
        return _5664.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5664.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5664.DutyCycle]":

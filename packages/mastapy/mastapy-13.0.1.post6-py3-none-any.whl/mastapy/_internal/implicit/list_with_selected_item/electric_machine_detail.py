...
class ListWithSelectedItem_ElectricMachineDetail(
    _1261.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1261.ElectricMachineDetail.TYPE":
        ...
        return _1261.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1261.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1261.ElectricMachineDetail]":

...
class ListWithSelectedItem_FEPart(_2453.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2453.FEPart.TYPE":
        ...
        return _2453.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2453.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2453.FEPart]":

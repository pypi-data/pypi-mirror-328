...
class ListWithSelectedItem_PointLoad(_2471.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2471.PointLoad.TYPE":
        ...
        return _2471.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2471.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2471.PointLoad]":

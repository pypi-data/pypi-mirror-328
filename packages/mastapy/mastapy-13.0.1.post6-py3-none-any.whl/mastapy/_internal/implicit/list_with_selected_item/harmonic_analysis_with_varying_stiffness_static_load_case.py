...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        cls,
    ) -> "_5770.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE":
        ...
        return _5770.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_5770.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":

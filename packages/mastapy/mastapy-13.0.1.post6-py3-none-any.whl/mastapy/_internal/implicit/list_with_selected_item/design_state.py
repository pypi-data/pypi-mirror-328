...
class ListWithSelectedItem_DesignState(
    _5663.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5663.DesignState.TYPE":
        ...
        return _5663.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5663.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5663.DesignState]":

...
class ListWithSelectedItem_ElectricMachineResults(
    _1325.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1325.ElectricMachineResults.TYPE":
        ...
        return _1325.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1325.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1325.ElectricMachineResults]":

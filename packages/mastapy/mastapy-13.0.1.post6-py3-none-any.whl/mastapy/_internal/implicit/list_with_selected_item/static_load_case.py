...
class ListWithSelectedItem_StaticLoadCase(
    _6805.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6805.StaticLoadCase.TYPE":
        ...
        return _6805.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6805.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6805.StaticLoadCase]":

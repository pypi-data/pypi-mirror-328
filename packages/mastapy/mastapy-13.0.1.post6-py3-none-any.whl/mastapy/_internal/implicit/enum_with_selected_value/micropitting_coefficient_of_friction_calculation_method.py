...
class EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_338.MicropittingCoefficientOfFrictionCalculationMethod":
        ...
        return _338.MicropittingCoefficientOfFrictionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_338.MicropittingCoefficientOfFrictionCalculationMethod.type_()":
        ...
        return _338.MicropittingCoefficientOfFrictionCalculationMethod.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_338.MicropittingCoefficientOfFrictionCalculationMethod]":

...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_5745.ExportOutputType":
        ...
        return _5745.ExportOutputType

    @classmethod
    def implicit_type(cls) -> "_5745.ExportOutputType.type_()":
        ...
        return _5745.ExportOutputType.type_()

    @property
    def selected_value(self: Self) -> "_5745.ExportOutputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5745.ExportOutputType]":

...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1871.BasicStaticLoadRatingCalculationMethod":
        ...
        return _1871.BasicStaticLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1871.BasicStaticLoadRatingCalculationMethod.type_()":
        ...
        return _1871.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1871.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1871.BasicStaticLoadRatingCalculationMethod]":

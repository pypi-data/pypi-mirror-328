...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2158.HeightSeries":
        ...
        return _2158.HeightSeries

    @classmethod
    def implicit_type(cls) -> "_2158.HeightSeries.type_()":
        ...
        return _2158.HeightSeries.type_()

    @property
    def value(self: Self) -> "_2158.HeightSeries":
    ...
    @property
    def override_value(self: Self) -> "_2158.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2158.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries

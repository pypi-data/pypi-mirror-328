...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1942.CylindricalRollerMaxAxialLoadMethod":
        ...
        return _1942.CylindricalRollerMaxAxialLoadMethod

    @classmethod
    def implicit_type(cls) -> "_1942.CylindricalRollerMaxAxialLoadMethod.type_()":
        ...
        return _1942.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: Self) -> "_1942.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: Self) -> "_1942.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: Self) -> "_1942.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod

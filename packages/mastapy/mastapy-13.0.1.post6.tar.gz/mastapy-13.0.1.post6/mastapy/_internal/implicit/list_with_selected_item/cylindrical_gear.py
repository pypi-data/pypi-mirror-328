...
class ListWithSelectedItem_CylindricalGear(
    _2525.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2525.CylindricalGear.TYPE":
        ...
        return _2525.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2525.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2525.CylindricalGear]":

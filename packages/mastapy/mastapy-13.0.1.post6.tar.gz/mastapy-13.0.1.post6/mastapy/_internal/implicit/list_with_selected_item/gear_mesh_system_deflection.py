...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2759.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2759.GearMeshSystemDeflection.TYPE":
        ...
        return _2759.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2759.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2759.GearMeshSystemDeflection]":

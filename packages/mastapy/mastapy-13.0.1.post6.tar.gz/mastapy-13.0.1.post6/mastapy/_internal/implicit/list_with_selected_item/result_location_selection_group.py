...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5851
...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5851.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5851.ResultLocationSelectionGroup.TYPE":
        ...
        return _5851.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_5851.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_5851.ResultLocationSelectionGroup]":

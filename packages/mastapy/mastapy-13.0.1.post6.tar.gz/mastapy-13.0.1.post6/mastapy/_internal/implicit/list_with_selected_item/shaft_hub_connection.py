...
class ListWithSelectedItem_ShaftHubConnection(
    _2598.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2598.ShaftHubConnection.TYPE":
        ...
        return _2598.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2598.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2598.ShaftHubConnection]":

...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2594.RigidConnectorToothSpacingType":
        ...
        return _2594.RigidConnectorToothSpacingType

    @classmethod
    def implicit_type(cls) -> "_2594.RigidConnectorToothSpacingType.type_()":
        ...
        return _2594.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: Self) -> "_2594.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: Self) -> "List[_2594.RigidConnectorToothSpacingType]":

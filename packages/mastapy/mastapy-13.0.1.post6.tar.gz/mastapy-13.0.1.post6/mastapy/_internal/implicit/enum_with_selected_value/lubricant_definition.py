...
class EnumWithSelectedValue_LubricantDefinition(
    ...
    @classmethod
    def wrapped_type(cls) -> "_261.LubricantDefinition":
        ...
        return _261.LubricantDefinition

    @classmethod
    def implicit_type(cls) -> "_261.LubricantDefinition.type_()":
        ...
        return _261.LubricantDefinition.type_()

    @property
    def selected_value(self: Self) -> "_261.LubricantDefinition":
    ...
    @property
    def available_values(self: Self) -> "List[_261.LubricantDefinition]":

...
ERROR_4D_SET_PROPERTY = (
    "Cannot set W component of Matrix4x4 column "
...
class Matrix4x4(MatrixBase):
    ...
    @classmethod
    def from_iterable(
        cls, t: Union[Iterable[Iterable[NUM]], Iterable[NUM]]
    ) -> "Matrix4x4":
    ...
    def m41(self, value: NUM):
        if self.wrapped:
            self.wrapped.Translation = _convert((value, self.m42, self.m43))
    ...
    def m42(self, value: NUM):
        if self.wrapped:
            self.wrapped.Translation = _convert((self.m41, value, self.m43))
    ...
    def m43(self, value: NUM):
        if self.wrapped:
            self.wrapped.Translation = _convert((self.m41, self.m42, value))
    ...
    def column0(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.XAxis = _convert((value[0], value[1], value[2]))
    ...
    def column1(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.YAxis = _convert((value[0], value[1], value[2]))
    ...
    def column2(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.ZAxis = _convert((value[0], value[1], value[2]))
    ...
    def column3(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.Translation = _convert((value[0], value[1], value[2]))
    ...
    def row0(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.XAxis = _convert((value[0], self.m12, self.m13))
            self.wrapped.YAxis = _convert((value[1], self.m22, self.m23))
            self.wrapped.ZAxis = _convert((value[2], self.m32, self.m33))
            self.wrapped.Translation = _convert((value[3], self.m42, self.m43))
    ...
    def row1(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.XAxis = _convert((self.m11, value[0], self.m13))
            self.wrapped.YAxis = _convert((self.m21, value[1], self.m23))
            self.wrapped.ZAxis = _convert((self.m31, value[2], self.m33))
            self.wrapped.Translation = _convert((self.m41, value[3], self.m43))
    ...
    def row2(self, value: MATRIX_TYPE):
        ...
        if self.wrapped:
            self.wrapped.XAxis = _convert((self.m11, self.m12, value[0]))
            self.wrapped.YAxis = _convert((self.m21, self.m22, value[1]))
            self.wrapped.ZAxis = _convert((self.m31, self.m32, value[2]))
            self.wrapped.Translation = _convert((self.m41, self.m42, value[3]))
    ...
    @classmethod
    def _force_dim(
        cls, v: MATRIX_TYPE, fill: float = 0.0, use_fill_for_scalar: bool = False
    ) -> "Matrix4x4":
        ...
        if b:
            ...
            with_scalar = Matrix4x4(v, v, v, v, v, v, v, v, v, v, v, v, v, v, v, v)
    ...
    @classmethod
    def _force_dim_vec(cls, v: MATRIX_TYPE, sizes: Tuple[int] = (4, 16)) -> Tuple[NUM]:
        try:
            if isinstance(v, Matrix4x4):
                return v
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[List[Vector4D], Vector4D]:
    ...
    def __setitem__(self, index: Union[int, slice], value: MATRIX_TYPE):
        ...
        def _set2(index: Union[int, slice], value: MATRIX_TYPE):
            if isinstance(index, slice):
                ...
                for i in range(*index.indices(len(self))):
                    if hasattr(value, "__iter__") and hasattr(value[i], "__iter__"):
                        _set(i, value[i])
                    else:
                        _set(i, value)
            else:
    ...
    def __eq__(self, value: MATRIX_TYPE) -> Tuple[bool]:
        try:
            values = self._force_dim(value)
            return tuple(map(lambda t: t[0] == t[1], zip(self._values, values._values)))
        except ValueError:
            raise MatrixException(ERROR_4D_MESSAGE) from None

    def __lt__(self, value: MATRIX_TYPE) -> Tuple[bool]:
        try:
            values = self._force_dim(value)
            return tuple(map(lambda t: t[0] < t[1], zip(self._values, values._values)))
        except ValueError:
    ...
    def __le__(self, value: MATRIX_TYPE) -> Tuple[bool]:
        try:
            values = self._force_dim(value)
            return tuple(map(lambda t: t[0] <= t[1], zip(self._values, values._values)))
        except ValueError:
    ...
    def __gt__(self, value: MATRIX_TYPE) -> Tuple[bool]:
        try:
            values = self._force_dim(value)
            return tuple(map(lambda t: t[0] > t[1], zip(self._values, values._values)))
        except ValueError:
    ...
    def __ge__(self, value: MATRIX_TYPE) -> Tuple[bool]:
        try:
            values = self._force_dim(value)
            return tuple(map(lambda t: t[0] >= t[1], zip(self._values, values._values)))
        except ValueError:
    ...
    @classmethod
    def transform_point(cls, matrix: MATRIX_TYPE, point: Iterable[NUM]) -> Vector3D:
        ...
        if not hasattr(point, "__iter__") or lp not in (3, 4):
            raise MatrixException(
                ("Failed to transform value. " "Expected a Vector3D or Vector4D.")
            ) from None
    ...
    def transform_direction(
        cls, matrix: MATRIX_TYPE, direction: Iterable[NUM]
    ) -> Vector3D:
        ...
        return (
            (matrix @ Vector4D(*direction, 0.0)).xyz
            if ld == 3
    ...
    @classmethod
    def translation(cls, x: NUM = 0.0, y: NUM = 0.0, z: NUM = 0.0) -> "Matrix4x4":
    ...
    @classmethod
    def rotation(cls, axis: Iterable[NUM], angle: NUM) -> "Matrix4x4":

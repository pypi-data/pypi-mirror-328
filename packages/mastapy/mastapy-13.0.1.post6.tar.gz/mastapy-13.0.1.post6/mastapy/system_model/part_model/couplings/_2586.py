...
class CVT(_2576.BeltDrive):
    ...
    class _Cast_CVT:
        ...
        @property
        def belt_drive(self: "CVT._Cast_CVT") -> "_2576.BeltDrive":
            return self._parent._cast(_2576.BeltDrive)

        @property
        def specialised_assembly(self: "CVT._Cast_CVT") -> "_2476.SpecialisedAssembly":
            from mastapy.system_model.part_model import _2476

            return self._parent._cast(_2476.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "CVT._Cast_CVT") -> "_2434.AbstractAssembly":
            from mastapy.system_model.part_model import _2434

            return self._parent._cast(_2434.AbstractAssembly)

        @property
        def part(self: "CVT._Cast_CVT") -> "_2468.Part":
            from mastapy.system_model.part_model import _2468

            return self._parent._cast(_2468.Part)

        @property
        def design_entity(self: "CVT._Cast_CVT") -> "_2203.DesignEntity":
            from mastapy.system_model import _2203

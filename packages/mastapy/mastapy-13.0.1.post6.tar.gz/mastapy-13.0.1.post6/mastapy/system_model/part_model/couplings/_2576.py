...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2577, _2590, _2586
...
class BeltDrive(_2476.SpecialisedAssembly):
    ...
    class _Cast_BeltDrive:
        ...
        @property
        def part(self: "BeltDrive._Cast_BeltDrive") -> "_2468.Part":
            from mastapy.system_model.part_model import _2468

            return self._parent._cast(_2468.Part)

        @property
        def design_entity(self: "BeltDrive._Cast_BeltDrive") -> "_2203.DesignEntity":
            from mastapy.system_model import _2203

            return self._parent._cast(_2203.DesignEntity)

        @property
        def cvt(self: "BeltDrive._Cast_BeltDrive") -> "_2586.CVT":

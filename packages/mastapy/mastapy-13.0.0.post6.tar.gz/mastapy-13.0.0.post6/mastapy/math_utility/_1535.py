...
class Vector6D(_1525.RealVector):
    ...
    class _Cast_Vector6D:
        ...
        @property
        def real_vector(self: "Vector6D._Cast_Vector6D") -> "_1525.RealVector":
            return self._parent._cast(_1525.RealVector)

        @property
        def real_matrix(self: "Vector6D._Cast_Vector6D") -> "_1524.RealMatrix":
            from mastapy.math_utility import _1524

            return self._parent._cast(_1524.RealMatrix)

        @property
        def generic_matrix(self: "Vector6D._Cast_Vector6D") -> "_1513.GenericMatrix":

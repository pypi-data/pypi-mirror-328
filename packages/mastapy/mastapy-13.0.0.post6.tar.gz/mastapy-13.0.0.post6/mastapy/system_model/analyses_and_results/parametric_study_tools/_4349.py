...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self: Self) -> "_4350.DutyCycleResultsForAllGearSets":
    ...
    def results_for_all_bearings(
        self: Self,
    ) -> "List[_4352.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: Self,
    ) -> "List[_4353.DutyCycleResultsForSingleShaft]":

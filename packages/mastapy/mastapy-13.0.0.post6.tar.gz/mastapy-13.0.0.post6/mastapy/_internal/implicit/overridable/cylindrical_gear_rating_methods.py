...
class Overridable_CylindricalGearRatingMethods(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_251.CylindricalGearRatingMethods":
    ...
    @property
    def override_value(self: Self) -> "_251.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
    ...
    @property
    def calculated_value(self: Self) -> "_251.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods

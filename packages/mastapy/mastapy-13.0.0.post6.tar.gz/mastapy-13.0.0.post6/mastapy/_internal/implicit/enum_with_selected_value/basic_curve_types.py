...
class EnumWithSelectedValue_BasicCurveTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_313.BasicCurveTypes":
        ...
        return _313.BasicCurveTypes

    @classmethod
    def implicit_type(cls) -> "_313.BasicCurveTypes.type_()":
        ...
        return _313.BasicCurveTypes.type_()

    @property
    def selected_value(self: Self) -> "_313.BasicCurveTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_313.BasicCurveTypes]":

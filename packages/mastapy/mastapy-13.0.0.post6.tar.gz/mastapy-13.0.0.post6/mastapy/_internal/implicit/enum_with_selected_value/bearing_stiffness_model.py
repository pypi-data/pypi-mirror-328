...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5385.BearingStiffnessModel":
        ...
        return _5385.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5385.BearingStiffnessModel.type_()":
        ...
        return _5385.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5385.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5385.BearingStiffnessModel]":

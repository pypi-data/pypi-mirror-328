...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2219.PowerLoadType":
        ...
        return _2219.PowerLoadType

    @classmethod
    def implicit_type(cls) -> "_2219.PowerLoadType.type_()":
        ...
        return _2219.PowerLoadType.type_()

    @property
    def selected_value(self: Self) -> "_2219.PowerLoadType":
    ...
    @property
    def available_values(self: Self) -> "List[_2219.PowerLoadType]":

...
class ListWithSelectedItem_DutyCycle(_5663.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5663.DutyCycle.TYPE":
        ...
        return _5663.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5663.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5663.DutyCycle]":

...
class ListWithSelectedItem_SystemDirectory(
    _1600.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1600.SystemDirectory.TYPE":
        ...
        return _1600.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1600.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1600.SystemDirectory]":

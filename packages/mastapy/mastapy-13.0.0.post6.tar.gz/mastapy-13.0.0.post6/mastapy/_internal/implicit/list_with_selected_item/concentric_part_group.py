...
class ListWithSelectedItem_ConcentricPartGroup(
    _2487.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2487.ConcentricPartGroup.TYPE":
        ...
        return _2487.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2487.ConcentricPartGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2487.ConcentricPartGroup]":

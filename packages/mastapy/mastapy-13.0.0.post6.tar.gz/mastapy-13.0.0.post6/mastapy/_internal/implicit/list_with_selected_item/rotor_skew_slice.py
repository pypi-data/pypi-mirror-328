...
class ListWithSelectedItem_RotorSkewSlice(
    _1294.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1294.RotorSkewSlice.TYPE":
        ...
        return _1294.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1294.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1294.RotorSkewSlice]":

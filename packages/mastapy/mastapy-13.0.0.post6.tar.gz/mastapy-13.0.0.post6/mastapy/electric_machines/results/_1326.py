...
class ElectricMachineResultsForConductorTurn(_0.APIBase):
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_ElectricMachineResultsForConductorTurn"
    )
    ...
    class _Cast_ElectricMachineResultsForConductorTurn:
        ...
        def __init__(
            self: "ElectricMachineResultsForConductorTurn._Cast_ElectricMachineResultsForConductorTurn",
            parent: "ElectricMachineResultsForConductorTurn",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self, instance_to_wrap: "ElectricMachineResultsForConductorTurn.TYPE"
    ):
    ...
    def cast_to(
        self: Self,
    ) -> "ElectricMachineResultsForConductorTurn._Cast_ElectricMachineResultsForConductorTurn":

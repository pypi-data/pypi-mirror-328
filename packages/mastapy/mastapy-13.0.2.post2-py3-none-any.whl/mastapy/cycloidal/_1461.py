...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1462, _1465
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1874.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1462.CycloidalDiscDesignExporter":

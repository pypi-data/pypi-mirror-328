...
if TYPE_CHECKING:
    from mastapy.utility import _1600, _1586
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: Self) -> "_1600.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1586.DispatcherHelper]":

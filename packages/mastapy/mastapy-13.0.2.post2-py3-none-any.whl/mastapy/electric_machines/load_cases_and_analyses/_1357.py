...
class EfficiencyMapAnalysis(_1359.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: Self) -> "_1329.EfficiencyResults":
    ...
    @property
    def load_case(self: Self) -> "_1358.EfficiencyMapLoadCase":

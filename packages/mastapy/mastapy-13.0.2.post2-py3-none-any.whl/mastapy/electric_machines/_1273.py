...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1316, _1267
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electro_magnetic_analysis(
        self: Self,
    ) -> "_1316.TwoDimensionalFEModelForAnalysis[_1271.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1267.Eccentricity":

...
if TYPE_CHECKING:
    from mastapy.bolts import _1482, _1487, _1490, _1475, _1477, _1473
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: Self) -> "List[_1482.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: Self, value: "List[_1482.ClampedSection]"):
    ...
    @property
    def joint_geometry(self: Self) -> "_1487.JointGeometries":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1487", "JointGeometries")(
            value
        )

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: Self, value: "_1487.JointGeometries"):
    ...
    def rolled_before_or_after_heat_treatment(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bolts._1490", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: Self, value: "_1490.RolledBeforeOrAfterHeatTreatment"
    ):
    ...
    @property
    def bolt_geometry(self: Self) -> "_1475.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: Self) -> "_1477.BoltMaterial":
    ...
    @property
    def material_of_nut(self: Self) -> "_1473.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: Self) -> "_1473.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: Self) -> "List[_1482.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]

...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    @classmethod
    def wrapped_type(cls) -> "_576.LocationOfEvaluationLowerLimit":
        ...
        return _576.LocationOfEvaluationLowerLimit

    @classmethod
    def implicit_type(cls) -> "_576.LocationOfEvaluationLowerLimit.type_()":
        ...
        return _576.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: Self) -> "_576.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: Self) -> "List[_576.LocationOfEvaluationLowerLimit]":

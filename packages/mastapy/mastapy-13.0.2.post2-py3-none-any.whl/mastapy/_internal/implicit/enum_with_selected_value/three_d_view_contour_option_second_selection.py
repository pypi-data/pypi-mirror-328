...
from mastapy.utility.enums import _1830
...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1830.ThreeDViewContourOptionSecondSelection":
        ...
        return _1830.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1830.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1830.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1830.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1830.ThreeDViewContourOptionSecondSelection]":

...
class EnumWithSelectedValue_ResidualStressCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1074.ResidualStressCalculationMethod":
        ...
        return _1074.ResidualStressCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1074.ResidualStressCalculationMethod.type_()":
        ...
        return _1074.ResidualStressCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1074.ResidualStressCalculationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1074.ResidualStressCalculationMethod]":

...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6906.HarmonicExcitationType":
        ...
        return _6906.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6906.HarmonicExcitationType.type_()":
        ...
        return _6906.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6906.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6906.HarmonicExcitationType]":

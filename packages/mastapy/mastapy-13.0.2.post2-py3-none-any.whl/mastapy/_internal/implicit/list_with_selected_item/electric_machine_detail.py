...
class ListWithSelectedItem_ElectricMachineDetail(
    _1268.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1268.ElectricMachineDetail.TYPE":
        ...
        return _1268.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1268.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1268.ElectricMachineDetail]":

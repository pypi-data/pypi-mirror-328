...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _628.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_628.CylindricalSetManufacturingConfig.TYPE":
        ...
        return _628.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_628.CylindricalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_628.CylindricalSetManufacturingConfig]":

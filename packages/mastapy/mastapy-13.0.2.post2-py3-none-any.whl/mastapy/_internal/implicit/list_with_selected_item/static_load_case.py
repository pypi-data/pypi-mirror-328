...
class ListWithSelectedItem_StaticLoadCase(
    _6813.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6813.StaticLoadCase.TYPE":
        ...
        return _6813.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6813.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6813.StaticLoadCase]":

...
class ListWithSelectedItem_PointLoad(_2478.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2478.PointLoad.TYPE":
        ...
        return _2478.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2478.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2478.PointLoad]":

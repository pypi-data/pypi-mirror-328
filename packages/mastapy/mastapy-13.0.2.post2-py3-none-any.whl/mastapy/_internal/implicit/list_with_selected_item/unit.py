...
class ListWithSelectedItem_Unit(_1617.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1617.Unit.TYPE":
        ...
        return _1617.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1617.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1617.Unit]":

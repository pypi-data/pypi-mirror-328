...
class ListWithSelectedItem_ElectricMachineSetup(
    _1273.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1273.ElectricMachineSetup.TYPE":
        ...
        return _1273.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1273.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1273.ElectricMachineSetup]":

...
class ListWithSelectedItem_GuideDxfModel(
    _2462.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2462.GuideDxfModel.TYPE":
        ...
        return _2462.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2462.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2462.GuideDxfModel]":

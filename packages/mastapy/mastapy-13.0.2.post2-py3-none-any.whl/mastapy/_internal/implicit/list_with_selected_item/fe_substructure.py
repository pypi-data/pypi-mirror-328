...
class ListWithSelectedItem_FESubstructure(
    _2390.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2390.FESubstructure.TYPE":
        ...
        return _2390.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2390.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2390.FESubstructure]":

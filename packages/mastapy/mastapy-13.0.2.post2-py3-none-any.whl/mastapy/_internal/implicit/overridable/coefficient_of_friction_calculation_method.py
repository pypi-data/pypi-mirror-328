...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_322.CoefficientOfFrictionCalculationMethod":
        ...
        return _322.CoefficientOfFrictionCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_322.CoefficientOfFrictionCalculationMethod.type_()":
        ...
        return _322.CoefficientOfFrictionCalculationMethod.type_()

    @property
    def value(self: Self) -> "_322.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: Self) -> "_322.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: Self) -> "_322.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod

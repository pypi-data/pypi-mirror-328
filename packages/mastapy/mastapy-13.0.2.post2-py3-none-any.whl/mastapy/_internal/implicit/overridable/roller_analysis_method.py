...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2076.RollerAnalysisMethod":
        ...
        return _2076.RollerAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_2076.RollerAnalysisMethod.type_()":
        ...
        return _2076.RollerAnalysisMethod.type_()

    @property
    def value(self: Self) -> "_2076.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: Self) -> "_2076.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: Self) -> "_2076.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod

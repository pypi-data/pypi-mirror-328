...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6932.MeshStiffnessSource":
        ...
        return _6932.MeshStiffnessSource

    @classmethod
    def implicit_type(cls) -> "_6932.MeshStiffnessSource.type_()":
        ...
        return _6932.MeshStiffnessSource.type_()

    @property
    def value(self: Self) -> "_6932.MeshStiffnessSource":
    ...
    @property
    def override_value(self: Self) -> "_6932.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: Self) -> "_6932.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource

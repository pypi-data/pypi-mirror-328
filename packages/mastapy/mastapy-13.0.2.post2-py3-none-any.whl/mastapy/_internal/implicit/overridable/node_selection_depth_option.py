...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2409.NodeSelectionDepthOption":
        ...
        return _2409.NodeSelectionDepthOption

    @classmethod
    def implicit_type(cls) -> "_2409.NodeSelectionDepthOption.type_()":
        ...
        return _2409.NodeSelectionDepthOption.type_()

    @property
    def value(self: Self) -> "_2409.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: Self) -> "_2409.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: Self) -> "_2409.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption

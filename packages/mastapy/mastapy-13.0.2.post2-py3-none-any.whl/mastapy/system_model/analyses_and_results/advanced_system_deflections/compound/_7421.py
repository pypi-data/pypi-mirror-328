...
class AssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7288.AssemblyAdvancedSystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_7422.BearingCompoundAdvancedSystemDeflection]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7424.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7427.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7434.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7433.BoltCompoundAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7455.CVTCompoundAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7435.ClutchCompoundAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7440.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7445.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7457.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7459.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7463.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7470.FEPartCompoundAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7469.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7471.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7478.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7485.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7488.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7489.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7490.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7492.OilSealCompoundAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7494.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7499.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7500.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7501.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7503.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7505.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7510.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7509.ShaftCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7515.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7516.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7521.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7524.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7527.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7531.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7535.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7539.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7542.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":

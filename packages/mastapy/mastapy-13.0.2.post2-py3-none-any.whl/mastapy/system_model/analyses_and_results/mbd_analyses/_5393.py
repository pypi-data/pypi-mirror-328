...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5533
...
class BearingMultibodyDynamicsAnalysis(_5423.ConnectorMultibodyDynamicsAnalysis):
    """BearingMultibodyDynamicsAnalysis

...
class StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3622.StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(
        self: Self,
    ) -> "List[_3750.StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(
        self: Self,
    ) -> "List[_3751.StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]":

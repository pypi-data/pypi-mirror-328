...
class ParametricStudyVariable(_2656.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    class _Cast_ParametricStudyVariable:
        ...
        def analysis_case_variable(
            ...
            return self._parent._cast(_2656.AnalysisCaseVariable)
    ...
    @property
    def dimension(self: Self) -> "_4391.ParametricStudyDimension":
    ...
    def dimension(self: Self, value: "_4391.ParametricStudyDimension"):
    ...
    @property
    def distribution(self: Self) -> "_4388.MonteCarloDistribution":
    ...
    @distribution.setter
    @enforce_parameter_types
    def distribution(self: Self, value: "_4388.MonteCarloDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: Self) -> "_4356.DesignOfExperimentsVariableSetter":

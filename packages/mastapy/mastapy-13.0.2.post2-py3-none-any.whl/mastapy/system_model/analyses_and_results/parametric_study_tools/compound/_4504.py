...
class FaceGearCompoundParametricStudyTool(_4509.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6893.FaceGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4365.FaceGearParametricStudyTool]":

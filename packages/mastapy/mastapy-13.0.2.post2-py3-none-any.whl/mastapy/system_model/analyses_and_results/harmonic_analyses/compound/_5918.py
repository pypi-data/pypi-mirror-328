...
class ConceptGearSetCompoundHarmonicAnalysis(_5947.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5719.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5916.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5917.ConceptGearMeshCompoundHarmonicAnalysis]":

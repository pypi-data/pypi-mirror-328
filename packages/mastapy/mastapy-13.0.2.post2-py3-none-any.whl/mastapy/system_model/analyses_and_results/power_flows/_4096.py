...
class FaceGearSetPowerFlow(_4103.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4095.FaceGearPowerFlow]":
    ...
    @property
    def face_gears_power_flow(self: Self) -> "List[_4095.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4094.FaceGearMeshPowerFlow]":
    ...
    @property
    def face_meshes_power_flow(self: Self) -> "List[_4094.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]

...
class PlanetCarrierSystemDeflection(_2790.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4128.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: Self) -> "List[_2854.PlanetCarrierWindup]":

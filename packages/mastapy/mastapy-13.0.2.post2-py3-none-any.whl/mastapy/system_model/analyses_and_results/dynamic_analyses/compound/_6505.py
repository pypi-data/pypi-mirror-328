...
class RingPinsCompoundDynamicAnalysis(_6493.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6376.RingPinsDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6376.RingPinsDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.RingPinsDynamicAnalysis]

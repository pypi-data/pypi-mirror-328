...
class BoltCompoundDynamicAnalysis(_6441.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_6304.BoltDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6304.BoltDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BoltDynamicAnalysis]

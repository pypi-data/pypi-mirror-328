...
class CouplingCompoundDynamicAnalysis(_6514.SpecialisedAssemblyCompoundDynamicAnalysis):
    """CouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6323.CouplingDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6323.CouplingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CouplingDynamicAnalysis]

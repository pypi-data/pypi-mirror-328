...
class ConceptGearSetCompoundStabilityAnalysis(_3965.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3801.ConceptGearSetStabilityAnalysis]":
    ...
    def concept_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3934.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3935.ConceptGearMeshCompoundStabilityAnalysis]":

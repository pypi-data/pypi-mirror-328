...
class OilSealCompoundStabilityAnalysis(_3941.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3851.OilSealStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3851.OilSealStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.OilSealStabilityAnalysis]

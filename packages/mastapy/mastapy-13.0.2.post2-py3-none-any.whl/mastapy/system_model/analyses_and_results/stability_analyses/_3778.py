...
class AssemblyStabilityAnalysis(_3771.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_3779.BearingStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_3781.BeltDriveStabilityAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_3790.BoltedJointStabilityAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_3791.BoltStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3814.CVTStabilityAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_3794.ClutchStabilityAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_3799.ConceptCouplingStabilityAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_3801.ConceptGearSetStabilityAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_3818.CycloidalDiscStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_3829.FEPartStabilityAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_3827.FaceGearSetStabilityAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_3836.HypoidGearSetStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_3848.MassDiscStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_3851.OilSealStabilityAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_3858.PlanetCarrierStabilityAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_3859.PointLoadStabilityAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_3860.PowerLoadStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_3862.RingPinsStabilityAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3868.ShaftHubConnectionStabilityAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_3869.ShaftStabilityAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_3877.SpringDamperStabilityAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3882.StraightBevelDiffGearSetStabilityAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_3892.SynchroniserStabilityAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_3895.TorqueConverterStabilityAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_3897.UnbalancedMassStabilityAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_3900.WormGearSetStabilityAnalysis]":

...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1253, _1254
...
class ContactPairReporting(_0.APIBase):
    ...
    def constrained_surface_type(
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1253",
    ...
    @property
    def reference_surface_type(self: Self) -> "_1254.ContactPairReferenceSurfaceType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1254",

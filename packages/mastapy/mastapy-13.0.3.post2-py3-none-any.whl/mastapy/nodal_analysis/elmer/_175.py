...
from mastapy.math_utility import _1545
...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1343, _1355
...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(
            ...
            return self._parent._cast(_1343.ElectricMachineMechanicalResultsViewable)

        @property
        def electric_machine_results_viewable(
            self: "ElmerResultsViewable._Cast_ElmerResultsViewable",
        ) -> "_1355.ElectricMachineResultsViewable":
            from mastapy.electric_machines.results import _1355

            return self._parent._cast(_1355.ElectricMachineResultsViewable)
    ...
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1545.ResultOptionsFor3DVector"):
    ...
    @property
    def scaling_draw_style(self: Self) -> "_1871.ScalingDrawStyle":

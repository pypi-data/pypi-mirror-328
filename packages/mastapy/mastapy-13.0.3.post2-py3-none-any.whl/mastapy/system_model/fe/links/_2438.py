...
from mastapy.system_model.fe import _2383, _2418, _2422, _2405
...
class FELink(_0.APIBase):
    ...
    class _Cast_FELink:
        ...
        @property
        def gear_mesh_fe_link(self: "FELink._Cast_FELink") -> "_2441.GearMeshFELink":
        ...
        @property
        def multi_node_fe_link(self: "FELink._Cast_FELink") -> "_2445.MultiNodeFELink":
        ...
        @property
        def point_load_fe_link(self: "FELink._Cast_FELink") -> "_2449.PointLoadFELink":
        ...
        def single_node_fe_link(
            ...
            from mastapy.system_model.fe.links import _2452

            return self._parent._cast(_2452.SingleNodeFELink)
    ...
    @enforce_parameter_types
    def bearing_node_link_option(self: Self, value: "_2383.BearingNodeOption"):
    ...
    @enforce_parameter_types
    def link_node_source(self: Self, value: "_2418.LinkNodeSource"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def node_selection_depth(
        self: Self,
        value: "Union[_2422.NodeSelectionDepthOption, Tuple[_2422.NodeSelectionDepthOption, bool]]",
    ):
    ...
    @property
    def component(self: Self) -> "_2484.MountableComponent":
    ...
    @property
    def socket(self: Self) -> "_2316.Socket":
    ...
    def nodes_grouped_by_angle(
        self: Self,
    ) -> "OrderedDict[float, List[_2405.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: Self, node: "_2405.FESubstructureNode"):

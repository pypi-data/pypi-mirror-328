...
class PointLoadCompoundSystemDeflection(_2996.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2812.PointLoadSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PointLoadSystemDeflection]

...
class MassDiscCompoundSystemDeflection(_2996.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2800.MassDiscSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.MassDiscSystemDeflection]

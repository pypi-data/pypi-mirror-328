...
class CylindricalGearSetCompoundSystemDeflection(_2933.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2765.CylindricalGearSetSystemDeflectionWithLTCAResults]":
    ...
    def cylindrical_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2919.CylindricalGearCompoundSystemDeflection]":
    ...
    def cylindrical_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2920.CylindricalGearMeshCompoundSystemDeflection]":

...
class BearingCompoundSystemDeflection(_2908.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1968.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2719.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]

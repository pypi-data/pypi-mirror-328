...
class StraightBevelDiffGearMeshSystemDeflection(_2727.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4163.StraightBevelDiffGearMeshPowerFlow":

...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_2769.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    def right_flank(self: Self) -> "_2769.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    @property
    def flanks(self: Self) -> "List[_2769.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    def both_flanks(self: Self) -> "_2769.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection

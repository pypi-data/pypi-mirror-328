...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2459, _2461
    from mastapy.bearings.bearing_results import _1969, _1961
...
class BearingSystemDeflection(_2749.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1969.LoadedBearingResults":
    ...
    @property
    def power_flow_results(self: Self) -> "_4061.BearingPowerFlow":
    ...
    @property
    def preload_spring_stiffness(self: Self) -> "_1961.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_between_rings(self: Self) -> "_1961.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: Self) -> "_1961.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: Self,
    ) -> "List[_2461.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: Self,
    ) -> "List[_1961.BearingStiffnessMatrixReporter]":

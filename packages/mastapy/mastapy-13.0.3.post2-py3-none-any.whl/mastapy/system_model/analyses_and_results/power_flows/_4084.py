...
class ConceptGearSetPowerFlow(_4116.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4083.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: Self) -> "List[_4083.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4082.ConceptGearMeshPowerFlow]":
    ...
    @property
    def concept_meshes_power_flow(self: Self) -> "List[_4082.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]

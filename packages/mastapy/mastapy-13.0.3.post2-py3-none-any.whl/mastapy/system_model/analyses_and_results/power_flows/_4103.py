...
class CylindricalGearSetPowerFlow(_4116.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4102.CylindricalGearPowerFlow]":
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4101.CylindricalGearMeshPowerFlow]":

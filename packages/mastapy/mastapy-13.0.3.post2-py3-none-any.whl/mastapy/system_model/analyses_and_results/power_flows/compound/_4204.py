...
class BevelGearCompoundPowerFlow(_4192.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4070.BevelGearPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4070.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]

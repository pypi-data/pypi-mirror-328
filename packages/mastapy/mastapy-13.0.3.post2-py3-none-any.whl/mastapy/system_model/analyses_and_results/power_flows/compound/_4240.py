...
class ExternalCADModelCompoundPowerFlow(_4213.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4106.ExternalCADModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4106.ExternalCADModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ExternalCADModelPowerFlow]

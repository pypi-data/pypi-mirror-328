...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self: Self) -> "_4372.DutyCycleResultsForAllGearSets":
    ...
    def results_for_all_bearings(
        self: Self,
    ) -> "List[_4374.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: Self,
    ) -> "List[_4375.DutyCycleResultsForSingleShaft]":

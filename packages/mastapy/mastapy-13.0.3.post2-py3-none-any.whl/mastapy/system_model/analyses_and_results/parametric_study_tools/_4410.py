...
if TYPE_CHECKING:
    ...
    from mastapy.system_model import _2229, _2223
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: Self, value: "_6839.AnalysisType"):
    ...
    @property
    def parametric_study_type(self: Self) -> "_6949.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6949",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: Self, value: "_6949.ParametricStudyType"):
    ...
    @property
    def external_full_fe_loader(self: Self) -> "_2229.ExternalFullFELoader":
    ...
    @property
    def step_results(self: Self) -> "List[_4412.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: Self) -> "List[_4413.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: Self,
    ) -> "List[_2669.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: Self, design_entity: "_2223.DesignEntity", path: "List[str]"
    ...
    def move_study_variable_down(
        self: Self, study_variable: "_4413.ParametricStudyVariable"
    ):
        """Method does not return.
    ...
    def remove_logging_variable(
        self: Self, analysis_variable: "_2669.AnalysisCaseVariable"
    ):
        """Method does not return.

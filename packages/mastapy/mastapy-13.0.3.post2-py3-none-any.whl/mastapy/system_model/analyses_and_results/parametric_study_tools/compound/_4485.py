...
class ClutchCompoundParametricStudyTool(_4501.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6856.ClutchLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4340.ClutchParametricStudyTool]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4340.ClutchParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ClutchParametricStudyTool]

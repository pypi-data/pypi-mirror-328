...
class FEPartCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6909.FEPartLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4380.FEPartParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4380.FEPartParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.FEPartParametricStudyTool]

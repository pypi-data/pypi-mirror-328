...
class ShaftCompoundParametricStudyTool(_4465.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6972.ShaftLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4431.ShaftParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4431.ShaftParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ShaftParametricStudyTool]

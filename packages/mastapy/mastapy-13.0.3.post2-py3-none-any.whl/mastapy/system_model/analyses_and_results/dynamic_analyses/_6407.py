...
class StraightBevelDiffGearSetDynamicAnalysis(_6316.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    def straight_bevel_diff_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6405.StraightBevelDiffGearDynamicAnalysis]":
    ...
    def straight_bevel_diff_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6406.StraightBevelDiffGearMeshDynamicAnalysis]":

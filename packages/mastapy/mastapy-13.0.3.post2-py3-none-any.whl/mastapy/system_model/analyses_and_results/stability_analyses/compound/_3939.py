...
class ClutchCompoundStabilityAnalysis(_3955.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3807.ClutchStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3807.ClutchStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.ClutchStabilityAnalysis]

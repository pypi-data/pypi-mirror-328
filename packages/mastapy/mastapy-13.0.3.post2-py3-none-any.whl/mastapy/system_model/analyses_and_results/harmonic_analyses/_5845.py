...
class StraightBevelGearSetHarmonicAnalysis(_5718.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5843.StraightBevelGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5844.StraightBevelGearMeshHarmonicAnalysis]":

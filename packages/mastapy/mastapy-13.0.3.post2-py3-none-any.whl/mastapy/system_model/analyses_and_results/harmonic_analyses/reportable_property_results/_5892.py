...
class ResultsForOrderIncludingNodes(_5890.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    class _Cast_ResultsForOrderIncludingNodes:
        ...
        def results_for_order_including_surfaces(
            ...
            return self._parent._cast(_5893.ResultsForOrderIncludingSurfaces)
    ...
    def node_results_global_coordinate_system(
        self: Self,
    ) -> "List[_5884.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]":

...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self: Self) -> "_5889.ResultsForMultipleOrdersForGroups":
    ...
    def excitations(
        self: Self,
    ) -> "List[_5898.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: Self,
    ) -> "List[_5891.ResultsForOrderIncludingGroups]":

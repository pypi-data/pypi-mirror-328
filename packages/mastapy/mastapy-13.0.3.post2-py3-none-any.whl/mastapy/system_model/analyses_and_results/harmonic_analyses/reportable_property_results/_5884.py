...
class HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic(
    ...
    @property
    def acceleration(self: Self) -> "_5895.ResultsForResponseOfANodeOnAHarmonic":
    ...
    @property
    def displacement(self: Self) -> "_5895.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
    ...
    @property
    def force(self: Self) -> "_5895.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
    ...
    @property
    def velocity(self: Self) -> "_5895.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic

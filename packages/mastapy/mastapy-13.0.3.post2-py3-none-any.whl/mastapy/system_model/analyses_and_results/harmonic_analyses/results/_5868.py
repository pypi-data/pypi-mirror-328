...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5867
...
class ExcitationSourceSelectionGroup(_5867.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    class _Cast_ExcitationSourceSelectionGroup:
        ...
        def excitation_source_selection_base(
            ...
            return self._parent._cast(_5867.ExcitationSourceSelectionBase)
    ...
    @property
    def sub_items(self: Self) -> "List[_5867.ExcitationSourceSelectionBase]":
    ...
    @enforce_parameter_types
    def include_only_harmonics_with_order(self: Self, order: "_1547.RoundedOrder"):

...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    class _Cast_HarmonicAnalysisExportOptions:
        ...
        def harmonic_analysis_fe_export_options(
            ...
            return self._parent._cast(_5785.HarmonicAnalysisFEExportOptions)
        ...
        def harmonic_analysis_root_assembly_export_options(
            ...
            return self._parent._cast(_5788.HarmonicAnalysisRootAssemblyExportOptions)
        ...
        def harmonic_analysis_shaft_export_options(
            ...
            return self._parent._cast(_5789.HarmonicAnalysisShaftExportOptions)
    ...
    def distance_units_for_export(self: Self, value: "_1628.Unit"):
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: Self, value: "_5766.ExportOutputType"):
    ...
    @enforce_parameter_types
    def type_of_result_to_export(self: Self, value: "_4648.DynamicsResponseType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def analysis_options(self: Self) -> "_5787.HarmonicAnalysisOptions":

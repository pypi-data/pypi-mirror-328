...
class HypoidGearSetHarmonicAnalysis(_5706.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5792.HypoidGearHarmonicAnalysis]":

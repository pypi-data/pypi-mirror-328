...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5861
...
class WormGearSetCompoundHarmonicAnalysis(_5960.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5861.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_6023.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_6024.WormGearMeshCompoundHarmonicAnalysis]":

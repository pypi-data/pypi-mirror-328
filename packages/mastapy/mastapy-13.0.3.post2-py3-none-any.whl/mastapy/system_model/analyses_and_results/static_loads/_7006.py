...
class WormGearSetLoadCase(_6917.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_7004.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: Self) -> "List[_7004.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def worm_meshes_load_case(self: Self) -> "List[_7005.WormGearMeshLoadCase]":

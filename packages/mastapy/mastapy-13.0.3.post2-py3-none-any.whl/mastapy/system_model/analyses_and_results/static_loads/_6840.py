...
class AssemblyLoadCase(_6828.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: Self) -> "List[_6841.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6843.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6846.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6852.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: Self) -> "List[_6853.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6877.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: Self) -> "List[_6854.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: Self) -> "List[_6856.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6862.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6865.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_6879.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6881.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_6887.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6909.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6908.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6910.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: Self) -> "List[_6914.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6929.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6939.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6942.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6943.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6944.MeasurementComponentLoadCase]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6948.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6953.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6957.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6960.PointLoadLoadCase]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6965.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: Self,
    ) -> "List[_6966.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6967.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_6971.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: Self) -> "List[_6972.ShaftLoadCase]":
    ...
    @property
    def shafts_and_housings(self: Self) -> "List[_6830.AbstractShaftOrHousingLoadCase]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_6977.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6980.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6983.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6986.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6990.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6995.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_7002.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_7006.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_7009.ZerolBevelGearSetLoadCase]":

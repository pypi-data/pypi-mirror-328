...
from mastapy.system_model.part_model import _2498
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6839, _6833
...
class StaticLoadCase(_6825.LoadCase):
    """StaticLoadCase
    ...
    class _Cast_StaticLoadCase:
        ...
        @property
        def load_case(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_6825.LoadCase":
            return self._parent._cast(_6825.LoadCase)

        @property
        def context(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_2671.Context":
    ...
    @property
    def system_deflection(self: Self) -> "_2667.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: Self) -> "_2662.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: Self) -> "_2653.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: Self) -> "_2661.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: Self) -> "_2656.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: Self) -> "_2646.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: Self) -> "_2663.StabilityAnalysis":
    ...
    def unbalanced_mass_inclusion(
        self: Self,
        value: "Union[_2498.UnbalancedMassInclusionOption, Tuple[_2498.UnbalancedMassInclusionOption, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def clutch_engagements(self: Self) -> "List[_5682.ClutchEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: Self) -> "_5684.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_design_state_group: "_5684.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":

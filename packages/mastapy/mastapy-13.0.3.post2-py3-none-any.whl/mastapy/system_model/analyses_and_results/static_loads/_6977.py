...
class SpiralBevelGearSetLoadCase(_6851.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6975.SpiralBevelGearLoadCase]":
    ...
    def spiral_bevel_gears_load_case(
        self: Self,
    ) -> "List[_6975.SpiralBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.SpiralBevelGearLoadCase]
    ...
    def spiral_bevel_meshes_load_case(
        self: Self,
    ) -> "List[_6976.SpiralBevelGearMeshLoadCase]":

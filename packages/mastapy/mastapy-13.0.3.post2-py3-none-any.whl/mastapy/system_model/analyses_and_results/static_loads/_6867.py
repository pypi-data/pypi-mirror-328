...
class ConicalGearManufactureError(_6913.GearManufactureError):
    """ConicalGearManufactureError
    ...
    class _Cast_ConicalGearManufactureError:
        ...
        def gear_manufacture_error(
            ...
            return self._parent._cast(_6913.GearManufactureError)
    ...
    @property
    def pitch_errors_concave_flank(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_concave_flank(self: Self, value: "_1553.Vector2DListAccessor"):
        self.wrapped.PitchErrorsConcaveFlank = value.wrapped

    @property
    def pitch_errors_convex_flank(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_convex_flank(self: Self, value: "_1553.Vector2DListAccessor"):

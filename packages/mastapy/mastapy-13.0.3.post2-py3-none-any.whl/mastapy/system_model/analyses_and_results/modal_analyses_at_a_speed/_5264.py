...
class WormGearSetModalAnalysisAtASpeed(_5198.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    def worm_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5263.WormGearModalAnalysisAtASpeed]":
    ...
    def worm_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5262.WormGearMeshModalAnalysisAtASpeed]":

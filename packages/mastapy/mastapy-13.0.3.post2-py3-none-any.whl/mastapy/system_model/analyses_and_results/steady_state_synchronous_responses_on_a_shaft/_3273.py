...
class AssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def bolts(self: Self) -> "List[_3286.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3308.CVTSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3314.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def shafts(self: Self) -> "List[_3362.ShaftSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3376.StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft]":

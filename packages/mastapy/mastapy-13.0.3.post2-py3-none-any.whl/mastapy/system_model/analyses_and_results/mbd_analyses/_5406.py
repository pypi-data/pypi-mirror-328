...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5546
...
class BearingMultibodyDynamicsAnalysis(_5436.ConnectorMultibodyDynamicsAnalysis):
    """BearingMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self: Self) -> "_5546.DynamicForceVector3DResult":

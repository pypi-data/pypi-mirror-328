...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: Self) -> "List[_5406.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5409.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5418.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5419.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5441.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5422.ClutchMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5456.FEPartMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_5461.GearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5480.MassDiscMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5487.OilSealMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5495.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5496.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5498.RingPinsMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5507.ShaftMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5522.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5531.TorqueConverterMultibodyDynamicsAnalysis]":

...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5688, _5680
...
class DutyCycle(_5681.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: Self,
    ) -> "List[_5688.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: Self) -> "_7023.TimeSeriesImporter":
    ...
    def add_static_load(self: Self, static_load: "_6826.StaticLoadCase"):
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: Self, sub_group: "_5688.SubGroupInSingleDesignState"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: Self, static_load: "_6826.StaticLoadCase"):
        """Method does not return.

...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4927.CylindricalGearSetModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5056.CylindricalGearCompoundModalAnalysisAtAStiffness]":
    ...
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5057.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]":

...
class ConceptGearSetModalAnalysisAtAStiffness(_4939.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    def concept_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4908.ConceptGearModalAnalysisAtAStiffness]":
    ...
    def concept_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4907.ConceptGearMeshModalAnalysisAtAStiffness]":

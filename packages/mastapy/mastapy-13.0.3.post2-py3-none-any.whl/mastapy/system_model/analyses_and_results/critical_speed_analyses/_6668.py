...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6582.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def spiral_bevel_gears_critical_speed_analysis(
        self: Self,
    ) -> "List[_6666.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_meshes_critical_speed_analysis(
        self: Self,
    ) -> "List[_6667.SpiralBevelGearMeshCriticalSpeedAnalysis]":

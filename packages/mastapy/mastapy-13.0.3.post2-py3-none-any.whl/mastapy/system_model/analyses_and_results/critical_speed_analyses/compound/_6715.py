...
class BoltCompoundCriticalSpeedAnalysis(_6721.ComponentCompoundCriticalSpeedAnalysis):
    """BoltCompoundCriticalSpeedAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6583.BoltCriticalSpeedAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6583.BoltCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.BoltCriticalSpeedAnalysis]

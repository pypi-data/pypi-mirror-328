...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    def extreme_load_case(self: Self, value: "_6826.StaticLoadCase"):
        wrapper_type = (
    ...
    @property
    def extreme_load_case_for_stop_start(self: Self) -> "_6826.StaticLoadCase":
    ...
    @enforce_parameter_types
    def extreme_load_case_for_stop_start(self: Self, value: "_6826.StaticLoadCase"):
    ...
    @ldd.setter
    @enforce_parameter_types
    def ldd(self: Self, value: "_5685.DutyCycle"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def nominal_load_case(self: Self, value: "_6826.StaticLoadCase"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def nominal_load_case_for_stop_start(self: Self) -> "_6826.StaticLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.StaticLoadCase"""
    ...
    @enforce_parameter_types
    def nominal_load_case_for_stop_start(self: Self, value: "_6826.StaticLoadCase"):

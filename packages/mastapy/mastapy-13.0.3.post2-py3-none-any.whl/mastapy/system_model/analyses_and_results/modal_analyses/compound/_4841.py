...
class RollingRingCompoundModalAnalysis(_4788.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4697.RollingRingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4697.RollingRingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RollingRingModalAnalysis]

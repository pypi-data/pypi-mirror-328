...
class BearingCompoundModalAnalysis(_4785.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4601.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4601.BearingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]

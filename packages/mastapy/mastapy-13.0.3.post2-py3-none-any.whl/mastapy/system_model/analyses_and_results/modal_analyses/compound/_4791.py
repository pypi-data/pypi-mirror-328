...
class CVTPulleyCompoundModalAnalysis(_4837.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4636.CVTPulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4636.CVTPulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTPulleyModalAnalysis]

...
class FaceGearSetCompoundModalAnalysis(_4809.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4652.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4802.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4803.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4652.FaceGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]

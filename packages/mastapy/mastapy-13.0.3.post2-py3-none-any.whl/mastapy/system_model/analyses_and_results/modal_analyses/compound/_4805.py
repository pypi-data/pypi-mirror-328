...
class FEPartCompoundModalAnalysis(_4751.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4653.FEPartModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4653.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]

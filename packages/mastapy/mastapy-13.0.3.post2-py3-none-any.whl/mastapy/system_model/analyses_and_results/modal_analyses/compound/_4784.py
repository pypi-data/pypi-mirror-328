...
class ConnectionCompoundModalAnalysis(_7560.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4628.ConnectionModalAnalysis]":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4628.ConnectionModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConnectionModalAnalysis]

...
class AssemblyCompoundModalAnalysis(_4749.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4600.AssemblyModalAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_4757.BearingCompoundModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4759.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4762.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4769.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4768.BoltCompoundModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4790.CVTCompoundModalAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_4770.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4775.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4780.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4792.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4794.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4798.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4805.FEPartCompoundModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4804.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4806.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4813.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4820.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4823.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4824.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4825.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4827.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4829.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4834.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4835.PointLoadCompoundModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4836.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4838.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4840.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4845.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4844.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4850.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4851.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4856.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4859.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4862.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4866.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4870.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4874.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4877.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4600.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]

...
class PerModeResultsReport(_1774.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: Self) -> "_1838.TableAndChartOptions":
    ...
    def display_option(self: Self, value: "_1838.TableAndChartOptions"):

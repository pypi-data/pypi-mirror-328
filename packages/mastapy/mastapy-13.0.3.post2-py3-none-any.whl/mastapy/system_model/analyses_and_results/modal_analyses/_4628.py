...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4747
...
class ConnectionModalAnalysis(_7562.ConnectionStaticLoadAnalysisCase):
    """ConnectionModalAnalysis

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2546, _2545
...
class CylindricalGearMesh(_2333.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self: Self) -> "_1507.Range":
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_1028.CylindricalGearMeshDesign":
    ...
    @property
    def cylindrical_gear_mesh_design(self: Self) -> "_1028.CylindricalGearMeshDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshDesign
    ...
    @property
    def cylindrical_gear_set(self: Self) -> "_2546.CylindricalGearSet":

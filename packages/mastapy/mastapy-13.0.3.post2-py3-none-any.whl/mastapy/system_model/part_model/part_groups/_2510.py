...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2507, _2511, _2512
...
class ParallelPartGroup(_2506.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: Self) -> "List[_2507.ConcentricPartGroup]":

...
from mastapy.system_model.part_model.configurations import _2638
...
class ActiveShaftDesignSelectionGroup(
    _2638.PartDetailConfiguration[
        "_2634.ActiveShaftDesignSelection", "_2502.Shaft", "_43.SimpleShaftDefinition"
    ]
):
    """ActiveShaftDesignSelectionGroup
    ...
    class _Cast_ActiveShaftDesignSelectionGroup:
        ...
        def part_detail_configuration(
            ...
            return self._parent._cast(_2638.PartDetailConfiguration)

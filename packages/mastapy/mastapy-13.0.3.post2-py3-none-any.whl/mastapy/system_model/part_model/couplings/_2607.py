...
class CVT(_2596.BeltDrive):
    ...
    class _Cast_CVT:
        ...
        @property
        def belt_drive(self: "CVT._Cast_CVT") -> "_2596.BeltDrive":
            return self._parent._cast(_2596.BeltDrive)

        @property
        def specialised_assembly(self: "CVT._Cast_CVT") -> "_2496.SpecialisedAssembly":
            from mastapy.system_model.part_model import _2496

            return self._parent._cast(_2496.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "CVT._Cast_CVT") -> "_2454.AbstractAssembly":
            from mastapy.system_model.part_model import _2454

            return self._parent._cast(_2454.AbstractAssembly)

        @property
        def part(self: "CVT._Cast_CVT") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "CVT._Cast_CVT") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

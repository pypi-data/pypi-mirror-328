...
class Clutch(_2604.Coupling):
    ...
    class _Cast_Clutch:
        ...
        @property
        def coupling(self: "Clutch._Cast_Clutch") -> "_2604.Coupling":
        ...
        @property
        def abstract_assembly(self: "Clutch._Cast_Clutch") -> "_2454.AbstractAssembly":
            from mastapy.system_model.part_model import _2454

            return self._parent._cast(_2454.AbstractAssembly)

        @property
        def part(self: "Clutch._Cast_Clutch") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Clutch._Cast_Clutch") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223
    ...
    @property
    def angular_speed_temperature_grid(self: Self) -> "_1583.GriddedSurfaceAccessor":
    ...
    @property
    def clutch_type(self: Self) -> "_2600.ClutchType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2600", "ClutchType"
        )(value)

    @clutch_type.setter
    @enforce_parameter_types
    def clutch_type(self: Self, value: "_2600.ClutchType"):
    ...
    @property
    def flow_rate_vs_speed(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def flow_rate_vs_speed(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @property
    def linear_speed_temperature_grid(self: Self) -> "_1583.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def spring_type(self: Self) -> "_5423.ClutchSpringType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5423",
            "ClutchSpringType",
        )(value)

    @spring_type.setter
    @enforce_parameter_types
    def spring_type(self: Self, value: "_5423.ClutchSpringType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType",
        )
    ...
    @property
    def clutch_connection(self: Self) -> "_2362.ClutchConnection":

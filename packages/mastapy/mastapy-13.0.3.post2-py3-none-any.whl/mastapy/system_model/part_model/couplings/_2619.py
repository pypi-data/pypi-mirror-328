...
from mastapy.system_model.part_model.couplings import _2612, _2615, _2616
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1428, _1433
    from mastapy.system_model.part_model.couplings import _2613, _2620, _2614
...
class ShaftHubConnection(_2467.Connector):
    """ShaftHubConnection
    ...
    class _Cast_ShaftHubConnection:
        ...
        @property
        def part(self: "ShaftHubConnection._Cast_ShaftHubConnection") -> "_2488.Part":
    ...
    @property
    def spline_type(self: Self) -> "_1428.SplineDesignTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1428", "SplineDesignTypes"
        )(value)

    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: Self, value: "_1428.SplineDesignTypes"):
    ...
    @enforce_parameter_types
    def stiffness_type(self: Self, value: "_2612.RigidConnectorStiffnessType"):
    ...
    @property
    def tilt_stiffness_type(self: Self) -> "_2613.RigidConnectorTiltStiffnessTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2613",
    ...
    def tilt_stiffness_type(
        self: Self, value: "_2613.RigidConnectorTiltStiffnessTypes"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(self: Self, value: "_2615.RigidConnectorToothSpacingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2616.RigidConnectorTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: Self, value: "_1413.FitTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def interference_fit_design(self: Self) -> "_1463.InterferenceFitDesign":
    ...
    @property
    def left_flank_lead_relief(self: Self) -> "_2620.SplineLeadRelief":
    ...
    @property
    def right_flank_lead_relief(self: Self) -> "_2620.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_joint_design(self: Self) -> "_1433.SplineJointDesign":
    ...
    @property
    def lead_reliefs(self: Self) -> "List[_2620.SplineLeadRelief]":
    ...
    def tooth_locations_external_spline_half(
        self: Self,
    ) -> "List[_2614.RigidConnectorToothLocation]":

...
class PointLoad(_2499.VirtualComponent):
    """PointLoad
    ...
    class _Cast_PointLoad:
        ...
        @property
        def component(self: "PointLoad._Cast_PointLoad") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "PointLoad._Cast_PointLoad") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "PointLoad._Cast_PointLoad") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

...
class SuperchargerRotorSet(_1847.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: Self) -> "_1885.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: Self) -> "_2585.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.gears.supercharger_rotor_set._2585",
    ...
    def y_variable_for_imported_data(
        self: Self, value: "_2585.YVariableForImportedData"
    ):
    ...
    @property
    def boost_pressure(self: Self) -> "_2575.BoostPressureInputOptions":
    ...
    @property
    def file(self: Self) -> "_2578.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: Self) -> "_2576.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: Self) -> "_2577.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: Self) -> "_2580.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: Self) -> "List[_2579.RotorSetMeasuredPoint]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2545, _2562
...
class CylindricalGearSet(_2552.GearSet):
    """CylindricalGearSet
    ...
    class _Cast_CylindricalGearSet:
        ...
        @property
        def part(self: "CylindricalGearSet._Cast_CylindricalGearSet") -> "_2488.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1038.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: Self) -> "_1038.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: Self) -> "_2583.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2545.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_2329.CylindricalGearMesh]":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_1038.CylindricalGearSetDesign]":
    ...
    def add_gear(self: Self) -> "_2545.CylindricalGear":

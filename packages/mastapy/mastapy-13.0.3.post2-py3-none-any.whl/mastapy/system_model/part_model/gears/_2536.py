...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2539, _2534, _2544, _2552
...
class BevelDifferentialGearSet(_2540.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_1200.BevelGearSetDesign":
    ...
    @property
    def bevel_gear_set_design(self: Self) -> "_1200.BevelGearSetDesign":
        """mastapy.gears.gear_designs.bevel.BevelGearSetDesign
    ...
    @property
    def bevel_gears(self: Self) -> "List[_2539.BevelGear]":
    ...
    @property
    def bevel_meshes(self: Self) -> "List[_2323.BevelGearMesh]":

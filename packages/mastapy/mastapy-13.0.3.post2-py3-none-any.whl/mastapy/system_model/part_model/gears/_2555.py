...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2554, _2544, _2552
...
class HypoidGearSet(_2534.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    class _Cast_HypoidGearSet:
        ...
        @property
        def gear_set(self: "HypoidGearSet._Cast_HypoidGearSet") -> "_2552.GearSet":
        ...
        @property
        def part(self: "HypoidGearSet._Cast_HypoidGearSet") -> "_2488.Part":
    ...
    @property
    def hypoid_gears(self: Self) -> "List[_2554.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_2335.HypoidGearMesh]":

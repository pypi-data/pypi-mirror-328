...
class CylindricalGearFromCAD(_2524.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: Self, value: "_2546.CylindricalGearSet"):
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: Self, value: "_2545.CylindricalGear"):
        wrapper_type = (

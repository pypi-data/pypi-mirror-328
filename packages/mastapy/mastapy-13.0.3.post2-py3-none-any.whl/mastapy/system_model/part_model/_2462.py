...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2463, _2488
    from mastapy.bolts import _1500
...
class Bolt(_2464.Component):
    ...
    class _Cast_Bolt:
        ...
        @property
        def component(self: "Bolt._Cast_Bolt") -> "_2464.Component":
            return self._parent._cast(_2464.Component)

        @property
        def part(self: "Bolt._Cast_Bolt") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Bolt._Cast_Bolt") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223
    ...
    @property
    def bolted_joint(self: Self) -> "_2463.BoltedJoint":
    ...
    @property
    def loaded_bolt(self: Self) -> "_1500.LoadedBolt":

...
from mastapy.bearings.tolerances import _1922, _1924
...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2458, _2493
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2458.AxialInternalClearanceTolerance)

        @property
        def radial_internal_clearance_tolerance(
            self: "InternalClearanceTolerance._Cast_InternalClearanceTolerance",
        ) -> "_2493.RadialInternalClearanceTolerance":
            from mastapy.system_model.part_model import _2493

            return self._parent._cast(_2493.RadialInternalClearanceTolerance)
    ...
    def clearance_class(self: Self, value: "_1922.InternalClearanceClass"):

...
class GuideDxfModel(_2464.Component):
    """GuideDxfModel
    ...
    class _Cast_GuideDxfModel:
        ...
        @property
        def component(self: "GuideDxfModel._Cast_GuideDxfModel") -> "_2464.Component":
            return self._parent._cast(_2464.Component)

        @property
        def part(self: "GuideDxfModel._Cast_GuideDxfModel") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self: Self) -> "_7032.AtsamExcitationsOrOthers":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation._7032",
            "AtsamExcitationsOrOthers",
        )(value)

    @excitations_type.setter
    @enforce_parameter_types
    def excitations_type(self: Self, value: "_7032.AtsamExcitationsOrOthers"):
    ...
    @gear_set.setter
    @enforce_parameter_types
    def gear_set(self: Self, value: "_2552.GearSet"):
        wrapper_type = (
    ...
    @property
    def mode_view_options(self: Self) -> "_7033.AtsamNaturalFrequencyViewOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation._7033",
            "AtsamNaturalFrequencyViewOption",
        )(value)

    @mode_view_options.setter
    @enforce_parameter_types
    def mode_view_options(self: Self, value: "_7033.AtsamNaturalFrequencyViewOption"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AdvancedTimeSteppingAnalysesForModulation.AtsamNaturalFrequencyViewOption",
        )

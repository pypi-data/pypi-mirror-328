...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: Self) -> "_1507.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: Self, value: "_1507.Range"):
        self.wrapped.FilteringFrequencyRange = value.wrapped

    @property
    def filtering_method(self: Self) -> "_5871.ModalContributionFilteringMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5871",
            "ModalContributionFilteringMethod",
        )(value)

    @filtering_method.setter
    @enforce_parameter_types
    def filtering_method(self: Self, value: "_5871.ModalContributionFilteringMethod"):
    ...
    @property
    def frequency_range(self: Self) -> "_1507.Range":
        """mastapy.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: Self, value: "_1507.Range"):
    ...
    @property
    def index_range(self: Self) -> "_1606.IntegerRange":
    ...
    @index_range.setter
    @enforce_parameter_types
    def index_range(self: Self, value: "_1606.IntegerRange"):
        self.wrapped.IndexRange = value.wrapped

    @property
    def modes_to_display(self: Self) -> "_5870.ModalContributionDisplayMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5870",
            "ModalContributionDisplayMethod",
        )(value)

    @modes_to_display.setter
    @enforce_parameter_types
    def modes_to_display(self: Self, value: "_5870.ModalContributionDisplayMethod"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
        )

...
from mastapy.utility.enums import _1840, _1841
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    class _Cast_PartAnalysisCaseWithContourViewable:
        ...
        def abstract_system_deflection_viewable(
            ...
            return self._parent._cast(_2263.AbstractSystemDeflectionViewable)
        ...
        def advanced_system_deflection_viewable(
            ...
            return self._parent._cast(_2264.AdvancedSystemDeflectionViewable)
        ...
        def system_deflection_viewable(
            ...
            return self._parent._cast(_2280.SystemDeflectionViewable)
    ...
    def contour(self: Self, value: "_1840.ThreeDViewContourOptionFirstSelection"):
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: Self, value: "_1841.ThreeDViewContourOptionSecondSelection"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

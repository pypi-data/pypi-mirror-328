...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1279, _1285, _1304
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: Self) -> "List[_1279.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: Self,
    ) -> "List[_1378.ElectricMachineLoadCaseGroup]":
    ...
    def add_electric_machine_detail(
        self: Self, type_: "_1285.ElectricMachineType", name: "str" = "Motor"
    ...
    def duplicate_electric_machine_detail(
        self: Self, detail: "_1279.ElectricMachineDetail"
    ...
    def remove_electric_machine_detail(
        self: Self, motor: "_1279.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: Self, load_case_group: "_1378.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool

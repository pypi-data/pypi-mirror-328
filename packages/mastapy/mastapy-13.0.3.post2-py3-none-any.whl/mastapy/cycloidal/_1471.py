...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1480, _1479, _1472
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: Self) -> "_1480.RingPinsDesign":
    ...
    @property
    def disc_phases(self: Self) -> "List[_1479.NamedDiscPhase]":
    ...
    @property
    def discs(self: Self) -> "List[_1472.CycloidalDiscDesign]":

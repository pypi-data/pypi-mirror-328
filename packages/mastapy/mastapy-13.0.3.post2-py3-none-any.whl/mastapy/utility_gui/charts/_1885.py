...
if TYPE_CHECKING:
    from mastapy.utility.report import _1761, _1766
    from mastapy.math_utility import _1507
    from mastapy.utility_gui.charts import _1881
...
class ThreeDChartDefinition(_1879.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: Self) -> "_1761.AxisSettings":
    ...
    @property
    def x_axis_range(self: Self) -> "_1507.Range":
    ...
    def x_axis_range(self: Self, value: "_1507.Range"):
        self.wrapped.XAxisRange = value.wrapped

    @property
    def y_axis_range(self: Self) -> "_1507.Range":
        """mastapy.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: Self, value: "_1507.Range"):
        self.wrapped.YAxisRange = value.wrapped

    @property
    def z_axis_range(self: Self) -> "_1507.Range":
        """mastapy.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: Self, value: "_1507.Range"):
        self.wrapped.ZAxisRange = value.wrapped

    def data_points_for_surfaces(self: Self) -> "List[_1881.PointsForSurface]":

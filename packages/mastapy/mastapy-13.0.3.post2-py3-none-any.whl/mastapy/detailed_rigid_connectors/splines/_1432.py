...
class SplineHalfDesign(_1406.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    @property
    def heat_treatment(self: Self) -> "_1416.HeatTreatmentTypes":
    ...
    @enforce_parameter_types
    def heat_treatment(self: Self, value: "_1416.HeatTreatmentTypes"):
    ...
    @property
    def fit_and_tolerance(self: Self) -> "_1439.FitAndTolerance":

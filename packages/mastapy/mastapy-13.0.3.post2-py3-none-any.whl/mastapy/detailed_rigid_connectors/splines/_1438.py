...
from mastapy.detailed_rigid_connectors.splines import _1421, _1422, _1433
...
class StandardSplineJointDesign(_1433.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    @enforce_parameter_types
    def module_preferred(self: Self, value: "_1421.Modules"):
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(self: Self, value: "_1422.PressureAngleTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1429, _1420, _1432
...
class DIN5480SplineHalfDesign(_1437.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self: Self) -> "_1429.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1429", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1429.FinishingMethods"):
    ...
    @property
    def manufacturing_type(self: Self) -> "_1420.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1420", "ManufacturingTypes"
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: Self, value: "_1420.ManufacturingTypes"):
        value = conversion.mp_to_pn_enum(

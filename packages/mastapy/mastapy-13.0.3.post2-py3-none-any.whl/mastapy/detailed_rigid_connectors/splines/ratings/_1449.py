...
class SplineHalfRating(_0.APIBase):
    ...
    class _Cast_SplineHalfRating:
        ...
        def agma6123_spline_half_rating(
            ...
            from mastapy.detailed_rigid_connectors.splines.ratings import _1441

            return self._parent._cast(_1441.AGMA6123SplineHalfRating)

        @property
        def din5466_spline_half_rating(
            self: "SplineHalfRating._Cast_SplineHalfRating",
        ) -> "_1443.DIN5466SplineHalfRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1443

            return self._parent._cast(_1443.DIN5466SplineHalfRating)

        @property
        def gbt17855_spline_half_rating(
            self: "SplineHalfRating._Cast_SplineHalfRating",
        ) -> "_1445.GBT17855SplineHalfRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1445

            return self._parent._cast(_1445.GBT17855SplineHalfRating)

        @property
        def sae_spline_half_rating(
            self: "SplineHalfRating._Cast_SplineHalfRating",
        ) -> "_1447.SAESplineHalfRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1447

            return self._parent._cast(_1447.SAESplineHalfRating)

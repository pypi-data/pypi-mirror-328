...
from mastapy.detailed_rigid_connectors.rating import _1454
...
class SplineJointRating(_1454.ShaftHubConnectionRating):
    """SplineJointRating
    ...
    class _Cast_SplineJointRating:
        ...
        def shaft_hub_connection_rating(
            ...
            return self._parent._cast(_1454.ShaftHubConnectionRating)
    ...
    @property
    def spline_half_ratings(self: Self) -> "List[_1449.SplineHalfRating]":

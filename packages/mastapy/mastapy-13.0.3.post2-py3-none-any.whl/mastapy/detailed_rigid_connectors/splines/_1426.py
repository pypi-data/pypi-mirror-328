...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1413, _1433
...
class SAESplineJointDesign(_1438.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: Self) -> "_1413.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1413", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: Self, value: "_1413.FitTypes"):

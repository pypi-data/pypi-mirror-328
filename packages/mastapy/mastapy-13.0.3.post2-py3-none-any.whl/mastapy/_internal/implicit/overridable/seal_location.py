...
from mastapy.bearings import _1918
...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1918.SealLocation":
        ...
        return _1918.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1918.SealLocation.type_()":
        ...
        return _1918.SealLocation.type_()

    @property
    def value(self: Self) -> "_1918.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1918.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1918.SealLocation":
        """mastapy.bearings.SealLocation

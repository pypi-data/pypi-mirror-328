...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1987.BallBearingContactCalculation":
        ...
        return _1987.BallBearingContactCalculation

    @classmethod
    def implicit_type(cls) -> "_1987.BallBearingContactCalculation.type_()":
        ...
        return _1987.BallBearingContactCalculation.type_()

    @property
    def value(self: Self) -> "_1987.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: Self) -> "_1987.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: Self) -> "_1987.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation

...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2498.UnbalancedMassInclusionOption":
        ...
        return _2498.UnbalancedMassInclusionOption

    @classmethod
    def implicit_type(cls) -> "_2498.UnbalancedMassInclusionOption.type_()":
        ...
        return _2498.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: Self) -> "_2498.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: Self) -> "_2498.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: Self) -> "_2498.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption

...
class Overridable_DQAxisConvention(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1277.DQAxisConvention":
        ...
        return _1277.DQAxisConvention

    @classmethod
    def implicit_type(cls) -> "_1277.DQAxisConvention.type_()":
        ...
        return _1277.DQAxisConvention.type_()

    @property
    def value(self: Self) -> "_1277.DQAxisConvention":
    ...
    @property
    def override_value(self: Self) -> "_1277.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
    ...
    @property
    def calculated_value(self: Self) -> "_1277.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention

...
from mastapy.bearings.bearing_designs.rolling import _2195
...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2195.WidthSeries":
        ...
        return _2195.WidthSeries

    @classmethod
    def implicit_type(cls) -> "_2195.WidthSeries.type_()":
        ...
        return _2195.WidthSeries.type_()

    @property
    def value(self: Self) -> "_2195.WidthSeries":
    ...
    @property
    def override_value(self: Self) -> "_2195.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2195.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries

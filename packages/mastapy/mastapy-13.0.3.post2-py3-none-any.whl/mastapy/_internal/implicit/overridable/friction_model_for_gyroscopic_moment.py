...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1992.FrictionModelForGyroscopicMoment":
        ...
        return _1992.FrictionModelForGyroscopicMoment

    @classmethod
    def implicit_type(cls) -> "_1992.FrictionModelForGyroscopicMoment.type_()":
        ...
        return _1992.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: Self) -> "_1992.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: Self) -> "_1992.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: Self) -> "_1992.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment

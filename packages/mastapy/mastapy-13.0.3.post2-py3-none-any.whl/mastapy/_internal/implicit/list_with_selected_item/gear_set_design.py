...
class ListWithSelectedItem_GearSetDesign(
    _954.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_954.GearSetDesign.TYPE":
        ...
        return _954.GearSetDesign.TYPE

    @property
    def selected_value(self: Self) -> "_954.GearSetDesign":
    ...
    @property
    def available_values(self: Self) -> "List[_954.GearSetDesign]":

...
class ListWithSelectedItem_DesignState(
    _5684.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5684.DesignState.TYPE":
        ...
        return _5684.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5684.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5684.DesignState]":

...
class ListWithSelectedItem_GearSet(_2552.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2552.GearSet.TYPE":
        ...
        return _2552.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2552.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2552.GearSet]":

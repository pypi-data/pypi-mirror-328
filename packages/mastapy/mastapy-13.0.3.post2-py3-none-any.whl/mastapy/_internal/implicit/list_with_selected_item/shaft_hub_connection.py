...
class ListWithSelectedItem_ShaftHubConnection(
    _2619.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2619.ShaftHubConnection.TYPE":
        ...
        return _2619.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2619.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2619.ShaftHubConnection]":

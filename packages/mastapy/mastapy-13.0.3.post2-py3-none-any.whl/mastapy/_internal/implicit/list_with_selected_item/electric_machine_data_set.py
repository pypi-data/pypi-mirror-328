...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2393.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2393.ElectricMachineDataSet.TYPE":
        ...
        return _2393.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2393.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2393.ElectricMachineDataSet]":

...
class ListWithSelectedItem_ElectricMachineDetail(
    _1279.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1279.ElectricMachineDetail.TYPE":
        ...
        return _1279.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1279.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1279.ElectricMachineDetail]":

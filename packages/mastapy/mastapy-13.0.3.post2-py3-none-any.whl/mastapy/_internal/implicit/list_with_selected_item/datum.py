...
class ListWithSelectedItem_Datum(_2468.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2468.Datum.TYPE":
        ...
        return _2468.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2468.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2468.Datum]":

...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5700.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5700.AbstractPeriodicExcitationDetail.TYPE":
        ...
        return _5700.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: Self) -> "_5700.AbstractPeriodicExcitationDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_5700.AbstractPeriodicExcitationDetail]":

...
class ListWithSelectedItem_ColumnTitle(
    _1835.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1835.ColumnTitle.TYPE":
        ...
        return _1835.ColumnTitle.TYPE

    @property
    def selected_value(self: Self) -> "_1835.ColumnTitle":
    ...
    @property
    def available_values(self: Self) -> "List[_1835.ColumnTitle]":

...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2780.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2780.GearMeshSystemDeflection.TYPE":
        ...
        return _2780.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2780.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2780.GearMeshSystemDeflection]":

...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _794.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_794.ConicalSetManufacturingConfig.TYPE":
        ...
        return _794.ConicalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_794.ConicalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_794.ConicalSetManufacturingConfig]":

...
class ListWithSelectedItem_RotorSkewSlice(
    _1313.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1313.RotorSkewSlice.TYPE":
        ...
        return _1313.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1313.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1313.RotorSkewSlice]":

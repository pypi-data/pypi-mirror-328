...
class ListWithSelectedItem_ConcentricPartGroup(
    _2507.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2507.ConcentricPartGroup.TYPE":
        ...
        return _2507.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2507.ConcentricPartGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2507.ConcentricPartGroup]":

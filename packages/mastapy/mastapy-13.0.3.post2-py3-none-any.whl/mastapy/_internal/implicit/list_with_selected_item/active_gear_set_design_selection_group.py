...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2532.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2532.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2532.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2532.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2532.ActiveGearSetDesignSelectionGroup]":

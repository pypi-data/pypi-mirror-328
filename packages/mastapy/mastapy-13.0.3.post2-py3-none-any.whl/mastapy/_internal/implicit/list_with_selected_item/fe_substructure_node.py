...
class ListWithSelectedItem_FESubstructureNode(
    _2405.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2405.FESubstructureNode.TYPE":
        ...
        return _2405.FESubstructureNode.TYPE

    @property
    def selected_value(self: Self) -> "_2405.FESubstructureNode":
    ...
    @property
    def available_values(self: Self) -> "List[_2405.FESubstructureNode]":

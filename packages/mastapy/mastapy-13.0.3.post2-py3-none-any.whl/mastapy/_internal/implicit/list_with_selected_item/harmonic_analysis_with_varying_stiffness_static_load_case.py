...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        cls,
    ) -> "_5791.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE":
        ...
        return _5791.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_5791.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":

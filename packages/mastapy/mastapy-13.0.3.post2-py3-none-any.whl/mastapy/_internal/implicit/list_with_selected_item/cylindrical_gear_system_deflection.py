...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2766.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2766.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2766.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2766.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2766.CylindricalGearSystemDeflection]":

...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1208.ToothThicknessSpecificationMethod":
        ...
        return _1208.ToothThicknessSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_1208.ToothThicknessSpecificationMethod.type_()":
        ...
        return _1208.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1208.ToothThicknessSpecificationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1208.ToothThicknessSpecificationMethod]":

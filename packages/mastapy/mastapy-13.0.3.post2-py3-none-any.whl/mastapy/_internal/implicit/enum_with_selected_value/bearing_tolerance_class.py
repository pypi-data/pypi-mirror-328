...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1923.BearingToleranceClass":
        ...
        return _1923.BearingToleranceClass

    @classmethod
    def implicit_type(cls) -> "_1923.BearingToleranceClass.type_()":
        ...
        return _1923.BearingToleranceClass.type_()

    @property
    def selected_value(self: Self) -> "_1923.BearingToleranceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1923.BearingToleranceClass]":

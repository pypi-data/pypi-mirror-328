...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2172.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2172.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2172.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2172.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2172.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2172.FatigueLoadLimitCalculationMethodEnum]":

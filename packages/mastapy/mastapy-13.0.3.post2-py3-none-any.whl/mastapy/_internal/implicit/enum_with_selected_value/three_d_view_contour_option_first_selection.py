...
from mastapy.utility.enums import _1840
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1840.ThreeDViewContourOptionFirstSelection":
        ...
        return _1840.ThreeDViewContourOptionFirstSelection

    @classmethod
    def implicit_type(cls) -> "_1840.ThreeDViewContourOptionFirstSelection.type_()":
        ...
        return _1840.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: Self) -> "_1840.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1840.ThreeDViewContourOptionFirstSelection]":

...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1258
...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1258.ProSolveSolverType":
        ...
        return _1258.ProSolveSolverType

    @classmethod
    def implicit_type(cls) -> "_1258.ProSolveSolverType.type_()":
        ...
        return _1258.ProSolveSolverType.type_()

    @property
    def selected_value(self: Self) -> "_1258.ProSolveSolverType":
    ...
    @property
    def available_values(self: Self) -> "List[_1258.ProSolveSolverType]":

...
from mastapy.electric_machines.load_cases_and_analyses import _1390
...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1390.SpecifyTorqueOrCurrent":
        ...
        return _1390.SpecifyTorqueOrCurrent

    @classmethod
    def implicit_type(cls) -> "_1390.SpecifyTorqueOrCurrent.type_()":
        ...
        return _1390.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: Self) -> "_1390.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: Self) -> "List[_1390.SpecifyTorqueOrCurrent]":

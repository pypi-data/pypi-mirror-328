...
from mastapy.bearings.bearing_results import _1983
...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1983.RaceAxialMountingType":
        ...
        return _1983.RaceAxialMountingType

    @classmethod
    def implicit_type(cls) -> "_1983.RaceAxialMountingType.type_()":
        ...
        return _1983.RaceAxialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1983.RaceAxialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1983.RaceAxialMountingType]":

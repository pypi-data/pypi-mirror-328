...
from mastapy.detailed_rigid_connectors.splines import _1435
...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1435.SplineRatingTypes":
        ...
        return _1435.SplineRatingTypes

    @classmethod
    def implicit_type(cls) -> "_1435.SplineRatingTypes.type_()":
        ...
        return _1435.SplineRatingTypes.type_()

    @property
    def selected_value(self: Self) -> "_1435.SplineRatingTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1435.SplineRatingTypes]":

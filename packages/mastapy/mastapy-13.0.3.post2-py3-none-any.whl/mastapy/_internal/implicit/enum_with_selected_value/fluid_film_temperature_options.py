...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1904.FluidFilmTemperatureOptions":
        ...
        return _1904.FluidFilmTemperatureOptions

    @classmethod
    def implicit_type(cls) -> "_1904.FluidFilmTemperatureOptions.type_()":
        ...
        return _1904.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: Self) -> "_1904.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1904.FluidFilmTemperatureOptions]":

...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6999.TorqueSpecificationForSystemDeflection":
        ...
        return _6999.TorqueSpecificationForSystemDeflection

    @classmethod
    def implicit_type(cls) -> "_6999.TorqueSpecificationForSystemDeflection.type_()":
        ...
        return _6999.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: Self) -> "_6999.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6999.TorqueSpecificationForSystemDeflection]":

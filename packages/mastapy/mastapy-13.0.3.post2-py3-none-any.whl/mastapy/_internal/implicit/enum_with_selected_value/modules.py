...
class EnumWithSelectedValue_Modules(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1421.Modules":
        ...
        return _1421.Modules

    @classmethod
    def implicit_type(cls) -> "_1421.Modules.type_()":
        ...
        return _1421.Modules.type_()

    @property
    def selected_value(self: Self) -> "_1421.Modules":
    ...
    @property
    def available_values(self: Self) -> "List[_1421.Modules]":

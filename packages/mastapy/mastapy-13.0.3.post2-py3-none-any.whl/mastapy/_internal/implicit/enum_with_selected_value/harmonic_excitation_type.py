...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6919.HarmonicExcitationType":
        ...
        return _6919.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6919.HarmonicExcitationType.type_()":
        ...
        return _6919.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6919.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6919.HarmonicExcitationType]":

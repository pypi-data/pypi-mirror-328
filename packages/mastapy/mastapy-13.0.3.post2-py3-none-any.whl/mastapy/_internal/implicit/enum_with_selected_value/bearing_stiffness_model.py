...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5407.BearingStiffnessModel":
        ...
        return _5407.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5407.BearingStiffnessModel.type_()":
        ...
        return _5407.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5407.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5407.BearingStiffnessModel]":

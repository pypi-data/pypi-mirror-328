...
class EnumWithSelectedValue_CoilPositionInSlot(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1271.CoilPositionInSlot":
        ...
        return _1271.CoilPositionInSlot

    @classmethod
    def implicit_type(cls) -> "_1271.CoilPositionInSlot.type_()":
        ...
        return _1271.CoilPositionInSlot.type_()

    @property
    def selected_value(self: Self) -> "_1271.CoilPositionInSlot":
    ...
    @property
    def available_values(self: Self) -> "List[_1271.CoilPositionInSlot]":

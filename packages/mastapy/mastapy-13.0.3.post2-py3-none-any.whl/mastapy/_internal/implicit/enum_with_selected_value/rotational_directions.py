...
from mastapy.bearings import _1917
...
class EnumWithSelectedValue_RotationalDirections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1917.RotationalDirections":
        ...
        return _1917.RotationalDirections

    @classmethod
    def implicit_type(cls) -> "_1917.RotationalDirections.type_()":
        ...
        return _1917.RotationalDirections.type_()

    @property
    def selected_value(self: Self) -> "_1917.RotationalDirections":
    ...
    @property
    def available_values(self: Self) -> "List[_1917.RotationalDirections]":

...
from mastapy.bearings.bearing_results import _1984
...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1984.RaceRadialMountingType":
        ...
        return _1984.RaceRadialMountingType

    @classmethod
    def implicit_type(cls) -> "_1984.RaceRadialMountingType.type_()":
        ...
        return _1984.RaceRadialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1984.RaceRadialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1984.RaceRadialMountingType]":

...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1513.ComplexPartDisplayOption":
        ...
        return _1513.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1513.ComplexPartDisplayOption.type_()":
        ...
        return _1513.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1513.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1513.ComplexPartDisplayOption]":

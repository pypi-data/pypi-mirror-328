...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1763.CadPageOrientation":
        ...
        return _1763.CadPageOrientation

    @classmethod
    def implicit_type(cls) -> "_1763.CadPageOrientation.type_()":
        ...
        return _1763.CadPageOrientation.type_()

    @property
    def selected_value(self: Self) -> "_1763.CadPageOrientation":
    ...
    @property
    def available_values(self: Self) -> "List[_1763.CadPageOrientation]":

...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1522.DegreeOfFreedom":
        ...
        return _1522.DegreeOfFreedom

    @classmethod
    def implicit_type(cls) -> "_1522.DegreeOfFreedom.type_()":
        ...
        return _1522.DegreeOfFreedom.type_()

    @property
    def selected_value(self: Self) -> "_1522.DegreeOfFreedom":
    ...
    @property
    def available_values(self: Self) -> "List[_1522.DegreeOfFreedom]":

...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2495.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        return _2495.ShaftDiameterModificationDueToRollingBearingRing

    @classmethod
    def implicit_type(
        cls,
    ) -> "_2495.ShaftDiameterModificationDueToRollingBearingRing.type_()":
        ...
        return _2495.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_2495.ShaftDiameterModificationDueToRollingBearingRing]":

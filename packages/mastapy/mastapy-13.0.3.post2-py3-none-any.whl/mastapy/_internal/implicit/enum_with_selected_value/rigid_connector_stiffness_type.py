...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2612.RigidConnectorStiffnessType":
        ...
        return _2612.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2612.RigidConnectorStiffnessType.type_()":
        ...
        return _2612.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2612.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2612.RigidConnectorStiffnessType]":

...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1528.ExtrapolationOptions":
        ...
        return _1528.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1528.ExtrapolationOptions.type_()":
        ...
        return _1528.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1528.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1528.ExtrapolationOptions]":

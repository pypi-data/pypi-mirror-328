...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2386.ComponentOrientationOption":
        ...
        return _2386.ComponentOrientationOption

    @classmethod
    def implicit_type(cls) -> "_2386.ComponentOrientationOption.type_()":
        ...
        return _2386.ComponentOrientationOption.type_()

    @property
    def selected_value(self: Self) -> "_2386.ComponentOrientationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2386.ComponentOrientationOption]":

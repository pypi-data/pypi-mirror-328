...
from mastapy.bearings.tolerances import _1943
...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1943.SupportToleranceLocationDesignation":
        ...
        return _1943.SupportToleranceLocationDesignation

    @classmethod
    def implicit_type(cls) -> "_1943.SupportToleranceLocationDesignation.type_()":
        ...
        return _1943.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1943.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1943.SupportToleranceLocationDesignation]":

...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5530.TorqueConverterLockupRule":
        ...
        return _5530.TorqueConverterLockupRule

    @classmethod
    def implicit_type(cls) -> "_5530.TorqueConverterLockupRule.type_()":
        ...
        return _5530.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: Self) -> "_5530.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: Self) -> "List[_5530.TorqueConverterLockupRule]":

...
from mastapy.gears.gear_designs.conical import _1187
...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1187.LoadDistributionFactorMethods":
        ...
        return _1187.LoadDistributionFactorMethods

    @classmethod
    def implicit_type(cls) -> "_1187.LoadDistributionFactorMethods.type_()":
        ...
        return _1187.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: Self) -> "_1187.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1187.LoadDistributionFactorMethods]":

...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1911.RollerBearingProfileTypes":
        ...
        return _1911.RollerBearingProfileTypes

    @classmethod
    def implicit_type(cls) -> "_1911.RollerBearingProfileTypes.type_()":
        ...
        return _1911.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: Self) -> "_1911.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1911.RollerBearingProfileTypes]":

...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_5766.ExportOutputType":
        ...
        return _5766.ExportOutputType

    @classmethod
    def implicit_type(cls) -> "_5766.ExportOutputType.type_()":
        ...
        return _5766.ExportOutputType.type_()

    @property
    def selected_value(self: Self) -> "_5766.ExportOutputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5766.ExportOutputType]":

...
class EnumWithSelectedValue_Table4JointInterfaceTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1466.Table4JointInterfaceTypes":
        ...
        return _1466.Table4JointInterfaceTypes

    @classmethod
    def implicit_type(cls) -> "_1466.Table4JointInterfaceTypes.type_()":
        ...
        return _1466.Table4JointInterfaceTypes.type_()

    @property
    def selected_value(self: Self) -> "_1466.Table4JointInterfaceTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1466.Table4JointInterfaceTypes]":

...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2234.MeshStiffnessModel":
        ...
        return _2234.MeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_2234.MeshStiffnessModel.type_()":
        ...
        return _2234.MeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_2234.MeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2234.MeshStiffnessModel]":

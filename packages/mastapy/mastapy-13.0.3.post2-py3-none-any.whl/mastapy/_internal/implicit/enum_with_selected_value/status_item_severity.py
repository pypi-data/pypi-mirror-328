...
from mastapy.utility.model_validation import _1813
...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1813.StatusItemSeverity":
        ...
        return _1813.StatusItemSeverity

    @classmethod
    def implicit_type(cls) -> "_1813.StatusItemSeverity.type_()":
        ...
        return _1813.StatusItemSeverity.type_()

    @property
    def selected_value(self: Self) -> "_1813.StatusItemSeverity":
    ...
    @property
    def available_values(self: Self) -> "List[_1813.StatusItemSeverity]":

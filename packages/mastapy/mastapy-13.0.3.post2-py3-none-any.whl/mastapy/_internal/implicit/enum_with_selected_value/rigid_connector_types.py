...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2616.RigidConnectorTypes":
        ...
        return _2616.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2616.RigidConnectorTypes.type_()":
        ...
        return _2616.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2616.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2616.RigidConnectorTypes]":

...
from mastapy.bearings import _1912
...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1912.RollingBearingArrangement":
        ...
        return _1912.RollingBearingArrangement

    @classmethod
    def implicit_type(cls) -> "_1912.RollingBearingArrangement.type_()":
        ...
        return _1912.RollingBearingArrangement.type_()

    @property
    def selected_value(self: Self) -> "_1912.RollingBearingArrangement":
    ...
    @property
    def available_values(self: Self) -> "List[_1912.RollingBearingArrangement]":

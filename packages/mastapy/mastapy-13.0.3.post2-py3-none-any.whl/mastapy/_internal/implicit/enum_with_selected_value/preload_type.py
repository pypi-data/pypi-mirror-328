...
from mastapy.bearings.bearing_results import _1981
...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1981.PreloadType":
        ...
        return _1981.PreloadType

    @classmethod
    def implicit_type(cls) -> "_1981.PreloadType.type_()":
        ...
        return _1981.PreloadType.type_()

    @property
    def selected_value(self: Self) -> "_1981.PreloadType":
    ...
    @property
    def available_values(self: Self) -> "List[_1981.PreloadType]":

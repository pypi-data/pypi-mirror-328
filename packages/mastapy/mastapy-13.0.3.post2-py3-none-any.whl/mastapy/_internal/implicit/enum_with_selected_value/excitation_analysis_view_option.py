...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2282.ExcitationAnalysisViewOption":
        ...
        return _2282.ExcitationAnalysisViewOption

    @classmethod
    def implicit_type(cls) -> "_2282.ExcitationAnalysisViewOption.type_()":
        ...
        return _2282.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: Self) -> "_2282.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2282.ExcitationAnalysisViewOption]":

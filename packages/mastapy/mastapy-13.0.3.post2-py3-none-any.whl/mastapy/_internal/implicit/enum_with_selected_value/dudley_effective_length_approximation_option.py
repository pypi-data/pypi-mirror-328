...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1412.DudleyEffectiveLengthApproximationOption":
        ...
        return _1412.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1412.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1412.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1412.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1412.DudleyEffectiveLengthApproximationOption]":

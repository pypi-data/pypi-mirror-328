...
from mastapy.utility.enums import _1841
...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1841.ThreeDViewContourOptionSecondSelection":
        ...
        return _1841.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1841.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1841.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1841.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1841.ThreeDViewContourOptionSecondSelection]":

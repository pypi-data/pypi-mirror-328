...
class EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption(
    ...
    def wrapped_type(
        cls,
    ) -> "_1164.CylindricalGearPairCreationOptions.DerivedParameterOption":
        ...
        return _1164.CylindricalGearPairCreationOptions.DerivedParameterOption

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1164.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()":
        ...
        return _1164.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_1164.CylindricalGearPairCreationOptions.DerivedParameterOption]":

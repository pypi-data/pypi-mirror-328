...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1382.LoadCaseType":
        ...
        return _1382.LoadCaseType

    @classmethod
    def implicit_type(cls) -> "_1382.LoadCaseType.type_()":
        ...
        return _1382.LoadCaseType.type_()

    @property
    def selected_value(self: Self) -> "_1382.LoadCaseType":
    ...
    @property
    def available_values(self: Self) -> "List[_1382.LoadCaseType]":

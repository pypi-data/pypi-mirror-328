...
class EnumWithSelectedValue_ElmerResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_176.ElmerResultType":
        ...
        return _176.ElmerResultType

    @classmethod
    def implicit_type(cls) -> "_176.ElmerResultType.type_()":
        ...
        return _176.ElmerResultType.type_()

    @property
    def selected_value(self: Self) -> "_176.ElmerResultType":
    ...
    @property
    def available_values(self: Self) -> "List[_176.ElmerResultType]":

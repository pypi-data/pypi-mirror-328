...
class EnumWithSelectedValue_DesignEntityId(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2224.DesignEntityId":
        ...
        return _2224.DesignEntityId

    @classmethod
    def implicit_type(cls) -> "_2224.DesignEntityId.type_()":
        ...
        return _2224.DesignEntityId.type_()

    @property
    def selected_value(self: Self) -> "_2224.DesignEntityId":
    ...
    @property
    def available_values(self: Self) -> "List[_2224.DesignEntityId]":

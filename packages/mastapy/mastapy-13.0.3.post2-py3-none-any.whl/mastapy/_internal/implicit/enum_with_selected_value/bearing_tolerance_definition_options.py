...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1924.BearingToleranceDefinitionOptions":
        ...
        return _1924.BearingToleranceDefinitionOptions

    @classmethod
    def implicit_type(cls) -> "_1924.BearingToleranceDefinitionOptions.type_()":
        ...
        return _1924.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: Self) -> "_1924.BearingToleranceDefinitionOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1924.BearingToleranceDefinitionOptions]":

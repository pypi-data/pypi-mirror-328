...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2129.StressConcentrationMethod":
        ...
        return _2129.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2129.StressConcentrationMethod.type_()":
        ...
        return _2129.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2129.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2129.StressConcentrationMethod]":

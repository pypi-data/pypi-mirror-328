...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1422.PressureAngleTypes":
        ...
        return _1422.PressureAngleTypes

    @classmethod
    def implicit_type(cls) -> "_1422.PressureAngleTypes.type_()":
        ...
        return _1422.PressureAngleTypes.type_()

    @property
    def selected_value(self: Self) -> "_1422.PressureAngleTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1422.PressureAngleTypes]":

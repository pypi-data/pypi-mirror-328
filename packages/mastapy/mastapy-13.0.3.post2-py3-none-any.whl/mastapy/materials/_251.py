...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    def bh_curve(self: Self, value: "_1553.Vector2DListAccessor"):
        self.wrapped.BHCurve = value.wrapped

    @property
    def bh_curve_plot(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def bh_curve_extrapolation_method(self: Self) -> "_250.BHCurveExtrapolationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._250", "BHCurveExtrapolationMethod"
        )(value)

    @bh_curve_extrapolation_method.setter
    @enforce_parameter_types
    def bh_curve_extrapolation_method(
        self: Self, value: "_250.BHCurveExtrapolationMethod"
    ):

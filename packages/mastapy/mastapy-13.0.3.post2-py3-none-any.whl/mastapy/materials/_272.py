...
if TYPE_CHECKING:
    ...
    from mastapy.bolts import _1484, _1488
...
class Material(_1847.NamedDatabaseItem):
    """Material
    ...
    class _Cast_Material:
        ...
        @property
        def magnet_material(self: "Material._Cast_Material") -> "_1301.MagnetMaterial":
        ...
        @property
        def spline_material(self: "Material._Cast_Material") -> "_1434.SplineMaterial":
            from mastapy.detailed_rigid_connectors.splines import _1434
        ...
        @property
        def bolt_material(self: "Material._Cast_Material") -> "_1488.BoltMaterial":

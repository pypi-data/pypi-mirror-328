...
class LubricationDetail(_1847.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def density_vs_temperature(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def density_vs_temperature(self: Self, value: "_1553.Vector2DListAccessor"):

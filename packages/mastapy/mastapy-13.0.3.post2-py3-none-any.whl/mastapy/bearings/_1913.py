...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1916, _1889, _1905
...
class RollingBearingDatabase(
    _1849.SQLDatabase["_1914.RollingBearingKey", "_2185.RollingBearing"]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: Self, bearing: "_2185.RollingBearing"):
    ...
    @enforce_parameter_types
    def create_bearing(
        self: Self, type_: "_1916.RollingBearingType", designation: "str" = "None"
    ...
    @enforce_parameter_types
    def remove_from_database(self: Self, bearing: "_2185.RollingBearing"):
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: Self, catalog: "_1889.BearingCatalog"
    ) -> "List[_2185.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: Self, designation: "str", catalog: "_1889.BearingCatalog"
    ) -> "_2185.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: Self,
        designation: "str",
        catalog: "_1889.BearingCatalog",
        type_: "_1916.RollingBearingType",
    ) -> "List[_2185.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1889.BearingCatalog",
        type_: "_1916.RollingBearingType",
        bore_range: "_1507.Range",
        outer_diameter_range: "_1507.Range",
        width_range: "_1507.Range",
        dynamic_capacity_range: "_1507.Range",
        number_of_rows: "int",
        material_type: "_1905.HybridSteelAll",
    ) -> "List[_2185.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]

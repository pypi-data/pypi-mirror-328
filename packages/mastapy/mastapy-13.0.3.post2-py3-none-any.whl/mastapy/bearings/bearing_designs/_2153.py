...
class LinearBearing(_2150.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: Self) -> "_1902.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1902", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(self: Self, value: "_1902.BearingStiffnessMatrixOption"):

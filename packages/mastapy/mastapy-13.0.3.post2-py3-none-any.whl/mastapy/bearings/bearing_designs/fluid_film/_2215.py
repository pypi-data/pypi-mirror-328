...
if TYPE_CHECKING:
    from mastapy.bearings import _1920
...
class TiltingPadThrustBearing(_2207.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: Self) -> "_1920.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1920", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: Self, value: "_1920.TiltingPadTypes"):

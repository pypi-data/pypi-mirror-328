...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self: Self) -> "_2165.BearingProtectionLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2165", "BearingProtectionLevel"
        )(value)
    ...
    @property
    def new_protection_level(self: Self) -> "_2165.BearingProtectionLevel":
        """mastapy.bearings.bearing_designs.rolling.BearingProtectionLevel"""
    ...
    @enforce_parameter_types
    def new_protection_level(self: Self, value: "_2165.BearingProtectionLevel"):

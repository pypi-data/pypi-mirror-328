...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2197, _2196
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self: Self) -> "List[_2197.BearingImportFile]":
    ...
    @property
    def variables(self: Self) -> "List[_2196.AbstractXmlVariableAssignment]":

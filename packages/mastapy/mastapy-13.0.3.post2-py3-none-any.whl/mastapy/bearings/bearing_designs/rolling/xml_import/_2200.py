...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2196
...
class XMLVariableAssignment(_2196.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
    ...
    class _Cast_XMLVariableAssignment:
        ...
        def abstract_xml_variable_assignment(
            ...
            return self._parent._cast(_2196.AbstractXmlVariableAssignment)

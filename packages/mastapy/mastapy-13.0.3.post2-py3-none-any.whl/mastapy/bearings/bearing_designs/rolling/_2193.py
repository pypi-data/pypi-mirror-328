...
if TYPE_CHECKING:
    from mastapy.bearings import _1909
...
class ThrustBallBearing(_2160.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: Self) -> "_1909.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1909", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: Self, value: "_1909.OuterRingMounting"):

...
if TYPE_CHECKING:
    from mastapy.utility.vectors import _1853, _1852
...
class LoadedBallBearingElement(_2034.LoadedElement):
    """LoadedBallBearingElement
    ...
    class _Cast_LoadedBallBearingElement:
        ...
        def loaded_angular_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2002.LoadedAngularContactBallBearingElement)
        ...
        def loaded_deep_groove_ball_bearing_element(
            ...
            return self._parent._cast(_2031.LoadedDeepGrooveBallBearingElement)
        ...
        def loaded_four_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2035.LoadedFourPointContactBallBearingElement)
        ...
        def loaded_multi_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2039.LoadedMultiPointContactBallBearingElement)
        ...
        def loaded_self_aligning_ball_bearing_element(
            ...
            return self._parent._cast(_2055.LoadedSelfAligningBallBearingElement)
        ...
        def loaded_three_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2070.LoadedThreePointContactBallBearingElement)
        ...
        def loaded_thrust_ball_bearing_element(
            ...
            return self._parent._cast(_2073.LoadedThrustBallBearingElement)
    ...
    def contact_patch_pressure_velocity_inner(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchPressureVelocityInner
    ...
    def contact_patch_pressure_velocity_outer(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchPressureVelocityOuter
    ...
    @property
    def contact_patch_sliding_speed_inner(self: Self) -> "_1853.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData

        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingSpeedInner
    ...
    @property
    def contact_patch_sliding_speed_outer(self: Self) -> "_1853.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData

        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingSpeedOuter
    ...
    def contact_patch_sliding_velocity_inner(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingVelocityInner
    ...
    def contact_patch_sliding_velocity_outer(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingVelocityOuter
    ...
    def inner_race_contact_geometries(
        self: Self,
    ) -> "List[_1988.BallBearingRaceContactGeometry]":

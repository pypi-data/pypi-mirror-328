...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2071, _2054
...
class LoadedThreePointContactBallBearingRow(_2023.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2071.LoadedThreePointContactBallBearingResults":

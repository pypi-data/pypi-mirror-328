...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2074, _2054
...
class LoadedThrustBallBearingRow(_2023.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2074.LoadedThrustBallBearingResults":

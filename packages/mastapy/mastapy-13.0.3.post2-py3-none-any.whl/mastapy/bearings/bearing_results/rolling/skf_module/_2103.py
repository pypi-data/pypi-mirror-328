...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2105, _2104
...
class Friction(_2116.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self: Self) -> "_2105.FrictionSources":
    ...
    @property
    def frictional_moment(self: Self) -> "_2104.FrictionalMoment":

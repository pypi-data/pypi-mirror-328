...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2112
...
class Viscosities(_2116.SKFCalculationResult):
    """Viscosities
    ...
    @property
    def operating_viscosity(self: Self) -> "_2112.OperatingViscosity":

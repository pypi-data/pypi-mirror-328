...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2113
...
class DynamicAxialLoadCarryingCapacity(_2116.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self: Self) -> "_2113.PermissibleAxialLoad":

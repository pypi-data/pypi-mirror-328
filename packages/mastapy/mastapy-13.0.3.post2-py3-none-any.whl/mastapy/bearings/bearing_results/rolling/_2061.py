...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2060, _2054
...
class LoadedSphericalRollerRadialBearingRow(_2050.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2060.LoadedSphericalRollerRadialBearingResults":

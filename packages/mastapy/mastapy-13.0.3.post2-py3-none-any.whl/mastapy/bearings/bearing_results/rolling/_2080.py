...
from mastapy.bearings.bearing_results.rolling import _2082
...
class MaximumStaticContactStress(_2082.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
    ...
    class _Cast_MaximumStaticContactStress:
        ...
        def maximum_static_contact_stress_results_abstract(
            ...
            return self._parent._cast(_2082.MaximumStaticContactStressResultsAbstract)

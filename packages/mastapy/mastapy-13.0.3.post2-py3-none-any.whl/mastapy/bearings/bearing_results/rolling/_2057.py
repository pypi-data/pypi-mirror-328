...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2056, _2054
...
class LoadedSelfAligningBallBearingRow(_2023.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2056.LoadedSelfAligningBallBearingResults":

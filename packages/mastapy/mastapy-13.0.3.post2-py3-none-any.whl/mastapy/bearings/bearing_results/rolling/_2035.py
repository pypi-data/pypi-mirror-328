...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling import _2020, _2034
...
class LoadedFourPointContactBallBearingElement(
    ...
    def contact_patch_pressure_velocity_outer_left(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchPressureVelocityOuterLeft
    ...
    def contact_patch_pressure_velocity_outer_right(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchPressureVelocityOuterRight
    ...
    def contact_patch_sliding_speed_outer_left(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingSpeedOuterLeft
    ...
    def contact_patch_sliding_speed_outer_right(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingSpeedOuterRight
    ...
    def contact_patch_sliding_velocity_outer_left(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingVelocityOuterLeft
    ...
    def contact_patch_sliding_velocity_outer_right(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.ContactPatchSlidingVelocityOuterRight

...
from mastapy.bearings.bearing_results.rolling.fitting import _2133
...
class InnerRingFittingThermalResults(_2133.RingFittingThermalResults):
    """InnerRingFittingThermalResults
    ...
    class _Cast_InnerRingFittingThermalResults:
        ...
        def ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2133.RingFittingThermalResults)

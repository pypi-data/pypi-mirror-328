...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.fluid_film import _2146, _2149
...
class LoadedFluidFilmBearingPad(_0.APIBase):
    ...
    class _Cast_LoadedFluidFilmBearingPad:
        ...
        def loaded_tilting_journal_pad(
            ...
            return self._parent._cast(_2146.LoadedTiltingJournalPad)

        @property
        def loaded_tilting_thrust_pad(
            self: "LoadedFluidFilmBearingPad._Cast_LoadedFluidFilmBearingPad",
        ) -> "_2149.LoadedTiltingThrustPad":
            from mastapy.bearings.bearing_results.fluid_film import _2149

            return self._parent._cast(_2149.LoadedTiltingThrustPad)

...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results import _1969, _1976, _1979
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: Self) -> "_2150.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: Self) -> "List[_1969.LoadedBearingResults]":

...
class Vector2D(VectorBase):
    ...
    def from_iterable(cls, t: Iterable[NUM]) -> "Vector2D":
        ...
        try:
            ...
            raise VectorException("Tuple must be of at least length 2.") from None
    ...
    @classmethod
    def min(cls, v0: Iterable[NUM], v1: Union[NUM, Iterable[NUM]]) -> "Vector2D":
        """Component-wise min.
    ...
    @classmethod
    def max(cls, v0: Iterable[NUM], v1: Union[NUM, Iterable[NUM]]) -> "Vector2D":
        """Component-wise max.
    ...
    @classmethod
    def step(cls, edge: Union[NUM, Iterable[NUM]], v: Iterable[NUM]) -> "Vector2D":
        """Component-wise step.
    ...
    @classmethod
    def atan2(cls, v: Iterable[NUM], w: Union[NUM, Iterable[NUM]]) -> "Vector2D":
    ...
    @classmethod
    def refract(cls, i: Iterable[NUM], n: Iterable[NUM], r: float) -> "Vector2D":

...
if TYPE_CHECKING:
    from mastapy.utility.reporting_property_framework import _1807
    from mastapy.math_utility.optimisation import _1569
...
TAnalysis = TypeVar("TAnalysis", bound="_1235.AbstractGearSetAnalysis")
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self: Self) -> "_1807.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1807", "CustomChartType"
        )(value)
    ...
    def select_chart_type(
        self: Self,
    ) -> "_1569.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1569",
    ...
    def select_chart_type(
        self: Self,
        value: "_1569.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ):

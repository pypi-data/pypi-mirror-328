...
if TYPE_CHECKING:
    ...
    from mastapy.gears.cylindrical import _1229, _1228, _1227, _1226
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self: Self) -> "List[_1227.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: Self,
    ) -> "List[_1226.CylindricalGearLTCAContactChartDataAsTextFile]":

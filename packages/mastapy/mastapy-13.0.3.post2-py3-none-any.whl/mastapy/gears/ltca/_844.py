...
class GearMeshLoadDistributionAnalysis(_1241.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: Self) -> "_1531.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: Self) -> "_1531.FourierSeries":
        """mastapy.math_utility.FourierSeries

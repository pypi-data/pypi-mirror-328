...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1186
...
class KlingelnbergConicalGearSetDesign(_1174.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self: Self) -> "_1186.KlingelnbergFinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1186", "KlingelnbergFinishingMethods"
        )(value)

    @gear_finish.setter
    @enforce_parameter_types
    def gear_finish(self: Self, value: "_1186.KlingelnbergFinishingMethods"):

...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.worm import _964, _960, _963, _961
...
class WormGearMeshDesign(_953.GearMeshDesign):
    """WormGearMeshDesign
    ...
    @property
    def wheel(self: Self) -> "_964.WormWheelDesign":
    ...
    @property
    def worm(self: Self) -> "_960.WormDesign":

...
from mastapy.gears.gear_designs.conical import _1187, _1173
...
class AGMAGleasonConicalGearMeshDesign(_1173.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    @enforce_parameter_types
    def load_distribution_factor_method(
        self: Self, value: "_1187.LoadDistributionFactorMethods"
    ):

...
from mastapy.utility.units_and_measurements.measurements import _1685, _1706
...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1046, _1056, _1077, _1097
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    class _Cast_ToothThicknessSpecificationBase:
        ...
        def finish_tooth_thickness_design_specification(
            ...
            return self._parent._cast(_1056.FinishToothThicknessDesignSpecification)
        ...
        def readonly_tooth_thickness_specification(
            ...
            return self._parent._cast(_1077.ReadonlyToothThicknessSpecification)

        @property
        def tooth_thickness_specification(
            self: "ToothThicknessSpecificationBase._Cast_ToothThicknessSpecificationBase",
        ) -> "_1097.ToothThicknessSpecification":
            from mastapy.gears.gear_designs.cylindrical import _1097

            return self._parent._cast(_1097.ToothThicknessSpecification)
    ...
    def chordal_span(
        self: Self,
    ) -> "_1046.CylindricalGearToothThicknessSpecification[_1685.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: Self,
    ) -> "_1046.CylindricalGearToothThicknessSpecification[_1706.Number]":
    ...
    def tooth_thickness(
        self: Self,
    ) -> "List[_1046.CylindricalGearToothThicknessSpecification[_1685.LengthShort]]":

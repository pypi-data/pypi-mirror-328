...
class FinishStockSpecification(
    _1079.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: Self, value: "_1102.FinishStockType"
    ):
    ...
    def normal(
        self: Self,
    ) -> "_1095.TolerancedValueSpecification[FinishStockSpecification]":

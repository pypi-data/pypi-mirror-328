...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1035, _1022
...
class CylindricalGearFlankMicroGeometry(_573.FlankMicroGeometry):
    ...
    @property
    def micro_geometry_matrix(self: Self) -> "_1583.GriddedSurfaceAccessor":
    ...
    def micro_geometry_matrix(self: Self, value: "_1583.GriddedSurfaceAccessor"):
    ...
    @property
    def bias(self: Self) -> "_1105.CylindricalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1108.CylindricalGearLeadModification":
    ...
    @property
    def micro_geometry_map(self: Self) -> "_1115.CylindricalGearMicroGeometryMap":
    ...
    @property
    def profile_relief(self: Self) -> "_1117.CylindricalGearProfileModification":
    ...
    def lead_form_deviation_points(
        self: Self,
    ) -> "List[_1126.LeadFormReliefWithDeviation]":
    ...
    def lead_slope_deviation_points(
        self: Self,
    ) -> "List[_1130.LeadSlopeReliefWithDeviation]":
    ...
    def profile_form_deviation_points(
        self: Self,
    ) -> "List[_1140.ProfileFormReliefWithDeviation]":
    ...
    def profile_slope_deviation_at_10_percent_face_width(
        self: Self,
    ) -> "List[_1144.ProfileSlopeReliefWithDeviation]":
    ...
    def total_lead_relief_points(
        self: Self,
    ) -> "List[_1147.TotalLeadReliefWithDeviation]":
    ...
    def total_profile_relief_points(
        self: Self,
    ) -> "List[_1148.TotalProfileReliefWithDeviation]":
    ...
    @property
    def gear_design(self: Self) -> "_1022.CylindricalGearDesign":

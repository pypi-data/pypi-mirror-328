...
class CylindricalGearMeshMicroGeometryDutyCycle(_1240.GearMeshDesignAnalysis):
    """CylindricalGearMeshMicroGeometryDutyCycle
    ...
    def peak_to_peak_te(
        self: Self,
    ) -> "_1862.DutyCyclePropertySummaryVeryShortLength[_860.CylindricalGearMeshLoadDistributionAnalysis]":

...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1036, _1028
...
class CylindricalGearMeshMicroGeometry(_1243.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def left_flank_lead_modification_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def right_flank_lead_modification_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def cylindrical_mesh(self: Self) -> "_1028.CylindricalGearMeshDesign":
    ...
    def cylindrical_gear_micro_geometries(
        self: Self,
    ) -> "List[_1113.CylindricalGearMicroGeometryBase]":
    ...
    def cylindrical_gear_micro_geometries_specified_per_tooth(
        self: Self,
    ) -> "List[_1116.CylindricalGearMicroGeometryPerTooth]":
    ...
    @property
    def gear_a(self: Self) -> "_1113.CylindricalGearMicroGeometryBase":
    ...
    @property
    def gear_b(self: Self) -> "_1113.CylindricalGearMicroGeometryBase":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMicroGeometryBase

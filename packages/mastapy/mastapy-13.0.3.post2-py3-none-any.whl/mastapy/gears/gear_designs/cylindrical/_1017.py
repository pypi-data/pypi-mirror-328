...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1016, _1022, _1019, _1034, _1089
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def cylindrical_gear_basic_rack_flank(
            ...
            return self._parent._cast(_1019.CylindricalGearBasicRackFlank)
        ...
        def cylindrical_gear_pinion_type_cutter_flank(
            ...
            return self._parent._cast(_1034.CylindricalGearPinionTypeCutterFlank)
        ...
        def standard_rack_flank(
            ...
            return self._parent._cast(_1089.StandardRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1016.CylindricalGearAbstractRack":

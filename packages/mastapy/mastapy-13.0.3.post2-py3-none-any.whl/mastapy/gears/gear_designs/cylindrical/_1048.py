...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1049, _1022, _1028
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_1049.CylindricalMeshedGearFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1049.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def flanks(self: Self) -> "List[_1049.CylindricalMeshedGearFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1049.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def mesh(self: Self) -> "_1028.CylindricalGearMeshDesign":

...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1064, _1066, _1067
...
class ISO6336GeometryBase(_0.APIBase):
    ...
    class _Cast_ISO6336GeometryBase:
        ...
        def iso6336_geometry(
            ...
            return self._parent._cast(_1064.ISO6336Geometry)
        ...
        def iso6336_geometry_for_shaped_gears(
            ...
            return self._parent._cast(_1066.ISO6336GeometryForShapedGears)
        ...
        def iso6336_geometry_manufactured(
            ...
            return self._parent._cast(_1067.ISO6336GeometryManufactured)

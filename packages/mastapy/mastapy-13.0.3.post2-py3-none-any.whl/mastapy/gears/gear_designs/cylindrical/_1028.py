...
class CylindricalGearMeshDesign(_953.GearMeshDesign):
    ...
    @property
    def profile_modification(self: Self) -> "_1037.CylindricalGearProfileModifications":
    ...
    def profile_modification(
        self: Self, value: "_1037.CylindricalGearProfileModifications"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications",
    ...
    @property
    def type_of_mechanism_housing(self: Self) -> "_1099.TypeOfMechanismHousing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1099", "TypeOfMechanismHousing"
        )(value)

    @type_of_mechanism_housing.setter
    @enforce_parameter_types
    def type_of_mechanism_housing(self: Self, value: "_1099.TypeOfMechanismHousing"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def valid_normal_module_range(self: Self) -> "_1507.Range":
    ...
    @property
    def left_flank(self: Self) -> "_1029.CylindricalGearMeshFlankDesign":
    ...
    @property
    def right_flank(self: Self) -> "_1029.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def cylindrical_meshed_gear(self: Self) -> "List[_1048.CylindricalMeshedGear]":
    ...
    @property
    def flanks(self: Self) -> "List[_1029.CylindricalGearMeshFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1029.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def gear_a(self: Self) -> "_1022.CylindricalGearDesign":
    ...
    @property
    def gear_b(self: Self) -> "_1022.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign

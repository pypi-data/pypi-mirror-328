...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1038, _1051
...
class GearSetDesign(_952.GearDesignComponent):
    """GearSetDesign
    ...
    @property
    def active_ltcafe_model(self: Self) -> "_1218.GearSetFEModel":
    ...
    @property
    def tifffe_model(self: Self) -> "_1218.GearSetFEModel":
        """mastapy.gears.fe_model.GearSetFEModel
    ...
    @property
    def gears(self: Self) -> "List[_951.GearDesign]":
    ...
    @property
    def ltcafe_models(self: Self) -> "List[_1218.GearSetFEModel]":

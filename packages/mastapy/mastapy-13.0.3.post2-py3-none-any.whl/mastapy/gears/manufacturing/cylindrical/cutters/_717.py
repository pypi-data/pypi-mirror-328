...
class CylindricalGearShaper(_721.InvoluteCutterDesign):
    ...
    @property
    def shaper_edge_type(self: Self) -> "_1086.ShaperEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1086", "ShaperEdgeTypes"
        )(value)

    @shaper_edge_type.setter
    @enforce_parameter_types
    def shaper_edge_type(self: Self, value: "_1086.ShaperEdgeTypes"):

...
if TYPE_CHECKING:
    from mastapy.gears.fe_model import _1217
...
class GearFEModel(_1239.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self: Self) -> "_1217.GearMeshingElementOptions":
    ...
    @enforce_parameter_types
    def get_stress_influence_coefficients_from_fe(self: Self, flank: "_329.GearFlanks"):
        """Method does not return.

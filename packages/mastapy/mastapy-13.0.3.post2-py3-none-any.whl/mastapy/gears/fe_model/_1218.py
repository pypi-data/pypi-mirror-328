...
if TYPE_CHECKING:
    ...
    from mastapy.gears.fe_model import _1215, _1216
...
class GearSetFEModel(_1249.GearSetImplementationDetail):
    """GearSetFEModel
    ...
    @property
    def gear_fe_models(self: Self) -> "List[_1215.GearFEModel]":
    ...
    @property
    def mesh_fe_models(self: Self) -> "List[_1216.GearMeshFEModel]":

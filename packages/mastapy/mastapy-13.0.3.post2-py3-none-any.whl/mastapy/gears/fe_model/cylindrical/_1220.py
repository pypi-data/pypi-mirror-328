...
if TYPE_CHECKING:
    ...
    from mastapy.gears.analysis import _1243, _1240, _1234
...
class CylindricalGearMeshFEModel(_1216.GearMeshFEModel):
    """CylindricalGearMeshFEModel
    ...
    def stiffness_wrt_contacts_for(
        self: Self, gear: "_1215.GearFEModel", flank: "_329.GearFlanks"
    ...
    @enforce_parameter_types
    def generate_stiffness_wrt_contacts_for(self: Self, progress: "_7580.TaskProgress"):
    ...
    def generate_stiffness_wrt_contacts_for_flank(
        self: Self, flank: "_329.GearFlanks", progress: "_7580.TaskProgress"
    ):
        """Method does not return.

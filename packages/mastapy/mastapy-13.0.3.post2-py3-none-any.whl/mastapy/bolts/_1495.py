...
if TYPE_CHECKING:
    from mastapy.bolts import _1493, _1498, _1501, _1486, _1488, _1484
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: Self) -> "List[_1493.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: Self, value: "List[_1493.ClampedSection]"):
    ...
    @property
    def joint_geometry(self: Self) -> "_1498.JointGeometries":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1498", "JointGeometries")(
            value
        )

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: Self, value: "_1498.JointGeometries"):
    ...
    def rolled_before_or_after_heat_treatment(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bolts._1501", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: Self, value: "_1501.RolledBeforeOrAfterHeatTreatment"
    ):
    ...
    @property
    def bolt_geometry(self: Self) -> "_1486.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: Self) -> "_1488.BoltMaterial":
    ...
    @property
    def material_of_nut(self: Self) -> "_1484.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: Self) -> "_1484.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: Self) -> "List[_1493.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]

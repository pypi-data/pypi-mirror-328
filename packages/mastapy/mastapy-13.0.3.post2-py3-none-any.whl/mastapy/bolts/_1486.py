...
if TYPE_CHECKING:
    from mastapy.bolts import _1490, _1491, _1502, _1492, _1497, _1504
...
class BoltGeometry(_1847.NamedDatabaseItem):
    """BoltGeometry
    ...
    @property
    def bolt_sections(self: Self) -> "List[_1490.BoltSection]":
    ...
    @enforce_parameter_types
    def bolt_sections(self: Self, value: "List[_1490.BoltSection]"):
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self: Self) -> "_1491.BoltShankType":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1491", "BoltShankType")(
            value
        )

    @bolt_shank_type.setter
    @enforce_parameter_types
    def bolt_shank_type(self: Self, value: "_1491.BoltShankType"):
    ...
    @property
    def standard_size(self: Self) -> "_1502.StandardSizes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1502", "StandardSizes")(
            value
        )

    @standard_size.setter
    @enforce_parameter_types
    def standard_size(self: Self, value: "_1502.StandardSizes"):
    ...
    @property
    def type_of_bolted_joint(self: Self) -> "_1492.BoltTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1492", "BoltTypes")(value)

    @type_of_bolted_joint.setter
    @enforce_parameter_types
    def type_of_bolted_joint(self: Self, value: "_1492.BoltTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.BoltTypes")
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self: Self) -> "_1497.HeadCapTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1497", "HeadCapTypes")(
            value
        )

    @type_of_head_cap.setter
    @enforce_parameter_types
    def type_of_head_cap(self: Self, value: "_1497.HeadCapTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.HeadCapTypes")
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self: Self) -> "_1504.ThreadTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1504", "ThreadTypes")(value)

    @type_of_thread.setter
    @enforce_parameter_types
    def type_of_thread(self: Self, value: "_1504.ThreadTypes"):

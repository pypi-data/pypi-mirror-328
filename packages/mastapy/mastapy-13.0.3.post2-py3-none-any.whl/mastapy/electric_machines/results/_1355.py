...
from mastapy.electric_machines import _1313, _1310
...
if TYPE_CHECKING:
    from mastapy.electric_machines.results import _1356
...
class ElectricMachineResultsViewable(_175.ElmerResultsViewable):
    ...
    @property
    def force_view_options(self: Self) -> "_1356.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.results._1356", "ElectricMachineForceViewOptions"
        )(value)

    @force_view_options.setter
    @enforce_parameter_types
    def force_view_options(self: Self, value: "_1356.ElectricMachineForceViewOptions"):
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: Self, value: "_1344.ElectricMachineResults"):
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: Self) -> "List[_1863.EnumWithBoolean[_1310.RegionID]]":

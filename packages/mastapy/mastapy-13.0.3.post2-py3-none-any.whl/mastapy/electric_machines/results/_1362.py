...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1384, _1381
    from mastapy.electric_machines import _1334
...
class OnLoadElectricMachineResults(_1344.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1344.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1384.MotoringOrGenerating":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1384",
    ...
    @property
    def power_factor_direction(self: Self) -> "_1381.LeadingOrLagging":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1381",
            "LeadingOrLagging",
        )(value)
    ...
    @property
    def windings(self: Self) -> "_1334.Windings":

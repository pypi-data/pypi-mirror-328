...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1331
    from mastapy.electric_machines.results import _1358, _1360
...
class ElectricMachineDQModel(_0.APIBase):
    ...
    class _Cast_ElectricMachineDQModel:
        ...
        def linear_dq_model(
            ...
            from mastapy.electric_machines.results import _1358

            return self._parent._cast(_1358.LinearDQModel)

        @property
        def non_linear_dq_model(
            self: "ElectricMachineDQModel._Cast_ElectricMachineDQModel",
        ) -> "_1360.NonLinearDQModel":
            from mastapy.electric_machines.results import _1360

            return self._parent._cast(_1360.NonLinearDQModel)

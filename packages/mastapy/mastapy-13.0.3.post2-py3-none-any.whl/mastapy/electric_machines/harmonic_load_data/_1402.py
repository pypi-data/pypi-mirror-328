...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.harmonic_load_data import _1403, _1404
...
class StatorToothInterpolator(_0.APIBase):
    ...
    class _Cast_StatorToothInterpolator:
        ...
        def stator_tooth_load_interpolator(
            ...
            from mastapy.electric_machines.harmonic_load_data import _1403

            return self._parent._cast(_1403.StatorToothLoadInterpolator)

        @property
        def stator_tooth_moment_interpolator(
            self: "StatorToothInterpolator._Cast_StatorToothInterpolator",
        ) -> "_1404.StatorToothMomentInterpolator":
            from mastapy.electric_machines.harmonic_load_data import _1404

            return self._parent._cast(_1404.StatorToothMomentInterpolator)

...
from mastapy.electric_machines.harmonic_load_data import _1402
...
class StatorToothMomentInterpolator(_1402.StatorToothInterpolator):
    """StatorToothMomentInterpolator
    ...
    class _Cast_StatorToothMomentInterpolator:
        ...
        def stator_tooth_interpolator(
            ...
            return self._parent._cast(_1402.StatorToothInterpolator)

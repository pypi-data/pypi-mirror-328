...
from mastapy.electric_machines.harmonic_load_data import _1400, _1397, _1401
...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1886, _1882
    from mastapy.math_utility import _1539
    from mastapy.electric_machines.harmonic_load_data import _1403, _1404, _1398
...
class ElectricMachineHarmonicLoadDataBase(_1401.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    @enforce_parameter_types
    def data_type_for_force_moment_distribution_and_temporal_spatial_harmonics_charts(
        self: Self, value: "_1400.HarmonicLoadDataType"
    ):
    ...
    @enforce_parameter_types
    def display_option_for_slice_data(self: Self, value: "_1397.ForceDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def force_distribution_3d(self: Self) -> "_1886.ThreeDVectorChartDefinition":
    ...
    @slice.setter
    @enforce_parameter_types
    def slice(self: Self, value: "_1313.RotorSkewSlice"):
        wrapper_type = (
    ...
    @property
    def temporal_spatial_harmonics_chart(self: Self) -> "_1882.ScatterChartDefinition":
    ...
    @property
    def rotor_x_force(self: Self) -> "_1539.MultipleFourierSeriesInterpolator":
    ...
    @property
    def rotor_y_force(self: Self) -> "_1539.MultipleFourierSeriesInterpolator":
        """mastapy.math_utility.MultipleFourierSeriesInterpolator
    ...
    @property
    def stator_axial_loads(self: Self) -> "_1403.StatorToothLoadInterpolator":
    ...
    @property
    def stator_radial_loads(self: Self) -> "_1403.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tangential_loads(self: Self) -> "_1403.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tooth_moments(self: Self) -> "_1404.StatorToothMomentInterpolator":
    ...
    def multiple_fourier_series_interpolator_for(
        self: Self,
        harmonic_load_data_type: "_1400.HarmonicLoadDataType",
        slice_index: "int",

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1322, _1279
...
class SurfacePermanentMagnetMachine(_1304.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    def rotor(self: Self) -> "_1322.SurfacePermanentMagnetRotor":

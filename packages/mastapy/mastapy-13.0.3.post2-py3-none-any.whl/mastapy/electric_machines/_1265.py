...
class CADMagnetDetails(_0.APIBase):
    ...
    @property
    def magnetisation_direction(self: Self) -> "_1300.MagnetisationDirection":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1300", "MagnetisationDirection"
        )(value)

    @magnetisation_direction.setter
    @enforce_parameter_types
    def magnetisation_direction(self: Self, value: "_1300.MagnetisationDirection"):

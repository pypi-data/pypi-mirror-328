...
from mastapy.electric_machines.load_cases_and_analyses import _1390, _1364
...
class DynamicForceLoadCase(_1364.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    @property
    def control_strategy(self: Self) -> "_1372.ElectricMachineControlStrategy":
    ...
    def control_strategy(self: Self, value: "_1372.ElectricMachineControlStrategy"):
    ...
    @enforce_parameter_types
    def load_specification(self: Self, value: "_1390.SpecifyTorqueOrCurrent"):
    ...
    def operating_points_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1387",
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: Self, value: "_1387.OperatingPointsSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: Self) -> "_1391.SpeedPointsDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1391",
            "SpeedPointsDistribution",
        )(value)

    @speed_points_distribution.setter
    @enforce_parameter_types
    def speed_points_distribution(self: Self, value: "_1391.SpeedPointsDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
        )

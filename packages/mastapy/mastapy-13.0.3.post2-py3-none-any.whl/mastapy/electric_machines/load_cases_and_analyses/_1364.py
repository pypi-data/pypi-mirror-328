...
class BasicDynamicForceLoadCase(_1377.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    @enforce_parameter_types
    def keep_single_operating_point_results(self: Self, value: "bool"):
    ...
    def number_of_steps_per_operating_point_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1386",
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: Self, value: "_1386.NumberOfStepsPerOperatingPointSpecificationMethod"
    ):
    ...
    @property
    def operating_points(self: Self) -> "List[_1367.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: Self, operating_point: "_1367.DynamicForcesOperatingPoint"
    ):
        """Method does not return.

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1295, _1296, _1299
...
class UShapedLayerSpecification(_1312.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    class _Cast_UShapedLayerSpecification:
        ...
        def rotor_internal_layer_specification(
            ...
            return self._parent._cast(_1312.RotorInternalLayerSpecification)
    ...
    @property
    def inner_magnet_clearance(self: Self) -> "_1295.MagnetClearance":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1295", "MagnetClearance"
        )(value)

    @inner_magnet_clearance.setter
    @enforce_parameter_types
    def inner_magnet_clearance(self: Self, value: "_1295.MagnetClearance"):
    ...
    @property
    def magnet_configuration(self: Self) -> "_1296.MagnetConfiguration":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1296", "MagnetConfiguration"
        )(value)

    @magnet_configuration.setter
    @enforce_parameter_types
    def magnet_configuration(self: Self, value: "_1296.MagnetConfiguration"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_magnet_lower_clearance(self: Self) -> "_1295.MagnetClearance":
        """mastapy.electric_machines.MagnetClearance"""
    ...
    @enforce_parameter_types
    def outer_magnet_lower_clearance(self: Self, value: "_1295.MagnetClearance"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.ElectricMachines.MagnetClearance"
        )
    ...
    @property
    def outer_magnets(self: Self) -> "_1299.MagnetForLayer":

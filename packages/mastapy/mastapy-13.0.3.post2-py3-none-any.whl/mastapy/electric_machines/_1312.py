...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1299, _1328, _1329
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def u_shaped_layer_specification(
            ...
            from mastapy.electric_machines import _1328

            return self._parent._cast(_1328.UShapedLayerSpecification)

        @property
        def v_shaped_magnet_layer_specification(
            self: "RotorInternalLayerSpecification._Cast_RotorInternalLayerSpecification",
        ) -> "_1329.VShapedMagnetLayerSpecification":
            from mastapy.electric_machines import _1329

            return self._parent._cast(_1329.VShapedMagnetLayerSpecification)
    ...
    @property
    def magnets(self: Self) -> "_1299.MagnetForLayer":

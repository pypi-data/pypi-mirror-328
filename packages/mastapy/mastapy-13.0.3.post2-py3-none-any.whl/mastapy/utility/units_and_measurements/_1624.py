...
class MeasurementSettings(_1612.PerMachineSettings):
    """MeasurementSettings
    ...
    @enforce_parameter_types
    def selected_measurement(self: Self, value: "_1623.MeasurementBase"):
        wrapper_type = (
    ...
    @property
    def current_selected_measurement(self: Self) -> "_1623.MeasurementBase":
    ...
    @enforce_parameter_types
    def find_measurement_by_name(self: Self, name: "str") -> "_1623.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: Self, measurement_type: "_7581.MeasurementType"

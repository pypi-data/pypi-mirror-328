...
from mastapy.utility.property import _1857
...
class DutyCyclePropertySummaryStress(_1857.DutyCyclePropertySummary["_1732.Stress", T]):
    """DutyCyclePropertySummaryStress
    ...
    class _Cast_DutyCyclePropertySummaryStress:
        ...
        def duty_cycle_property_summary(
            ...
            return self._parent._cast(_1857.DutyCyclePropertySummary)

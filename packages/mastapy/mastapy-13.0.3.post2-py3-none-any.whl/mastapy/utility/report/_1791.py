...
if TYPE_CHECKING:
    from mastapy.utility.report import _1801, _1802, _1762, _1775, _1796, _1805
    from mastapy.utility.reporting_property_framework import _1806
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    class _Cast_CustomReportPropertyItem:
        ...
        def blank_row(
            ...
            return self._parent._cast(_1762.BlankRow)
        ...
        def custom_report_chart_item(
            ...
            return self._parent._cast(_1775.CustomReportChartItem)

        @property
        def custom_row(
            self: "CustomReportPropertyItem._Cast_CustomReportPropertyItem",
        ) -> "_1796.CustomRow":
            from mastapy.utility.report import _1796

            return self._parent._cast(_1796.CustomRow)

        @property
        def user_text_row(
            self: "CustomReportPropertyItem._Cast_CustomReportPropertyItem",
        ) -> "_1805.UserTextRow":
            from mastapy.utility.report import _1805

            return self._parent._cast(_1805.UserTextRow)
    ...
    @property
    def font_style(self: Self) -> "_1801.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1801", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: Self, value: "_1801.FontStyle"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Utility.Report.FontStyle")
        self.wrapped.FontStyle = value

    @property
    def font_weight(self: Self) -> "_1802.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1802", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: Self, value: "_1802.FontWeight"):
    ...
    @property
    def horizontal_position(self: Self) -> "_1806.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1806", "CellValuePosition"
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: Self, value: "_1806.CellValuePosition"):
        value = conversion.mp_to_pn_enum(

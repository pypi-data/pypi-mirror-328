...
if TYPE_CHECKING:
    from mastapy.utility.report import _1762, _1805
...
class CustomRow(_1791.CustomReportPropertyItem):
    """CustomRow
    ...
    class _Cast_CustomRow:
        ...
        @property
        def blank_row(self: "CustomRow._Cast_CustomRow") -> "_1762.BlankRow":
            from mastapy.utility.report import _1762

            return self._parent._cast(_1762.BlankRow)

        @property
        def user_text_row(self: "CustomRow._Cast_CustomRow") -> "_1805.UserTextRow":

...
class NamedTuple6(_0.APIBase, Generic[T1, T2, T3, T4, T5, T6]):
    ...
    TYPE = _NAMED_TUPLE_6
    _CastSelf = TypeVar("_CastSelf", bound="_Cast_NamedTuple6")

    class _Cast_NamedTuple6:
        """Special nested class for casting NamedTuple6 to subclasses."""

        def __init__(self: "NamedTuple6._Cast_NamedTuple6", parent: "NamedTuple6"):
            self._parent = parent

        @property
        def named_tuple_6(self: "NamedTuple6._Cast_NamedTuple6") -> "NamedTuple6":
            return self._parent

        def __getattr__(self: "NamedTuple6._Cast_NamedTuple6", name: str):
            try:
    ...
    def __init__(self: Self, instance_to_wrap: "NamedTuple6.TYPE"):
    ...
    @property
    def cast_to(self: Self) -> "NamedTuple6._Cast_NamedTuple6":

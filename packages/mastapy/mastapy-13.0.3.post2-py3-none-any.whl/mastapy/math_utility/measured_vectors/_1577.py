...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1582, _1578, _1579
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    class _Cast_AbstractForceAndDisplacementResults:
        ...
        def force_and_displacement_results(
            ...
            return self._parent._cast(_1578.ForceAndDisplacementResults)
        ...
        def force_results(
            ...
            return self._parent._cast(_1579.ForceResults)
    ...
    @property
    def force(self: Self) -> "_1582.VectorWithLinearAndAngularComponents":

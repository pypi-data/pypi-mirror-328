...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1576, _1575, _1565, _1566, _1571
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationVariableBase:
        ...
        def pareto_optimisation_input(
            ...
            from mastapy.math_utility.optimisation import _1565

            return self._parent._cast(_1565.ParetoOptimisationInput)

        @property
        def pareto_optimisation_output(
            self: "ParetoOptimisationVariableBase._Cast_ParetoOptimisationVariableBase",
        ) -> "_1566.ParetoOptimisationOutput":
            from mastapy.math_utility.optimisation import _1566

            return self._parent._cast(_1566.ParetoOptimisationOutput)

        @property
        def pareto_optimisation_variable(
            self: "ParetoOptimisationVariableBase._Cast_ParetoOptimisationVariableBase",
        ) -> "_1571.ParetoOptimisationVariable":
            from mastapy.math_utility.optimisation import _1571

            return self._parent._cast(_1571.ParetoOptimisationVariable)
        ...
        def parametric_study_doe_result_variable(
            ...
            return self._parent._cast(_4405.ParametricStudyDOEResultVariable)
    ...
    @property
    def integer_range(self: Self) -> "_1606.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: Self, value: "_1606.IntegerRange"):
    ...
    @property
    def range(self: Self) -> "_1507.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: Self, value: "_1507.Range"):
        self.wrapped.Range = value.wrapped

    @property
    def specification_type(self: Self) -> "_1576.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1576", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1576.TargetingPropertyTo"):
    ...
    @property
    def specify_input_range_as(self: Self) -> "_1575.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1575", "SpecifyOptimisationInputAs"
        )(value)

    @specify_input_range_as.setter
    @enforce_parameter_types
    def specify_input_range_as(self: Self, value: "_1575.SpecifyOptimisationInputAs"):
        value = conversion.mp_to_pn_enum(

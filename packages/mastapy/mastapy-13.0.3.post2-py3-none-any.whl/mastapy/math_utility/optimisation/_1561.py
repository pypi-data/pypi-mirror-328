...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self: Self) -> "List[_1563.OptimizationVariable]":
    ...
    @property
    def target_history(self: Self) -> "List[_1563.OptimizationVariable]":
        """List[mastapy.math_utility.optimisation.OptimizationVariable]
    ...
    def add_input_history(self: Self, value: "_1563.OptimizationVariable"):
    ...
    @enforce_parameter_types
    def add_target_history(self: Self, value: "_1563.OptimizationVariable"):
        """Method does not return.

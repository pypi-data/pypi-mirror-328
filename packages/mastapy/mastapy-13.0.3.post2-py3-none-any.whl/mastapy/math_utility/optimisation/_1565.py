...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1575, _1572
...
class ParetoOptimisationInput(_1571.ParetoOptimisationVariable):
    """ParetoOptimisationInput
    ...
    class _Cast_ParetoOptimisationInput:
        ...
        def pareto_optimisation_variable_base(
            ...
            from mastapy.math_utility.optimisation import _1572

            return self._parent._cast(_1572.ParetoOptimisationVariableBase)

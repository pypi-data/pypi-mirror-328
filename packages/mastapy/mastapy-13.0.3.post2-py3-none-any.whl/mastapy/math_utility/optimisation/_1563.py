...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1562, _1574
...
class OptimizationVariable(_0.APIBase):
    ...
    class _Cast_OptimizationVariable:
        ...
        def optimization_input(
            ...
            return self._parent._cast(_1562.OptimizationInput)

        @property
        def reporting_optimization_input(
            self: "OptimizationVariable._Cast_OptimizationVariable",
        ) -> "_1574.ReportingOptimizationInput":
            from mastapy.math_utility.optimisation import _1574

            return self._parent._cast(_1574.ReportingOptimizationInput)
    ...
    @property
    def measurement(self: Self) -> "_1623.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1623.MeasurementBase"):

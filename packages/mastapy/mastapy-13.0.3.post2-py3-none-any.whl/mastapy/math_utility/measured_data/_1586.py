...
class TwodimensionalFunctionLookupTable(
    _1584.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1583.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: Self, value: "_1583.GriddedSurfaceAccessor"):

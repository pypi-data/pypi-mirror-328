...
if TYPE_CHECKING:
    from mastapy.math_utility import _1543, _1532
...
class Vector6D(_1544.RealVector):
    """Vector6D
    ...
    class _Cast_Vector6D:
        ...
        @property
        def real_vector(self: "Vector6D._Cast_Vector6D") -> "_1544.RealVector":
            return self._parent._cast(_1544.RealVector)

        @property
        def real_matrix(self: "Vector6D._Cast_Vector6D") -> "_1543.RealMatrix":
            from mastapy.math_utility import _1543

            return self._parent._cast(_1543.RealMatrix)

        @property
        def generic_matrix(self: "Vector6D._Cast_Vector6D") -> "_1532.GenericMatrix":

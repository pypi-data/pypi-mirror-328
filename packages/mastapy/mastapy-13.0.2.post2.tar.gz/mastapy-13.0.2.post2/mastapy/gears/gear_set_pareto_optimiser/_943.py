...
class StraightBevelGearSetParetoOptimiser(_915.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_967.StraightBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_967.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_967.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]

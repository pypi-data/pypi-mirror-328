...
if TYPE_CHECKING:
    from mastapy.gears.fe_model import _1205
...
class GearFEModel(_1227.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self: Self) -> "_1205.GearMeshingElementOptions":

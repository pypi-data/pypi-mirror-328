...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1551, _1563
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: Self) -> "_1612.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1612.MeasurementBase"):

...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2380.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2380.ElectricMachineDataSet.TYPE":
        ...
        return _2380.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2380.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2380.ElectricMachineDataSet]":

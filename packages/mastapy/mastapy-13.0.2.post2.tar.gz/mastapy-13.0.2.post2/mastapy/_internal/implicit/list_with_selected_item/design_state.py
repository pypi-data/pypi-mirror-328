...
class ListWithSelectedItem_DesignState(
    _5671.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5671.DesignState.TYPE":
        ...
        return _5671.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5671.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5671.DesignState]":

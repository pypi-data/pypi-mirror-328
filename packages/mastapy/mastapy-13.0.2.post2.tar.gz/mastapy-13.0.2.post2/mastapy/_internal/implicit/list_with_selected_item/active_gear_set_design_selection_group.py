...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2519.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2519.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2519.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2519.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2519.ActiveGearSetDesignSelectionGroup]":

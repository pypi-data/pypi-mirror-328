...
class ListWithSelectedItem_PowerLoad(_2479.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2479.PowerLoad.TYPE":
        ...
        return _2479.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2479.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2479.PowerLoad]":

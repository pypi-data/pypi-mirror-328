...
class ListWithSelectedItem_Datum(_2455.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2455.Datum.TYPE":
        ...
        return _2455.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2455.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2455.Datum]":

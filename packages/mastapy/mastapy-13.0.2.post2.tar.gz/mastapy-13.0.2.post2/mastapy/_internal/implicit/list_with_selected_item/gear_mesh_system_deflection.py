...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2767.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2767.GearMeshSystemDeflection.TYPE":
        ...
        return _2767.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2767.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2767.GearMeshSystemDeflection]":

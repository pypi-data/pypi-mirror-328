...
class ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis(
    _859.CylindricalGearLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_859.CylindricalGearLoadDistributionAnalysis.TYPE":
        ...
        return _859.CylindricalGearLoadDistributionAnalysis.TYPE

    @property
    def selected_value(self: Self) -> "_859.CylindricalGearLoadDistributionAnalysis":
    ...
    def available_values(
        self: Self,
    ) -> "List[_859.CylindricalGearLoadDistributionAnalysis]":

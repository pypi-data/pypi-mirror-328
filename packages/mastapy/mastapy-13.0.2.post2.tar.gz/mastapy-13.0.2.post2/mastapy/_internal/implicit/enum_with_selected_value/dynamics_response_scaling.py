...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1513.DynamicsResponseScaling":
        ...
        return _1513.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1513.DynamicsResponseScaling.type_()":
        ...
        return _1513.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1513.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1513.DynamicsResponseScaling]":

...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2116.StressConcentrationMethod":
        ...
        return _2116.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2116.StressConcentrationMethod.type_()":
        ...
        return _2116.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2116.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2116.StressConcentrationMethod]":

...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_325.ContactRatioRequirements":
        ...
        return _325.ContactRatioRequirements

    @classmethod
    def implicit_type(cls) -> "_325.ContactRatioRequirements.type_()":
        ...
        return _325.ContactRatioRequirements.type_()

    @property
    def value(self: Self) -> "_325.ContactRatioRequirements":
    ...
    @property
    def override_value(self: Self) -> "_325.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: Self) -> "_325.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements

...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_337.ISOToleranceStandard":
        ...
        return _337.ISOToleranceStandard

    @classmethod
    def implicit_type(cls) -> "_337.ISOToleranceStandard.type_()":
        ...
        return _337.ISOToleranceStandard.type_()

    @property
    def value(self: Self) -> "_337.ISOToleranceStandard":
    ...
    @property
    def override_value(self: Self) -> "_337.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
    ...
    @property
    def calculated_value(self: Self) -> "_337.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard

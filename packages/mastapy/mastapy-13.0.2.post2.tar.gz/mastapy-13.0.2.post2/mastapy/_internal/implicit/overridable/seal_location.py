...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1905.SealLocation":
        ...
        return _1905.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1905.SealLocation.type_()":
        ...
        return _1905.SealLocation.type_()

    @property
    def value(self: Self) -> "_1905.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1905.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1905.SealLocation":
        """mastapy.bearings.SealLocation

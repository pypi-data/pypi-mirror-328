...
from mastapy.nodal_analysis.elmer.results import _178
...
class Data1D(_178.Data):
    ...
    class _Cast_Data1D:
        ...
        @property
        def data(self: "Data1D._Cast_Data1D") -> "_178.Data":
            return self._parent._cast(_178.Data)

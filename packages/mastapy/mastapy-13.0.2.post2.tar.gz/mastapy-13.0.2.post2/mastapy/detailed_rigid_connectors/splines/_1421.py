...
class SplineHalfDesign(_1395.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    class _Cast_SplineHalfDesign:
        ...
        def custom_spline_half_design(
            ...
            return self._parent._cast(_1396.CustomSplineHalfDesign)
    ...
    @property
    def heat_treatment(self: Self) -> "_1405.HeatTreatmentTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1405", "HeatTreatmentTypes"
        )(value)

    @heat_treatment.setter
    @enforce_parameter_types
    def heat_treatment(self: Self, value: "_1405.HeatTreatmentTypes"):
    ...
    @property
    def fit_and_tolerance(self: Self) -> "_1428.FitAndTolerance":

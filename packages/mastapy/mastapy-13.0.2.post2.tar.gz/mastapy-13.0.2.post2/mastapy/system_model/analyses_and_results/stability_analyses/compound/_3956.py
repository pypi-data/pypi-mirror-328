...
class DatumCompoundStabilityAnalysis(_3930.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3823.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3823.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]

...
class BeltDriveCompoundModalAnalysis(_4834.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4590.BeltDriveModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4590.BeltDriveModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BeltDriveModalAnalysis]

...
class PulleyCompoundModalAnalysis(_4775.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4679.PulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4679.PulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PulleyModalAnalysis]

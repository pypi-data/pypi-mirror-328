...
class AssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    @property
    def bolts(self: Self) -> "List[_3532.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3554.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3560.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_3608.ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3619.StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed]":

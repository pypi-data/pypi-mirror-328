...
class TorqueConverterCompoundPowerFlow(_4212.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4164.TorqueConverterPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4164.TorqueConverterPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.TorqueConverterPowerFlow]

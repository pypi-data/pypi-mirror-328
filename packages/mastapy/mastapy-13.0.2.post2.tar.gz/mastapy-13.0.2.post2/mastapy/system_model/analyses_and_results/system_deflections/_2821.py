...
class StraightBevelDiffGearMeshSystemDeflection(_2714.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4150.StraightBevelDiffGearMeshPowerFlow":

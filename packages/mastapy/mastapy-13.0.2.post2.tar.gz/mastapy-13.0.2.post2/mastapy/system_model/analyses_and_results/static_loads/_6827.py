...
class AssemblyLoadCase(_6815.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: Self) -> "List[_6828.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6830.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6833.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6839.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: Self) -> "List[_6840.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6864.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: Self) -> "List[_6841.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: Self) -> "List[_6843.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6849.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6852.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_6866.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6868.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_6874.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6896.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6895.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6897.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: Self) -> "List[_6901.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6916.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6926.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6929.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6930.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6931.MeasurementComponentLoadCase]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6935.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6940.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6944.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6947.PointLoadLoadCase]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6952.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: Self,
    ) -> "List[_6953.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6954.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_6958.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: Self) -> "List[_6959.ShaftLoadCase]":
    ...
    @property
    def shafts_and_housings(self: Self) -> "List[_6817.AbstractShaftOrHousingLoadCase]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_6964.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6967.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6970.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6973.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6977.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6982.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6989.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6993.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_6996.ZerolBevelGearSetLoadCase]":

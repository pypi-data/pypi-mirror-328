...
class ConceptGearSetCompoundDynamicAnalysis(_6476.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6316.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6445.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6446.ConceptGearMeshCompoundDynamicAnalysis]":

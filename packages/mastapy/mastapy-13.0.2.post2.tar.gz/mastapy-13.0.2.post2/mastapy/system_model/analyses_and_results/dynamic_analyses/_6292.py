...
class AssemblyDynamicAnalysis(_6285.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6293.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6295.BeltDriveDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6305.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6304.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6326.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6307.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6312.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6316.ConceptGearSetDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6330.CycloidalDiscDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6343.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6342.FaceGearSetDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6344.FlexiblePinAssemblyDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6351.HypoidGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6362.MassDiscDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6365.OilSealDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6372.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6373.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6374.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6376.RingPinsDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6378.RollingRingAssemblyDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6382.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6390.SpringDamperDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6400.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6405.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6408.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6412.WormGearSetDynamicAnalysis]":

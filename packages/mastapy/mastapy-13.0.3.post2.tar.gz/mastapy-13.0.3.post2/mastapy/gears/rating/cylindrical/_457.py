...
if TYPE_CHECKING:
    ...
    from mastapy.utility.units_and_measurements import _1625
...
class CylindricalGearDesignAndRatingSettingsItem(_1847.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @enforce_parameter_types
    def cylindrical_gear_profile_measurement(
        self: Self, value: "_1036.CylindricalGearProfileMeasurementType"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileMeasurementType",
    ...
    @property
    def tolerance_rounding_system(self: Self) -> "_1625.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.units_and_measurements._1625", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(self: Self, value: "_1625.MeasurementSystem"):
        value = conversion.mp_to_pn_enum(

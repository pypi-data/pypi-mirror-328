...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1094, _1024
...
class GearSetDesignGroup(_0.APIBase):
    ...
    def default_rough_toleranced_metal_measurement(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1094",
    ...
    @enforce_parameter_types
    def default_rough_toleranced_metal_measurement(
        self: Self, value: "_1094.TolerancedMetalMeasurements"
    ):

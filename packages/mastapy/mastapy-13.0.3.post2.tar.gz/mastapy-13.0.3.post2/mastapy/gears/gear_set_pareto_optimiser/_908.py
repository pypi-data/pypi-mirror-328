...
class CylindricalGearSetParetoOptimiser(_915.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_1038.CylindricalGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_1038.CylindricalGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_1038.CylindricalGearSetDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign]

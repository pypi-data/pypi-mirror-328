...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1567, _1564, _1559
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def filters(self: Self) -> "List[_1564.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: Self) -> "List[_1559.InputSetter[TAnalysis]]":

...
if TYPE_CHECKING:
    ...
    from mastapy.gears.fe_model.conical import _1225
...
class ConicalSetFEModel(_1218.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self: Self) -> "_1225.FlankDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.fe_model.conical._1225", "FlankDataSource"
        )(value)

    @flank_data_source.setter
    @enforce_parameter_types
    def flank_data_source(self: Self, value: "_1225.FlankDataSource"):
        value = conversion.mp_to_pn_enum(

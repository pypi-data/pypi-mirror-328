...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.bevel import _1203
...
class StraightBevelDiffGearDesign(_1198.BevelGearDesign):
    """StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self: Self) -> "_1203.EdgeRadiusType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1203", "EdgeRadiusType"
        )(value)

    @edge_radius_from.setter
    @enforce_parameter_types
    def edge_radius_from(self: Self, value: "_1203.EdgeRadiusType"):

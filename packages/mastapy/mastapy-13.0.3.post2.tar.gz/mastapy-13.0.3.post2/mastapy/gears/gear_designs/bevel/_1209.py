...
_WHEEL_FINISH_CUTTER_POINT_WIDTH_RESTRICTION_METHOD = python_net_import(
    "SMT.MastaAPI.Gears.GearDesigns.Bevel",
    "WheelFinishCutterPointWidthRestrictionMethod",
)
...
Self = TypeVar("Self", bound="WheelFinishCutterPointWidthRestrictionMethod")

...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.conical import _1183
...
class AGMAGleasonConicalGearSetDesign(_1174.ConicalGearSetDesign):
    """AGMAGleasonConicalGearSetDesign
    ...
    def design_method(self: Self, value: "_1197.AGMAGleasonConicalGearGeometryMethods"):
    ...
    def reliability_requirement_gleason(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1183", "GleasonSafetyRequirements"
        )(value)

    @reliability_requirement_gleason.setter
    @enforce_parameter_types
    def reliability_requirement_gleason(
        self: Self, value: "_1183.GleasonSafetyRequirements"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def conical_meshes(self: Self) -> "List[_1212.AGMAGleasonConicalGearMeshDesign]":
    ...
    @property
    def meshes(self: Self) -> "List[_1212.AGMAGleasonConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.agma_gleason_conical.AGMAGleasonConicalGearMeshDesign]

...
class CylindricalGearPinionTypeCutter(_1016.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: Self) -> "_1034.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1034.CylindricalGearPinionTypeCutterFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank

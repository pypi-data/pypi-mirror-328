...
class CylindricalGearSetDesign(_954.GearSetDesign):
    ...
    class _Cast_CylindricalGearSetDesign:
        ...
        def cylindrical_planetary_gear_set_design(
            ...
            return self._parent._cast(_1051.CylindricalPlanetaryGearSetDesign)
    ...
    @property
    def gear_fit_system(self: Self) -> "_1057.GearFitSystems":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1057", "GearFitSystems"
        )(value)

    @gear_fit_system.setter
    @enforce_parameter_types
    def gear_fit_system(self: Self, value: "_1057.GearFitSystems"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def ltca_settings(self: Self) -> "_1070.LTCASettings":
    ...
    @property
    def left_flank(self: Self) -> "_1039.CylindricalGearSetFlankDesign":
    ...
    @property
    def micropitting(self: Self) -> "_1073.Micropitting":
    ...
    @property
    def right_flank(self: Self) -> "_1039.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def scuffing(self: Self) -> "_1082.Scuffing":
    ...
    @property
    def usage(self: Self) -> "_1100.Usage":
    ...
    @property
    def gears(self: Self) -> "List[_1022.CylindricalGearDesign]":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_1022.CylindricalGearDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign]
    ...
    @property
    def flanks(self: Self) -> "List[_1039.CylindricalGearSetFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1039.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1119.CylindricalGearSetMicroGeometry]":
    ...
    def add_new_micro_geometry(self: Self) -> "_1119.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry"""
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(
        self: Self, gears: "List[_1022.CylindricalGearDesign]"
    ) -> "_1119.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def delete_micro_geometry(
        self: Self, micro_geometry: "_1119.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
    ...
    def set_active_micro_geometry(
        self: Self, value: "_1119.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.

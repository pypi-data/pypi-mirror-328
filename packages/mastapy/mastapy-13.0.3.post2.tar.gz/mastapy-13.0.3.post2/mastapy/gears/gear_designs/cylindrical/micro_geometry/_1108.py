...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1127, _1109
...
class CylindricalGearLeadModification(_575.LeadModification):
    """CylindricalGearLeadModification
    ...
    @property
    def lead_modification_chart(self: Self) -> "_1887.TwoDChartDefinition":

...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1131, _1139
...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    class _Cast_SingleCylindricalGearTriangularEndModification:
        ...
        def parabolic_cylindrical_gear_triangular_end_modification(
            ...
            from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1139
    ...
    @property
    def profile_evaluation(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
    ...
    @property
    def profile_start(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement

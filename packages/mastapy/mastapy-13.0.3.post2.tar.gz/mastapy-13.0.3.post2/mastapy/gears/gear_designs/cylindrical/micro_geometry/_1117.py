...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1141, _1118
...
class CylindricalGearProfileModification(_585.ProfileModification):
    ...
    @property
    def profile_modification_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def start_of_involute_check_diameter(self: Self) -> "overridable.Overridable_float":
        """Overridable[float]"""
        temp = self.wrapped.StartOfInvoluteCheckDiameter
    ...
    def start_of_involute_check_diameter(
        ...
        self.wrapped.StartOfInvoluteCheckDiameter = value
    ...
    @property
    def barrelling_peak_point(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
    ...
    @property
    def evaluation_lower_limit(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def evaluation_upper_limit(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    def start_of_involute_check(
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.StartOfInvoluteCheck

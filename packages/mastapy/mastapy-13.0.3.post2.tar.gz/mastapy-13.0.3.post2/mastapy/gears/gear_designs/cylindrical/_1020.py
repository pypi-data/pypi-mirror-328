...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1016, _1041
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: Self, value: "_1060.GeometrySpecificationType"
    ):
    ...
    @property
    def cylindrical_gear_cutter(self: Self) -> "_1016.CylindricalGearAbstractRack":

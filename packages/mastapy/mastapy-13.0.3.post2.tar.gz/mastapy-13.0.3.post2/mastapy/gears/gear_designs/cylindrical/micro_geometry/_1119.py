...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1038, _1051, _1022
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1113, _1110
...
class CylindricalGearSetMicroGeometry(_1249.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def cylindrical_mesh_micro_geometries(
        self: Self,
    ) -> "List[_1110.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: Self, gear_set_design: "_1038.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: Self, gear_set_design: "_1051.CylindricalPlanetaryGearSetDesign"
    ) -> "_1249.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail

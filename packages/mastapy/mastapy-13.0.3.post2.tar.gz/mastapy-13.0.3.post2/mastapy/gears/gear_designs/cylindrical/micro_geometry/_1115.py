...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self: Self) -> "_1132.MeasuredMapDataTypes":
    ...
    def measured_map_data_type(self: Self, value: "_1132.MeasuredMapDataTypes"):
    ...
    @property
    def zero_bias_relief(self: Self) -> "_1035.CylindricalGearProfileMeasurement":

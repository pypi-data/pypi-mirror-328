...
class CaseHardeningProperties(_0.APIBase):
    ...
    @enforce_parameter_types
    def hardness_profile_calculation_method(
        self: Self, value: "_1062.HardnessProfileCalculationMethod"
    ):
    ...
    @property
    def heat_treatment_type(self: Self) -> "_1063.HeatTreatmentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1063", "HeatTreatmentType"
        )(value)

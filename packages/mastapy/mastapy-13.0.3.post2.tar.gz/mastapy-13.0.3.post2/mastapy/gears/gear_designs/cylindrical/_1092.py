...
class TiffAnalysisSettings(
    _1604.IndependentReportablePropertiesBase["TiffAnalysisSettings"]
):
    """TiffAnalysisSettings
    ...
    @property
    def core_material_properties(self: Self) -> "_1061.HardenedMaterialProperties":
    ...
    @property
    def surface_material_properties(self: Self) -> "_1061.HardenedMaterialProperties":
        """mastapy.gears.gear_designs.cylindrical.HardenedMaterialProperties

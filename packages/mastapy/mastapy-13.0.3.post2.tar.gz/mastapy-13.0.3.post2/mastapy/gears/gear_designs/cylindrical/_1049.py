...
class CylindricalMeshedGearFlank(_0.APIBase):
    ...
    @property
    def specific_sliding_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def end_of_active_profile(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
    ...
    @property
    def working_pitch(self: Self) -> "_1035.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement

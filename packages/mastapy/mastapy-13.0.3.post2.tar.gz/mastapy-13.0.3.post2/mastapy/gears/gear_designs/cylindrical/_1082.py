...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1084, _1085
...
class Scuffing(_1604.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: Self, value: "_1083.ScuffingCoefficientOfFrictionMethods"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: Self, value: "_1084.ScuffingTemperatureMethodsAGMA"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: Self, value: "_1085.ScuffingTemperatureMethodsISO"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",

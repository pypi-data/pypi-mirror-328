...
class CylindricalGearPinionTypeCutterFlank(_1017.CylindricalGearAbstractRackFlank):
    """CylindricalGearPinionTypeCutterFlank
    ...
    class _Cast_CylindricalGearPinionTypeCutterFlank:
        ...
        def cylindrical_gear_abstract_rack_flank(
            ...
            return self._parent._cast(_1017.CylindricalGearAbstractRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1033.CylindricalGearPinionTypeCutter":

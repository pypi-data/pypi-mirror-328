...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1095, _1078
...
class CylindricalMeshAngularBacklash(_1050.CylindricalMeshLinearBacklashSpecification):
    """CylindricalMeshAngularBacklash
    ...
    class _Cast_CylindricalMeshAngularBacklash:
        ...
        def relative_measurement_view_model(
            ...
            return self._parent._cast(_1078.RelativeMeasurementViewModel)

...
class GearSetCreationOptions(_0.APIBase, Generic[T]):
    ...
    class _Cast_GearSetCreationOptions:
        ...
        def cylindrical_gear_pair_creation_options(
            ...
            from mastapy.gears.gear_designs.creation_options import _1164

            return self._parent._cast(_1164.CylindricalGearPairCreationOptions)

        @property
        def hypoid_gear_set_creation_options(
            self: "GearSetCreationOptions._Cast_GearSetCreationOptions",
        ) -> "_1166.HypoidGearSetCreationOptions":
            from mastapy.gears.gear_designs.creation_options import _1166

            return self._parent._cast(_1166.HypoidGearSetCreationOptions)

        @property
        def spiral_bevel_gear_set_creation_options(
            self: "GearSetCreationOptions._Cast_GearSetCreationOptions",
        ) -> "_1167.SpiralBevelGearSetCreationOptions":
            from mastapy.gears.gear_designs.creation_options import _1167

            return self._parent._cast(_1167.SpiralBevelGearSetCreationOptions)

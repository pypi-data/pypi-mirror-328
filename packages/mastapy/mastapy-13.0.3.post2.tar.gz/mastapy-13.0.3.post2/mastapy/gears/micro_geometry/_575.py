...
class LeadModification(_582.Modification):
    ...
    def cad_composed_drawing(self: Self) -> "Image":
        ...
        """
        temp = self.wrapped.CADComposedDrawing
    ...
    @property
    def measured_data(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: Self, value: "_1553.Vector2DListAccessor"):

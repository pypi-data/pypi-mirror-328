...
from mastapy.detailed_rigid_connectors.splines import _1430, _1436
...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(self: Self, value: "_1430.SplineFitClassType"):
    ...
    @enforce_parameter_types
    def tolerance_class(self: Self, value: "_1436.SplineToleranceClassTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

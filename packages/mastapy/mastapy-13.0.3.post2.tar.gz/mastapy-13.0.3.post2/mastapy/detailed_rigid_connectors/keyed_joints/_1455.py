...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1456, _1458
...
class KeyedJointDesign(_1463.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: Self) -> "_1456.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1456", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: Self, value: "_1456.KeyTypes"):
    ...
    @property
    def number_of_keys(self: Self) -> "_1458.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1458", "NumberOfKeys"
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: Self, value: "_1458.NumberOfKeys"):
        value = conversion.mp_to_pn_enum(

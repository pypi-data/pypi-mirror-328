...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1459
...
class KeywayRating(_1467.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self: Self) -> "_1455.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: Self) -> "List[_1459.KeywayHalfRating]":

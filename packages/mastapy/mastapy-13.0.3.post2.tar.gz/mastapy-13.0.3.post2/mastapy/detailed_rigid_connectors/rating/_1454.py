...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1460
    from mastapy.detailed_rigid_connectors.interference_fits.rating import _1467
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    class _Cast_ShaftHubConnectionRating:
        ...
        def agma6123_spline_joint_rating(
            ...
            return self._parent._cast(_1442.AGMA6123SplineJointRating)
        ...
        def din5466_spline_rating(
            ...
            return self._parent._cast(_1444.DIN5466SplineRating)

        @property
        def gbt17855_spline_joint_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ) -> "_1446.GBT17855SplineJointRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1446

            return self._parent._cast(_1446.GBT17855SplineJointRating)

        @property
        def sae_spline_joint_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ) -> "_1448.SAESplineJointRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1448

            return self._parent._cast(_1448.SAESplineJointRating)

        @property
        def spline_joint_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ) -> "_1450.SplineJointRating":
            from mastapy.detailed_rigid_connectors.splines.ratings import _1450

            return self._parent._cast(_1450.SplineJointRating)
        ...
        def keyway_rating(
            ...
            return self._parent._cast(_1460.KeywayRating)

        @property
        def interference_fit_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ) -> "_1467.InterferenceFitRating":
            from mastapy.detailed_rigid_connectors.interference_fits.rating import _1467

            return self._parent._cast(_1467.InterferenceFitRating)
    ...
    @property
    def joint_design(self: Self) -> "_1405.DetailedRigidConnectorDesign":

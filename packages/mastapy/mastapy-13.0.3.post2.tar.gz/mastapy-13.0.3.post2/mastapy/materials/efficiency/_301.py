...
class OilPumpDetail(_1604.IndependentReportablePropertiesBase["OilPumpDetail"]):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @property
    def oil_flow_rate_vs_speed(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def oil_flow_rate_vs_speed(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @property
    def operating_oil_pressure_vs_speed(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""

...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1473, _1476
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1473.CycloidalDiscDesignExporter":

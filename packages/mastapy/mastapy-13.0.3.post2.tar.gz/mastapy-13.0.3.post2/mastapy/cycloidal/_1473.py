...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1478
...
class CycloidalDiscDesignExporter(_0.APIBase):
    ...
    @property
    def geometry_to_export(self: Self) -> "_1478.GeometryToExport":
        ...
        return constructor.new_from_mastapy(
            "mastapy.cycloidal._1478", "GeometryToExport"
        )(value)

    @geometry_to_export.setter
    @enforce_parameter_types
    def geometry_to_export(self: Self, value: "_1478.GeometryToExport"):
    ...
    def profile_points(
        self: Self,
        geometry_to_export: "_1478.GeometryToExport",

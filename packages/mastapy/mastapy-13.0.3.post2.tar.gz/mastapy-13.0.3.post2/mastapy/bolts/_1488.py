...
if TYPE_CHECKING:
    from mastapy.bolts import _1503
...
class BoltMaterial(_1484.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: Self) -> "_1503.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1503", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1503.StrengthGrades"):

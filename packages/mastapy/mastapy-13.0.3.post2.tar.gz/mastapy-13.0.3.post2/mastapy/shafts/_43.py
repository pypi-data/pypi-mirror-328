...
class SimpleShaftDefinition(_1847.NamedDatabaseItem):
    """SimpleShaftDefinition
    ...
    def override_default_shaft_material(self: Self) -> "bool":
        """bool"""
        temp = self.wrapped.OverrideDefaultShaftMaterial
    ...
    @enforce_parameter_types
    def override_default_shaft_material(self: Self, value: "bool"):
        self.wrapped.OverrideDefaultShaftMaterial = (

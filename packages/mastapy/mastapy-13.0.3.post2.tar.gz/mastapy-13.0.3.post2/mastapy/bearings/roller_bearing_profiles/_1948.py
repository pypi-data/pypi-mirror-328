...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self: Self) -> "_1911.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1911", "RollerBearingProfileTypes"
        )(value)

    @active_profile_type.setter
    @enforce_parameter_types
    def active_profile_type(self: Self, value: "_1911.RollerBearingProfileTypes"):
    ...
    @property
    def active_profile(self: Self) -> "_1956.RollerBearingProfile":

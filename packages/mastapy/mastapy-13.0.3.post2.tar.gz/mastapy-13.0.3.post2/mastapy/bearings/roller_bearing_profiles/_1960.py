...
from mastapy.bearings.roller_bearing_profiles import _1958
...
class UserSpecifiedRollerRaceProfilePoint(_1958.RollerRaceProfilePoint):
    """UserSpecifiedRollerRaceProfilePoint
    ...
    class _Cast_UserSpecifiedRollerRaceProfilePoint:
        ...
        def roller_race_profile_point(
            ...
            return self._parent._cast(_1958.RollerRaceProfilePoint)

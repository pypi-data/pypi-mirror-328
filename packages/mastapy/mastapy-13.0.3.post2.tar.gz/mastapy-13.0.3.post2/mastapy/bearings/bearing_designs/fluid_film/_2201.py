...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2202, _2203
...
class AxialFeedJournalBearing(_0.APIBase):
    ...
    class _Cast_AxialFeedJournalBearing:
        ...
        def axial_groove_journal_bearing(
            ...
            return self._parent._cast(_2202.AxialGrooveJournalBearing)

        @property
        def axial_hole_journal_bearing(
            self: "AxialFeedJournalBearing._Cast_AxialFeedJournalBearing",
        ) -> "_2203.AxialHoleJournalBearing":
            from mastapy.bearings.bearing_designs.fluid_film import _2203

            return self._parent._cast(_2203.AxialHoleJournalBearing)

...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2214, _2215
...
class PadFluidFilmBearing(_2151.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: Self, value: "_1917.RotationalDirections"):

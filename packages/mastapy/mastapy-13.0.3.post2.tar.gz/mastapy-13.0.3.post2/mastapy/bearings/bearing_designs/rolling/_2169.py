...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_designs.rolling import _2180, _2182, _2185
...
class CylindricalRollerBearing(_2181.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: Self, value: "_1962.CylindricalRollerMaxAxialLoadMethod"
    ):

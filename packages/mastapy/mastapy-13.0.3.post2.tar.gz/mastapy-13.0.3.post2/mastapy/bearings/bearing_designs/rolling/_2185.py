...
from mastapy.bearings import _1912, _1890, _1891, _1915
from mastapy.bearings.bearing_designs.rolling import _2171, _2172, _2178, _2195
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1892, _1889
    ...
    from mastapy.bearings.bearing_designs import _2154, _2150
...
class RollingBearing(_2151.DetailedBearing):
    """RollingBearing
    ...
    @arrangement.setter
    @enforce_parameter_types
    def arrangement(self: Self, value: "_1912.RollingBearingArrangement"):
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: Self, value: "_1890.BasicDynamicLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: Self, value: "_1891.BasicStaticLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def cage_bridge_shape(self: Self) -> "_2167.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2167", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @enforce_parameter_types
    def cage_bridge_shape(self: Self, value: "_2167.CageBridgeShape"):
    ...
    @property
    def cage_material(self: Self) -> "_1892.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1892", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @enforce_parameter_types
    def cage_material(self: Self, value: "_1892.BearingCageMaterial"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def catalogue(self: Self) -> "_1889.BearingCatalog":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1889", "BearingCatalog")(
            value
        )
    ...
    def diameter_series(
        self: Self,
        value: "Union[_2171.DiameterSeries, Tuple[_2171.DiameterSeries, bool]]",
    ):
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: Self, value: "_2172.FatigueLoadLimitCalculationMethodEnum"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def height_series(
        self: Self, value: "Union[_2178.HeightSeries, Tuple[_2178.HeightSeries, bool]]"
    ):
    ...
    @enforce_parameter_types
    def inner_race_type(self: Self, value: "_1915.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def outer_race_type(self: Self, value: "_1915.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        )
    ...
    @property
    def sleeve_type(self: Self) -> "_2188.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2188", "SleeveType"
        )(value)
    ...
    @property
    def type_information(self: Self) -> "_2166.BearingTypeExtraInformation":
    ...
    @enforce_parameter_types
    def width_series(
        self: Self, value: "Union[_2195.WidthSeries, Tuple[_2195.WidthSeries, bool]]"
    ):
    ...
    @property
    def element_material(self: Self) -> "_248.BearingMaterial":
    ...
    @property
    def geometric_constants(self: Self) -> "_2175.GeometricConstants":
    ...
    @property
    def history(self: Self) -> "_1600.FileHistory":
    ...
    @property
    def iso153122018(self: Self) -> "_1997.ISO153122018Results":
    ...
    @property
    def inner_ring_material(self: Self) -> "_248.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def outer_ring_material(self: Self) -> "_248.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def protection(self: Self) -> "_2163.BearingProtection":

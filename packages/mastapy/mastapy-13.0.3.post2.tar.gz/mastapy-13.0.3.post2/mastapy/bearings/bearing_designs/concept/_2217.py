...
class ConceptAxialClearanceBearing(_2218.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: Self) -> "_2216.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.concept._2216", "BearingNodePosition"
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: Self, value: "_2216.BearingNodePosition"):

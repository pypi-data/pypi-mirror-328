...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2115
...
class SKFSettings(_1612.PerMachineSettings):
    """SKFSettings
    ...
    @property
    def skf_authentication(self: Self) -> "_2115.SKFAuthentication":

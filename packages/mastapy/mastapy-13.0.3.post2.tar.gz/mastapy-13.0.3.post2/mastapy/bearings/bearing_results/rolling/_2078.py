...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2077, _2054
...
class LoadedToroidalRollerBearingRow(_2050.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2077.LoadedToroidalRollerBearingResults":

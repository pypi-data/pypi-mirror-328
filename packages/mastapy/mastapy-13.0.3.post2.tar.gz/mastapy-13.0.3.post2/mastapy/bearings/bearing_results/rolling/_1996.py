...
class ISO14179SettingsPerBearingType(
    _1604.IndependentReportablePropertiesBase["ISO14179SettingsPerBearingType"]
):
    """ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self: Self) -> "_1916.RollingBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1916", "RollingBearingType"
        )(value)

    @property
    def iso14179_settings(self: Self) -> "_1994.ISO14179Settings":

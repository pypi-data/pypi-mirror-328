...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2041, _2045, _2050, _2054
...
class LoadedNeedleRollerBearingRow(_2030.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2041.LoadedNeedleRollerBearingResults":

...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2032, _2054
...
class LoadedDeepGrooveBallBearingRow(_2023.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2032.LoadedDeepGrooveBallBearingResults":

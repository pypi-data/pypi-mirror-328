...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1998, _2000
...
class ISOTR141792001Results(_0.APIBase):
    ...
    class _Cast_ISOTR141792001Results:
        ...
        def isotr1417912001_results(
            ...
            return self._parent._cast(_1998.ISOTR1417912001Results)
        ...
        def isotr1417922001_results(
            ...
            return self._parent._cast(_2000.ISOTR1417922001Results)

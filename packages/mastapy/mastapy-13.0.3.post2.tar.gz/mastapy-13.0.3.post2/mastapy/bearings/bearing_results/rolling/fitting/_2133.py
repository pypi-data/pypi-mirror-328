...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.fitting import _2131, _2130, _2132
...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(
            ...
            from mastapy.bearings.bearing_results.rolling.fitting import _2130

            return self._parent._cast(_2130.InnerRingFittingThermalResults)

        @property
        def outer_ring_fitting_thermal_results(
            self: "RingFittingThermalResults._Cast_RingFittingThermalResults",
        ) -> "_2132.OuterRingFittingThermalResults":
            from mastapy.bearings.bearing_results.rolling.fitting import _2132

            return self._parent._cast(_2132.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self: Self) -> "List[_2131.InterferenceComponents]":

...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2102, _2114
...
class Frequencies(_2116.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: Self) -> "_2102.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: Self) -> "_2114.RotationalFrequency":

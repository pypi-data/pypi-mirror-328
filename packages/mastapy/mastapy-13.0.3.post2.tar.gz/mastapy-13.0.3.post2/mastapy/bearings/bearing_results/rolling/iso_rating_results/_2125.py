...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.abma import _2135, _2136, _2137
...
class ISOResults(_0.APIBase):
    ...
    class _Cast_ISOResults:
        ...
        def ball_iso2812007_results(
            ...
            return self._parent._cast(_2121.BallISO2812007Results)
        ...
        def ball_isots162812008_results(
            ...
            return self._parent._cast(_2122.BallISOTS162812008Results)
        ...
        def isots162812008_results(
            ...
            return self._parent._cast(_2126.ISOTS162812008Results)
        ...
        def roller_iso2812007_results(
            ...
            return self._parent._cast(_2127.RollerISO2812007Results)
        ...
        def roller_isots162812008_results(
            ...
            return self._parent._cast(_2128.RollerISOTS162812008Results)
        ...
        def ansiabma112014_results(
            ...
            return self._parent._cast(_2135.ANSIABMA112014Results)

        @property
        def ansiabma92015_results(
            self: "ISOResults._Cast_ISOResults",
        ) -> "_2136.ANSIABMA92015Results":
            from mastapy.bearings.bearing_results.rolling.abma import _2136

            return self._parent._cast(_2136.ANSIABMA92015Results)
        ...
        def ansiabma_results(
            ...
            return self._parent._cast(_2137.ANSIABMAResults)

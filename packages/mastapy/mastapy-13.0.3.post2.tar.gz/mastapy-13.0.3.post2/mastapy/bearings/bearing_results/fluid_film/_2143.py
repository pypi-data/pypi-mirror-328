...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedPlainJournalBearingRow:
        ...
        def loaded_plain_oil_fed_journal_bearing_row(
            ...
            return self._parent._cast(_2145.LoadedPlainOilFedJournalBearingRow)
    ...
    @property
    def row(self: Self) -> "_1898.BearingRow":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1898", "BearingRow")(
            value
        )

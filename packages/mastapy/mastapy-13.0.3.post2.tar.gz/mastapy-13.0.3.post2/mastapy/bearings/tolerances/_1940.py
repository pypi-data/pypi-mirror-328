...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1941, _1936, _1921
...
class SupportDetail(_1928.InterferenceDetail):
    """SupportDetail
    ...
    @property
    def material_source(self: Self) -> "_1941.SupportMaterialSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1941", "SupportMaterialSource"
        )(value)
    ...
    @property
    def radial_specification_method(self: Self) -> "_1936.RadialSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1936", "RadialSpecificationMethod"
        )(value)

    @radial_specification_method.setter
    @enforce_parameter_types
    def radial_specification_method(
        self: Self, value: "_1936.RadialSpecificationMethod"
    ):

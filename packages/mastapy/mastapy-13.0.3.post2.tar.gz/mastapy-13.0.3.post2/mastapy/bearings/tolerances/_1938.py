...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1939, _1945, _1935
...
class RoundnessSpecification(
    _1604.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    @property
    def specification_type(self: Self) -> "_1939.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1939", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1939.RoundnessSpecificationType"):
    ...
    @property
    def type_of_fit(self: Self) -> "_1945.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1945", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: Self, value: "_1945.TypeOfFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def user_specified_deviation(self: Self, value: "_1553.Vector2DListAccessor"):
        self.wrapped.UserSpecifiedDeviation = value.wrapped

    @property
    def roundness_distribution(self: Self) -> "List[_1935.RaceRoundnessAtAngle]":

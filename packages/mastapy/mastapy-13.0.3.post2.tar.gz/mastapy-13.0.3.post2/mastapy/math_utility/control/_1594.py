...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility import _1541
...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def integral_gain_vs_time_and_error(self: Self) -> "_1583.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def update_method(self: Self) -> "_1541.PIDControlUpdateMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1541", "PIDControlUpdateMethod"
        )(value)

    @update_method.setter
    @enforce_parameter_types
    def update_method(self: Self, value: "_1541.PIDControlUpdateMethod"):

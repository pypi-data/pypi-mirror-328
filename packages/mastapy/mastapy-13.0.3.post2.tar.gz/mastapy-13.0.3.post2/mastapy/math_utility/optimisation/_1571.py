...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1573, _1565, _1566
...
class ParetoOptimisationVariable(_1572.ParetoOptimisationVariableBase):
    """ParetoOptimisationVariable
    ...
    def property_target_for_dominant_candidate_search(
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1573",
    ...
    def property_target_for_dominant_candidate_search(
        self: Self, value: "_1573.PropertyTargetForDominantCandidateSearch"
    ):

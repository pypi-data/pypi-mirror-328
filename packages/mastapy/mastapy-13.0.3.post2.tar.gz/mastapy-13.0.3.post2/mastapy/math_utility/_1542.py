...
class Quaternion(_1544.RealVector):
    """Quaternion
    ...
    class _Cast_Quaternion:
        ...
        @property
        def real_vector(self: "Quaternion._Cast_Quaternion") -> "_1544.RealVector":
            return self._parent._cast(_1544.RealVector)

        @property
        def real_matrix(self: "Quaternion._Cast_Quaternion") -> "_1543.RealMatrix":

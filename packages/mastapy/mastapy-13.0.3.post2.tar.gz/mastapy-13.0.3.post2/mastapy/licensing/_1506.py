...
if TYPE_CHECKING:
    from mastapy.licensing import _7593, _7594, _7595
...
class LicenceServer:
    ...
    @staticmethod
    @enforce_parameter_types
    def update_server_settings(server_details: "_7593.LicenceServerDetails"):
    ...
    @staticmethod
    def get_server_settings() -> "_7593.LicenceServerDetails":
    ...
    @staticmethod
    def get_licensed_module_details() -> "Iterable[_7594.ModuleDetails]":
    ...
    @staticmethod
    def get_available_module_details() -> "Iterable[_7594.ModuleDetails]":
        """Iterable[mastapy.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    def get_requested_module_statuses() -> "Iterable[_7595.ModuleLicenceStatus]":

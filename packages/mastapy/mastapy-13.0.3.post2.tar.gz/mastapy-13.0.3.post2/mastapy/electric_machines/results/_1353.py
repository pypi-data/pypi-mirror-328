...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1351, _1354, _1352, _1350
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: Self,
    ) -> "List[_1351.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: Self,
    ) -> "List[_1354.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1352.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: Self,
    ) -> "List[_1350.ElectricMachineResultsForPhaseAtTimeStep]":

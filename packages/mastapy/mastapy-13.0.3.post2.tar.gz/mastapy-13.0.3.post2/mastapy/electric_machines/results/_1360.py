...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1885, _1887
    from mastapy.electric_machines.results import _1361
...
class NonLinearDQModel(_1341.ElectricMachineDQModel):
    """NonLinearDQModel
    ...
    class _Cast_NonLinearDQModel:
        ...
        def electric_machine_dq_model(
            ...
            return self._parent._cast(_1341.ElectricMachineDQModel)
    ...
    @property
    def d_axis_armature_flux_linkage_map(self: Self) -> "_1885.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
    ...
    @property
    def q_axis_armature_flux_linkage_map(self: Self) -> "_1885.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition

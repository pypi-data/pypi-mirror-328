...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1362, _1363
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def on_load_results(self: Self) -> "_1362.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: Self) -> "_1363.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: Self) -> "List[_1362.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: Self,
    ) -> "List[_1363.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: Self,
    ) -> "List[_1362.OnLoadElectricMachineResults]":
        """List[mastapy.electric_machines.results.OnLoadElectricMachineResults]

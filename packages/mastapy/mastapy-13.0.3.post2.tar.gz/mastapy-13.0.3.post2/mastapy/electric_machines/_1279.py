...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1360, _1361
    from mastapy.math_utility import _1540
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def cad_electric_machine_detail(
            ...
            return self._parent._cast(_1264.CADElectricMachineDetail)
    ...
    def core_loss_build_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1274", "CoreLossBuildFactorSpecificationMethod"
        )(value)

    @core_loss_build_factor_specification_method.setter
    @enforce_parameter_types
    def core_loss_build_factor_specification_method(
        self: Self, value: "_1274.CoreLossBuildFactorSpecificationMethod"
    ):
    ...
    @property
    def electric_machine_type(self: Self) -> "_1285.ElectricMachineType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1285", "ElectricMachineType"
        )(value)
    ...
    @select_setup.setter
    @enforce_parameter_types
    def select_setup(self: Self, value: "_1284.ElectricMachineSetup"):
        wrapper_type = (
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1360.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1311.Rotor":
    ...
    @property
    def selected_setup(self: Self) -> "_1284.ElectricMachineSetup":
    ...
    @property
    def stator(self: Self) -> "_1261.AbstractStator":
    ...
    @property
    def results_locations(self: Self) -> "List[_1540.Named2DLocation]":
    ...
    @property
    def setups(self: Self) -> "List[_1284.ElectricMachineSetup]":
    ...
    def add_setup(self: Self) -> "_1284.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup"""
    ...
    def generate_design_without_non_linear_dq_model(
        self: Self,
    ) -> "_1609.MethodOutcomeWithResult[ElectricMachineDetail]":
    ...
    @enforce_parameter_types
    def remove_setup(self: Self, setup: "_1284.ElectricMachineSetup"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def setup_named(self: Self, name: "str") -> "_1284.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup
    ...
    def try_generate_non_linear_dq_model_with_task_progress(
        self: Self, progress: "_7580.TaskProgress"
    ) -> "_1609.MethodOutcomeWithResult[ElectricMachineDetail]":
        """mastapy.utility.MethodOutcomeWithResult[mastapy.electric_machines.ElectricMachineDetail]

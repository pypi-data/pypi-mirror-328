...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1327, _1278
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electro_magnetic_analysis(
        self: Self,
    ) -> "_1327.TwoDimensionalFEModelForAnalysis[_1282.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1278.Eccentricity":

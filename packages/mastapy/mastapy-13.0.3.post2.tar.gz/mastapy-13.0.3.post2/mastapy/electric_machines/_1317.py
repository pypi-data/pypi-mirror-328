...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1318, _1324
...
class Stator(_1261.AbstractStator):
    """Stator
    ...
    class _Cast_Stator:
        ...
        @property
        def abstract_stator(self: "Stator._Cast_Stator") -> "_1261.AbstractStator":
            return self._parent._cast(_1261.AbstractStator)
    ...
    def number_of_stator_cutout_specifications(self: Self, value: "int"):
    ...
    def stator_cutout_specifications(
        self: Self,
    ) -> "List[_1318.StatorCutoutSpecification]":
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1324.ToothAndSlot":

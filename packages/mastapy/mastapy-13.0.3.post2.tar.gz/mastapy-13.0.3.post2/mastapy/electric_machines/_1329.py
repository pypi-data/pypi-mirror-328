...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1295, _1287
...
class VShapedMagnetLayerSpecification(_1312.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    def cutout_width(self: Self, value: "Union[float, Tuple[float, bool]]"):
    ...
    @property
    def magnet_clearance(self: Self) -> "_1295.MagnetClearance":
    ...
    @enforce_parameter_types
    def magnet_clearance(self: Self, value: "_1295.MagnetClearance"):
    ...
    @property
    def upper_flux_barrier_web_specification(self: Self) -> "_1287.FluxBarrierOrWeb":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1287", "FluxBarrierOrWeb"
        )(value)

    @upper_flux_barrier_web_specification.setter
    @enforce_parameter_types
    def upper_flux_barrier_web_specification(
        self: Self, value: "_1287.FluxBarrierOrWeb"
    ):
        value = conversion.mp_to_pn_enum(

...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            return self._parent._cast(_1364.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1366.DynamicForceLoadCase)
        ...
        def efficiency_map_load_case(
            ...
            return self._parent._cast(_1369.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1376.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1379.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1393

            return self._parent._cast(_1393.SpeedTorqueCurveLoadCase)

        @property
        def speed_torque_load_case(
            self: "ElectricMachineLoadCaseBase._Cast_ElectricMachineLoadCaseBase",
        ) -> "_1394.SpeedTorqueLoadCase":
            from mastapy.electric_machines.load_cases_and_analyses import _1394

            return self._parent._cast(_1394.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1395.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1370.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1378.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1370.ElectricMachineAnalysis"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: Self, setup: "_1284.ElectricMachineSetup"):
        """Method does not return.

...
from mastapy.electric_machines.load_cases_and_analyses import _1370
from mastapy.electric_machines.results import _1357
...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1364, _1374
...
class DynamicForceAnalysis(
    _1370.ElectricMachineAnalysis, _1357.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    class _Cast_DynamicForceAnalysis:
        ...
        def electric_machine_analysis(
            ...
            return self._parent._cast(_1370.ElectricMachineAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1364.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1339.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1374.ElectricMachineFEAnalysis]":

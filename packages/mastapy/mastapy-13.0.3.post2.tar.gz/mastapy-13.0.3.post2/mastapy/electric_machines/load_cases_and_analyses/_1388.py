...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1376, _1389, _1374
...
class SingleOperatingPointAnalysis(_1370.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1376.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1389.SlotDetailForAnalysis]":

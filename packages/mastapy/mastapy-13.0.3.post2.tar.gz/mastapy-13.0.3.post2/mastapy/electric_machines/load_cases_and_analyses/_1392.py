...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1359
...
class SpeedTorqueCurveAnalysis(_1370.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1393.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: Self) -> "List[_1359.MaximumTorqueResultsPoints]":

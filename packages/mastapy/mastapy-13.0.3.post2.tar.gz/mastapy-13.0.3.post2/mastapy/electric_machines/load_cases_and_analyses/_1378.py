...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: Self) -> "List[_1366.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1364.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: Self) -> "List[_1369.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: Self,
    ) -> "List[_1394.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1376.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: Self,
    ) -> "List[_1393.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: Self, load_case_type: "_1382.LoadCaseType"
    ...
    def add_load_case_named(
        self: Self, load_case_type: "_1382.LoadCaseType", name: "str"
    ) -> "_1377.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: Self,
        setup: "_1284.ElectricMachineSetup",
        load_case_type: "_1382.LoadCaseType",
    ) -> "_1608.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1284.ElectricMachineSetup",
        load_case_type: "_1382.LoadCaseType",
        task_progress: "_7580.TaskProgress",
    ) -> "_1608.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: Self, load_case: "_1377.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1313, _1267, _1292, _1308, _1322
...
class Rotor(_0.APIBase):
    ...
    class _Cast_Rotor:
        ...
        @property
        def cad_rotor(self: "Rotor._Cast_Rotor") -> "_1267.CADRotor":
            from mastapy.electric_machines import _1267

            return self._parent._cast(_1267.CADRotor)
        ...
        def surface_permanent_magnet_rotor(
            ...
            return self._parent._cast(_1322.SurfacePermanentMagnetRotor)
    ...
    def d_axis_and_q_axis_convention(
        self: Self,
        value: "Union[_1277.DQAxisConvention, Tuple[_1277.DQAxisConvention, bool]]",
    ):
    ...
    @property
    def skew_slices(self: Self) -> "List[_1313.RotorSkewSlice]":

...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1291, _1330
...
class CADToothAndSlot(_1262.AbstractToothAndSlot):
    """CADToothAndSlot
    ...
    def individual_conductor_specification_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1291", "IndividualConductorSpecificationSource"
        )(value)

    @individual_conductor_specification_source.setter
    @enforce_parameter_types
    def individual_conductor_specification_source(
        self: Self, value: "_1291.IndividualConductorSpecificationSource"
    ):

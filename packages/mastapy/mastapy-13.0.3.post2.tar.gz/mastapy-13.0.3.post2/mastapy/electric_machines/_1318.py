...
class StatorCutoutSpecification(_0.APIBase):
    ...
    TYPE = _STATOR_CUTOUT_SPECIFICATION
    ...
    class _Cast_StatorCutoutSpecification:
        ...
        @property
        def stator_cutout_specification(
            self: "StatorCutoutSpecification._Cast_StatorCutoutSpecification",
        ) -> "StatorCutoutSpecification":
            return self._parent
    ...
    def angle_to_first_cutout(self: Self, value: "float"):
    ...
    @enforce_parameter_types
    def number_of_cutouts(self: Self, value: "Union[int, Tuple[int, bool]]"):

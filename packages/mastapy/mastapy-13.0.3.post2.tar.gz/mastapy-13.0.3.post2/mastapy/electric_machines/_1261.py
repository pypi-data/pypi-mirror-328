...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1262, _1334, _1268, _1317
...
class AbstractStator(_0.APIBase):
    ...
    class _Cast_AbstractStator:
        ...
        def cad_stator(
            ...
            return self._parent._cast(_1268.CADStator)

        @property
        def stator(self: "AbstractStator._Cast_AbstractStator") -> "_1317.Stator":
            from mastapy.electric_machines import _1317

            return self._parent._cast(_1317.Stator)
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1262.AbstractToothAndSlot":

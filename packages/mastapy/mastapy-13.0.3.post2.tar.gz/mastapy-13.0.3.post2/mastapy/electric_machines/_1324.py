...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1326, _1325
...
class ToothAndSlot(_1262.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    class _Cast_ToothAndSlot:
        ...
        def abstract_tooth_and_slot(
            ...
            return self._parent._cast(_1262.AbstractToothAndSlot)
    ...
    @property
    def tooth_taper_specification(self: Self) -> "_1326.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1326", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(self: Self, value: "_1326.ToothTaperSpecification"):
    ...
    @property
    def tooth_slot_style(self: Self) -> "_1325.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1325", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: Self, value: "_1325.ToothSlotStyle"):
        value = conversion.mp_to_pn_enum(

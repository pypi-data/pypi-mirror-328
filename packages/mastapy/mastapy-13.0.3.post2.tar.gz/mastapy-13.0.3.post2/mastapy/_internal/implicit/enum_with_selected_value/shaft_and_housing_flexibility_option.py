...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5505.ShaftAndHousingFlexibilityOption":
        ...
        return _5505.ShaftAndHousingFlexibilityOption

    @classmethod
    def implicit_type(cls) -> "_5505.ShaftAndHousingFlexibilityOption.type_()":
        ...
        return _5505.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: Self) -> "_5505.ShaftAndHousingFlexibilityOption":
    ...
    @property
    def available_values(self: Self) -> "List[_5505.ShaftAndHousingFlexibilityOption]":

...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6839.AnalysisType":
        ...
        return _6839.AnalysisType

    @classmethod
    def implicit_type(cls) -> "_6839.AnalysisType.type_()":
        ...
        return _6839.AnalysisType.type_()

    @property
    def selected_value(self: Self) -> "_6839.AnalysisType":
    ...
    @property
    def available_values(self: Self) -> "List[_6839.AnalysisType]":

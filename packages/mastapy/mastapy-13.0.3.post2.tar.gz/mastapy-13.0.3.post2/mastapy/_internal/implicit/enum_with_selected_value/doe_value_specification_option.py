...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4370.DoeValueSpecificationOption":
        ...
        return _4370.DoeValueSpecificationOption

    @classmethod
    def implicit_type(cls) -> "_4370.DoeValueSpecificationOption.type_()":
        ...
        return _4370.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: Self) -> "_4370.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_4370.DoeValueSpecificationOption]":

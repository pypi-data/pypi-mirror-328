...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6998.TorqueRippleInputType":
        ...
        return _6998.TorqueRippleInputType

    @classmethod
    def implicit_type(cls) -> "_6998.TorqueRippleInputType.type_()":
        ...
        return _6998.TorqueRippleInputType.type_()

    @property
    def selected_value(self: Self) -> "_6998.TorqueRippleInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_6998.TorqueRippleInputType]":

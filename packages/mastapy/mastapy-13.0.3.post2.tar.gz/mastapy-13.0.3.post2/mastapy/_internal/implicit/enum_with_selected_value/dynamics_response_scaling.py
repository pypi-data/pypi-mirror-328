...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1524.DynamicsResponseScaling":
        ...
        return _1524.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1524.DynamicsResponseScaling.type_()":
        ...
        return _1524.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1524.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1524.DynamicsResponseScaling]":

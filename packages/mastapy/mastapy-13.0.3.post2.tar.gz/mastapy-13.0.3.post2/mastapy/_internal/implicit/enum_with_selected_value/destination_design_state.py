...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    @classmethod
    def wrapped_type(cls) -> "_7013.DestinationDesignState":
        ...
        return _7013.DestinationDesignState

    @classmethod
    def implicit_type(cls) -> "_7013.DestinationDesignState.type_()":
        ...
        return _7013.DestinationDesignState.type_()

    @property
    def selected_value(self: Self) -> "_7013.DestinationDesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_7013.DestinationDesignState]":

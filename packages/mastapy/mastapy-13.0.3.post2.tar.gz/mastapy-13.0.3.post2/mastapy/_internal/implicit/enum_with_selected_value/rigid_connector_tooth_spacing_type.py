...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2615.RigidConnectorToothSpacingType":
        ...
        return _2615.RigidConnectorToothSpacingType

    @classmethod
    def implicit_type(cls) -> "_2615.RigidConnectorToothSpacingType.type_()":
        ...
        return _2615.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: Self) -> "_2615.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: Self) -> "List[_2615.RigidConnectorToothSpacingType]":

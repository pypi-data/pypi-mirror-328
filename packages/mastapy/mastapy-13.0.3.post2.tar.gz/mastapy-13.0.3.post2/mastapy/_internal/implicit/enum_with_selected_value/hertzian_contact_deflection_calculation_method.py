...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1591.HertzianContactDeflectionCalculationMethod":
        ...
        return _1591.HertzianContactDeflectionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1591.HertzianContactDeflectionCalculationMethod.type_()":
        ...
        return _1591.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_1591.HertzianContactDeflectionCalculationMethod]":

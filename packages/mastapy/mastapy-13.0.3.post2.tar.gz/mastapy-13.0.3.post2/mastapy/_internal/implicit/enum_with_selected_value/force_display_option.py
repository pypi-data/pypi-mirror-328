...
from mastapy.electric_machines.harmonic_load_data import _1397
...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1397.ForceDisplayOption":
        ...
        return _1397.ForceDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1397.ForceDisplayOption.type_()":
        ...
        return _1397.ForceDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1397.ForceDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1397.ForceDisplayOption]":

...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5459.GearMeshStiffnessModel":
        ...
        return _5459.GearMeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5459.GearMeshStiffnessModel.type_()":
        ...
        return _5459.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5459.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5459.GearMeshStiffnessModel]":

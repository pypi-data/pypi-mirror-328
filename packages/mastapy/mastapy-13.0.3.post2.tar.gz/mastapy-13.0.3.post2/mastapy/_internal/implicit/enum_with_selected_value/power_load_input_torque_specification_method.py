...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2237.PowerLoadInputTorqueSpecificationMethod":
        ...
        return _2237.PowerLoadInputTorqueSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_2237.PowerLoadInputTorqueSpecificationMethod.type_()":
        ...
        return _2237.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2237.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2237.PowerLoadInputTorqueSpecificationMethod]":

...
class EnumWithSelectedValue_FitTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1413.FitTypes":
        ...
        return _1413.FitTypes

    @classmethod
    def implicit_type(cls) -> "_1413.FitTypes.type_()":
        ...
        return _1413.FitTypes.type_()

    @property
    def selected_value(self: Self) -> "_1413.FitTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1413.FitTypes]":

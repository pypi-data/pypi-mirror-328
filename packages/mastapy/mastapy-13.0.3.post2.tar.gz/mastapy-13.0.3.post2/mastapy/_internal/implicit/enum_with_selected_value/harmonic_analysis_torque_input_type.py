...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5790.HarmonicAnalysisTorqueInputType":
        ...
        return _5790.HarmonicAnalysisTorqueInputType

    @classmethod
    def implicit_type(cls) -> "_5790.HarmonicAnalysisTorqueInputType.type_()":
        ...
        return _5790.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: Self) -> "_5790.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5790.HarmonicAnalysisTorqueInputType]":

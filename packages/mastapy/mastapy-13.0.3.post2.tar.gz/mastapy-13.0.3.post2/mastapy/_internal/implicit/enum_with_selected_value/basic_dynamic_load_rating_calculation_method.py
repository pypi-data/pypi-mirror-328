...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1890.BasicDynamicLoadRatingCalculationMethod":
        ...
        return _1890.BasicDynamicLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1890.BasicDynamicLoadRatingCalculationMethod.type_()":
        ...
        return _1890.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1890.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1890.BasicDynamicLoadRatingCalculationMethod]":

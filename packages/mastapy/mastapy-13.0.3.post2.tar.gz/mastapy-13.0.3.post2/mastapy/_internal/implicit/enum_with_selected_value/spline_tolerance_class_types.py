...
from mastapy.detailed_rigid_connectors.splines import _1436
...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1436.SplineToleranceClassTypes":
        ...
        return _1436.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1436.SplineToleranceClassTypes.type_()":
        ...
        return _1436.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1436.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1436.SplineToleranceClassTypes]":

...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1839.ThreeDViewContourOption":
        ...
        return _1839.ThreeDViewContourOption

    @classmethod
    def implicit_type(cls) -> "_1839.ThreeDViewContourOption.type_()":
        ...
        return _1839.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: Self) -> "_1839.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1839.ThreeDViewContourOption]":

...
from mastapy.system_model.fe import _2431
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2431.ThermalExpansionOption":
        ...
        return _2431.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2431.ThermalExpansionOption.type_()":
        ...
        return _2431.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2431.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2431.ThermalExpansionOption]":

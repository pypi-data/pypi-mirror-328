...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2418.LinkNodeSource":
        ...
        return _2418.LinkNodeSource

    @classmethod
    def implicit_type(cls) -> "_2418.LinkNodeSource.type_()":
        ...
        return _2418.LinkNodeSource.type_()

    @property
    def selected_value(self: Self) -> "_2418.LinkNodeSource":
    ...
    @property
    def available_values(self: Self) -> "List[_2418.LinkNodeSource]":

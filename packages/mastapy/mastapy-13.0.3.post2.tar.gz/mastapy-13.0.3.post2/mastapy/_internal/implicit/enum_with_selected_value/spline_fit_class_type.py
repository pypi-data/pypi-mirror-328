...
from mastapy.detailed_rigid_connectors.splines import _1430
...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1430.SplineFitClassType":
        ...
        return _1430.SplineFitClassType

    @classmethod
    def implicit_type(cls) -> "_1430.SplineFitClassType.type_()":
        ...
        return _1430.SplineFitClassType.type_()

    @property
    def selected_value(self: Self) -> "_1430.SplineFitClassType":
    ...
    @property
    def available_values(self: Self) -> "List[_1430.SplineFitClassType]":

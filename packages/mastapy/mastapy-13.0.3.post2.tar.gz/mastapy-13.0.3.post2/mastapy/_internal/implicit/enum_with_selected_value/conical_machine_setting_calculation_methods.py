...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1175.ConicalMachineSettingCalculationMethods":
        ...
        return _1175.ConicalMachineSettingCalculationMethods

    @classmethod
    def implicit_type(cls) -> "_1175.ConicalMachineSettingCalculationMethods.type_()":
        ...
        return _1175.ConicalMachineSettingCalculationMethods.type_()

    @property
    def selected_value(self: Self) -> "_1175.ConicalMachineSettingCalculationMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1175.ConicalMachineSettingCalculationMethods]":

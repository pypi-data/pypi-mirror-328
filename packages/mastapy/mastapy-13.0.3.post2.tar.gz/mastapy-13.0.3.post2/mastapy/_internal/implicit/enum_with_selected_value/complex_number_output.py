...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls,
    ) -> "_5785.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        return _5785.HarmonicAnalysisFEExportOptions.ComplexNumberOutput

    @classmethod
    def implicit_type(
        cls,
    ) -> "_5785.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()":
        ...
        return _5785.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_5785.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":

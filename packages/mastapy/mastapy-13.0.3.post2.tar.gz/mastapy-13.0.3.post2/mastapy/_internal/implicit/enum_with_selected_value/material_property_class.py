...
from mastapy.fe_tools.enums import _1260
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1260.MaterialPropertyClass":
        ...
        return _1260.MaterialPropertyClass

    @classmethod
    def implicit_type(cls) -> "_1260.MaterialPropertyClass.type_()":
        ...
        return _1260.MaterialPropertyClass.type_()

    @property
    def selected_value(self: Self) -> "_1260.MaterialPropertyClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1260.MaterialPropertyClass]":

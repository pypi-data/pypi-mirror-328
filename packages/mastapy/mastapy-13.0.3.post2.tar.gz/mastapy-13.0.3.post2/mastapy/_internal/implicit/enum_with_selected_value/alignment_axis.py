...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1509.AlignmentAxis":
        ...
        return _1509.AlignmentAxis

    @classmethod
    def implicit_type(cls) -> "_1509.AlignmentAxis.type_()":
        ...
        return _1509.AlignmentAxis.type_()

    @property
    def selected_value(self: Self) -> "_1509.AlignmentAxis":
    ...
    @property
    def available_values(self: Self) -> "List[_1509.AlignmentAxis]":

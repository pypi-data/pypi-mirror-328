...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2408.FESubstructureType":
        ...
        return _2408.FESubstructureType

    @classmethod
    def implicit_type(cls) -> "_2408.FESubstructureType.type_()":
        ...
        return _2408.FESubstructureType.type_()

    @property
    def selected_value(self: Self) -> "_2408.FESubstructureType":
    ...
    @property
    def available_values(self: Self) -> "List[_2408.FESubstructureType]":

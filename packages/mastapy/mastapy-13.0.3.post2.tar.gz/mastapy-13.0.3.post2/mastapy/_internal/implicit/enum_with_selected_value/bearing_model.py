...
class EnumWithSelectedValue_BearingModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1897.BearingModel":
        ...
        return _1897.BearingModel

    @classmethod
    def implicit_type(cls) -> "_1897.BearingModel.type_()":
        ...
        return _1897.BearingModel.type_()

    @property
    def selected_value(self: Self) -> "_1897.BearingModel":
    ...
    @property
    def available_values(self: Self) -> "List[_1897.BearingModel]":

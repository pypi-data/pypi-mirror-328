...
from mastapy.utility.model_validation import _1810
...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1810.Severity":
        ...
        return _1810.Severity

    @classmethod
    def implicit_type(cls) -> "_1810.Severity.type_()":
        ...
        return _1810.Severity.type_()

    @property
    def selected_value(self: Self) -> "_1810.Severity":
    ...
    @property
    def available_values(self: Self) -> "List[_1810.Severity]":

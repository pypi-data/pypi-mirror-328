...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1083.ScuffingCoefficientOfFrictionMethods":
        ...
        return _1083.ScuffingCoefficientOfFrictionMethods

    @classmethod
    def implicit_type(cls) -> "_1083.ScuffingCoefficientOfFrictionMethods.type_()":
        ...
        return _1083.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: Self) -> "_1083.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1083.ScuffingCoefficientOfFrictionMethods]":

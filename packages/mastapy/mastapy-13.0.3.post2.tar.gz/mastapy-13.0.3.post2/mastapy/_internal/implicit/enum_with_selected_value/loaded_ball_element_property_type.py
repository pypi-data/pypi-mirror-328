...
from mastapy.bearings.bearing_results import _1982
...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1982.LoadedBallElementPropertyType":
        ...
        return _1982.LoadedBallElementPropertyType

    @classmethod
    def implicit_type(cls) -> "_1982.LoadedBallElementPropertyType.type_()":
        ...
        return _1982.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: Self) -> "_1982.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: Self) -> "List[_1982.LoadedBallElementPropertyType]":

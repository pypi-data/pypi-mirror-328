...
class EnumWithSelectedValue_CandidateDisplayChoice(
    ...
    @classmethod
    def wrapped_type(cls) -> "_906.CandidateDisplayChoice":
        ...
        return _906.CandidateDisplayChoice

    @classmethod
    def implicit_type(cls) -> "_906.CandidateDisplayChoice.type_()":
        ...
        return _906.CandidateDisplayChoice.type_()

    @property
    def selected_value(self: Self) -> "_906.CandidateDisplayChoice":
    ...
    @property
    def available_values(self: Self) -> "List[_906.CandidateDisplayChoice]":

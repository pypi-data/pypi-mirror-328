...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2383.BearingNodeOption":
        ...
        return _2383.BearingNodeOption

    @classmethod
    def implicit_type(cls) -> "_2383.BearingNodeOption.type_()":
        ...
        return _2383.BearingNodeOption.type_()

    @property
    def selected_value(self: Self) -> "_2383.BearingNodeOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2383.BearingNodeOption]":

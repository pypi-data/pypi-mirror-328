...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2239.PowerLoadType":
        ...
        return _2239.PowerLoadType

    @classmethod
    def implicit_type(cls) -> "_2239.PowerLoadType.type_()":
        ...
        return _2239.PowerLoadType.type_()

    @property
    def selected_value(self: Self) -> "_2239.PowerLoadType":
    ...
    @property
    def available_values(self: Self) -> "List[_2239.PowerLoadType]":

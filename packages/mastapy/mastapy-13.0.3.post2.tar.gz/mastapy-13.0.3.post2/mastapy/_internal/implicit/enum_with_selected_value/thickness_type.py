...
class EnumWithSelectedValue_ThicknessType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1091.ThicknessType":
        ...
        return _1091.ThicknessType

    @classmethod
    def implicit_type(cls) -> "_1091.ThicknessType.type_()":
        ...
        return _1091.ThicknessType.type_()

    @property
    def selected_value(self: Self) -> "_1091.ThicknessType":
    ...
    @property
    def available_values(self: Self) -> "List[_1091.ThicknessType]":

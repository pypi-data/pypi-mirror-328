...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1400.HarmonicLoadDataType":
        ...
        return _1400.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1400.HarmonicLoadDataType.type_()":
        ...
        return _1400.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1400.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1400.HarmonicLoadDataType]":

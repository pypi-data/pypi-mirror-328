...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1197.AGMAGleasonConicalGearGeometryMethods":
        ...
        return _1197.AGMAGleasonConicalGearGeometryMethods

    @classmethod
    def implicit_type(cls) -> "_1197.AGMAGleasonConicalGearGeometryMethods.type_()":
        ...
        return _1197.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: Self) -> "_1197.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1197.AGMAGleasonConicalGearGeometryMethods]":

...
from mastapy.gears.gear_designs.conical import _1176
...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1176.ConicalManufactureMethods":
        ...
        return _1176.ConicalManufactureMethods

    @classmethod
    def implicit_type(cls) -> "_1176.ConicalManufactureMethods.type_()":
        ...
        return _1176.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: Self) -> "_1176.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1176.ConicalManufactureMethods]":

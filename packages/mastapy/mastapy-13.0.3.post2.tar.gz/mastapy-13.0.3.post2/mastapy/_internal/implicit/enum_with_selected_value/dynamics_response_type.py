...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4648.DynamicsResponseType":
        ...
        return _4648.DynamicsResponseType

    @classmethod
    def implicit_type(cls) -> "_4648.DynamicsResponseType.type_()":
        ...
        return _4648.DynamicsResponseType.type_()

    @property
    def selected_value(self: Self) -> "_4648.DynamicsResponseType":
    ...
    @property
    def available_values(self: Self) -> "List[_4648.DynamicsResponseType]":

...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1891.BasicStaticLoadRatingCalculationMethod":
        ...
        return _1891.BasicStaticLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1891.BasicStaticLoadRatingCalculationMethod.type_()":
        ...
        return _1891.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1891.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1891.BasicStaticLoadRatingCalculationMethod]":

...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1986.BallBearingAnalysisMethod":
        ...
        return _1986.BallBearingAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_1986.BallBearingAnalysisMethod.type_()":
        ...
        return _1986.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: Self) -> "_1986.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1986.BallBearingAnalysisMethod]":

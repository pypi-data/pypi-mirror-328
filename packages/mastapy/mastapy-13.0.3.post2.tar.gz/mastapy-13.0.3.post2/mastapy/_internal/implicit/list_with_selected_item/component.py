...
class ListWithSelectedItem_Component(_2464.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2464.Component.TYPE":
        ...
        return _2464.Component.TYPE

    @property
    def selected_value(self: Self) -> "_2464.Component":
    ...
    @property
    def available_values(self: Self) -> "List[_2464.Component]":

...
class ListWithSelectedItem_FESubstructure(
    _2403.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2403.FESubstructure.TYPE":
        ...
        return _2403.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2403.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2403.FESubstructure]":

...
class ListWithSelectedItem_FEPart(_2473.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2473.FEPart.TYPE":
        ...
        return _2473.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2473.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2473.FEPart]":

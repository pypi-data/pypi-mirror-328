...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5872
...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5872.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5872.ResultLocationSelectionGroup.TYPE":
        ...
        return _5872.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_5872.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_5872.ResultLocationSelectionGroup]":

...
class ListWithSelectedItem_Unit(_1628.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1628.Unit.TYPE":
        ...
        return _1628.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1628.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1628.Unit]":

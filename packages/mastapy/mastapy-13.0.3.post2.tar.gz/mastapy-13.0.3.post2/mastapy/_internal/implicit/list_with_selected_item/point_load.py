...
class ListWithSelectedItem_PointLoad(_2491.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2491.PointLoad.TYPE":
        ...
        return _2491.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2491.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2491.PointLoad]":

...
class ListWithSelectedItem_CylindricalGearSet(
    _2546.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2546.CylindricalGearSet.TYPE":
        ...
        return _2546.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2546.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2546.CylindricalGearSet]":

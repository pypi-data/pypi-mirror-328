...
from mastapy.utility import _1618
...
class ListWithSelectedItem_SystemDirectory(
    _1618.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1618.SystemDirectory.TYPE":
        ...
        return _1618.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1618.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1618.SystemDirectory]":

...
class ListWithSelectedItem_CylindricalGear(
    _2545.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2545.CylindricalGear.TYPE":
        ...
        return _2545.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2545.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2545.CylindricalGear]":

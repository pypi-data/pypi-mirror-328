...
class ListWithSelectedItem_StaticLoadCase(
    _6826.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6826.StaticLoadCase.TYPE":
        ...
        return _6826.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6826.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6826.StaticLoadCase]":

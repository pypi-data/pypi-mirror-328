...
class ListWithSelectedItem_ElectricMachineSetup(
    _1284.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1284.ElectricMachineSetup.TYPE":
        ...
        return _1284.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1284.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1284.ElectricMachineSetup]":

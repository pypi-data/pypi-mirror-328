...
class ListWithSelectedItem_PowerLoad(_2492.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2492.PowerLoad.TYPE":
        ...
        return _2492.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2492.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2492.PowerLoad]":

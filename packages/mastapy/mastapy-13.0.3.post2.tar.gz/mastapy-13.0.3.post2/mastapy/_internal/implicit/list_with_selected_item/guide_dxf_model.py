...
class ListWithSelectedItem_GuideDxfModel(
    _2475.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2475.GuideDxfModel.TYPE":
        ...
        return _2475.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2475.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2475.GuideDxfModel]":

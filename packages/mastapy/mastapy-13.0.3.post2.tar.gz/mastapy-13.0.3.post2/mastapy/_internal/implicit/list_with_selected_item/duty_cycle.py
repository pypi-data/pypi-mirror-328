...
class ListWithSelectedItem_DutyCycle(_5685.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5685.DutyCycle.TYPE":
        ...
        return _5685.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5685.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5685.DutyCycle]":

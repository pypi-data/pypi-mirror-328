...
class ListWithSelectedItem_FELink(_2438.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2438.FELink.TYPE":
        ...
        return _2438.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2438.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2438.FELink]":

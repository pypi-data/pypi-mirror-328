...
class ListWithSelectedItem_MeasurementBase(
    _1623.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1623.MeasurementBase.TYPE":
        ...
        return _1623.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1623.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1623.MeasurementBase]":

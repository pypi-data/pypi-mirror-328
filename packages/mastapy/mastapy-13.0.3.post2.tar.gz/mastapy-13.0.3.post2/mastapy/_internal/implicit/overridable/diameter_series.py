...
class Overridable_DiameterSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2171.DiameterSeries":
        ...
        return _2171.DiameterSeries

    @classmethod
    def implicit_type(cls) -> "_2171.DiameterSeries.type_()":
        ...
        return _2171.DiameterSeries.type_()

    @property
    def value(self: Self) -> "_2171.DiameterSeries":
    ...
    @property
    def override_value(self: Self) -> "_2171.DiameterSeries":
        """mastapy.bearings.bearing_designs.rolling.DiameterSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2171.DiameterSeries":
        """mastapy.bearings.bearing_designs.rolling.DiameterSeries

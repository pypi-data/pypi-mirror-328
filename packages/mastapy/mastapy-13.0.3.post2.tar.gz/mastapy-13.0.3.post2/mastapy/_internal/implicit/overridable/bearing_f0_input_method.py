...
class Overridable_BearingF0InputMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2460.BearingF0InputMethod":
        ...
        return _2460.BearingF0InputMethod

    @classmethod
    def implicit_type(cls) -> "_2460.BearingF0InputMethod.type_()":
        ...
        return _2460.BearingF0InputMethod.type_()

    @property
    def value(self: Self) -> "_2460.BearingF0InputMethod":
    ...
    @property
    def override_value(self: Self) -> "_2460.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod
    ...
    @property
    def calculated_value(self: Self) -> "_2460.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod

...
if TYPE_CHECKING:
    from mastapy.utility_gui import _1869
...
class DataLoggerWithCharts(_1593.DataLogger):
    """DataLoggerWithCharts
    ...
    class _Cast_DataLoggerWithCharts:
        ...
        def data_logger(
            ...
            return self._parent._cast(_1593.DataLogger)
    ...
    @property
    def logged_items(self: Self) -> "List[_1869.DataLoggerItem]":

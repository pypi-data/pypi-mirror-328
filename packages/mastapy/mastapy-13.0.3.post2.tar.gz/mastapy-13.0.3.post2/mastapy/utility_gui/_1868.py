...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2578
...
class DataInputFileOptions(_0.APIBase):
    ...
    class _Cast_DataInputFileOptions:
        ...
        def rotor_set_data_input_file_options(
            ...
            return self._parent._cast(_2578.RotorSetDataInputFileOptions)
        ...
        def multi_time_series_data_input_file_options(
            ...
            return self._parent._cast(_7018.MultiTimeSeriesDataInputFileOptions)

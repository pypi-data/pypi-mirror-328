...
class AssemblyCompoundDynamicAnalysis(_6429.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6305.AssemblyDynamicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_6437.BearingCompoundDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6439.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6442.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6449.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6448.BoltCompoundDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6470.CVTCompoundDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6450.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6455.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6460.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6472.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6474.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6478.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6485.FEPartCompoundDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6484.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6486.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6493.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6500.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6503.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_6504.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6505.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6507.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6509.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6514.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6515.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6516.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6518.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6520.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6525.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6524.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6530.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6531.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6536.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6539.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6542.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6546.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6550.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6554.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6557.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6305.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]

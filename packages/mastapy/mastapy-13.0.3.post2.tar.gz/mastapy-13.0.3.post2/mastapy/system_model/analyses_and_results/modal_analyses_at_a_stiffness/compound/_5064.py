...
class FaceGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4934.FaceGearSetModalAnalysisAtAStiffness]":
    ...
    def face_gears_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5062.FaceGearCompoundModalAnalysisAtAStiffness]":
    ...
    def face_meshes_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5063.FaceGearMeshCompoundModalAnalysisAtAStiffness]":

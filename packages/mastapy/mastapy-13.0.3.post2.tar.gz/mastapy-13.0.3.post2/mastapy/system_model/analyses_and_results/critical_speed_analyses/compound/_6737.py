...
class CVTCompoundCriticalSpeedAnalysis(_6706.BeltDriveCompoundCriticalSpeedAnalysis):
    """CVTCompoundCriticalSpeedAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6608.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6608.CVTCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.CVTCriticalSpeedAnalysis]

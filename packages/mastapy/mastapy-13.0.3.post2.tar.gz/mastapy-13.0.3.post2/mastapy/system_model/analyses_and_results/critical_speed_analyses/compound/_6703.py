...
class AssemblyCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6571.AssemblyCriticalSpeedAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_6704.BearingCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6706.BeltDriveCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6709.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_6716.BoltedJointCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6715.BoltCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6737.CVTCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6717.ClutchCompoundCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6722.ConceptCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6727.ConceptGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6739.CycloidalAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6741.CycloidalDiscCompoundCriticalSpeedAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6745.CylindricalGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6752.FEPartCompoundCriticalSpeedAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6751.FaceGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6753.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6760.HypoidGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_6767.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6770.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6771.MassDiscCompoundCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6772.MeasurementComponentCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6774.OilSealCompoundCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6776.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6781.PlanetCarrierCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6782.PointLoadCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6783.PowerLoadCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6785.RingPinsCompoundCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6787.RollingRingAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6792.ShaftHubConnectionCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6791.ShaftCompoundCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6797.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6798.SpringDamperCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6803.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6806.StraightBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6809.SynchroniserCompoundCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6813.TorqueConverterCompoundCriticalSpeedAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6817.UnbalancedMassCompoundCriticalSpeedAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6821.WormGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6824.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]":

...
class AssemblyCriticalSpeedAnalysis(_6564.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6572.BearingCriticalSpeedAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6574.BeltDriveCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6577.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6584.BoltedJointCriticalSpeedAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6583.BoltCriticalSpeedAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6608.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6586.ClutchCriticalSpeedAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6612.CycloidalDiscCriticalSpeedAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6623.FEPartCriticalSpeedAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6622.FaceGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6642.MassDiscCriticalSpeedAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6645.OilSealCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6648.PartToPartShearCouplingCriticalSpeedAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6652.PlanetCarrierCriticalSpeedAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6653.PointLoadCriticalSpeedAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6654.PowerLoadCriticalSpeedAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6656.RingPinsCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6663.ShaftHubConnectionCriticalSpeedAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6662.ShaftCriticalSpeedAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6670.SpringDamperCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6677.StraightBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6680.SynchroniserCriticalSpeedAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6692.WormGearSetCriticalSpeedAnalysis]":

...
if TYPE_CHECKING:
    ...
    from mastapy.utility import _1617
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: Self) -> "_6560.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: Self) -> "_6563.MASTAFileDetails":
    ...
    @property
    def working_folder(self: Self) -> "_1617.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: Self,
    ) -> "List[_6562.ExcelSheetDesignStateSelector]":

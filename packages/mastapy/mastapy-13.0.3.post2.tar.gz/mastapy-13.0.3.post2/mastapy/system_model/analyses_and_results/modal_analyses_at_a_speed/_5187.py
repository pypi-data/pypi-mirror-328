...
class CylindricalGearSetModalAnalysisAtASpeed(_5198.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    def cylindrical_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5186.CylindricalGearModalAnalysisAtASpeed]":
    ...
    def cylindrical_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5185.CylindricalGearMeshModalAnalysisAtASpeed]":

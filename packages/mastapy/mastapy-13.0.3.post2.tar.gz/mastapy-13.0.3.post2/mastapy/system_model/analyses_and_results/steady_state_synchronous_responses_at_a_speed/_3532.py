...
class AssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3544.BoltedJointSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_3545.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3567.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3548.ClutchSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3553.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3555.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3573.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3579.FaceGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3582.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3595.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3603.OilSealSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3607.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3610.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3612.PowerLoadSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3614.RingPinsSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3616.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_3621.ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3629.SpringDamperSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3632.StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3635.StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3645.TorqueConverterSteadyStateSynchronousResponseAtASpeed]":

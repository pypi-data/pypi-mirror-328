...
class ShaftHubConnectionSystemDeflection(_2749.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1454.ShaftHubConnectionRating":
    ...
    @property
    def power_flow_results(self: Self) -> "_4153.ShaftHubConnectionPowerFlow":
    ...
    @property
    def left_flank_contacts(self: Self) -> "List[_2871.SplineFlankContactReporting]":
    ...
    @property
    def right_flank_contacts(self: Self) -> "List[_2871.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
    ...
    @property
    def tip_contacts(self: Self) -> "List[_2871.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]

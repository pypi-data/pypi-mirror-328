...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: Self) -> "_2719.BearingSystemDeflection":
    ...
    def bearing_results(
        self: Self,
    ) -> "List[_2717.BearingDynamicResultsPropertyWrapper]":
    ...
    @property
    def cage_results(self: Self) -> "List[_2717.BearingDynamicResultsPropertyWrapper]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingDynamicResultsPropertyWrapper]
    ...
    def element_results(
        self: Self,
    ) -> "List[_2715.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: Self,
    ) -> "List[_2716.BearingDynamicPostAnalysisResultWrapper]":

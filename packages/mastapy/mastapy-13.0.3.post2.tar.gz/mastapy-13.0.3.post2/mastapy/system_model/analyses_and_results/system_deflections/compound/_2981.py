...
class StraightBevelDiffGearSetCompoundSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2835.StraightBevelDiffGearSetSystemDeflection]":
    ...
    def straight_bevel_diff_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2979.StraightBevelDiffGearCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2980.StraightBevelDiffGearMeshCompoundSystemDeflection]":

...
class FaceGearSetCompoundSystemDeflection(_2933.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def face_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2926.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2927.FaceGearMeshCompoundSystemDeflection]":

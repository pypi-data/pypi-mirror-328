...
if TYPE_CHECKING:
    ...
    from mastapy.gears.analysis import _1249, _1246
...
class GearSetSystemDeflection(_2827.SpecialisedAssemblySystemDeflection):
    """GearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4116.GearSetPowerFlow":
    ...
    def analysis_for(
        self: Self,
        gear_set_imp_detail: "_1249.GearSetImplementationDetail",
    ...
    def perform_implementation_detail_analysis_with_progress(
        self: Self,
        imp_detail: "_1249.GearSetImplementationDetail",
        gear_set_mode: "_332.GearSetModes",

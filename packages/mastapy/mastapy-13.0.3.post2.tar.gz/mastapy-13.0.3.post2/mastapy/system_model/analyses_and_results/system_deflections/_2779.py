...
class FlexiblePinAssemblySystemDeflection(_2827.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def flexible_pin_shaft_details(self: Self) -> "_2825.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: Self) -> "_2825.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4113.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: Self) -> "_2825.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: Self) -> "List[_2719.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: Self,
    ) -> "List[_2799.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: Self,
    ) -> "List[_2804.ObservedPinStiffnessReporter]":

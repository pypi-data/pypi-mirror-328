...
class StraightBevelSunGearSystemDeflection(_2836.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4170.StraightBevelSunGearPowerFlow":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3908
...
class TorqueConverterCompoundStabilityAnalysis(_3955.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3908.TorqueConverterStabilityAnalysis]":

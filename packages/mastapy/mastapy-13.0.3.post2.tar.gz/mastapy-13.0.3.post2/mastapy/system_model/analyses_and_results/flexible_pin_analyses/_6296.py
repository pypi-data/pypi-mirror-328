...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6290
...
class FlexiblePinAnalysisStopStartAnalysis(_6290.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    class _Cast_FlexiblePinAnalysisStopStartAnalysis:
        ...
        def flexible_pin_analysis(
            ...
            return self._parent._cast(_6290.FlexiblePinAnalysis)
    ...
    @property
    def shaft_extreme_load_case(self: Self) -> "_2825.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: Self) -> "_2825.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection

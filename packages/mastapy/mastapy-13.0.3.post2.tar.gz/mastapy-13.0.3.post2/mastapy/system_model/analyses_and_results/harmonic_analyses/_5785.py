...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5773, _5832
...
class HarmonicAnalysisFEExportOptions(
    _5784.HarmonicAnalysisExportOptions[
        "_2675.IHaveFEPartHarmonicAnalysisResults", "_2473.FEPart"
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    class _Cast_HarmonicAnalysisFEExportOptions:
        ...
        def harmonic_analysis_export_options(
            ...
            return self._parent._cast(_5784.HarmonicAnalysisExportOptions)
    ...
    @enforce_parameter_types
    def distance_unit(self: Self, value: "_1628.Unit"):
    ...
    @enforce_parameter_types
    def element_face_group_to_export(self: Self, value: "_227.CMSElementFaceGroup"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def fe_export_format(self: Self, value: "_169.FEExportFormat"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: Self, value: "_1628.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )

...
class AssemblyCompoundHarmonicAnalysis(_5900.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5707.AssemblyHarmonicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_5908.BearingCompoundHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5910.BeltDriveCompoundHarmonicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5913.BevelDifferentialGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5920.BoltedJointCompoundHarmonicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5919.BoltCompoundHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5941.CVTCompoundHarmonicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5921.ClutchCompoundHarmonicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5926.ConceptCouplingCompoundHarmonicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5931.ConceptGearSetCompoundHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5943.CycloidalAssemblyCompoundHarmonicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5945.CycloidalDiscCompoundHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5949.CylindricalGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5956.FEPartCompoundHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5955.FaceGearSetCompoundHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5957.FlexiblePinAssemblyCompoundHarmonicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5964.HypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5971.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_5974.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_5975.MassDiscCompoundHarmonicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5976.MeasurementComponentCompoundHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5978.OilSealCompoundHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5980.PartToPartShearCouplingCompoundHarmonicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5985.PlanetCarrierCompoundHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5986.PointLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5987.PowerLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5989.RingPinsCompoundHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5991.RollingRingAssemblyCompoundHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5996.ShaftHubConnectionCompoundHarmonicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5995.ShaftCompoundHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6001.SpiralBevelGearSetCompoundHarmonicAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6002.SpringDamperCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6007.StraightBevelDiffGearSetCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6010.StraightBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6013.SynchroniserCompoundHarmonicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6017.TorqueConverterCompoundHarmonicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6021.UnbalancedMassCompoundHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6025.WormGearSetCompoundHarmonicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6028.ZerolBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5707.AssemblyHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.AssemblyHarmonicAnalysis]

...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    class _Cast_FEPartHarmonicAnalysisResultsPropertyAccessor:
        ...
        def harmonic_analysis_results_property_accessor(
            ...
            return self._parent._cast(_5886.HarmonicAnalysisResultsPropertyAccessor)
    ...
    @property
    def combined_orders(self: Self) -> "_5888.ResultsForMultipleOrdersForFESurface":
    ...
    def excitations(
        self: Self,
    ) -> "List[_5879.FEPartSingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: Self,
    ) -> "List[_5893.ResultsForOrderIncludingSurfaces]":

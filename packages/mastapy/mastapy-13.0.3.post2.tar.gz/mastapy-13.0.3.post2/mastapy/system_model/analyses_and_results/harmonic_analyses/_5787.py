...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    class _Cast_HarmonicAnalysisOptions:
        ...
        def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
            ...
            "_7094.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation"
        ):
            from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
                _7094,
            )
    ...
    @property
    def response_cache_level(self: Self) -> "_5820.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses._5820",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: Self, value: "_5820.ResponseCacheLevel"):
    ...
    @property
    def excitation_selection(self: Self) -> "_5868.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: Self) -> "_4678.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: Self) -> "_5839.StiffnessOptionsForHarmonicAnalysis":

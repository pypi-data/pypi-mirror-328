...
class StiffnessOptionsForHarmonicAnalysis(
    _7557.AbstractAnalysisOptions["_6826.StaticLoadCase"]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(self: Self, value: "_5790.HarmonicAnalysisTorqueInputType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_speed_curve(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: Self, value: "_1553.Vector2DListAccessor"):

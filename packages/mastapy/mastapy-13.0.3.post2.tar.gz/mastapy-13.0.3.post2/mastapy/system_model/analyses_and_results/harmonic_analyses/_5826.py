...
class RootAssemblyHarmonicAnalysis(
    _5707.AssemblyHarmonicAnalysis, _2676.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: Self) -> "_5788.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: Self) -> "_5782.HarmonicAnalysis":

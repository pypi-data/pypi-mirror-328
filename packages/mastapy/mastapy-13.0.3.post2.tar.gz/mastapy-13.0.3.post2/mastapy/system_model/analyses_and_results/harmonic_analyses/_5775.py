...
class GearMeshExcitationDetail(_5700.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def gear_mesh(self: Self) -> "_2780.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5725.ComplianceAndForceData":

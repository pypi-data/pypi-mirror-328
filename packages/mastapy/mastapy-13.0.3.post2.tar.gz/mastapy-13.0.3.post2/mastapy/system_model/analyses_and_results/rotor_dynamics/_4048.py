...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1623.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1623.MeasurementBase")
...
class ShaftComplexShape(_0.APIBase, Generic[TLinearMeasurement, TAngularMeasurement]):
    ...
    class _Cast_ShaftComplexShape:
        ...
        def shaft_forced_complex_shape(
            ...
            return self._parent._cast(_4049.ShaftForcedComplexShape)

        @property
        def shaft_modal_complex_shape(
            self: "ShaftComplexShape._Cast_ShaftComplexShape",
        ) -> "_4050.ShaftModalComplexShape":
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4050

            return self._parent._cast(_4050.ShaftModalComplexShape)

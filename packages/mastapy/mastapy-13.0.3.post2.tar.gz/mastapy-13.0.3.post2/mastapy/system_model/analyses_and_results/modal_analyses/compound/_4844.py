...
class ShaftCompoundModalAnalysis(_4750.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4700.ShaftModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4700.ShaftModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ShaftModalAnalysis]

...
from mastapy.system_model.analyses_and_results.modal_analyses import _4647, _4648
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.math_utility import _1513, _1545
...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility import _1552, _1538
    from mastapy.math_utility.measured_data_scaling import _1587
    from mastapy.system_model.analyses_and_results.harmonic_analyses import (
        _5773,
        _5787,
        _5832,
    )
    from mastapy.system_model.drawing.options import _2283, _2281
    from mastapy.utility.property import _1863
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: Self, value: "_4647.DynamicsResponse3DChartType"):
    ...
    @enforce_parameter_types
    def complex_component(self: Self, value: "_1513.ComplexPartDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def connected_component_type(self: Self) -> "_5865.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5865",
            "ConnectedComponentType",
        )(value)

    @connected_component_type.setter
    @enforce_parameter_types
    def connected_component_type(self: Self, value: "_5865.ConnectedComponentType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
        )
    ...
    @property
    def coordinate_system(self: Self) -> "_4630.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4630",
            "CoordinateSystemForWhine",
        )(value)

    @coordinate_system.setter
    @enforce_parameter_types
    def coordinate_system(self: Self, value: "_4630.CoordinateSystemForWhine"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
        )
    ...
    @enforce_parameter_types
    def response_type(self: Self, value: "_4648.DynamicsResponseType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def speed_range_for_combining_excitations(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4680",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: Self, value: "_4680.MultipleExcitationsSpeedRangeOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    def translation_or_rotation(self: Self) -> "_1552.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1552", "TranslationRotation"
        )(value)

    @translation_or_rotation.setter
    @enforce_parameter_types
    def translation_or_rotation(self: Self, value: "_1552.TranslationRotation"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def vector_magnitude_method(self: Self) -> "_1538.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1538", "ComplexMagnitudeMethod"
        )(value)

    @vector_magnitude_method.setter
    @enforce_parameter_types
    def vector_magnitude_method(self: Self, value: "_1538.ComplexMagnitudeMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def whine_waterfall_export_option(self: Self) -> "_4729.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4729",
    ...
    def whine_waterfall_export_option(
        self: Self, value: "_4729.WhineWaterfallExportOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    def data_scaling(self: Self) -> "_1587.DataScalingOptions":
    ...
    @property
    def order_cuts_chart_settings(self: Self) -> "_4682.OrderCutsChartSettings":
    ...
    @property
    def selected_excitations(self: Self) -> "_5868.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: Self) -> "_4728.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: Self) -> "List[_5874.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: Self,
    ) -> "List[_1863.EnumWithBoolean[_1545.ResultOptionsFor3DVector]]":

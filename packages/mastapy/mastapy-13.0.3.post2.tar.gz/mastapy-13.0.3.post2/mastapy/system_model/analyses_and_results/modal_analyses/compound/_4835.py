...
class PointLoadCompoundModalAnalysis(_4871.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4690.PointLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4690.PointLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PointLoadModalAnalysis]

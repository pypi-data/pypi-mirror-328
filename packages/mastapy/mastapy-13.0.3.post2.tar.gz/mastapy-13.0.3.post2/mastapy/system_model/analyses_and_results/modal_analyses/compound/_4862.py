...
class SynchroniserCompoundModalAnalysis(_4847.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4719.SynchroniserModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4719.SynchroniserModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.SynchroniserModalAnalysis]

...
class DatumCompoundModalAnalysis(_4774.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4645.DatumModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4645.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]

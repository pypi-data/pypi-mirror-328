...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses import _4678, _4676
...
class ModalAnalysis(_7571.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    class _Cast_ModalAnalysis:
        ...
        @property
        def context(self: "ModalAnalysis._Cast_ModalAnalysis") -> "_2671.Context":
            from mastapy.system_model.analyses_and_results import _2671
    ...
    @property
    def analysis_settings(self: Self) -> "_4678.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: Self) -> "_4676.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: Self) -> "_6350.DynamicAnalysis":

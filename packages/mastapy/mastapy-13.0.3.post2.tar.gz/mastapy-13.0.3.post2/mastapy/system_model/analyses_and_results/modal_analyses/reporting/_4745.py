...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis import _1814
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2673.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: Self,
    ) -> "List[_1814.DesignEntityExcitationDescription]":

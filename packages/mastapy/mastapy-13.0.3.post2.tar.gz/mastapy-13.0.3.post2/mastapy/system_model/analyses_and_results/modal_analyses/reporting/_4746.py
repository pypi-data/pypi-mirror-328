...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4739
...
class ShaftPerModeResult(_4739.ComponentPerModeResult):
    """ShaftPerModeResult
    ...
    class _Cast_ShaftPerModeResult:
        ...
        def component_per_mode_result(
            ...
            return self._parent._cast(_4739.ComponentPerModeResult)

...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4744
...
class SingleModeResults(_4740.DesignEntityModalAnalysisGroupResults):
    """SingleModeResults
    ...
    def all_rigidly_connected_groups(
        self: Self,
    ) -> "List[_4744.RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis]":

...
class WormGearSetModalAnalysis(_4658.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self: Self) -> "List[_4732.WormGearModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4731.WormGearMeshModalAnalysis]":

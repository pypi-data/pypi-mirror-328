...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4740
...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4743
...
class SingleExcitationResultsModalAnalysis(_4740.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def design_entity_modal_analysis_group_results(
            ...
            return self._parent._cast(_4740.DesignEntityModalAnalysisGroupResults)
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4743.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):

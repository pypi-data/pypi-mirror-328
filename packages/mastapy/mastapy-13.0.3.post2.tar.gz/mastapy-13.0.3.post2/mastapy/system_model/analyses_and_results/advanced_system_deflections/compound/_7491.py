...
class HypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7360.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def hypoid_gears_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7489.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_meshes_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7490.HypoidGearMeshCompoundAdvancedSystemDeflection]":

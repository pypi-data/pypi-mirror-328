...
class ConceptGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7325.ConceptGearSetAdvancedSystemDeflection]":
    ...
    def concept_gears_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7456.ConceptGearCompoundAdvancedSystemDeflection]":
    ...
    def concept_meshes_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7457.ConceptGearMeshCompoundAdvancedSystemDeflection]":

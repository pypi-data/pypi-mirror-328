...
class AssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7301.AssemblyAdvancedSystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_7435.BearingCompoundAdvancedSystemDeflection]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7437.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7440.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7447.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7446.BoltCompoundAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7468.CVTCompoundAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7448.ClutchCompoundAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7453.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7458.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7470.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7472.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7476.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7483.FEPartCompoundAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7482.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7484.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7491.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7498.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7501.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7502.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7503.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7505.OilSealCompoundAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7507.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7512.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7513.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7514.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7516.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7518.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7523.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7522.ShaftCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7528.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7529.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7534.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7537.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7540.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7544.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7548.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7552.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7555.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":

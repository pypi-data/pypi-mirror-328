...
from mastapy.system_model.analyses_and_results.load_case_groups import _5686
...
class ClutchEngagementStatus(
    _5686.GenericClutchEngagementStatus["_2362.ClutchConnection"]
):
    """ClutchEngagementStatus
    ...
    class _Cast_ClutchEngagementStatus:
        ...
        def generic_clutch_engagement_status(
            ...
            return self._parent._cast(_5686.GenericClutchEngagementStatus)

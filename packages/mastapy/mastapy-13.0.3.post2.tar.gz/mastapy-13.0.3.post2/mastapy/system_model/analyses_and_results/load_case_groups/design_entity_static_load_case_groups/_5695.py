...
TConnection = TypeVar("TConnection", bound="_2292.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_6871.ConnectionLoadCase"
)


class ConnectionStaticLoadCaseGroup(
    _5696.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup

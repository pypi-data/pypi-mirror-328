...
class BearingCompoundParametricStudyTool(_4500.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self: Self) -> "_1968.LoadedBearingDutyCycle":
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6841.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4325.BearingParametricStudyTool]":

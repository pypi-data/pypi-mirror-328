...
class ZerolBevelGearSetPowerFlow(_4071.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4186.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: Self,
    ) -> "List[_4186.ZerolBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4185.ZerolBevelGearMeshPowerFlow]":

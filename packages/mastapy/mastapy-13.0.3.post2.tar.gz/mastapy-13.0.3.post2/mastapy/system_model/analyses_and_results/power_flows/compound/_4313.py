...
class WormGearSetCompoundPowerFlow(_4248.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4184.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4311.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4312.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4184.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]

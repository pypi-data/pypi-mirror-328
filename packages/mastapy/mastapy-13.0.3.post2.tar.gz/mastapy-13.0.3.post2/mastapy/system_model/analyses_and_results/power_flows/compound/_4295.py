...
class StraightBevelDiffGearSetCompoundPowerFlow(_4206.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4293.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4294.StraightBevelDiffGearMeshCompoundPowerFlow]":

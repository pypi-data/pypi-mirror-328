...
class BearingCompoundPowerFlow(_4224.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4061.BearingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4061.BearingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BearingPowerFlow]

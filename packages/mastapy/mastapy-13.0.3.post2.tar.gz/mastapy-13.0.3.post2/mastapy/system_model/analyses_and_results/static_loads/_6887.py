...
class CylindricalGearSetLoadCase(_6917.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    @property
    def reset_micro_geometry(self: Self) -> "_6963.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6963",
            "ResetMicroGeometryOptions",
        )(value)

    @reset_micro_geometry.setter
    @enforce_parameter_types
    def reset_micro_geometry(self: Self, value: "_6963.ResetMicroGeometryOptions"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.ResetMicroGeometryOptions",
        )
    ...
    @property
    def ltca(self: Self) -> "_1069.LTCALoadCaseModifiableSettings":
    ...
    @property
    def gears(self: Self) -> "List[_6883.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: Self,
    ) -> "List[_6883.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    def cylindrical_meshes_load_case(
        self: Self,
    ) -> "List[_6885.CylindricalGearMeshLoadCase]":

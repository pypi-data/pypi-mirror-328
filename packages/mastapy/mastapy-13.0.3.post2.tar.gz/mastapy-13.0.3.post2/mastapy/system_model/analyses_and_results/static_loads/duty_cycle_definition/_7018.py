...
if TYPE_CHECKING:
    from mastapy.utility.file_access_helpers import _1836
...
class MultiTimeSeriesDataInputFileOptions(_1868.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    class _Cast_MultiTimeSeriesDataInputFileOptions:
        ...
        def data_input_file_options(
            ...
            return self._parent._cast(_1868.DataInputFileOptions)
    ...
    @property
    def delimiter_options(self: Self) -> "_1836.TextFileDelimiterOptions":

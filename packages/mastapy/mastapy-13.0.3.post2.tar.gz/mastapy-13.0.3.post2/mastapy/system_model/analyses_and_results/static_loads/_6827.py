...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2660, _2641, _2671
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5482
    from mastapy.system_model.analyses_and_results.load_case_groups import _5692
...
class TimeSeriesLoadCase(_6825.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: Self) -> "_2660.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: Self) -> "_5482.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: Self) -> "_5692.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: Self,
        new_load_case_group: "_5692.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":

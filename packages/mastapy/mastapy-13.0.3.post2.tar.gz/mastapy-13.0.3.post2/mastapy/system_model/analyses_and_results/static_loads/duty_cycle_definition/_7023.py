...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: Self, value: "_7013.DestinationDesignState"
    ):
    ...
    @property
    def force_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def import_type(self: Self) -> "_6930.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6930", "ImportType"
        )(value)

    @import_type.setter
    @enforce_parameter_types
    def import_type(self: Self, value: "_6930.ImportType"):
    ...
    @property
    def moment_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def speed_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def torque_chart(self: Self) -> "_1887.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def design_state_options(self: Self) -> "_7012.DesignStateOptions":
    ...
    @property
    def gear_ratio_options(self: Self) -> "_7015.GearRatioInputOptions":
    ...
    @property
    def load_case_name_inputs(self: Self) -> "_7016.LoadCaseNameOptions":
    ...
    @property
    def time_step_input(self: Self) -> "_7024.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: Self,
    ) -> "List[_7011.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    def file_inputs(self: Self) -> "List[_7018.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    def force_inputs(self: Self) -> "List[_7014.ForceInputOptions]":
    ...
    @property
    def moment_inputs(self: Self) -> "List[_7017.MomentInputOptions]":
    ...
    @property
    def speed_inputs(self: Self) -> "List[_7022.SpeedInputOptions]":
    ...
    @property
    def torque_inputs(self: Self) -> "List[_7025.TorqueInputOptions]":
    ...
    @property
    def columns(self: Self) -> "List[_1835.ColumnTitle]":

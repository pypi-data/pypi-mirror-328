...
class FEPartLoadCase(_6830.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: Self) -> "_2379.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2379", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: Self, value: "_2403.FESubstructure"):
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: Self,
    ) -> "List[_6857.CMSElementFaceGroupWithSelectionOption]":

...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6867, _6884
...
class GearManufactureError(_0.APIBase):
    ...
    class _Cast_GearManufactureError:
        ...
        def conical_gear_manufacture_error(
            ...
            return self._parent._cast(_6867.ConicalGearManufactureError)
        ...
        def cylindrical_gear_manufacture_error(
            ...
            return self._parent._cast(_6884.CylindricalGearManufactureError)

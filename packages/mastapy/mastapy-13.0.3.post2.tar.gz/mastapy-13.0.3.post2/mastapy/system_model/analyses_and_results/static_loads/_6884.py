...
class CylindricalGearManufactureError(_6913.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self: Self) -> "_1553.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_left_flank(self: Self, value: "_1553.Vector2DListAccessor"):
        self.wrapped.PitchErrorsLeftFlank = value.wrapped

    @property
    def pitch_errors_right_flank(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_right_flank(self: Self, value: "_1553.Vector2DListAccessor"):

...
from mastapy.system_model.analyses_and_results.static_loads import _6999, _7003
from mastapy.system_model import _2237
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model import _2236, _2238
    from mastapy.math_utility.measured_data import _1583
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5537
    from mastapy.nodal_analysis.varying_input_components import _100
    from mastapy.system_model.part_model import _2492
    from mastapy.math_utility.control import _1594
...
class PowerLoadLoadCase(_7003.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    def drag_torque_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2236", "PowerLoadDragTorqueSpecificationMethod"
        )(value)

    @drag_torque_specification_method.setter
    @enforce_parameter_types
    def drag_torque_specification_method(
        self: Self, value: "_2236.PowerLoadDragTorqueSpecificationMethod"
    ):
    ...
    @property
    def drag_torque_vs_speed_and_time(self: Self) -> "_1583.GriddedSurfaceAccessor":
    ...
    def drag_torque_vs_speed_and_time(
        self: Self, value: "_1583.GriddedSurfaceAccessor"
    ):
    ...
    @enforce_parameter_types
    def electric_machine_data_set_selector(
        self: Self, value: "_2393.ElectricMachineDataSet"
    ):
        wrapper_type = (
    ...
    @property
    def engine_throttle_time_profile(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def engine_throttle_time_profile(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @property
    def speed_vs_time(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def speed_vs_time(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: Self, value: "_6999.TorqueSpecificationForSystemDeflection"
    ):
    ...
    def target_speed_input_type(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2238", "PowerLoadPIDControlSpeedInputType"
        )(value)

    @target_speed_input_type.setter
    @enforce_parameter_types
    def target_speed_input_type(
        self: Self, value: "_2238.PowerLoadPIDControlSpeedInputType"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def target_speed_vs_time(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def target_speed_vs_time(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @enforce_parameter_types
    def torque_input_method(
        self: Self, value: "_2237.PowerLoadInputTorqueSpecificationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_vs_angle(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_angle(self: Self, value: "_1553.Vector2DListAccessor"):
        self.wrapped.TorqueVsAngle = value.wrapped

    @property
    def torque_vs_angle_and_speed(self: Self) -> "_1583.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_angle_and_speed(self: Self, value: "_1583.GriddedSurfaceAccessor"):
        self.wrapped.TorqueVsAngleAndSpeed = value.wrapped

    @property
    def torque_vs_time(self: Self) -> "_1553.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_time(self: Self, value: "_1553.Vector2DListAccessor"):
    ...
    @property
    def wheel_slip_model(self: Self) -> "_5537.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5537",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: Self, value: "_5537.WheelSlipType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
    ...
    @property
    def pid_control_settings(self: Self) -> "_1594.PIDControlSettings":
        """mastapy.math_utility.control.PIDControlSettings

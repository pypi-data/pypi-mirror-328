...
class BevelDifferentialGearSetLoadCase(_6851.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6844.BevelDifferentialGearLoadCase]":
    ...
    def bevel_differential_gears_load_case(
        self: Self,
    ) -> "List[_6844.BevelDifferentialGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelDifferentialGearLoadCase]
    ...
    def bevel_differential_meshes_load_case(
        self: Self,
    ) -> "List[_6845.BevelDifferentialGearMeshLoadCase]":

...
class FaceGearSetLoadCase(_6917.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6906.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: Self) -> "List[_6906.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def face_meshes_load_case(self: Self) -> "List[_6907.FaceGearMeshLoadCase]":

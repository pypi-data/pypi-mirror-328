...
class RootAssemblyLoadCase(_6840.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: Self) -> "_1594.PIDControlSettings":
    ...
    @property
    def supercharger_rotor_sets(self: Self) -> "List[_6887.CylindricalGearSetLoadCase]":

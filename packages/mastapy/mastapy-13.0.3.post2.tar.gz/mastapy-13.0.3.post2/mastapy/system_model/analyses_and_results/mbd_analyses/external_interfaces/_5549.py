...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self: Self) -> "_5468.InputSignalFilterLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5468",
            "InputSignalFilterLevel",
        )(value)

    @input_signal_filter_level.setter
    @enforce_parameter_types
    def input_signal_filter_level(self: Self, value: "_5468.InputSignalFilterLevel"):

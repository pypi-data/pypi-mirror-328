...
class PulleyMultibodyDynamicsAnalysis(_5438.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self: Self) -> "List[_5547.DynamicTorqueResultAtTime]":

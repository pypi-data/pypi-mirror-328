...
class WormGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5540.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def worm_gears_compound_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5673.WormGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_meshes_compound_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5674.WormGearMeshCompoundMultibodyDynamicsAnalysis]":

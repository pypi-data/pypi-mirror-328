...
class MBDRunUpAnalysisOptions(
    _7557.AbstractAnalysisOptions["_6827.TimeSeriesLoadCase"]
):
    """MBDRunUpAnalysisOptions
    ...
    class _Cast_MBDRunUpAnalysisOptions:
        ...
        def abstract_analysis_options(
            ...
            return self._parent._cast(_7557.AbstractAnalysisOptions)
    ...
    def input_velocity_processing_type(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5469",
    ...
    def input_velocity_processing_type(
        self: Self, value: "_5469.InputVelocityForRunUpProcessingType"
    ):
    ...
    @property
    def run_up_driving_mode(self: Self) -> "_5504.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5504",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: Self, value: "_5504.RunUpDrivingMode"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: Self, value: "_5509.ShapeOfInitialAccelerationPeriodForRunUp"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",

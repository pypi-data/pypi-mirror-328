...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3366.SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: Self,
    ) -> "List[_3495.SpiralBevelGearCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        "List[_3496.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.drawing import _2267, _2277, _2278
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    class _Cast_RotorDynamicsViewable:
        ...
        def critical_speed_analysis_viewable(
            ...
            return self._parent._cast(_2267.CriticalSpeedAnalysisViewable)

        @property
        def stability_analysis_viewable(
            self: "RotorDynamicsViewable._Cast_RotorDynamicsViewable",
        ) -> "_2277.StabilityAnalysisViewable":
            from mastapy.system_model.drawing import _2277

            return self._parent._cast(_2277.StabilityAnalysisViewable)
        ...
        def steady_state_synchronous_response_viewable(
            ...
            return self._parent._cast(_2278.SteadyStateSynchronousResponseViewable)
    ...
    @property
    def rotor_dynamics(self: Self) -> "_4047.RotorDynamicsDrawStyle":

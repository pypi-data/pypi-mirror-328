...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5700, _5791
from mastapy._internal import constructor, enum_with_selected_value_runtime, conversion
from mastapy.math_utility import _1547
from mastapy.system_model.analyses_and_results.system_deflections import _2780
from mastapy.system_model.drawing.options import _2282
...
class HarmonicAnalysisViewable(_2268.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    class _Cast_HarmonicAnalysisViewable:
        ...
        def dynamic_analysis_viewable(
            ...
            return self._parent._cast(_2268.DynamicAnalysisViewable)
    ...
    def excitation(self: Self, value: "_5700.AbstractPeriodicExcitationDetail"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: Self, value: "_5791.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ):
        wrapper_type = (
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: Self, value: "_1547.RoundedOrder"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: Self, value: "_2780.GearMeshSystemDeflection"):
        wrapper_type = (
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: Self, value: "_2282.ExcitationAnalysisViewOption"):

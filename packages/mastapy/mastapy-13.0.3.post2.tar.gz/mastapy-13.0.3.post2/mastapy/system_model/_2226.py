...
from mastapy.system_model.part_model import _2491, _2492
...
if TYPE_CHECKING:
    from mastapy.system_model import _2227, _2231
...
class DutyCycleImporter(_0.APIBase):
    ...
    def design_state_destinations(
        self: Self,
    ) -> "List[_2227.DutyCycleImporterDesignEntityMatch[_5684.DesignState]]":
    ...
    @property
    def duty_cycles_to_import(self: Self) -> "List[_2231.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: Self,
    ) -> "List[_2227.DutyCycleImporterDesignEntityMatch[_2491.PointLoad]]":
    ...
    def power_load_destinations(
        self: Self,
    ) -> "List[_2227.DutyCycleImporterDesignEntityMatch[_2492.PowerLoad]]":

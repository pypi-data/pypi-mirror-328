...
from mastapy.system_model.part_model import _2492, _2495
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1866
    from mastapy.gears import _325, _331
    from mastapy.system_model import _2243, _2244, _2228, _2225, _2242, _2232
    ...
    from mastapy.utility import _1600, _1601
    from mastapy.gears.materials import _601
    from mastapy.shafts import _35
    from mastapy.system_model.optimization.system_optimiser import _2260, _2259
    from mastapy.system_model.part_model.configurations import _2636, _2633, _2635
    from mastapy.bearings.bearing_results.rolling import _1996
    from mastapy.system_model.database_access import _2284
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6826, _6825
    from mastapy.utility.model_validation import _1811
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _3003
    ...
    from mastapy.gears.gear_designs.creation_options import _1164, _1166, _1167
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1866.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2532.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2492.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2492.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2495.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2243", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2243.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2498.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2498", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2498.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2244.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1409.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2228.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2381.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1600.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1601.FileHistoryItem":
    ...
    @property
    def settings(self: Self) -> "_2225.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2242.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2260.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2636.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2633.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2532.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1996.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2635.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2284.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5684.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5685.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2553.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2553.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: Self) -> "_2232.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2494.RootAssembly":
    ...
    @property
    def system_optimiser(self: Self) -> "_2259.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5692.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5685.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_3003.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_3003.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5684.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5685.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2185.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_3003.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1811.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6825.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2453.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1599.ExternalFullFEFileOption" = _1599.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design

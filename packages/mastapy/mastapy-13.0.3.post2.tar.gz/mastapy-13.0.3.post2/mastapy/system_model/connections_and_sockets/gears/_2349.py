...
class WormGearMesh(_2333.GearMesh):
    """WormGearMesh
    ...
    class _Cast_WormGearMesh:
        ...
        @property
        def gear_mesh(self: "WormGearMesh._Cast_WormGearMesh") -> "_2333.GearMesh":
        ...
        @property
        def connection(self: "WormGearMesh._Cast_WormGearMesh") -> "_2292.Connection":

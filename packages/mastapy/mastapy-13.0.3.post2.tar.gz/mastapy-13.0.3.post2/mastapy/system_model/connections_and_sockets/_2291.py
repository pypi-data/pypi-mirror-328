...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.connections_and_sockets import _2290, _2295, _2297
...
class ComponentMeasurer(_0.APIBase):
    ...
    class _Cast_ComponentMeasurer:
        ...
        def component_connection(
            ...
            return self._parent._cast(_2290.ComponentConnection)
        ...
        def cylindrical_component_connection(
            ...
            return self._parent._cast(_2295.CylindricalComponentConnection)
        ...
        def datum_measurement(
            ...
            return self._parent._cast(_2297.DatumMeasurement)
    ...
    @property
    def component(self: Self) -> "_2464.Component":

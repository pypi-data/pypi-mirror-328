...
from mastapy.system_model.part_model import _2464, _2468
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1628
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.fe import _2431, _2408
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model import _2240
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self: Self) -> "_2376.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2376", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2376.AlignmentMethod"):
    ...
    @property
    def bearing_node_alignment(self: Self) -> "_2382.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2382", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(self: Self, value: "_2382.BearingNodeAlignmentOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: Self, value: "_2464.Component"):
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: Self, value: "_2468.Datum"):
    ...
    @enforce_parameter_types
    def distance_display_unit(self: Self, value: "_1628.Unit"):
    ...
    @enforce_parameter_types
    def force_display_unit(self: Self, value: "_1628.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @enforce_parameter_types
    def thermal_expansion_option(self: Self, value: "_2431.ThermalExpansionOption"):
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2408.FESubstructureType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def alignment_to_component(
        self: Self,
    ) -> "_2240.RelativeComponentAlignment[_2464.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2464.Component](temp)
    ...
    @property
    def coordinate_system(self: Self) -> "_1517.CoordinateSystem3D":
    ...
    @property
    def export(self: Self) -> "_2404.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: Self) -> "_2473.FEPart":
    ...
    @property
    def gear_meshing_options(self: Self) -> "List[_2415.GearMeshingOptions]":
    ...
    @property
    def geometries(self: Self) -> "List[_2401.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: Self,
    ) -> "List[_2416.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: Self) -> "List[_2438.FELink]":
    ...
    @property
    def nodes(self: Self) -> "List[_2405.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: Self) -> "List[_2502.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: Self,
    ) -> "List[_2429.ReplacedShaftSelectionHelper]":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7580.TaskProgress"] = None,
    ):
        """Method does not return.
    ...
    def import_node_positions(
        self: Self, file_name: "str", distance_unit: "_1628.Unit"
    ):
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: Self,
        file_name: "str",
        distance_unit: "_1628.Unit",
        force_unit: "_1628.Unit",
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(self: Self, node: "_2405.FESubstructureNode") -> "List[_2438.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: Self, file_name: "str", progress: "_7580.TaskProgress"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def load_stl_geometry(self: Self, length_unit: "_1628.Unit", file_name: "str"):
        """Method does not return.

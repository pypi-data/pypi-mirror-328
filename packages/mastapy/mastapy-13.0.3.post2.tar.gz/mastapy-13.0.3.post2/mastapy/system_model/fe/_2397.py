...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2395, _2421
...
class FEEntityGroupWithSelection(_0.APIBase, Generic[TGroup, TGroupContents]):
    ...
    class _Cast_FEEntityGroupWithSelection:
        ...
        def element_face_group_with_selection(
            ...
            return self._parent._cast(_2395.ElementFaceGroupWithSelection)

        @property
        def node_group_with_selection(
            self: "FEEntityGroupWithSelection._Cast_FEEntityGroupWithSelection",
        ) -> "_2421.NodeGroupWithSelection":
            from mastapy.system_model.fe import _2421

            return self._parent._cast(_2421.NodeGroupWithSelection)

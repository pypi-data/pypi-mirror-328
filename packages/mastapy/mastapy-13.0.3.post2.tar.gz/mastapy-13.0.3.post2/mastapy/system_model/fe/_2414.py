...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2420, _2380
...
class FESubstructureWithSelectionForStaticAnalysis(_2410.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: Self, value: "_1839.ThreeDViewContourOption"):
    ...
    def boundary_conditions_all_nodes(
        self: Self,
    ) -> "List[_2420.NodeBoundaryConditionStaticAnalysis]":
    ...
    @property
    def force_results(self: Self) -> "List[_1582.VectorWithLinearAndAngularComponents]":
        """List[mastapy.math_utility.measured_vectors.VectorWithLinearAndAngularComponents]

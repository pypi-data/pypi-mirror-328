...
if TYPE_CHECKING:
    from mastapy.system_model.fe.version_comparer import _2436, _2432
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self: Self) -> "_2436.LoadCasesToRun":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe.version_comparer._2436", "LoadCasesToRun"
        )(value)

    @load_cases_to_run.setter
    @enforce_parameter_types
    def load_cases_to_run(self: Self, value: "_2436.LoadCasesToRun"):
    ...
    @property
    def design_results(self: Self) -> "List[_2432.DesignResults]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2396, _2387, _2388, _2419, _2380
...
class FESubstructureWithSelectionComponents(_2410.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    class _Cast_FESubstructureWithSelectionComponents:
        ...
        def fe_substructure_with_selection(
            ...
            return self._parent._cast(_2410.FESubstructureWithSelection)
        ...
        def base_fe_with_selection(
            ...
            return self._parent._cast(_2380.BaseFEWithSelection)
    ...
    @property
    def manual_alignment(self: Self) -> "_1518.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_212.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: Self) -> "List[_2440.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_2387.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_2388.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_213.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: Self) -> "List[_2440.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: Self) -> "List[_2440.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_214.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: Self) -> "List[_2419.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_211.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_215.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_216.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_217.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_2396.ElementPropertiesWithSelection[_218.ElementPropertiesSpringDashpot]]":

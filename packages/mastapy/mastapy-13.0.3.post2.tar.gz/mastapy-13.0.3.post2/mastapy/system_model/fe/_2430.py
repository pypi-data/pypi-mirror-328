...
from mastapy.nodal_analysis.fe_export_utility import _168, _169
...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2424, _2425
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def default_type_of_result_to_export(
        self: Self, value: "_168.BoundaryConditionType"
    ):
    ...
    @length_unit.setter
    @enforce_parameter_types
    def length_unit(self: Self, value: "_1628.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def links(self: Self) -> "List[_2424.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: Self) -> "List[_2425.PerNodeExportOptions]":

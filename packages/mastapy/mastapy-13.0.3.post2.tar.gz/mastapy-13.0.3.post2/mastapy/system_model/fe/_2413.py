...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2407, _2380
...
class FESubstructureWithSelectionForModalAnalysis(_2410.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: Self,
    ) -> "List[_2407.FESubstructureNodeModeShapes]":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.optimization.system_optimiser import _2260, _2261, _2257
    from mastapy.utility.logging import _1826
    from mastapy.system_model.part_model.gears import _2546, _2552
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(self: Self, value: "_5685.DutyCycle"):
        wrapper_type = (
    ...
    @property
    def design(self: Self) -> "_2220.Design":
    ...
    @property
    def details(self: Self) -> "_2260.SystemOptimiserDetails":
    ...
    @property
    def log(self: Self) -> "_1826.Logger":
    ...
    @property
    def tooth_number_finder(self: Self) -> "_2261.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: Self,
    ) -> "List[_5689.SystemOptimisationGearSet]":
    ...
    @property
    def system_optimiser_duty_cycle(self: Self) -> "_5685.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: Self, value: "_5685.DutyCycle"):

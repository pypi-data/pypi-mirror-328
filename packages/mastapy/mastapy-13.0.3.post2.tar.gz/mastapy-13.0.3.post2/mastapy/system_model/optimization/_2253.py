...
if TYPE_CHECKING:
    from mastapy.system_model.optimization import _2252, _2247, _2250
...
class OptimizationStep(_0.APIBase):
    ...
    class _Cast_OptimizationStep:
        ...
        def conical_gear_optimization_step(
            ...
            return self._parent._cast(_2247.ConicalGearOptimizationStep)

        @property
        def cylindrical_gear_optimization_step(
            self: "OptimizationStep._Cast_OptimizationStep",
        ) -> "_2250.CylindricalGearOptimizationStep":
            from mastapy.system_model.optimization import _2250

            return self._parent._cast(_2250.CylindricalGearOptimizationStep)
    ...
    @property
    def optimisation_target(self: Self) -> "_2252.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.optimization._2252", "MicroGeometryOptimisationTarget"
        )(value)

    @optimisation_target.setter
    @enforce_parameter_types
    def optimisation_target(self: Self, value: "_2252.MicroGeometryOptimisationTarget"):

...
from mastapy.system_model import _2239
...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2469, _2501, _2484, _2464, _2488
...
class PowerLoad(_2499.VirtualComponent):
    """PowerLoad
    ...
    class _Cast_PowerLoad:
        ...
        @property
        def component(self: "PowerLoad._Cast_PowerLoad") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "PowerLoad._Cast_PowerLoad") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "PowerLoad._Cast_PowerLoad") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: Self, value: "_1279.ElectricMachineDetail"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: Self, value: "_2469.ElectricMachineSearchRegionSpecificationMethod"
    ):
    ...
    @property
    def engine_fuel_consumption_grid(self: Self) -> "_1583.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def engine_fuel_consumption_grid(self: Self, value: "_1583.GriddedSurfaceAccessor"):
        self.wrapped.EngineFuelConsumptionGrid = value.wrapped

    @property
    def engine_torque_grid(self: Self) -> "_1583.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: Self, value: "_1583.GriddedSurfaceAccessor"):
    ...
    @enforce_parameter_types
    def power_load_type(self: Self, value: "_2239.PowerLoadType"):
    ...
    @property
    def single_blade_details(self: Self) -> "_2501.WindTurbineSingleBladeDetails":

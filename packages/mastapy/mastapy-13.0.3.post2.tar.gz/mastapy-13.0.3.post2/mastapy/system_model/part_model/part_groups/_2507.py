...
from mastapy.system_model.part_model.part_groups import _2506
...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2508, _2512
...
class ConcentricPartGroup(_2506.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    class _Cast_ConcentricPartGroup:
        ...
        def concentric_or_parallel_part_group(
            ...
            return self._parent._cast(_2506.ConcentricOrParallelPartGroup)
    ...
    @property
    def parallel_groups(self: Self) -> "List[_2508.ConcentricPartGroupParallelToThis]":

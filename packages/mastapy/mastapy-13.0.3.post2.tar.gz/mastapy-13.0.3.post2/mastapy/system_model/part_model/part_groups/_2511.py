...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2509, _2506, _2512
...
class ParallelPartGroupSelection(_2510.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    def design_measurements(self: Self) -> "List[_2509.DesignMeasurements]":

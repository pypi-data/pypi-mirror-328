...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2629, _2631
...
class TorqueConverter(_2604.Coupling):
    """TorqueConverter
    ...
    class _Cast_TorqueConverter:
        ...
        @property
        def coupling(self: "TorqueConverter._Cast_TorqueConverter") -> "_2604.Coupling":
        ...
        @property
        def part(self: "TorqueConverter._Cast_TorqueConverter") -> "_2488.Part":
    ...
    @property
    def pump(self: Self) -> "_2629.TorqueConverterPump":
    ...
    @property
    def turbine(self: Self) -> "_2631.TorqueConverterTurbine":

...
if TYPE_CHECKING:
    from mastapy.math_utility.stiffness_calculators import _1555
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self: Self) -> "_1555.IndividualContactPosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.stiffness_calculators._1555",
    ...
    @property
    def microgeometry_clearance_chart(self: Self) -> "_1887.TwoDChartDefinition":
    ...
    @property
    def crowning(self: Self) -> "_2606.CrowningSpecification":

...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.couplings import _2627, _2625
...
class Synchroniser(_2496.SpecialisedAssembly):
    """Synchroniser
    ...
    class _Cast_Synchroniser:
        ...
        @property
        def part(self: "Synchroniser._Cast_Synchroniser") -> "_2488.Part":
    ...
    @property
    def clutch_connection_left(self: Self) -> "_2362.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: Self) -> "_2362.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: Self) -> "_2627.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: Self) -> "_2625.SynchroniserHalf":
    ...
    @property
    def right_cone(self: Self) -> "_2625.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf

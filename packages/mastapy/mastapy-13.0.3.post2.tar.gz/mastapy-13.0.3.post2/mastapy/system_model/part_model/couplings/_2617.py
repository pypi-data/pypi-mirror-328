...
class RollingRing(_2605.CouplingHalf):
    """RollingRing
    ...
    class _Cast_RollingRing:
        ...
        @property
        def component(self: "RollingRing._Cast_RollingRing") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "RollingRing._Cast_RollingRing") -> "_2488.Part":

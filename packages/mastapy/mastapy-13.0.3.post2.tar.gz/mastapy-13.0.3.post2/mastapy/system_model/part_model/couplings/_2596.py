...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2597, _2611, _2607
...
class BeltDrive(_2496.SpecialisedAssembly):
    """BeltDrive
    ...
    class _Cast_BeltDrive:
        ...
        @property
        def part(self: "BeltDrive._Cast_BeltDrive") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "BeltDrive._Cast_BeltDrive") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

            return self._parent._cast(_2223.DesignEntity)

        @property
        def cvt(self: "BeltDrive._Cast_BeltDrive") -> "_2607.CVT":
    ...
    @property
    def type_of_belt(self: Self) -> "_2597.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2597", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: Self, value: "_2597.BeltDriveType"):
    ...
    @property
    def belt_connections(self: Self) -> "List[_2288.BeltConnection]":
    ...
    @property
    def pulleys(self: Self) -> "List[_2611.Pulley]":

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2624, _2605
...
class SynchroniserHalf(_2626.SynchroniserPart):
    """SynchroniserHalf
    ...
    class _Cast_SynchroniserHalf:
        ...
        @property
        def part(self: "SynchroniserHalf._Cast_SynchroniserHalf") -> "_2488.Part":
    ...
    @property
    def cones(self: Self) -> "List[_2624.SynchroniserCone]":

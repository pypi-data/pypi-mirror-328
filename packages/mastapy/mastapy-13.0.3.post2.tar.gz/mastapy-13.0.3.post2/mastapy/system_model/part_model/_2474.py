...
class FlexiblePinAssembly(_2496.SpecialisedAssembly):
    """FlexiblePinAssembly
    ...
    class _Cast_FlexiblePinAssembly:
        ...
        @property
        def part(self: "FlexiblePinAssembly._Cast_FlexiblePinAssembly") -> "_2488.Part":
    ...
    @property
    def planet_gear(self: Self) -> "_2545.CylindricalGear":

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2500
...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    @property
    def edgewise_modes(self: Self) -> "_2500.WindTurbineBladeModeDetails":
    ...
    @property
    def flapwise_modes(self: Self) -> "_2500.WindTurbineBladeModeDetails":
        """mastapy.system_model.part_model.WindTurbineBladeModeDetails

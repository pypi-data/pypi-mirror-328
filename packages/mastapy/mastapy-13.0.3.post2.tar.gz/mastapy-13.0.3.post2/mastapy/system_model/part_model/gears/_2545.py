...
class CylindricalGear(_2550.Gear):
    """CylindricalGear
    ...
    class _Cast_CylindricalGear:
        ...
        @property
        def gear(self: "CylindricalGear._Cast_CylindricalGear") -> "_2550.Gear":
        ...
        @property
        def part(self: "CylindricalGear._Cast_CylindricalGear") -> "_2488.Part":
    ...
    @property
    def active_gear_design(self: Self) -> "_1022.CylindricalGearDesign":
    ...
    @property
    def cylindrical_gear_design(self: Self) -> "_1022.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign

...
from mastapy.system_model.part_model import _2475, _2455
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2476, _2484, _2456, _2464, _2488
...
class Shaft(_2455.AbstractShaft):
    """Shaft
    ...
    class _Cast_Shaft:
        ...
        @property
        def abstract_shaft(self: "Shaft._Cast_Shaft") -> "_2455.AbstractShaft":
        ...
        @property
        def component(self: "Shaft._Cast_Shaft") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "Shaft._Cast_Shaft") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Shaft._Cast_Shaft") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: Self, value: "_2475.GuideDxfModel"):
        wrapper_type = (
    ...
    @property
    def guide_image(self: Self) -> "_2476.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: Self) -> "_2403.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: Self, component: "_2484.MountableComponent", offset: "float"
    ):
        """Method does not return.

...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2480, _2457
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing(self: Self) -> "_2480.LoadSharingModes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2480", "LoadSharingModes"
        )(value)

    @planetary_load_sharing.setter
    @enforce_parameter_types
    def planetary_load_sharing(self: Self, value: "_2480.LoadSharingModes"):
    ...
    @enforce_parameter_types
    def planetary_load_sharing_agma_application_level(
        self: Self, value: "_2457.AGMALoadSharingTableApplicationLevel"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.AGMALoadSharingTableApplicationLevel",

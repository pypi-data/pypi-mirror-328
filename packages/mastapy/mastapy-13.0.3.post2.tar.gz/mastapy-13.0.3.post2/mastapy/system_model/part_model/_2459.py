...
from mastapy.bearings.bearing_results import _1962, _1981
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1893, _1906, _1889
...
class Bearing(_2467.Connector):
    ...
    class _Cast_Bearing:
        ...
        @property
        def connector(self: "Bearing._Cast_Bearing") -> "_2467.Connector":
        ...
        @property
        def component(self: "Bearing._Cast_Bearing") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "Bearing._Cast_Bearing") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Bearing._Cast_Bearing") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1923.BearingToleranceClass"):
    ...
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1924.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1893.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1893", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1893.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2460", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2460.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1804.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1906.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1906", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1906.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1897.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1804.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1962.CylindricalRollerMaxAxialLoadMethod, Tuple[_1962.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1981.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2150.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2090.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1940.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1940.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1940.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def right_support_detail(self: Self) -> "_1940.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1926.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1937.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1932.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1937.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2150.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1927.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1942.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1933.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1942.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1944.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1889.BearingCatalog", designation: "str"
    ):
    ...
    def try_attach_left_side_to(
        self: Self, shaft: "_2502.Shaft", offset: "float" = float("nan")

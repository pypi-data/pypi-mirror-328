...
class MassDisc(_2499.VirtualComponent):
    """MassDisc
    ...
    class _Cast_MassDisc:
        ...
        @property
        def component(self: "MassDisc._Cast_MassDisc") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "MassDisc._Cast_MassDisc") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "MassDisc._Cast_MassDisc") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

...
from mastapy.gears.gear_designs.bevel import _1197
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1916, _1889
    ...
    from mastapy.gears.gear_designs.creation_options import _1164, _1167
...
class Assembly(_2454.AbstractAssembly):
    """Assembly
    ...
    class _Cast_Assembly:
        ...
        def abstract_assembly(
            self: "Assembly._Cast_Assembly",
        ) -> "_2454.AbstractAssembly":
            return self._parent._cast(_2454.AbstractAssembly)

        @property
        def part(self: "Assembly._Cast_Assembly") -> "_2488.Part":
            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Assembly._Cast_Assembly") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

            return self._parent._cast(_2223.DesignEntity)

        @property
        def root_assembly(self: "Assembly._Cast_Assembly") -> "_2494.RootAssembly":
    ...
    @property
    def oil_level_specification(self: Self) -> "_2485.OilLevelSpecification":
    ...
    @property
    def bearings(self: Self) -> "List[_2459.Bearing]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2463.BoltedJoint]":
    ...
    @property
    def component_details(self: Self) -> "List[_2464.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: Self) -> "List[_2464.Component]":
        """List[mastapy.system_model.part_model.Component]
    ...
    @property
    def conical_gear_sets(self: Self) -> "List[_2544.ConicalGearSet]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_2546.CylindricalGearSet]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2473.FEPart]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2549.FaceGearSet]":
    ...
    @property
    def gear_sets(self: Self) -> "List[_2552.GearSet]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_2555.HypoidGearSet]":
    ...
    def klingelnberg_cyclo_palloid_gear_sets(
        self: Self,
    ) -> "List[_2557.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2486.OilSeal]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2491.PointLoad]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2492.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_2619.ShaftHubConnection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2502.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_2564.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: Self) -> "List[_2568.StraightBevelGearSet]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2572.WormGearSet]":
    ...
    def get_part_named(self: Self, name: "str") -> "_2488.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: Self, name: "str") -> "_2459.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: Self, name: "str") -> "_2462.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_component(self: Self, name: "str") -> "_2464.Component":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_connector(self: Self, name: "str") -> "_2467.Connector":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: Self, name: "str") -> "_2468.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: Self, name: "str") -> "_2473.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: Self, name: "str") -> "_2482.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: Self, name: "str") -> "_2486.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_point_load(self: Self, name: "str") -> "_2491.PointLoad":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_power_load(self: Self, name: "str") -> "_2492.PowerLoad":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: Self, name: "str") -> "_2502.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bevel_gear(self: Self, name: "str") -> "_2539.BevelGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: Self, name: "str") -> "_2548.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: Self, name: "str") -> "_2550.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: Self, name: "str") -> "_2552.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: Self, name: "str") -> "_2571.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: Self, name: "str") -> "_2590.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_belt_drive(self: Self, name: "str") -> "_2596.BeltDrive":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: Self, name: "str") -> "_2598.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: Self, name: "str") -> "_2604.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: Self, name: "str") -> "_2607.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt_pulley(self: Self, name: "str") -> "_2608.CVTPulley":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: Self, name: "str") -> "_2611.Pulley":
        """T_get_part_named
    ...
    def all_parts(self: Self) -> "List[_2488.Part]":
    ...
    def all_parts_of_type_abstract_shaft(self: Self) -> "List[_2455.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: Self,
    ) -> "List[_2456.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: Self) -> "List[_2459.Bearing]":
        """List[mastapy.system_model.part_model.Bearing]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bearing")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_bolt(self: Self) -> "List[_2462.Bolt]":
        """List[mastapy.system_model.part_model.Bolt]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bolt")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_bolted_joint(self: Self) -> "List[_2463.BoltedJoint]":
        """List[mastapy.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "BoltedJoint"
        )
    ...
    def all_parts_of_type_component(self: Self) -> "List[_2464.Component]":
        """List[mastapy.system_model.part_model.Component]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Component")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_connector(self: Self) -> "List[_2467.Connector]":
        """List[mastapy.system_model.part_model.Connector]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Connector")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_datum(self: Self) -> "List[_2468.Datum]":
    ...
    def all_parts_of_type_fe_part(self: Self) -> "List[_2473.FEPart]":
        """List[mastapy.system_model.part_model.FEPart]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "FEPart")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: Self,
    ) -> "List[_2474.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: Self) -> "List[_2475.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: Self) -> "List[_2482.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: Self,
    ) -> "List[_2483.MeasurementComponent]":
    ...
    def all_parts_of_type_oil_seal(self: Self) -> "List[_2486.OilSeal]":
        """List[mastapy.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_planet_carrier(self: Self) -> "List[_2489.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: Self) -> "List[_2491.PointLoad]":
        """List[mastapy.system_model.part_model.PointLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PointLoad")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_power_load(self: Self) -> "List[_2492.PowerLoad]":
        """List[mastapy.system_model.part_model.PowerLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PowerLoad")
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[cast_type]())

    def all_parts_of_type_root_assembly(self: Self) -> "List[_2494.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: Self,
    ) -> "List[_2496.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: Self) -> "List[_2497.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: Self) -> "List[_2502.Shaft]":
        """List[mastapy.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.ShaftModel", "Shaft"
        )
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: Self,
    ) -> "List[_2533.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: Self,
    ) -> "List[_2534.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: Self,
    ) -> "List[_2535.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: Self,
    ) -> "List[_2536.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: Self,
    ) -> "List[_2537.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: Self,
    ) -> "List[_2538.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: Self) -> "List[_2539.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: Self) -> "List[_2540.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: Self) -> "List[_2541.ConceptGear]":
    ...
    def all_parts_of_type_concept_gear_set(self: Self) -> "List[_2542.ConceptGearSet]":
    ...
    def all_parts_of_type_conical_gear(self: Self) -> "List[_2543.ConicalGear]":
    ...
    def all_parts_of_type_conical_gear_set(self: Self) -> "List[_2544.ConicalGearSet]":
        """List[mastapy.system_model.part_model.gears.ConicalGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "ConicalGearSet"
        )
    ...
    def all_parts_of_type_cylindrical_gear(self: Self) -> "List[_2545.CylindricalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: Self,
    ) -> "List[_2547.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: Self) -> "List[_2548.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: Self) -> "List[_2549.FaceGearSet]":
        """List[mastapy.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "FaceGearSet"
        )
    ...
    def all_parts_of_type_gear(self: Self) -> "List[_2550.Gear]":
    ...
    def all_parts_of_type_gear_set(self: Self) -> "List[_2552.GearSet]":
        """List[mastapy.system_model.part_model.gears.GearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "GearSet"
        )
    ...
    def all_parts_of_type_hypoid_gear(self: Self) -> "List[_2554.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: Self) -> "List[_2555.HypoidGearSet]":
        """List[mastapy.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "HypoidGearSet"
        )
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: Self,
    ) -> "List[_2556.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: Self,
    ) -> "List[_2559.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: Self,
    ) -> "List[_2561.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: Self,
    ) -> "List[_2565.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: Self,
    ) -> "List[_2566.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: Self,
    ) -> "List[_2568.StraightBevelGearSet]":
        """List[mastapy.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "StraightBevelGearSet"
        )
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: Self,
    ) -> "List[_2569.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: Self,
    ) -> "List[_2570.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: Self) -> "List[_2571.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: Self) -> "List[_2572.WormGearSet]":
        """List[mastapy.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "WormGearSet"
        )
    ...
    def all_parts_of_type_zerol_bevel_gear(self: Self) -> "List[_2573.ZerolBevelGear]":
    ...
    def all_parts_of_type_cycloidal_disc(self: Self) -> "List[_2589.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: Self) -> "List[_2590.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: Self) -> "List[_2596.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: Self) -> "List[_2598.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: Self) -> "List[_2599.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling(self: Self) -> "List[_2601.ConceptCoupling]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: Self,
    ) -> "List[_2602.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: Self) -> "List[_2604.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: Self) -> "List[_2605.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: Self) -> "List[_2607.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: Self) -> "List[_2608.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: Self,
    ) -> "List[_2609.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: Self,
    ) -> "List[_2610.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: Self) -> "List[_2611.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: Self) -> "List[_2617.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: Self,
    ) -> "List[_2618.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: Self) -> "List[_2621.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: Self) -> "List[_2623.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter(self: Self) -> "List[_2628.TorqueConverter]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: Self,
    ) -> "List[_2629.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: Self,
    ) -> "List[_2631.TorqueConverterTurbine]":
    ...
    @enforce_parameter_types
    def add_bearing(self: Self, name: "str") -> "_2459.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: Self, name: "str", type_: "_1916.RollingBearingType"
    ) -> "_2459.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: Self, name: "str", type_: "_1916.RollingBearingType", designation: "str"
    ) -> "_2459.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: Self, belt_creation_options: Optional["_2591.BeltCreationOptions"] = None
    ) -> "_2596.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: Self, name: "str" = "CVT") -> "_2607.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: Self, name: "str" = "Clutch") -> "_2598.Clutch":
    ...
    @enforce_parameter_types
    def add_datum(self: Self, name: "str" = "Datum") -> "_2468.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: Self, name: "str" = "FE Part") -> "_2473.FEPart":
    ...
    def add_hypoid_gear_set_detailed(
        ...
        design_method: "_1197.AGMAGleasonConicalGearGeometryMethods" = _1197.AGMAGleasonConicalGearGeometryMethods.GLEASON,
    ) -> "_2555.HypoidGearSet":
        """mastapy.system_model.part_model.gears.HypoidGearSet
    ...
    @enforce_parameter_types
    def add_linear_bearing(self: Self, name: "str", width: "float") -> "_2459.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    @enforce_parameter_types
    def add_mass_disc(self: Self, name: "str" = "Mass Disc") -> "_2482.MassDisc":
    ...
    @enforce_parameter_types
    def add_oil_seal(self: Self, name: "str" = "Oil Seal") -> "_2486.OilSeal":
    ...
    @enforce_parameter_types
    def add_point_load(self: Self, name: "str" = "Point Load") -> "_2491.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: Self, name: "str" = "Power Load") -> "_2492.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: Self, catalogue: "_1889.BearingCatalog", designation: "str", name: "str"
    ) -> "_2459.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: Self, shaft_creation_options: "_2595.ShaftCreationOptions"
    ) -> "_2502.Shaft":
    ...
    @enforce_parameter_types
    def add_shaft_hub_connection(self: Self, name: "str") -> "_2619.ShaftHubConnection":

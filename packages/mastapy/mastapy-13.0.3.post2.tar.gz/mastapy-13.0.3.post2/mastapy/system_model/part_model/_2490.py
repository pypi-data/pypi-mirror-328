...
if TYPE_CHECKING:
    from mastapy.system_model import _2235
...
class PlanetCarrierSettings(_1612.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2235", "PlanetPinManufacturingErrorsCoordinateSystem"
        )(value)

    @planet_pin_manufacturing_errors_coordinate_system.setter
    @enforce_parameter_types
    def planet_pin_manufacturing_errors_coordinate_system(
        self: Self, value: "_2235.PlanetPinManufacturingErrorsCoordinateSystem"
    ):

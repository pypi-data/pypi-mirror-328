...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2481, _2464, _2488
...
class PlanetCarrier(_2484.MountableComponent):
    """PlanetCarrier
    ...
    class _Cast_PlanetCarrier:
        ...
        @property
        def component(self: "PlanetCarrier._Cast_PlanetCarrier") -> "_2464.Component":
            from mastapy.system_model.part_model import _2464

            return self._parent._cast(_2464.Component)

        @property
        def part(self: "PlanetCarrier._Cast_PlanetCarrier") -> "_2488.Part":
    ...
    @property
    def planetary_sockets(self: Self) -> "List[_2308.PlanetarySocket]":

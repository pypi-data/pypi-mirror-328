...
from mastapy.bearings.bearing_results import _1983, _1984
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2478, _2487
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def inner_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2478.InnerBearingRaceMountingOptions)
        ...
        def outer_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2487.OuterBearingRaceMountingOptions)
    ...
    def axial_mounting(self: Self, value: "_1983.RaceAxialMountingType"):
    ...
    @enforce_parameter_types
    def simple_radial_mounting(self: Self, value: "_1984.RaceRadialMountingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (

...
class Datum(_2464.Component):
    ...
    class _Cast_Datum:
        ...
        @property
        def component(self: "Datum._Cast_Datum") -> "_2464.Component":
            return self._parent._cast(_2464.Component)

        @property
        def part(self: "Datum._Cast_Datum") -> "_2488.Part":
            from mastapy.system_model.part_model import _2488

            return self._parent._cast(_2488.Part)

        @property
        def design_entity(self: "Datum._Cast_Datum") -> "_2223.DesignEntity":
            from mastapy.system_model import _2223

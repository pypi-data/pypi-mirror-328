...
if TYPE_CHECKING:
    ...
    from mastapy.fe_tools.vfx_tools import _1256
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self: Self) -> "_1521.DataPrecision":
    ...
    @property
    def solver_options(self: Self) -> "_1256.ProSolveOptions":

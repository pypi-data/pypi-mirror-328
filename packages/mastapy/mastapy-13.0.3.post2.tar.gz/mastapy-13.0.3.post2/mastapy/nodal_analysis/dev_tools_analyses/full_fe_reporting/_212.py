...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1252
...
class ElementPropertiesBeam(_219.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self: Self) -> "_1252.BeamSectionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1252",
            "BeamSectionType",
        )(value)

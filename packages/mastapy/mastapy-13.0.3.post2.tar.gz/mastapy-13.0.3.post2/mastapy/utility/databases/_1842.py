...
if TYPE_CHECKING:
    from mastapy.utility.databases import _1844, _1846, _1849
...
class Database(_0.APIBase, Generic[TKey, TValue]):
    ...
    class _Cast_Database:
        ...
        @property
        def named_database(self: "Database._Cast_Database") -> "_1846.NamedDatabase":
            from mastapy.utility.databases import _1846

            return self._parent._cast(_1846.NamedDatabase)

        @property
        def sql_database(self: "Database._Cast_Database") -> "_1849.SQLDatabase":

...
if TYPE_CHECKING:
    from mastapy.utility import _1611, _1597
...
class EnvironmentSummary(_0.APIBase):
    ...
    def current_net_framework_version(self: Self) -> "str":
        ...
        Note:
            This property is readonly.
        """
        temp = self.wrapped.CurrentNETFrameworkVersion
    ...
    @property
    def current_culture(self: Self) -> "_1611.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1597.DispatcherHelper]":

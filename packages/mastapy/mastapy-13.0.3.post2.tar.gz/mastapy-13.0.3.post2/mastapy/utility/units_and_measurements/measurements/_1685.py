...
class LengthShort(_1623.MeasurementBase):
    """LengthShort
    ...
    @property
    def inches(self: Self) -> "_1628.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def metres(self: Self) -> "_1628.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def micrometres(self: Self) -> "_1628.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millimetres(self: Self) -> "_1628.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def thousandths_of_an_inch(self: Self) -> "_1628.Unit":
        """mastapy.utility.units_and_measurements.Unit

...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis.gears import _1817, _1820
...
class GearOrderForTE(_1822.OrderWithRadius):
    """GearOrderForTE
    ...
    class _Cast_GearOrderForTE:
        ...
        def order_for_te(
            ...
            return self._parent._cast(_1820.OrderForTE)
    ...
    @property
    def position(self: Self) -> "_1817.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.modal_analysis.gears._1817", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: Self) -> "List[_1820.OrderForTE]":

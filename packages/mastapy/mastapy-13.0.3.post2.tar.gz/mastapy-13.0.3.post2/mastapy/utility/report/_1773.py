...
if TYPE_CHECKING:
    from mastapy.utility.cad_export import _1851
...
class CustomReportCadDrawing(_1789.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self: Self) -> "_1851.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.cad_export._1851", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: Self, value: "_1851.StockDrawings"):

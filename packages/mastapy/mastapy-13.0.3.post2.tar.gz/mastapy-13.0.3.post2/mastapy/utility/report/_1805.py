...
if TYPE_CHECKING:
    from mastapy.utility.report import _1803, _1791
...
class UserTextRow(_1796.CustomRow):
    """UserTextRow
    ...
    class _Cast_UserTextRow:
        ...
        @property
        def custom_row(self: "UserTextRow._Cast_UserTextRow") -> "_1796.CustomRow":
        ...
        def custom_report_property_item(
            ...
            from mastapy.utility.report import _1791

            return self._parent._cast(_1791.CustomReportPropertyItem)
    ...
    @property
    def heading_size(self: Self) -> "_1803.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1803", "HeadingSize"
        )(value)

    @heading_size.setter
    @enforce_parameter_types
    def heading_size(self: Self, value: "_1803.HeadingSize"):

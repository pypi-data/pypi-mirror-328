...
class CustomReportChartItem(_1791.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self: Self) -> "_1767.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1767", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: Self, value: "_1767.SMTChartPointShape"):

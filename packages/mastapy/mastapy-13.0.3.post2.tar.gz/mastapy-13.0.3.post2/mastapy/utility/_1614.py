...
class ProgramSettings(_1612.PerMachineSettings):
    """ProgramSettings
    ...
    def load_saved_operation_mode_and_selection(self: Self) -> "bool":
        """bool"""
        temp = self.wrapped.LoadSavedOperationModeAndSelection
    ...
    @enforce_parameter_types
    def load_saved_operation_mode_and_selection(self: Self, value: "bool"):

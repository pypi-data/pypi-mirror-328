...
def load_wine_quality(return_X_y=False):
    """
    ...
    -------
    tuple
        If `return_X_y=False` (default), returns:
            (red_wine_df, white_wine_df) : Two pandas DataFrames containing full datasets.
        
        If `return_X_y=True`, returns:

...
class WagoController():
    ...
    def writeBit(self,address,bit,bool):
    ...
    def setOutputChannel(self,channel):
        return self.writeBit(self.output_register,channel,1)
    
    def cutOutputChannel(self,channel):
        return self.writeBit(self.output_register,channel,0)
    
    def checkOutputChannel(self,channel):
        return self.readBit(self.output_register,channel)
    
    def setInputChannel(self,channel):
        return self.writeBit(self.input_register,channel,1)
    
    def cutInputChannel(self,channel):
        return self.writeBit(self.input_register,channel,0)
    
    def checkInputChannel(self,channel):
        return self.readBit(self.input_register,channel)
    
    def setOutput(self):
        return self.write(self.output_register,255)
    
    def cutOutput(self):
        return self.write(self.output_register,0)
    
    def checkOutput(self):
        return self.read(self.output_register)
    
    def setInput(self):
        return self.write(self.input_register,255)
    
    def cutInput(self):
        return self.write(self.input_register,0)
    
    def checkInput(self):
        return self.read(self.input_register)

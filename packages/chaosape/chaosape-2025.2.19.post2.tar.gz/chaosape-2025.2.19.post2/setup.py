...
# cause issues where files that were deleted from a more recent ChaosApe are
...
if "install" in sys.argv:
    ...
    for lib_path in lib_paths:
        existing_path = os.path.abspath(os.path.join(lib_path, "chaosape"))
...
all_needed_files = ["LICENSE", "chaosape.py"]
...
setup(
    ...
    url='https://github.com/NormanTUD/ChaosApe/',
    install_requires=[],
    packages=['.',],
...
You have just installed ChaosApe over top of an existing
installation, without removing it first. Because of this,
your install may now include extraneous files from a
previous version that have since been removed from
ChaosApe. This is known to cause a variety of problems. You
should manually remove the

%(existing_path)s

directory and re-install ChaosApe.

...
# 文本相似度
print(nlp.text_similarity(query, documents))

# 问句文本相似度(去除停词)
print(nlp.query_text_similarity(query, documents))

# 混合相似度
print(nlp.hybrid_similarity(query, documents, query_vector, docs_vector))

# 问句混合相似度(去除停词)
print(nlp.query_hybrid_similarity(query, documents,query_vector, docs_vector))

# 向量相似度
print(nlp.vector_similarity(query_vector, docs_vector))

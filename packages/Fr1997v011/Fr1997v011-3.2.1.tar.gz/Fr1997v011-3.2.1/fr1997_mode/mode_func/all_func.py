...
"""
    ...
    pip3 cache purge
    pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==3.2.0
...
class XhsJike:
    ...
    def generate_search_id(self):
        ...
        combined_value = timestamp * 10000 + random_value
        return self.base36encode(combined_value)
    ...
    def xhs_search_data_do(self, keyword, page, search_id=None):
        save_data = []
        ret = {'code': 0, 'has_more': True, 'save_data': save_data}
        try:
            res = mode_xhs.search_v2_lhf(keyword, page)
            if res.status_code == 200:
                data_data = res.json()
                code = data_data['code']

...
class Well:
    ...
    def get_info(self) -> dict:
        ...
        for tag_name in curve_display_properties:
            color = curve_display_properties[tag_name]['line_color']
            colors_dict = {'line_color': (color.red / 255, color.green / 255, color.blue / 255, color.alpha / 255)}
            tag_names_dict = {'tag_name': tag_name}
            display_properties[curve_display_properties[tag_name]['id']] = dict(**colors_dict, **tag_names_dict)
        ...
        for well in well_list:
            ...
            for curve_name in list(curves_dict['curve_info'].keys()):
                ...
                curves_dict['curve_info'][curve_name]['line_color'] = display_properties[curve_type]['line_color']
    ...
    def get_curve_display_properties(self) -> dict:
        ...
        for tag in curve_display_properties:
            ...
            line_color_dict = {'line_color': tag.line_color}

    ...
    def make_instance(self, include_optional) -> CreateShiftRequestBodyContainer:
        ...
        if include_optional:
            return CreateShiftRequestBodyContainer(
                data = dima_test_sdk.models.create_shift_request_body_container_data.CreateShiftRequestBodyContainer_data(
                    contract_id = 'm98757x', 
                    shifts = [
                        dima_test_sdk.models.create_shift_schema.CreateShiftSchema(

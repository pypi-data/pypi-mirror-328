...
class TestProfileEntitlements(unittest.TestCase):
    """ProfileEntitlements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileEntitlements:
        """Test ProfileEntitlements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileEntitlements`
        """
        model = ProfileEntitlements()
        if include_optional:
            return ProfileEntitlements(
                hris_profile_id = '',
                entitlements = [
                    dima_test_sdk.models.entitlements.Entitlements(
                        id = '', 
                        tracking_period = '', 
                        ...
                        requested = '', 
                        rollovers = [
                            dima_test_sdk.models.entitlements_rollovers_inner.Entitlements_rollovers_inner(
                        ...
                        time_off_event_id = '', 
                        policy = dima_test_sdk.models.entitlements_policy.Entitlements_policy(
                            id = '', 
                            name = '', 
                            description = '', 
                            policy_type_id = '', 
                            ...
                            policy_type = dima_test_sdk.models.get_policies_for_profile_200_response_policies_inner_policy_type.getPoliciesForProfile_200_response_policies_inner_policy_type(
                                ...
                                name = '', ), ), 
                        future_events = [
                            dima_test_sdk.models.entitlements_future_events_inner.Entitlements_future_events_inner(
                                id = '', 
                                profile_id = '', 
                                policy_id = '', 
                                time_off_id = '', 
    ...
    def testProfileEntitlements(self):
        """Test ProfileEntitlements"""

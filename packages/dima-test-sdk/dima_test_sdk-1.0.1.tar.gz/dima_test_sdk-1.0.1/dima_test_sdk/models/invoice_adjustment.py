...
class InvoiceAdjustment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "status", "description", "date_submitted", "currency_code", "invoice_id", "quantity", "total_amount", "created_at", "scale", "custom_scale", "attachment", "worksheet", "reviewed_by", "contract", "payment_cycle", "reported_by", "approvers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvoiceAdjustment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvoiceAdjustment from a dict"""
        if obj is None:
            return None

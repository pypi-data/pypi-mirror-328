...
class WorkerBankAccountToAdd(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["full_name", "phone", "address_line1", "address_line2", "city", "province_state", "postal", "bank_name", "country_code", "bank_country_code", "swift_bic", "account_number", "bank_code", "original_name", "tax_id", "branch_code", "currency_code", "bank_branch_name", "iban", "email", "rib_number", "account_type", "ach_routing_number"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkerBankAccountToAdd from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkerBankAccountToAdd from a dict"""
        if obj is None:
            return None

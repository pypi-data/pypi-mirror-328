...
class BgCheckForContract(BaseModel):
    """
    BgCheckForContract
    """ # noqa: E501
    ...
    candidate_email: Optional[StrictStr] = Field(default=None, description="The email of the candidate.")
    __properties: ClassVar[List[str]] = ["id", "name", "third_party_name", "status", "is_complete", "created_at", "completed_at", "package", "candidate_email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BgCheckForContract from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BgCheckForContract from a dict"""
        if obj is None:
            return None

...
class PAYGTASKS(BaseModel):
    ...
    compensation_details: PAYGTASKSAllOfCompensationDetails
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['payg_tasks']):
            raise ValueError("must be one of enum values ('payg_tasks')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PAYGTASKS from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PAYGTASKS from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "compensation_details": PAYGTASKSAllOfCompensationDetails.from_dict(obj["compensation_details"]) if obj.get("compensation_details") is not None else None
        })
        return _obj

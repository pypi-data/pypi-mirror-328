...
class ContractToCreatePayAsYouGoTimeBasedAllOfCompensationDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "currency_code", "frequency", "cycle_end", "cycle_end_type", "payment_due_type", "payment_due_days", "pay_before_weekends", "first_payment_date", "first_payment", "notice_period", "scale"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContractToCreatePayAsYouGoTimeBasedAllOfCompensationDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContractToCreatePayAsYouGoTimeBasedAllOfCompensationDetails from a dict"""
        if obj is None:
            return None

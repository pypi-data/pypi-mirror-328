...
class GetBenefitEmployees200ResponseDataInner(BaseModel):
    """
    ...
    phones: Optional[List[GetBenefitEmployees200ResponseDataInnerPhonesInner]] = Field(default=None, description="List of phone numbers associated with the employee.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBenefitEmployees200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBenefitEmployees200ResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "phones": [GetBenefitEmployees200ResponseDataInnerPhonesInner.from_dict(_item) for _item in obj["phones"]] if obj.get("phones") is not None else None,

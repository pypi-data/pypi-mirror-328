...
class ONGOINGTIMEBASED(BaseModel):
    """
    ONGOINGTIMEBASED
    """ # noqa: E501
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ongoing_time_based']):
            raise ValueError("must be one of enum values ('ongoing_time_based')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ONGOINGTIMEBASED from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ONGOINGTIMEBASED from a dict"""
        if obj is None:
            return None

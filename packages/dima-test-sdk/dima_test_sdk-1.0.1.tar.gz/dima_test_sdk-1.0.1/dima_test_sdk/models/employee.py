...
class Employee(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "first_name", "last_name", "full_name", "worker_id", "external_id", "termination_last_day", "preferred_first_name", "preferred_last_name", "addresses", "emails", "birth_date", "start_date", "nationalities", "client_legal_entity", "state", "seniority", "completion_date", "direct_manager", "direct_reports", "direct_reports_count", "worker_relations", "custom_field_values", "employments", "hiring_status", "new_hiring_status", "hiring_type", "job_title", "country", "timezone", "department", "work_location", "updated_at"]

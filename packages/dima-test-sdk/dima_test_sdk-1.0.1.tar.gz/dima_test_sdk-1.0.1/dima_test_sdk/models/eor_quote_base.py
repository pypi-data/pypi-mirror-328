...
class EorQuoteBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["annual_salary", "currency", "breakdown_costs", "severance_accrual_total", "severance_accrual_total_usd", "recurring_allowance_total", "recurring_allowance_total_usd", "salary_total", "salary_total_usd", "employer_cost_total", "employer_cost_total_usd", "platform_fee_total", "platform_fee_total_usd", "mobility_fee_total", "mobility_fee_total_usd", "monthly_cost_total", "monthly_cost_total_usd", "gross_salary_total", "gross_salary_total_usd", "cba_total", "cba_total_usd", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EorQuoteBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EorQuoteBase from a dict"""
        if obj is None:
            return None

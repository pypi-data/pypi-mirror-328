...
class Timesheet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "status", "description", "date_submitted", "currency_code", "total_amount", "quantity", "created_at", "scale", "custom_scale", "attachment", "worksheet", "reviewed_by", "contract", "payment_cycle", "reported_by", "approvers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "approvers": [TimesheetApprover.from_dict(_item) for _item in obj["approvers"]] if obj.get("approvers") is not None else None
        })
        return _obj

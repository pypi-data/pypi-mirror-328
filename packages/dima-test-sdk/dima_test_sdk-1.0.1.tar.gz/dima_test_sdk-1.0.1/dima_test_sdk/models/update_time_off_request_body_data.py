...
class UpdateTimeOffRequestBodyData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["recipient_profile_id", "other_type_description", "reason", "start_date", "end_date", "time_off_type_id", "description", "deduction_amount", "is_paid", "contract_oid", "attachments", "dates", "time_off_percentage", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTimeOffRequestBodyData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTimeOffRequestBodyData from a dict"""
        if obj is None:
            return None

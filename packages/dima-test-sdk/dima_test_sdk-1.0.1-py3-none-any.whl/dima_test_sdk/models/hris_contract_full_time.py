...
class HrisContractFullTime(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract_oid", "start_date", "employee_number", "end_date", "employment_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HrisContractFullTime from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HrisContractFullTime from a dict"""
        if obj is None:
            return None

...
class UserPersonalInformationToUpdateContainerData(BaseModel):
    """
    ...
    work_email: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The work email of the worker.")
    date_of_birth: Optional[date] = Field(default=None, description="The date of birth of the worker. Format: YYYY-MM-DD.")
    phone_numbers: Optional[List[PeoplePersonalContainerDataPhoneNumbersInner]] = None
    __properties: ClassVar[List[str]] = ["legal_first_name", "legal_last_name", "preferred_name", "personal_email", "work_email", "date_of_birth", "phone_numbers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserPersonalInformationToUpdateContainerData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserPersonalInformationToUpdateContainerData from a dict"""
        if obj is None:
            return None

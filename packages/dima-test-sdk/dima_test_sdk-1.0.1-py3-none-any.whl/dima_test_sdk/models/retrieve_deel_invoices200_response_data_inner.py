...
class RetrieveDeelInvoices200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "label", "total", "status", "currency", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveDeelInvoices200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveDeelInvoices200ResponseDataInner from a dict"""
        if obj is None:
            return None

...
class PAYASYOUGOTIMEBASED(BaseModel):
    """
    PAYASYOUGOTIMEBASED
    """ # noqa: E501
    ...
    worker: Optional[PAYASYOUGOTIMEBASEDAllOfWorker] = None
    job_title: PAYASYOUGOTIMEBASEDAllOfJobTitle
    seniority: Optional[PAYASYOUGOTIMEBASEDAllOfSeniority] = None
    ...
    compensation_details: PAYASYOUGOTIMEBASEDAllOfCompensationDetails
    __properties: ClassVar[List[str]] = ["meta", "title", "client", "worker", "job_title", "seniority", "state_code", "external_id", "who_reports", "country_code", "notice_period", "scope_of_work", "special_clause", "termination_date", "type", "start_date", "compensation_details"]
    ...
    def termination_date_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pay_as_you_go_time_based']):
            raise ValueError("must be one of enum values ('pay_as_you_go_time_based')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PAYASYOUGOTIMEBASED from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PAYASYOUGOTIMEBASED from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "meta": PAYASYOUGOTIMEBASEDAllOfMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "title": obj.get("title"),
            "client": PAYASYOUGOTIMEBASEDAllOfClient.from_dict(obj["client"]) if obj.get("client") is not None else None,
            "worker": PAYASYOUGOTIMEBASEDAllOfWorker.from_dict(obj["worker"]) if obj.get("worker") is not None else None,
            "job_title": PAYASYOUGOTIMEBASEDAllOfJobTitle.from_dict(obj["job_title"]) if obj.get("job_title") is not None else None,
            "seniority": PAYASYOUGOTIMEBASEDAllOfSeniority.from_dict(obj["seniority"]) if obj.get("seniority") is not None else None,
            ...
            "compensation_details": PAYASYOUGOTIMEBASEDAllOfCompensationDetails.from_dict(obj["compensation_details"]) if obj.get("compensation_details") is not None else None
        })
        return _obj

...
class GetGpBankAccounts200ResponseDataInner(BaseModel):
    """
    ...
    sort_code: Optional[StrictStr] = Field(default=None, description="UK sort code.")
    ...
    __properties: ClassVar[List[str]] = ["city", "iban", "email", "phone", "postal", "tax_id", "bank_code", "bank_name", "full_name", "sort_code", "swift_bic", "rib_number", "branch_code", "account_type", "country_code", "address_line1", "address_line2", "currency_code", "original_name", "account_number", "province_state", "bank_branch_name", "bank_country_code", "ach_routing_number", "id", "status", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetGpBankAccounts200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetGpBankAccounts200ResponseDataInner from a dict"""
        if obj is None:
            return None

...
class CandidateToCreate(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier of candidate in your ATS.")
    first_name: StrictStr = Field(description="Candidate's first name.")
    last_name: StrictStr = Field(description="Candidate's last name.")
    status: CandidateStatusEnum
    start_date: date = Field(description="Short date in format ISO-8601 (YYYY-MM-DD). For example: 2022-12-31.")
    link: StrictStr = Field(description="Link to candidate's profile in ATS.")
    ...
    __properties: ClassVar[List[str]] = ["id", "first_name", "last_name", "status", "start_date", "link", "job_title", "email", "nationality", "country", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandidateToCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandidateToCreate from a dict"""
        if obj is None:
            return None

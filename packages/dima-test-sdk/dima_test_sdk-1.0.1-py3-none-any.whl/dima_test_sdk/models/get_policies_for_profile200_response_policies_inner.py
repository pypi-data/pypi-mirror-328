...
class GetPoliciesForProfile200ResponsePoliciesInner(BaseModel):
    """
    ...
    time_off_types: Optional[List[GetPoliciesForProfile200ResponsePoliciesInnerTimeOffTypesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPoliciesForProfile200ResponsePoliciesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPoliciesForProfile200ResponsePoliciesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "time_off_types": [GetPoliciesForProfile200ResponsePoliciesInnerTimeOffTypesInner.from_dict(_item) for _item in obj["time_off_types"]] if obj.get("time_off_types") is not None else None,

...
class Policy(BaseModel):
    ...
    time_off_types: Optional[List[TimeOffType]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time_off_types": [TimeOffType.from_dict(_item) for _item in obj["time_off_types"]] if obj.get("time_off_types") is not None else None,

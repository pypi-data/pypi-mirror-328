...
class InvoiceAdjustmentSearchContainer(BaseModel):
    ...
    types: Optional[InvoiceAdjustmentSearchContainerTypes] = None
    statuses: Optional[InvoiceAdjustmentSearchContainerStatuses] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvoiceAdjustmentSearchContainer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvoiceAdjustmentSearchContainer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "types": InvoiceAdjustmentSearchContainerTypes.from_dict(obj["types"]) if obj.get("types") is not None else None,
            "statuses": InvoiceAdjustmentSearchContainerStatuses.from_dict(obj["statuses"]) if obj.get("statuses") is not None else None,

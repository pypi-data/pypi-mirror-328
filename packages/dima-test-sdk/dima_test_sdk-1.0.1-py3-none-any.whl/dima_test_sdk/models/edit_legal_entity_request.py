...
class EditLegalEntityRequest(BaseModel):
    """
    ...
    company_identifiers: Optional[EditLegalEntityRequestCompanyIdentifiers] = None
    __properties: ClassVar[List[str]] = ["name", "phone", "address", "sic_number", "entity_type", "industry_name", "company_identifiers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditLegalEntityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditLegalEntityRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "company_identifiers": EditLegalEntityRequestCompanyIdentifiers.from_dict(obj["company_identifiers"]) if obj.get("company_identifiers") is not None else None
        })
        return _obj

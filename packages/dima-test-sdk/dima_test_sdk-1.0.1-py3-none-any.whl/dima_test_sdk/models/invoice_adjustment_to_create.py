...
class InvoiceAdjustmentToCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contract_id", "date_submitted", "type", "amount", "description", "paymentCycleId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvoiceAdjustmentToCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvoiceAdjustmentToCreate from a dict"""
        if obj is None:
            return None

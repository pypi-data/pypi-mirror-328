...
from data_gateway_sdk.protocols.device_packet.smpm_device_packet import SmpMGasMeterV0DevicePacket, SmpMEnergyMeterV0DevicePacket, SmpMJupiter08BV0DevicePacket, \
    SmpMJupiter12BV0DevicePacket, SmpMJupiter16BV0DevicePacket, SmpMWaterMeter04BV0DevicePacket, SmpMWaterMeter08BV0DevicePacket, SmpMWaterMeter12BV0DevicePacket, \
...
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_3phase_generated import SmpmUlDeviceEnergy16B3PhaseGeneratedData
...
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_journal import SmpmUlDeviceEnergy16BJournalData, SmpmUlDeviceEnergy16bJournalType, EventData
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_profile_8h1_energy import SmpmUlDeviceEnergy16BProfile8H1EnergyData, SmpmUlDeviceEnergy16bProfile8h1EnergyType
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_profile_8h2_energy import SmpmUlDeviceEnergy16BProfile8H2EnergyData, SmpmUlDeviceEnergy16bProfile8h2EnergyType
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_profile_8h3_energy import SmpmUlDeviceEnergy16bProfile8h3EnergyType, SmpmUlDeviceEnergy16BProfile8H3EnergyData
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_tariff_consumed import SmpmUlDeviceEnergy16BTariffConsumedData
from data_gateway_sdk.protocols.smpm.smpm_ul_device_energy_16b_tariff_generated import SmpmUlDeviceEnergy16BTariffGeneratedData
...
def test_protocol_smpm_energy_v0_multiple_parsing() -> None:
    ...
    assert DeviceProtocolType.SMP_M_ENERGY_METER_V0.parse(bytes.fromhex("6c060080002000060001280006e000c86c060080002000060001280006e000c8")) == [  # type: ignore
        SmpMEnergyMeterV0DevicePacket(packet=SmpmUlDeviceEnergy16BProfile8H1EnergyData(
            type=SmpmUlDeviceEnergy16bProfile8h1EnergyType.ENERGY_CONSUMED_ACTIVE,
            days_ago=timedelta(seconds=0.0),
    ...
    assert DeviceProtocolType.SMP_M_ENERGY_METER_V0.parse(bytes.fromhex("6c060080002000060001280006e000c86c060080002000060001280006e000c8")) == [  # type: ignore
        SmpMEnergyMeterV0DevicePacket(packet=SmpmUlDeviceEnergy16BProfile8H2EnergyData(
            type=SmpmUlDeviceEnergy16bProfile8h2EnergyType.ENERGY_CONSUMED_ACTIVE,
            days_ago=timedelta(seconds=0.0),
            profile=(0, 1, 2, 3, 4, 5, 6, 7),
            point_factor=5.0,
            point_factor_multiplier=2,
...
def test_protocol_smpm_water_meter_multiple_parsing() -> None:
    ...
    assert DeviceProtocolType.SMP_M_WATER_METER_08B_V0.parse(bytes.fromhex('68e4eab106a33a7869e14a1400000000')) == [  # type: ignore

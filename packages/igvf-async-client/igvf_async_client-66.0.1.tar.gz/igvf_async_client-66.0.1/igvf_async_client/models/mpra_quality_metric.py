...
"""
    ...
    The version of the OpenAPI document: 66.0.1
...
class MpraQualityMetric(BaseModel):
    ...
    pearson_correlation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The correlation of log2 RNA/DNA ratios across tested sequences as a measure of replicable activity signal.")
    median_barcodes_passing_filtering: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Median number of barcodes across tested sequences that passed filtering to determine if there was sufficient barcode to oligo coverage.")
    median_rna_read_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Median of RNA read count for oligos that passed filtering to determine sufficient coverage in terms of read count.")
    pct_oligos_passing: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percent of tested sequences that passed filtering of the mappable sequences to determine if the designed library was sufficiently recovered.")
    median_assigned_barocdes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Median number of barcodes assigned to tested sequences in mapping as a quality control measure for the mapping step, whether there is sufficient barcode to oligo coverage.")
    fraction_assigned_oligos: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fraction of assigned tested sequences in mapping to determine if the library during the mapping step was sufficiently recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pct_oligos_passing": obj.get("pct_oligos_passing"),
            "median_assigned_barocdes": obj.get("median_assigned_barocdes"),

...
class OpenRouterEntryPoint(AbstractEntryPoint):
    def __init__(
        self, model_id: str, api_key: str, emb_dim: int = 1024, providers: list[str] = [], warmup: bool = False
    ) -> None:
        self._model = OpenAI(base_url="https://openrouter.ai/api/v1", api_key=api_key)

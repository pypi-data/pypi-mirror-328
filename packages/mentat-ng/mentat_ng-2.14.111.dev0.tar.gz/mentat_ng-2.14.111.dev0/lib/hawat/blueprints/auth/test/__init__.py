...
class AuthTestCase(TestRunnerMixin, HawatTestCase):
    ...
    def test_01_login(self):
        ...
        self.assertTrue(
            b'Following is a list of all available user login options. Please choose the one appropriate for you.' in response.data)
    ...
    def test_02_register(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTrue(
            b'Following is a list of all available user account registration options. Please choose the one most suitable for your needs.' in response.data)

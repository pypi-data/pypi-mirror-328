...
class SearchView(HTMLMixin, SQLAlchemyMixin, BaseSearchView):  # pylint: disable=locally-disabled,too-many-ancestors
    ...
    def get_context_action_menu(cls):
        ...
        context_action_menu.add_entry(
            ...
            url=lambda **x: flask.url_for('changelogs.search',
        ...
        context_action_menu.add_entry(
            ...
            url=lambda **x: flask.url_for('changelogs.search', imodel=x['item'].model,
                                          imodel_id=x['item'].model_id, dt_from='', submit='Search'),
            icon='action-search',
            hidelegend=True
        )
        context_action_menu.add_entry(
            ...
            url=lambda **x: flask.url_for('changelogs.search',
                                          authors=x['item'].author or '__SYSTEM__',
                                          imodel=x['item'].model, imodel_id=x['item'].model_id,
                                          dt_from='', submit='Search'),
            icon='action-search',
            hidelegend=True
        )

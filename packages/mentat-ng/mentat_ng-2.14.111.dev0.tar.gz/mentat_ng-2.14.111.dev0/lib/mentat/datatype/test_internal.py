...
class TestMentatDatatypeInternal(unittest.TestCase):
    ...
    def test_01_conversions(self):
        ...
        self.assertEqual(mentat.datatype.internal.t_datetime('2017-06-13T10:55:52+02:00'), datetime.datetime.utcfromtimestamp(1497344152))

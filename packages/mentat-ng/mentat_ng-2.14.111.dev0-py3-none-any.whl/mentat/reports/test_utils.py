...
class TestMentatReportsUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        global_filter = FilterModel(name = 'FLT_GLOBAL', source_based = True, type = 'advanced', filter = 'Category == "Anomaly.Traffic"', description = 'DESC3', enabled = True)
    ...
    def test_04_reporting_settings(self):
        ...
        self.assertEqual(str(reporting_settings.filters), "[<Filter(name='FLT_GLOBAL')>, <Filter(name='FLT1')>, <Filter(name='FLT2')>]")
        ...
        self.assertEqual(str(filter_list), "[(<Filter(name='FLT_GLOBAL')>, COMPBINOP(VARIABLE('Category') OP_EQ CONSTANT('Anomaly.Traffic'))), "

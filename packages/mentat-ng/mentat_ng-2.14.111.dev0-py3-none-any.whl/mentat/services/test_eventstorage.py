...
class TestMentatStorage(unittest.TestCase):
    ...
    def test_12_thresholding_cache(self):
        ...
        storage.threshold_save('msgid1', 'ident3', 'test@domain.org', 'low', reltime + datetime.timedelta(seconds = 5), False)
        storage.threshold_save('msgid2', 'ident3', 'test@domain.org', 'low', reltime + datetime.timedelta(seconds = 6), False)
        storage.threshold_save('msgid3', 'ident2', 'test@domain.com', 'low', reltime + datetime.timedelta(seconds = 2), True)
    ...
    def test_13_relapse(self):
        ...
        for target in True, False:
            ...
            relapses = storage.search_relapsed_events('test@domain.org', 'low', ttltime + datetime.timedelta(seconds=300), target)
            ...
            storage.threshold_set('ident2', thrtime, reltime, ttltime, label)
            _threshold_save(idea1['ID'], 'ident1', reltime + datetime.timedelta(seconds=200), target)
            _threshold_save(idea2['ID'], 'ident2', reltime + datetime.timedelta(seconds=200), not target)

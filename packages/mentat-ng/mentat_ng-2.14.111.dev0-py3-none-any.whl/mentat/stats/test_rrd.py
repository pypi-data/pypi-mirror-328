...
class TestMentatStatsRrd(unittest.TestCase):
    ...
    def test_02_prepare_db(self):
        ...
        #
        self.assertEqual(self.stats.prepare_db('typea.{}'.format(mentat.stats.rrd.DB_TOTALS_NAME), tst), (f'{RRD_STATS_DIR}/typea._totals.rrd', True))
        self.assertEqual(self.stats.prepare_db('typeb.{}'.format(mentat.stats.rrd.DB_TOTALS_NAME), tst), (f'{RRD_STATS_DIR}/typeb._totals.rrd', True))

        self.assertEqual(self.stats.prepare_db('typea.testa', tst), (f'{RRD_STATS_DIR}/typea.testa.rrd', True))
        self.assertEqual(self.stats.prepare_db('typea.testb', tst), (f'{RRD_STATS_DIR}/typea.testb.rrd', True))
        self.assertEqual(self.stats.prepare_db('typea.testc', tst), (f'{RRD_STATS_DIR}/typea.testc.rrd', True))

        self.assertEqual(self.stats.prepare_db('typeb.testa', tst), (f'{RRD_STATS_DIR}/typeb.testa.rrd', True))
        self.assertEqual(self.stats.prepare_db('typeb.testb', tst), (f'{RRD_STATS_DIR}/typeb.testb.rrd', True))
        self.assertEqual(self.stats.prepare_db('typeb.testc', tst), (f'{RRD_STATS_DIR}/typeb.testc.rrd', True))

        #
        # Create same RRD databases again, but the files already exist, and will not be created.
        #
        self.assertEqual(self.stats.prepare_db('typea.{}'.format(mentat.stats.rrd.DB_TOTALS_NAME), tst), (f'{RRD_STATS_DIR}/typea._totals.rrd', False))
        self.assertEqual(self.stats.prepare_db('typeb.{}'.format(mentat.stats.rrd.DB_TOTALS_NAME), tst), (f'{RRD_STATS_DIR}/typeb._totals.rrd', False))

        self.assertEqual(self.stats.prepare_db('typea.testa', tst), (f'{RRD_STATS_DIR}/typea.testa.rrd', False))
        self.assertEqual(self.stats.prepare_db('typea.testb', tst), (f'{RRD_STATS_DIR}/typea.testb.rrd', False))
        self.assertEqual(self.stats.prepare_db('typea.testc', tst), (f'{RRD_STATS_DIR}/typea.testc.rrd', False))

        self.assertEqual(self.stats.prepare_db('typeb.testa', tst), (f'{RRD_STATS_DIR}/typeb.testa.rrd', False))
        self.assertEqual(self.stats.prepare_db('typeb.testb', tst), (f'{RRD_STATS_DIR}/typeb.testb.rrd', False))
        self.assertEqual(self.stats.prepare_db('typeb.testc', tst), (f'{RRD_STATS_DIR}/typeb.testc.rrd', False))

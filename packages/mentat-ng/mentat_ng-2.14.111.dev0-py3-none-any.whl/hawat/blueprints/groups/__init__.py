...
class AddMemberView(HTMLMixin, SQLAlchemyMixin,
...
class RejectMemberView(HTMLMixin, SQLAlchemyMixin,
                       ItemObjectRelationView):  # pylint: disable=locally-disabled,too-many-ancestors
    """
...
class RemoveMemberView(HTMLMixin, SQLAlchemyMixin,
                       ItemObjectRelationView):  # pylint: disable=locally-disabled,too-many-ancestors
    """
...
class AddManagerView(HTMLMixin, SQLAlchemyMixin,
                     ItemObjectRelationView):  # pylint: disable=locally-disabled,too-many-ancestors
    """
...
class RemoveManagerView(HTMLMixin, SQLAlchemyMixin,
                        ItemObjectRelationView):  # pylint: disable=locally-disabled,too-many-ancestors
    """
...
def get_blueprint():
    ...
    hbp.register_view_class(RejectMemberView, f'/{BLUEPRINT_NAME}/<int:item_id>/reject_member/<int:other_id>')
    hbp.register_view_class(RemoveMemberView, f'/{BLUEPRINT_NAME}/<int:item_id>/remove_member/<int:other_id>')
    hbp.register_view_class(AddManagerView, f'/{BLUEPRINT_NAME}/<int:item_id>/add_manager/<int:other_id>')
    hbp.register_view_class(RemoveManagerView, f'/{BLUEPRINT_NAME}/<int:item_id>/remove_manager/<int:other_id>')

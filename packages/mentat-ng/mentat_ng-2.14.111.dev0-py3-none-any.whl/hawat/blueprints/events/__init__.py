...
def _get_report_search_context_from_form_data(form_data: dict[str, Any]) -> dict[str, Any]:
...
def _get_report_search_context_from_idea(
    event: "Idea",
    additional_context: Optional[Literal['source', 'target']]
) -> dict[str, Any]:
    res = {}
    ...
    if additional_context == 'source':
        ...
        _add_not_none(res, 'severities', event.get_jpath_value('_Mentat.TargetSeverity'), as_list=True)
        _add_not_none(
            res,
            'target_ips',
...
def _get_event_search_context_from_idea(event: "Idea") -> dict[str, Any]:
    ...
    _add_not_none(res, 'groups', event.get_jpath_value('_Mentat.ResolvedAbuses'), as_list=True)
    _add_not_none(res, 'target_groups', event.get_jpath_value('_Mentat.TargetAbuses'), as_list=True)

    _add_not_none(res, 'severities', event.get_jpath_value('_Mentat.EventSeverity'), as_list=True)
    _add_not_none(res, 'target_severities', event.get_jpath_value('_Mentat.TargetSeverity'), as_list=True)

    _add_not_none(res, 'classes', event.get_jpath_value('_Mentat.EventClass'), as_list=True)
    _add_not_none(res, 'target_classes', event.get_jpath_value('_Mentat.TargetClass'), as_list=True)
...
class EventsBlueprint(HawatBlueprint):
    ...
    def register_app(self, app):
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('source_addrs', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('target_addrs', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_host().add_rule('host_addrs', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('categories', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('classes', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('target_classes', True).add_kwrule('target_groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('detectors', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('detector_types', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('source_types', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('target_types', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_host().add_rule('host_types', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('source_ports', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_source_target().add_rule('target_ports', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb_for_host().add_rule('host_ports', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('protocols', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('severities', True).add_kwrule('groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule('target_severities', True).add_kwrule('target_groups', True, True).add_kwrules_from_form(SimpleEventSearchForm),

    ...
    def do_before_response(self, **kwargs):
        ...
        try:
            rrd_stats = mentat.stats.rrd.RrdStats(
                get_resource_path_fr(flask.current_app.mconfig[mentat.const.CKEY_CORE_STATISTICS][mentat.const.CKEY_CORE_STATISTICS_RRDSDIR]),
                get_resource_path_fr(flask.current_app.mconfig[mentat.const.CKEY_CORE_STATISTICS][

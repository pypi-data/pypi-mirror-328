#=========================================================================
 # COMPILER NUITKA
def COMPILER_NUITKA(compiler:str,filepath:str,modulepath:str|None,console:bool,tkinter:bool):
    import subprocess
    import sys
    import os
    ...
    if compiler=='msvc':
        ...
        if MSVCInstalled!=True:
            ...
            COMPILER_NUITKA(compiler,filepath,modulepath,console,tkinter)

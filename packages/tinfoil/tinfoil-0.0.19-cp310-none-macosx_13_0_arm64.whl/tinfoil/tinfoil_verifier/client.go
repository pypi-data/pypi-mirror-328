...
#cgo CFLAGS: "-I/Library/Frameworks/Python.framework/Versions/3.10/include/python3.10" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/Library/Frameworks/Python.framework/Versions/3.10/lib" "-lpython3.10" -ldl   -framework CoreFoundation

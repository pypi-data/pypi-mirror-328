...
#cgo CFLAGS: "-I/opt/hostedtoolcache/Python/3.12.9/x64/include/python3.12" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/opt/hostedtoolcache/Python/3.12.9/x64/lib" "-lpython3.12" -ldl -lm

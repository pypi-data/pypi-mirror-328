...
extern long long int client_Response_Headers_Get(long long int handle);
extern void client_Response_Headers_Set(long long int handle, long long int val);
...
extern long long int client_TLSBoundRoundTripper_ExpectedCertFP_Get(long long int handle);
extern void client_TLSBoundRoundTripper_ExpectedCertFP_Set(long long int handle, long long int val);
...
extern long long int client_GroundTruth_CertFingerprint_Get(long long int handle);
extern void client_GroundTruth_CertFingerprint_Set(long long int handle, long long int val);

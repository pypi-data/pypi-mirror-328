...
#cgo CFLAGS: "-I/opt/hostedtoolcache/Python/3.13.2/x64/include/python3.13" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/opt/hostedtoolcache/Python/3.13.2/x64/lib" "-lpython3.13" -ldl -lm

...
#cgo CFLAGS: "-I/opt/hostedtoolcache/Python/3.10.16/x64/include/python3.10" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/opt/hostedtoolcache/Python/3.10.16/x64/lib" "-lpython3.10" -lcrypt -ldl  -lm -lm

...
#cgo CFLAGS: "-I/opt/hostedtoolcache/Python/3.11.11/x64/include/python3.11" -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: "-L/opt/hostedtoolcache/Python/3.11.11/x64/lib" "-lpython3.11" -ldl -lm

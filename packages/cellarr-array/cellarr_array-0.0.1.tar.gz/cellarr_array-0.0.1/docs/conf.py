...
module_dir = os.path.join(__location__, "../src/cellarr_array")
try:
...
project = "cellarr-array"
copyright = "2025, Jayaram Kancherla"
...
try:
    from cellarr_array import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "cellarr-array-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "cellarr-array Documentation", "Jayaram Kancherla", "manual")
]
